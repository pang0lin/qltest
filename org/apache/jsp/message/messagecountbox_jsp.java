 ...
 * Generated at: 2023-01-06 09:53:30 UTC
...
public final class messagecountbox_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//	String id_set = request.getParameter("id");
        ...
        pageSize = Integer.parseInt(request.getAttribute("maxPageItems").toString());
            ...
            try {
              ...
              // /message/messagecountbox.jsp(90,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/MessageAction?action=countMsgView");
              // /message/messagecountbox.jsp(90,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.print(pageSize2);
                  out.write("\">\r\n\r\n\t<tr>\r\n\t\t<td width=\"4%\" nowrap rowspan=2></td>\r\n\t\t<td width=\"2%\" nowrap>发信人：</td>\r\n\t\t<td width=\"20%\"><input type=\"text\" name=\"name\" class=\"inputText\" size=\"16\" value=\"");
                  out.print(name_set);
                  out.write("\" onKeyDown=\"if(event.keyCode==13) search();\"></td>\r\n\t\t<td width=\"1%\" nowrap >从：</td>\r\n\t\t<td width=\"45%\" nowrap>\r\n\t\t  ");
if(startdate_set!=null)	{
...
if(checkbox_set !=null && "checked".equals(checkbox_set)){out.print("checked");}
                  out.write(">\r\n\r\n\t\t</td>\r\n\t\t<td align=\"right\" colspan=\"2\"> \r\n\t\t        <button class=\"btnButton2Font\" onclick=\"search();\">重置</button>\r\n\t\t\t<button class=\"btnButton2Font\" onclick=\"clearr();\">清除</button></td>\r\n\r\n\t</tr>\t\r\n\t");
            ...
            out.write("\r\n</table>\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\t<tr>\r\n\t\t<!--td width=\"6%\" nowrap class=\"listTableHead\">序号</td-->\r\n\t\t<td width=\"60%\" class=\"listTableHead\">发信人</td>\r\n\t\t<td width=\"40%\" class=\"listTableHead\">数量</td>\r\n\t</tr>\r\n\t");

		long sum=0;// 员工发短信数总计
		long systemcounter=0;//系统短信数　
		if(request.getAttribute("countSysMsg") !=null){
			systemcounter= Long.parseLong(request.getAttribute("countSysMsg").toString());
		}
		if(request.getParameter("pager.offset")!=null){
            ...
            try {
              ...
              // /message/messagecountbox.jsp(144,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fnotEmpty_005f0.setName("countMsgList");
              ...
              if (_jspx_eval_logic_005fnotEmpty_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  try {
                    ...
                    // /message/messagecountbox.jsp(144,38) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("countList");
                    // /message/messagecountbox.jsp(144,38) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("countMsgList");
                    // /message/messagecountbox.jsp(144,38) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setScope("request");
                    int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
                    if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      java.lang.Object countList = null;
                      ...
                      countList = (java.lang.Object) _jspx_page_context.findAttribute("countList");
                      do {
                        out.write('\r');
                        out.write('\n');
                        out.write('	');

		Object[] obj = (Object[]) countList;
		sum = sum + Long.parseLong(obj[2].toString());
		if(obj[0]!=null && !obj[0].toString().equals("系统管理员")){
			index ++;
			j ++;
			...
			if(index%2 != 0){listClass="listTableLine2";}
                  ...
                  out.write("\r\n\t<tr>\r\n\t\t<td colspan=\"1\" class=\"listTableHead\">系统</td>\r\n\t\t<td class=\"listTableLine1\">");
                  out.print(systemcounter);
                  out.write("</td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td colspan=\"1\" class=\"listTableHead\">总计</td>\r\n\t\t<td class=\"listTableLine1\">");
                  out.print(sum+systemcounter);
                  out.write("</td>\r\n\t</tr>");
            ...
            out.write("<input type=\"hidden\" name=\"checkboxNumber\">\r\n\t<input type=\"hidden\" name=\"jNumber\" value=\"");
            out.print(j);
