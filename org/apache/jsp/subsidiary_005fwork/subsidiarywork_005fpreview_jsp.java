...
public final class subsidiarywork_005fpreview_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String wishCard=request.getParameter("wishCard");
    ...
    String information = po.getWishContent();
    String filePath="/jsoa/upload/"+path;
    if(path!=null&&!"".equals(path)){
    	filePath = filePath.substring(0, filePath.indexOf(","));
    }
    if (wishText != null && !"".equals(wishText)){
