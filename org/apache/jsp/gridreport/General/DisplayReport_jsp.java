...
try{
	base.begin();
	String sql = "SELECT reportId,reportSql,sourceBase FROM oa_report WHERE grfName='"+grfName+"'";
	...
	if(!"0".equals(reportId)){
		sql = "SELECT beReplaceName,beReplaceString,replaceString FROM oa_reportreplace WHERE reportId="+reportId;
		...
		while(rs.next()){
			...
			if(dataString.length()>0){
				...
				if(request.getParameter(name)!=null&&!"".equals(request.getParameter(name))){
					String replaceSql = rs.getString(3);
...
if(!"".equals(where)){
	...
	if(reportSql.toLowerCase().indexOf("where 1=1")>0){
		reportSql = reportSql.substring(0,reportSql.toLowerCase().indexOf("where 1=1")+9)+" "+where+" "+reportSql.substring(reportSql.toLowerCase().indexOf("where 1=1")+9);
	}else if(reportSql.toLowerCase().indexOf(" where ")>0){
		reportSql = reportSql.substring(0,reportSql.toLowerCase().indexOf(" where ")+7)+" 1=1 "+where +" and "+reportSql.substring(reportSql.toLowerCase().indexOf(" where ")+7);
	}else{
		reportSql = reportSql + " where 1=1 "+where;
	}
	reportSql += " "+byStr;
}
...
if(!"".equals(html)&&!"".equals(reportSql)&&"".equals(ShowToolbar)){ 
      ...
      out.write("\r\n<tr height=\"100%\"><td>\r\n<script type=\"text/javascript\">\r\n    var Report = \"");
      out.print(grfName );
      out.write("\";\r\n    if (Report == \"null\")\r\n\t\tReport = \"\";\r\n    else if (Report != \"\")\r\n        Report = \"/jsoa/gridreport/grf/\" + Report;\r\n    \r\n    CreateDisplayViewerEx(\"100%\", \"100%\", Report, \"\", true, \"");
      out.print(ShowToolbar );
      out.write("\");\r\n    var QuerySQL = \"\";\r\n    ");
if("".equals(reportSql)){
      out.write("\r\n    QuerySQL = ReportViewer.Report.DetailGrid.Recordset.QuerySQL;\r\n    ");
}else{
      out.write("QuerySQL = \"");
      out.print(reportSql );
      out.write('"');
      ...
      out.write("\r\n    QuerySQL = encodeURI(QuerySQL);\r\n    //从报表模板中获取到查询SQL，并作为DataURL(xmlSQLParam)的参数\r\n    ReportViewer.DataURL = encodeURI(\"POST::/jsoa/gridreport/data/xmlSQLParam.jsp?QuerySQL=\"+QuerySQL);\r\n</script></td></tr>\r\n</table>\r\n</body>\r\n</html>\r\n ");
