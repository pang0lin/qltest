 ...
 * Generated at: 2023-01-06 09:50:11 UTC
...
public final class subsidiarywork_005ffestalcard_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int offset1 = index ;
      ...
      try {
       ...
       String url="/jsoa/ChannelAction.do?action=view&channelType=1&userChannelName=公共信息&userDefine=1&publicinfo=1";
            ...
            out.write("');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">公告</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n     <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/ForumClassAction.do?action=list&publicinfo=1&isproject=N');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">论坛</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanelSelected\" onClick=\"changePanle(this,'/jsoa/FestalCardAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">节日贺卡</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n     <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/BirthCardAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">生日贺卡</div>\r\n");
            out.write("        <div class=\"tabPanelRight\"></div>      \r\n      </div> \r\n      \r\n\t</td>\r\n\t  <td  align=\"right\">\r\n\t\t<button  class=\"btnButton2Font\"  onclick=\"MM_openBrWindow('/jsoa/subsidiary_work/subsidiarywork_festalcard_add.jsp','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=700,height=500')\">新增</button>\r\n\t\t<button  class=\"btnButton2Font\"  style=\"cursor:pointer\"onclick=\"delBatch()\">删除</button>\r\n\t\t<button class=\"btnButton4font\" onClick=\"chSearch(this)\" value=\"查询\">查询</button>\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n\r\n\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n<form name=\"form1\">\r\n\t<tr align=\"center\" valign=\"middle\">\r\n\t\t<td  width=\"40\" height=\"27\" class=\"listTableHead\"><input type=\"checkbox\" name=\"selectAll\" style=\"cursor:'hand'\" onclick=\"selectAllItem();\"></td>\r\n\t\t<td  width=\"10%\" class=\"listTableHead\">   历法  </td>\r\n\t\t<td  width=\"6%\" class=\"listTableHead\"> 年 </td>\r\n\t\t<td  width=\"4%\" class=\"listTableHead\"> 月 </td>\r\n\t\t<td  width=\"4%\" class=\"listTableHead\"> 日 </td>\r\n");
            out.write("\t\t<td  width=\"20%\" class=\"listTableHead\"> 节日名称 </td>\r\n\t\t<td  class=\"listTableHead\"> 节日祝福 </td>\r\n\t\t<td  width=\"8%\" class=\"listTableHead\"> 提前提醒 </td>\r\n\t\t<td  width=\"8%\" class=\"listTableHeadLast\"> 处理 </td>\r\n\t\t</tr>\r\n\t");
            //  logic:iterate
            ...
            try {
              ...
              // /subsidiary_work/subsidiarywork_festalcard.jsp(149,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("mylist");
              // /subsidiary_work/subsidiarywork_festalcard.jsp(149,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("mylist");
              // /subsidiary_work/subsidiarywork_festalcard.jsp(149,1) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(index%2 != 0){listClass="listTableLine2";}
                  ...
                  out.write("\r\n\t<tr>\r\n\t\t<td  class=\"");
                  out.print(listClass);
                  out.write("\" >\r\n\t\t<input style=\"cursor:'hand'\" type=\"checkbox\" name=\"batchDel\" value=\"");
                  out.print(obj[0]);
                  out.write("\">\r\n\t\t</td>\r\n\t\t<td  class=\"");
                  out.print(listClass);
                  out.write("\" align=\"left\">");
 out.println(Integer.parseInt(obj[8].toString())==1?"农历":"公历");
                  out.write("</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"  align=\"left\">\r\n\t\t");
 out.println( Integer.parseInt(obj[9].toString())==0?"&nbsp;":(obj[4]+""));
                  out.write("\r\n\t\t</td>\r\n\t\t<td  class=\"");
                  out.print(listClass);
                  out.write("\" align=\"left\">");
 if(obj[3]!=null &&!"".equals(obj[3].toString())) out.print(obj[3]+"") ; else out.print("") ; 
                  out.write("</td>\r\n\t\t<td  class=\"");
                  out.print(listClass);
                  out.write("\" align=\"left\">");
                  ...
                  out.write("</td>\r\n\t\t<td  class=\"");
                  out.print(listClass);
                  out.write("\" align=\"left\"><a href=\"javascript:void(0);\" onclick=\"edit('");
                  out.print(obj[0]);
                  out.write("', '1')\">");
                  ...
                  out.print(listClass);
                  out.write("\" align=\"left\">\r\n\t\t");
                  out.print(obj[6]==null?"&nbsp;":(com.js.util.util.CharacterTool.escapeHTMLTags(obj[6]+"")));
                  out.write("\r\n\t\t</td>\r\n\t\t<td  class=\"");
                  out.print(listClass);
                  out.write(" \" align=\"left\">");
 out.println(obj[5]=(obj[5]==null||"".equals(obj[5].toString()))?"&nbsp;":obj[5]);
                  out.write("天</td>\r\n\t\t<td  class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">\r\n\t\t\t<img  style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" alt=\"修改\" onclick=\"edit('");
                  out.print(obj[0]);
                  out.write("', '0')\" >&nbsp;<img  style=\"cursor:pointer\" border=\"0\" src=\"images/del.gif\" alt=\"删除\" onclick=\"del('");
                  out.print(obj[0]);
                  out.write("')\" >&nbsp;\r\n\t\t</td>\r\n\t</tr>\r\n\t");
...
String pagerURL = "/jsoa/FestalCardAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
  ...
  private boolean _jspx_meth_html_005fform_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /subsidiary_work/subsidiarywork_festalcard.jsp(62,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fform_005f0.setAction("/FestalCardAction.do?action=list");
      // /subsidiary_work/subsidiarywork_festalcard.jsp(62,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          if (_jspx_meth_html_005ftext_005f0(_jspx_th_html_005fform_005f0, _jspx_page_context))
            return true;
          out.write("\r\n\t\t &nbsp;</td>\r\n\t\t</td>\r\n\t\t<td align=\"right\">\r\n\t\t\t<button  class=\"btnButton2Font\" onclick=\"query1();\" style=\"cursor:pointer\">查询</button>\r\n\t\t\t<button  class=\"btnButton2Font\" onclick=\"clear1();\" style=\"cursor:pointer\">重置</button>\r\n\t\t</td>\r\n\t\t<td width=\"16\" align=\"center\" valign=\"middle\" rowspan=\"1\"></td>\r\n\t</tr>\r\n</table>\r\n<!-- SEARCH\tPART -->\r\n\r\n");
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /subsidiary_work/subsidiarywork_festalcard.jsp(69,2) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyleClass("inputtext");
      // /subsidiary_work/subsidiarywork_festalcard.jsp(69,2) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setProperty("queryText");
      // /subsidiary_work/subsidiarywork_festalcard.jsp(69,2) name = onkeypress type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setOnkeypress("return look() ;");
      // /subsidiary_work/subsidiarywork_festalcard.jsp(69,2) name = onkeyup type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setOnkeyup("value=checkQuery(this,'节日名称')");
      // /subsidiary_work/subsidiarywork_festalcard.jsp(69,2) name = onblur type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setOnblur("value=checkQuery1(this,'节日名称')");
      // /subsidiary_work/subsidiarywork_festalcard.jsp(69,2) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
