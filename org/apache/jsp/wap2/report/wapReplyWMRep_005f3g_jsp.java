...
public final class wapReplyWMRep_005f3g_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String leaveword = request.getParameter("leaveword");
	...
	if (leaveFlag) {
		...
		if("1".equals(reportType)){
			bd.add(userName, leaderId, userId, leaveword, usersId, usersName, "", domainId);
		}else if("3".equals(reportType)){
			String grade = request.getParameter("grade");
			bd.add(userName, leaderId, userId, leaveword, usersId, usersName, "", grade, "", "", domainId);
		}else{}
