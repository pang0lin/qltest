 ...
 * Generated at: 2023-01-06 09:41:03 UTC
...
String isload = "0";
if(request.getParameter("pager.offset")!=null) isload="1";
...
boolean flag = mdb.hasRight(session.getAttribute("userId").toString(), "09*09*01");
      ...
      out.write("\r\n\t\t       <div class=\"btnBQspace AlignLeft\"></div>\r\n\t\t\t    <div id=\"PanleDIV\"  class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/CollectCategoryAction.do?action=list');\">\r\n\t\t        <div class=\"tabPanelLeft\"></div>\r\n\t\t        <div class=\"tabPanelCenter\">数据采集类别</div>\r\n\t\t        <div class=\"tabPanelRight\"></div>      \r\n\t\t      </div>\r\n\t\t      ");
		       ...
		       if(flag){ 
      out.write("\r\n\t\t       <div class=\"btnBQspace AlignLeft\"></div>\r\n\t\t\t    <div id=\"PanleDIV\" class=\"tabPanelSelected\" onClick=\"changePanle(this,'/jsoa/ReportTypeAction.do?action=list');\">\r\n\t\t        <div class=\"tabPanelLeft\"></div>\r\n\t\t        <div class=\"tabPanelCenter\">报表类别</div>\r\n\t\t        <div class=\"tabPanelRight\"></div>      \r\n\t\t      </div>\r\n\t\t      ");
}
      out.write("\r\n\t\t  </td>\r\n\t\t  <td align=\"right\">\r\n\t\t  <input type=\"button\" class=\"btnButton2Font\" onclick=\"openURL('/jsoa/ReportTypeAction.do?action=add')\" value=\"新增\"/>\r\n\t\t  <input type=\"button\" class=\"btnButton2Font\" onclick=\"batchDel();\" value=\"删除\"/>\r\n\t\t  <input type=\"button\" class=\"btnButton2Font\" id=\"btnButton2FontShow\" onClick=\"showSearch(this);\" value=\"查询\"/>\r\n\t\t  </td> \r\n\t    </tr>\r\n\t</table>\r\n</td>\r\n</tr>\r\n<!-- LIST TITLE PART -->\r\n\r\n<tr><td>\r\n\t<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n\t        <input type=\"hidden\" name=\"fromSystem\" value=\"1\">\r\n\t\t\t<tr>\r\n\t\t\t\t<td class=\"listTableHead\" width=\"40\" nowrap><input type=\"checkbox\" name=\"Del\" onclick=\"selectAllItem(this);\"></td>\r\n\t\t\t\t<td class=\"listTableHead\" width=\"20%\" >分类名称 </td>\r\n\t\t\t\t<td class=\"listTableHead\" >分类描述 </td>\r\n\t\t\t\t<td class=\"listTableHead\" width=\"20%\" >查看人 </td>\r\n\t\t\t\t<td class=\"listTableHeadLast\" width=\"8%\" nowrap> 处理 </td>\r\n\t\t\t</tr>\r\n\t\t\t");
String className = "listTableLine1";
			for(int i=0;i<list.size();i++){
				if(i/2==0) className="listTableLine1";
				else className="listTableLine2";
				Object[] obj = (Object[])list.get(i);
				String gString = ""; 
				String[] orders = obj[5].toString().split("\\$");
				for(int j=0;j<((orders.length/2)-1);j++){
					gString += "&nbsp;&nbsp;";
				}
      ...
      out.write("\"\r\n\t\t\t\t\t\t");
      out.print(operation.contains(obj[0].toString())?"":"disabled=\"disabled\"" );
...
if(operation.contains(obj[0].toString())){ 
      out.write("<div align=\"left\">\r\n\t\t\t\t\t<img src=\"/jsoa/images/modi.gif\" title=\"修改\" style=\"cursor:pointer\" onclick=\"modify('");
      out.print(obj[0].toString() );
...
String pagerURL = "/jsoa/ReportTypeAction.do";
      out.write("\r\n\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n<iframe name=\"myIframe\" style=\"display:none;\"></iframe>\r\n</body>\r\n<script language =\"javascript\">\r\nfunction modify(typeId){\r\n\topenURL(\"/jsoa/ReportTypeAction.do?action=modi&typeId=\"+typeId);\r\n}\r\nfunction del(typeId){\r\n\tif(confirm(\"删除分类将会将子分类和分类下的报表删除，您确定删除吗？\")){\r\n\t\twindow.open(\"/jsoa/ReportTypeAction.do?action=delete&typeId=\"+typeId+\",\",\"myIframe\");\r\n\t}\r\n}\r\nfunction batchDel(){\r\n\tif(confirm(\"删除分类将会将子分类和分类下的报表删除，您确定删除吗？\")){\r\n\t\twindow.open(\"/jsoa/ReportTypeAction.do?action=delete&typeId=\"+getAllSelectIds()+\",\",\"myIframe\");\r\n\t}\r\n}\r\nfunction showSearch(obj){\r\n\tif(document.getElementById(\"searchbar\").style.display==\"none\"){\r\n\t\tdocument.getElementById(\"searchbar\").style.display=\"\";\r\n\t\tobj.value=\"关闭查询\";\r\n\t}else{\r\n\t\tdocument.getElementById(\"searchbar\").style.display=\"none\";\r\n\t\tobj.value=\"查询\";\r\n\t}\r\n}\r\nfunction search(){\r\n\tlocation.href = \"/jsoa/ReportTypeAction.do?action=list&searchTypeName=\"+document.getElementById(\"searchTypeName\").value;\r\n}\r\nfunction searchClear(){\r\n");
      out.write("\tdocument.getElementById(\"searchTypeName\").value=\"\";\r\n}\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\n</SCRIPT>\r\n</html>\r\n<script src=\"/jsoa/js/util.js\"></script>");
