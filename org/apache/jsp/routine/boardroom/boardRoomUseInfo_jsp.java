 ...
 * Generated at: 2023-01-06 09:48:29 UTC
...
public final class boardRoomUseInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      try {
		...
		String searchEndDate = request.getParameter("searchEndDate");
            ...
            out.write("\r\n<body   class=\"MainFrameBox\" onload=\"resizeWin(850,600);\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"\">\r\n\t");
            //  html:form
            ...
            try {
              ...
              // /routine/boardroom/boardRoomUseInfo.jsp(71,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/BoardRoomAction.do?action=boardRoomUseInfo");
              // /routine/boardroom/boardRoomUseInfo.jsp(71,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
			...
			if(searchStartDate.indexOf("-")!=-1){
		
            out.write("\r\n\t\t");
            out.print(searchStartDate.replace('-','年').replace('-','月')+"日");
            out.write(' ');
            out.write('至');
            out.write(' ');
            out.print(searchEndDate.replace('-','年').replace('-','月')+"日");
            out.write("\r\n\t\t");
}else{
            out.write("\r\n\t\t");
            out.print(searchStartDate.replace('/','年').replace('/','月')+"日");
            ...
            out.write("\r\n\t</td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\t<form  name=\"form1\" method=\"post\">\r\n\t<tr>\r\n\t    <td  class=\"listTableHead\" width=\"15%\">时间<a href=\"javascript:orderby('/jsoa/BoardRoomAction.do?action=boardRoomUseInfo&orderbytime=");
            out.print(timeOrder);
            out.write("')\">");
if(request.getParameter("orderbytime")==null){
            ...
            out.write("</a></td>\r\n\t\t<td class=\"listTableHead\" width=\"15%\">会议室名称<a href=\"javascript:orderby('/jsoa/BoardRoomAction.do?action=boardRoomUseInfo&orderbystatus=");
...
if(request.getParameter("orderbystatus")==null){
            ...
            out.write("</a></td>\r\n\t\t<td class=\"listTableHead\" width=\"23%\">会议主题</td>\r\n\t\t<td  class=\"listTableHead\" width=\"8%\">类型</td>\r\n\t\t<td  class=\"listTableHead\" width=\"8%\">预定人</td>\r\n\t\t<td  class=\"listTableHeadLast\" width=\"20%\">参会人员</td>\r\n\t</tr>\r\n\r\n\t");
		...
		if(request.getParameter("pager.offset")!=null){
            ...
            try {
              ...
              // /routine/boardroom/boardRoomUseInfo.jsp(123,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /routine/boardroom/boardRoomUseInfo.jsp(123,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("boardroomUseList");
		...
		//				"boardRoomApplyPO.boardroomApplyId,boardRoomPO.boardroomId,boardRoomPO.name,
		//boardRoomPO.boardroomType,boardRoomPO.location,boardRoomApplyPO.applyEmpName5,
		//boardRoomApplyPO.applyOrgName,poo.meetingDate,poo.startTime,poo.endTime,
		//boardRoomApplyPO.emceeName10,boardRoomApplyPO.motif,boardRoomApplyPO.bdroomAppType,
		//boardRoomApplyPO.applyEmp,poo.id,poo.status,boardRoomApplyPO.attendee16,boardRoomApplyPO.attendeeLeader17,
		//boardRoomApplyPO.nonvoting18,boardRoomApplyPO.notePerson19",
	
                  out.write("\r\n\t<tr>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
if(obj[6] !=null && !"".equals(obj[7].toString())){
                  out.print(obj[7].toString().substring(2,10));
}else{
                  out.write("&nbsp;");
}
                  out.write("&nbsp;");
if(obj[7] !=null && !"".equals(obj[8].toString())){
                  ...
                  out.write('-');
if(obj[8] !=null && !"".equals(obj[9].toString())){
                  out.print(endHours);
                  out.write(':');
...
if(obj[16] !=null && !"".equals(obj[16].toString())){
                  ...
                  out.write("\r\n\t\t\t");
if(obj[17] !=null && !"".equals(obj[17].toString())){
                  out.print(obj[17]);
}
                  out.write("\r\n\t\t\t");
if(obj[18] !=null && !"".equals(obj[18].toString())){
                  out.print(obj[18]);
}
                  out.write("\r\n\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n<script language=\"javascript\">\r\n<!--\r\n\r\nfunction search(){\r\n    //\tdocument.BoardRoomActionForm.submit();\r\n    var hhref = \"&searchStartDate=\"+document.all.searchStartDate.value+\"&searchEndDate=\"+document.all.searchEndDate.value;\r\n\twindow.location.href=\"/jsoa/BoardRoomAction.do?action=boardRoomUseInfo\"+hhref;\r\n}\r\n\r\nfunction cleared(){\r\n    window.location.href=\"/jsoa/BoardRoomAction.do?action=useBoardroomView\";\r\n}\r\n\r\nfunction view(id,name,meetingId){\r\n\tMM_openBrWindow('BoardRoomAction.do?action=selectBoardroomApplyView&boardroomApplyId='+id+'&boardroomName='+name+'&type=view&isView=true&meetingId='+meetingId+'&executeStatus=true','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=580')\r\n}\r\n\r\nfunction modify(id,name){\r\n\tMM_openBrWindow('BoardRoomAction.do?action=selectBoardroomApplyModify&boardroomApplyId='+id+'&boardroomName='+name+'&type=view','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=580')\r\n}\r\n\r\nfunction cancel(id){\r\n");
            out.write("\t ");
 int  deloff = j==1? pageSize2-15:pageSize2;
         if(deloff<0) deloff =0 ;
     
            out.write("\r\n\tif(confirm(\"确实要删除这次申请吗？\")){ window.location.href=\"/jsoa/BoardRoomAction.do?action=cancelBoardroomApply&boardroomApplyId=\"+id+\"&pager.offset=\"+");
            out.print(deloff);
            out.write(";\r\n    }\r\n}\r\n\r\nfunction orderby(url){\r\n\tdocument.BoardRoomActionForm.action = url;\r\n\tdocument.BoardRoomActionForm.submit();\r\n}\r\n\r\nfunction finish(id, id2, name, meetingDate, startTime, endTime){\r\n\tif(confirm(\"确实要结束这次会议吗？\")){\r\n\t\tMM_openBrWindow('/jsoa/routine/boardroom/boardRoomApply_finish.jsp?boardroomApplyId='+id+'&meetingId='+id2+'&name='+name+'&meetingDate='+meetingDate+'&startTime='+startTime+'&endTime='+endTime,'','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=450,height=250')\r\n\t}\r\n}\r\n//-->\r\n</script>\r\n");
