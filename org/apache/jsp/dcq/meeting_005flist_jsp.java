 ...
 * Generated at: 2023-01-06 09:44:26 UTC
  ...
  for(int i=0;i<myList.size();i++){
 	...
 	if(index%2 != 0){
 	     ...
 	     listClass="listTableLine1";
            ...
            out.write('"');
            out.write('>');
            out.print(obj[2]==null?"":obj[2].toString().substring(0, obj[2].toString().length()-2));
            out.write("</td>\r\n        <td class=\"");
            out.print(listClass);
            out.write('"');
            out.write('>');
            out.print(obj[3]==null?"":obj[3].toString().substring(0, obj[3].toString().length()-2));
            out.write("</td>\r\n        <td class=\"");
            out.print(listClass);
            out.write('"');
            out.write('>');
