...
String copedFormId=session.getAttribute("copyedForm")==null?"":session.getAttribute("copyedForm").toString();
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /eform/form.jsp(48,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/CustomFormAction.do");
              // /eform/form.jsp(48,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if("shandongguotou".equals(com.js.util.config.SystemCommon.getCustomerName())){
                  ...
                  out.write("\r\n\t      \r\n    </td>\r\n    <td  align=\"right\" nowrap>\r\n    <input type=\"button\" value=\"新增\" class=\"btnButton2Font\" onclick=\"javascript:add()\" />\r\n    <input type=\"button\" value=\"复制表单\" class=\"btnButton2Font\" onclick=\"javascript:copyData()\" />\r\n    <input type=\"button\" value=\"删除\" class=\"btnButton2Font\" onclick='javascript:if(!checkboxIsChecked(document.all.id)){alert(\"请选择要删除的记录！\");}else{if(confirm(\"确定删除吗?\")) {del();}}' />\r\n   \t<input type=\"button\" class=\"btnButton4font\" onClick=\"chSearch(this)\" value=\"查询\" />\r\n    </td>\r\n  </tr>\r\n</table>\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n\t<tr>\r\n\t\t<td width=\"40\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"chkSelect\" style=\"cursor:'hand'\" onclick=\"selectID(this);\"></td>\r\n\t\t<td class=\"listTableHead\" onclick=\"sort('1');\">表单名称<img  name=\"img1\"  title=\"");
                  if (_jspx_meth_bean_005fmessage_005f0(_jspx_th_html_005fform_005f0, _jspx_page_context))
                    return;
                  out.write("\" style=\"cursor:pointer\" src=\"/jsoa/images/blanksort.gif\"/></td>\r\n\t\t<td width=\"35%\" class=\"listTableHead\">关联数据表</td>\r\n                <td width=\"9%\" class=\"listTableHead\">显示模版</td>\r\n                <td width=\"9%\" class=\"listTableHead\">打印模版</td>\r\n                <td width=\"9%\" class=\"listTableHead\">移动模版</td>\r\n\t\t<td width=\"8%\" nowrap class=\"listTableHeadLast\">处理</td>\r\n\t</tr>\r\n\t\t");


			if(request.getParameter("pager.offset") != null){
				flag = Integer.parseInt(request.getParameter("pager.offset"));
			...
			String mobileId="";
                  ...
                  try {
                    ...
                    // /eform/form.jsp(141,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("formList");
                    // /eform/form.jsp(141,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("formList");
                    // /eform/form.jsp(141,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
			...
			index++;
			j++;
			Object[] obj = (Object[])  formList;
			String listClass="listTableLine1";
			if(index%2 != 0){
				listClass="listTableLine2";
			}
			if(obj[3]==null||obj[3].toString().equals("")||obj[3].toString().equals("null")){
				printid=obj[0].toString();
			}else{
				printid=obj[3].toString();
			}
                        ...
                        out.write('"');
                        out.write('>');
                        out.print(obj[1]==null?"&nbsp":obj[1]);
                        out.write("</td>\r\n\t\t<td class=\"");
                        out.print(listClass);
                        out.write('"');
                        out.write('>');
                        out.print(obj[2]==null?"&nbsp":obj[2]);
                        out.write("</td>\r\n        <td class=\"");
                        out.print(listClass);
                        out.write("\"><a href=\"javascript:void(0);\" onclick=\"javascript:edit('");
                        out.print(obj[0]);
                        out.write("',0)\">显示模版</a></td>\r\n\t\t<td class=\"");
                        out.print(listClass);
                        out.write("\"><a href=\"javascript:void(0);\" onclick=\"javascript:edit('");
                        out.print(printid );
                        out.write("',1)\">打印模版</a></td>\r\n\t\t<td class=\"");
                        out.print(listClass);
                        out.write("\"><a href=\"javascript:void(0);\" onclick=\"javascript:editMobilePage('");
                        out.print(obj[0] );
                        out.write('\'');
                        out.write(',');
                        out.write('\'');
                        out.print(obj[4] );
                        out.write("',2)\">移动模版</a></td>\r\n\t\t<td class=\"");
                        out.print(listClass);
                        out.write(" listTableLineLastTD\" nowrap>\r\n\t\t\t<a href=\"javascript:void(0);\" onclick=\"javascript:edit('");
                        out.print(obj[0]);
                        out.write("',0)\">");
                        if (_jspx_meth_html_005fimg_005f0(_jspx_th_logic_005fiterate_005f0, _jspx_page_context))
                          return;
                        out.write("</a>&nbsp;\r\n\t\t\t<a href=\"javascript:void(0);\" onclick=\"javascript:if(confirm('确定删除吗?')) {delone('");
                        out.print(obj[0]);
                        out.write("');}\">");
                        if (_jspx_meth_html_005fimg_005f1(_jspx_th_logic_005fiterate_005f0, _jspx_page_context))
                          return;
                        out.write("</a>\r\n\t\t</td>\r\n\t</tr>\r\n\t\t\r\n\t\t");
...
String pagerURL = "/jsoa/CustomFormAction.do";
                  out.write("\r\n\t\t\t\t\t\t\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\r\n<script language=\"javascript\">\r\n\tfunction add(){\t\r\n\t\tMM_openBrWindow(\"/jsoa/CustomFormAction.do?operate=add\",\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600\") ;\r\n\t}\r\n\t\r\n    function sort(mark){\r\n         var sname=document.all.sname.value;\r\n         var operate=document.all.operate.value;\r\n         var pageid=document.all.pageid.value;\r\n         var desc=document.all.desc.value;\r\n         if(desc==\"1\"){ \r\n              desc = \"2\";\r\n         }else if (desc == \"2\"){\r\n             desc = \"1\";\r\n         }else{\r\n             desc = \"1\";\r\n         }\r\n         var hhref= \"/jsoa/CustomFormAction.do?mark=\"+mark+\"&sname=\"+sname+\"&operate=\"+operate+\"&pageid=\"+pageid+\"&desc=\"+desc ;\r\n         window.location.href =hhref;\r\n    }\r\n\r\n\tfunction del(){\r\n\t\tCustomFormActionForm.operate.value=\"batchdelete\";\r\n\t\tCustomFormActionForm.submit();\r\n\t}\r\n\r\n\tfunction delone(tag){\r\n\t");

     int deloffset =  j == 1 ? pageSize2-15:pageSize2 ;
     deloffset = deloffset < 0 ? 0 : deloffset ;
     
      out.write("\r\n\t\tCustomFormActionForm.operate.value=\"signledelete\";\r\n\t\tCustomFormActionForm.pageid.value=tag;\r\n\t\tCustomFormActionForm.action=\"/jsoa/CustomFormAction.do?operate=signledelete&pageid=\"+tag+\"&pager.offset=");
      out.print(deloffset);
      out.write("\";\r\n\t\tCustomFormActionForm.submit();\r\n\t}\r\n\r\n\tfunction edit(tag,isPrint){\r\n\t\tMM_openBrWindow(\"/jsoa/CustomFormAction.do?operate=edit&pageid=\"+tag+\"&pager.offset=\"+document.all.pager.value+\"&sname=\"+document.all.sname.value+\"&isPrint=\"+isPrint,\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600\") ;\r\n\t}\r\n\tfunction editMobilePage(pageId,mobileId){\r\n\t\tMM_openBrWindow(\"/jsoa/CustomFormAction.do?operate=toMobileEdit&pageid=\"+pageId+\"&mobileId=\"+mobileId+\"&pager.offset=\"+document.all.pager.value+\"&sname=\"+document.all.sname.value,\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600\") ;\r\n\t}\r\n\tfunction query(){\r\n\t\t//CustomFormActionForm.operate.value=\"search\";\r\n\t\tCustomFormActionForm.submit();\r\n\t}\r\n\r\n\tfunction selectAll(name) {\r\n    var obj=document.all[name];\r\n    if (obj&&obj.length) {\r\n      for (i=0;i<obj.length;i++) {\r\n\t\t  if (!obj[i].disabled)\r\n\t\t\t  obj[i].checked=true;\r\n      }\r\n      return;\r\n    }\r\n    if (obj) {\r\n      obj.checked=true;\r\n    }\r\n  }\r\n\r\n  function clearAll(name) {\r\n    var obj=document.all[name];\r\n");
      out.write("    if (obj&&obj.length) {\r\n      for (i=0;i<obj.length;i++) {\r\n        if (!obj[i].disabled)\r\n\t\t\tobj[i].checked=false;\r\n      }\r\n      return;\r\n    }\r\n    if (obj) {\r\n      obj.checked=false;\r\n    }\r\n  }\r\n  function selectID(obj){\r\n\t  if (obj.checked)\r\n\t\t  selectAll('id');\r\n\t  else\r\n\t\t  clearAll('id');\r\n  }\r\n  \r\n  var copyedID=\"");
      out.print(copedFormId );
      out.write("\";\r\n  \r\n  function copyData(){\r\n  \tcopyedID=\"\";\r\n  \tvar name=\"id\";\r\n  \tvar obj=document.all[name];\r\n    if (obj&&obj.length) {\r\n      for (i=0;i<obj.length;i++) {\r\n        if (obj[i].checked)\r\n\t\t\t     copyedID+=obj[i].value+\",\";\r\n      }      \r\n    }else{\r\n    \tif (obj.checked)\r\n         copyedID+=obj.value+\",\";\r\n    }\r\n    //alert(copyedID);\r\n    if(copyedID==\"\"){\r\n    \talert(\"请选择要复制的数据表!\");\r\n    }else{\r\n    \tdocument.location.href=\"/jsoa/CustomFormAction.do?oprFlag=copyData&formId=\"+copyedID;\r\n    }\r\n  }\r\n  \r\n  function pasteData(){\r\n  \tif(copyedID==\"\"){\r\n  \t\talert(\"请先复制数据表!\");\r\n  \t}else{\r\n  \t\tdocument.location.href=\"/jsoa/CustomFormAction.do?oprFlag=pasteData\";\r\n  \t\tcopyedID=\"\";\r\n  \t}\r\n  \t\r\n  }\r\n  function changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\nfunction chSearch(obj){\r\n\tif(obj.value == \"查询\"){\r\n\t\tobj.value = \"关闭查询\";\r\n\t\tdocument.all.searchTable.style.display=\"\";\r\n\t}else{\r\n\t\tobj.value = \"查询\";\r\n\t\tdocument.all.searchTable.style.display=\"none\";\r\n\t}\r\n}\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /eform/form.jsp(60,4) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyleClass("inputText");
      // /eform/form.jsp(60,4) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setProperty("sname");
      // /eform/form.jsp(60,4) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /eform/form.jsp(124,79) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("personalwork");
      // /eform/form.jsp(124,79) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setKey("innercontact.sortbyname");
  ...
  private boolean _jspx_meth_html_005fimg_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /eform/form.jsp(165,76) name = border type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f0.setBorder("0");
      // /eform/form.jsp(165,76) name = src type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f0.setSrc("/jsoa/images/modi.gif");
      // /eform/form.jsp(165,76) name = alt type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f0.setAlt("修改显示模板");
  ...
  private boolean _jspx_meth_html_005fimg_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
          throws java.lang.Throwable {
    javax.servlet.jsp.PageContext pageContext = _jspx_page_context;
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  html:img
    ...
    try {
      ...
      _jspx_th_html_005fimg_005f1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_logic_005fiterate_005f0);
      // /eform/form.jsp(166,101) name = border type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f1.setBorder("0");
      // /eform/form.jsp(166,101) name = src type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f1.setSrc("/jsoa/images/del.gif");
      // /eform/form.jsp(166,101) name = alt type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
