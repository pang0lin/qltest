...
for(int i=0;i<list.size();i++){ 
	...
	<%
		...
		if (recordCount > WapUtil.LIMITED) {
			if (upIndex >= 0){
				upUrl = basePath+"/wap/action/WapContactAction.do?action=classList&id="+id+"&beginIndex="+upIndex+"&type="+type;
			...
			if (nextIndex < recordCount){
				nextUrl = basePath + upUrl=path+"/wap/action/WapContactAction.do?action=classList&id="+id+"&beginIndex="+upIndex+"&type="+type;
				if (null != keyword && !"".equals(keyword))
