...
public final class systemmanager_005frole_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String MANAGER="系统管理员";
String MANAGERBASE="普通管理员-基础管理";
String MANAGERAPP="普通管理员-扩展管理";
...
String roleDescription=request.getParameter("searchDesc");
if(roleName==null || "null".equals(roleName)){
   roleName="";
}
if(roleDescription==null || "null".equals(roleDescription)){
   roleDescription="";
}
String canUpdateIds=request.getAttribute("canUpdateIds")==null?"":request.getAttribute("canUpdateIds").toString();
...
if(request.getAttribute("shenhe")!=null){
    shenhe="onload=\"shenhe();\"";
}

            out.write("\r\n\r\n<body  class=\"MainFrameBox\" ");
            out.print(shenhe );
            out.write(">\r\n\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\" id=\"searchbar\" style=\"display:none\">\r\n  <form name=\"frm\" action=\"/jsoa/RoleAction.do\" method=\"get\">\r\n  \t<input type=\"hidden\" name=\"action\" value=\"search\">\r\n\t<tr>\r\n\t  <td width=\"20\" rowspan=\"2\" valign=\"top\"></td>\r\n\t  <td width=\"33%\">角色名称：\r\n\t\t  <input type=\"text\" class=\"inputtext\" name=\"searchName\" size=\"20\" value=\"");
            out.print(roleName);
            out.write("\">\r\n\t\t</td>\r\n\t\t<td width=\"33%\">角色描述：\r\n\t\t\t<input type=\"text\" class=\"inputtext\" name=\"searchDesc\" size=\"20\" value=\"");
            out.print(roleDescription);
            out.write("\">\r\n\t  </td>\r\n\t  <td width=\"28%\" align=\"right\"><button class=\"btnButton2Font\" onClick=\"search();\">查询</button>\r\n\t\t  <button class=\"btnButton2Font\" onClick=\"resetForm();\">重置</button></td>\r\n\t\t  <td width=\"16\">&nbsp;</td>\r\n\t</tr>\r\n  </form>\r\n</table>\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">  \r\n  <tr>\r\n    <td align=\"right\">    \r\n\t<button class=\"btnButton2Font\" onClick=\"JSMainWinOpen('/jsoa/RoleAction.do?action=add&pager.offset=");
            out.print(indexTmp);
            out.write("','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=560');\">新增</button>\r\n\t    <button class=\"btnButton2Font\" id=\"btnButton2FontShow\" onClick=\"showSearch();\">查询</button>\r\n    <button class=\"btnButton2Font\" id=\"btnButton2FontClose\" onClick=\"closeSearch();\" style=\"display:none\">关闭查询</button>\r\n\t\r\n\t<button class=\"btnButton2Font\" onClick=\"batchDelete();\">删除</button>\r\n\t</td>\r\n </tr>\r\n</table>\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n    ");
String url="/RoleAction.do?pager.offset="+indexTmp;
            out.write("\r\n\t ");
            //  html:form
            ...
            try {
              ...
              // /setup/systemmanager_role.jsp(87,2) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction(url);
              // /setup/systemmanager_role.jsp(87,2) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.print(indexTmp);
                  out.write("\">\r\n\t \r\n     <tr align=\"center\">\r\n\t\t<td  width=\"5%\" class=\"listTableHead\"><input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n\t\t<td class=\"listTableHead\" width=\"30%\">角色名称</td>\r\n\t\t<td class=\"listTableHead\" width=\"55%\">角色描述</td>\r\n\t\t<td class=\"listTableHeadLast\" width=\"10%\">处理</td>\r\n\t </tr>\r\n       ");
		...
		boolean canUpdate=false;
                  ...
                  try {
                    ...
                    // /setup/systemmanager_role.jsp(105,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("roleList");
                    // /setup/systemmanager_role.jsp(105,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		    ...
		    obj = (Object[]) roleList;
			index ++;
			roleId=Integer.parseInt(obj[0].toString());
			if(index%2 != 0){
				listClass="listTableLine2"; 
			}else{
				listClass="listTableLine1";
			}
			if((canUpdateIds.indexOf(","+obj[0].toString()+",")>=0) ||("1".equals(session.getAttribute("sysManager").toString()))){
			   canUpdate=true;
			}else{
				 canUpdate=false;
			}
                        ...
                        out.write('>');
if(canUpdate){
if(obj[1] != null && !obj[1].toString().equals(MANAGER) && !obj[1].toString().equals(MANAGERBASE) && !obj[1].toString().equals(MANAGERAPP)){
                        out.write("<input type=\"checkbox\" name=\"batchDeleteId\" value=\"");
                        out.print(obj[0]);
                        out.write('"');
                        out.write('>');
}else{
...
if(obj[1] != null && !obj[1].toString().equals(MANAGER) && !obj[1].toString().equals(MANAGERBASE) && !obj[1].toString().equals(MANAGERAPP)){
                        ...
                        out.write('"');
                        out.write('>');
                        out.print((obj[2]==null||obj[2].toString().equals(""))?"&nbsp":obj[2]);
                        out.write("</td>\r\n\r\n\t\t\t\t<td class=\"");
                        out.print(listClass);
...
if(canUpdate){
					if(obj[1] != null && !obj[1].toString().equals(MANAGER) && !obj[1].toString().equals(MANAGERBASE) && !obj[1].toString().equals(MANAGERAPP)){
                        ...
                        out.print(obj[0]);
                        out.write("','0');\" >&nbsp;<img src=\"images/del.gif\" alt=\"删除\" style=\"cursor:pointer\" onclick=\"deleteSingle('");
                        out.print(obj[0]);
                        out.write("');\" >\r\n\t\t\t\t\t");
}else{
                        out.write("\r\n\t\t\t\t\t<img src=\"images/modi.gif\" alt=\"修改\" style=\"cursor:pointer\" onclick=\"modify('");
...
String pagerURL = "/jsoa/RoleAction.do";
            out.write("\r\n\t ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\nfunction showSearch(){\r\n  document.getElementById(\"searchbar\").style.display=\"\";\r\n  document.getElementById(\"btnButton2FontShow\").style.display=\"none\";\r\n  document.getElementById(\"btnButton2FontClose\").style.display=\"\";\r\n}\r\nfunction closeSearch(){\r\n  document.getElementById(\"searchbar\").style.display=\"none\";\r\n  document.getElementById(\"btnButton2FontShow\").style.display=\"\";\r\n  document.getElementById(\"btnButton2FontClose\").style.display=\"none\";\r\n}\r\n\r\n\r\nfunction deleteSingle(id){\r\n    if(confirm(\"确实要删除该角色吗？\")){\r\n\twindow.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/RoleAction.do?pager.offset=");
      out.print(indexTmp);
      out.write("&action=deleteSingle&singleId=\"+id+'&searchName='+document.RoleActionForm.searchName.value+'&searchDesc='+document.RoleActionForm.searchDesc.value;\r\n    }\r\n}\r\n\r\nfunction batchDelete(){\r\n    if(checkboxIsChecked(document.all.batchDeleteId)){\r\n    \tif(confirm(\"确实要删除这些角色吗？\")){\r\n                document.RoleActionForm.action.value = \"batchDelete\";\r\n                RoleActionForm.submit();\r\n    \t}\r\n    }else{\r\n    \talert(\"请选择要删除的记录！\");\r\n    }\r\n\r\n}\r\n\r\nfunction deleteAll(){\r\n    if(confirm(\"确实要删除所有的角色吗？\")){\r\n        document.RoleActionForm.action.value = \"deleteAll\";\r\n        RoleActionForm.submit();\r\n    }\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDeleteId){\r\n        if(isNaN(document.all.batchDeleteId.length)){\r\n            document.all.batchDeleteId.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDeleteId.length;i++){\r\n                document.all.batchDeleteId[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\nfunction modify(id,sysRole){\r\n");
      out.write("    JSMainWinOpen('/jsoa/RoleAction.do?action=modify&modifyId='+id+'&sysRole='+sysRole+'&pager.offset='+'");
      out.print(indexTmp);
      out.write("&searchName='+document.RoleActionForm.searchName.value+'&searchDesc='+document.RoleActionForm.searchDesc.value,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=560')\r\n}\r\n\r\nfunction search(){\r\n    var roleName=document.frm.searchName.value;\r\n    var roleDescription=document.frm.searchDesc.value;\r\n    if(roleName.indexOf(\"'\")>=0){\r\n        alert(\"角色名称不合法,输入值不能包含:'!\");\r\n        document.frm.searchName.focus();\r\n     }else{\r\n     \t  if(roleDescription.indexOf(\"'\")>=0){\r\n\t\t        alert(\"角色描述不合法,输入值不能包含:'!\");\r\n\t\t        document.frm.searchDesc.focus();\r\n\t\t    }else{\r\n\t\t    \tdocument.frm.submit();\r\n\t\t    }\r\n     }\r\n}\r\n\r\nfunction resetForm(){\r\n\tdocument.frm.searchName.value=\"\";\r\n\tdocument.frm.searchDesc.value=\"\";\r\n\tdocument.frm.submit();\r\n}\r\nfunction shenhe(){\r\n    alert(\"数据已提交审计管理员审核！\");\r\n}\r\nfunction view(id,sysRole){\r\n\tJSMainWinOpen('/jsoa/RoleAction.do?action=modify&modifyId='+id+'&sysRole='+sysRole+'&pager.offset='+'");
      out.print(indexTmp);
      out.write("&viewrole=yes','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=560')\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
