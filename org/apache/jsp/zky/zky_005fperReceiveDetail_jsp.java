...
public final class zky_005fperReceiveDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(orderBy == null || !orderBy.equals("count")){
      ...
      out.write("\r\n                            </td>\r\n\t\t\t\t\t\t  <td class=\"listTableHead\"  width=\"8%\">单价&nbsp;&nbsp;\r\n\t\t\t\t\t\t  ");
if(orderBy == null || !orderBy.equals("price")){
      out.write("\r\n                            <img src=\"images/blanksort.gif\" style=\"cursor:pointer\" onclick=\"orderBy('price','desc');\" title=\"按单价降序排序\" />\r\n                            ");
}else if(orderBy.equals("price") && sortType.equals("desc")){
      out.write("\r\n                            <img src=\"images/downsort.gif\" style=\"cursor:pointer\" onclick=\"orderBy('price','asc');\" title=\"按单价升序排序\" />\r\n                            ");
}else if(orderBy.equals("price") && sortType.equals("asc")){
      out.write("\r\n                            <img src=\"images/upsort.gif\" style=\"cursor:pointer\" onclick=\"orderBy('price','desc');\" title=\"按单价降序排序\">\r\n                            ");
}
      out.write("\r\n                           </td>\r\n\t\t\t\t\t\t  <td class=\"listTableHead\"  width=\"10%\">药费&nbsp;&nbsp;\r\n\t\t\t\t\t\t  ");
...
Object[] obj; 
      ...
      try {
        ...
        // /zky/zky_perReceiveDetail.jsp(134,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("receiveDetail");
        // /zky/zky_perReceiveDetail.jsp(134,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("receiveDetail");
        // /zky/zky_perReceiveDetail.jsp(134,7) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setScope("request");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object receiveDetail = null;
          ...
          receiveDetail = (java.lang.Object) _jspx_page_context.findAttribute("receiveDetail");
          do {
            out.write("\r\n\t\t\t\t\t\t ");

						 	obj=(Object[])receiveDetail;
							index ++;
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\";\r\n}\r\n//导出excel\r\nfunction exportLog(){\t\r\n\twindow.location.href=\"/jsoa/ZkyMedicalAction.do?action=receiveDetail&export=perMedical_list_export&medicalName=");
      out.print(medicalName);
      out.write("&checkbox=");
      out.print(checkbox);
      out.write("&searchBeginDate=");
