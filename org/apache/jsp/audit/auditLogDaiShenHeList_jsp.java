...
public final class auditLogDaiShenHeList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if("1".equals(searchDate)){out.print("checked");}
        ...
        String startTime,endTime,rate;
            ...
            try {
              ...
              // /audit/auditLogDaiShenHeList.jsp(148,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("mylist");
              // /audit/auditLogDaiShenHeList.jsp(148,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
			...
			if("1".equals(obj[7].toString())||"3".equals(obj[7].toString())||"6".equals(obj[7].toString())||
			     ...
			     onclick = "JSMainWinOpen('"+obj[8]+obj[0]+"&disabled=disabled&comeflag=frame&pager.offset="+num+"','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=580')";
			     //onclick = "switchLog('"+obj[8]+obj[0]+"&disabled=disabled&pager.offset="+num+"');";
			}
			if("2".equals(obj[7].toString())){//群组审计
			     onclick = "approveAuditOrgGroup('"+obj[8]+obj[0]+"&disabled=disabled&pager.offset="+num+"');";
			}
			if("4".equals(obj[7].toString())){//IP审计
			     onclick = "approveAuditIp('"+obj[8]+obj[0]+"&disabled=disabled&pager.offset="+num+"');";
			}
			if("5".equals(obj[7].toString())){//门户审计
			     onclick = "approveAuditPortal('"+obj[8]+obj[0]+"&disabled=disabled&pager.offset="+num+"');";
			}
			if("7".equals(obj[7].toString())){//菜单审计
			     onclick = "approveAudit('"+obj[8]+obj[0]+"&disabled=disabled&pager.offset="+num+"');";
			}
			if("8".equals(obj[7].toString())){//扩展菜单审计
			     onclick = "approveAuditModuleMenu('"+obj[8]+obj[0]+"&disabled=disabled&pager.offset="+num+"');";
			}
                  ...
                  out.write("</td>\r\n               <td class=\"");
                  out.print(listClass);
                  out.write("\">\r\n               <img src=\"images/taskreport.gif\" title=\"审核\" style=\"cursor:pointer\" onclick=\"");
                  out.print(onclick );
                  out.write("\"  >\r\n               </td>\r\n           </tr>\r\n       ");
...
String range = session.getAttribute("browseRange")+"";
      out.write("\r\nfunction selectFZR(){\r\n   openEndow(\"fzrId\",\"fzrName\",document.all.fzrId.value,document.all.fzrName.value,\"user\",\"yes\",\"userorggroup\",\"");
      out.print(range);
