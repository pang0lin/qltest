...
public final class userLingdao_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for(int i=0;i<list.size();i++){
      ...
      out.write("\r\n\t\t\t</table></div>\r\n\t\t</div>\r\n\t\t<script type=\"text/javascript\">\r\n\t\tfunction showMore(orgId,empId,year,month,type,obj){\r\n\t\t\t//alert(orgId+\"  \"+type);\r\n\t\t\tvar value = obj.innerHTML;\r\n\t\t\tif(value==\"0\"){\r\n\t\t\t\talert(\"没有相关数据！\");\r\n\t\t\t}else{\r\n\t\t\t\twindow.open(\"/jsoa/kqShow.do?action=bmMore&userId=\"+empId+\"&year=\"+year+\"&month=\"+month+\"&orgId=\"+orgId+\"&type=\"+type);\r\n\t\t\t}\r\n\t\t}\r\n\t\tfunction searchData(){\r\n\t\t\tvar year = document.getElementById(\"year\").value;\r\n\t\t\tvar month = document.getElementById(\"month\").value;\r\n\t\t\tlocation.href = \"/jsoa/kqShow.do?action=lingdao&year=\"+year+\"&month=\"+month;\r\n\t\t}\r\n\t\t</script>\r\n\t</body>\r\n</html>\r\n");
