 ...
 * Generated at: 2023-01-06 10:04:07 UTC
...
public final class examinationStocklist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
		...
		queryStr = "&searchStyle="+searchStyle+"&searchType="+searchType+"&searchSubject="+searchSubject;

            out.write("\r\n<body  class=\"MainFrameBox\" onload=\"javascript:document.all.searchStyle.value='");
            out.print(searchStyle);
            out.write("';document.all.searchType.value='");
            out.print(searchType);
            out.write("';\" onKeyDown=\"if(event.keyCode==13) document.form2.submit();\">\r\n\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<table width=\"100%\" id=\"searchtable\"  style=\"display:none;\" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n       <form name=\"form2\" method=\"post\" action=\"/jsoa/ExaminationStockAction.do?action=list&sign=");
            out.print(sign);
            ...
            try {
              ...
              // /examination/examinationStocklist.jsp(79,36) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_logic_005fpresent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  try {
                    ...
                    // /examination/examinationStocklist.jsp(80,38) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("typeList");
                    // /examination/examinationStocklist.jsp(80,38) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            out.write("\" >\r\n                              </td>\r\n                                <td width=\"22%\" align=\"right\" rowspan=\"2\">\r\n                                  <input  type=\"button\"class=\"btnButton2Font\"  style=\"cursor:pointer\" onclick=\"javacript:form2.submit();\" value=\"查询\">\r\n                                  <input  type=\"button\"class=\"btnButton2Font\"  style=\"cursor:pointer\" onclick=\"window.location.href='/jsoa/ExaminationStockAction.do?action=list&sign=");
            out.print(sign);
            out.write("'\" value=\"重置\" >&nbsp;\r\n                              </td>\r\n                            </tr>\r\n                          </form>\r\n    </table>\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n  <tr>\r\n    <td  align=\"right\" nowrap>\r\n\t\t\t\t\t  <button class=\"btnButton2Font\" onclick=\"MM_openBrWindow('ExaminationStockAction.do?action=add&sign=");
            out.print(sign);
            out.write("','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=600,height=300')\"> 新增</button>\r\n\t\t\t\t\t\t<button class=\"btnButton2Font\" onclick=\"delBatch();\">删除</button>\r\n\t\t\t\t\t\t");
if(sign.equals("0")){
            out.write("\r\n\t\t\t\t\t\t<button class=\"btnButton7Font\" onclick=\"move();\">转移至考试题库</button>\r\n\t\t\t\t\t\t");
} else{ 
            out.write("\r\n\t\t\t\t\t\t<button class=\"btnButton7Font\" onclick=\"move();\">转移至自测题库</button>\r\n\t\t\t\t\t\t");
}
            out.write("\r\n\t\t\t\t\t\t<button id=\"hiddenSearch\"  class=\"btnButton4Font\" onClick=\"hidserch()\">查询</button>\r\n\t</td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n<form  name=\"form1\" method=\"post\">\r\n                      <tr align=\"center\">\r\n                        <td width=\"40\" height=\"27\" class=\"listTableHead\"><input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n                        <td width=\"8%\"  class=\"listTableHead\"> 类型<a href=\"javascript:orderby('/jsoa/ExaminationStockAction.do?action=list&sign=");
            out.print(sign);
            out.write("&styleOrder=");
            out.print(styleOrder);
            out.print(queryStr);
            out.write("')\">");
if(request.getParameter("styleOrder")==null){
            out.write("\r\n\t<img src=\"/jsoa/images/blanksort.gif\" border=\"0\" alt=\"按类型排序\">\r\n\t");
}else if("1".equals(styleOrder)){
            out.write("\r\n\t<img src=\"/jsoa/images/downsort.gif\" border=\"0\" alt=\"按类型排序\">\r\n\t");
}else if("0".equals(styleOrder)){
            out.write("\r\n\t<img src=\"/jsoa/images/upsort.gif\" border=\"0\" alt=\"按类型排序\">\r\n\t");
}
            out.write("</a> </td>\r\n\t\t\t\t\t\t<td width=\"15%\"   class=\"listTableHead\"> 分类<a href=\"javascript:orderby('/jsoa/ExaminationStockAction.do?action=list&sign=");
            out.print(sign);
            out.write("&typeOrder=");
            out.print(typeOrder);
            out.print(queryStr);
            out.write("')\">");
if(request.getParameter("typeOrder")==null){
            out.write("\r\n\t<img src=\"/jsoa/images/blanksort.gif\" border=\"0\" alt=\"按分类排序\">\r\n\t");
}else if("1".equals(typeOrder)){
            out.write("\r\n\t<img src=\"/jsoa/images/downsort.gif\" border=\"0\" alt=\"按分类排序\">\r\n\t");
}else if("0".equals(typeOrder)){
            out.write("\r\n\t<img src=\"/jsoa/images/upsort.gif\" border=\"0\" alt=\"按分类排序\">\r\n\t");
}
            out.write("</a> </td>\r\n\t\t\t\t\t\t<td   class=\"listTableHead\"> 题目 </td>\r\n                        <td width=\"8%\"  class=\"listTableHeadLast\" nowrap=\"nowrap\"> &nbsp;处理&nbsp; </td>\r\n                      </tr>\r\n\r\n                      ");
            ...
            try {
              ...
              // /examination/examinationStocklist.jsp(142,22) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setId("list");
              // /examination/examinationStocklist.jsp(142,22) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_logic_005fiterate_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  out.write("</a>&nbsp;</td>\r\n                          <td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\" align=\"left\" nowrap><img  style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" alt=\"修改\" onclick=\"modify('");
                  out.print(obj[0]);
