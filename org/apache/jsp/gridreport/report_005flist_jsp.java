...
String id = "";
if(request.getParameter("id")!=null) id="&id="+request.getParameter("id");
ManagerService managerBD = new ManagerService();
//判断是否有维护权限
boolean flag = managerBD.hasRight(session.getAttribute("userId").toString(), "09*09*02");
String operation = request.getAttribute("operation").toString();
//是否本分类的维护人员
boolean opr = request.getAttribute("opr")==null||"n".equals(request.getAttribute("opr").toString())?false:true;
...
String className = "listTableLine1";
			for(int i=0;i<list.size();i++){
				if(i%2==0){ className="listTableLine2";}
      ...
      out.print(className );
      out.write("\" align=\"left\">\r\n\t\t\t\t<span style=\"cursor:pointer;\" onclick=\"openURL('");
      out.print(obj[7].toString() );
      out.write("');\" title=\"预览报表\">");
...
if(flag){ 
      ...
      out.write(" listTableLineLastTD\"  nowrap align=\"center\">\r\n\t\t\t\t");
				...
				if(opr&&operation.contains(","+obj[0].toString()+",")){  
      out.write("\r\n\t\t\t\t<div align=\"left\">\r\n\t\t\t\t<img src=\"/jsoa/images/modi.gif\" title=\"修改\" style=\"cursor:pointer\" onclick=\"modify('");
      out.print(obj[0].toString() );
      out.write("')\" >&nbsp;\r\n\t\t\t\t");
if(!"2".equals(obj[6])){ 
      out.write("\r\n\t\t\t\t<img src=\"/jsoa/images/sq.gif\" title=\"修改模板\" style=\"cursor:pointer\" onclick=\"modiGrf('");
...
String pagerURL = "/jsoa/ReportAction.do";
      out.write("\r\n\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n<iframe name=\"myIframe\" style=\"display:none;\"></iframe>\r\n</body>\r\n<script language =\"javascript\">\r\nfunction modify(reportId){\r\n\topenURL(\"/jsoa/ReportAction.do?action=modi&reportId=\"+reportId+\"");
      out.print(id );
      out.write("\");\r\n}\r\nfunction del(reportId){\r\n\twindow.open(\"/jsoa/ReportAction.do?action=delete&reportId=\"+reportId+\",");
      out.print(id );
      out.write("\",\"myIframe\");\r\n}\r\nfunction showGrf(url){\r\n\topenURL(url);\r\n}\r\nfunction batchDel(){\r\n\twindow.open(\"/jsoa/ReportAction.do?action=delete&reportId=\"+getAllSelectIds()+\"");
      out.print(id );
      out.write("\",\"myIframe\");\r\n}\r\nfunction showSearch(obj){\r\n\tif(document.getElementById(\"searchbar\").style.display==\"none\"){\r\n\t\tdocument.getElementById(\"searchbar\").style.display=\"\";\r\n\t\tobj.value=\"关闭查询\";\r\n\t}else{\r\n\t\tdocument.getElementById(\"searchbar\").style.display=\"none\";\r\n\t\tobj.value=\"查询\";\r\n\t}\r\n}\r\nfunction modiGrf(grfName){\r\n\topenURL(\"/jsoa/gridreport/General/DesignReport.jsp?data=data/xmlData.jsp&report=\"+grfName);\r\n}\r\nfunction search(){\r\n\tlocation.href = \"/jsoa/ReportAction.do?action=list");
      out.print(id );
      out.write("&searchReportName=\"+document.getElementById(\"searchReportName\").value;\r\n}\r\nfunction searchClear(){\r\n\tdocument.getElementById(\"searchReportName\").value=\"\";\r\n}\r\n</SCRIPT>\r\n</html>\r\n<script src=\"/jsoa/js/util.js\"></script>");
