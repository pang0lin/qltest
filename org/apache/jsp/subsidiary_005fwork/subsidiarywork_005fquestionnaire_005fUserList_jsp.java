...
public final class subsidiarywork_005fquestionnaire_005fUserList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String read=request.getParameter("read");
      ...
      out.write("\r\n<title>");
      out.print(read.equals("1")?"已":"未");
      out.write("投票人员</title>\r\n<link href=\"/jsoa/skin/");
	...
	if(request.getAttribute("maxPageItems") !=null){
      ...
      out.write("\r\n<table width=\"100%\">\r\n    <tr>\r\n        <td>\r\n            <form name=\"form1\" method=\"POST\" action=\"/jsoa/QuestionnaireAction.do?action=viewbrowserUser&questionnaireId=");
      out.print(request.getParameter("questionnaireId"));
      out.write("&read=");
      out.print(read);
      out.write("\">\r\n            用户：\r\n            <input onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'用户')\" onblur=\"value=checkQuery1(this,'用户')\" type=\"text\" name=\"searchName\" class=\"inputText\" value=\"");
      out.print(request.getParameter("searchName")==null?"":request.getParameter("searchName"));
      out.write("\">\r\n\t\t\t<button class=\"btnButton2font\" onclick=\"form1.submit();\">查询</button>\r\n\t\t    <button class=\"btnButton2font\" onclick=\"window.location.href='/jsoa/QuestionnaireAction.do?action=viewbrowserUser&questionnaireId=");
      out.print(request.getParameter("questionnaireId"));
      out.write("&read=");
      out.print(read);
...
if("1".equals(read)){
      ...
      out.write("</td>\r\n    </tr>\r\n    <tr>\r\n        <td>\r\n            <table width=\"100%\" border=\"1\" cellpadding=\"1\" cellspacing=\"0\" bordercolor=\"#000000\" bordercolordark=\"#FFFFFF\">\r\n                ");
                ...
                Object[] obj = null;
                java.util.List list = (java.util.List) request.getAttribute("browserList");
                int j = 0;
...
if(read.equals("1")){
      out.write("<a style=\"cursor:pointer\" title=\"");
      out.print(new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format((Date)obj[3]));
      out.write('"');
      out.write('>');
      out.print(obj[0]);
      out.write("</a>");
      ...
      out.write("&nbsp;");
if(online){
      out.write("<img align=\"absbottom\" width=\"16\" height=\"16\" src=\"/jsoa/images/rtx/blank.gif\" onload=\"online('");
      out.print(obj[2]);
      out.write("');\">");
}
      out.write("</td>\r\n                    ");
