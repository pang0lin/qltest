 ...
 * Generated at: 2023-01-06 10:09:09 UTC
...
if(!"10".equals(status)){ 
        ...
        String term;
            ...
            try {
              ...
              // /cooperate/itemlist.jsp(141,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /cooperate/itemlist.jsp(141,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(!"10".equals(status)){ 
                  out.write("\r\n               <td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">\r\n               <img src=\"/jsoa/images/del.gif\" style=\"cursor:pointer\" onclick=\"delItem('");
                  out.print(obj[6]);
                  out.write("');\">\r\n               ");
if("1002".equals(status)){ 
                  out.write("\r\n               ");
 if("1".equals(com.js.util.config.SystemCommon.getUseArchives())){
                  out.write("\r\n               <img src=\"/jsoa/images/guidang2.gif\" style=\"cursor:pointer\" onclick=\"guidang('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
