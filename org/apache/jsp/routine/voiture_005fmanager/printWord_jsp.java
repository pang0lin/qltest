...
public final class printWord_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	request.setCharacterEncoding("GBK");
      ...
      out.write("\r\n<head>\r\n<title>车辆申请表</title>\r\n</head>\r\n<html>\r\n\t<body leftmargin=10 rightmargin=10>\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n\t\t<table id=\"print\" border=\"0\" width=\"90%\" cellpadding=\"0\" cellspacing=\"0\" style=\"display:\">\r\n\t\t\t<tr>\r\n\t\t\t\t<td align=\"right\">\r\n\t\t\t\t\t<input type=\"button\" name=\"prt\" value=\"打印\" onclick=\"_print();\">\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t</table>\r\n\t\t<center><h5>车辆申请</h5></center>\r\n\t\t<table width=\"80%\"  border=\"1\" align=\"center\" cellpadding=\"5\" cellspacing=\"0\" bordercolorlight=\"#000000\" bordercolordark=\"#FFFFFF\" style=\"font-size:11pt\">\r\n\t\t\t<tr align=\"left\">\r\n\t\t\t\t<td width=\"120\"><b>车辆名称</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tif(opener.document.getElementById(\"voitureName\")&&opener.document.getElementById(\"voitureName\").value!=''){\r\n\t\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"voitureName\").options[opener.document.getElementById(\"voitureName\").selectedIndex].text);\r\n\t\t\t\t\t\t}else if(opener.document.getElementById(\"voitureId\")&&opener.document.getElementById(\"voitureId\").options&&opener.document.getElementById(\"voitureId\").value!=''){\r\n");
      out.write("\t\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"voitureId\").options[opener.document.getElementById(\"voitureId\").selectedIndex].text);\r\n\t\t\t\t\t\t}else{\r\n\t\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"_aa\").innerHTML);\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t\t<td width=\"120\"><b>申请部门</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"orgName\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td><b>申请人</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"empName\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t\t<td><b>目的地</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"destination\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td><b>跟车人数</b></td>\r\n\t\t\t\t<td width=\"35%\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"personNum\").value);\r\n");
      out.write("\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t\t<td><b>司机</b></td>\r\n\t\t\t\t<td width=\"35%\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"motorMan\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td><b>用车人</b></td>\r\n\t\t\t\t<td colspan=\"3\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"ycr\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td><b>预计用车时间</b></td>\r\n\t\t\t\t<td colspan=\"3\"><script language=\"javascript\">\r\n\t\t\t\t\t\tvar startDate = opener.document.getElementById(\"startDate\").value;\r\n\t\t\t\t\t\tstartDate = startDate.replace(/\\//,'年');\r\n\t\t\t\t\t\tstartDate = startDate.replace(/\\//,'月');\r\n\t\t\t\t\t\tstartDate = startDate + '日';\r\n\t\t\t\t\t\tdocument.writeln(startDate);\r\n\t\t\t\t\t\tvar _s=opener.document.getElementById(\"startHour\").value;\r\n\t\t\t\t\t\tdocument.write(_s);\r\n\t\t\t\t\t\tdocument.write('时');\r\n\t\t\t\t\t\tvar _m = opener.document.getElementById(\"startMinute\").value;\r\n\t\t\t\t\t\t_m = _m + '分';\r\n\t\t\t\t\t\tdocument.writeln(_m);\r\n\t\t\t\t\t\tdocument.write(' 至 ');\r\n");
      out.write("\t\t\t\t\t\tvar endDate = opener.document.getElementById(\"endDate\").value;\r\n\t\t\t\t\t\tendDate = endDate.replace(/\\//,'年');\r\n\t\t\t\t\t\tendDate = endDate.replace(/\\//,'月');\r\n\t\t\t\t\t\tendDate = endDate + '日';\r\n\t\t\t\t\t\tdocument.writeln(startDate);\r\n\t\t\t\t\t\tvar _e=opener.document.getElementById(\"endHour\").value;\r\n\t\t\t\t\t\tdocument.write(_e);\r\n\t\t\t\t\t\tdocument.write('时');\r\n\t\t\t\t\t\tvar _em = opener.document.getElementById(\"endMinute\").value;\r\n\t\t\t\t\t\t_em = _em + '分';\r\n\t\t\t\t\t\tdocument.writeln(_em);\r\n\t\t\t\t\t</script>\r\n\t\t\t\t<br></td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td><b>用车类型</b></td>\r\n\t\t\t\t<td colspan=\"3\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tvar voitureStyle = opener.document.getElementsByName(\"voitureStyle\");\r\n\t\t\t\t\t\tfor(var i=0; i<voitureStyle.length; i++){\r\n\t\t\t\t\t\t\tif(i==0 && voitureStyle[i].checked){\r\n\t\t\t\t\t\t\t\tdocument.writeln('普通用车');\r\n\t\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\t\t}else if(i==1 && voitureStyle[i].checked){\r\n\t\t\t\t\t\t\t\tdocument.writeln('接待用车');\r\n\t\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\t\t}else if(i==2 && voitureStyle[i].checked){\r\n\t\t\t\t\t\t\t\tdocument.writeln('大型活动用车');\r\n\t\t\t\t\t\t\t\tbreak;\r\n");
      out.write("\t\t\t\t\t\t\t}else if(i==3 && voitureStyle[i].checked){\r\n\t\t\t\t\t\t\t\tdocument.writeln('其他用车');\r\n\t\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\t\t}\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr height=60>\r\n\t\t\t\t<td><b>事由</b></td>\r\n\t\t\t\t<td colspan=\"3\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"reason\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr height=60>\r\n\t\t\t\t<td><b>备注</b></td>\r\n\t\t\t\t<td colspan=\"3\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"remark\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t</table>\r\n\t\t");
...
//=request.getParameter("content")
      out.write("\r\n</td></tr></table>\r\n\t</body>\r\n</html>\r\n<script language=\"javascript\">\r\n\tfunction _print(){\r\n\t\tdocument.getElementById(\"print\").style.display=\"none\";\r\n\t\twindow.print();\r\n\t}\r\n    //document.all.newForm.innerHTML = opener.document.all.VoitureApplyActionForm.innerHTML;\r\n\t");
