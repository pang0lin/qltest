 ...
 * Generated at: 2023-01-06 09:50:52 UTC
...
public final class systemmanager_005fip_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(session.getAttribute("sysManager").toString().equals("1")){
		...
		String listClass="listTableLine1";
            ...
            try {
              ...
              // /setup/systemmanager_ip.jsp(66,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("ipList");
              // /setup/systemmanager_ip.jsp(66,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("ipList");
              // /setup/systemmanager_ip.jsp(66,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setScope("request");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object ipList = null;
                ...
                ipList = (java.lang.Object) _jspx_page_context.findAttribute("ipList");
                do {
                  out.write("\r\n\t\t");

		obj = (Object[]) ipList;
		index ++;
		ipAddr=obj[1].toString().split("\\.");
		if(index%2 != 0){
...
//=index
			  ...
			  for(i=0;i<4;i++){
				  out.print(Integer.parseInt(ipAddr[i].toString()));
				  if(i!=3) out.print(".");
			  }
		  out.print("至");
		  ipAddr=obj[2].toString().split("\\.");
		  for(i=0;i<4;i++){
			  out.print(Integer.parseInt(ipAddr[i].toString()));
			  if(i!=3) out.print(".");
		  }
                  ...
                  out.write('至');
                  out.write(' ');
                  out.print(obj[4].toString().substring(0,10));
                  out.write("</td>\r\n\t\t  ");

		  if(new Date().getTime()>((Date)obj[4]).getTime()+86399999){
			  ipIsOpen="过期";
		  }else{
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n\r\n<!--\r\nvar flag=\"");
      out.print(flag);
      out.write("\";\r\nif(\"foraudit\"==flag){\r\n\talert(\"数据已提交审核管理员审核！\");\r\n}\r\nfunction del(id){\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/ipAction.do?action=del&pager.offset=");
      out.print(offset1);
      ...
      out.print(offset1);
      out.write("&ids=\" + strId;\r\n    }else{\r\n        alert(\"请选择要开通的记录！\");\r\n        return;\r\n    }\r\n}\r\n\r\nfunction delBatch() {\r\n         var strId=getCheckBoxID();\r\n         if(strId!=\"\"){\r\n             if(confirm(\"确实要删除吗？\")){\r\n                 window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/ipAction.do?action=delBatch&pager.offset=");
      out.print(offset1);
      out.write("&ids=\" + strId;\r\n             }\r\n         }else{\r\n             alert(\"请选择要删除的记录！\");\r\n             return;\r\n         }\r\n}\r\nfunction delAll() {\r\n     if(confirm(\"确实要清空吗？\")){\r\n         window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/ipAction.do?action=delAll\";\r\n    }\r\n}\r\n\r\nfunction modify(id,beginTime,endTime,begineAddress,endAddress){\r\n\tJSMainWinOpen('ipAction.do?action=update&pager.offset=");
      out.print(offset1);
      out.write("&id='+id+'&beginTime='+beginTime+'&endTime='+endTime+'&begineAddress='+begineAddress+'&endAddress='+endAddress,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=668,height=450')\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n//-->\r\n</script>\r\n\r\n<script src=\"/jsoa/js/util.js\"></script>");
