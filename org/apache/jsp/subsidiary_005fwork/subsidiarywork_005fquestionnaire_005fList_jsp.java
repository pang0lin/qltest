 ...
 * Generated at: 2023-01-06 09:50:15 UTC
...
public final class subsidiarywork_005fquestionnaire_005fList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        list=request.getAttribute("vindicate")==null?null:(List)request.getAttribute("vindicate");
        
        list1=request.getAttribute("examineList")==null?null:(List)request.getAttribute("examineList");
	...
	java.util.Date newDate = new java.util.Date();
        ...
        if(request.getAttribute("isModiRight")!= null){
            ...
            try {
              ...
              // /subsidiary_work/subsidiarywork_questionnaire_List.jsp(108,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/QuestionnaireAction.do?action=questionnaireSearch");
              // /subsidiary_work/subsidiarywork_questionnaire_List.jsp(108,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n\t\t<tr>\r\n\t\t  <td width=\"20\" rowspan=\"2\" ></td>\r\n\t\t  <td colspan=\"\"> 标题：&nbsp;&nbsp;&nbsp;&nbsp; \r\n\t\t\t<input onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'标题')\" onblur=\"value=checkQuery1(this,'标题')\" name=\"searchTitle\" type=\"text\"  value=\"");
                  out.print(searchTitle);
                  out.write("\" maxlength=\"20\" size=\"20\" class=\"inputtext\"/>\r\n\t\t  </td>\r\n\t\t  <td> 状态：&nbsp;&nbsp;&nbsp;&nbsp;\r\n\t\t\t<select name=\"searchStatus\" style=\"width:105px\">\r\n\t\t\t\t<option value=\"2\">全部</option>\r\n\t\t\t\t<option value=\"1\" ");
...
if(request.getParameter("htrq") != null) out.print("checked");
                  out.write(">\r\n\t\t  </td>\r\n\t\t  <td align=\"right\" nowrap>\r\n\t\t      <input type=\"submit\" class=\"btnButton2font\" onClick=\"search();\" value=\"查询\"/>\r\n\t\t\t  <button  class=\"btnButton2Font\" onclick=\"cleared(); return false;\" style=\"cursor:pointer\">重置</button>\r\n\t\t  </td>\r\n\t\t</tr>\r\n\t");
 ...
 if(!"".equals(isAddRight) && "yes".equals(isAddRight)){
            out.write("\r\n\t   <button  class=\"btnButton2Font\"onclick=\"MM_openBrWindow('QuestionnaireAction.do?action=addQuestionnaireView','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=600,height=400')\"> 新增</button>");
}
            out.write("\r\n\t  ");
 if(!"".equals(isModiRight) && "yes".equals(isModiRight)){
	  ...
	  String isSearchValue = "0";
	  if(request.getParameter("isSearch") != null){
	  isSearchValue = request.getParameter("isSearch");
	  }
	  
            out.write("\r\n\t  <tr align=\"center\">\r\n\t\t<td width=\"40\" height=\"27\" class=\"listTableHead\" nowrap><input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n\t\t<td  class=\"listTableHead\"> 标题 </td>\r\n\t\t<td width=\"36%\" class=\"listTableHead\"> 可投票人范围 </td>\r\n\t\t<td width=\"8%\" class=\"listTableHead\"> 状态 </td>\r\n\t\t<td width=\"15%\" class=\"listTableHeadLast\" nowrap=\"nowrap\"> &nbsp;处理&nbsp; </td>\r\n\t  </tr>\r\n\r\n\t  ");
            ...
            try {
              ...
              // /subsidiary_work/subsidiarywork_questionnaire_List.jsp(186,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /subsidiary_work/subsidiarywork_questionnaire_List.jsp(186,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(!list.contains(obj[0])){
                  ...
                  out.write(" ></td>\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write("\"><a style=\"cursor:pointer\" href=\"javascript:preview('");
                  out.print(obj[0]);
                  out.write("')\">");
                  out.print(obj[1]);
                  out.write("</a>&nbsp;</td>\r\n\t\t  <td class=\"");
...
if( list.contains(obj[0])){
                  ...
                  out.write(',');
                  out.write('\'');
                  out.print(isSearchValue);
                  out.write("')\">&nbsp;<img style=\"cursor:pointer\" border=\"0\" src=\"images/del.gif\" title=\"删除\" onclick=\"del('");
                  out.print(obj[0]);
                  out.write("')\" >&nbsp;<img  style=\"cursor:pointer\" border=\"0\" src=\"images/sj.gif\"  height=\"15\" title=\"设计\" onclick=\"design('");
                  out.print(obj[0]);
                  out.write("')\">&nbsp;<img  style=\"cursor:pointer\" border=\"0\" src=\"images/tj.gif\" title=\"查询统计\" onclick=\"Statistic('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
                  out.print(obj[1]);
                  out.write("')\">&nbsp;<img style=\"cursor:pointer\" onclick=\"javascript:actorName('");
                  out.print(obj[0]);
                  out.write("','1','");
                  out.print(obj[1]);
                  out.write("')\" src=\"/jsoa/images/tpr.gif\" border=\"0\" title=\"答卷管理\" />");
}if( list1.contains(obj[0])){
                  out.write(" <img  style=\"cursor:pointer\" border=\"0\" src=\"images/konwledge_view.gif\" title=\"答卷\" onclick=\"answer('");
                  out.print(obj[0]);
                  out.write("')\" />");
}
                  out.write(" &nbsp;</td>\r\n\t  </tr>\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
 ...
 int deloff = j == 1?pageSize2 -15 :pageSize2;
    if(deloff < 0 ) deloff = 0 ;
            ...
            out.write("\r\n    if(confirm(\"确实要删除这则问卷吗？\")){\r\n    window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/QuestionnaireAction.do?action=deleteQuestionnaire&questionnaireId=\"+id+\"&pager.offset=");
            out.print(deloff);
            ...
            out.write("    window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/QuestionnaireAction.do?action=questionnaireListView\";\r\n    }\r\nfunction LY_ONKEYDOWN(){\r\n    if(event.keyCode == 13 ){\r\n    \tdocument.QuestionnaireActionForm.submit();\r\n    \t}\r\n    }\r\n    \r\nfunction actorName(id,grade,name){\r\n\r\n\r\n\tMM_openBrWindow('QuestionnaireAction.do?action=actorNameListView&questionnaireId='+id+'&grade='+grade+'&name='+name,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600')\r\n}    \r\nfunction hidserch()\r\n{    \r\n     var stable=document.getElementById(\"searchBar\");\r\n     var sbutton=document.getElementById(\"hiddenSearch\");\r\n     if(stable.style.display==\"none\")\r\n     {\r\n      stable.style.display=\"\";\r\n      sbutton.innerHTML=\"关闭查询\";\r\n      \r\n     }else{\r\n     stable.style.display=\"none\";\r\n     sbutton.innerHTML=\"查询\";\r\n     \r\n     }\r\n}\r\n//-->\r\n</script>\r\n");
