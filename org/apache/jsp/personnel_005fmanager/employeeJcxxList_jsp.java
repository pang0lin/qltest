...
public final class employeeJcxxList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
canAdd="0";
      ...
      out.write("<strong>奖惩信息：</strong></td>\r\n</tr>\r\n\r\n\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n");
 if(canAdd.equals("1")){
      out.write("\r\n\r\n<tr>\r\n<td align=\"center\" >\r\n<table width=\"96%\"\theight=\"22\"\tborder=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n\t<tr>\r\n\t  <td align=\"right\">\r\n\t\t  <button  class=\"btnButton2Font\" onClick=\"javascript:MM_openBrWindow('/jsoa/EmployeeJcxxAction.do?action=add&empID=");
      out.print(empID);
      out.write("&canAdd=");
      out.print(canAdd);
      out.write("','','scrollbars=yes,resizable=no,width=600,height=350')\">新增</button>\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n\r\n</td>\r\n</tr>\r\n");
}
      out.write("\r\n\r\n\r\n<tr>\r\n<td align=\"center\">\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<!-- LIST TITLE PART -->\r\n<table width=\"98%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"docBoxNoPanel\" style=\"border:1px solid #6ea2da;\">\r\n\t<form name=\"EmployeeJcxxActionForm\" method=\"post\" action=\"/jsoa/EmployeeJcxxAction.do\">\r\n\t\t<tr align=\"center\" bgcolor=\"#cfe6ff\">\r\n\t\t\t<td width=\"15%\" class=\"outRightLine1\" nowrap>获奖时间</td>\r\n\t\t\t<td class=\"outRightLine1\" width=\"20%\"> 奖项名称</td>\r\n\t\t\t<td class=\"outRightLine1\" > 获奖级别</td>\r\n\t\t\t<td class=\"outRightLine1\" width=\"10%\"> 获奖属性</td>\r\n\t\t\t<td class=\"outRightLine1\" width=\"15%\"> 惩罚时间 </td>\r\n\t\t\t<td class=\"outRightLine1\" width=\"20%\"> 惩罚名称</td>\r\n\t\t\t");
 if(canAdd.equals("1")){
      ...
      try {
        ...
        // /personnel_manager/employeeJcxxList.jsp(143,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("jcxxList");
        // /personnel_manager/employeeJcxxList.jsp(143,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("jcxxList");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object jcxxList = null;
          ...
          jcxxList = (java.lang.Object) _jspx_page_context.findAttribute("jcxxList");
          do {
            out.write("\r\n\t\t");

		  jcxxObj = (Object[]) jcxxList;
		  index ++;
...
if(index%2 != 0){listClass="listTableLine2";}
            ...
            out.print(jcxxObj[3]);
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\" style=\"word-break:break-all;\">");
            out.print(jcxxObj[4]==null?"&nbsp;":jcxxObj[4]);
            out.write("&nbsp;</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(jcxxObj[5]);
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(jcxxObj[6]);
...
if(!deleteSuccess.booleanValue()){
      ...
      out.write("\r\n</html>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction search(){\r\n    form2.submit();\r\n}\r\nfunction delSingle(id){\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=\"/jsoa/EmployeeJcxxAction.do?action=delete&jcxxId=\" + id+\"&empID=");
      out.print(empID);
      out.write("&open=");
      out.print(open);
      out.write("\" ;\r\n    }\r\n}\r\nfunction modify(id){\r\n    MM_openBrWindow('/jsoa/EmployeeJcxxAction.do?action=modify&jcxxId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=600,height=350')\r\n}\r\n\tfunction view(id){\r\n    MM_openBrWindow('/jsoa/EmployeeJcxxAction.do?action=view&jcxxId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
