...
public final class workAddressList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//} 
      ...
      try {
        ...
        // /personnel_manager/workAddressList.jsp(140,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("workAddressList");
        // /personnel_manager/workAddressList.jsp(140,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("workAddressList");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object workAddressList = null;
          ...
          workAddressList = (java.lang.Object) _jspx_page_context.findAttribute("workAddressList");
          do {
            out.write("\r\n\t\t");

		  workAddressObj = (Object[]) workAddressList;
		  index ++;
		  j++;
...
if(index%2 != 0){listClass="listTableLine2";}
            ...
            out.write("\" name=\"workAddressId\"></td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            ...
            out.write('"');
            out.write('>');
            out.print(workAddressObj[2]==null?"":workAddressObj[2]);
            out.write("&nbsp;</td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write('"');
            out.write('>');
            out.print(workAddressObj[4]==null?"":workAddressObj[4]);
            out.write("&nbsp;</td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write('"');
            out.write('>');
            out.print(workAddressObj[3]==null?"":workAddressObj[3]);
            out.write("&nbsp;</td>\r\n\t\t  <td class=\"");
            out.print(listClass);
...
String pagerURL = "/jsoa/WorkAddressAction.do";
      out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
   ...
   if(deloff<0) deloff = 0;
      ...
      out.write("\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=\"/jsoa/WorkAddressAction.do?flag=delete&workAddressId=\" + id + \"&pager.offset=");
      out.print(deloff);
      out.write("\";\r\n    }\r\n}\r\nfunction selectAll(obj){\r\n    if(document.all.workAddressId){\r\n        if(document.all.workAddressId.length){\r\n            for(var i = 0; i < document.all.workAddressId.length; i ++){\r\n                if(obj.checked){\r\n                    document.all.workAddressId[i].checked = true;\r\n                }else{\r\n                    document.all.workAddressId[i].checked = false;\r\n                }\r\n            }\r\n        }else{\r\n            if(obj.checked){\r\n                document.all.workAddressId.checked = true;\r\n            }else{\r\n                document.all.workAddressId.checked = false;\r\n            }\r\n        }\r\n    }\r\n}\r\nfunction batchDelete(){\r\n\r\n        if(checkboxIsChecked(document.all.workAddressId)){\r\n            var id = \"\";\r\n            if(document.all.workAddressId.length){\r\n                for(var i = 0; i < document.all.workAddressId.length; i ++){\r\n                    if(document.all.workAddressId[i].checked){\r\n                        id += document.all.workAddressId[i].value + \",\";\r\n");
      out.write("                    }\r\n                }\r\n            }else{\r\n                if(document.all.workAddressId.checked){\r\n                    id = document.all.workAddressId.value;\r\n                }\r\n            }\r\n            if(id.indexOf(\",\") > 0){\r\n                id = id.substring(0, id.length - 1);\r\n            }\r\n            if(confirm(\"确实要删除吗？\")){\r\n            window.location.href = \"/jsoa/WorkAddressAction.do?flag=delete&workAddressId=\" + id + \"");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("\";;\r\n            }\r\n        }else{\r\n            alert(\"请选择要删除的记录！\");\r\n        }\r\n}\r\n\r\nfunction modify(id){\r\n    MM_openBrWindow('/jsoa/WorkAddressAction.do?flag=modify&workAddressId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=600,height=350')\r\n}\r\n\tfunction view(id){\r\n    MM_openBrWindow('/jsoa/WorkAddressAction.do?flag=view&workAddressId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
