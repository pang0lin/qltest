 ...
 * Generated at: 2023-01-06 09:54:41 UTC
...
public final class receive_005fpress_jsp extends org.apache.jasper.runtime.HttpJspBase
...
SimpleDateFormat sDateFormat=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
  ...
  if(null == date_checked) date_checked = "false";
      ...
      out.write("\r\n\r\n\r\n<body class=\"MainFrameBox\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n\r\n<form action=\"\" name=\"frm\" method=\"post\">\r\n<table width=\"100%\" id=\"searchTable\" style=\"display:none\" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n<tr>\r\n    <td width=\"2%\" height=\"23\" align=\"left\" scope=\"col\" nowrap=\"nowrap\"></td>\r\n    <td width=\"9%\" height=\"23\" align=\"left\" scope=\"col\" nowrap=\"nowrap\">");
      out.print(Resource.getValue(local,"personalwork","pressmanage.title"));
      out.write("：</td>\r\n    <td width=\"24%\" scope=\"col\" align=\"left\"> <input name=\"title\" value=\"");
      out.print(page_title);
      out.write("\" maxlength=\"50\" class=\"inputText\" size=\"22\" onKeyDown=\"javascript:kdown(1)\"/></td>\r\n    <td width=\"7%\" scope=\"col\" align=\"left\" nowrap=\"nowrap\">&nbsp;");
      out.print(Resource.getValue(local,"personalwork","pressmanage.category"));
      out.write("：</td>\r\n    <td width=\"25%\" scope=\"col\" align=\"left\"><input name=\"category\" value=\"");
      out.print(page_category);
      out.write("\" maxlength=\"30\" class=\"inputText\" size=\"22\" onKeyDown=\"javascript:kdown(2)\"/></td>\r\n    <td width=\"7%\" scope=\"col\" align=\"left\" nowrap>");
      out.print(Resource.getValue(local,"personalwork","pressmanage.receiver"));
      out.write("：</td>\r\n    <td width=\"24%\" scope=\"col\" align=\"left\"><input name=\"receiver_name\" value=\"");
      out.print(page_receive);
      out.write("\" class=\"inputText\" size=\"22\" onKeyDown=\"javascript:kdown(3)\"/>\r\n    </td>\r\n\t<td width=\"2%\" height=\"23\" align=\"left\" scope=\"col\" nowrap=\"nowrap\"></td>\r\n  </tr>\r\n  <tr>\r\n    <td width=\"2%\" height=\"23\" align=\"left\" scope=\"col\" nowrap=\"nowrap\"></td>\r\n    <td nowrap=\"nowrap\">");
      out.print(Resource.getValue(local,"personalwork","pressmanage.soncategory"));
      out.write("：</td>\r\n    <td><input name=\"subcategory\" value=\"");
      out.print(page_subcategory);
      out.write("\" maxlength=\"50\" class=\"inputText\" size=\"22\" onKeyDown=\"javascript:kdown(4)\"/></td>\r\n    <td width=\"5%\" scope=\"col\" align=\"left\" nowrap=\"nowrap\">&nbsp;</td>\r\n    <td width=\"25%\"  align=\"left\">&nbsp;</td>\r\n    <td width=\"8%\"  align=\"left\">&nbsp;</td>\r\n    <td width=\"25%\"  align=\"left\">&nbsp;\r\n    </td>\r\n\t<td width=\"2%\" height=\"23\" align=\"left\" scope=\"col\" nowrap=\"nowrap\"></td>\r\n  </tr>\r\n  <tr>\r\n    <td width=\"2%\" height=\"23\" align=\"left\" scope=\"col\" nowrap=\"nowrap\"></td>\r\n  \t<td nowrap=\"nowrap\">");
      out.print(Resource.getValue(local,"personalwork","pressmanage.sendtime"));
      out.write("：</td>\r\n    <td colspan=\"4\">\r\n      <input  type=\"hidden\" name=\"date_start_hi\" value=\"");
      ...
      out.write("\r\n      <input  type=\"hidden\" name=\"date_end_hi\" value=\"");
 ...
 if("shandongjiguanshiwuju".equals(com.js.util.config.SystemCommon.getCustomerName())){ 
      ...
      out.write("\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n    \r\n    <div class=\"btnBQspace AlignLeft\"></div>\r\n     <div id=\"PanleDIV\" class=\"tabPanelSelected\" onClick=\"changePanle(this,'/jsoa/pressManageAction.do?action=receive_list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n         ");
 if("shandongjiguanshiwuju".equals(com.js.util.config.SystemCommon.getCustomerName())){ 
      ...
      out.write("</td>\r\n    <td scope=\"col\" align=\"center\" width=\"20%\" class=\"listTableHead\">接收时间</td>\r\n    <td scope=\"col\" align=\"center\" width=\"8%\" class=\"listTableHeadLast\">");
      ...
      out.write("</td>\r\n  </tr>\r\n\r\n  ");
			...
			Object[] tup = (Object[]) list4.get(i);
                        ...
                        String tmptitle = String.valueOf(tup[1]);
                        //tmptitle = tmptitle.replaceAll("&quot","'");
                        //tmptitle = tmptitle.replaceAll("&gt",">");
                        //tmptitle = tmptitle.replaceAll("&amp","&");
                        //tmptitle = tmptitle.replaceAll("&lt","<");
                        String tmpcategory = String.valueOf(tup[5]);
                        //tmpcategory = tmpcategory.replaceAll("&quot","'");
                        //tmpcategory = tmpcategory.replaceAll("&gt",">");
                        //tmpcategory = tmpcategory.replaceAll("&amp","&");
                        //tmpcategory = tmpcategory.replaceAll("&lt","<");
                        String tmpsubcategory = String.valueOf(tup[6]);
                        //tmpsubcategory = tmpsubcategory.replaceAll("&quot","'");
                        //tmpsubcategory = tmpsubcategory.replaceAll("&gt",">");
                        //tmpsubcategory = tmpsubcategory.replaceAll("&amp","&");
                        //tmpsubcategory = tmpsubcategory.replaceAll("&lt","<");
                        String tmpsender = String.valueOf(tup[3]);
                        //tmpsender = tmpsender.replaceAll("&quot","'");
                        //tmpsender = tmpsender.replaceAll("&gt",">");
                        //tmpsender = tmpsender.replaceAll("&amp","&");
                        //tmpsender = tmpsender.replaceAll("&lt","<");
                        int pressStatus  = Integer.parseInt(String.valueOf(tup[8]));
                        
                        String actionTime=String.valueOf(tup[9]);
                        
                        PressDealDoEJBBean pd=new PressDealDoEJBBean();
                        String flag="0";
                        if(tmpcategory!=null&&!tmpcategory.equals("null")){
      ...
      out.write('"');
      out.write('>');
      out.print((pressStatus==0)?"<font color='red'>":"");
      out.write(' ');
      out.write(' ');
      out.print(tmptitle);
      out.write(' ');
      out.print((pressStatus==0)?"</font>":"");
      out.write("</a> </td>\r\n\r\n    <td class=\"listTableLine");
      out.print(((tmp%2==0)?2:1));
      out.write('"');
      out.write('>');
      ...
      out.print((pressStatus==0)?"<font color='red'>":"");
//=tmpsender
      out.print(String.valueOf(tup[2]));
      out.write(' ');
      out.print((pressStatus==0)?"</font>":"");
      out.write("</td>\r\n    \r\n    <td class=\"listTableLine");
      out.print(((tmp%2==0)?2:1));
      ...
      out.print((pressStatus==0)?"<font color='red'>":"");
      out.write(' ');
      out.print(sDateFormat.format(sDateFormat.parse(actionTime)));
      out.write(' ');
      out.print((pressStatus==0)?"</font>":"");
      out.write("</td>\r\n    \r\n    <td nowrap=\"nowrap\" class=\"listTableLine");
      out.print(((tmp%2==0)?2:1));
      out.write(" listTableLineLastTD\">\r\n      <img title=\"");
      out.print(Resource.getValue(local,"common","comm.delete"));
      out.write("\" src=\"/jsoa/images/del.gif\"  style=\"cursor:pointer\" onClick=\"return del_receiverPress('");
      out.print(index);
      out.write('\'');
      out.write(',');
      out.write('\'');
      ...
      out.write(',');
      out.write('\'');
      out.print((Resource.getValue(local,"personalwork","pressmanage.deletetitleremind")+"： "+tmptitle+Resource.getValue(local,"personalwork","pressmanage.deletetitleremind2")));
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(tmp);
      ...
      out.write("\" src=\"/jsoa/images/wjbl.gif\" style=\"cursor:pointer\" onClick=\"return add_feedback('");
      out.print(tup[0]);
      out.write("')\"/>\r\n      </td>\r\n\r\n   </tr>\r\n\r\n  ");
 ++tmp; }
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n\r\n<p>&nbsp;</p>\r\n\r\n</td></tr></table>\r\n</body>\r\n</html>\r\n\r\n<script language=\"javascript\">\r\nfunction Myreset(){\r\n  document.frm.title.value=\"\";\r\n  document.frm.category.value=\"\";\r\n  document.frm.subcategory.value=\"\";\r\n  document.frm.receiver_name.value=\"\";\r\n  document.frm.check_date.checked = false;\r\n  this.location =\"/jsoa/pressManageAction.do?action=receive_list\";\r\n}\r\n\r\n\r\nfunction MM_openBrWindow(theURL,winName,features) { //v2.0\r\n  JSMainWinOpen(theURL,winName,features);\r\n}\r\n\r\nfunction  LookUp(){\r\n        if(document.frm.title.value.indexOf(\"'\")>-1){\r\n          alert(Personalwork.pressmanage_titleisillegality);\r\n          return false;\r\n\t}\r\n        if(document.frm.category.value.indexOf(\"'\")>-1){\r\n          alert(Personalwork.pressmanage_categoryisillegality);\r\n          document.frm.category.focus();\r\n          return false;\r\n\t}\r\n        if(document.frm.subcategory.value.indexOf(\"'\")>-1){\r\n          alert(Personalwork.pressmanage_soncategoryisillegality);\r\n          document.frm.subcategory.focus();\r\n");
      out.write("          return false;\r\n\t}\r\n        if(document.frm.receiver_name.value.indexOf(\"'\")>-1){\r\n          alert(Personalwork.pressmanage_senderisillegality);\r\n          document.frm.receiver_name.focus();\r\n          return false;\r\n\t}\r\n        if(document.all(\"checkbox\").checked == true) document.all(\"check_date\").value = 'true' ;\r\n        else document.all(\"check_date\").value = 'false' ;\r\n  \tdocument.frm.action = \"/jsoa/pressManageAction.do?action=receive_list\"; //&pager.offset=\r\n        document.frm.submit();\r\n        //this.location = \"/jsoa/pressManageAction.do?action=sender_list&pager.offset=&title=\"+document.frm.title.value+\"&&category=\"+document.frm.category.value+\"&subcategory=\"+document.frm.subcategory.value+\"&receiver_name=\"+document.frm.receiver_name.value+\"&date_start=\"+document.frm.send_date1.value+\"&date_end=\"+document.frm.send_date2.value;\r\n}\r\n\r\nfunction  del_receiverPress(offset,pressId,presstitle,rowId){  //删除接收到的反馈\r\nvar pageset =  offset ;\r\n  if(rowId == 0)  pageset = pageset - 15;\r\n  if(pageset < 0) pageset = 0;\r\n");
      out.write("if(confirm(presstitle))\r\n  this.location='/jsoa/pressManageAction.do?action=delete_receive_press&pager.offset='+pageset+'&pressId='+pressId+'&title='+document.frm.title.value+'&category='+document.frm.category.value+'&subcategory='+document.frm.subcategory.value+'&receiver_name='+document.frm.receiver_name.value+'&date_start='+document.frm.date_start_hi.value+'&date_end='+document.frm.date_end_hi.value+'&check_date='+document.frm.check_date.value;\r\nelse return false;\r\n}\r\n\r\nfunction  WinOpenWithoutMMC(url){ //\r\n  MM_openBrWindow(url,'','TOP=0,LEFT=0,scrollbars=no,resizable=no,width=600,height=360');\r\n}\r\n\r\nfunction  add_feedback(id){   //进入反馈一个催办\r\n  WinOpenWithoutMMC('/jsoa/press_feedback/feedback_add.jsp?pressId='+id);\r\n}\r\n\r\nfunction  getDisplayPress(id){\r\n  var url = '/jsoa/pressManageAction.do?action=goto_display_press&workflow=1&pressId='+id\r\n          +'&actType=receivePress'\r\n          +'&pager.offset=");
      out.print(index);
      out.write("'\r\n          +'&title='+document.frm.title.value\r\n          +'&category='+document.frm.category.value\r\n          +'&subcategory='+document.frm.subcategory.value\r\n          +'&receiver_name='+document.frm.receiver_name.value\r\n          +'&date_start='+document.frm.date_start_hi.value\r\n          +'&date_end='+document.frm.date_end_hi.value\r\n          +'&check_date='+document.frm.check_date.value;\r\n   WinOpenWithoutMMC(url);\r\n}\r\nfunction getDisplayBodyPress(id){\r\n\tvar url = '/jsoa/pressManageAction.do?action=goto_body_press&pressId='+id\r\n    +'&actType=receivePress';\r\n\tWinOpenWithoutMMC(url);\r\n}\r\nfunction  kdown(ss){\r\n  if (event.keyCode == 13){\r\n    if(ss == 1) LookUp();//document.frm.category.focus();\r\n    if(ss == 2) LookUp();//document.frm.receiver_name.focus();\r\n    if(ss == 3) LookUp();//document.frm.subcategory.focus();\r\n    if(ss == 4) LookUp();//document.frm.lookup.focus();\r\n  }\r\n}\r\n\r\nfunction test(str){\r\n  alert(str);\r\n}\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+cURL;\r\n");
