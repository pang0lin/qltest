...
public final class printWord_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	request.setCharacterEncoding("GBK");
      ...
      out.write("\r\n<html>\r\n<head>\r\n<title>会议室打印</title>\r\n\r\n</head>\r\n\t<body leftmargin=10 rightmargin=10>\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n\t\t<table id=\"print\" border=\"0\" width=\"90%\" cellpadding=\"0\" cellspacing=\"0\" style=\"display:\">\r\n\t\t\t<tr>\r\n\t\t\t\t<td align=\"right\">\r\n\t\t\t\t\t<input type=\"button\" name=\"prt\" value=\"打印\" onclick=\"_print();\">\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t</table>\r\n\t\t<center><h3>会议室申请</h3></center>\r\n\t\t<table width=\"80%\"  border=\"1\" align=\"center\" cellpadding=\"5\" cellspacing=\"0\" bordercolorlight=\"#000000\" bordercolordark=\"#FFFFFF\" style=\"font-size:11pt\">\r\n\t\t\t<tr align=\"left\">\r\n\t\t\t\t<td width=\"113\"><b>会议主题</b></td>\r\n\t\t\t\t<td colspan=\"3\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"motif\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t\r\n\t\t\t<tr>\r\n\t\t\t\t<td><b>主&nbsp;持&nbsp;人</b></td>\r\n\t\t\t\t<td width=\"35%\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"emceeName\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n");
      out.write("\t\t\t\t</td>\r\n\t\t\t\t<td norap><b>会议室名称</b></td>\r\n\t\t\t\t<td width=\"35%\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tvar boardroomId = opener.document.getElementById(\"boardroomId\").options[opener.document.getElementById(\"boardroomId\").selectedIndex].text;\r\n\t\t\t\t\t\tdocument.writeln(boardroomId);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td><b>时&nbsp;&nbsp;&nbsp;&nbsp;间</b></td>\r\n\t\t\t\t<td colspan=\"3\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tvar startDate = opener.document.getElementById(\"destineDate\").value;\r\n\t\t\t\t\t\tstartDate = startDate.replace(/\\//,'年');\r\n\t\t\t\t\t\tstartDate = startDate.replace(/\\//,'月');\r\n\t\t\t\t\t\tstartDate = startDate + '日';\r\n\t\t\t\t\t\tdocument.writeln(startDate);\r\n\t\t\t\t\t\tvar _s=opener.document.getElementById(\"startHour\").value;\r\n\t\t\t\t\t\tdocument.write(_s);\r\n\t\t\t\t\t\tdocument.write('时');\r\n\t\t\t\t\t\tvar _m = opener.document.getElementById(\"startMinutes\").value;\r\n\t\t\t\t\t\t_m = _m + '分';\r\n\t\t\t\t\t\tdocument.writeln(_m);\r\n\t\t\t\t\t\tdocument.write(' 至 ');\r\n\t\t\t\t\t\tvar _e=opener.document.getElementById(\"endHour\").value;\r\n\t\t\t\t\t\tdocument.write(_e);\r\n");
      out.write("\t\t\t\t\t\tdocument.write('时');\r\n\t\t\t\t\t\tvar _em = opener.document.getElementById(\"endMinutes\").value;\r\n\t\t\t\t\t\t_em = _em + '分';\r\n\t\t\t\t\t\tdocument.writeln(_em);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<script language=\"javascript\">\r\n\t\t\t\tif(opener.document.getElementById(\"points\") && opener.document.getElementById(\"maxNumber\").value != '0'){\r\n\t\t\t\t\tdocument.writeln('<tr>');\r\n\t\t\t\t\tdocument.writeln('<td><b>点数</b></td>');\r\n\t\t\t\t\tdocument.writeln('<td colspan=\"3\">');\r\n\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"points\").value + ' (该会议室最大支持'+opener.document.getElementById(\"maxNumber\").value+'点)');\r\n\t\t\t\t\tdocument.writeln('</td>');\r\n\t\t\t\t\tdocument.writeln('</tr>');\r\n\t\t\t\t}\r\n\t\t\t</script>\r\n\r\n\t\t\t<tr height=40>\r\n\t\t\t\t<td><b>出&nbsp;席&nbsp;人</b></td>\r\n\t\t\t\t<td colspan=\"3\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"attendee\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr height=40>\r\n\t\t\t\t<td><b>列&nbsp;席&nbsp;人</b></td>\r\n\t\t\t\t<td colspan=\"3\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n");
      out.write("\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"nonvoting\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td><b>会议类型</b></td>\r\n\t\t\t\t<td colspan=\"3\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tvar boardroomApplyType = opener.document.getElementById(\"boardroomApplyType\").options[opener.document.getElementById(\"boardroomApplyType\").selectedIndex].text;\r\n\t\t\t\t\t\tif(boardroomApplyType!='请选择'){\r\n\t\t\t\t\t\t\tdocument.writeln(boardroomApplyType);\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td><b>预&nbsp;定&nbsp;者</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"applyEmpName\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t\t<td  nowrap><b>预定部门</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"applyOrgName\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td nowrap><b>预定日期</b></td>\r\n\t\t\t\t<td><script language=\"javascript\">applyDate\r\n\t\t\t\t\t\tvar applyDate = opener.document.getElementById(\"applyDate\").value;\r\n");
      out.write("\t\t\t\t\t\tapplyDate = applyDate.replace(/\\//,'年');\r\n\t\t\t\t\t\tapplyDate = applyDate.replace(/\\//,'月');\r\n\t\t\t\t\t\tapplyDate = applyDate + '日';\r\n\t\t\t\t\t\tdocument.writeln(applyDate);\r\n\t\t\t\t\t</script>\r\n\t\t\t\t</td>\r\n\t\t\t\t<td><b>联系电话</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"linkTelephone\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td nowrap><b>出席领导</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"attendeeLeader\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t\t<td nowrap><b>会议记录人</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"notePerson\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr height=40>\r\n\t\t\t\t<td><b>会议议题</b></td>\r\n\t\t\t\t<td colspan=\"3\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"depict\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td nowrap><b>出席人数</b></td>\r\n");
      out.write("\t\t\t\t<td colspan=\"3\">\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tvar ren = \"\";\r\n\t\t\t\t\t\tvar chuxiren = opener.document.getElementById(\"attendee\").value;\r\n\t\t\t\t\t\tvar liexiren = opener.document.getElementById(\"nonvoting\").value;\r\n\t\t\t\t\t\tren = chuxiren +liexiren;\r\n\t\t\t\t\t\tdocument.write(ren.split(\",\").length-1);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<script language=\"javascript\">\r\n\t\t\t\tif(opener.document.getElementsByName(\"bdEquName\")){\r\n\r\n\t\t\t\t\tvar bdEquName=opener.document.getElementsByName(\"bdEquName\");\r\n\t\t\t\t\tvar bdEqu=opener.document.getElementsByName(\"bdEqu\");\r\n\t\t\t\t\tfor(var i=0; i<bdEquName.length; i++){\r\n\t\t\t\t\t\tif(i==0){\r\n\t\t\t\t\t\t\tdocument.writeln('<tr>');\r\n\t\t\t\t\t\t\tdocument.writeln('<td><b>会议设备</b></td>');\r\n\t\t\t\t\t\t\tdocument.writeln('<td colspan=\"3\">');\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t\tif(bdEqu[i].checked){\r\n\t\t\t\t\t\t\tdocument.write('<input type=\"checkbox\" name=\"bdEqu\" checked>');\r\n\t\t\t\t\t\t}else{\r\n\t\t\t\t\t\t\tdocument.write('<input type=\"checkbox\" name=\"bdEqu\">');\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t\tdocument.writeln(bdEquName[i].value+'&nbsp;&nbsp;');\r\n\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\tfor(var i=0; i<bdEquName.length; i++){\r\n\t\t\t\t\t\tif(i==0){\r\n\t\t\t\t\t\t\tdocument.writeln('</td>');\r\n\t\t\t\t\t\t\tdocument.writeln('</tr>');\r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t\t</script>\r\n\t\t\t<tr>\r\n\t\t\t <td colspan=\"4\">\r\n\t\t\t\t");

			if(request.getParameter("processId")!=null && !"".equals(request.getParameter("processId")) && !"null".equals(request.getParameter("processId"))){
...
//=request.getParameter("content")
      out.write("\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n</html>\r\n<script language=\"javascript\">\r\n\tfunction _print(){\r\n\t\tdocument.getElementById(\"print\").style.display=\"none\";\r\n\t\twindow.print();\r\n\t}\r\n    //document.all.newForm.innerHTML = opener.document.all.BoardRoomActionForm.innerHTML;\r\n\t");
