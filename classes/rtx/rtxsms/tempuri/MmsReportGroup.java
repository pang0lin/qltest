...
public class MmsReportGroup implements Serializable {
  private long mmsID;
  ...
  public MmsReportGroup(long mmsID, long status, String reportTime, String exStatus) {
    this.mmsID = mmsID;
    this.status = status;
  ...
  public synchronized boolean equals(Object obj) {
    if (!(obj instanceof MmsReportGroup))
      return false; 
  ...
  private static TypeDesc typeDesc = new TypeDesc(MmsReportGroup.class, true);
  
  static {
    typeDesc.setXmlType(new QName("http://tempuri.org/", "MmsReportGroup"));
