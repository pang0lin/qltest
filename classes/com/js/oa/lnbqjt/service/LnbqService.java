package com.js.oa.lnbqjt.service;
...
public class LnbqService {
  ...
  private ResultData updateDept(RwsOrganization org) {
    ...
    try {
      ...
      if (parent == null || "".equals(parent))
        parent = "0"; 
      Long long_ = vo.getOrgId();
      if (parent.equals(long_))
        parent = "0"; 
      vo.setOrgParentOrgId(Integer.valueOf(parent).intValue());
  ...
  private ResultData addEmployee(RwsPerson person) {
    ...
    try {
      ...
      String lastupdatestr = dtmt.format(lastupdate);
      vo.setLastupdate(lastupdatestr);
      String mwmm = "111111";
      ...
      if (flag == 0) {
        ...
        String empid = getEmpIdByGUID(person.getUuid(), "0");
        bd.regain(empid);
        result.setCode("0");
        result.setMessage("操作成功");
      } else {
  ...
  public void rwsTest() {
    String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><datas><data><id>201407250006</id><operation>INSERT</operation><type>person</type><uuid>b7336050-100d-4d97-bea7-9cbb6a83e025</uuid><newParentPath>.华丰集团.葵花仁油有限公司.总经理办公室</newParentPath><newParentUuid>e5a659b9-7ed3-4000-b8ab-45c06f831239</newParentUuid><utsNode><cn>201407250006</cn><sn>黄世杜</sn><employeesex>男</employeesex><userpasswordcipher /><employeemail>shenfenglan50@163.com</employeemail><employeemobile>13671022548</employeemobile><employeebirthday>1969/1/14 0:00:00</employeebirthday><employeestate>1</employeestate><employeeposition /><employeepositionjobcode /><employeepositionjobname /><lastmodifytime>2017-01-12 10:43:33</lastmodifytime></utsNode></data></datas>";
    System.out.println(xml);
    String result = "";
    result = (new LnbqService()).synchronizeDatas(xml);
