 ...
 * Generated at: 2023-01-06 09:57:36 UTC
...
public final class multiuploadfile_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if("add".equals(mode))
{
    ...
    if(tooBig){
      ...
      out.write("\";\r\n        var saveNames=\"");
      out.print(saveNames);
      out.write("\";\r\n        var obj=eval(\"opener.window.document.all.\"+parentTable);\r\n        obj.insertRow();\r\n        var rowNum=obj.rows.length-1;\r\n        var newNode=obj.rows(rowNum);\r\n        newNode.bgColor=\"#FFFFFF\";\r\n        newNode.id=\"newInsertedTrid\";\r\n        for(var i=0;i<2;i++)\r\n            newNode.insertCell();\r\n        obj.rows(rowNum).cells(0).innerText=\"");
      out.print(fileName);
      out.write("\";\r\n        obj.rows(rowNum).cells(0).id=\"A\"+rowNum;\r\n        obj.rows(rowNum).cells(1).innerHTML=\"<input type=\\\"hidden\\\" id=\\\"\"+saveNames+\"\\\" name=\\\"\"+saveNames+\"\\\" value='");
      out.print(saveName);
      out.write("'><a href='javascript:delaccessory(\\\"\"+rowNum+\"\\\",\\\"\"+parentTable+\"\\\",\\\"\"+path+\"\\\",\\\"\"+fileNames+\"\\\",\\\"\"+saveNames+\"\\\");'>\"\r\n        +\"<img src='/jsoa/images/del.gif' alt='删除' border='0'></a>\"\r\n        +\"<input type=\\\"hidden\\\" id=\\\"\"+fileNames+\"\\\" name=\\\"\"+fileNames+\"\\\" value='");
      out.print(fileName);
      ...
      out.print(tableName);
      out.write("')\">\r\n<br>\r\n<div align=\"center\"><P><font color=\"#3366CC\">请选择要上传的文件</font></p></div>\r\n<TABLE width=\"80%\" align=\"center\" border=0>\r\n<CENTER>\r\n<FORM ENCTYPE = \"multipart/form-data\" NAME =\"frm\" ACTION = \"multiuploadfile.jsp?path=");
      out.print(path);
