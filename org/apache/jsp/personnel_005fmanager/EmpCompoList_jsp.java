...
public final class EmpCompoList_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write(".css\" rel=\"stylesheet\" type=\"text/css\" />\r\n<script\tsrc=\"js/js.js\" language=\"javascript\"></script>\r\n<!--  STYLE\tCHANGE START -->\r\n\r\n<script language=\"JavaScript\" type=\"text/JavaScript\">\r\n<!--\r\nfunction MM_openBrWindow(theURL,winName,features) { //v2.0\r\n  JSMainWinOpen(theURL,winName,features);\r\n}\r\ndocument.onkeydown=look;\r\nfunction look(){\r\n\tif(event.keyCode==13){\r\n\t\tsearch();\r\n\t}\r\n}\r\n//-->\r\n</script>\r\n<script language=\"JavaScript\" src=\"js/date0.js\"></script>\r\n</head>\r\n\r\n<body  class=\"MainFrameBox\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<!-- SEARCH\tPART -->\r\n<table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n\t<form action=\"/jsoa/EmpCompoAction.do?action=list\" name=\"form1\" method=\"post\">\r\n\t\t<tr>\r\n\t\t\t<td width=\"40%\" nowrap=\"nowrap\">\r\n\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;事故人：&nbsp;&nbsp;\r\n\t\t\t\t<input type=\"text\" name=\"empName\" value=\"");
            out.print(request.getAttribute("empName")!=null?request.getAttribute("empName"):"");
            out.write("\" size=\"20\" maxlength=\"100\" class=\"inputtext\"/>\r\n\t\t\t</td>\r\n\t\t\t<td nowrap=\"nowrap\">\r\n\t\t\t\t事故：\r\n\t\t\t\t<input type=\"text\" name=\"accident\" value=\"");
            out.print(request.getAttribute("accident")!=null?request.getAttribute("accident"):"");
            out.write("\" size=\"20\" maxlength=\"100\" class=\"inputtext\"/>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\t\t");

			Date s_date = new Date();
			String s_year = String.valueOf(s_date.getYear()+1900);
			String s_month = String.valueOf(s_date.getMonth()+1);
			String s_day = String.valueOf(s_date.getDate());

			Date e_date = new Date();
			String e_year = String.valueOf(e_date.getYear()+1900);
			String e_month = String.valueOf(e_date.getMonth()+1);
			String e_day = String.valueOf(e_date.getDate());

			String sDate = request.getAttribute("start_date")!=null?request.getAttribute("start_date").toString():null;
			if(sDate!=null){
				s_year = sDate.substring(0, sDate.indexOf("/"));
				s_month = sDate.substring(sDate.indexOf("/")+1, sDate.lastIndexOf("/"));
				s_day = sDate.substring(sDate.lastIndexOf("/")+1);

				String eDate = request.getAttribute("end_date").toString();
				e_year = eDate.substring(0, eDate.indexOf("/"));
				e_month = eDate.substring(eDate.indexOf("/")+1, eDate.lastIndexOf("/"));
				e_day = eDate.substring(eDate.lastIndexOf("/")+1);
			}
		...
		String listClass="listTableLine1";
            ...
            try {
              ...
              // /personnel_manager/EmpCompoList.jsp(142,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /personnel_manager/EmpCompoList.jsp(142,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /personnel_manager/EmpCompoList.jsp(142,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		listClass = index%2!=0?"listTableLine2":"listTableLine1";
                  ...
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">\r\n\t\t\t<img style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" alt=\"修改\" onclick=\"MM_openBrWindow('/jsoa/EmpCompoAction.do?action=load&id=");
                  out.print(obj[0]);
                  out.write("&pager.offset=");
                  out.print(offset1);
                  out.write("','','TOP=0,LEFT=0, resizable=yes,width=800,height=600')\" ><img style=\"cursor:pointer\" border=\"0\" src=\"images/del.gif\" alt=\"删除\" onclick=\"del('");
                  out.print(obj[0]);
                  out.write("')\" >&nbsp;\r\n\t\t</td>\r\n\t  </tr>\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
     ...
     deloffset = deloffset < 0 ? 0 : deloffset ;
      ...
      out.write("\tform1.action = \"/jsoa/EmpCompoAction.do?action=export\";\r\n\tform1.submit();\r\n\tform1.action = \"/jsoa/EmpCompoAction.do?action=list\";\r\n}\r\n//-->\r\n</script>\r\n");
