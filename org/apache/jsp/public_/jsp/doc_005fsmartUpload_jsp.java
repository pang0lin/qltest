...
public final class doc_005fsmartUpload_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try{
	accessoryIndex=Integer.parseInt(request.getParameter("accessoryIndex"));
}catch(Exception ex){
	ex.printStackTrace();
}
...
if("add".equals(mode))
{
    ...
    for (int j=0;j<fileList.size();j++)
    {
        ...
        {
        	accessoryIndex++;       
        	fileName=accessoryIndex+"."+fileName.substring(fileName.lastIndexOf("\\") + 1);
...
break;}else{ 
	...
	String baseURL=com.js.util.util.BASE64.BASE64EncoderNoBR("FileName="+saveName+"&name="+fileName+"&documentOpen=1&path="+path+"&edit=1");	
      ...
      out.write("\r\n        var fileNameTemp=\"");
      out.print(fileName);
      out.write("\";            \r\n        opener.window.document.all._accessoryIndex.value=\"");
      out.print(accessoryIndex);
      out.write("\";\r\n        opener.window.document.all.");
      out.print(tableName);
      out.write("_tr.style.display = \"\";\r\n        var fileInnerHTML= \"<div id=\\\"sp_");
      out.print(saveName.substring(0, saveName.indexOf(".")));
      out.write("\\\" style=\\\"color:blue;cursor:pointer\\\" \";\r\n        ");
if(saveName.toLowerCase().endsWith(".doc") || saveName.toLowerCase().endsWith(".xls")){
      out.write("\r\n        fileInnerHTML+=\"onclick=\\\"window.open('/jsoa/iWebOfficeSign/showView.jsp?");
      out.print(baseURL);
      out.write("');\\\">\";\r\n        ");
}else{
      out.write("\r\n        fileInnerHTML+=\"onclick=\\\"document.delFile.location.replace='/jsoa/download.jsp?");
      out.print(baseURL);
      out.write("';\\\">\";\r\n        ");
}
      out.write("\r\n                \r\n        fileInnerHTML+=\"<img src=/jsoa/images/fj2.gif align=absmiddle>\" + fileNameTemp\r\n        +\"<input type=\\\"hidden\\\" id=\"+saveNames+\" name=\"+saveNames+\" value='");
      out.print(saveName);
