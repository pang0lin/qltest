...
public final class equipmentTypeList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
            ...
            out.write("申请流程</div>\r\n\t        <div class=\"tabPanelRight\"></div>      \r\n\t      </div>\r\n\t      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t      <div id=\"PanleDIV\"  class=\"tabPanelSelected\" onClick=\"changePanle(this,'/jsoa/EquipmentAction.do?action=equipmentTypeView');\">\r\n\t        <div class=\"tabPanelLeft\"></div>\r\n\t        <div class=\"tabPanelCenter\">");
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
            out.write('设');
            out.write('备');
}else{
...
if(request.getAttribute("noAddRight") == null){
            out.write("\r\n\t\t\t\t\t  <button class=\"btnButton2Font\" onclick=\"MM_openBrWindow('EquipmentAction.do?action=addEquipmentTypeView','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=600,height=300')\"> 新增</button>\r\n\t\t\t\t\t\t");
            ...
            try {
              ...
              // /routine/equipment/equipmentTypeList.jsp(79,22) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /routine/equipment/equipmentTypeList.jsp(79,22) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
