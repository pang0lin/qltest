...
public class GovSendFileLoadForRWSAction extends Action {
  public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse httpServletResponse) {
    ...
    if ("load".equals(action)) {
      ...
      if (activity != null && !"".equals(activity) && !"0".equals(activity)) {
    ...
    forward.setPath("/jsoa/doc/doc/doc_sendfile_modiForRWS.jsp");
    return forward;
  }
