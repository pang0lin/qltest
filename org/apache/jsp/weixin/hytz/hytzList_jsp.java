...
public final class hytzList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String type = null!=request.getAttribute("type") ? request.getAttribute("type").toString() : "day";
...
if("day".equals(type)){ 
      ...
      out.write("\r\n\t\t<SCRIPT language=JavaScript>\r\n\t\tfunction gotoPage(url, flag){\r\n\t\t    if(flag){\r\n\t\t        location.href=encodeURI(url);\r\n\t\t    }\r\n\t\t}\r\n\t\t\r\n\t\tfunction submitForm(){\r\n\t\t\tvar k = document.getElementById(\"keys\").value;\r\n\t\t\tif(\"\" != k){\r\n\t\t\t\tk = encodeURI(k);\r\n\t\t\t}\r\n\t\t\tdocument.getElementById(\"keyword\").value = k;\r\n\t\t\tdocument.getElementById(\"searchForm\").submit();\r\n\t\t}\r\n\t\t</SCRIPT>\r\n\t</HEAD>\r\n\t<BODY  onload=\"setHeader('javascript:closeWindow(\\'hytz\\')', '");
if("day".equals(type)){ 
      out.write("今日会议");
}else{
      out.write(" 全部会议 ");
}
      out.write("');\">\r\n\t\t<!-- 搜索 -->\r\n\t   \t<FORM id=\"searchForm\" action=\"/jsoa/weiXinHytzAction.do?action=list&initsort=2&type=");
      out.print(type);
      ...
      out.print(path);
      out.write("/weixin/hytz/hytzInfo.jsp?boardroomApplyId=");
      out.print(obj[0]);
      out.write("&type=");
      out.print(type);
      ...
      out.write("\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t\t\r\n\t\t\r\n\t\t <!-- 分页 -->\r\n\t\t");
		...
		if (size > WapUtil.LIMITED) {
			if (upIndex >= 0){
				upUrl = path + "/weiXinHytzAction.do?action=list&initsort=2&type="+type+"&beginIndex=" + upIndex;
			...
			if (nextIndex < size){
				nextUrl = path + "/weiXinHytzAction.do?action=list&initsort=2&type="+type+"&beginIndex=" + nextIndex;
				if (null != keyword && !"".equals(keyword))
