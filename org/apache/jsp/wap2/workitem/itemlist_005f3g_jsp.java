...
public final class itemlist_005f3g_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(list!=null&&list.size()>0){ 
	...
	if(mainURL.indexOf("BodyAction.do")>-1){
		...
		mainURL=app+"/WapCoopAction.do?action=toDealwith&amp;"+mainURL+"&amp;status=10&amp;comeFrom=1&amp;type=workdealwith&amp;beginIndex="+beginIndex;
	}else{
		mainURL=app+"/wap2/workitem/item_info_3g.jsp?workId="+obj[10]+"&amp;beginIndex="+beginIndex+"&amp;status="+status+showDoc;
	}
...
if(upIndex>=0)upUrl=app+"/WorkDealWithAction.do?action=list&amp;status="+status+"&amp;beginIndex="+upIndex+showDoc;
if(nextIndex<recordCount)nextUrl=app+"/WorkDealWithAction.do?action=list&amp;status="+status+"&amp;beginIndex="+nextIndex+showDoc;
