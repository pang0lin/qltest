...
public final class msHistoryListStatus_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\r\n\t\t<tr>\r\n\t\t\t<td width=\"2%\" ></td> \r\n\t\t\t<td width=\"8%\"  height=\"28\" nowrap>发送人：</td>\r\n\t\t\t<td width=\"20%\"><input type=\"text\" class=\"inputText\" name=\"fromUser\" value=\"");
            out.print(fromUser);
            out.write("\"/></td>\r\n\t\t\t<td width=\"8%\"  nowrap align=right>发送部门：</td>\r\n\t\t\t<td width=\"20%\"><input type=\"text\" class=\"inputText\" name=\"fromOrg\" value=\"");
            out.print(fromOrg);
            out.write("\"/></td>\t\r\n\t\t\t<td width=\"8%\"  height=\"28\" nowrap>接收人：</td>\r\n\t\t\t<td width=\"20%\"><input type=\"text\" class=\"inputText\" name=\"sendToPerson\" value=\"");
            out.print(sendToPerson);
            ...
            out.write(',');
            out.print(e_day);
            out.write(");\t\t\t  \r\n\t\t\t  </script><input type=\"checkbox\" name=\"searchDate\" value=\"1\">\r\n\t\t\t</td>\r\n\t\t\t<td width=\"8%\"  nowrap align=right>发送内容：</td>\r\n\t\t\t<td width=\"20%\"><input type=\"text\" class=\"inputText\" name=\"fromContent\" value=\"");
            out.print(fromContent);
            out.write("\"/></td>\t\r\n\t\t\t<td colspan=\"2\">&nbsp;</td>\r\n\t\t\t<td align=\"right\">\r\n\t\t\t\t<input type=\"button\" class=\"btnButton4Font\" onClick=\"search();\" style=\"cursor:pointer\" value=\"查询\"/>\r\n\t\t\t\t<input type=\"button\" class=\"btnButton2Font\" onClick=\"clearr();\" style=\"cursor:pointer\" value=\"重置\"/>\r\n\t\t\t</td>\r\n\t\t   <td width=\"12\" ></td> \r\n\t\t</tr>\r\n\t           \r\n</table>\r\n</form> \r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"inlineBottomLine\">\r\n  \r\n  <tr> \r\n     <td align=\"right\" nowrap>\r\n\t\t<input type=\"button\" id=\"hiddenSearch\"  class=\"btnButton4Font\" onClick=\"hidserch()\" value=\"查询\"/>\r\n\t </td>\r\n  \r\n  </tr>\r\n  \r\n</table>\r\n\r\n<div id=\"docinfo0\" name=\"docinfo0\">\r\n\r\n   <table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n         <tr >\r\n           <td class=\"listTableHead\" width=\"80\" >发送人</td>\r\n           <td class=\"listTableHead\" width=\"200\" nowrap >发送部门</td>\r\n           <td class=\"listTableHead\" width=\"120\" nowrap >接收人</td>\r\n           <td class=\"listTableHead\" width=\"120\" nowrap >接收号码</td>\r\n");
            out.write("           <td class=\"listTableHead\"  nowrap >短信内容</td>\r\n           <td width=\"170\" class=\"listTableHead\" nowrap >发送时间</td>\r\n           <td class=\"listTableHead\" width=\"100\" nowrap >状态</td>\r\n           <td class=\"listTableHead\" width=\"250\" nowrap >回复短信内容</td>\r\n         </tr>   \r\n         \r\n         ");
    ...
    //    String msgContent=null;
    	  String sendTime=null;
            ...
            try {
              ...
              // /message/msHistoryListStatus.jsp(159,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("mylist");
              // /message/msHistoryListStatus.jsp(159,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
           ...
           SimpleDateFormat dateFormat = new SimpleDateFormat( "yyyy-MM-dd HH:mm:ss");
			...
			if(sendTime==null){
				sendTime=(String)dateFormat.format(obj[4]);
			}else{
				if(sendTime.equals(dateFormat.format(obj[4]))){
					obj[1]="";
					obj[2]="";
				}else{
					sendTime=(String)dateFormat.format(obj[4]);
			...
			//SimpleDateFormat dateFormat = new SimpleDateFormat( "yyyy-MM-dd HH:mm:ss");
			String time=dateFormat.format(obj[4]);
			String s = "<font color='red'>发送失败</font>";
			if("1".equals(obj[6]+"")||"4000".equals(obj[6]+"")){
				s = "发送成功";
			}else if("0".equals(obj[6]+"")){
				//s= "已发送到mas机";
				s= "已发送";
			}else if("1000".equals(obj[6]+"") || "3000".equals(obj[6]+"")){
				s= "准备发送";
			}
                  ...
                  out.write('"');
                  out.write('>');
                  out.print("null".equalsIgnoreCase(obj[9]+"")?"":obj[9]  );
                  out.write("&nbsp;</td>\r\n               <td class=\"");
                  out.print(listClass);
                  out.write("\" title='");
                  out.print("null".equalsIgnoreCase(obj[5]+"")?"":obj[5]  );
                  out.write('\'');
                  out.write('>');
                  out.print("null".equalsIgnoreCase(obj[5]+"")?"":obj[5]  );
                  out.write("&nbsp;</td>\r\n               <td class=\"");
                  ...
                  out.print(listClass);
                  out.write("\" title='");
                  out.print("null".equalsIgnoreCase(obj[7]+"")?"":obj[7]  );
                  out.write('\'');
                  out.write('>');
                  out.print("null".equalsIgnoreCase(obj[7]+"")?"":obj[7]  );
                  out.write("&nbsp;</td>\r\n           </tr>\r\n       ");
...
String pagerURL = "/jsoa//MsHistoryAction.do";
            out.write("\r\n\t\t\t");
