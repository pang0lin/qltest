 ...
 * Generated at: 2023-01-06 10:06:29 UTC
...
public final class ftaxlist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if("1".equals(searchTime)){out.print("checked");}
	    ...
	    if("1".equals(canEidt)){
            ...
            out.write("\r\n      \t<input type=\"button\" class=\"btnButton2font\" onClick=\"javascript:uploadtemplate(9,2);\" value=\"导入\"/>\r\n      \t<input type=\"button\" class=\"btnButton2font\" onClick=\"javascript:downloadtemplate(9);\" value=\"下载模版\"/>\r\n      \t\t");
            ...
            try {
              ...
              // /finance/ftax/ftaxlist.jsp(122,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/oaSysRemindAction");
              // /finance/ftax/ftaxlist.jsp(122,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if(null!=showList&&showList.size()>0){ 
			for(int i=0;i<showList.size();i++){
				Object obj[]=(Object[])showList.get(i);
                  ...
                  out.write("\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\"  width=\"15%\">录入时间</td>\r\n\t\t<td width=\"10%\"  class=\"listTableHead\"  id=\"tdWidth\">操作</td>\r\n  </tr>\r\n  ");
...
String pagerURL = "/jsoa/fTaxAction.do";
            out.write("\r\n\t\t\t\t\t\t\t\t\t");
