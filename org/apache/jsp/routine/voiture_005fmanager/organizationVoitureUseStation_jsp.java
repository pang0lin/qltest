 ...
 * Generated at: 2023-01-06 09:47:41 UTC
...
public final class organizationVoitureUseStation_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String tmpNow=(now.getYear()+1900)+"-"+(now.getMonth()+1)+"-"+now.getDate();
            ...
            try {
              ...
              // /routine/voiture_manager/organizationVoitureUseStation.jsp(75,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("organizationVoitureUseStationList");
              // /routine/voiture_manager/organizationVoitureUseStation.jsp(75,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("organizationVoitureUseStationList");
              // /routine/voiture_manager/organizationVoitureUseStation.jsp(75,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setScope("request");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object organizationVoitureUseStationList = null;
                ...
                organizationVoitureUseStationList = (java.lang.Object) _jspx_page_context.findAttribute("organizationVoitureUseStationList");
                do {
                  out.write("\r\n     \t\t     \t ");

                        Object[] obj = (Object[])organizationVoitureUseStationList;
                  ...
                  out.write("\r\n                          ");
                          ...
                          if(obj[0]!=null){
							  ...
							  if(obj[2]!=null)
							  sendStartKilo=Double.parseDouble(obj[2].toString());
							  if(obj[3]!=null)
							  sendEndKilo=Double.parseDouble(obj[3].toString());
							  oneTotalKilo=sendEndKilo-sendStartKilo;
							  totalKilo+=oneTotalKilo;

							  if(obj[4]!=null)
							  kiloPrice=Double.parseDouble(obj[4].toString());
							 ...
							 if(obj[5]!=null)
							  sendStartTime=                    Double.parseDouble(obj[5].toString());
							 if(obj[6]!=null)
							  sendEndTime=                    Double.parseDouble(obj[6].toString());
							  oneTotalTime=(sendEndTime-sendStartTime);
							  totalTime+=oneTotalTime;

							  if(obj[7]!=null)
							  sendCount=Integer.parseInt(obj[7].toString());
            ...
            out.write("\r\n\t\t\t\t\t<tr>\r\n\r\n                          <td>合计</td>\r\n\t\t\t\t\t\t  <td>&nbsp;</td>\r\n\t\t\t\t\t\t  <td>&nbsp;</td>\r\n\t\t\t\t\t\t  <td>");
            out.print(fmt2.format(totalKilo));
            out.write(" </td>\r\n\t\t\t\t\t\t  <td>");
            out.print(fmt2.format(totalKiloPrice));
            out.write(" </td>\r\n\t\t\t\t\t\t  <td>");
            out.print(fmt2.format((totalTime/(1000*60*60))));
            out.write(" </td>\r\n\t\t\t\t\t\t  <td>");
