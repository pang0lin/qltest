...
public final class informationmanager_005finfo_005fbrowser_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(BrowserJudge.isFirefox(request)){
      ...
      out.write(".css\" rel=\"stylesheet\" type=\"text/css\" />\r\n</head>\r\n<body bgcolor=\"#ffffff\" onKeyDown=\"if(event.keyCode==13){ searchSubmit();return false;}\" onclick=\"yinc()\" >\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n\r\n");
      out.write("\r\n<script language=\"JScript.Encode\" src=\"/jsoa/js/browinfo.js\"></script>\r\n<script language=\"JScript.Encode\" src=\"/jsoa/js/rtxint.js\"></script>\r\n<script language=\"javascript\">\r\n\r\nfunction rtxonline(a){\r\n\t RAP(a);\r\n}\r\n\r\n</script>");
      out.write('\r');
      out.write('\n');
...
String imType="",imHref="",imURL="";
if(online){
	com.js.message.RealTimeUtil util=new com.js.message.RealTimeUtil();
	imType=util.getType();
	if("gk".equals(imType)){
		imHref="lava://chat?contact="+util.getZoneID()+".";
		imURL="http://"+util.getServerDN()+":"+util.getPort()+"/cgi-bin/chkonline/"+util.getZoneID()+".";
	}
}

      out.write("\r\n<table width=\"100%\">\r\n    <tr>\r\n        <td>\r\n            <form name=\"form1\" method=\"POST\" action=\"/jsoa/InfoBrowserAction.do?informationId=");
      out.print(request.getParameter("informationId"));
      out.write("\">\r\n            ");
      if (_jspx_meth_bean_005fmessage_005f1(_jspx_page_context))
        return;
      out.write("：\r\n            <input type=\"text\" name=\"searchName\" class=\"inputText\" value=\"");
      out.print(request.getParameter("searchName")==null?"":request.getParameter("searchName"));
      out.write("\">\r\n\t\t\t<button class=\"btnButton4font\" onclick=\"searchSubmit();\">");
      if (_jspx_meth_bean_005fmessage_005f2(_jspx_page_context))
        return;
      out.write("</button>\r\n\t\t    <button class=\"btnButton2font\" onclick=\"window.location.href='/jsoa/InfoBrowserAction.do?informationId=");
      out.print(request.getParameter("informationId"));
      out.write("&read=");
      out.print(read);
      out.write("';\">");
...
if("1".equals(read)){
      ...
      out.write("</td>\r\n    </tr>\r\n    <tr>\r\n        <td>\r\n            <table width=\"100%\" border=\"1\" cellpadding=\"1\" cellspacing=\"0\" bordercolor=\"#000000\" bordercolordark=\"#FFFFFF\">\r\n                ");
			...
			status="false";
                ...
                Object[] obj = null;
                List list = (List) request.getAttribute("browserList");
                int j = 0;
...
if(online){
				if("rtx".equals(imType)){
		 			for(int z=0;z<userOnlinList.size();z++)
		                {
		                if(obj[4].equals((Long)userOnlinList.get(z)))
		                ta="1";
		                 }
...
if("0".equals(ta)) {
      out.write("\r\n                  <img src=\"/jsoa/images/man_off_16.bmp\" border=\"0\" style=\"cursor:pointer;\" onclick=\"javascript:OpenDiv(60,70,'");
      out.print(obj[4]);
      out.write('\'');
      out.write(',');
      out.write('\'');
      ...
      out.write("\r\n                  <img src=\"/jsoa/images/man_on_16.bmp\" border=\"0\" style=\"cursor:pointer;\" onclick=\"javascript:OpenDiv(60,70,'");
      out.print(obj[4]);
      out.write('\'');
      out.write(',');
      out.write('\'');
                  ...
                  List jsuserOnlinList=onlineDB.getAllOnlinerId();
                   String jsta="0";
		             for(int w=0;w<jsuserOnlinList.size();w++)
		                {
		               if(obj[4].equals((Long)jsuserOnlinList.get(w)))
		                jsta="1";
		                }
...
if("0".equals(jsta)) {
	  ...
	  String pagerURL = "/jsoa/InfoBrowserAction.do";
      out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/informationmanager_info_browser.jsp(11,7) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("information");
      // /info/informationmanager_info_browser.jsp(11,7) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setKey("info.viewvisitstatistics");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/informationmanager_info_browser.jsp(37,12) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("information");
      // /info/informationmanager_info_browser.jsp(37,12) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setKey("info.viewusers");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/informationmanager_info_browser.jsp(39,60) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setBundle("common");
      // /info/informationmanager_info_browser.jsp(39,60) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/informationmanager_info_browser.jsp(40,170) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setBundle("common");
      // /info/informationmanager_info_browser.jsp(40,170) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/informationmanager_info_browser.jsp(47,34) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setBundle("information");
      // /info/informationmanager_info_browser.jsp(47,34) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setKey("info.viewuservisited");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f5(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/informationmanager_info_browser.jsp(47,109) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f5.setBundle("information");
      // /info/informationmanager_info_browser.jsp(47,109) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f5.setKey("info.viewusernonvisisted");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f6(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/informationmanager_info_browser.jsp(178,9) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f6.setBundle("information");
      // /info/informationmanager_info_browser.jsp(178,9) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f6.setKey("info.searchcondition");
