 ...
 * Generated at: 2023-01-06 09:52:08 UTC
...
public final class empChangeTypeModi_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String empChangeTypeId = "";
	if(request.getAttribute("empChangeTypeId") != null){
           empChangeTypeId = request.getAttribute("empChangeTypeId").toString();
	}

      out.write("\r\n\r\n<body leftmargin=\"0\" topmargin=\"0\" onLoad=\"load();resizeWin(400,200);\"  class=\"MainFrameBox Pupwin\">\r\n<table width=\"100%\" height=\"100%\" border=\"0\" cellpadding=\"10\" cellspacing=\"0\" class=\"docBoxNoPanel\">\r\n  <tr>\r\n    <td valign=\"top\">\r\n\t\t<div id=\"docinfo0\" style=\"display:;\">\r\n\t\t\t<table width=\"100%\" border=\"0\" cellpadding=\"2\" cellspacing=\"1\">\r\n\t\t\t\t");
      //  html:form
      ...
      try {
        ...
        // /personnel_manager/empChangeTypeModi.jsp(43,4) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("/EmpChangeAction.do?action=updateEmpChangeType");
        // /personnel_manager/empChangeTypeModi.jsp(43,4) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setMethod("post");
        int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
        if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t  <td width=\"80\"><label class=\"mustFillcolor\">*</label>调整类型：</td>\r\n\t\t\t\t\t  <td>\r\n\t\t\t\t\t\t  ");
            if (_jspx_meth_html_005ftext_005f0(_jspx_th_html_005fform_005f0, _jspx_page_context))
              return;
            out.write("\r\n\t\t\t\t\t  </td>\r\n\t\t\t\t\t</tr>\r\n\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t  <td colspan=\"2\" valign=\"top\"> <p>&nbsp; </p></td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t\t<input type=\"hidden\" name=\"empChangeTypeId\" value=\"");
            out.print(empChangeTypeId);
            out.write("\">\r\n\t\t\t\t\t");
...
//	String saveType = request.getParameter("saveType");
      ...
      out.write("\r\n</html>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction load(){\r\n\t");
 if (errMessages == null || errMessages.length()== 0) {
      out.write("\r\n    var reload = document.EmpChangeActionForm.saveType.value;\r\n    if (reload == \"updateAndExit\"){\r\n    \twindow.opener.location.href=\"/jsoa/EmpChangeAction.do?action=empChangTypeView&pager.offset=");
      out.print(request.getParameter("pager.offset"));
      out.write("\";\r\n        window.close();\r\n    }\r\n    if (reload == \"null\"){\r\n    \treturn ;\r\n    }\r\n   ");
}
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personnel_manager/empChangeTypeModi.jsp(47,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setProperty("empChangeType");
      // /personnel_manager/empChangeTypeModi.jsp(47,8) name = maxlength type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setMaxlength("25");
      // /personnel_manager/empChangeTypeModi.jsp(47,8) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyleClass("inputtext");
      // /personnel_manager/empChangeTypeModi.jsp(47,8) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personnel_manager/empChangeTypeModi.jsp(55,5) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
