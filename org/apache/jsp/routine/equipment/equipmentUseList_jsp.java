 ...
 * Generated at: 2023-01-06 09:48:51 UTC
...
public final class equipmentUseList_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      try {
        ...
        pageSize = Integer.parseInt(request.getAttribute("maxPageItems").toString());
            ...
            try {
              ...
              // /routine/equipment/equipmentUseList.jsp(49,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/EquipmentAction.do?action=equipmentUseView");
              // /routine/equipment/equipmentUseList.jsp(49,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
                  ...
                  out.write("' style=\"width:70%\"/></td>\r\n\t\t<td width=\"30%\" height=\"25\" >借用人：\r\n\t    <input name=\"searchEmpName\" onKeyPress=\"return look() ;\" onKeyUp=\"value=checkQuery(this,'借用人')\" onBlur=\"value=checkQuery1(this,'借用人')\" type=\"text\"  class=\"inputText\" onKeyDown=\"if(event.keyCode==13) search();\" value='");
                  out.print(request.getParameter("searchEmpName")!=null?request.getParameter("searchEmpName"):"");
                  out.write("' style=\"width:70%\"/></td>\r\n\t\t<td width=\"40%\" height=\"25\" >借用部门：&nbsp;&nbsp;\r\n\t    <input name=\"searchOrgName\"  onkeypress=\"return look() ;\" onKeyUp=\"value=checkQuery(this,'借用部门')\" onBlur=\"value=checkQuery1(this,'借用部门')\"  type=\"text\"   class=\"inputText\" onKeyDown=\"if(event.keyCode==13) search();\" value='");
                  out.print(request.getParameter("searchOrgName")!=null?request.getParameter("searchOrgName"):"");
                  out.write("' style=\"width:70%\"/></td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td height=\"25\" colspan=\"2\">借用日期：&nbsp;\r\n\t\t                      ");
Calendar now = Calendar.getInstance();
                  out.write("\r\n\t\t\t\t\t\t\t  <script language=javascript>\r\n\t\t\t\t\t\t\t    ");
if(request.getParameter("searchStartDate") != null && !"".equals(request.getParameter("searchStartDate")))
                                now.setTime(new java.util.Date(request.getParameter("searchStartDate")));
...
if(request.getParameter("searchEndDate") != null && !"".equals(request.getParameter("searchEndDate")))
                                now.setTime(new java.util.Date(request.getParameter("searchEndDate")));
...
if ("1".equals(request.getParameter("searchDatecheckbox"))) {
                  ...
                  out.write(" style=\"cursor:pointer\">\t    </td>\r\n\t\t<td align=\"right\"><button class=\"btnButton2Font\" onClick=\"search();\">查询</button>\r\n\t\t<button class=\"btnButton2Font\" onClick=\"cleared();return false;\" >重置</button></td>\r\n\t</tr>\r\n\t");
            ...
            out.write("\r\n</table>\r\n\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n  <tr height=\"20\">\r\n    <td align=\"right\"><button id=\"hiddenSearch\"  class=\"btnButton4Font\" onClick=\"hidserch()\">查询</button>\r\n    \r\n    <button class=\"btnButton4Font\"  id=\"btnButton2Download\" onClick=\"exportEquipmentMessage();\" />导出Excel</td>\r\n    \r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n<form  name=\"form1\" method=\"post\">\r\n                      <tr align=\"center\">\r\n                        <td width=\"10%\" class=\"listTableHead\"> 编码 </td>\r\n                        <td width=\"18%\" class=\"listTableHead\"> ");
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
            out.write('设');
            out.write('备');
}else{
            ...
            out.write("名称 </td>\r\n                        <td width=\"8%\" class=\"listTableHead\"> 借用人 </td>\r\n                        <td width=\"26%\" class=\"listTableHead\"> 借用部门 </td>\r\n\t\t\t\t\t\t<td width=\"15%\" class=\"listTableHead\"> 借用时间 </td>\r\n\t\t\t\t\t\t<td width=\"15%\" class=\"listTableHead\"> 用完时间 </td>\r\n                        <td width=\"8%\" class=\"listTableHeadLast\" nowrap=\"nowrap\"> &nbsp;状态&nbsp; </td>\r\n                      </tr>\r\n\r\n                      ");
            ...
            try {
              ...
              // /routine/equipment/equipmentUseList.jsp(111,22) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /routine/equipment/equipmentUseList.jsp(111,22) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(obj[9] !=null && "4".equals(obj[9].toString())){
                  ...
                  out.write("\r\n\t\t\t\t\t\t");
if(obj[9] !=null && "2".equals(obj[9].toString())){
                  out.write("\r\n\t\t\t\t\t\t  <img  style=\"cursor:pointer\" border=\"0\" src=\"images/finsh.gif\" alt=\"归还\" onClick=\"Restitute('");
                  out.print(obj[0]);
                  out.write("')\" >\r\n\t\t\t\t\t\t  ");
}
                  out.write("</td>\r\n                      </tr>\r\n                      ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\nfunction getCheckBoxID() {\r\n    var strCheckBox = \"\" ;\r\n    var k=0;\r\n    for(var i = 0 ; i < document.all.form1.length ; i++ ) {\r\n        var obj = document.all.form1[i] ;\r\n         if(obj.type == \"checkbox\"  && obj.name==\"batchDel\"){\r\n\t\tif(obj.checked) {\r\n             \tk++;\r\n                \tstrCheckBox += obj.value  ;\r\n                    \tstrCheckBox += \",\" ;\r\n\t\t}\r\n         }\r\n    }\r\n    document.all.checkboxNumber.value = k;\r\n    return strCheckBox ;\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\n\r\nfunction modify(id){\r\n\tMM_openBrWindow('EquipmentAction.do?action=selectEquipmentApplyView&equipmentApplyId='+id+'&type=modi','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=400')\r\n");
      out.write("}\r\n\r\nfunction del(id){\r\n    \tvar checkboxNumber = document.all.checkboxNumber.value;\r\n        var j = document.all.jNumber.value\r\n        var pageSize2 = document.all.pageSize2.value;\r\n        var pageSize3 = document.all.pageSize3.value;\r\n    if(checkboxNumber==j && pageSize2>=pageSize3){\r\n        pageSize2 = pageSize2-pageSize3;\r\n        }\r\n    if(confirm(\"确实要删除这条记录吗？\")){\r\n    window.location.href=\"/jsoa/EquipmentAction.do?action=deleteEquipmentApply&equipmentApplyId=\"+id+\"&pager.offset=\"+pageSize2;\r\n    }\r\n}\r\n\r\nfunction Restitute(id){\r\n    if(confirm(\"确实要归还吗？\")){\r\n        var condition = \"\";\r\n\t   if(document.all.searchDatecheckbox.checked){\r\n        condition = \"&searchDatecheckbox=1&searchStartDate=\"+document.all.searchStartDate.value+\"&searchEndDate=\"+document.all.searchEndDate.value;\r\n\t   } window.location.href=\"/jsoa/EquipmentAction.do?action=restituteEquipmentApply&equipmentApplyId=\"+id+\"&searchEquipmentName=");
      out.print(request.getParameter("searchEquipmentName")==null?"":request.getParameter("searchEquipmentName"));
      out.write("&searchEmpName=");
      out.print(request.getParameter("searchEmpName")==null?"":request.getParameter("searchEmpName"));
      out.write("&searchOrgName=");
      out.print(request.getParameter("searchOrgName")==null?"":request.getParameter("searchOrgName"));
      out.write("\"+condition+\"&pager.offset=");
      out.print(request.getParameter("pager.offset")==null?"0":request.getParameter("pager.offset"));
      out.write("\";\r\n    }\r\n}\r\n\r\nfunction search(){\r\n    \tdocument.EquipmentActionForm.submit();\r\n    }\r\nfunction cleared(){\r\n    window.location.href=\"/jsoa/EquipmentAction.do?action=equipmentUseView\";\r\n    }\r\nfunction hidserch()\r\n{\r\n     var stable=document.getElementById(\"searchtable\");\r\n     var sbutton=document.getElementById(\"hiddenSearch\");\r\n     if(stable.style.display==\"none\")\r\n     {\r\n      stable.style.display=\"\";\r\n      hiddenSearch.innerHTML=\"关闭查询\";\r\n      \r\n     }else{\r\n     \r\n     stable.style.display=\"none\";\r\n     hiddenSearch.innerHTML=\"查询\";\r\n     \r\n     }\r\n}\r\nfunction exportEquipmentMessage(){\t\r\n   \r\n\tvar searchStartDate = document.getElementsByName(\"searchStartDate\")[0].value;\r\n\tvar searchEndDate = document.getElementsByName(\"searchEndDate\")[0].value;\r\n\tvar searchEquipmentName = document.getElementsByName(\"searchEquipmentName\")[0].value;\r\n\tvar searchEmpName = document.getElementsByName(\"searchEmpName\")[0].value;\r\n\tvar searchOrgName = document.getElementsByName(\"searchOrgName\")[0].value;\r\n\tvar searchDatecheckbox = document.getElementsByName(\"searchDatecheckbox\")[0].checked;\r\n");
      out.write("    var mark=\"0\";\r\n    if(searchDatecheckbox){\r\n     mark=\"1\"\r\n    }\r\n    \r\n    \r\n\tvar para = \"&searchStartDate=\" + searchStartDate + \"&searchEndDate=\" + searchEndDate + \"&searchEquipmentName=\" + searchEquipmentName + \"&searchEmpName=\" + searchEmpName + \"&searchOrgName=\" + searchOrgName\r\n\t       + \"&searchDatecheckbox=\" + searchDatecheckbox  ; \r\n\t\r\n\t\r\n\tJSMainWinOpen(\"/jsoa/EquipmentAction.do?action=equipmentUseViewExcel\"+para);\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
