 ...
 * Generated at: 2023-01-06 10:09:15 UTC
...
public final class itemlistForRWS_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getAttribute("toUserId")!=null){
            ...
            out.write("\r\n\t\t\r\n         <tr>\r\n\t\t\t<td width=\"20\"><INPUT TYPE=\"hidden\"name=\"tran\" value=\"null\"></td>\r\n\t\t\t<td nowrap>标题：</td>\r\n\t\t\t<td>\r\n\t\t\t<input type=\"text\" id=\"title\" name=\"title\" size=\"35\" value=\"");
            out.print(request.getParameter("title")!=null?request.getParameter("title"):"");
            out.write("\" class=\"inputText\" />\r\n\t\t\t</td>\r\n\t\t\t<td>发起人：</td>\r\n\t\t\t<td>\r\n\t\t\t<input type=\"text\" id=\"posterName\" name=\"posterName\" size=\"35\" value=\"");
            out.print(request.getParameter("posterName")!=null?request.getParameter("posterName"):"");
...
if("yuguidang".equals(request.getAttribute("gdzt"))){ 
            out.write("\r\n \t\t\t\t<td width=\"15%\" class=\"listTableHead\">预归档日期</td> \r\n \t\t   ");
}else { 
            out.write("\r\n \t\t        <td width=\"15%\" class=\"listTableHead\">归档日期</td> \r\n \t\t   ");
} 
...
if(!"10".equals(status)){ 
        ...
        String term;
            ...
            try {
              ...
              // /cooperate/itemlistForRWS.jsp(154,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /cooperate/itemlistForRWS.jsp(154,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(!"10".equals(status)){ 
  ...
  if("yuguidang".equals(request.getAttribute("gdzt"))){ 
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj[obj.length-2].toString().substring(0, 16));
                  out.write("</td>\r\n \t\t        ");
}else { 
                  out.write("\r\n \t\t            <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(obj[obj.length-1].toString().substring(0, 16) );
                  out.write("</td>\r\n \t\t        ");
} 
                  out.write("\r\n               <td class=\"");
                  out.print(listClass);
...
if(!"10".equals(status)){ 
 				 ...
 				 if("weiguidang".equals(request.getAttribute("gdzt"))){ 
                  out.write("\r\n\t\t\t\t   <img src=\"images/yuguidang.gif\" style=\"cursor:pointer\" onclick=\"yuguidang('");
                  out.print(obj[0].toString());
                  out.write("');\" title=\"预归档\">\r\n\t\t\t\t");
 }else if("yuguidang".equals(request.getAttribute("gdzt"))){
                  out.write("\r\n\t\t\t\t  ");
 if("0".equals(WorkFlowEJBBeanForRWS.getStatusForCooperate(obj[0].toString()))){ 
                  out.write("\r\n\t\t\t\t   <img src=\"images/chexiaoguidang.gif\" style=\"cursor:pointer\" onclick=\"chexiaoguidang('");
                  out.print(obj[0].toString());
                  out.write("');\" title=\"驳回归档\">\r\n\t\t\t\t   <img src=\"images/tongyiguidang.gif\" style=\"cursor:pointer\" onclick=\"tongyiguidang('");
                  out.print(obj[0].toString());
                  out.write("');\" title=\"同意归档\">\r\n\t\t\t\t   ");
}else{ 
                  ...
                  out.write("\r\n\t\t\t\t");
}else if("yiguidang".equals(request.getAttribute("gdzt"))){ 
                  out.write("\r\n\t\t\t\t   &nbsp;\r\n\t\t\t\t");
} 
                  out.write("\r\n               \r\n               \r\n               </td>\r\n               ");
} 
