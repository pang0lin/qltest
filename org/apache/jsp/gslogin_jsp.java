...
public final class gslogin_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if("no".equals(validate)){
	...
	String userAccountName=(String)request.getAttribute("userAccountName");
      ...
      out.print(webapp);
      out.write("/webmail/ajax_util.js\"></script>\r\n\r\n\r\n</head>\r\n<body onUnload=\"javascript:unLoad();\" onLoad=\"javascript:load();checkIE11();initHeight();jumpErr();\">\r\n");
      //  html:form
      ...
      try {
        ...
        // /gslogin.jsp(85,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("/CheckUser");
        // /gslogin.jsp(85,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
