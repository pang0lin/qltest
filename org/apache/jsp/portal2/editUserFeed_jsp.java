...
public final class editUserFeed_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Logger logger = Logger.getLogger("editUserFeed.jsp");
...
if(action.equals("delete")){
	Element feed=(Element)XPath.selectSingleNode(root,"/myfeed/feed[@id='"+id+"']");
	root.removeContent(feed);
