 ...
 * Generated at: 2023-01-06 10:03:25 UTC
...
public final class selfProductPageExport_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if("nzp".equals(type)){
	try{
		String title = "内作品基础数据导出";
		String[] headTitle ={"管理NO","图号","中文名称","前缀","扫描件","主单位","制作工序","转下工序","前置天数","虚拟件","预设仓库"};
		...
		java.util.List<java.util.ArrayList<String>> list = com.js.oa.eform.util.HaierSpecialModels.getSelfProductNzpInfo(parmMap);
	    ...
	    WritableSheet ws = wwb.createSheet("内作品", 10);
	    ...
	    if(list!=null && list.size()>0){
	    	for(int i=0;i<list.size();i++){
	    		java.util.ArrayList<String> sub=list.get(i);
	    	    for(int j=0;j<sub.size();j++){
	    	    	ws.addCell(new Label(j,i+1,sub.get(j),wcf));
	    	    }
	        }
	    }	
	...
	try{
		String title = "新机型基础数据导出";
		String[] headTitle ={"管理NO","机型名称","机型总成图号","产品编码","ROSH类型","销售类型","内外机区分","生产类型","类别","前缀","包装单位",
				"包装毛重(kg)","主单位","长(mm)","宽(mm)","高(mm)","包装体积(m3)","工序","是否排产","前置天数","预设仓库"};
		...
		parmMap.put("export","1");
		java.util.List<java.util.ArrayList<String>> list = com.js.oa.eform.util.HaierSpecialModels.getSelfProductXjxInfo(parmMap);
	    ...
	    //创建一个工作表   ，一个excel文件中可以创建多个工作表
	    WritableSheet ws = wwb.createSheet("新机型", 10);
