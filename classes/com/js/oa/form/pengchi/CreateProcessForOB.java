...
public class CreateProcessForOB {
  ...
  public List<Map<String, String>> getFieldValueForOB() {
    ...
    try {
      ...
      String updateRemark = "OA修改状态为215,时间:" + sdf.format(new Date());
      if (ukids.length() > 0) {
        ukids = ukids.substring(0, ukids.length() - 1);
        String[] idArray = ukids.split(",");
        updateSql = "update PRODDTA.FE64311H@jdedblink set KHNXTR='215',KHPOHP01='0',KHPOHP02='N',KHUSER='OA',KHUPMJ=?,KHDL17=? where KHUKID=?";
        ...
        pstmt.executeBatch();
        conn.commit();
        System.out.println("------成功修改OB单的读取状态！---UKID=" + ukids);
  ...
  public List<Map<String, String>> getFieldvalueForOBmx() {
    List<Map<String, String>> datas = new ArrayList<Map<String, String>>();
    String sql = "select KDUKID,KDDCTO,KDKCOO,KDDOCO,KDSFXO,KDLITM,KDDSC1,KDDSC2,DRDL01,KDUOM,KDUOM2,KDVR01,KDPRRC,KDUORG,KDSQOR,KDURAT,CRPDTA.NTOD(KDDRQJ) KDDRQJ from PRODDTA.FE64311D@jdedblink,PRODCTL.F0005@jdedblink where  DRSY='41' and DRRT='P3' and DRKY=KDPRP3 and KDPOHP01=0 and KDPOHP02='N' and KDKCOO='00010' and KDDCTO=?";
    DataSource ds = (new DataSourceBase()).getDataSource("jdbc/pengchi");
    Connection conn = null;
    try {
      conn = ds.getConnection();
  ...
  public void startProcess() {
    List<Map<String, String>> ob = getFieldValueForOB();
    List<Map<String, String>> obmx = new ArrayList<Map<String, String>>();
    if (ob != null && ob.size() > 0)
      obmx = getFieldvalueForOBmx(); 
    ...
    for (int i = 0; i < formBaseInfo.size(); i++) {
      if (((String)((Map)formBaseInfo.get(i)).get("formid")).equals("OBDG"))
        info = formBaseInfo.get(i); 
    } 
    if (ob != null && ob.size() > 0 && obmx != null && obmx.size() > 0) {
      String result = "-1";
      for (Map<String, String> obmap : ob) {
        String ukid = obmap.get("ukzj");
        try {
          float totalnum = 0.0F;
          double totalCorrectNum = 0.0D;
          double totalCorrectMoney = 0.0D;
          float totalmoney = 0.0F;
          for (Map<String, String> mxmap : obmx) {
            if (((String)obmap.get("ukzj")).equals(mxmap.get("ukzj")) && ((String)obmap.get("ddlx")).equals(mxmap.get("ddlx")) && ((String)obmap.get("ddgs")).equals(mxmap.get("ddgs")) && ((String)obmap.get("ddh")).equals(mxmap.get("ddh")) && ((String)obmap.get("ddhz")).equals(mxmap.get("ddhz"))) {
          ...
          xml.append("<UserName  submitName=\"").append(((String)obmap.get("zdr")).trim()).append("\"  receiveName=\"").append(info.get("receiveName")).append("\"/>");
          xml.append("<Data>");
          ...
          xml.append("<field name=\"qgdh\" type=\"varchar\">").append(((String)obmap.get("qgdh")).trim()).append("</field>");
          xml.append("<field name=\"gys\" type=\"varchar\">").append(((String)obmap.get("gys")).trim()).append("</field>");
          xml.append("<field name=\"lxr\" type=\"varchar\">").append(((String)obmap.get("lxr")).trim()).append("</field>");
          xml.append("<field name=\"lxrdh\" type=\"varchar\">").append(((String)obmap.get("lxrdh")).trim()).append("</field>");
          xml.append("<field name=\"cgy\" type=\"varchar\">").append(((String)obmap.get("cgy")).trim()).append("</field>");
          xml.append("<field name=\"lxrcz\" type=\"varchar\">").append(((String)obmap.get("lxrcz")).trim()).append("</field>");
          xml.append("<field name=\"cgycz\" type=\"varchar\">").append(((String)obmap.get("cgycz")).trim()).append("</field>");
          xml.append("<field name=\"cgydh\" type=\"varchar\">").append(((String)obmap.get("cgydh")).trim()).append("</field>");
          xml.append("<field name=\"cgdh\" type=\"varchar\">").append(((String)obmap.get("cgdh")).trim()).append("</field>");
          xml.append("<field name=\"ddrq\" type=\"varchar\">").append(((String)obmap.get("ddrq")).trim()).append("</field>");
          xml.append("<field name=\"dz\" type=\"varchar\">").append(((String)obmap.get("dz")).trim()).append("</field>");
          ...
          xml.append("<field name=\"zkje\" type=\"varchar\">").append(((String)obmap.get("zkje")).trim()).append("</field>");
          xml.append("<field name=\"fjf\" type=\"varchar\">").append(((String)obmap.get("fjf")).trim()).append("</field>");
          xml.append("<field name=\"zje\" type=\"varchar\">").append(((String)obmap.get("zje")).trim()).append("</field>");
          xml.append("<field name=\"zzs\" type=\"varchar\">").append(((String)obmap.get("zzs")).trim()).append("</field>");
          xml.append("<field name=\"fkfs\" type=\"varchar\">").append(((String)obmap.get("fkfs")).trim()).append("</field>");
          xml.append("<field name=\"fplx\" type=\"varchar\">").append(((String)obmap.get("fplx")).trim()).append("</field>");
          xml.append("<field name=\"shdz\" type=\"varchar\">").append(((String)obmap.get("shdz")).trim()).append("</field>");
          xml.append("<field name=\"zdr\" type=\"varchar\">").append(((String)obmap.get("zdrmc")).trim()).append("</field>");
          xml.append("<field name=\"ukzj\" type=\"varchar\">").append(((String)obmap.get("ukzj")).trim()).append("</field>");
          xml.append("<field name=\"ddlx\" type=\"varchar\">").append(((String)obmap.get("ddlx")).trim()).append("</field>");
          xml.append("<field name=\"ddgs\" type=\"varchar\">").append(((String)obmap.get("ddgs")).trim()).append("</field>");
          xml.append("<field name=\"ddh\" type=\"varchar\">").append(((String)obmap.get("ddh")).trim()).append("</field>");
          xml.append("<field name=\"ddhz\" type=\"varchar\">").append(((String)obmap.get("ddhz")).trim()).append("</field>");
          xml.append("</Column>");
          xml.append("</Table>");
          int num = 0;
          for (Map<String, String> mxmap : obmx) {
        ...
        if (!result.equals("-1") && result.length() < 10) {
          System.out.println("时间：[" + printTime + "]创建采购单（东莞）OB成功！--单号是：" + (String)obmap.get("ddh"));
          continue;
        } 
        if (result.equals("-1")) {
          System.out.println("时间：[" + printTime + "]创建采购单（东莞）OB失败！--单号是：" + (String)obmap.get("ddh"));
  ...
  public List<Map<String, String>> getBaseinfo() {
    ...
    try {
      ...
      for (int i = 0; i < formNodes.size(); i++) {
        ...
        if (((String)nodeMap.get("formid")).equals("OBDG")) {
