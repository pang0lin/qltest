...
public final class examinationManagelist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(isTime.equals("1")){
            ...
            out.write(">\r\n\r\n\t\t\t </td>\r\n       \r\n                                <td width=\"22%\" align=\"right\" rowspan=\"2\">\r\n                                  <input type=\"button\" class=\"btnButton2Font\"  style=\"cursor:pointer\" onclick=\"javacript:form2.submit();\" value=\"查询\"/>\r\n                                  <input type=\"button\" class=\"btnButton2Font\"  style=\"cursor:pointer\" onclick=\"window.location.href='/jsoa/ExaminationManageAction.do?action=list'\" value=\"重置\"/>&nbsp;\r\n                              </td>\r\n                            </tr>\r\n                          </form>\r\n    </table>\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n  <tr>\r\n    <td>&nbsp;</td>\r\n    <td width=\"240\" align=\"right\" nowrap>\t\r\n\t  <input type=\"button\" class=\"btnButton2Font\" onclick=\"MM_openBrWindow('ExaminationManageAction.do?action=add','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=600,height=300')\" value=\"新增\"/>\r\n\t\t\t\t\t\t<input type=\"button\" class=\"btnButton2Font\" onclick=\"delBatch();\" value=\"删除\" />\r\n\t\t\t\t\t\t<input type=\"button\" id=\"hiddenSearch\"  class=\"btnButton4Font\" onClick=\"hidserch()\" value=\"查询\"/>\r\n");
            ...
            try {
              ...
              // /examination/examinationManagelist.jsp(140,22) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /examination/examinationManagelist.jsp(140,22) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  out.write("</td>\r\n                          <td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\" align=\"left\" nowrap><img  style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" title=\"修改\" onclick=\"modify('");
                  out.print(obj[0]);
...
String pagerURL = "/jsoa/ExaminationManageAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
 ...
 int deloff = j==1 ? pageSize2-15:pageSize2;
   if(deloff < 0 ) deloff = 0;
            ...
            out.write("\r\n    if(confirm(\"删除时同时将与此相关的考试信息删除,确实要删除这条记录吗？\")){\r\n    window.location.href=\"/jsoa/ExaminationManageAction.do?action=delete&id=\"+id+\"&pager.offset=");
            out.print(deloff);
            out.print(queryStr);
            out.write("\";\r\n    }\r\n}\r\n\r\nfunction delBatch() {\r\n    \tvar strId=getCheckBoxID();\r\n        var checkboxNumber = document.all.checkboxNumber.value;\r\n        var j = document.all.jNumber.value\r\n        var pageSize2 = document.all.pageSize2.value;\r\n        var pageSize3 = document.all.pageSize3.value;\r\n    if(checkboxNumber==j && pageSize2>=pageSize3){\r\n        pageSize2 = pageSize2-pageSize3;\r\n        }\r\n        if(strId!=\"\"){\r\n\tif(confirm(\"删除时同时将与此相关的考试信息删除,确实要删除这些记录吗？\")){\r\n         window.location.href=\"/jsoa/ExaminationManageAction.do?action=deleteBatch&ids=\" + getCheckBoxID()+\"");
            out.print(queryStr);
            out.write("&pager.offset=\"+pageSize2 ;\r\n    }\r\n    }else{\r\n             alert(\"请选择要删除的记录!\");\r\n             return;\r\n         }\r\n}\r\n\r\nfunction modify(id){\r\n\tMM_openBrWindow('ExaminationManageAction.do?action=modify&id='+id+'&pager.offset=");
            out.print(pageSize2);
            out.print(queryStr);
