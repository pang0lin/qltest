...
public final class oacollectcategorylist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String isLoad = request.getParameter("pager.offset")==null?"0":"1";
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\r\n\t\t\t       <div class=\"btnBQspace AlignLeft\"></div>\r\n\t\t\t\t    <div id=\"PanleDIV\"  class=\"tabPanelSelected\" onClick=\"changePanle(this,'/jsoa/CollectCategoryAction.do?action=list');\">\r\n\t\t\t        <div class=\"tabPanelLeft\"></div>\r\n\t\t\t        <div class=\"tabPanelCenter\">数据采集类别</div>\r\n\t\t\t        <div class=\"tabPanelRight\"></div>      \r\n\t\t\t      </div>\r\n\t\t\t      ");
} 
            ...
            out.write("\r\n\t\t    </td>\r\n\t <td align=\"right\">\r\n\t \t<input type=\"button\" class=\"btnButton2font\" onClick=\"copyCate();\" value=\"复制\" />\r\n\t\t<input type=\"button\" class=\"btnButton2font\" onClick=\"JSMainWinOpen2('/jsoa/CollectCategoryAction.do?action=forCollectCategoryAdd','','',500,280)\"\r\n\t\t\t\t\tvalue=");
            if (_jspx_meth_bean_005fmessage_005f1(_jspx_th_html_005fhtml_005f0, _jspx_page_context))
              return;
            out.write(" />\r\n\t </td>\r\n  </tr>\r\n</table>\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n      <tr>\r\n      \t<td width=\"40px\" class=\"listTableHead\"><input type=\"checkbox\" id=\"selectAll\" onclick=\"selectAllItem(this);\" /></td>\r\n\t\t<td class=\"listTableHead\">类别名称</td>\r\n\t\t<td width=\"30%\" class=\"listTableHead\" >可查看人</td>\r\n\t\t<td width=\"8%\" class=\"listTableHead\" >级别</td>\r\n\t\t<!-- <td width=\"8%\" class=\"listTableHead\" >排序</td> -->\r\n\t\t<td width=\"8%\" class=\"listTableHead\" nowrap>创建人</td>\r\n\t\t<td width=\"8%\" class=\"listTableHeadLast\" nowrap>操作</td>\r\n\t</tr>\r\n\t");
		  ...
		  String listClass="listTableLine1";
            ...
            try {
              ...
              // /oacollect/oacollectcategorylist.jsp(140,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /oacollect/oacollectcategorylist.jsp(140,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /oacollect/oacollectcategorylist.jsp(140,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
	       ...
	       Object[] obj = (Object[])list;
			...
			if(index%2 != 0){
				...
				listClass="listTableLine1";
                  ...
                  out.write("\r\n\t\t  <tr>\r\n\t\t  \t<td class=\"");
                  out.print(listClass);
                  out.write("\"><input type=\"checkbox\" name=\"selectSingle\" value=\"");
                  out.print(obj[0].toString());
                  out.write("\" onclick=\"clickObj(this);\" />&nbsp;</td>\r\n\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\">\r\n\t\t\t");
for( int j = 0; j < Integer.parseInt( obj[5].toString() ) - 1; j ++ ){
				out.print("&nbsp;&nbsp;");
			}
                  out.write("\r\n\t\t\t");
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj[4]==null?"&nbsp;":obj[4].toString());
                  out.write("</td>\r\n\t\t\t<td  class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\"><img style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" alt=\"修改\" onclick=\"modify('");
 ...
 String pagerURL = "/jsoa/CollectCategoryAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\nvar flag=\"");
      out.print(flag);
      out.write("\";\r\nif(\"deletesuccess\"==flag){\r\nalert(\"删除成功！\");\r\n}\r\nif(\"deleteerror\"==flag){\r\nalert(\"删除失败！\");\r\n}\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\n\r\nfunction modify(id)\r\n{\r\n  JSMainWinOpen2('/jsoa/CollectCategoryAction.do?action=forCollectCategoryModi&id='+id,'','',500,280)\r\n\r\n}\r\nfunction del(id)\r\n{\r\n  if(confirm(\"删除分类后，该分类的下级分类及所属该分类的项目信息也将一起删除，您确定删除吗?\")){\r\n\t  window.location.href='/jsoa/CollectCategoryAction.do?action=collectCategoryDelete&ids='+id+\"&pager.offset=");
      out.print(offset1);
      out.write("\";\r\n  }\t  \r\n}\r\nfunction copyCate(){\r\n\tvar ids = getAllSelectIds();\r\n\tif(\"\"==ids){\r\n\t\talert(\"请选择要复制的分类！\");\r\n\t}else{\r\n\t\tlocation.href=\"/jsoa/CollectCategoryAction.do?action=copyCollectCategory&ids=\"+ids;\r\n\t}\r\n}\r\n");
String actionString = request.getParameter("action");
if("copyCollectCategory".equals(actionString)||"collectCategoryDelete".equals(actionString)){ 
      out.write("\r\n\tlocation.href=\"/jsoa/CollectCategoryAction.do?action=list\";\r\n");
} 
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /oacollect/oacollectcategorylist.jsp(45,7) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("personalwork");
      // /oacollect/oacollectcategorylist.jsp(45,7) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /oacollect/oacollectcategorylist.jsp(122,11) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("common");
      // /oacollect/oacollectcategorylist.jsp(122,11) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
