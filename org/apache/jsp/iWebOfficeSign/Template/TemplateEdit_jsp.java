 ...
 * Generated at: 2023-01-06 10:08:53 UTC
...
public final class TemplateEdit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  if("2015".equals(SystemCommon.getiWebOfficeVersion())) {
		StringBuffer url = new StringBuffer("/jsoa/iWebOffice2015/Template/TemplateEdit.jsp?1=1");
  ...
  String iwebObjectUrl="http://"+request.getServerName()+":"+request.getServerPort()+mHttpUrlName.substring(0,mHttpUrlName.lastIndexOf(mScriptName))+"/"+"iWebOfficeSign/iWebOffice2003.ocx#version=8,2,4,0";
...
String mobanURL = session.getAttribute("mobanURL").toString();
session.removeAttribute("mobanURL"); 
...
if(".doc".equals(mFileType)){
      ...
      out.print(flag );
      out.write("'\"> <span style=\"color:red\">注意:只有点击\"保存\"按钮后，所做的操作才有效！</span>\r\n</form>\r\n\r\n</body>\r\n</html>");
