...
public final class sendfile_005fdealwithInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(null==oid || "".equals(oid) || "".equals(personID)){
	
      out.write("\r\n\t<script type=\"text/javascript\">\r\n\talert(\"参数信息错误。\");\r\n\twindow.close();\r\n\t</script>\r\n\t");

}
List<Object[]> list = new BusinessShowBean().getSendfileDealwithInfo(oid, personID);

      out.write("\r\n<!-- 发文办理情况 -->\r\n<!DOCTYPE HTML>\r\n<html>\r\n\t<head>\r\n\t\t<base href=\"");
      out.print(basePath);
      out.write("\">\r\n\t    <title>发文办理情况查看</title>\r\n\t\t<meta http-equiv=\"pragma\" content=\"no-cache\">\r\n\t\t<meta http-equiv=\"cache-control\" content=\"no-cache\">\r\n\t\t<meta http-equiv=\"expires\" content=\"0\">\r\n\t\t<link href=\"skin/");
      ...
      out.write("\r\n\t\t\t<script type=\"text/javascript\">\r\n\t\t\talert(\"无办理信息，如急需办理请选择催办。\");\r\n\t\t\twindow.close();\r\n\t\t\t</script>\r\n\t\t\t");

		} else{
			
      out.write("\r\n\t\t\t<div style=\"width: 80%; margin: 10px auto; text-align: center;\">\r\n\t\t\t\t<h2>发文办理情况</h2>\r\n\t\t\t\t<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td class=\"listTableHead\">接收单位</td>\r\n\t\t\t\t\t\t<td class=\"listTableHead\">接收人</td>\r\n\t\t\t\t\t\t<td width=\"130\" class=\"listTableHead\">接收时间</td>\r\n\t\t\t\t\t\t<td width=\"50\" class=\"listTableHead\">状态</td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t\t");
      ...
      out.write("\">\r\n\t\t\t\t\t\t\t\t");
								...
								if(null != obj[5]){
									if("0".equals(obj[5].toString()) || "1".equals(obj[5].toString())){
										out.print("流转");
