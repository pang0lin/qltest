...
public final class examinationSelfTestlist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String queryStr = "";	
String searchTestEmpName = request.getParameter("searchTestEmpName")==null?"":request.getParameter("searchTestEmpName");
String searchTestEmpID = request.getParameter("searchTestEmpID")==null?"":request.getParameter("searchTestEmpID");
String searchTestOrgName = request.getParameter("searchTestOrgName")==null?"":request.getParameter("searchTestOrgName");
String searchTestOrgID = request.getParameter("searchTestOrgID")==null?"":request.getParameter("searchTestOrgID");
String isTime = request.getParameter("isTime")==null?"":request.getParameter("isTime");
queryStr = "&searchTestEmpName="+searchTestEmpName+"&searchTestEmpID="+searchTestEmpID+"&searchTestOrgName="
+searchTestOrgName+"&searchTestOrgID="+searchTestOrgID+"&isTime="+isTime+"&start_date="+start_date+"&end_date="+end_date;

            out.write("\r\n<body  class=\"MainFrameBox\" onKeyDown=\"if(event.keyCode==13) document.form2.submit();\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n  <tr>\r\n    <td>&nbsp;</td>\r\n    <td width=\"240\" align=\"right\" nowrap>\t\t\t\t  \r\n\t\t\t\t\t\t<button class=\"btnButton2Font\" onclick=\"delBatch();\">删除</button>\r\n\t</td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n<form  name=\"form1\" method=\"post\">\r\n                      <tr align=\"center\">\r\n                        <td width=\"40\" height=\"27\" class=\"listTableHead\"><input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n                        <td width=\"15%\"  class=\"listTableHead\"> 自测时间</td>\r\n\t\t\t\t\t\t<td width=\"15%\"   class=\"listTableHead\"> 姓名</td>\r\n\t\t\t\t\t\t<td   class=\"listTableHead\"> 所在部门 </td>\r\n                        <td width=\"8%\"  class=\"listTableHeadLast\" nowrap=\"nowrap\"> &nbsp;处理&nbsp; </td>\r\n");
            out.write("                      </tr>\r\n\r\n                      ");
            ...
            try {
              ...
              // /examination/examinationSelfTestlist.jsp(114,22) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /examination/examinationSelfTestlist.jsp(114,22) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj[1].toString().substring(2,16));
                  out.write("&nbsp;</td>\r\n                          <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  ...
                  out.write("&nbsp;</td>\r\n                          <td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\" align=\"left\"><img style=\"cursor:pointer\" border=\"0\" src=\"images/del.gif\" alt=\"删除\" onclick=\"del('");
                  out.print(obj[0]);
                  out.write("')\" ></td>\r\n                      </tr>\r\n                      ");
...
String pagerURL = "/jsoa/ExaminationSelfTestAction.do";
            out.write("\r\n\t  ");
