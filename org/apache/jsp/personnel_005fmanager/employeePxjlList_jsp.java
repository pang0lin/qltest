...
public final class employeePxjlList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
canAdd="0";
      ...
      out.write("<strong>培训经历：</strong></td>\r\n</tr>\r\n\r\n\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n");
 if(canAdd.equals("1")){
      out.write("\r\n\r\n<tr>\r\n<td align=\"center\" >\r\n<table width=\"96%\"\theight=\"22\"\tborder=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n\t<tr>\r\n\t  <td align=\"right\">\r\n\t\t  <button  class=\"btnButton2Font\" onClick=\"javascript:MM_openBrWindow('/jsoa/EmployeePxjlAction.do?action=add&empID=");
      out.print(empID);
      out.write("&canAdd=");
      out.print(canAdd);
      out.write("','','scrollbars=yes,resizable=no,width=600,height=350')\">新增</button>\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n\r\n</td>\r\n</tr>\r\n");
}
      out.write("\r\n\r\n\r\n<tr>\r\n<td align=\"center\">\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<!-- LIST TITLE PART -->\r\n<table width=\"98%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"docBoxNoPanel\" style=\"border:1px solid #6ea2da;\">\r\n\t<form name=\"EmployeePxjlActionForm\" method=\"post\" action=\"/jsoa/EmployeePxjlAction.do\">\r\n\t\t<tr align=\"center\" bgcolor=\"#cfe6ff\">\r\n\t\t\t<td width=\"15%\" class=\"outRightLine1\" nowrap>开始时间</td>\r\n\t\t\t<td class=\"outRightLine1\" width=\"20%\"> 结束名称</td>\r\n\t\t\t<td class=\"outRightLine1\" > 总学时</td>\r\n\t\t\t<td class=\"outRightLine1\" width=\"10%\"> 培训性质</td>\r\n\t\t\t<td class=\"outRightLine1\" width=\"15%\"> 参加培训项目 </td>\r\n\t\t\t<td class=\"outRightLine1\" width=\"10%\"> 获得证书</td>\r\n\t\t\t<td class=\"outRightLine1\" width=\"10%\"> 培训地点</td>\r\n\t\t\t");
 if(canAdd.equals("1")){
      ...
      try {
        ...
        // /personnel_manager/employeePxjlList.jsp(144,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("pxjlList");
        // /personnel_manager/employeePxjlList.jsp(144,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("pxjlList");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object pxjlList = null;
          ...
          pxjlList = (java.lang.Object) _jspx_page_context.findAttribute("pxjlList");
          do {
            out.write("\r\n\t\t");

		  pxjlObj = (Object[]) pxjlList;
		  index ++;
...
if(index%2 != 0){listClass="listTableLine2";}
            ...
            out.print(pxjlObj[3]);
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\" style=\"word-break:break-all;\">");
            out.print(pxjlObj[4]==null?"&nbsp;":pxjlObj[4]);
            out.write("&nbsp;</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(pxjlObj[5]);
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(pxjlObj[6]);
...
if(!deleteSuccess.booleanValue()){
      ...
      out.write("\r\n</html>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction search(){\r\n    form2.submit();\r\n}\r\nfunction delSingle(id){\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=\"/jsoa/EmployeePxjlAction.do?action=delete&pxjlId=\" + id+\"&empID=");
      out.print(empID);
      out.write("&open=");
      out.print(open);
      out.write("\" ;\r\n    }\r\n}\r\nfunction modify(id){\r\n    MM_openBrWindow('/jsoa/EmployeePxjlAction.do?action=modify&pxjlId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=600,height=350')\r\n}\r\n\tfunction view(id){\r\n    MM_openBrWindow('/jsoa/EmployeePxjlAction.do?action=view&pxjlId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
