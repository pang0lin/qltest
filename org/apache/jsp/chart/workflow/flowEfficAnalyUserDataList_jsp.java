...
public final class flowEfficAnalyUserDataList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int kindCount=0;
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.print(request.getAttribute("activityName"));
            out.write("）用户效率分析\r\n\t\t<td align=\"right\">\r\n\t\t<input type=\"button\" class=\"btnButton2Font\" onclick=\"javascript:window.location.href=((window.location.href).substring(0,(window.location.href).indexOf('/jsoa')))+'/jsoa/chartWorkFlow.do?action=flowEfficAnalyUserChart&processId=");
            out.print(request.getAttribute("processId"));
            out.write("&processName=");
            out.print(request.getAttribute("processName"));
            ...
            out.print(offset1);
            out.write("';\" value=\"图示\" />\r\n\t\t<input type=\"button\" class=\"btnButton2Font\" onclick=\"JSMainWinOpen('/jsoa/chartWorkFlow.do?action=flowEfficAnalyUserDataExport&processId=");
            out.print(request.getAttribute("processId"));
            out.write("&processName=");
            out.print(request.getAttribute("processName"));
            out.write("&activityId=");
	  ...
	  String listClass="listTableLine1";
            ...
            try {
              ...
              // /chart/workflow/flowEfficAnalyUserDataList.jsp(114,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("resultList");
              // /chart/workflow/flowEfficAnalyUserDataList.jsp(114,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("resultList");
              // /chart/workflow/flowEfficAnalyUserDataList.jsp(114,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
