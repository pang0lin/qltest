 ...
 * Generated at: 2023-01-06 09:52:14 UTC
...
public final class EmpInhabitancyList_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\t\t<td width=\"10%\" class=\"listTableHead\" nowrap=\"nowrap\">申办人</td>\r\n\t\t<td width=\"10%\" class=\"listTableHead\">初办时间</td>\r\n\t\t<td width=\"20%\" class=\"listTableHead\" nowrap=\"nowrap\">居住证年限</td>\r\n\t\t<td width=\"15%\" class=\"listTableHead\" nowrap=\"nowrap\">续办时间</td>\r\n\t\t<td width=\"15%\" class=\"listTableHead\" nowrap=\"nowrap\">备注</td>\r\n\t\t<td width=\"8%\" class=\"listTableHeadLast\" nowrap>处理</td>\r\n\t  </tr>\r\n\r\n\t\t");
		...
		String listClass="listTableLine1";
            ...
            try {
              ...
              // /personnel_manager/EmpInhabitancyList.jsp(138,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /personnel_manager/EmpInhabitancyList.jsp(138,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /personnel_manager/EmpInhabitancyList.jsp(138,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		listClass = index%2!=0?"listTableLine2":"listTableLine1";
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj[2]!=null?sdf.format(obj[2]):"");
                  out.write("&nbsp;</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  ...
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">\r\n\t\t\t<img style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" alt=\"修改\" onclick=\"MM_openBrWindow('/jsoa/EmpInhabitancyAction.do?action=load&id=");
                  out.print(obj[0]);
...
String pagerURL = "/jsoa/EmpInhabitancyAction.do";
            out.write("\r\n      ");
...
if(!currentPageNumber.equals(pageCount)){
     ...
     deloffset = deloffset < 0 ? 0 : deloffset ;
      ...
      out.write("\tform1.action = \"/jsoa/EmpInhabitancyAction.do?action=export\";\r\n\tform1.submit();\r\n\tform1.action = \"/jsoa/EmpInhabitancyAction.do?action=list\";\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
