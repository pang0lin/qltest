...
public final class doc_005fdownload_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try{ 
  ...
  if(informationId!=null && !"null".equals(informationId) && !"".equals(informationId)){
	  ...
	  if(file.exists()){
		  ...
		  System.out.println("getFileShowUse:"+com.js.util.config.SystemCommon.getFileShowUse());
		  System.out.println("isFirefox:"+com.js.util.util.BrowserJudge.isFirefox(request));
		  System.out.println("---"+",.doc,.docx,.ppt,.pptx,.xls,.xlsx,".indexOf(","+prefix+","));
		  System.out.println("---prefix:"+prefix);
		  System.out.println("isWebKit:"+(com.js.util.util.BrowserJudge.isWebKit(request)));
		  System.out.println("isIE:"+(com.js.util.util.BrowserJudge.isIE(request)));
		  System.out.println("getDefaultType:"+com.js.util.config.SystemCommon.getDefaultType().indexOf(","+prefix+","));
		  System.out.println("getExtendType:"+com.js.util.config.SystemCommon.getExtendType().indexOf(","+prefix+","));
