...
public final class type_005fp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.oa.crm.po.ProType");
  }
...
ProType proType=(ProType)request.getAttribute("proType");

      out.write("\r\n<HTML>\r\n<HEAD><TITLE>");
      out.print(proType==null?"新增项目类型":"修改项目类型");
      ...
      out.write("\">                           \r\n     </TD>\r\n  </TR> \r\n    \r\n  <TR valign=\"top\" style=\"display:none;padding-top:12px;\">\r\n     <td>\r\n     &nbsp;单价：&nbsp;<input style=\"width:300px;\" type=\"text\" class=\"inputText\" maxLength=\"50\" name=\"price\" value=\"");
      out.print(proType==null?"":proType.getPrice());
      out.write("\">\r\n     </td>\r\n  </TR> \r\n    \r\n <TR valign=\"top\" style=\"padding-top:12px;\">\r\n     <td>\r\n     &nbsp;描述：&nbsp;<textarea rows=\"3\" name=\"desc\" class=\"inputTextarea\" style=\"width:300px;\" maxSize=\"120\">");
      out.print(proType==null?"":proType.getProductDesc());
