...
public final class officemanager_005fatfunction_005fexport_005fwork_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.system.vo.usermanager.WorkVO");
...
response.setHeader("Content-disposition", "attachment;filename="+new String("工作经历".getBytes("GBK"),"iso8859-1")+".xls");

      out.write("\r\n<html>\r\n<head>\r\n    <title>导出</title>\r\n</head>\r\n<body>\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<table border=\"1\">\r\n    <tr>\r\n        <td align=\"center\"><b>姓名</b></td>\r\n        <td align=\"center\"><b>组织</b></td>\r\n        <td align=\"center\"><b>开始工作时间</b></td>\r\n        <td align=\"center\"><b>结束工作时间</b></td>\r\n        <td align=\"center\"><b>工作单位</b></td>\r\n        <td align=\"center\"><b>担任职务</b></td>\r\n        <td align=\"center\"><b>证明人</b></td>\r\n        <td align=\"center\"><b>电话</b></td>\r\n\t\t<td align=\"center\"><b>备注</b></td>\r\n    </tr>\r\n    ");
WorkVO empVO = null;
    Object[] empObj = null;
	String empName = "";
    String orgName = "";
    DateFormat df = DateFormat.getDateInstance(DateFormat.LONG, Locale.CHINESE);
      ...
      try {
        ...
        // /office_manager/officemanager_atfunction_export_work.jsp(34,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("empList");
        // /office_manager/officemanager_atfunction_export_work.jsp(34,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("empList");
        // /office_manager/officemanager_atfunction_export_work.jsp(34,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        orgName = empObj[3]==null?"&nbsp;":empObj[3].toString();
            ...
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
            out.print(empVO.getWorkunit()==null?"&nbsp;":empVO.getWorkunit());
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
            out.print(empVO.getWorkduty()==null?"&nbsp;":empVO.getWorkduty());
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
            out.print(empVO.getProveperson()==null?"&nbsp;":empVO.getProveperson());
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
            out.print(empVO.getTelephone()==null?"&nbsp;":empVO.getTelephone());
            out.write("&nbsp;</td>\r\n\t\t\t<td align=\"left\">");
            out.print(empVO.getWorkMemo()==null?"&nbsp;":empVO.getWorkMemo());
            out.write("&nbsp;</td>\r\n        </tr>\r\n    ");
