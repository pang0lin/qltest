...
public final class noTravelUseList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if ("1".equals(request.getParameter("isDate"))) {
		...
		pageSize2=Integer.parseInt(request.getParameter("pager.offset"));
            ...
            try {
              ...
              // /routine/voiture_manager/noTravelUseList.jsp(180,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /routine/voiture_manager/noTravelUseList.jsp(180,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(index%2 != 0){listClass="listTableLine2";}
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj[5]==null||obj[5]=="null"?"&nbsp;":obj[5]);
                  out.write("&nbsp;</td>\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(obj[6]==null||obj[6]=="null"?"&nbsp;":obj[6]);
                  out.write("&nbsp;</td>\r\n\t\t\t\t");
				...
				*/
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(DateFormat.getDateInstance(DateFormat.DEFAULT).format((Date)obj[7]));
                  out.write("&nbsp;");
                  out.print(obj[8]);
                  out.write("</td>\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(DateFormat.getDateInstance(DateFormat.DEFAULT).format((Date)obj[9]));
                  out.write("&nbsp;");
                  out.print(obj[10]);
                  out.write("</td>\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  ...
                  out.write("\r\n\t\t\t\t\t\t<img src=\"images/sq.gif\" title=\"拼车申请\" style=\"cursor:pointer\"\tonclick=\"apply('");
                  out.print(obj[11]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
...
if(!currentPageNumber.equals(pageCount)){
  ...
  if(deloff<0) deloff = 0 ;
            ...
            out.write("     \r\n     }\r\n}\r\nfunction apply(id,carPoolId){\r\n\t//MM_openBrWindow('VoitureApplyAction.do?flag=add&remindField=");
//=request.getParameter("remindField")
            out.write("&processId=");
//=request.getParameter("processId")
            out.write("&voitureId='+id+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=720,height=500');\r\n\t\t//MM_openBrWindow(\"VoitureApplyAction.do?flag=add&processType=1&remindField=");
//=request.getParameter("remindField")
            out.write("&processId=");
//=request.getParameter("processId")
            out.write("&voitureId=\"+id+\"&tableId=");
//=request.getParameter("tableId")
            out.write("&moduleId=11&processName=车辆申请流程\",\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=720,height=500\");\r\n\t\t//var\tselProcess=document.all.selProcess.value;\r\n\t\t//alert(selProcess);\r\n\t\tMM_openBrWindow(\"VoitureApplyAction.do?flag=add&voitureId=\"+id+\"&moduleId=11&isPC=1&carPoolId=\"+carPoolId,\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=400,height=300\");\r\n}\r\n//-->\r\n</script>\r\n\r\n");
