...
public final class netdisk_005fmydisk_005fshared_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String cando="";
if(request.getAttribute("ishared")!=null && !"".equals(request.getAttribute("ishared")) 
		&& !"null".equalsIgnoreCase(request.getAttribute("ishared")+"")){
  ...
  String currentid="0";
  if(!"".equals(request.getParameter("currentid")) && request.getParameter("currentid") !=null && !"null".equalsIgnoreCase(request.getParameter("currentid"))){
    currentid=request.getParameter("currentid");
  }

  String copynoly="0";
  if(!"".equals(request.getParameter("copynoly")) && request.getParameter("copynoly") !=null && !"null".equalsIgnoreCase(request.getParameter("copynoly"))){
    copynoly=request.getParameter("copynoly");
  }


  String cancopy="";
  if(request.getAttribute("cancopy")!=null && !"".equals(request.getAttribute("cancopy")) && !"null".equalsIgnoreCase(request.getAttribute("cancopy")+"")){
  ...
  String copyitem="";
  if(request.getAttribute("copyitem")!=null && !"".equals(request.getAttribute("copyitem").toString())&& !"null".equalsIgnoreCase(request.getAttribute("copyitem").toString())){
     copyitem=request.getAttribute("copyitem").toString();
  }
  String copyorcut="";
  if(request.getAttribute("copyorcut")!=null && !"".equals(request.getAttribute("copyorcut").toString())&& !"null".equalsIgnoreCase(request.getAttribute("copyorcut").toString())){
     copyitem=request.getAttribute("copyorcut").toString();
  }
  Exchange exchange=new Exchange();
            ...
            out.print(fileType);
            out.write("\"></td>\r\n\t  <td align=\"right\">\r\n\t \t  ");
            out.write("\r\n\t \t  <input type=\"button\" class=\"btnButton2font\" onClick=\"searchs();\" value='");
...
if("2".equals(cando)&&request.getAttribute("toUserId")==null){
	 ...
	 String listClass="listTableLine1";
            ...
            try {
              ...
              // /netdisk/netdisk_mydisk_shared.jsp(187,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /netdisk/netdisk_mydisk_shared.jsp(187,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("mydisklist");
              // /netdisk/netdisk_mydisk_shared.jsp(187,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if("sql".equals(obj[4].toString().toLowerCase()) ||"java".equals(obj[4].toString().toLowerCase()) 
				||"jpg".equals(obj[4].toString().toLowerCase()) || "gif".equals(obj[4].toString().toLowerCase()) 
				|| "png".equals(obj[4].toString().toLowerCase())||"bmp".equals(obj[4].toString().toLowerCase()) ){
                  out.write("\r\n\t\t\t\tonMouseOver=\"show('");
                  out.print(obj[2]);
                  out.write("',1,'");
                  out.print(obj[1]);
...
if("2".equals(cando)&&request.getAttribute("toUserId")==null){
                  out.write("\r\n\t\t<img src=\"/jsoa/images/del.gif\" style=\"cursor:pointer\" onclick=\"deletefile('");
                  out.print(obj[0]);
                  out.write("');\" title=\"");
                  out.print(Resource.getValue(local,"personalwork","agent.delete"));
                  out.write("\">\r\n\t\t <img src=\"/jsoa/images/rename.gif\" style=\"cursor:pointer\" onclick=\"rename('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
...
if(request.getAttribute("toUserId")!=null){
      ...
      out.write("&currentid=\"+ fatherid +\"&copyitem=\"+ copyitem +\"&copyorcut=\"+ copyorcut +\"&ishared=\"+ ishared +\"\";\r\n\t  ");
		...
		if("2".equals(cando)&&request.getAttribute("toUserId")==null){ 
      out.write("\r\n\t  window.location.href=\"/jsoa/NetdiskAction.do?action=listshared&currentid=\"+ fatherid +\"&copyitem=\"+ copyitem +\"&copyorcut=\"+ copyorcut +\"&ishared=\"+ ishared +\"&cando=2\";\r\n\t  ");
}else{
...
if(request.getAttribute("toUserId")==null){
      out.write("\r\n  \t\twindow.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/NetdiskAction.do?action=searchsharedthings&fileSaveName=\"+ fileSaveName +\"&fileType=\"+ fileType +\"&currentid=\"+ currentid ;\r\n  \r\n  ");
}else{
...
if(sysMap != null && sysMap.get("附件上传") != null){
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_mydisk_shared.jsp(115,19) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("personalwork");
      // /netdisk/netdisk_mydisk_shared.jsp(115,19) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_mydisk_shared.jsp(116,19) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("personalwork");
      // /netdisk/netdisk_mydisk_shared.jsp(116,19) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_mydisk_shared.jsp(119,77) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setBundle("common");
      // /netdisk/netdisk_mydisk_shared.jsp(119,77) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_mydisk_shared.jsp(120,80) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setBundle("common");
      // /netdisk/netdisk_mydisk_shared.jsp(120,80) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_mydisk_shared.jsp(125,33) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setBundle("personalwork");
      // /netdisk/netdisk_mydisk_shared.jsp(125,33) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_mydisk_shared.jsp(125,357) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f5.setBundle("personalwork");
      // /netdisk/netdisk_mydisk_shared.jsp(125,357) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_mydisk_shared.jsp(172,48) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f6.setBundle("personalwork");
      // /netdisk/netdisk_mydisk_shared.jsp(172,48) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_mydisk_shared.jsp(173,30) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f7.setBundle("personalwork");
      // /netdisk/netdisk_mydisk_shared.jsp(173,30) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_mydisk_shared.jsp(174,41) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f8.setBundle("personalwork");
      // /netdisk/netdisk_mydisk_shared.jsp(174,41) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_mydisk_shared.jsp(177,46) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f9.setBundle("common");
      // /netdisk/netdisk_mydisk_shared.jsp(177,46) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
