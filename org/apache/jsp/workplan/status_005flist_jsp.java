 ...
 * Generated at: 2023-01-06 09:42:15 UTC
      ...
      try {
		...
		Object[] obj;
                  ...
                  try {
                    ...
                    // /workplan/status_list.jsp(82,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("statusList");
                    // /workplan/status_list.jsp(82,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("statusList");
                    // /workplan/status_list.jsp(82,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(index%2 == 0){
                        ...
                        out.write(">\r\n\t\t\t\t<td class=\"");
                        out.print(listClass);
                        out.write("\" align=\"left\"><input type=\"checkbox\" id=\"statusId\" name=\"statusId\"  value=\"");
                        out.print(obj[0]);
                        out.write("\"></td>\r\n\t\t\t\t<td class=\"");
                        out.print(listClass);
      ...
      out.write("\r\n<script src=\"/jsoa/js/util.js\"></script>\r\n<script language=\"JavaScript\" type=\"text/JavaScript\">\r\n<!--\r\nfunction MM_openBrWindow(theURL,winName,features) { //v2.0\r\n  JSMainWinOpenNew(theURL,winName,features);\r\n}\r\nfunction modify(id){\r\n\tJSMainWinOpenNew(\"/jsoa/WorkplanSetAction.do?action=statusmodify&statusId=\"+id,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=300');\r\n}\r\nfunction del(){\r\n\tvar ids=getBatchIDs();\r\n\tif(ids!=\"\"){\r\n\t\tdeleteItem(ids)\r\n\t}else{\r\n\t\talert(\"请选择要删除的记录!\");\r\n\t}\r\n}\r\nfunction deleteItem(ids){\r\n\tif(confirm(\"您确实要删除选中的记录吗!\")){\r\n\t\tlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/WorkplanSetAction.do?action=deletestatus&statusId=\"+ids;\r\n\t}\r\n}\r\nfunction getBatchIDs(){\r\n\tvar ckObj=document.getElementsByName(\"statusId\");\r\n\tvar ids=\"\";\r\n\tfor(var i=0;i<ckObj.length;i++){\r\n\t\tif(ckObj[i].checked){\r\n\t\t\tids+=ckObj[i].value+\",\";\r\n\t\t}\r\n\t}\r\n\tif(ids.length>1){\r\n\t\tids=ids.substring(0,(ids.length-1));\r\n\t}\r\n\treturn ids;\r\n\t\r\n}\r\nfunction changePanle(obj,cURL){\r\n");
