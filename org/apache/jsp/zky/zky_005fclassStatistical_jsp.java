...
public final class zky_005fclassStatistical_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String userClass = request.getAttribute("userClass")==null?(null==request.getParameter("userClass")?"":request.getParameter("userClass")):request.getAttribute("userClass").toString();
...
if(searchEndDate.equals("")){
      ...
      out.write("/>\r\n\t\t\t\t\t\t\t\t  </td>\r\n\t\t\t\t\t\t\t      <td align=\"right\">\r\n\t\t\t\t\t\t\t\t    <input type=\"button\" class=\"btnButton2Font\" onClick=\"searchSubmit();\" value=\"查询\" />\r\n\t\t\t\t\t\t\t\t\t<input type=\"button\" class=\"btnButton2Font\" onClick=\"searchReset();\" value=\"重置\" />\r\n\t\t\t\t\t\t\t\t  </td>\r\n\t\t\t\t\t\t\t\t  <td width=\"20\">&nbsp;</td>\r\n\t\t\t\t\t\t\t </tr>\r\n\t\t\t\t\t\t</table>\r\n\t\t\t\t    </form> \r\n\t\t\t\t\t<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"inlineBottomLine\">\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t  <td align=\"right\">\r\n\t\t\t\t\t\t  ");
						  ...
						  java.util.Map<String,String> sumMap=(java.util.Map<String,String>)request.getAttribute("sum_stat");
...
if(orderBy == null || !orderBy.equals("count")){
      ...
      out.write("\r\n                          </td>\r\n\t\t\t\t\t\t  <td class=\"listTableHead\"  width=\"20%\">金额&nbsp;&nbsp;\r\n\t\t\t\t\t\t  ");
...
Object[] obj; 
      ...
      try {
        ...
        // /zky/zky_classStatistical.jsp(150,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("classStatistical");
        // /zky/zky_classStatistical.jsp(150,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("classStatistical");
        // /zky/zky_classStatistical.jsp(150,7) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setScope("request");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object classStatistical = null;
          ...
          classStatistical = (java.lang.Object) _jspx_page_context.findAttribute("classStatistical");
          do {
            out.write("\r\n\t\t\t\t\t\t ");

						 	obj=(Object[])classStatistical;
							index ++;
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\t}\r\n\tdocument.getElementById(\"classStatistical\").submit();\r\n}\r\n//重置,清空所有数据\r\nfunction searchReset(){\r\n\tdocument.getElementById(\"medicalName\").value=\"\";\r\n\tdocument.getElementById(\"userClass\").value=\"\";\r\n\tdocument.getElementById(\"searchBeginDate\").value=\"\";\r\n\tdocument.getElementById(\"searchEndDate\").value=\"\";\r\n\tdocument.getElementById(\"checkbox\").value=\"\";\r\n\tdocument.getElementById(\"classStatistical\").submit();\r\n}\r\n//排序\r\nfunction orderBy(type,sortType){\r\n    window.location.href=\"/jsoa/ZkyMedicalAction.do?action=classStatistical&orderBy=\"+type+\"&sortType=\"+sortType+\"&medicalName=");
      out.print(medicalName);
      out.write("&userClass=");
      out.print(userClass);
      out.write("\";\r\n}\r\n//导出excel\r\nfunction exportLog(){\t\r\n\twindow.location.href=\"/jsoa/ZkyMedicalAction.do?action=classStatistical&export=stalical_list_export&medicalName=");
      out.print(medicalName);
      out.write("&checkbox=");
      out.print(checkbox);
