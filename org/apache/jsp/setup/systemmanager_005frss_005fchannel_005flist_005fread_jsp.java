 ...
 * Generated at: 2023-01-06 09:51:22 UTC
...
public final class systemmanager_005frss_005fchannel_005flist_005fread_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int offset1=index;
      ...
      try {
        ...
        // /setup/systemmanager_rss_channel_list_read.jsp(60,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("rssChannelList");
        // /setup/systemmanager_rss_channel_list_read.jsp(60,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("rssChannelList");
        // /setup/systemmanager_rss_channel_list_read.jsp(60,7) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            out.write("\r\n\t\t\t\t\t\t\t\t");
											...
											String categoryId = obj[4].toString();
											index++;
											if(index%2 != 0){
            ...
            out.print(listClass);
            out.write("\">\r\n\t\t                                ");
            out.print(RssCategoryChannelForm.getChannelNameById(channelId) );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t                                ");
            out.print(RssCategoryChannelForm.getChannelURLById(channelId) );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t                                ");
            ...
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t");
if(state.equals("0")){ 
            out.write("\r\n\t\t\t\t\t\t\t\t\t<img src=\"images/modi.gif\" alt=\"订阅\" style=\"cursor:pointer\" onclick=\"orderRss(");
            out.print(obj[0]);
            out.write(',');
            out.print(obj[3]);
            out.write(")\" >\r\n                                    ");
}else{ 
            out.write("\r\n\t\t\t\t\t\t\t\t\t<img src=\"images/del.gif\" alt=\"取消订阅\" style=\"cursor:pointer\" onclick=\"delSingle(");
            out.print(channelId);
            out.write(")\" >\r\n\t\t\t\t\t\t\t\t\t");
} 
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t");
...
String pagerURL = "/jsoa/rssChannel.do";
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("/rssOrder.do?method=orderRssChannel&categoryId=\"+categoryId+\"&channelId=\"+channelId;\r\n   jumpMain(url);\r\n}\r\n\r\nfunction goProOrderRss(){\r\n   var url=\"");
      out.print(request.getContextPath());
      out.write("/rssCategoryChannel.do?method=goRssChannelList&selectType=readonly\";\r\n   jumpMain(url);\r\n}\r\n\r\nfunction delSingle(channelId){\r\n   var url=\"");
      out.print(request.getContextPath());
      out.write("/rssOrder.do?method=removeRssOrder&channelId=\"+channelId;\r\n   jumpMain(url);\r\n   window.parent.menuTop.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/ChannelMenuAction.do?channelType=0&userChannelName=知识管理\";\r\n}\r\n\r\n\r\n\r\n</script>\r\n");
