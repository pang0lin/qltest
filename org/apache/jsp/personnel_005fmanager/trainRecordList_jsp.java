 ...
 * Generated at: 2023-01-06 09:52:46 UTC
...
public final class trainRecordList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(!deleteSuccess.booleanValue()){
	...
	java.util.Date newDate = new java.util.Date();
        ...
        if (request.getAttribute("beginDate")!= null){
            ...
            java.util.regex.Matcher m1 = p1.matcher(request.getAttribute("beginDate").toString());
            m1.find();
            b_year= m1.group(1);
            b_month = m1.group(2);
            b_day = m1.group(3);
		...
		java.util.regex.Matcher m2 = p2.matcher(request.getAttribute("endDate").toString());
                m2.find();
		e_year= m2.group(1);
            	e_month = m2.group(2);
            	e_day = m2.group(3);
      ...
      out.write("\r\n<body   class=\"MainFrameBox\" onload=\"document.all.trainClass.value='");
      out.print(trainClass);
      out.write("'\" onKeyDown=\"if(event.keyCode==13) search();\" style=\"BACKGROUND-COLOR:transparent\">\r\n\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n");
      //  html:form
      ...
      try {
        ...
        // /personnel_manager/trainRecordList.jsp(88,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("/TrainRecordAction.do?flag=search");
        // /personnel_manager/trainRecordList.jsp(88,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setMethod("post");
        int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
        if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n<table width=\"100%\"\tborder=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n\t<tr>\r\n\t  <td  width=\"80\" nowrap=\"nowrap\">&nbsp;&nbsp;培训名称：</td>\r\n\t  <td width=\"40%\" align=\"left\">");
            if (_jspx_meth_html_005ftext_005f0(_jspx_th_html_005fform_005f0, _jspx_page_context))
              return;
            out.write("\r\n\t  </td>\r\n\t  <td width=\"80\" nowrap=\"nowrap\">参加人：</td>\r\n\t  <td width=\"45%\" align=\"left\">");
            if (_jspx_meth_html_005ftext_005f1(_jspx_th_html_005fform_005f0, _jspx_page_context))
              return;
            out.write("</td>\r\n\t</tr>\r\n\t<tr>\r\n\t  <td nowrap=\"nowrap\">&nbsp;&nbsp;培训种类：</td>\r\n\t  <td width=\"40%\" align=\"left\">");
            //  html:select
            ...
            try {
              ...
              // /personnel_manager/trainRecordList.jsp(99,32) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fselect_005f0.setProperty("trainClass");
              // /personnel_manager/trainRecordList.jsp(99,32) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fselect_005f0.setStyle("width:65.5%;");
              ...
              if (_jspx_eval_html_005fselect_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  try {
                    ...
                    // /personnel_manager/trainRecordList.jsp(101,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("List");
                    // /personnel_manager/trainRecordList.jsp(101,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("trainClassList");
                    // /personnel_manager/trainRecordList.jsp(101,7) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
Object[] obj = (Object[]) List;
            ...
            out.print(e_day);
            out.write(");\r\n\t\t   </script>\r\n\t\t    ");
 if(request.getAttribute("pxrqchecked") != null && "1".equals((String)request.getAttribute("pxrqchecked"))){ 
            out.write("\r\n\t\t    <input type=\"checkbox\" name=\"pxrq\" value=\"1\" checked>\r\n\t\t\t");
}else{
            out.write("\r\n\t\t\t<input type=\"checkbox\" name=\"pxrq\" value=\"0\" >\r\n\t\t\t");
}
            out.write("\r\n       </td>\r\n\t   <td></td>\r\n\t   \t<td  align=\"right\"  nowrap>\r\n\t\t\t<button  class=\"btnButton2Font\" onclick=\"search();\" style=\"cursor:pointer\">查询</button>\r\n\t\t\t<button  class=\"btnButton2Font\" onclick=\"cleared();\" style=\"cursor:pointer\">重置</button>\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<table width=\"100%\"\theight=\"25\"\tborder=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n\t<tr>\r\n\t  <td align=\"right\">\r\n\t      ");
 if(new ManagerService().
                    hasRight(session.getAttribute("userId").toString(),
                             "07*32*02")){ 
            out.write("\r\n\t\t  <button  class=\"btnButton2Font\" onClick=\"javascript:MM_openBrWindow('/jsoa/TrainRecordAction.do?flag=add','','scrollbars=yes,resizable=no,width=600,height=350')\">新增</button>\r\n\t\t  ");
}
            out.write("\r\n\t\t  ");
 if(new ManagerService().
                    hasRight(session.getAttribute("userId").toString(),
                             "07*32*02")){ 
            out.write("\r\n\t\t  <button  class=\"btnButton2Font\" onClick=\"javascript:batchDelete()\">删除</button>\r\n\t\t  <button class=\"btnButton2Font\" onclick=\"exportExcel();\" style=\"cursor:pointer\">导出</button>\r\n\t\t  ");
 } 
            out.write("\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n\r\n\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\t\t<tr align=\"center\">\r\n\t\t\t<td width=\"2%\" class=\"listTableHead\" nowrap>\r\n\t\t\t\t<input type=\"checkbox\" value=\"1\" name=\"selectAllBox\" onClick=\"selectAll(this);\" ></td>\r\n\t\t\t<td class=\"listTableHead\" width=\"15%\"> 培训名称 </td>\r\n\t\t\t<td class=\"listTableHead\" width=\"10%\"> 开始日期 </td>\r\n\t\t\t<td class=\"listTableHead\" width=\"10%\"> 结束日期 </td>\r\n\t\t\t<td class=\"listTableHead\" width=\"15%\"> 培训种类 </td>\r\n\t\t\t<td class=\"listTableHead\" width=\"40%\"> 参与人 </td>\r\n\t\t\t<td width=\"8%\" class=\"listTableHeadLast\" nowrap>处理</td>\r\n\t\t</tr>\r\n\t\t");
            ...
            try {
              ...
              // /personnel_manager/trainRecordList.jsp(177,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setId("trainRecordList");
              // /personnel_manager/trainRecordList.jsp(177,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setName("trainRecordList");
              int _jspx_eval_logic_005fiterate_005f1 = _jspx_th_logic_005fiterate_005f1.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object trainRecordList = null;
                ...
                trainRecordList = (java.lang.Object) _jspx_page_context.findAttribute("trainRecordList");
                do {
                  out.write("\r\n\t\t");

		  trainRecordObj = (Object[]) trainRecordList;
		  index ++;
		  j++;
...
if(index%2 != 0){listClass="listTableLine2";}
                  ...
                  out.print(trainRecordObj[0]);
                  out.write("\" name=\"TrainRecordId\"></td>\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write("\"><a href=\"javascript:view('");
                  out.print(trainRecordObj[0]);
                  out.write("')\">");
                  out.print(trainRecordObj[1]);
                  out.write("</a></td>\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(trainRecordObj[3]==null?"&nbsp;":trainRecordObj[3].toString().substring(0,10));
                  out.write("</td>\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(trainRecordObj[4]==null?"&nbsp;":trainRecordObj[4].toString().substring(0,10));
                  out.write("</td>\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(trainRecordObj[5]==null?"&nbsp;":trainRecordObj[5]);
                  out.write("</td>\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(trainRecordObj[6]==null?"&nbsp;":trainRecordObj[6]);
                  out.write("</td>\r\n\t\t  <td class=\"");
                  out.print(listClass);
...
String pagerURL = "/jsoa/TrainRecordAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n</html>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction search(){\r\n\tTrainRecordActionForm.action = \"/jsoa/TrainRecordAction.do?flag=search\";\r\n    TrainRecordActionForm.submit();\r\n}\r\nfunction cleared(){\r\nTrainRecordActionForm.trainName.value = \"\";\r\nTrainRecordActionForm.trainActor.value = \"\";\r\nTrainRecordActionForm.trainClass.value = 0;\r\nTrainRecordActionForm.pxrq.checked = false;\r\nsearch();\r\n}\r\nfunction delSingle(id){\r\n");

   int deloff = j == 1? index1-15:index1;
   if(deloff<0) deloff = 0;

      out.write("\r\n    if(confirm(\"确实要删除吗？\")){\r\n\t    TrainRecordActionForm.action = \"/jsoa/TrainRecordAction.do?flag=delete&TrainRecordId=\" + id + \"&pager.offset=");
      out.print(deloff);
      out.write("\";\r\n        TrainRecordActionForm.submit();\r\n    }\r\n}\r\nfunction selectAll(obj){\r\n    if(document.all.TrainRecordId){\r\n        if(document.all.TrainRecordId.length){\r\n            for(var i = 0; i < document.all.TrainRecordId.length; i ++){\r\n                if(obj.checked){\r\n                    document.all.TrainRecordId[i].checked = true;\r\n                }else{\r\n                    document.all.TrainRecordId[i].checked = false;\r\n                }\r\n            }\r\n        }else{\r\n            if(obj.checked){\r\n                document.all.TrainRecordId.checked = true;\r\n            }else{\r\n                document.all.TrainRecordId.checked = false;\r\n            }\r\n        }\r\n    }\r\n}\r\nfunction batchDelete(){\r\n\r\n        if(checkboxIsChecked(document.all.TrainRecordId)){\r\n            var id = \"\";\r\n            if(document.all.TrainRecordId.length){\r\n                for(var i = 0; i < document.all.TrainRecordId.length; i ++){\r\n                    if(document.all.TrainRecordId[i].checked){\r\n                        id += document.all.TrainRecordId[i].value + \",\";\r\n");
      out.write("                    }\r\n                }\r\n            }else{\r\n                if(document.all.TrainRecordId.checked){\r\n                    id = document.all.TrainRecordId.value;\r\n                }\r\n            }\r\n            if(id.indexOf(\",\") > 0){\r\n                id = id.substring(0, id.length - 1);\r\n            }\r\n            if(confirm(\"确实要删除吗？\")){\r\n\t\t\t TrainRecordActionForm.action = \"/jsoa/TrainRecordAction.do?flag=delete&TrainRecordId=\" + id + \"");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("\";\r\n             TrainRecordActionForm.submit();\r\n            }\r\n        }else{\r\n            alert(\"请选择要删除的记录！\");\r\n        }\r\n}\r\n\r\nfunction modify(id){\r\n\tif(document.all.pxrq.checked){\r\n    MM_openBrWindow('/jsoa/TrainRecordAction.do?flag=modify&TrainRecordId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("&trainSearchName='+document.all.trainName.value+'&trainSearchActor='+document.all.trainActor.value+'&trainSearchClass='+document.all.trainClass.value+'&beginSearchDate='+document.all.beginDate.value+'&endSearchDate='+document.all.endDate.value+'&pxrq='+document.all.pxrq.value,'','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=600,height=350')\r\n\t}else{\r\n       MM_openBrWindow('/jsoa/TrainRecordAction.do?flag=modify&TrainRecordId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("&trainSearchName='+document.all.trainName.value+'&trainSearchActor='+document.all.trainActor.value+'&trainSearchClass='+document.all.trainClass.value+'&beginSearchDate='+document.all.beginDate.value+'&endSearchDate='+document.all.endDate.value,'','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=600,height=350')\r\n\t}\r\n}\r\n\tfunction view(id){\r\n    MM_openBrWindow('/jsoa/TrainRecordAction.do?flag=view&TrainRecordId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=600,height=350')\r\n}\r\n\r\nfunction exportExcel() {\r\n\t//TrainRecordActionForm.target = \"_blank\";\r\n\tTrainRecordActionForm.action = \"/jsoa/TrainRecordAction.do?flag=export\";\r\n\tTrainRecordActionForm.submit();\r\n\tTrainRecordActionForm.action = \"/jsoa/TrainRecordAction.do?flag=search\";\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personnel_manager/trainRecordList.jsp(92,32) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setProperty("trainName");
      // /personnel_manager/trainRecordList.jsp(92,32) name = onkeypress type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setOnkeypress("return look() ;");
      // /personnel_manager/trainRecordList.jsp(92,32) name = onkeyup type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setOnkeyup("value=checkQuery(this,'培训名称')");
      // /personnel_manager/trainRecordList.jsp(92,32) name = onblur type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setOnblur("value=checkQuery1(this,'培训名称')");
      // /personnel_manager/trainRecordList.jsp(92,32) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyleClass("inputtext");
      // /personnel_manager/trainRecordList.jsp(92,32) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyle("width:65.5%;");
  ...
  private boolean _jspx_meth_html_005ftext_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personnel_manager/trainRecordList.jsp(95,32) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setProperty("trainActor");
      // /personnel_manager/trainRecordList.jsp(95,32) name = onkeypress type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setOnkeypress("return look() ;");
      // /personnel_manager/trainRecordList.jsp(95,32) name = onkeyup type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setOnkeyup("value=checkQuery(this,'参加人')");
      // /personnel_manager/trainRecordList.jsp(95,32) name = onblur type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setOnblur("value=checkQuery1(this,'参加人')");
      // /personnel_manager/trainRecordList.jsp(95,32) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setStyleClass("inputtext");
      // /personnel_manager/trainRecordList.jsp(95,32) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setStyle("width:55%;");
