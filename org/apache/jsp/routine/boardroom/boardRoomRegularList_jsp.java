...
public final class boardRoomRegularList_jsp extends org.apache.jasper.runtime.HttpJspBase
	...
	if(request.getAttribute("boardroomApplyType") !=null){
		boardroomApplyType = request.getAttribute("boardroomApplyType").toString();
            ...
            try {
              ...
              // /routine/boardroom/boardRoomRegularList.jsp(81,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/BoardRoomAction.do?action=boardRoomUseSearch");
              // /routine/boardroom/boardRoomRegularList.jsp(81,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  try {
                    ...
                    // /routine/boardroom/boardRoomRegularList.jsp(97,32) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("List");
                    // /routine/boardroom/boardRoomRegularList.jsp(97,32) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("boardroomApplyTypeList");
                    // /routine/boardroom/boardRoomRegularList.jsp(97,32) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
Object[] obj = (Object[]) List;
		...
		String[] circleStr = new String[]{"每周","每月","每年"};
            ...
            try {
              ...
              // /routine/boardroom/boardRoomRegularList.jsp(139,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setId("List");
              // /routine/boardroom/boardRoomRegularList.jsp(139,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setName("boardroomRegularList");
	...
	String[] weekStr = new String[]{"周日","周一","周二","周三","周四","周五","周六"};
		...
		Object[] obj = (Object[])List;
		BoardRoomRegularPO regularPO = (BoardRoomRegularPO)obj[13];
		String beginTime = (regularPO.getEveryMeetingBeginTime()/60)+":"+(regularPO.getEveryMeetingBeginTime()%60);
		String endTime = (regularPO.getEveryMeetingEndTime()/60)+":"+(regularPO.getEveryMeetingEndTime()%60);
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(((BoardRoomApplyTypePO)obj[9]).getType() );
                  out.write("&nbsp;</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(circleStr[regularPO.getMeetingCircle()-1] );
                  out.write("&nbsp;</td>\r\n\t\t");
String meetingTime = "";
		if(regularPO.getMeetingCircle()==1){//每周 
			if(regularPO.getMeetingLength()==1){
				meetingTime = "每周 "+weekStr[Integer.valueOf(regularPO.getEveryMeetingBegin())]+" "+beginTime+" 到 "+endTime;
			}else{
				meetingTime = "每周 "+weekStr[Integer.valueOf(regularPO.getEveryMeetingBegin())]+" "+beginTime+" 到 "+
										weekStr[Integer.valueOf(regularPO.getEveryMeetingEnd())]+" "+endTime;
			}
		}else if(regularPO.getMeetingCircle()==2){//每月
			if(regularPO.getMeetingLength()==1){
				meetingTime = "每月 "+regularPO.getEveryMeetingBegin()+"日 "+beginTime+" 到 "+endTime;
			}else{
				meetingTime = "每月 "+regularPO.getEveryMeetingBegin()+"日 "+beginTime+" 到 "+regularPO.getEveryMeetingEnd()+"日 "+endTime;
			}
		}else{//每年
			if(regularPO.getMeetingLength()==1){
				meetingTime = "每年 "+regularPO.getEveryMeetingBegin().replace("-","月")+"日 "+beginTime+" 到 "+endTime;
			}else{
				meetingTime = "每年 "+regularPO.getEveryMeetingBegin().replace("-","月")+"日 "+beginTime+" 到 "+
										regularPO.getEveryMeetingEnd().replace("-","月")+"日 "+endTime;
			}
		}
                  out.write("\r\n\t\t<td class=\"");
                  out.print(listClass);
		...
		if(maintenanceBoardRoomIds.indexOf(","+obj[1]+",")>=0){
			if((obj[10]+"").equals(session.getAttribute("userId")+"")){
                  ...
                  out.write("<img style=\"cursor:pointer\" border=\"0\" src=\"images/del.gif\" title=\"删除\" onclick=\"cancel('");
                  out.print(obj[0] );
                  out.write("')\">\r\n\t\t");
}else if((obj[10]+"").equals(session.getAttribute("userId")+"")){ 
                  ...
                  out.write('\'');
                  out.print(obj[2] );
                  out.write("')\">\r\n\t\t<img style=\"cursor:pointer\" border=\"0\" src=\"images/del.gif\" title=\"删除\" onclick=\"cancel('");
                  out.print(obj[0] );
                  out.write("')\">\r\n\t\t");
} 
                  out.write("\r\n\t\t&nbsp;</td>\r\n\t</tr>\r\n\t");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n<script language=\"javascript\">\r\nfunction search(){\r\n    //\tdocument.BoardRoomActionForm.submit();\r\n    var hhref = \"&searchBoardRomeName=\"+document.all.searchBoardRomeName.value+\"&searchBoardRomeEmcee=\"+\r\n\t\t    document.all.searchBoardRomeEmcee.value+\"&searchBoardRomeMotif=\"+document.all.searchBoardRomeMotif.value+\r\n\t\t    \"&searchApplyName=\"+document.all.searchApplyName.value+\"&boardroomApplyType=\"+document.all.boardroomApplyType.value;\r\n\twindow.location.href=\"/jsoa/BoardRoomAction.do?action=boardroomRegularView&saveType=boardRoomUseSearch\"+hhref;\r\n}\r\n\r\nfunction cleared(){\r\n    window.location.href=\"/jsoa/BoardRoomAction.do?action=boardroomRegularView\";\r\n}\r\n\r\nfunction view(id,name){\r\n\tMM_openBrWindow('BoardRoomAction.do?action=selectBoardroomApplyView&boardroomApplyId='+id+'&boardroomName='+name+'&type=view&executeStatus=false','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=580')\r\n}\r\n\r\nfunction modify(id,name){\r\n\tMM_openBrWindow('BoardRoomAction.do?action=selectBoardroomApplyModify&boardroomApplyId='+id+'&boardroomName='+name+'&type=view','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=580')\r\n");
            out.write("}\r\n\r\nfunction cancel(id){\r\n\tif(confirm(\"确实要删除这次预定申请吗？\")){\r\n\t\tif(confirm(\"即将删除与本次预定申请相关所有预定信息及会议记录，您确定删除吗？\")){\r\n\t\t\twindow.location.href=\"/jsoa/BoardRoomAction.do?action=deleteRegularApply&boardroomApplyId=\"+id+\"&saveType=\"+document.all.saveType.value+\"&searchBoardRomeName=\"+document.all.searchBoardRomeName.value+\"&searchBoardRomeEmcee=\"\r\n\t\t\t\t            +document.all.searchBoardRomeEmcee.value+\"&searchBoardRomeMotif=\"+document.all.searchBoardRomeMotif.value\r\n\t\t\t\t            +\"&searchApplyName=\"+document.all.searchApplyName.value+\"&boardroomApplyType=\"+document.all.boardroomApplyType.value\r\n\t\t\t\t            +\"&pager.offset=");
            out.print(request.getParameter("pager.offset"));
            out.write("\";\t\r\n\t\t\talert(\"会议预定信息删除成功！\");\r\n\t\t}\r\n    }\r\n}\r\n\r\nfunction finish(id, id2, name, meetingDate, startTime, endTime,boardroomId,emproomtype){\r\n\tif(confirm(\"确实要结束这次会议吗？\")){\r\n\t\tMM_openBrWindow('/jsoa/routine/boardroom/boardRoomApply_finish.jsp?boardroomApplyId='+id+'&meetingId='+id2+'&name='+name+'&meetingDate='+meetingDate+'&startTime='+startTime+'&endTime='+endTime+'&boardroomId='+boardroomId+'&emproomtype='+emproomtype,'','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=450,height=250')\r\n\t}\r\n}\r\nfunction hidserch()\r\n{    \r\n     var stable=document.getElementById(\"searchBar\");\r\n     var sbutton=document.getElementById(\"hiddenSearch\");\r\n     if(stable.style.display==\"none\"){\r\n\t\tstable.style.display=\"\";\r\n\t\tsbutton.value=\"关闭查询\";\r\n      \r\n     }else{\r\n\t     stable.style.display=\"none\";\r\n\t     sbutton.value=\"查询\";\r\n     \r\n     }\r\n}\r\n\r\n</script>\r\n");
