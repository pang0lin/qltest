...
public final class doc_005fsendfile_005faddifrm1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n<script>\r\n var sealArr = new Array() ;\r\n\r\n function createSealArr(id,name) {\r\n    \t//\t alert(id+name) ;\r\n\t var sealItem = new Array(2) ;\r\n\t sealItem[0] = id ;\r\n\t sealItem[1] = name  ;\r\n\t sealArr[sealArr.length] = sealItem ;\r\n }\r\n\r\nfunction addOption(obj){\r\n        //清除原来的选项\r\n\t   var old\t= obj.length;\r\n\t   for (var x = old ; x >=0 ; x-- ) {\r\n       \t   obj.options[x]=null;\r\n       \t   obj.options.remove(x);\r\n        }\r\n        var cur = sealArr.length ;\r\n\r\n\t obj.add(document.createElement(\"OPTION\"));\r\n\t obj.options[0].innerText = \"-------请选择-------\";\r\n         obj.options[0].value = \"-1\";\r\n\t     for(var i = 1;i <=cur ;i ++){\r\n                 obj.add(document.createElement(\"OPTION\"));\r\n                 obj.options[i].innerText = sealArr[i-1][1];\r\n                 obj.options[i].value = sealArr[i-1][0];\r\n\t     }\r\n\r\n }\r\n\r\n</script>\r\n");
      //  logic:iterate
      ...
      try {
        ...
        // /doc/doc/doc_sendfile_addifrm1.jsp(42,0) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("seallist");
        // /doc/doc/doc_sendfile_addifrm1.jsp(42,0) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("seallist");
        // /doc/doc/doc_sendfile_addifrm1.jsp(42,0) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
Object[] obj  = (Object[])seallist ;
      ...
      out.write("\r\n\r\n\r\n <script language=\"javascript\">\r\n //alert(parent.document.all.sendFileSealId) ;\r\n //alert(sealArr) ;\r\n addOption(parent.document.all.sendFileSealId);\r\n </script>\r\n");
