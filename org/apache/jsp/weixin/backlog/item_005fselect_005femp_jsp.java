...
public final class item_005fselect_005femp_jsp extends org.apache.jasper.runtime.HttpJspBase
...
public String getUserByGroup(String groupIdStr) {
    ...
    try {
        ...
        java.sql.ResultSet rs = stmt.executeQuery(
                "SELECT DISTINCT EMP_ID FROM ORG_USER_GROUP WHERE GROUP_ID IN (" + groupIdStr + ")");
        while (rs.next()) {
...
String dealTip = null!=request.getParameter("dealTips") ? request.getParameter("dealTips") : "";
...
//当前节点的批示意见类型
String actiCommFieldType = request.getParameter("actiCommFieldType");
	...
	switch(participantType){
		...
		case 4:
			...
			if("211".equals(fieldShow) || "210".equals(fieldShow)){//多选人,单选人
				...
				selectUserName = users[0].substring(0, users[0].length() - 1);
...
if(request.getParameter("wechatShowDoc")!=null){
	...
	wechatShowDoc2 = request.getParameter("wechatShowDoc");
      ...
      out.write("\"/>\r\n\t\t\t\t\r\n\t\t\t\t<input type=\"hidden\" id=\"operIdSearch\" name=\"operIdSearch\" value=\"");
      out.print(operId );
