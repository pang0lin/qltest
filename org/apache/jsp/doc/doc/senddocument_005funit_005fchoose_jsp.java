...
public final class senddocument_005funit_005fchoose_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(unitTypeObj!=null&&unitTypeObj.length>0){
            ...
            try {
              ...
              // /doc/doc/senddocument_unit_choose.jsp(79,2) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("SenddocumentBaseAction.do?action=unitlist_choose");
              // /doc/doc/senddocument_unit_choose.jsp(79,2) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.print(fieldId);
                  out.write("\">\r\n<table width=\"100%\" height=\"10\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n  <tr>\r\n    <td align=\"left\"><input type=\"radio\" name=\"isAllName\" value=\"1\" checked/>选用全称  \r\n                \t <input type=\"radio\" name=\"isAllName\" value=\"2\"/>选用简称\r\n\t</td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\r\n     <tr align=\"center\">\r\n\t\t<td  width=\"8%\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"chkSelect\" style=\"cursor:'hand'\" onclick=\"selectAll(this)\">序号</td>\r\n\t\t<td  width=\"15%\"  class=\"listTableHead\">单位分类  ");
if(orderBy == null || !orderBy.equals("unitType")){
                  ...
                  out.write("</td>\r\n\t\t<td  class=\"listTableHead\">单位全称</td>\r\n\t\t\r\n\t\t<td width=\"20%\" class=\"listTableHeadLast\">单位简称</td>\r\n\t </tr>\r\n\t ");
	 ...
	 String listClass="listTableLine1";
                  ...
                  try {
                    ...
                    // /doc/doc/senddocument_unit_choose.jsp(108,5) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("mylist");
                    // /doc/doc/senddocument_unit_choose.jsp(108,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("mylist");
                    // /doc/doc/senddocument_unit_choose.jsp(108,5) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t</td>\r\n  </tr>\r\n</table>\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n  <tr>\r\n    <td align=\"left\">\r\n\r\n\t    <button class=\"btnButton2Font\" onClick=\"closeOK();\">选中</button>\r\n\t\t<button class=\"btnButton2Font\" onClick=\"tuichu();\">退出</button>\r\n\r\n\t</td>\r\n  </tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n");
      ...
      out.write("\t\t\t  }else{\r\n\t\t\t   retText+=objArr[2]+',';\t  \r\n\t\t\t  }\r\n\t\t\t\r\n\t\t\t  \r\n                \t/*retvalue +=objvalue.substring(0,objvalue.indexOf(\";\")) ;\r\n\t\t\t\t\r\n                        retvalue += \",\" ;\r\n\r\n\t\t\t\t\t\tretText+=objvalue.substring(objvalue.indexOf(\";\")+1);\r\n                        retText+=\",\";*/\r\n\r\n\t\t}\r\n         }\r\n    }\r\n\r\n\r\n   if(retText.length>1){\r\n\t\t retText=retText.substring(0,retText.length-1);\r\n\t\r\n\t}\r\n\tif(retvalue.length>1){\r\n\t\t retvalue=retvalue.substring(0,retvalue.length-1);\r\n\t}\r\n \r\n     if(eval(\"opener.window.document.all.\"+\"");
      out.print(field);
      out.write("\").value==\"\"){\r\n\teval(\"opener.window.document.all.\"+\"");
      out.print(field);
      out.write("\").value=eval(\"opener.window.document.all.\"+\"");
      out.print(field);
      out.write("\").value+retText;\r\n\teval(\"opener.window.document.all.\"+\"");
      out.print(fieldId);
      out.write("\").value=eval(\"opener.window.document.all.\"+\"");
      out.print(fieldId);
      out.write("\").value+retvalue;\r\n\t\tif(eval(\"opener.window.document.all.ReceiveFile_SendFileUnit\")){\r\n\t\t\teval(\"opener.window.document.all.ReceiveFile_SendFileUnit\").value=eval(\"opener.window.document.all.\"+\"");
      out.print(field);
      out.write("\").value+retText;\r\n\t\t}\r\n\t}else{\r\n\teval(\"opener.window.document.all.\"+\"");
      out.print(field);
      out.write("\").value=eval(\"opener.window.document.all.\"+\"");
      ...
      out.write("\").value+\",\"+retvalue;\r\n\t\tif(eval(\"opener.window.document.all.ReceiveFile_SendFileUnit\")){\r\n\t\t\teval(\"opener.window.document.all.ReceiveFile_SendFileUnit\").value=eval(\"opener.window.document.all.\"+\"");
      out.print(field);
      out.write("\").value+\",\"+retText;\r\n\t\t}\r\n\t}\r\n\twindow.close();\r\n\r\n}\r\n\r\n\r\n\r\nfunction orderBy(type,sortType){\r\n\r\n\t var myhref =\"/jsoa/SenddocumentBaseAction.do?action=unitlist_choose&orderBy=\" + type + \"&sortType=\" + sortType+\"&field=");
      out.print(field);
      out.write("&fieldId=");
      out.print(fieldId);
      out.write("\";\r\n\t  window.location.href = myhref;\r\n\r\n}\r\n\r\nfunction unsearcher(){\r\n\r\n var myhref =\"/jsoa/SenddocumentBaseAction.do?action=unitlist_choose&field=");
      out.print(field);
      out.write("&fieldId=");
      out.print(fieldId);
      out.write("\";\r\n window.location.href = myhref;\r\n}\r\n\r\nfunction searcher() {\r\n     if(document.all.unitType.value.indexOf(\"'\") >= 0){\r\n    \talert(\"搜索条件不能包含单引号！\");\r\n        return ;\r\n    }\r\n   var myhref =\"/jsoa/SenddocumentBaseAction.do?action=unitlist_choose&unitType=\"+document.all.unitType.value+\"&field=");
      out.print(field);
      out.write("&fieldId=");
      out.print(fieldId);
