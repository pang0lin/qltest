...
public final class chat_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
public static double getAttachSize(double d, int i) {
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String timeScan = (String)request.getAttribute("timeScan");	

      out.write("\r\n<html>\r\n<head>\r\n\t<meta http-equiv=\"Content-Type\" content=\"text/html; charset=GBK\">\r\n\r\n\t<title>聊天记录</title>\r\n\t<script language=\"JavaScript\"\r\n\t\tsrc=\"/jsoa/js/resource/zh_cn/CommonResource.js\"\r\n\t\ttype=\"text/javascript\"></script>\r\n\t<script language=\"JavaScript\"\r\n\t\tsrc=\"/jsoa/js/resource/zh_cn/MailResource.js\" type=\"text/javascript\"></script>\r\n\t<script src=\"/jsoa/js/util.js\"></script>\r\n\t<script language=\"javascript\" src=\"/jsoa/doc/form/ext/adapter/jquery/jquery.js\" type=\"text/javascript\"></script>\r\n\t<link href=\"/jsoa/skin/");
      out.print(session.getAttribute("skin"));
      out.write("/style-");
      out.print(session.getAttribute("browserVersion"));
      out.write(".css\" rel=\"stylesheet\" type=\"text/css\" />\r\n</head>\r\n\t\r\n<body class=\"MainFrameBox\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n\t<tr>\r\n\t\t<td>\r\n\r\n\t\t<form name=\"form1\" action=\"/jsoa/ChatAction.do?action=list&sortFlag=all\"\tmethod=\"post\" onSubmit=\"return checkinputs(document.form1);\">\r\n\t\t\t<table  width=\"100%\" id=\"searchTable\" style=\"display:none\"\tborder=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t");

						String senderName = request.getParameter("senderName");
						String toName = request.getParameter("toName");
						if (senderName == null || senderName.equalsIgnoreCase("null")) {
							senderName = "";
						}
						if (toName == null || toName.equalsIgnoreCase("null")) {
							toName = "";
						}
					
      out.write("\r\n\r\n\t\t\t\t\t<td align=\"left\">\r\n\t\t\t\t\t\t&nbsp;&nbsp;发件人：\r\n\t\t\t\t\t\t<input type=\"text\" name=\"senderName\" id=\"senderName\" size=\"12\" value=\"");
      out.print(senderName);
      out.write("\" />\r\n\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;\r\n\t\t\t\t\t\t&nbsp;收件人：\r\n\t\t\t\t\t\t<input type=\"text\" name=\"toName\" id=\"toName\" size=\"12\" value=\"");
      out.print(toName);
  ...
  String search = "senderName="+senderName+"&toName="+toName;
  if(request.getAttribute("toUserId")==null){ 
      out.write("\r\n    <td width=\"65%\" scope=\"col\" nowrap>\r\n     <div id=\"PanleDIV\" class=\"tabPanelSelected\" onClick=\"changePanle('/jsoa/ChatAction.do?action=list&sortFlag=all');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        ");
 if("shandongjiguanshiwuju".equals(com.js.util.config.SystemCommon.getCustomerName())){ 
      ...
      out.write("\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n\t  \r\n\t   <div class=\"btnBQspace AlignLeft\"></div>\r\n\t   <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle('/jsoa/getMessage.do?action=getAll&str=all');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n         ");
 if("shandongjiguanshiwuju".equals(com.js.util.config.SystemCommon.getCustomerName())){ 
 ...
 if("shandongjiguanshiwuju".equals(com.js.util.config.SystemCommon.getCustomerName())){ 
      ...
      out.write("\r\n    <td  scope=\"col\" align=\"right\" nowrap>\r\n    <select name=\"timeScan\" id=\"timeScan\" style=\"vertical-align:bottom;font-size:9pt;width:110px;\" onchange=\"query1();\">\r\n\t\t<option value=\"\">选择时间</option>\r\n\t\t<option value=\"new\" ");
if("new".equals(timeScan)){ 
      out.write(" selected=\"selected\" ");
} 
      out.write(">最近一周</option>\r\n\t\t<option value=\"week\" ");
if("week".equals(timeScan)){ 
      out.write(" selected=\"selected\" ");
} 
      out.write(">一周前</option>\r\n\t\t<option value=\"month\" ");
if("month".equals(timeScan)){ 
      out.write(" selected=\"selected\" ");
} 
      out.write(">一月前</option>\r\n\t\t<option value=\"tmonth\" ");
if("tmonth".equals(timeScan)){ 
      out.write(" selected=\"selected\" ");
} 
      out.write(">三月前</option>\r\n\t\t<option value=\"hyear\" ");
if("hyear".equals(timeScan)){ 
      out.write(" selected=\"selected\" ");
} 
      out.write(">半年前</option>\r\n\t\t<option value=\"all\" ");
if("all".equals(timeScan)){ 
      out.write(" selected=\"selected\" ");
} 
      out.write(">全部</option>\t\t\t\t\t\t\t\t\r\n\t </select>\r\n\t \t<input type=\"button\" class=\"btnButton2Font\" onclick=\"markAsRead()\" value=\"标记已读\"</button>\r\n      \t<input type=\"button\" class=\"btnButton2Font\" onClick=\"delChat()\" value=\"删除\" />\r\n      \t<input type=\"button\" class=\"btnButton4font\" onClick=\"chSearch(this)\" value=\"查询\" /> \r\n      </td>\r\n  </tr>\r\n</table>\r\n\t\t\t<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\"\r\n\t\t\t\tclass=\"listTable\">\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td width=\"40\" class=\"listTableHead\">\r\n\t\t\t\t\t\t<input type=\"checkbox\" name=\"selectAll\"\r\n\t\t\t\t\t\t\tonclick=\"javascript:selectAllItem();\">\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td width=\"7%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t状态\r\n\t\t\t\t\t\t");

						String sortFlag = request.getParameter("sortFlag");
						
      out.write("\t\t\t\t\t\t\r\n\t\t\t\t\t\t\r\n\t\t\t\t\t\t");

							if ("isread".equals(sortFlag)) {
						
      out.write("\r\n\t\t\t\t\t\t<a href=\"/jsoa/ChatAction.do?action=list&sortFlag=noread&");
      out.print(search );
      out.write("\">\r\n\t\t\t\t\t\t \t<img src=\"/jsoa/images/downsort.gif\" border=\"0\" title=\"按状态排序\"> \r\n\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t");

							}else if ("noread".equals(sortFlag)) {
						
      out.write("\r\n\t\t\t\t\t\t<a href=\"/jsoa/ChatAction.do?action=list&sortFlag=isread&");
      out.print(search );
      out.write("\">\r\n\t\t\t\t\t\t\t<img src=\"/jsoa/images/upsort.gif\" border=\"0\" title=\"按状态排序\">\r\n\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t");

							}else{
						
      out.write("\r\n\t\t\t\t\t\t<a href=\"/jsoa/ChatAction.do?action=list&sortFlag=isread&");
      out.print(search );
      out.write("\">\r\n\t\t\t\t\t\t\t<img src=\"/jsoa/images/blanksort.gif\" border=\"0\" title=\"按状态排序\">\r\n\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t");

							}
						
      out.write("\r\n\t\t\t\t\t</td>\r\n\r\n\t\t\t\t\t<td width=\"11%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t发件人\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td width=\"11%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t收件人\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td  class=\"listTableHead\">\r\n\t\t\t\t\t\t内容\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td width=\"12%\" class=\"listTableHead\">\r\n\t\t\t\t\t附件大小\r\n\t\t\t\t\t\t");

							if ("small".equals(sortFlag)) {
						
      out.write("\r\n\r\n\t\t\t\t\t\t<a href=\"/jsoa/ChatAction.do?action=list&sortFlag=big&");
      out.print(search );
      out.write("\"><img\r\n\t\t\t\t\t\t\t\tsrc=\"/jsoa/images/downsort.gif\" border=\"0\" title=\"按发送时间排序\">\r\n\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t");

							}else if ("big".equals(sortFlag)) {
						
      out.write("\r\n\t\t\t\t\t\t<a href=\"/jsoa/ChatAction.do?action=list&sortFlag=small&");
      out.print(search );
      out.write("\"><img\r\n\t\t\t\t\t\t\t\tsrc=\"/jsoa/images/upsort.gif\" border=\"0\" title=\"按发送时间排序\"> </a>\r\n\t\t\t\t\t\t");

							}else{
						
      out.write("\r\n\t\t\t\t\t\t<a href=\"/jsoa/ChatAction.do?action=list&sortFlag=small&");
      out.print(search );
      out.write("\"><img\r\n\t\t\t\t\t\t\t\tsrc=\"/jsoa/images/blanksort.gif\" border=\"0\" title=\"按发送时间排序\">\r\n\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t");

						}
						
      out.write("\r\n\t\t\t\t\t\t\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td width=\"15%\" class=\"listTableHeadLast\">\r\n\t\t\t\t\t\t发送时间\t\t\t\t\t\t\r\n\t\t\t\t\t\t");

							if ("timeup".equals(sortFlag)) {
						
      out.write("\r\n\t\t\t\t\t\t<a href=\"/jsoa/ChatAction.do?action=list&sortFlag=timedown&");
      out.print(search );
      out.write("\"><img\r\n\t\t\t\t\t\t\t\tsrc=\"/jsoa/images/downsort.gif\" border=\"0\" title=\"按发送时间排序\">\r\n\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t");

							}else if ("timedown".equals(sortFlag)) {
						
      out.write("\r\n\t\t\t\t\t\t<a href=\"/jsoa/ChatAction.do?action=list&sortFlag=timeup&");
      out.print(search );
      out.write("\"><img\r\n\t\t\t\t\t\t\t\tsrc=\"/jsoa/images/upsort.gif\" border=\"0\" title=\"按发送时间排序\"> </a>\r\n\t\t\t\t\t\t");
...
java.util.List list=(java.util.List)request.getAttribute("mylist");
                  ...
                  String chatStatus,chatSenderId,chatSenderName,chatToName,content,isRead,chatHasAttach,attachSize,chatTime;
      ...
      try {
        ...
        // /chat/chat_list.jsp(249,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("mylist");
        // /chat/chat_list.jsp(249,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("mylist");
        // /chat/chat_list.jsp(249,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            out.write("\r\n\t\t\t\t  ");
					...
					chatUserId=obj[0].toString();
					chatStatus=obj[1].toString();
					isRead=obj[2].toString();
					chatSenderId=obj[3]==null?"":obj[3].toString();
					chatSenderName=obj[4]==null?"":obj[4].toString();
					chatToName=obj[5]==null?"":obj[5].toString();
					
					content=obj[6]==null?"":obj[6].toString();
					chatTime=obj[7]==null?"":obj[7].toString();
					chatHasAttach=obj[8]==null?"":obj[8].toString();					
					attachSize = obj[9]==null?"0":obj[9].toString();
					chatId=obj[10]==null?"":obj[10].toString();
...
if (isRead.equals("0")) {
            out.write("\r\n\t\t\t\t\t\t\t<div id=\"status_");
            out.print(chatId);
            out.write("\" style=\"display:inline;cursor:pointer;width:18px;height:16px;background:url(images/icons.gif);background-repeat:no-repeat; background-position:-48px 1px\">&nbsp;</div>\r\n\t\t\t\t\t\t\t");
} else {
            out.write("\r\n\t\t\t\t\t\t\t<div style=\"display:inline;cursor:pointer;width:18px;height:16px;background:url(images/icons.gif);background-repeat:no-repeat; background-position:-48px -15px\">&nbsp;</div>\r\n\t\t\t\t\t\t\t");
}
            out.write("\r\n\t\t\t\t\t\t\t");
if (userID.equals(chatSenderId)&&"0".equals(chatStatus)) {
            out.write("\r\n\t\t\t\t\t\t\t<div style=\"display:inline;cursor:pointer;width:18px;height:16px;background:url(images/H.gif);background-repeat:no-repeat;background-position:0px 3px\">&nbsp;</div>\r\n\t\t\t\t\t\t\t");
} else {
            out.write("\r\n\t\t\t\t\t\t\t<div style=\"display:inline;cursor:pointer;width:18px;height:16px;background:url(images/G.gif);background-repeat:no-repeat;background-position:0px 3px\">&nbsp;</div>\r\n\t\t\t\t\t\t\t");
}
            out.write("\r\n\t\t\t\t\t\t</td>");
}else{ 
            out.write("\r\n\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\" style=\"text-align:center;\">\r\n\t\t\t\t\t\t<table width=\"100%\"\theight=\"20\"\tborder=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr><td width=\"50%\" align=\"right\">\r\n\t\t\t\t\t\t\t");
if (isRead.equals("0")) {
            out.write("\r\n\t\t\t\t\t\t\t<div id=\"status_");
            out.print(chatId);
            out.write("\" style=\"cursor:pointer;width:18px;height:16px;background:url(images/icons.gif);background-repeat:no-repeat; background-position:-48px 1px\">&nbsp;</div>\r\n\t\t\t\t\t\t\t");
} else {
            out.write("\r\n\t\t\t\t\t\t\t<div style=\"cursor:pointer;width:18px;height:16px;background:url(images/icons.gif);background-repeat:no-repeat; background-position:-48px -15px\">&nbsp;</div>\r\n\t\t\t\t\t\t\t");
}
            out.write("</td><td width=\"50%\" align=\"left\">\r\n\t\t\t\t\t\t\t");
if (userID.equals(chatSenderId)&&"0".equals(chatStatus)) {
            out.write("\r\n\t\t\t\t\t\t\t<div style=\"cursor:pointer;width:18px;height:16px;background:url(images/H.gif);background-repeat:no-repeat;background-position:0px 3px\">&nbsp;</div>\r\n\t\t\t\t\t\t\t");
} else {
            out.write("\r\n\t\t\t\t\t\t\t<div style=\"cursor:pointer;width:18px;height:16px;background:url(images/G.gif);background-repeat:no-repeat;background-position:0px 3px\">&nbsp;</div>\r\n\t\t\t\t\t\t\t");
}
            ...
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t ");
            out.print(chatSenderName );
            out.write("\r\n                        </td>\r\n\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\" title=\"");
            out.print(chatToName );
            out.write("\" >\r\n\t\t\t\t\t\t\t");
            ...
            out.write("\" title=\"");
            out.print(content );
            out.write("\"\r\n\t\t\t\t\t\t\tstyle=\"word-WRAP: break-word; CURSOR: pointer; font-size: 12px;");
if("0".equals(isRead)&&"1".equals(chatStatus)){
            ...
            out.print(isRead);
            out.write(")\">\r\n\t\t\t\t\t\t\t");
if (chatHasAttach.equals("1")) {
            out.write("\r\n\t\t\t\t\t\t\t\t\t<img src=\"/jsoa/images/fj2.gif\" title=\"附件\" style=\"margin-right:-10px;\">\r\n\t\t\t\t\t\t\t");
}
							if (content.length() > 30){
								content = content.substring(0, 30)+"...";
							}
								out.print("<a style=\"vertical-align:middle;height:20px;line-height:20px;padding-bottom:10px;\" onFocus=\"this.blur()\" href='#'>"+content+"</a>");
							
            out.write("\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t");
double kb = 1024;
							double accessorySize1 = Double.parseDouble(attachSize);
							out.print(getAttachSize(accessorySize1 / 1024, 2));
							
            out.write("KB\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t");

							if(chatTime.indexOf(":")>0){
      ...
      out.write("\r\n\t\t\t</table>\t\t\t\r\n\t\t</form>\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"pagebar\">\r\n \t<tr>\r\n      <td>\r\n\t  ");
	  	...
	  	String pagerURL = "/jsoa/ChatAction.do";
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n</td></tr></table>\r\n<iframe name=\"myIframe\" id=\"myIframe\" style=\"display:none;\" ></iframe>\r\n\t</body>\r\n</html>\r\n<script language=\"javascript\">\r\n\r\n     function checkinputs(obj){\t\t\r\n\t\t if(obj.senderName.value==\"\")\r\n\t\t  {\r\n\t\t    return false;\r\n\t\t  }\r\n\t\treturn true;\r\n\t }\r\n\r\n\t  function showChat(elem,id,isRead){ \r\n\t  \t\tif(\"0\"==isRead){\r\n\t  \t\t\t\r\n\t\t\t\telem.style.fontWeight=\"normal\";\r\n\t\t\t\tdocument.getElementById(\"status_\" + id).style.backgroundPosition=\"-48px -15px\";\r\n\t\t\t\t/*if(navigator.userAgent.indexOf(\"Trident/7.0\")>=0 || navigator.userAgent.indexOf(\"Firefox\")>=0){\r\n      \t\t\t \telem.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.children[0].children[0].children[0].children[0].children[0].style.backgroundPosition=\"-48px -15px\";\r\n                }else{\r\n                   elem.previousSibling.previousSibling.previousSibling.firstChild.style.backgroundPosition=\"-48px -15px\"; \t\r\n                }*/\r\n\t\t\t\t  \t \r\n\t\t\t}\t\t    \r\n\t\t\tvar wid=620;\r\n\t\t\tvar heigh=465;\t\r\n");
      out.write("\t\t\tJSMainWinOpen2('/jsoa/chat/showChat.jsp?id='+id+'&isRead='+isRead,'','',wid,heigh);\r\n\t  }\r\n  \t\r\n    function  delChat() {   \t   \r\n\t  var errflag=false; \r\n\t  var temp=\"\";  \r\n      for (var i = 0; i < document.getElementsByName(\"batchDel\").length; i++) {\t\t       \r\n           if (document.getElementsByName(\"batchDel\")[i].checked) {\t    \t\t                \r\n               temp=temp+document.getElementsByName(\"batchDel\")[i].value+\",\";\t\r\n               if(!errflag){\r\n               \t\terrflag=true; \r\n               }           \r\n           }                    \r\n       } \t\r\n      var timeScan;\r\n      timeScan=document.all.timeScan.options[document.all.timeScan.selectedIndex].value;\r\n      if(errflag==false&&temp==\"\"){   \r\n\t          alert(\"请选择要删除的聊天记录\"); \r\n\t  } else {   \r\n\t\tif(confirm(\"是否删除个人消息记录！\")){\t\r\n\t\t//点击确认删除后不再弹出刷新页面的提示更改   shilijun 2015/10/26    \r\n\t\t\tform1.action = \"/jsoa/ChatAction.do?action=list&flag=delete&chatId=\" + temp + \"&deltype=\" + timeScan;\r\n\t\t\tform1.submit();  \r\n\t       }      \r\n       }   \r\n     }  \r\n");
      out.write("     //标记已读\r\n     function markAsRead()\r\n     {\r\n     \tvar errflag=false; \r\n\t   \tvar temp=\"\";  \r\n\t    for (var i = 0; i < document.getElementsByName(\"batchDel\").length; i++)\r\n\t    {\t\t       \r\n        \tif (document.getElementsByName(\"batchDel\")[i].checked) \r\n        \t{         \r\n\t\t    \ttemp=temp+document.getElementsByName(\"batchDel\")[i].value+\",\";\t\r\n\t\t        if(!errflag)\r\n\t\t        {\r\n\t\t        \terrflag=true; \r\n\t\t        }           \r\n\t\t    }                    \r\n\t\t} \t\r\n\t    var timeScan;\r\n\t    timeScan=document.all.timeScan.options[document.all.timeScan.selectedIndex].value;\r\n\t    if(errflag==false&&temp==\"\")\r\n\t    {   \r\n\t\t\talert(\"请选择要标记已读的记录！\");        \r\n\t\t} \r\n\t\telse \r\n\t\t{   \r\n\t\t    if(confirm(\"是否标记已读的记录！\"))\r\n\t\t\t{\r\n\t\t\t\t//点击确认已读后不再弹出刷新页面的提示更改   shilijun 2015/10/26    \r\n\t\t\t\tform1.action = \"/jsoa/ChatAction.do?action=list&flag=markAsRead&chatId=\" + temp + \"&markype=\" + timeScan;\r\n\t\t\t    form1.submit();\r\n\t\t    }      \r\n\t    }   \r\n     }   \r\n\t function selectAllItem(){\r\n\t    var result=document.all.selectAll.checked;\t    \r\n");
      out.write("\t    if(document.all.batchDel){\r\n\t        if(isNaN(document.all.batchDel.length)){\r\n\t            document.all.batchDel.checked=result;\r\n\t        }else{\r\n\t            for(var i=0;i<document.all.batchDel.length;i++){\r\n\t                document.all.batchDel[i].checked=result;\r\n\t            }\r\n\t        }\r\n\t    }\r\n\t} \r\n\tfunction clear1()\r\n\t{\r\n\t  window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/ChatAction.do?action=list\";\r\n\t}\r\n\r\n\tfunction query1()\r\n\t{\r\n\t\tform1.submit();\r\n\t}\r\n\t\r\n\tfunction changePanle(cURL){\r\n\t   \r\n\t\tlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+cURL;\r\n\t}\r\n\tfunction chSearch(obj){\r\n\t\tif(obj.value == \"查询\"){\r\n\t\t\tobj.value = \"关闭查询\";\r\n\t\t\tdocument.all.searchTable.style.display=\"\";\r\n\t\t}else{\r\n\t\t\tobj.value = \"查询\";\r\n\t\t\tdocument.all.searchTable.style.display=\"none\";\r\n\t\t}\r\n\t}\r\n\r\n\t//此处为string类添加三个成员\r\n\tString.prototype.Trim = function(){ return Trim(this);}\r\n\tString.prototype.LTrim = function(){return LTrim(this);}\r\n");
      out.write("\tString.prototype.RTrim = function(){return RTrim(this);}\r\n\t\r\n\t//此处为独立函数\r\n\tfunction LTrim(str)\r\n\t{\r\n\t    var i;\r\n\t    for(i=0;i<str.length;i++)\r\n\t    {\r\n\t        if(str.charAt(i)!=\" \"&&str.charAt(i)!=\" \")break;\r\n\t    }\r\n\t    str=str.substring(i,str.length);\r\n\t    return str;\r\n\t}\r\n\tfunction RTrim(str)\r\n\t{\r\n\t    var i;\r\n\t    for(i=str.length-1;i>=0;i--)\r\n\t    {\r\n\t        if(str.charAt(i)!=\" \"&&str.charAt(i)!=\" \")break;\r\n\t    }\r\n\t    str=str.substring(0,i+1);\r\n\t    return str;\r\n\t}\r\n\tfunction Trim(str)\r\n\t{\r\n\t    return LTrim(RTrim(str));\r\n\t}\r\n\t</script>\r\n");
