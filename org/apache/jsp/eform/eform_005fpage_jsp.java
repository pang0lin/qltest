...
public final class eform_005fpage_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getParameter("menuId")==null||"null".equals(request.getParameter("menuId"))){
      ...
      out.write("\r\n   ");
if(request.getParameter("saveShow")!=null){ 
      out.write("\r\n\tlocation.href=\"/jsoa/EFormPageAction.do?action=update&flag=1&formId=");
...
if(request.getParameter("stat")!=null && request.getParameter("stat").equals("1")){
      ...
      out.write("\r\n<body   class=\"MainFrameBox Pupwin\" onload=\"init();resizeWin(800,600);\" >\r\n<form name=\"form1\" action=\"/jsoa/EFormPageAction.do?action=save\" method=\"POST\">\r\n");
if(request.getParameter("t")!=null){ 
      out.write("<input type=\"hidden\" name=\"t\" id=\"t\" value=\"");
...
if(request.getParameter("collectId")!=null){ 
	...
	if(request.getParameter("apply")!=null){
      out.write("\r\n\t\t<input type=hidden name=isDelay id=isDelay value=\"");
      out.print(request.getParameter("apply"));
      out.write("\">\r\n\t");

	}else{
		
      out.write("\r\n\t\t<input type=hidden name=isDelay id=isDelay value=\"0\">\r\n\t\t");
...
*/
      ...
      out.write("\r\n\t</td></tr>\r\n\t<tr id=\"operateButtonTR\"><td>\r\n            ");
 if (flagg == null || flagg.equals("0")) {
      out.write("\r\n\t\t");
if("中科院".equals(SystemCommon.getCustomerName()) && "1".equals(request.getParameter("isZky"))){ 
      out.write("<input type=\"button\" class=\"btnButton4font\" onclick=\"javascript:saveShow();\" value=\"保存\" />");
}else{ 
      ...
      out.write("\r\n        <input type=\"button\" class=\"btnButton2font\" onclick=\"javascript:printCurForm()\" value=\"打印\" />\r\n            ");
} 
      out.write("\r\n\t</td></tr>\r\n</table>\r\n</form>\r\n");

String tableName = request.getParameter("t")==null?"":request.getParameter("t");
String tableField = tableName.contains("_")?tableName.split("_")[1]:tableName;
if("中科院".equals(SystemCommon.getCustomerName()) && "1".equals(request.getParameter("isZky"))){
      out.write("\r\n<iframe name=\"zkyScore\" id=\"zkyScore\" style=\"display:none\" src=\"/jsoa/zky/zkyScore.jsp?t=");
      out.print(tableName );
      out.write('&');
      out.write('f');
      out.write('=');
      out.print(tableField);
      out.write("_fs\" ></iframe>");
} 
      out.write("\r\n</body>\r\n");
String[] js={"",""};
js=new com.js.oa.eform.service.CustomFormBD().getJSCode(pageId); 
      out.write("\r\n<SCRIPT LANGUAGE=\"JavaScript\">\r\n<!--\r\nfunction init(){\r\n");
      out.print(js[0]==null?"":js[0] );
      out.write('\r');
      out.write('\n');
if("中科院".equals(SystemCommon.getCustomerName()) && "1".equals(request.getParameter("isZky"))){ 
      out.write("\r\nif(document.getElementById(\"");
      out.print(tableField+"_gh" );
      out.write("\")!=null){\r\n\tdocument.getElementById(\"");
      out.print(tableField+"_gh" );
      out.write("\").readOnly=true;\r\n}\r\nif(document.getElementById(\"");
      out.print(tableField+"_nd" );
      out.write("\")!=null && document.getElementById(\"");
      out.print(tableField+"_nd" );
      out.write("\").value==\"\"){\r\n\tvar dateYear = \"");
      out.print(SystemCommon.getZkyNd() );
      out.write("\";\r\n\tdocument.getElementById(\"");
      out.print(tableField+"_nd" );
      out.write("\").value=dateYear;\r\n}\r\nif(document.getElementById(\"");
      out.print(tableField+"_fs" );
      out.write("\")!=null){\r\n\tvar mqzt = document.getElementsByName(\"");
      out.print(tableField+"_mqzt" );
      out.write("\");\r\n\tfor(var i=0;i<mqzt.length;i++){\r\n\t\tif(mqzt[i].checked){\r\n\t\t\tif(mqzt[i].value==\"0\") document.getElementById(\"");
      out.print(tableField+"_fs" );
      out.write("\").readOnly=true;\r\n\t\t}\r\n\t}\r\n\tdocument.getElementById(\"");
      out.print(tableField+"_fs" );
      out.write("\").onclick=function(){\r\n\t\twindow.zkyScore.getScore();\r\n\t}\r\n}\r\nvar mqztValue = \"0\";\r\nif(document.getElementById(\"");
      out.print(tableField+"_jxzt" );
      out.write("\").value == \"\"){\r\n\tdocument.getElementById(\"");
      out.print(tableField+"_jxzt" );
      out.write("\").value = \"未提交\";\r\n}\r\nvar mqzt = document.getElementsByName(\"");
      out.print(tableField+"_mqzt" );
      out.write("\");\r\nfor(var i=0;i<mqzt.length;i++){\r\n\tmqzt[i].onclick=function(){\r\n\t\tif(this.value==mqztValue){\r\n\t\t}else{\r\n\t\t\tif(parseInt(mqztValue)>parseInt(this.value)){\r\n\t\t\t\tdocument.getElementById(\"");
      out.print(tableField+"_jxzt" );
      out.write("\").value = \"已退回\";\r\n\t\t\t}else{\r\n\t\t\t\tdocument.getElementById(\"");
      out.print(tableField+"_jxzt" );
      out.write("\").value = \"已提交\";\r\n\t\t\t}\r\n\t\t}\r\n\t}\r\n\tif(mqzt[i].checked){\r\n\t\tmqztValue = mqzt[i].value;\r\n\t}\r\n}\r\nif(mqztValue==\"0\"){\r\n\tmqzt[2].disabled=true\r\n}\r\nif(mqztValue==\"2\"){\r\n\tmqzt[0].disabled=true\r\n}\r\n//alert(mqztValue);\r\n");
}
      out.write("\r\n\r\n\r\n");
...
if(SystemCommon.getCustomerName().equals("esesj")){
	if (flagg == null){
      ...
      out.write("\r\n\t\tdocument.getElementById(\"jst_name\").value=\"");
      out.print(userName);
      out.write("\";\r\n\t\t");

	}
	if("undefined".equals(flagg)){
		
      out.write("\r\n\t\tdocument.getElementById(\"jst_State\").parentNode.innerText=\"\";\r\n\t\t");
...
if("中科院".equals(SystemCommon.getCustomerName()) && "1".equals(request.getParameter("isZky"))){ 
      out.write("window.zkyScore.getScore();");
} 
      out.write("\r\n\t\tdocument.all.operate.value=\"saveShow\";\r\n\t\tdocument.all.form1.submit();\r\n\t}\r\n}\r\nfunction save(){\r\n\tif(customFormBeforeSubmit()){\r\n\t\t");
if("中科院".equals(SystemCommon.getCustomerName()) && "1".equals(request.getParameter("isZky"))){ 
      out.write("window.zkyScore.getScore();");
} 
