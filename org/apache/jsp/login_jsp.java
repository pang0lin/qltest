 ...
 * Generated at: 2023-01-06 09:38:42 UTC
...
if(projectType!=null&&"tjgzw".equals(projectType)){//是天津国资委项目 登录超时或掉线后 直接 跳转到 tjgzw/login_gzw.jsp
      ...
      out.write("\r\n<script>\r\nwindow.opener=null;\r\nwindow.open('', '_self', '');\r\nwindow.close();\r\nwindow.location.href='/jsoa/tjgzw/login_gzw.jsp'\r\n\r\n</script>\r\n\r\n");
 } 
      out.write("\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n");
...
if("no".equals(validate)){
	...
	if(request.getParameter("error")!=null){ 
      ...
      try {
        ...
        // /login.jsp(116,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("/CheckUser");
        // /login.jsp(116,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    String uKeyLogType=SystemCommon.getLogType();
      ...
      if("2".equals(uKeyType) && "2".equals(uKeyLogType)){
       ...
       if(!markImage.equals("")&&!markImage.equals("0")){
            ...
            out.write("\r\n      <tr>\r\n        <td height=\"30\" align=\"right\" valign=\"middle\"><div style=\"width:225px; text-align:left\"><font color=\"#4b74ac\" style=\"line-height:25px;\">验证码&nbsp;<b>:</b></font>&nbsp;\r\n        <input style=\"margin-bottom:4px; height:20px;\" id=\"ImageCode\" name=\"ImageCode\" type=\"text\"  size=\"4\">&nbsp;&nbsp;<img id=\"pwdImage\" src=\"CreateImage\" alt=\"换一张\" style=\"cursor: hand;\" onClick=\"this.src='CreateImage?'+Math.random();\"/></div></td>\r\n      </tr>\r\n      ");
} 
            ...
            out.write("\r\n              <td><input type=\"checkbox\" name=\"checkbox\" id=\"checkbox\"/></td>\r\n              <td valign=\"bottom\"><label for=\"checkbox\">记住密码</label></td>\r\n              ");
} 
            out.write("\r\n              <td align=\"right\" valign=\"middle\"><a href=\"javascript:submitForm();\"><img src=\"images/an_niu.gif\" border=\"0\"></a></td>\r\n            </tr>\r\n            <tr>\r\n            <td colspan=\"3\" align=\"right\" height=\"20\" valign=\"bottom\"><!-- <a href=\"#\" onclick=\"javascript:forgetPwd();\">忘记密码了？</a> --></td>\r\n            </tr>\r\n        </table></td>\r\n      </tr>\r\n    </table>\r\n    ");
