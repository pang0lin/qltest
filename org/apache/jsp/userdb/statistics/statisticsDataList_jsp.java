...
public final class statisticsDataList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int offset1=index;
            ...
            out.write("\r\n<body class=\"MainFrameBox\" onload=\"syncValue();\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<table width=\"100%\"\theight=\"25\"\tborder=\"0\" cellpadding=\"0\" cellspacing=\"0\" >\r\n\t<tr>\r\n\t\t<td align=\"right\">\r\n\t\t\t<button  class=\"btnButton2Font\" onclick=\"showChart();\">图示</button>\r\n\t\t\t<button  class=\"btnButton2Font\" onclick=\"doExport();\">导出</button>\r\n\t\t\t");
            out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n");
            //  html:form
            ...
            try {
              ...
              // /userdb/statistics/statisticsDataList.jsp(55,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/StatisticsAction.do?action=statisticsDataChart");
              // /userdb/statistics/statisticsDataList.jsp(55,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  for(int i=0;i<dataList.size();i++){
 	...
 	if(index%2 != 0){
 	     ...
 	     listClass="listTableLine1";
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(null==obj[0]?"&nbsp;":(("".equals(obj[0].toString()))?"&nbsp;":obj[0].toString()));
                  out.write("</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\";\r\n\tvar menuId=\"");
            out.print(request.getAttribute("menuId"));
            out.write("\";\r\n\tvar url=\"/jsoa/StatisticsAction.do?action=statisticsData&statsId=\"+statsId+\"&rightType=\"+rightType+\"&menuId=\"+menuId\r\n\t+\"&moduleProcessId=");
            out.print(request.getAttribute("moduleProcessId"));
            out.write("\"\r\n\t+\"&processId=");
            out.print(request.getAttribute("processId"));
            out.write("\"\r\n\t+\"&processName=");
