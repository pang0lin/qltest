 ...
 * Generated at: 2023-01-06 09:53:11 UTC
...
public final class zky_005fmodulemangerList_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\t\t     <button class=\"btnButton2Font\" onClick=\"search();\" >查询</button>\r\n\t\t  </td>\r\n\t\t</tr>\r\n\t  </form>\r\n</table>\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"inlineBottomLine\">\r\n  <tr>\r\n    <td>  \r\n\t  <div id=\"PanleDIV\"  class=\"tabPanelSelected\" onClick=\"changePanle(this,'/jsoa/ZkyMangerAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">模块管理员</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n   \r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/ZkyMangerAction.do?action=perforlist');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">绩效管理员</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>    \r\n\t</td>\r\n\t  <td align=\"right\">\r\n\t    <input type=\"button\" class=\"btnButton2Font\" onclick=\"MM_openBrWindow('/jsoa/ZkyMangerAction.do?action=moudleAdd','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=540,height=440')\" value=\"新增\"/>\r\n");
		...
		Object[] obj;
            ...
            try {
              ...
              // /zky/zky_modulemangerList.jsp(102,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("mangerList");
              // /zky/zky_modulemangerList.jsp(102,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("mangerList");
              // /zky/zky_modulemangerList.jsp(102,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setScope("request");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object mangerList = null;
                ...
                mangerList = (java.lang.Object) _jspx_page_context.findAttribute("mangerList");
                do {
                  out.write("\r\n\t\t\t");

			obj = (Object[]) mangerList;
			index ++;
...
if(pageUtil.getCurPageNum()==1){ 
	...
	for(int i=0;i<ints.length;i++){if(ints[i]==pageUtil.getCurPageNum()){
            ...
            out.write("\r\n\tvar mangerUsername=document.getElementById(\"mangerUsername\").value;\r\n\tvar mangerMenuName=document.getElementById(\"mangerMenuName\").value;\r\n\t\r\n\tif(mangerUsername==null && mangerMenuName==null){\r\n\t\talert(\"条件不能为空！\");\r\n\t\tdocument.getElementById(\"mangerMenuName\").focus();\r\n\t}else{\r\n\t\twindow.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/ZkyMangerAction.do?action=list&mangerUsername=\"+mangerUsername+\"&mangerMenuName=\"+mangerMenuName;\r\n\t}\r\n}\r\n\r\n\r\nfunction MM_openBrWindow(theURL,winName,features) { \r\n\tJSMainWinOpen(theURL,winName,features);\r\n}\r\nfunction modify(id){\r\n\tJSMainWinOpen(\"/jsoa/ZkyMangerAction.do?action=modify&mangerId=\"+id,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=300');\r\n}\r\nfunction del(){\r\n\tvar ids=getBatchIDs();\r\n\tif(ids!=\"\"){\r\n\t\tdeleteItem(ids)\r\n\t}else{\r\n\t\talert(\"请选择要删除的记录!\");\r\n\t}\r\n}\r\nfunction deleteItem(ids){\r\n\tif(confirm(\"您确实要删除选中的记录吗!\")){\r\n\t\tlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/ZkyMangerAction.do?action=deleteMangerMoudle&mangerId=\"+ids;\r\n");
