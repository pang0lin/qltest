 ...
 * Generated at: 2023-01-06 09:51:50 UTC
...
public final class trainClassList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//} 
      ...
      try {
        ...
        // /personnel_manager/trainClassList.jsp(136,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("trainClassList");
        // /personnel_manager/trainClassList.jsp(136,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("trainClassList");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object trainClassList = null;
          ...
          trainClassList = (java.lang.Object) _jspx_page_context.findAttribute("trainClassList");
          do {
            out.write("\r\n\t\t");

		  trainClassObj = (Object[]) trainClassList;
		  index ++;
		  j++;
...
if(index%2 != 0){listClass="listTableLine2";}
            ...
            out.print(trainClassObj[0]);
            out.write("\" name=\"trainClassId\"></td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write("\"><a href=\"javascript:view('");
            out.print(trainClassObj[0]);
            out.write("')\">");
            out.print(trainClassObj[1]);
            out.write("</a></td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write('"');
            out.write('>');
            out.print(trainClassObj[2]==null?"":trainClassObj[2]);
            out.write("&nbsp;</td>\r\n\t\t  <td class=\"");
            out.print(listClass);
...
String pagerURL = "/jsoa/TrainClassAction.do";
      out.write("\r\n\t  ");
...
if(!deleteSuccess.booleanValue()){
   ...
   if(deloff<0) deloff = 0;
      ...
      out.write("\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=\"/jsoa/TrainClassAction.do?flag=delete&trainClassId=\" + id + \"&pager.offset=");
      out.print(deloff);
