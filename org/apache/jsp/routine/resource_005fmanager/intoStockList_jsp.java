...
public final class intoStockList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(!deleteSuccess.booleanValue()){
      ...
      out.write("\r\n\t  <td>\r\n\t\t   入库单号：&nbsp;<input onKeyPress=\"return look() ;\" onKeyUp=\"value=checkQuery(this,'入库单号')\" onBlur=\"value=checkQuery1(this,'入库单号')\" type=\"text\" style=\"width:105px\"  class=\"inputText\" size=\"18\" name=\"searchId\" value=\"");
      out.print(searchId);
...
if(searchEndDate.equals("")){
      ...
      out.print(stockId);
      out.write("\" >\r\n\t\t</td>\r\n\r\n\t\t<td align=\"right\">\r\n\t\t  <input type=\"submit\" class=\"btnButton2font\" onClick=\"search();\" value=\"查询\"/>\r\n\t\t  <input type=\"button\" class=\"btnButton2Font\"   onClick=\"window.location.href='/jsoa/IntoStockAction.do?flag=view&stockId=");
...
if("1".equals(stockShow)){
      ...
      out.write("&processType=");
      out.print(request.getParameter("processType"));
      out.write("&moduleId=13&mode=stock','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=640,height=500')\" ");
} 
      out.write(" value=\"新入库单\" />\r\n\t\t  ");
if(processId==null||"null".equals(processId)||"".equals(processId)){
      out.write("<input type=\"button\" class=\"btnButton2Font\" onClick=\"javascript:batchDelete()\" value=\"删除\"/>");
}
//}
...
if(processId==null||"null".equals(processId)||"".equals(processId)){
      ...
      out.write("\r\n\t\t<td class=\"listTableHead\" width=\"10%\"> 入库单号 </td>\r\n\t\t<td class=\"listTableHead\" width=\"15%\"> 入库日期 </td>\r\n\t\t<td class=\"listTableHead\"> 入库部门 </td>\r\n\t\t<td class=\"listTableHead\" width=\"13%\"> 制单人 </td>\r\n\t\t<td class=\"listTableHead\" width=\"13%\"> 状态 </td>\r\n\t\t<td width=\"8%\" class=\"listTableHeadLast\" nowrap> 处理 </td>\r\n  </tr>\r\n\t  ");
      ...
      try {
        ...
        // /routine/resource_manager/intoStockList.jsp(186,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("intoStockList");
        // /routine/resource_manager/intoStockList.jsp(186,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(intoStockObj[3].toString().equals("N")){
            ...
            out.write('"');
            out.write('>');
            out.print(intoStockObj[5]==null?"&nbsp;":StaticParam.getOrgByNum(intoStockObj[5]+""));
            out.write("</td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write('"');
            out.write('>');
...
if(intoStockObj[3].toString().equals("N")){ if(processId==null||"null".equals(processId)||"".equals(processId)){
            out.write("<img src=\"images/modi.gif\" title=\"修改\" style=\"cursor:pointer\" onClick=\"modify('");
            out.print(intoStockObj[0]);
            out.write("', '");
            out.print(intoStockObj[3]);
            ...
            out.write("&nbsp;<img src=\"images/konwledge_view.gif\" title=\"查看\" style=\"cursor:pointer\" onClick=\"modiMoney('");
            out.print(intoStockObj[0]);
            out.write("', '");
            out.print(intoStockObj[3]);
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n    </td>\r\n  </tr>\r\n</table>\r\n<!-- PAGER -->\r\n\r\n\r\n\r\n</td></tr></table>\r\n\r\n</body>\r\n</html>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction search(){\r\n//    var tmp = form2.searchId.value;\r\n//    if(tmp.length>=1 && isNaN(tmp)){\r\n//        alert(\"进货单号必须为数字!\");\r\n//        return false;\r\n//    }\r\n    form2.submit();\r\n}\r\nfunction delSingle(id){\r\n    if(confirm(\"确实要删除吗？\")){\r\n    window.location.href=\"/jsoa/IntoStockAction.do?flag=delete&mode=stock&stockName=");
      out.print(request.getParameter("stockName"));
      out.write("&stockId=");
      out.print(request.getParameter("stockId"));
      ...
      out.write("&checkFlag=' + checkFlag + '&ptMasterId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("&mode=stock&canview=1','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=640,height=500')\r\n}\r\n\r\nfunction modiMoney(id, checkFlag){\r\n    MM_openBrWindow('/jsoa/IntoStockAction.do?flag=modiMoney&stockId=");
      out.print(request.getParameter("stockId"));
      out.write("&checkFlag=' + checkFlag + '&ptMasterId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      ...
      out.print(request.getParameter("stockId"));
      out.write("&addcolumn=8&mode=stock&stockName=");
      out.print(request.getParameter("stockName"));
      out.write("&stockId=");
      out.print(request.getParameter("stockId"));
      out.write("&processId=");
