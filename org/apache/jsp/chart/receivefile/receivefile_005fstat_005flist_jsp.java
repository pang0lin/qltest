...
public final class receivefile_005fstat_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Date receiveTimeBeginDate,receiveTimeEndDate,limitTimeBeginDate,limitTimeEndDate;

SimpleDateFormat format = new SimpleDateFormat("yyyy/MM/dd");
if(receiveTimeBegin==null || !"1".equals(searchReceiveTime)){
	receiveTimeBeginDate=new Date();
}else{
	receiveTimeBeginDate=format.parse(receiveTimeBegin);
}
if(receiveTimeEnd==null|| !"1".equals(searchReceiveTime)){
	receiveTimeEndDate=new Date();
}else{
	receiveTimeEndDate=format.parse(receiveTimeEnd);
}

if(limitTimeBegin==null|| !"1".equals(searchLimitTime)){
	limitTimeBeginDate=new Date();
}else{
	limitTimeBeginDate=format.parse(limitTimeBegin);
}
if(limitTimeEnd==null|| !"1".equals(searchLimitTime)){
	limitTimeEndDate=new Date();
}else{
	limitTimeEndDate=format.parse(limitTimeEnd);
}
...
String statProcessId="";
if(request.getParameter("statProcessId")!=null && !"null".equals(request.getParameter("statProcessId"))){
	statProcessId=request.getParameter("statProcessId");
}
...
if(statProcessId.equals(tmp[0])){out.print("selected");} 
            ...
            out.write("\r\n\t\t\t</select>\r\n\t\t\t</td>\r\n\t\t\t<td align=\"center\">部门名称：</td>\r\n\t\t  \t<td>\r\n\t\t\t<input type=\"text\" class=\"inputtext\" name=\"orgName\" id=\"orgName\" value=\"\"/>\r\n\t\t\t</td>\r\n\t  \t  \r\n\t\t  <td  align=\"right\">\r\n\t\t  </td>\r\n\t </tr>\r\n\t <tr>\r\n\t \t<td align=\"center\">来文时间：</td>\t \t\r\n\t \t<td colspan=\"4\">\r\n\t\t  <script language=javascript>\r\n\t\t\t\t\tvar dtpDate = createDatePicker(\"receiveTimeBegin\",");
            out.print((receiveTimeBeginDate.getYear()+1900));
            out.write(',');
            out.print((receiveTimeBeginDate.getMonth()+1));
            out.write(',');
            out.print((receiveTimeBeginDate.getDate()));
            out.write(");\r\n\t\t\t\t  </script>\r\n\t\t  \r\n\t\t \t 至\r\n\t\t\t<script language=javascript>\r\n\t\t\t\t\tvar dtpDate = createDatePicker(\"receiveTimeEnd\",");
            out.print((receiveTimeEndDate.getYear()+1900));
            out.write(',');
            out.print((receiveTimeEndDate.getMonth()+1));
            out.write(',');
            out.print((receiveTimeEndDate.getDate()));
            out.write(");\r\n\t\t\t</script>\r\n\t\t  <input type=\"checkbox\" id=\"searchReceiveTime\" name=\"searchReceiveTime\" value=\"1\" ");
if("1".equals(searchReceiveTime)){out.print("checked");}
            out.write("/>\r\n\t\t</td>\r\n\t </tr>\r\n\t <tr>\r\n\t \t<td align=\"center\">办理时限：</td>\t \t\r\n\t \t<td colspan=\"3\">\r\n\t\t  <script language=javascript>\r\n\t\t\t\t\tvar dtpDate = createDatePicker(\"limitTimeBegin\",");
            out.print((limitTimeBeginDate.getYear()+1900));
            out.write(',');
            out.print((limitTimeBeginDate.getMonth()+1));
            out.write(',');
            out.print((limitTimeBeginDate.getDate()));
            out.write(");\r\n\t\t\t\t  </script>\r\n\t\t  \r\n\t\t \t 至\r\n\t\t\t<script language=javascript>\r\n\t\t\t\t\tvar dtpDate = createDatePicker(\"limitTimeEnd\",");
            out.print((limitTimeEndDate.getYear()+1900));
            out.write(',');
            out.print((limitTimeEndDate.getMonth()+1));
            out.write(',');
            out.print((limitTimeEndDate.getDate()));
            out.write(");\r\n\t\t\t</script>\r\n\t\t  <input type=\"checkbox\" id=\"searchLimitTime\" name=\"searchLimitTime\" value=\"1\" ");
if("1".equals(searchLimitTime)){out.print("checked");}
		  ...
		  if(orderBy == null || !orderBy.equals("cc1")){
            ...
            out.write("\r\n\t\t</td>\t\r\n\t\t<td width=\"10%\" class=\"listTableHead\" id=\"tdWidth\">超期未办\r\n\t\t");
		  ...
		  if(orderBy == null || !orderBy.equals("cc2")){
            ...
            out.write("\r\n\t\t</td>\t\r\n\t\t<td width=\"10%\" class=\"listTableHead\" id=\"tdWidth\">在办事项\r\n\t\t");
		  ...
		  if(orderBy == null || !orderBy.equals("cc3")){
            ...
            out.write("\r\n\t\t</td>\t\r\n\t\t<td width=\"10%\" class=\"listTableHead\" id=\"tdWidth\">办结事项\r\n\t\t");
		  ...
		  if(orderBy == null || !orderBy.equals("cc4")){
            ...
            out.write("\r\n\t\t</td>\t\r\n\t\t<td width=\"10%\" class=\"listTableHead\" id=\"tdWidth\">超期办结\r\n\t\t");

		  if(orderBy == null || !orderBy.equals("cc5")){
            out.write("\r\n\t\t<img src=\"images/blanksort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('cc5','desc');\" title=\"按办结流程数量排序\">\r\n\t\t");
}else if(orderBy.equals("cc5") && sortType.equals("desc")){
            out.write("\r\n\t\t<img src=\"images/downsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('cc5','asc');\" title=\"按办结流程数量排序\">\r\n\t\t");
}else if(orderBy.equals("cc5") && sortType.equals("asc")){
            out.write("\r\n\t\t<img src=\"images/upsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('cc5','desc');\" title=\"按办结流程数量排序\">\r\n\t\t");
}
            out.write("\r\n\t\t</td>\t\t\t\t\r\n  \t</tr>\r\n\t  ");
	  ...
	  String listClass="listTableLine1";
            ...
            try {
              ...
              // /chart/receivefile/receivefile_stat_list.jsp(248,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /chart/receivefile/receivefile_stat_list.jsp(248,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /chart/receivefile/receivefile_stat_list.jsp(248,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		index ++;
		countRecordCount ++;
		level=Integer.parseInt(obj[6].toString());
		...
		if(index%2 != 0){
	 	     ...
	 	     listClass="listTableLine1";
                  ...
                  out.write("&nbsp;</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"><a href=\"#\" onclick=\"goDetail('");
                  out.print(obj[7]);
                  out.write("');\">");
            ...
            try {
              ...
              // /chart/receivefile/receivefile_stat_list.jsp(282,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setId("reCountList");
              // /chart/receivefile/receivefile_stat_list.jsp(282,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setName("reCountList");
              // /chart/receivefile/receivefile_stat_list.jsp(282,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if(index%2 != 0){
	 	     ...
	 	     listClass="listTableLine1";
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj2[4]!=null?obj2[4].toString():"0");
                  out.write("&nbsp;</td>\r\n\t  </tr>\r\n\t  ");
            ...
            out.write("\r\n</table>\r\n<!-- LIST TITLE PART -->\r\n<!-- PAGER -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n <tr>\r\n    <td>\r\n\t  ");
String pagerURL = "/jsoa/ChartReceivefileAction.do";
            out.write("\r\n      ");
