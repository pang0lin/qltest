...
public final class doc_005fshowuserinfo_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Integer showType = request.getAttribute("showType")==null?Integer.valueOf("0"):Integer.valueOf(request.getAttribute("showType").toString());
...
if(showType.intValue() == 0){
	...
	String listClass="listTableLine1";
      ...
      try {
        ...
        // /doc/doc/doc_showuserinfo.jsp(67,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("uList");
        // /doc/doc/doc_showuserinfo.jsp(67,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("uList");
        // /doc/doc/doc_showuserinfo.jsp(67,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setScope("request");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object uList = null;
          ...
          uList = (java.lang.Object) _jspx_page_context.findAttribute("uList");
          do {
            out.write("\r\n        ");
obj = (Object[]) uList;
		index ++;
		if(index%2 != 0){
            ...
            out.write('"');
            out.write(' ');
            out.print(showType.intValue()==0?"":"listTableLineLastTD");
            out.write('>');
            out.print(obj[1]);
            out.write('.');
            out.print(obj[0]);
...
if(showType.intValue() == 0){
            out.write("\r\n            ");
            out.print(obj[2].toString().indexOf(".")>=0?obj[2].toString().substring(0, obj[2].toString().indexOf(".")):obj[2]);
            out.write("\r\n            ");
}else{
            out.write("&nbsp;\r\n\t\t\t");
}
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n</html>\r\n\r\n<script>\r\n\r\nfunction search(){\r\n\r\n\tif(document.all.userName.value.indexOf(\"'\")>=0 ){\r\n\talert(\"用户名不能有 ' 号 \");\r\n\treturn false;\r\n\r\n\t}else{\r\n\tif(document.all.userName.value.indexOf(\"\\\"\")>=0 ){\r\n\talert(\"用户名不能有 \\\" 号 \");\r\n\treturn false;\r\n\r\n\t}else{\r\n\r\nform1.submit();\r\n}\r\n}\r\n\r\n}\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
