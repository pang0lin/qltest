...
public final class officemanager_005fsalary_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int index = 0;
      ...
      try {
        ...
        // /office_manager/officemanager_salary_list.jsp(106,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("list");
        // /office_manager/officemanager_salary_list.jsp(106,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("list");
        // /office_manager/officemanager_salary_list.jsp(106,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      SalaryPO salaryPO = (SalaryPO) obj[0];
      
      long salary_id=salaryPO.getSalary_id();
      Date sendtim=salaryPO.getSendTime();
      String sendtime=dateFormat.format(sendtim);
      String userName=salaryPO.getEmployeeVO().getEmpName();
      String number=salaryPO.getEmployeeVO().getEmpNumber();
    ...
    if(index%2 != 0){listClass="listTableLine2";}
            ...
            out.write("\r\n\t<tr style=\"cursor:pointer\" onClick=\"javascript:detail('");
            out.print(salary_id);
            out.write("');\">\r\n\t<td class=\"");
            out.print(listClass);
            out.write('"');
...
String pagerURL = "/jsoa/SalaryAction.do";
      out.write("\r\n     ");
