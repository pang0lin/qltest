 ...
 * Generated at: 2023-01-06 10:03:10 UTC
...
if("bjyh".equals(SystemCommon.getCustomerName())){ 
            out.write("\r\n<script language=\"JavaScript\" src=\"/jsoa/eform/js/bankOfBeijing.js\"></script>\r\n");
} 
...
if(filterSearchField!=null){ 
            ...
            out.write("\">\r\n<table width=\"100%\" border=\"0\" id=\"searchBar\"  style=\"display:;\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n   <tr>\r\n      <td width=\"2%\">&nbsp;</td>\r\n      <td width=\"92%\">\r\n         <table width=\"100%\">\r\n            ");

            String paraValue;
            for(i=0;i<filterSearchField.length;i++){
            	paraValue=request.getParameter(filterSearchField[i][1]);
            	if(paraValue==null || "null".equals(paraValue)){
            		paraValue="";
            	}
            	if(i%3==0){
            		
            out.write("\r\n            \t <tr>\r\n        \t\t\t<td width=\"8%\"  height=\"28\" nowrap>");
            out.print(filterSearchField[i][0]);
            out.write("：</td>\r\n        \t\t\t<td width=\"25%\"><input type=\"text\" name=\"");
            out.print(filterSearchField[i][1] );
            ...
            out.write("\r\n         </table>\r\n      </td>\r\n      <td width=\"4%\"><input type=\"button\" class=\"btnButton4Font\" onClick=\"search();\" style=\"cursor:pointer\" value=\"查询\" /></td>\r\n      <td width=\"1%\">&nbsp;</td>\r\n   </tr>\t           \r\n</table>\r\n</form> \r\n");
} 
            out.write("\r\n\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"inlineBottomLine\">\r\n  <tr>\r\n    <td align=\"left\" nowrap>\r\n\t\t   \r\n\t      \r\n    </td>\r\n    <td align=\"right\" nowrap>\r\n\t\t<input type=\"button\" class=\"btnButton4font\" onClick=\"exportData()\" value=\"导出\" />\r\n\t</td>\r\n  </tr>\r\n</table>\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n         <tr >\r\n           ");
        ...
        if(request.getParameter("pager.offset") != null && !"null".equals(request.getParameter("pager.offset"))){
            ...
            try {
              ...
              // /eform/getFilterList.jsp(129,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /eform/getFilterList.jsp(129,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
			...
			if(index%2 != 0){
               ...
               String temp;
	           for(i=0;i<filterListField.length;i++){
	        	   if(filterListField[i][2]!=null && !"null".equals(filterListField[i][2])){
	        		   dataIndex=Integer.parseInt(filterListField[i][2]);
	        	   }else{
	        		   dataIndex=1;
	        	   }
                  ...
                  out.print(listClass);
                  out.write("\" title=\"");
                  out.print((obj[dataIndex]==null || "null".equals(obj[dataIndex].toString()))?"":obj[dataIndex].toString() );
                  out.write("\">\r\n\t           ");
                  out.print(com.js.util.util.CharacterTool.replaceXMLTags((obj[dataIndex]==null || "null".equals(obj[dataIndex].toString()))?"":obj[dataIndex].toString()) );
                  out.write("\r\n\t           &nbsp;</td>\r\n\t           ");
} 
                  out.write("\r\n               \r\n               <td class=\"");
                  out.print(listClass);
                  ...
                  out.print(obj[0] );
                  out.write("\">\r\n               <input type=\"hidden\" name=\"turnText\" value=\"");
                  out.print(obj[1] );
                  out.write("\">\r\n               </td>\r\n           </tr>\r\n       ");
...
String pagerURL = "/jsoa/FormDataFilterAction.do";
            out.write("\r\n\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
	...
	if(index==1){
      ...
      out.write("\r\n\t\r\n\tvar objValue=document.getElementsByName(\"turnValue\");\r\n\tvar objText=document.getElementsByName(\"turnText\");\r\n\t\t\r\n\tdataOK(objValue[0].value,objText[0].value);\r\n\t");

	}
	
      out.write("\r\n}\r\nfunction search(){\r\n\tdocument.form1.inputValue.value=\"\";\r\n\tdocument.form1.submit();\r\n}\r\nfunction dataOK(dataId,dataText){\r\n\tvar curIndex=parseInt(\"");
      out.print(curIndex);
      out.write("\");\r\n\r\n\tvar obj=opener.document.getElementsByName(\"");
      out.print(request.getParameter("fieldName"));
      out.write("\");//opener.document.all.");
      out.print(request.getParameter("fieldName"));
      out.write(";\r\n\tvar objTemp=opener.document.getElementsByName(\"");
      out.print(request.getParameter("fieldName"));
      out.write("_temp\");//opener.document.all.");
      out.print(request.getParameter("fieldName"));
      out.write("_temp;\r\n\tvar objbtn=opener.document.getElementsByName(\"");
      out.print(request.getParameter("fieldName"));
...
if("bjyh".equals(SystemCommon.getCustomerName())){ 
      ...
      out.write("\r\n\t\r\n\twindow.close();\r\n}\r\nfunction exportData(){\r\n\tvar para=\"action=export&fieldId=");
      out.print(request.getParameter("fieldId") );
      out.write("\";\r\n\tpara+=\"&fieldName=");
      out.print(request.getParameter("fieldName") );
      out.write("\";\r\n\tpara+=\"&inputValue=");
	 ...
	 for(i=0;i<filterSearchField.length;i++){
      ...
      out.write("\r\n\t JSMainWinOpen(\"/jsoa/FormDataFilterAction.do?\"+para);\r\n}\r\n\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
