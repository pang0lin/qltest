...
public final class portalDefaultModify_jsp extends org.apache.jasper.runtime.HttpJspBase
...
response.setDateHeader ("Expires", 0);
      ...
      out.write("\"/>\r\n                 <tr >\r\n\t\t\t\t  <td width=\"90\" height=\"25\">选择门户&nbsp;<label class=\"mustFillcolor\">*</label>：</td>\r\n\t\t\t\t  <td>\r\n\t\t\t\t\t <select id=\"portalId\" name=\"portalId\" style=\"width:10%\">\r\n\t\t\t\t\t   <option value=\"\">--请选择--</option>\r\n\t\t\t\t\t  ");
					    ...
					    if(request.getAttribute("list")!=null){
						  ...
						  String portal=request.getAttribute("portal")+"";
						  for(int i = 0 ;i<list.size();i++){
						  Object []obj = (Object[])list.get(i);
						  String selected="";
						  if(portal.equals(obj[0]+"&&"+obj[1])){
						      selected="selected";
						  }else{
      ...
      out.write("\r\n\t\t\t\t\t  </select>\t\t  \r\n\t\t\t\t  </td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr id=\"tr2\">\r\n\t\t\t\t   <td height=\"25\">使用范围<label class=\"mustFillcolor\"> *</label>：</td>\r\n\t\t\t\t   <td>\r\n\t\t\t\t\t  <textarea id=\"viewRangeName\" name=\"viewRangeName\" rows=\"4\" style=\"width:400px;cursor:pointer\"  readonly=\"true\" onclick=\"openEndow('userOrgGroup','viewRangeName','");
      out.print(request.getAttribute("userOrgGroup") );
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(request.getAttribute("viewrangename") );
      out.write("','userorg','no','userorg','");
