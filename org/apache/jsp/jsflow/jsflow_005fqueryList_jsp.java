 ...
 * Generated at: 2023-01-06 10:07:34 UTC
...
public final class jsflow_005fqueryList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.oa.jsflow.bean.ProcessQuery");
  }
...
String title = request.getAttribute("title")==null?(null==request.getParameter("title")?"":request.getParameter("title")):request.getAttribute("title").toString();
String org = request.getAttribute("org")==null?(null==request.getParameter("org")?"":request.getParameter("org")):request.getAttribute("org").toString();
String submitperson = request.getAttribute("submitperson")==null?(null==request.getParameter("submitperson")?"":request.getParameter("submitperson")):request.getAttribute("submitperson").toString();
String status = request.getAttribute("status")==null?(null==request.getParameter("status")?"":request.getParameter("status")):request.getAttribute("status").toString();
int index=0;
...
Object[] obj; 
      ...
      try {
        ...
        // /jsflow/jsflow_queryList.jsp(109,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("list");
        // /jsflow/jsflow_queryList.jsp(109,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("list");
        // /jsflow/jsflow_queryList.jsp(109,7) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            out.write("\r\n\t\t\t\t\t\t ");
							...
							String user=p.getdealperson(obj[2]+"", obj[1]+"",obj[9]+"");
							String queryType="1";
							String curStatus=obj[4]+"";
							if("0".equals(obj[4]) || "1".equals(obj[4]))
							{
								queryType="1";
							}else{
								queryType="100";
            ...
            out.write("\" class=\"");
            out.print(listClass);
            out.write("\">&nbsp;\r\n\t\t\t\t\t\t\t\t<a href=\"javascript:JSMainWinOpen('/jsoa/jsflow/workflow_listInfo.jsp?record=");
            out.print(obj[2] );
