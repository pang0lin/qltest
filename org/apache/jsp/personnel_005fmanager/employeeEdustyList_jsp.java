...
public final class employeeEdustyList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
canAdd="0";
      ...
      out.write("<strong>教育经历：</strong></td>\r\n</tr>\r\n\r\n\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n");
 if(canAdd.equals("1")){
      out.write("\r\n\r\n<tr>\r\n<td align=\"center\" >\r\n<table width=\"96%\"\theight=\"22\"\tborder=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n\t<tr>\r\n\t  <td align=\"right\">\r\n\t\t  <button  class=\"btnButton2Font\" onClick=\"javascript:MM_openBrWindow('/jsoa/EmployeeEdustyAction.do?action=add&empID=");
      out.print(empID);
      out.write("&canAdd=");
      out.print(canAdd);
      out.write("','','scrollbars=yes,resizable=no,width=600,height=350')\">新增</button>\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n\r\n</td>\r\n</tr>\r\n");
}
      out.write("\r\n\r\n\r\n<tr>\r\n<td align=\"center\">\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<!-- LIST TITLE PART -->\r\n<table width=\"98%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"docBoxNoPanel\" style=\"border:1px solid #6ea2da;\">\r\n\t<form name=\"EmployeeEdustyActionForm\" method=\"post\" action=\"/jsoa/EmployeeEdustyAction.do\">\r\n\t\t<tr align=\"center\" bgcolor=\"#cfe6ff\">\r\n\t\t\t<td width=\"10%\" class=\"outRightLine1\" nowrap>\r\n\t\t\t\t开始日期</td>\r\n\t\t\t<td class=\"outRightLine1\" width=\"10%\"> 结束日期 </td>\r\n\t\t\t<td class=\"outRightLine1\" > 学校 </td>\r\n\t\t\t<td class=\"outRightLine1\" width=\"21%\"> 专业 </td>\r\n\t\t\t<td class=\"outRightLine1\" width=\"10%\"> 学历 </td>\r\n\t\t\t<td class=\"outRightLine1\" width=\"10%\"> 学位 </td>\r\n\t\t\t");
 if(canAdd.equals("1")){
      ...
      try {
        ...
        // /personnel_manager/employeeEdustyList.jsp(145,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("edustyList");
        // /personnel_manager/employeeEdustyList.jsp(145,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("edustyList");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object edustyList = null;
          ...
          edustyList = (java.lang.Object) _jspx_page_context.findAttribute("edustyList");
          do {
            out.write("\r\n\t\t");

		  edustyObj = (Object[]) edustyList;
		  index ++;
...
if(index%2 != 0){listClass="listTableLine2";}
            ...
            out.print((""+edustyObj[1]).substring(0,10));
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print((""+edustyObj[2]).substring(0,10));
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\" style=\"word-break:break-all;\">");
            out.print(edustyObj[3]);
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\" style=\"word-break:break-all;\">");
            out.print(edustyObj[4]==null?"&nbsp;":edustyObj[4]);
            out.write("&nbsp;</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(edustyObj[5]);
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(edustyObj[6]);
            out.write("</td>\r\n\t\t  ");
 if(canAdd.equals("1")){
            out.write("\r\n\t\t  <td class=\"listTableLine3 listTableLineLastTD\" nowrap>\r\n\t\t  \t<img src=\"images/modi.gif\" alt=\"修改\" style=\"cursor:pointer\" onClick=\"modify('");
            out.print(edustyObj[0]);
...
if(!deleteSuccess.booleanValue()){
      out.write("\r\n<script language=\"javascript\">\r\nalert(\"删除失败！您选择的教育经历正在使用\");\r\n</script>\r\n");
}
      out.write("\r\n</html>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction search(){\r\n    form2.submit();\r\n}\r\nfunction delSingle(id){\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=\"/jsoa/EmployeeEdustyAction.do?action=delete&edustyId=\" + id+\"&empID=");
      out.print(empID);
      out.write("&open=");
      out.print(open);
      out.write("\" ;\r\n    }\r\n}\r\nfunction modify(id){\r\n    MM_openBrWindow('/jsoa/EmployeeEdustyAction.do?action=modify&edustyId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=600,height=350')\r\n}\r\n\tfunction view(id){\r\n    MM_openBrWindow('/jsoa/EmployeeEdustyAction.do?action=view&edustyId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
