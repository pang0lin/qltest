...
public class WorkflowForOF extends Workflow {
  public String complete(HttpServletRequest request) {
    ...
    if (comment.equals("null") || comment.equals(""))
      comment = "OA审批通过"; 
    String sql = "Select ukzj,shjg,ddgs,ddh,ddlx,ddhz From kf_cgdof Where kf_cgdof_id=?";
    ...
    String sql1 = "Select ukzj From kf_cgdofmx Where kf_cgdofmx_foreignkey=?";
  ...
  public void back(HttpServletRequest request) {
    ...
    String sql = "Select ukzj,ddgs,ddh,ddlx,ddhz From kf_cgdof Where kf_cgdof_id=?";
    DataSourceBase db = new DataSourceBase();
    DataSource ds = db.getDataSource();
    Connection conn = null;
    PreparedStatement pstmt = null;
    ...
    try {
      ...
      rs.close();
      pstmt.close();
      String thsql = "update  kf_cgdof set thbz=? where kf_cgdof_id=?";
