...
public final class printWord_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	request.setCharacterEncoding("GBK");
      ...
      out.write("\r\n<html>\r\n\t<body leftmargin=10 rightmargin=10>\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n\t\t<table id=\"print\" border=\"0\" width=\"90%\" cellpadding=\"0\" cellspacing=\"0\" style=\"display:\">\r\n\t\t\t<tr>\r\n\t\t\t\t<td align=\"right\">\r\n\t\t\t\t\t<input type=\"button\" name=\"prt\" value=\"打印\" onclick=\"_print();\">\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t</table>\r\n\t\t<center><h5>设备申请</h5></center>\r\n\t\t<table width=\"80%\"  border=\"1\" align=\"center\" cellpadding=\"5\" cellspacing=\"0\" bordercolorlight=\"#000000\" bordercolordark=\"#FFFFFF\" style=\"font-size:11pt\">\r\n\t\t\t<tr align=\"left\">\r\n\t\t\t\t<td width=\"113\"><b>名称</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"name\").value);\r\n\t\t\t\t\t</script>\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td><b>编码</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"code\").value);\r\n\t\t\t\t\t</script>\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td><b>借用人</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n");
      out.write("\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"borrowerName\").value);\r\n\t\t\t\t\t</script>\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td><b>借用部门</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"borrowerOrgName\").value);\r\n\t\t\t\t\t</script>\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td><b>借用时间</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tvar startDate = opener.document.getElementById(\"startDate\").value;\r\n\t\t\t\t\t\tstartDate = startDate.replace(/\\//,'年');\r\n\t\t\t\t\t\tstartDate = startDate.replace(/\\//,'月');\r\n\t\t\t\t\t\tstartDate = startDate + '日';\r\n\t\t\t\t\t\tdocument.writeln(startDate);\r\n\t\t\t\t\t\tvar _s=opener.document.getElementById(\"startTime\").value/3600+'';\r\n\t\t\t\t\t\tif(_s.indexOf('.')!=-1){\r\n\t\t\t\t\t\t\tdocument.write(_s.substr(0,_s.indexOf('.')) + ':30');\r\n\t\t\t\t\t\t}else{\r\n\t\t\t\t\t\t\tdocument.write(_s + ':00');\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t\tdocument.write(' 至 ');\r\n\t\t\t\t\t\tvar endDate = opener.document.getElementById(\"endDate\").value;\r\n\t\t\t\t\t\tendDate = endDate.replace(/\\//,'年');\r\n\t\t\t\t\t\tendDate = endDate.replace(/\\//,'月');\r\n");
      out.write("\t\t\t\t\t\tendDate = endDate + '日';\r\n\t\t\t\t\t\tdocument.writeln(endDate);\r\n\t\t\t\t\t\tvar _e=opener.document.getElementById(\"endTime\").value/3600+'';\r\n\t\t\t\t\t\tif(_e.indexOf('.')!=-1){\r\n\t\t\t\t\t\t\tdocument.write(_e.substr(0,_e.indexOf('.')) + ':30');\r\n\t\t\t\t\t\t}else{\r\n\t\t\t\t\t\t\tdocument.write(_e + ':00');\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t</script>\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr height=80>\r\n\t\t\t\t<td><b>用途</b></td>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<script language=\"javascript\">\r\n\t\t\t\t\t\tdocument.writeln(opener.document.getElementById(\"purpose\").value);\r\n\t\t\t\t\t</script>&nbsp;\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t</table>\r\n\t\t");
...
//=request.getParameter("content")
      out.write("\r\n</td>\r\n</tr>\r\n</table>\r\n\r\n\t</body>\r\n</html>\r\n<script language=\"javascript\">\r\n\tfunction _print(){\r\n\t\tdocument.getElementById(\"print\").style.display=\"none\";\r\n\t\twindow.print();\r\n\t}\r\n    //document.all.newForm.innerHTML = opener.document.all.EquipmentActionForm.innerHTML;\r\n\t");
