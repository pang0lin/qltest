      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\r\n\t\t<tr>\r\n\t\t\t<td width=\"2%\" ></td> \r\n\t\t\t<td width=\"8%\"  height=\"28\" nowrap>项目名称：</td>\r\n\t\t\t<td width=\"20%\"><input type=\"text\" class=\"inputText\" name=\"title\" value=\"");
            out.print(title);
            out.write("\"/></td>\r\n\t\t\t\r\n\t\t\t<td width=\"8%\"  nowrap align=right>负责人：</td>\r\n\t\t\t<td width=\"20%\">\r\n\t\t\t<input type=\"text\" name=\"fzrName\"  class=\"inputText\" value=\"");
            out.print(fzrName );
            out.write("\" title=\"请点击选择\" onclick=\"selectFZR();\" />\r\n\t\t\t<input type=\"hidden\" name=\"fzrId\" value=\"");
            out.print(fzrId );
            out.write("\"/>\r\n\t\t\t</td>\r\n\t\t\t<td width=\"8%\" nowrap align=\"right\" style=\"display:none\">状态：</td>\r\n\t\t\t<td width=\"12%\" style=\"display:none\"><select name=\"status\" id=\"status\" size=\"1\"  class=\"menu1\">\r\n\t\t\t\t\t\t\t<option value=\"");
            out.print(status1);
            out.write('"');
            out.write('>');
...
if(!"".equals(status1)){ 
            ...
            out.write("\r\n\t\t\t\t             ");
if(!"0".equals(status1)){ 
            out.write(" <option value=\"0\">未开始</option>");
} 
            out.write("\r\n\t\t\t\t             ");
if(!"10".equals(status1)){ 
            out.write("<option value=\"10\">进行中</option>");
} 
            out.write("\r\n\t\t\t\t             ");
if(!"100".equals(status1)){ 
            out.write("<option value=\"100\">已结束</option>");
} 
...
if("0".equals(status1)){ 
            out.write(" \r\n\t\t<input type=\"button\" class=\"btnButton2font\" id=\"batchdel\" onclick=\"javascript:add();\" value=\"新增\"/> \r\n\t\t");
} 
            out.write("\r\n\t\t<input type=\"button\" class=\"btnButton2font\" id=\"batchdel\" onclick=\"javascript:batchDel();\" value=\"删除\"/>\r\n\t\t<input type=\"button\" id=\"hiddenSearch\"  class=\"btnButton4Font\" onClick=\"hidserch()\" value=\"查询\"/>\r\n\t </td>\r\n  \r\n  </tr>\r\n  \r\n</table>\r\n\r\n<div id=\"docinfo0\" name=\"docinfo0\">\r\n\r\n   <table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n         <tr >\r\n           <td width=\"40\" nowrap class=\"listTableHead\"><input type=\"checkbox\" value=\"1\" name=\"selAll\" onclick=\"selectAll(this);\"></td>\r\n           <td class=\"listTableHead\">名称</td>\r\n           <td class=\"listTableHead\" width=\"12%\" nowrap>分类</td>\r\n           <td class=\"listTableHead\" width=\"5%\" nowrap>进度</td>\r\n           <td class=\"listTableHead\" width=\"12%\" nowrap>负责人</td>\r\n           <td width=\"15%\" class=\"listTableHead\" nowrap>开始日期</td>\r\n           <td width=\"15%\" class=\"listTableHead\" nowrap>结束日期</td>\r\n           <td width=\"8%\" nowrap class=\"listTableHeadLast\">操作</td>\r\n         </tr>   \r\n         \r\n         ");
        ...
        String startTime,endTime,rate;
            ...
            try {
              ...
              // /relproject/pro_list.jsp(155,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /relproject/pro_list.jsp(155,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
			...
			boolean fu=relProjectBean.getfuzByProId(Long.valueOf(obj[0].toString()),Long.valueOf(userId));
...
if(!fu){
                  ...
                  out.print(listClass);
                  out.write("\" nowrap>");
                  out.print(classNameMap.get(obj[0].toString()) );
                  out.write("&nbsp;</td>\r\n               <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  ...
                  out.print(listClass);
                  out.write("\" nowrap>");
                  out.print(map.get(obj[0].toString()) );
                  out.write("</td>\r\n               <td class=\"");
                  out.print(listClass);
                  out.write("\" nowrap>");
                  out.print(startTime );
...
if(fu){
                  out.write("\r\n               <img src=\"/jsoa/images/modi.gif\" style=\"cursor:pointer\" onclick=\"modifyPro('");
                  out.print(obj[0] );
                  out.write("');\">\r\n               <img src=\"/jsoa/images/del.gif\" style=\"cursor:pointer\" onclick=\"delSingle('");
                  out.print(obj[0]);
                  out.write("');\">\r\n               ");
}else{ 
                  out.write("&nbsp;");
...
String pagerURL = "/jsoa/RelProjectAction.do";
            out.write("\r\n\t\t\t");
