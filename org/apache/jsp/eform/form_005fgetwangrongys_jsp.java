...
public final class form_005fgetwangrongys_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try{	
	String sql="SELECT SUM(ssye) FROM view_realcost WHERE bm=? AND yf<=MONTH(?) AND jd=QUARTER(?) AND lx=? GROUP BY lx";
	conn=base.getDataSource().getConnection();		
	pstmt=conn.prepareStatement(sql);
	pstmt.setString(1, bm);
	pstmt.setString(2,date);
	pstmt.setString(3,date);
	pstmt.setString(4,lx);
