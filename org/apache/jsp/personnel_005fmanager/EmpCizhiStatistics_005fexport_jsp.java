...
public final class EmpCizhiStatistics_005fexport_jsp extends org.apache.jasper.runtime.HttpJspBase
...
response.setHeader("Content-disposition", "attachment;filename="+new String("离职名单报表".getBytes("GBK"),"iso8859-1")+".xls");
...
if("00".equals(month)){
	  	...
	  	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            ...
            try {
              ...
              // /personnel_manager/EmpCizhiStatistics_export.jsp(89,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /personnel_manager/EmpCizhiStatistics_export.jsp(89,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /personnel_manager/EmpCizhiStatistics_export.jsp(89,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
