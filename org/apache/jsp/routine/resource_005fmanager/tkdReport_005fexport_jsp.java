...
public final class tkdReport_005fexport_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  String goodsType = request.getAttribute("goodsType")==null?"":request.getAttribute("goodsType").toString();
	 ...
	 double je = 0 ;
      ...
      try {
        ...
        // /routine/resource_manager/tkdReport_export.jsp(77,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("drawGoodsList");
        // /routine/resource_manager/tkdReport_export.jsp(77,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
	 ...
	 je = ArithUtil.add(je , Double.parseDouble(reportObj[5].toString()));
            ...
            out.write("</td>\r\n      <td><div align=\"right\">");
            out.print(Math.abs(new Double(slFormat.format(Float.parseFloat(reportObj[2].toString()))).doubleValue()));
            out.write("</div></td>\r\n     <td><div align=\"right\">");
            out.print(decimalFormat.format(Float.parseFloat(reportObj[4].toString())));
            out.write("</div></td>\r\n      <td><div align=\"right\">");
            out.print(Math.abs(new Double(decimalFormat.format(Float.parseFloat(reportObj[5].toString()))).doubleValue()));
            out.write("</div></td>\r\n\r\n\t  </tr>\r\n\t");
