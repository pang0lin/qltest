...
public class FPage implements Serializable {
  ...
  public FPage(String pageName, String pageContent, Long pageIsUse, String pageFile, Long tableId, String tableDesname, Timestamp createDate, Long createdEmp, Long createdOrg) {
