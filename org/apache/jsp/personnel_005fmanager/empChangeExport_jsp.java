...
public final class empChangeExport_jsp extends org.apache.jasper.runtime.HttpJspBase
...
response.setHeader("Content-disposition", "attachment;filename="+new String("人事调整".getBytes("GBK"),"iso8859-1")+".xls");
	...
	isDate = request.getAttribute("isDate").toString();
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n<head>\r\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=GBK\">\r\n\r\n</head>\r\n\r\n<body>\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"1\" cellpadding=\"0\" cellspacing=\"1\">\r\n\t<tr align=\"center\">\r\n\t\t<td width=\"10%\"> 调整日期 </td>\r\n\t\t<td width=\"10%\"> 调整人员 </td>\r\n\t\t<td width=\"20%\"> 调整前部门 </td>\r\n\t\t<td width=\"20%\"> 调整后部门 </td>\r\n\t\t<td width=\"10%\"> 调整前职务 </td>\r\n\t\t<td width=\"10%\"> 调整后职务 </td>\r\n\t\t<td width=\"10%\"> 类型 </td>\r\n\t  </tr>\r\n\r\n\t\t");
		...
		String listClass="";
            ...
            try {
              ...
              // /personnel_manager/empChangeExport.jsp(48,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /personnel_manager/empChangeExport.jsp(48,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("personnelList");
              // /personnel_manager/empChangeExport.jsp(48,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
