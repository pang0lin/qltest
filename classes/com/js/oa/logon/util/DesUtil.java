...
public class DesUtil {
  public String decodeStr(String data) {
    ...
    String decStr = "";
    try {
      List<int[]> firstKeyBt = getKeyBytes("jiusi");
      int firstLength = firstKeyBt.size();
      List<int[]> secondKeyBt = getKeyBytes("jiusi.net");
      int secondLength = secondKeyBt.size();
      List<int[]> thirdKeyBt = getKeyBytes("www.jiusi.net");
      int thirdLength = thirdKeyBt.size();
      ...
      for (i = 0; i < iterator; i++) {
        ...
        decStr = String.valueOf(decStr) + byteToString(tempBt);
      } 
    } catch (Exception ex) {
      ex.printStackTrace();
    } 
  ...
  private String byteToString(int[] byteData) {
    ...
    for (int i = 0; i < 4; i++) {
      ...
      if (count != 0)
        str = String.valueOf(str) + (char)count; 
    } 
    return str;
  }
  ...
  private String bt64ToHex(int[] byteData) {
    ...
    for (int i = 0; i < 16; i++) {
      String bt = "";
      for (int j = 0; j < 4; j++)
        bt = String.valueOf(bt) + byteData[i * 4 + j]; 
      hex = String.valueOf(hex) + bt4ToHex(bt);
    } 
    return hex;
  }
  ...
  private String hexToBt64(String hex) {
    String binary = "";
    for (int i = 0; i < 16; i++)
      binary = String.valueOf(binary) + hexToBt4(hex.substring(i, i + 1)); 
    return binary;
  }
  ...
  private int[] sBoxPermute(int[] expandByte) {
    ...
    int[][] s2 = { { 
          ...
          7, 12, 5, 14, 9 } };
    int[][] s3 = { { 
          10, 9, 14, 6, 3, 15, 5, 1, 13, 12, 
          7, 11, 4, 2, 8 }, { 
          13, 7, 9, 3, 4, 6, 10, 2, 8, 5, 
          14, 12, 11, 15, 1 }, { 
          13, 6, 4, 9, 8, 15, 3, 11, 1, 2, 
          12, 5, 10, 14, 7 }, { 
          1, 10, 13, 6, 9, 8, 7, 4, 15, 14, 
          3, 11, 5, 2, 12 } };
    int[][] s4 = { { 
          7, 13, 14, 3, 6, 9, 10, 1, 2, 8, 
          5, 11, 12, 4, 15 }, { 
          13, 8, 11, 5, 6, 15, 3, 4, 7, 2, 
          12, 1, 10, 14, 9 }, { 
          10, 6, 9, 12, 11, 7, 13, 15, 1, 3, 
          14, 5, 2, 8, 4 }, { 
          3, 15, 6, 10, 1, 13, 8, 9, 4, 5, 
          11, 12, 7, 2, 14 } };
    int[][] s5 = { { 
          2, 12, 4, 1, 7, 10, 11, 6, 8, 5, 
          3, 15, 13, 14, 9 }, { 
          14, 11, 2, 12, 4, 7, 13, 1, 5, 15, 
          10, 3, 9, 8, 6 }, { 
          ...
          9, 10, 4, 5, 3 } };
    int[][] s6 = { { 
          12, 1, 10, 15, 9, 2, 6, 8, 13, 3, 
          4, 14, 7, 5, 11 }, { 
          10, 15, 4, 2, 7, 12, 9, 5, 6, 1, 
          13, 14, 11, 3, 8 }, { 
          9, 14, 15, 5, 2, 8, 12, 3, 7, 4, 
          10, 1, 13, 11, 6 }, { 
          4, 3, 2, 12, 9, 5, 15, 10, 11, 14, 
          1, 7, 6, 8, 13 } };
    int[][] s7 = { { 
          4, 11, 2, 14, 15, 8, 13, 3, 12, 9, 
          7, 5, 10, 6, 1 }, { 
          13, 11, 7, 4, 9, 1, 10, 14, 3, 5, 
          12, 2, 15, 8, 6 }, { 
