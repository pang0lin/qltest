...
public final class weixin_005fcoop_005fdealwith_005f3g_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String status= request.getAttribute("dealwithStatus").toString();
...
String operate=request.getAttribute("operate")==null || request.getAttribute("operate")==""?"":request.getAttribute("operate").toString();
//处理页面跳转方向
String url="";
if(type!=null&&type.equals("workdealwith")){
	...
	if(status.equals("202and1002")||bodyEx!=null && bodyEx.size()>0){
      ...
      out.write("\r\n\t<body onload=\"setHeader('javascript:closeWindow();','协同工作');\" class=\"wapcss\">\r\n\t\t<div class=\"zsglform\" style=\"padding-bottom: 60px;\">\r\n\t\t\r\n\t\t\t<div style=\"margin-top: 15px;\">\r\n\t\t\t\t<span style=\"float: left; margin-left: 10px;\">发送人：");
      out.print(bpo.getPosterName());
      out.write("</span>\r\n\t\t\t\t<span style=\"float: right; margin-right: 5px;\">\r\n\t\t\t\t\t<a href=\"javascript:void(0);\" onclick=\"showInfo(this)\" style=\"text-decoration: none;\">详情</a>\r\n\t\t\t\t</span>\r\n\t\t\t</div>\r\n\t        <div class=\"zsgllineitem\"></div>\r\n\t\t\t<div id=\"infomation\" style=\"display: none; background: #efefef;\">\r\n\t\t\t\t<div class=\"item\" style=\"padding: 5px 5px 5px 10px;\">\r\n         \t\t\t<div class=\"title\" style=\"float: left; line-height: 20px;\">发送至：</div>\r\n\t\t\t\t\t<div class=\"content\" style=\"float: left; line-height: 20px;\">\r\n\t\t\t\t\t  \t<div class=\"info\">");
      ...
      out.write("\r\n\t\t\t     \t<div class=\"item\" style=\"padding: 5px 5px 5px 10px;\">\r\n\t\t\t\t\t\t<div class=\"title\" style=\"float: left;\">办理期限：</div>\r\n\t\t\t\t\t\t<div class=\"content\" style=\"float: left;\">\r\n\t\t\t\t\t\t\t<div class=\"info\">\r\n\t\t\t\t\t\t\t\t");
      ...
      out.write("\r\n\t\t      \t\t<div class=\"item\" style=\"padding: 5px 5px 5px 10px;\">\r\n\t\t\t\t\t\t<div class=\"title\" style=\"float: left;\">相关项目：</div>\r\n\t\t\t\t\t\t<div class=\"content\" style=\"float: left;\">\r\n\t\t\t\t\t\t\t<div class=\"info\">\r\n\t\t\t                \t");
      ...
      out.write("\r\n\t\t\t\t<div class=\"item\" style=\"padding: 10px;\">\r\n\t\t\t\t\t<div class=\"title\" style=\"padding-left: 5px; float: left;\">附件：</div>\t\t\t\r\n\t\t\t\t\t<div class=\"content\" style=\"float: left; text-align: left; clear: both;\">\r\n\t            \t\t<div class=\"info\">\r\n\t           \t \t\t\t<div class=\"c\">\r\n\t\t\t\t\t\t\t\t");

								Object[] aObjects = null;
								for(int i=0; i<attach.size(); i++){
									aObjects = (Object[]) attach.get(i);
									out.print("<a style='margin-left: 40px;text-decoration: none;' href=\"javascript:void(0);\" onclick=\"showHtmlObject('" 
						   			+ aObjects[2] + "', '0', 'cooperate')\">" 
						   			+ aObjects[1] + "</a><br />");
								}
      ...
      out.write("\r\n\t            \t \t\t\t<div class=\"c\">\r\n\t\t            \t \t\t\t<p class='name' style=\"font-size: 14px; padding-left: 5px;\">");
      out.print(obj[2] );
      out.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
      out.print(postTime );
      ...
      out.write("\r\n\t              \t\t</div>\r\n\t          \t\t</div>\r\n\t          \t</div>\r\n\t          \t<div class=\"zsgllineitem\"></div>\r\n\t\t\t\t");
			...
			// 正文补充附件
			if(null!=bodyExAttach && bodyExAttach.size()>0){
				
      out.write("\r\n\t\t\t\t<div class=\"item\" style=\"padding: 10px;\">\r\n\t\t\t\t\t<div class=\"title\" style=\"padding-left: 5px; float: left;\">补充附件：</div>\t\t\t\r\n\t\t\t\t\t<div class=\"content\" style=\"float: left; text-align: left; clear: both;\">\r\n\t            \t\t<div class=\"info\">\r\n\t           \t \t\t\t<div class=\"c\">\r\n\t\t\t\t\t\t\t\t");

								Object[] eObjects = null;
								for(int i=0; i<bodyExAttach.size(); i++){
									eObjects = (Object[]) bodyExAttach.get(i);
									out.print("<a style='margin-left: 40px;text-decoration: none;' href=\"javascript:void(0);\" onclick=\"showHtmlObject('" 
						   			+ eObjects[2] + "', '0', 'cooperate')\">" 
						   			+ eObjects[1] + "</a><br />");
								}
      ...
      out.write("\r\n\t\t        \t\t\t\t        <div class=\"item\" style=\"width: 90%; float: right; clear: left; border: 0; padding-top: 5px; padding-bottom: 5px;\">\r\n\t\t\t\t\t\t\t\t\t\t\t<div class=\"picture\">\r\n\t\t\t\t\t\t\t\t\t\t\t\t\t<img style=\"width:30px; height:30px;\" src='/jsoa/weixin/common/getUserAvatar.jsp?userId=");
      ...
      out.print(path);
      out.write("/weixin/cooperate/weixin_dealwithAccess.jsp?bodyId=");
      out.print(bodyId );
      out.write("&memberId=");
      out.print(memberId );
      out.write("&type=");
      ...
      out.print(operate );
      out.write("\" />\r\n\t\t \t\t\t\t\t<input id=\"userIds\" name=\"userIds\" type=\"hidden\" />\r\n\t\t\t\t            <input id=\"userNames\" name=\"userNames\" type=\"hidden\" />\r\n\t\t\t\t\t\t\t<input id=\"userAccounts\" name=\"userAccounts\" type=\"hidden\" />\r\n\t\t\t\t\t\t    <input type=\"text\" id=\"reply_content\" name=\"reply_content\" placeholder=\"已阅\" />\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t<div class=\"replyDiv\">\r\n\t\t\t\t\t\t\t<div class=\"reply\" style=\"margin-right: 2px;\" onclick=\"javascript:doSave();\">办理</div>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</form>\r\n\t     \t\t\t");

	     		}else if("message".equals(from)){
	     			
      out.write("<div id=\"closeWindow\" class=\"button gray\" onclick=\"closewindow();\">关闭</div>");

	     		} else{
	     			
      out.write("<div class=\"button gray\" onclick=\"javascript:window.history.back();\">关闭</div>");
