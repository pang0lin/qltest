...
public final class kq_005fout_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
e= new Date(end_date);
	...
	eday = String.valueOf(e.getDate());
      ...
      try {
        ...
        // /kq/kq_out_list.jsp(146,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("list");
        // /kq/kq_out_list.jsp(146,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("list");
        // /kq/kq_out_list.jsp(146,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
	  ...
	  String beginDate=dateFormat.format(obj[6]); 
	   String endDate=dateFormat1.format(obj[7]); 
	   String cause=obj[8]+"&nbsp;"; 
...
String pagerURL = "/jsoa/KqOutAction.do";
      out.write("\r\n     ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("}\r\nfunction hidserch()\r\n{\r\n     var stable=document.getElementById(\"searchtable\");\r\n     var sbutton=document.getElementById(\"hiddenSearch\");\r\n     if(stable.style.display==\"none\")\r\n     {\r\n      stable.style.display=\"\";\r\n      hiddenSearch.innerHTML=\"关闭查询\";\r\n      \r\n     }else{\r\n     \r\n     stable.style.display=\"none\";\r\n     hiddenSearch.innerHTML=\"查询\";\r\n     \r\n     }\r\n}\r\n\r\nfunction del(id){\r\n if(confirm(\"你确定要删除吗？\"))\r\n {\r\n  window.location.href= ((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/KqOutAction.do?action=del&outid=\"+id ;\r\n  }\r\n}\r\n\r\nfunction update(id)\r\n{\r\n\r\nJSMainWinOpen(((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+'/jsoa/KqOutAction.do?action=update&outid='+id,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600')\r\n\r\n}\r\nfunction selectOrg()\r\n{\r\nopenEndow('orgId','orgName',form1.orgId.value,form1.orgName.value,'org','no','org','");
      out.print(range);
