...
public final class statisticsManageList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String statsTitle=null==request.getParameter("statsTitle")?"":request.getParameter("statsTitle");
int index=0;
...
int offset1=index;
            ...
            try {
              ...
              // /userdb/statistics/statisticsManageList.jsp(71,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/StatisticsManageAction");
              // /userdb/statistics/statisticsManageList.jsp(71,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("get");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n  <tr>\r\n\t\t<td width=\"40px\"  nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"sAll\" onclick=\"selectAll(this);\"></td>\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\">数据分析名称</td>\t\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\">统计字段</td>\t\t\t\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\">状态</td>\t\r\n\t\t<td width=\"10%\" class=\"listTableHead\" id=\"tdWidth\">操作</td>\r\n  </tr>\r\n  ");
  ...
  for(int i=0;i<myList.size();i++){
 	...
 	if(index%2 != 0){
 	     ...
 	     listClass="listTableLine1";
                  ...
                  out.write('"');
                  out.write('>');
                  out.print((null==obj[3]||"".equals(obj[3]))?(null==obj[6]?"":obj[6].toString()):obj[3].toString());
                  out.write("</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
...
String pagerURL = "/jsoa/StatisticsManageAction.do";
            out.write("\r\n\t\t\t\t\t\t\t\t\t");
