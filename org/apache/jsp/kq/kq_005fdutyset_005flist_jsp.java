 ...
 * Generated at: 2023-01-06 09:43:22 UTC
...
public final class kq_005fdutyset_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getAttribute("reload")!=null){ 
      out.write("\r\n<script language=\"JavaScript\">\r\nlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/KqDutySetAction.do?action=list\";\r\n</script>\r\n");
} 
      out.write('\r');
      out.write('\n');
      //  html:html
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\r\n\t    <div id=\"PanleDIV\"  class=\"tabPanel\"  onClick=\"changePanle(this,'/jsoa/KqHolidayAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">节假日设置</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    \r\n\t    <!-- <div id=\"PanleDIV\"  class=\"tabPanel\"  onClick=\"changePanle(this,'/jsoa/KqNosignAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">免签设置</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div> -->\r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    \r\n\t    <div id=\"PanleDIV\"  class=\"tabPanelSelected\"  onClick=\"changePanle(this,'/jsoa/KqDutySetAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">排班设置</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n      ");
 if("shenzhougaotie".equals(com.js.util.config.SystemCommon.getCustomerName())){ 
            out.write("\r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    \r\n\t    <div id=\"PanleDIV\"  class=\"tabPanel\"  onClick=\"changePanle(this,'/jsoa/SKqWhitelistAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">打卡白名单设置</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    \r\n\t    <div id=\"PanleDIV\"  class=\"tabPanel\"  onClick=\"changePanle(this,'/jsoa/SKqParaSetAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">考勤参数设置</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n      ");
} 
            out.write("\r\n      ");
 if("1".equals(com.js.util.config.SystemCommon.getUseWeiXinQYH())){ 
            out.write("\r\n      <div id=\"PanleDIV\"  class=\"tabPanel\"  onClick=\"changePanle(this,'/jsoa/KqWeiXinBMDAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">微信白名单设置</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n      ");
} 
            out.write("\r\n\t\t</td>\r\n\t  <td align=\"right\">\r\n\t\t  <button  class=\"btnButton2Font\" onClick=\"javascript:JSMainWinOpen('/jsoa/KqDutySetAction.do?action=add','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600');\" >新增</button>\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n\r\n\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n\t  <tr align=\"center\">\r\n\t\t<td  width=\"10%\"class=\"listTableHead\">排班名称</td>\r\n\t\t<td  width=\"10%\"class=\"listTableHead\">第一次登记</td>\r\n\t\t<td  width=\"10%\"class=\"listTableHead\">第二次登记</td>\r\n\t\t<td  style=\"display:");
            out.print(showTR);
            out.write("\" width=\"10%\"class=\"listTableHead\">第三次登记</td>\r\n\t\t<td  style=\"display:");
            out.print(showTR);
            out.write("\" width=\"10%\"class=\"listTableHead\">第四次登记</td>\r\n\t\t<td  style=\"display:");
            out.print(showTR);
            out.write("\" width=\"10%\"class=\"listTableHead\">第五次登记</td>\r\n\t\t<td  style=\"display:");
            out.print(showTR);
            out.write("\" width=\"10%\"class=\"listTableHead\">第六次登记</td>\r\n\t\t<td  class=\"listTableHead\">适用人员</td>\r\n\t\t<td width=\"8%\" nowrap class=\"listTableHeadLast\">");
	  ...
	  String listClass="listTableLine1";
            ...
            try {
              ...
              // /kq/kq_dutyset_list.jsp(155,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /kq/kq_dutyset_list.jsp(155,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /kq/kq_dutyset_list.jsp(155,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		listClass = index%2!=0?"listTableLine2":"listTableLine1";
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj[3].toString().equals("0")?"&nbsp;":"上班"+obj[3]);
                  out.write("</td>\r\n\t\t     <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(obj[4].toString().equals("0")?"&nbsp;":"下班"+obj[4]);
                  out.write("</td>\r\n\t\t   <td style=\"display:");
                  out.print(showTR);
                  out.write("\" class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(obj[5].toString().equals("0")?"&nbsp;":"上班"+obj[5]);
                  out.write("</td>\r\n\t\t     <td style=\"display:");
                  out.print(showTR);
                  out.write("\" class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(obj[6].toString().equals("0")?"&nbsp;":"下班"+obj[6]);
                  out.write("</td>\r\n\t\t   <td style=\"display:");
                  out.print(showTR);
                  out.write("\" class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(obj[7].toString().equals("0")?"&nbsp;":"上班"+obj[7]);
                  out.write("</td>\r\n\t\t     <td style=\"display:");
                  out.print(showTR);
                  out.write("\" class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(obj[8].toString().equals("0")?"&nbsp;":"下班"+obj[8]);
                  out.write("</td>\r\n\t\t     \r\n\t\t   <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print("".equals(obj[2]+"")?"（假期排班）":obj[2]+"" );
                  out.write("&nbsp;</td>\r\n           <td class=\"");
                  out.print(listClass);
...
String pagerURL = "/jsoa/KqDutySetAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n\r\n\r\nfunction del(id){\r\n if(confirm(\"你确定要删除吗？\"))\r\n {\r\n  window.location.href= ((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/KqDutySetAction.do?action=del&dutysetid=\"+id ;\r\n  }\r\n}\r\n\r\nfunction update(id)\r\n{\r\n\r\nJSMainWinOpen('/jsoa/KqDutySetAction.do?action=update&dutysetid='+id,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600')\r\n\r\n}\r\n\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+cURL;\r\n}\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /kq/kq_dutyset_list.jsp(150,50) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("personalwork");
      // /kq/kq_dutyset_list.jsp(150,50) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
