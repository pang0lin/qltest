...
if(com.js.util.util.BrowserJudge.isMSIE(request)){ 
      ...
      out.print(menuIndex );
      out.write("');openURL('/jsoa/BodyAction.do?flag=add')\"><img id=\"menuImg_");
      out.print(menuIndex );
      out.write("\"  src=\"/jsoa/imges/shanj.gif\" />&nbsp;新建事项</div></td>\r\n\t\t\t\t\t\t  </tr>  \r\n\t\t\t\t\t\t \r\n\t\t\t\t\t\t  <tr id=\"mainTR_");
      out.print(++menuIndex);
      out.write("\">\r\n\t\t\t\t\t\t    <td><div id=\"topDIV");
      out.print(menuIndex );
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/CoItemAction.do?status=1')\"><img id=\"menuImg_");
      out.print(menuIndex );
      out.write("\"  src=\"/jsoa/imges/shanj.gif\" />&nbsp;待发事项</div></td>\r\n\t\t\t\t\t\t  </tr>   \r\n\t\t\t\t\t\t     \r\n\t\t\t\t\t\t  <tr id=\"mainTR_");
      out.print(++menuIndex);
      out.write("\">\r\n\t\t\t\t\t\t    <td><div id=\"topDIV");
      out.print(menuIndex );
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/CoItemAction.do?status=10')\"><img id=\"menuImg_");
      out.print(menuIndex );
      out.write("\" src=\"/jsoa/imges/shanj.gif\" />&nbsp;待办事项</div></td>\r\n\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t  \r\n\t\t\t\t\t\t  <tr id=\"mainTR_");
      out.print(++menuIndex);
      out.write("\">\r\n\t\t\t\t\t\t    <td><div id=\"topDIV");
      out.print(menuIndex );
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/CoItemAction.do?status=201&myItem=0')\"><img id=\"menuImg_");
      out.print(menuIndex );
      out.write("\" src=\"/jsoa/imges/shanj.gif\" />&nbsp;已办事项</div></td>\r\n\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t  \r\n\t\t\t\t\t\t  <tr id=\"mainTR_");
      out.print(++menuIndex);
      out.write("\">\r\n\t\t\t\t\t\t    <td><div id=\"topDIV");
      out.print(menuIndex );
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/CoItemAction.do?status=202&myItem=1')\"><img id=\"menuImg_");
      out.print(menuIndex );
