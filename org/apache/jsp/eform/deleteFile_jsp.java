 ...
 * Generated at: 2023-01-06 10:03:17 UTC
...
public final class deleteFile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n\r\n");
//@ page import="com.js.util.util.Ftp"
      out.write("\r\n\r\n\r\n");
...
String password=map.get("oriPass").toString();
Ftp ftp=new Ftp(server,port,user,password);
ftp.open();
if(fileName!=null || "null".equals(fileName)){
	fileName=path+"/"+fileName;
	ftp.deleteFile(fileName);
}
if(request.getParameter("delfiles")!=null){
    fileName=request.getParameter("delfiles");
    String[] fileArray=fileName.split(",");   
    for(int i=0;i<fileArray.length;i++){
        if(!"".equals(fileArray[i])){
			fileName=path+"/"+fileArray[i];
			ftp.deleteFile(fileName);
        }
    }
}
