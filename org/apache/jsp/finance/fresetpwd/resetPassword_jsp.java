 ...
 * Generated at: 2023-01-06 10:06:19 UTC
...
public final class resetPassword_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(!"chinaLife".equals(SystemCommon.getCustomerName())){ 
      ...
      try {
        ...
        // /finance/fresetpwd/resetPassword.jsp(96,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("List");
        // /finance/fresetpwd/resetPassword.jsp(96,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("listUsers");
        // /finance/fresetpwd/resetPassword.jsp(96,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		if(index%2 != 0){
            ...
            out.write("</td>\r\n\t    <td class=\"");
            out.print(listClass);
            out.write("\">\r\n          <div>\r\n              <input type=\"button\" class=\"btnButton2Font\" onclick=\"resetPwd('");
            out.print(obj[0]);
            out.write("')\" style=\"cursor:hand\" value=\"重置\"/>\r\n              <input type=\"button\" class=\"btnButton2Font\" onclick=\"modPwd('");
            out.print(obj[0]);
            out.write("')\" style=\"cursor:hand\" value=\"修改\"/>\r\n          </div>\r\n        </td>\r\n\t  </tr>\r\n\t  ");
...
String pagerURL = "/jsoa/fUserAction.do";
      out.write("\r\n\t\t\t");
