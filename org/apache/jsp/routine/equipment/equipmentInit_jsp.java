...
public final class equipmentInit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
 ...
 out.print(java.text.DateFormat.getDateInstance(java.text.DateFormat.LONG  ,java.util.Locale.CHINA).format((new java.util.Date(nowYear-1900, nowMonth-1, nowDay))));
            ...
            try {
              ...
              // /routine/equipment/equipmentInit.jsp(82,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("EquipmentAction");
              // /routine/equipment/equipmentInit.jsp(82,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n<table border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\" style=\"border-bottom:0px;\" width=\"100%\">\r\n                      <tr  align=\"center\" >\r\n                        <td     rowspan=\"2\" align=\"center\" nowrap  class=\"listTableHead\">");
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
                  out.write('设');
                  out.write('备');
}else{
                  ...
                  out.write("\r\n\t\t\t\t\t</tr>\r\n\t</table>\r\n\t\t\t\t<table border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\" width=\"100%\">\r\n                      ");
                         ...
                         List searchDate=request.getAttribute("equipmentList")==null?new ArrayList():(List)request.getAttribute("equipmentList");
...
for(int j=0;j<searchDate.size();j++){
						...
						String voiturePlace[]= new BoardRoomBD().getEquipmentInfo(obj[0].toString(),formatter.format(searchStartDate));
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\nfunction search(){\r\n    frm1.submit();\r\n}\r\n\r\nfunction cleared(){\r\n document.location.href=\"EquipmentAction.do?action=equipmentView&init=0\";\r\n}\r\n\r\nfunction apply(id,processIdd){\r\n     //   var selProcess=document.all.selProcess.value;\r\n\tMM_openBrWindow('EquipmentAction.do?action=addEquipmentApplyView&equipmentId='+id+'&moduleId=14','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=350,height=250')\r\n}\r\n\r\n\r\nfunction lookState(id){\r\n    //alert(id);\r\n    MM_openBrWindow('/jsoa/EquipmentAction.do?action=statuDetail&equipmentid='+id,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=700,height=350')\r\n}\r\n\r\nfunction useApply(){\r\n\tMM_openBrWindow('EquipmentAction.do?action=addEquipmentApplyView&moduleId=14','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=350,height=250')\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
