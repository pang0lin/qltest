  ...
  for(int i=0;i<myList.size();i++){
 	...
 	if(index%2 != 0){
 	     ...
 	     listClass="listTableLine1";
            ...
            out.print(listClass);
            out.write("\">\r\n          ");
if(obj[4]!=null&&!"".equals(obj[4]+"")&&"1".equals(obj[4]+"")){
             out.print("已退回");
          }else{
             out.print("未退回");
          } 
          ...
          if(obj[2]!=null&&!"".equals(obj[2]+"")&&"2".equals(obj[2]+"")){
             out.print("紧急");
          }else{
             out.print("普通");
          } 
