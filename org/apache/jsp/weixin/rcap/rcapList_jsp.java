...
public final class rcapList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String keyword = null!=request.getAttribute("keyword") ? request.getAttribute("keyword").toString() : "";
      ...
      out.print(title);
      out.write("');\">\r\n\t\t<!-- 搜索 -->\r\n\t   \t<FORM id=\"searchForm\" action=\"/jsoa/weiXinRcapAction.do?action=list&schUser=");
      out.print(scheUser );
			...
			if(schList != null && schList.size() > 0) {
				...
				for (int i = 0; i < schList.size(); i++) {
					...
					if(date == null){
						...
						dateTimeString=dateTimeString.substring(0, 10) + "  " + new SimpleDateFormat("HH:mm").format(new Date(a))
					...
					String userAccountStr=com.js.system.util.StaticParam.getUserAccountsByEmpId(event.getEventEmpId()+"");
					showTitle = empName + schTitle;
					
      out.write("\r\n\t\t\t        <a style=\"text-decoration: none;\"  href=\"");
      out.print(path);
      out.write("/weiXinRcapAction.do?action=rcapInfo&amp;schUser=");
      out.print(scheUser );
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t<div class=\"second\">");
      out.print(event.getEventEmpName() );
      out.write("</div>\r\n\t\t\t\t\t        </div>\r\n\t\t\t\t        </div>\r\n\t\t\t        </a>\r\n\t\t\t\t\t");
      ...
      out.write("\r\n\t\t</div>\r\n\t\t\t\r\n\t\r\n\t\t\r\n\t\t <!-- 分页 -->\r\n\t\t");
		...
		if (size > WapUtil.LIMITED) {
			if (upIndex >= 0){
				upUrl = path + "/weiXinRcapAction.do?action=list&amp;beginIndex=" + upIndex + "&amp;schUser=" + scheUser;
			...
			if (nextIndex < size){
				nextUrl = path + "/weiXinRcapAction.do?action=list&amp;beginIndex=" + nextIndex + "&amp;schUser=" + scheUser;
				if (null != keyword && !"".equals(keyword))
