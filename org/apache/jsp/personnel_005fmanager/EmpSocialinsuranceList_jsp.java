...
public final class EmpSocialinsuranceList_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      try {
		...
		String listClass="listTableLine1";
            ...
            try {
              ...
              // /personnel_manager/EmpSocialinsuranceList.jsp(114,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /personnel_manager/EmpSocialinsuranceList.jsp(114,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /personnel_manager/EmpSocialinsuranceList.jsp(114,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		listClass = index%2!=0?"listTableLine2":"listTableLine1";
                  ...
                  out.write("&nbsp;</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\" nowrap>\r\n\t\t\t<img style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" alt=\"修改\" onclick=\"MM_openBrWindow('/jsoa/EmpSocialinsuranceAction.do?action=load&id=");
                  out.print(obj[0]);
...
String pagerURL = "/jsoa/EmpSocialinsuranceAction.do";
            out.write("\r\n      ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\nfunction add(){\r\n\tMM_openBrWindow('/jsoa/EmpSocialinsuranceAction.do?action=new','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600');\r\n}\r\n\r\nfunction del(id) {\r\n     ");

     int deloffset =  countRecordCount == 1 ? offset1-15:offset1 ;
     deloffset = deloffset < 0 ? 0 : deloffset ;
     
      out.write("\r\n     if(confirm(\"确实要删除吗？\")){\r\n         window.location.href=\"/jsoa/EmpSocialinsuranceAction.do?action=delete&id=\"+id+\"&empName=\"+document.form1.empName.value+\"&payType=\"+document.form1.payType.value+\"&pager.offset=");
      out.print(deloffset);
      out.write("\";\r\n    }\r\n }\r\n\r\nfunction search(){\r\n\tif(legalCharacters(document.all.empName)){\r\n\t\talert(\"申办人不能包含有特殊字符！\"+\"\\\\\\\"'`<>^/\");\r\n\t\tdocument.form1.empName.focus();\r\n\t\treturn;\r\n    }\r\n\r\n\tdocument.form1.submit();\r\n}\r\n\r\nfunction clearr(){\r\n\tlocation.href=\"/jsoa/EmpSocialinsuranceAction.do?action=list\";\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\nfunction batchDel(){\r\n\tif(getCheckBoxID() != ''){\r\n\t\tvar ids = getCheckBoxID();\r\n\t\tids = ids.substring(0, ids.length-1);\r\n\t\tif(confirm(\"确实要删除吗？\")){\r\n\t\t\twindow.location.href=\"/jsoa/EmpSocialinsuranceAction.do?action=batchDel&ids=\"+ids+\"&empName=\"+document.form1.empName.value+\"&payType=\"+document.form1.payType.value+\"&pager.offset=");
      out.print(deloffset);
      ...
      out.write("\tform1.action = \"/jsoa/EmpSocialinsuranceAction.do?action=export\";\r\n\tform1.submit();\r\n\tform1.action = \"/jsoa/EmpSocialinsuranceAction.do?action=list\";\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
