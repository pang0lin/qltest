 ...
 * Generated at: 2023-01-06 10:02:03 UTC
...
public final class officemanager_005fatfunction_005fexport_005fcontract_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.system.vo.usermanager.ContractVO");
...
response.setHeader("Content-disposition", "attachment;filename="+new String("合同信息".getBytes("GBK"),"iso8859-1")+".xls");

      out.write("\r\n<html>\r\n<head>\r\n    <title>导出</title>\r\n</head>\r\n<body>\r\n<table border=\"1\">\r\n    <tr>\r\n        <td align=\"center\"><b>姓名</b></td>\r\n        <td align=\"center\"><b>组织</b></td>\r\n        <td align=\"center\"><b>签订日期</b></td>\r\n        <td align=\"center\"><b>合同类型</b></td>\r\n        <td align=\"center\"><b>合同类别</b></td>\r\n        <td align=\"center\"><b>合同期限</b></td>\r\n        <td align=\"center\"><b>合同开始日期</b></td>\r\n        <td align=\"center\"><b>合同结束日期</b></td>\r\n    </tr>\r\n    ");
ContractVO empVO = null;
    Object[] empObj = null;
	String empName = "";
    String orgName = "";
	String contractType = "";
    DateFormat df = DateFormat.getDateInstance(DateFormat.LONG, Locale.CHINESE);
      ...
      try {
        ...
        // /office_manager/officemanager_atfunction_export_contract.jsp(31,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("empList");
        // /office_manager/officemanager_atfunction_export_contract.jsp(31,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("empList");
        // /office_manager/officemanager_atfunction_export_contract.jsp(31,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        empVO = (ContractVO) empObj[0];
		empName = empObj[1]==null?"&nbsp;":empObj[1].toString();
        orgName = empObj[3]==null?"&nbsp;":empObj[3].toString();
		contractType = empVO.getContractType()==null?"":empVO.getContractType();
            ...
            out.print(orgName);
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
            out.print(empVO.getGivenDate()==null?"&nbsp;":df.format(empVO.getGivenDate()));
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
            out.print(empVO.getContractStyle()==null?"&nbsp;":empVO.getContractStyle());
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
if("-1".equals(contractType)){out.println("无固定限期");}if("0".equals(contractType)){out.println("有固定期限");}if("1".equals(contractType)){out.println("以完成任务为期限");}
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
if("0".equals(contractType)){out.println(empVO.getContractLimit()+"年");}
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
