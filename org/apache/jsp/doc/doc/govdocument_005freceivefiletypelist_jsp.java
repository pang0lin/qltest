...
public final class govdocument_005freceivefiletypelist_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("   <form  action=\"GovReceiveFileTypeAction.do\"  name=\"form1\" method=\"post\">\r\n     <tr>\r\n\t\t<td  width=\"8%\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\">序号</td>\r\n\t\t<td class=\"listTableHead\">收文类型名称</td>\r\n\t\t<td width=\"8%\" nowrap class=\"listTableHeadLast\">处理</td>\r\n\t </tr>\r\n     ");
		  ...
		  String listClass="listTableLine1";
            ...
            try {
              ...
              // /doc/doc/govdocument_receivefiletypelist.jsp(59,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("govReceiveFileTypeList");
              // /doc/doc/govdocument_receivefiletypelist.jsp(59,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("govReceiveFileTypeList");
              // /doc/doc/govdocument_receivefiletypelist.jsp(59,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setScope("request");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object govReceiveFileTypeList = null;
                ...
                govReceiveFileTypeList = (java.lang.Object) _jspx_page_context.findAttribute("govReceiveFileTypeList");
                do {
                  out.write("\r\n\t\t  ");

			Object[] obj = (Object[])govReceiveFileTypeList;
...
String pagerURL = "/jsoa/GovReceiveFileTypeAction.do";
            out.write("\r\n\t\t  ");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t</td>\r\n  </tr>  \r\n</table>\r\n\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n<script language=\"javascript\">\r\n//添加\r\nfunction add() {\r\n    var hhref  = \"/jsoa/GovReceiveFileTypeAction.do?actionFlag=addwindow\" ;\r\n JSMainWinOpen(hhref,\"\",\"TOP=0,LEFT=0,scrollbars=no,resizable=no,width=570,height=300\") ;\r\n}\r\n\r\nfunction modify(id){\r\n\tJSMainWinOpen('GovReceiveFileTypeAction.do?actionFlag=modify&id='+id+\"&pager.offset=");
            out.print(nowPage);
            out.write("\",'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=570,height=300')\r\n}\r\n\r\nfunction delBatch() {\r\n    var strId=getCheckBoxID();\r\n        if(strId!=\"\"){\r\n     if(confirm(\"确实要删除吗？\")){\r\n     \twindow.location.href=\"/jsoa/GovReceiveFileTypeAction.do?actionFlag=delBatch&ids=\" + getCheckBoxID()+\"&pager.offset=");
            out.print(nowPage);
            out.write("\" ;\r\n    }\r\n    }else{\r\n             alert(\"请选择要删除的记录!\");\r\n             return;\r\n         }\r\n}\r\n\r\nfunction del(id){\r\n    if(confirm(\"确实要删除吗？\")){\r\n      window.location.href=\"/jsoa/GovReceiveFileTypeAction.do?actionFlag=delone&id=\"+id+\"&pager.offset=");
            out.print(nowPage);
