...
String deleteSuccess = request.getAttribute("deleteSuccess") + "";
Boolean addRight = new Boolean(false);
if(!vindicate.equals("")) addRight = new Boolean(true);
if(deleteSuccess != null && deleteSuccess.length() > 0 && !"null".equals(deleteSuccess)){
      out.write("\r\n<script language=\"javascript\">\r\nalert('");
      out.print(deleteSuccess);
      out.write("');\r\n</script>\r\n");
}
      out.write("\r\n<!--goodsTypeList.jsp-->\r\n<body class=\"MainFrameBox\" onKeyDown=\"if(event.keyCode==13) search();\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n\r\n<!-- SEARCH\tPART -->\r\n<table id=\"searchTable\" style=\"display:none\"  width=\"100%\"\tborder=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n <form name=\"form2\" method=\"post\" action=\"/jsoa/GoodsTypeAction.do?flag=search\">\r\n\t<tr>\r\n\t  <td width=\"20\" rowspan=\"1\"></td>\r\n\t  <td>\r\n              物品类别：\r\n              <input onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'物品类别')\" onblur=\"value=checkQuery1(this,'物品类别')\" type=\"text\" class=\"inputtext\" size=\"30\" name=\"searchGoodsTypeName\" value=\"");
      out.print(request.getParameter("searchGoodsTypeName")==null?"":request.getParameter("searchGoodsTypeName"));
...
if(addRight.booleanValue()){
      out.write("\r\n\t\t  <button  class=\"btnButton2Font\"  onclick=\"javascript:MM_openBrWindow('/jsoa/GoodsTypeAction.do?flag=add','','TOP=10,LEFT=10,scrollbars=yes,resizable=no,width=540,height=350')\">新增</button>\r\n\t\t  ");
}
		  if(!vindicate.equals("")){
      out.write("\r\n\t\t  <button  class=\"btnButton2Font\"  onclick=\"javascript:batchDelete()\">删除</button>\r\n\t\t  ");
}
      out.write("\r\n\t\t  <button class=\"btnButton4font\" onClick=\"chSearch(this)\" value=\"查询\">查询</button>\r\n\t  </td>  </tr>\r\n</table>\r\n</td>\r\n</tr>\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\" >\r\n\t\t<tr align=\"center\">\r\n\t\t\t<td width=\"40\" height=\"28\" class=\"listTableHead\" nowrap>\r\n\t\t\t\t<input type=\"checkbox\" value=\"1\" name=\"selectAllBox\" onClick=\"selectAll(this);\"></td>\r\n\t\t\t<td width=\"30%\" class=\"listTableHead\"> 物品类别 </td>\r\n\t\t\t<td width=\"22%\" class=\"listTableHead\"> 所属仓库 </td>\r\n\t\t\t<td width=\"10%\" class=\"listTableHead\"> 类别前缀 </td>\r\n\t\t\t<td width=\"26%\" class=\"listTableHead\"> 备注 </td>\r\n\t\t\t<td width=\"8%\" class=\"listTableHeadLast\" nowrap> 处理 </td>\r\n\t\t</tr>\r\n\t\t");
      ...
      try {
        ...
        // /routine/resource_manager/goodsTypeList.jsp(146,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_logic_005fpresent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /routine/resource_manager/goodsTypeList.jsp(147,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("goodsTypeList");
              // /routine/resource_manager/goodsTypeList.jsp(147,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("goodsTypeList");
...
if(index%2 != 0){listClass="listTableLine2";}
		curParengid=goodsTypeObj[4].toString();
		if(curParengid.equals("0")) parentName=goodsTypeObj[1].toString();
		
                  out.write("\r\n\t\t<tr>\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write("\" height=\"25\"><input type=\"checkbox\" value=\"");
                  out.print(goodsTypeObj[0]);
                  out.write("\" name=\"goodsTypeId\"></td>\r\n\t\t  ");

		  if(!curParengid.equals("0")){
                  ...
                  out.write("\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write("\"><input type=hidden name=\"stockId\" value=\"");
                  out.print(goodsTypeObj[5]);
                  out.write('"');
                  out.write('>');
                  ...
                  out.write('"');
                  out.write('>');
                  out.print((goodsTypeObj[7]==null||goodsTypeObj[7].toString().trim().equals(""))?"&nbsp":goodsTypeObj[7]);
                  out.write("</td>\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print((goodsTypeObj[3]==null||goodsTypeObj[3].toString().trim().equals(""))?"&nbsp":goodsTypeObj[3]);
                  out.write("</td>\r\n\t\t");

		//if(vindicate.indexOf("$" + goodsTypeObj[0] + "$") >= 0)
...
String pagerURL = "/jsoa/GoodsTypeAction.do";
      out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n<!-- PAGER -->\r\n</table>\r\n\r\n\r\n\r\n</body>\r\n</html>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction search(){\r\n    form2.submit();\r\n}\r\nfunction unsearcher(){\r\n\twindow.location.href='/jsoa/GoodsTypeAction.do?flag=view'\r\n}\r\nfunction delSingle(goodsTypeId,stockId){\r\n ");
 int deloff = j==1? pageSize2-15:pageSize2;
  if(deloff < 0 ) deloff = 0 ;
 
      out.write("\r\n    if(confirm(\"确实要删除吗？\")){\r\n    window.location.href=\"/jsoa/GoodsTypeAction.do?flag=delete&stockId=\"+stockId+\"&goodsTypeId=\" + goodsTypeId + \"&pager.offset=");
      out.print(deloff);
      out.write("\" ;\r\n    }\r\n}\r\nfunction selectAll(obj){\r\n    if(document.all.goodsTypeId){\r\n        if(document.all.goodsTypeId.length){\r\n            for(var i = 0; i < document.all.goodsTypeId.length; i ++){\r\n                if(obj.checked){\r\n                    document.all.goodsTypeId[i].checked = true;\r\n                }else{\r\n                    document.all.goodsTypeId[i].checked = false;\r\n                }\r\n            }\r\n        }else{\r\n            if(obj.checked){\r\n                document.all.goodsTypeId.checked = true;\r\n            }else{\r\n                document.all.goodsTypeId.checked = false;\r\n            }\r\n        }\r\n    }\r\n}\r\nfunction batchDelete(){\r\n    //if(confirm(\"确实要删除物品类别吗？\")){\r\n        if(checkboxIsChecked(document.all.goodsTypeId)){\r\n            if(confirm(\"确实要删除物品类别吗？\")){\r\n            var id = \"\";\r\n            var sid =\"\";\r\n            if(document.all.goodsTypeId.length){\r\n                for(var i = 0; i < document.all.goodsTypeId.length; i ++){\r\n                    if(document.all.goodsTypeId[i].checked){\r\n");
      out.write("                        id += document.all.goodsTypeId[i].value + \",\";\r\n\t\t\t\t\t\tsid += document.all.stockId[i].value + \",\";\r\n                    }\r\n                }\r\n            }else{\r\n                if(document.all.goodsTypeId.checked){\r\n                    id = document.all.goodsTypeId.value;\r\n\t\t\t\t\tsid = document.all.stockId.value;\r\n                }\r\n            }\r\n\r\n            if(id.indexOf(\",\") > 0){\r\n                id = id.substring(0, id.length - 1);\r\n            }\r\n\t\t\tif(sid.indexOf(\",\") > 0){\r\n                sid = sid.substring(0, sid.length - 1);\r\n            }\r\n            window.location.href = \"/jsoa/GoodsTypeAction.do?flag=delete&goodsTypeId=\" + id+\"&stockId=\"+sid;\r\n            }\r\n        }else{\r\n            alert(\"请选择要删除的记录！\");\r\n        }\r\n}\r\n\r\nfunction modify(id,sid){\r\n\tMM_openBrWindow('/jsoa/GoodsTypeAction.do?flag=modify&stockId='+sid+'&goodsTypeId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("&searchGoodsTypeName_old='+document.all.searchGoodsTypeName.value,'','TOP=10,LEFT=10,scrollbars=no,resizable=no,width=540,height=350')\r\n}\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\n\tfunction chSearch(obj){\r\n\tif(obj.value == \"查询\"){\r\n\t\tobj.value = \"关闭查询\";\r\n\t\tobj.innerHTML=\"关闭查询\";\r\n\t\tdocument.all.searchTable.style.display=\"\";\r\n\t}else{\r\n\t\tobj.value = \"查询\";\r\n\t\tobj.innerHTML=\"查询\";\r\n\t\tdocument.all.searchTable.style.display=\"none\";\r\n\t}\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
