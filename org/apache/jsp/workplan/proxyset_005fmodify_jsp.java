...
public final class proxyset_005fmodify_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.oa.workplan.po.WorkplanProxyPO");
  }
...
WorkplanProxyPO po=(WorkplanProxyPO)request.getAttribute("proxyInfo");


      out.write("\r\n</head>\r\n<body onload=\"init();resizeWin(600,350)\"  class=\"MainFrameBox Pupwin\">\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"10\" cellspacing=\"0\" class=\"docBoxNoPanel\">\r\n<tr>\r\n    <td valign=\"top\">\r\n\t<div id=\"docinfo0\" style=\"display:;\">\r\n\t   <table width=\"100%\" border=\"0\" cellpadding=\"2\" cellspacing=\"1\">\r\n<form name=\"WorkProxyActionForm\"  action=\"/jsoa/WorkplanSetAction.do?action=proxymodifysave\" method=\"post\">\r\n\r\n\t\t\t\t<input type=\"hidden\" name=\"proxyId\" id=\"proxyId\" value=\"");
      out.print(po.getProxyId() );
      out.write("\" />\r\n\t\t\t\t  <td width=\"80\" nowrap>授权至&nbsp;<label class=\"MustFillColor\">*</label>：</td>\r\n\t\t\t\t  <td>\t\t\t\t\r\n\t\t\t\t\t  <input type=\"text\"  title=\"请点击选择\"style=\"cursor:pointer\"class=\"inputText\"id=\"proxyName\" style=\"width:95%\" maxlength=\"20\" value=\"");
      out.print(po.getProxyName());
      out.write("\" name=\"proxyName\"  readonly=\"readonly\"  onClick=\"openEndow('proxyId','proxyName',WorkProxyActionForm.proxyId.value,WorkProxyActionForm.proxyName.value,'user','yes','user','*0*')\"/>\r\n\t\t\t\t  </td>\r\n\t\t\t\t</tr>\r\n\t\t<!--  \t\t<div style=\"display\">\r\n\t\t\t\t <tr>\r\n \t\t\t\t  <td nowrap>代理状态：</td>\r\n\t\t\t\t  <td>\r\n\t\t\t\t  ");
if(po.getProxystatus()>0){ 
      out.write("\r\n\t\t\t\t  <input type=\"radio\" name=\"proxyStatus\" value=\"0\" style=\"display\">\r\n\t\t\t\t  <input type=\"radio\" name=\"proxyStatus\" value=\"1\" checked=\"checked\"style=\"display\" >\r\n\t\t\t\t  ");
}else {
      out.write("\r\n\t\t\t\t\t  <input type=\"radio\" name=\"proxyStatus\" value=\"1\" style=\"display\" >\r\n\t\t\t\t\t  <input type=\"radio\" name=\"proxyStatus\" value=\"0\" checked=\"checked\" style=\"display\">\r\n\t\t\t\t\t  ");
}
