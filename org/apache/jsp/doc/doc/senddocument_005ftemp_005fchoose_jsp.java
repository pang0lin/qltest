...
public final class senddocument_005ftemp_005fchoose_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int offset1 = index ;
String tempIds=(String)request.getAttribute("tempIds")==null?"":(String)request.getAttribute("tempIds");
...
if(request.getParameter("tempFileName")!=null)
  tempFileName=request.getParameter("tempFileName");
            ...
            try {
              ...
              // /doc/doc/senddocument_temp_choose.jsp(59,2) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("SenddocumentBaseAction.do?action=sendtmepList");
              // /doc/doc/senddocument_temp_choose.jsp(59,2) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n  \r\n<table width=\"100%\" height=\"10\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n  <tr>\r\n    <td align=\"left\">\r\n\t</td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\r\n     <tr align=\"center\">\r\n\t\t<td  width=\"8%\" nowrap class=\"listTableHead\">序号</td>\r\n\t\t<td  class=\"listTableHeadLast\">模板名称</td>\r\n\t\r\n\t </tr>\r\n\t ");
	 ...
	 String listClass="listTableLine1";
                  ...
                  try {
                    ...
                    // /doc/doc/senddocument_temp_choose.jsp(78,5) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("myList");
                    // /doc/doc/senddocument_temp_choose.jsp(78,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("myList");
                    // /doc/doc/senddocument_temp_choose.jsp(78,5) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		Object[] obj = (Object[])myList;
			...
			if(index%2 != 0){
				...
				listClass="listTableLine1";
                        ...
                        out.write("\r\n\t<tr>\r\n\t  <td class=\"");
                        out.print(listClass);
                        out.write("\">\r\n\t  <input type=\"checkbox\" style=\"cursor:'hand'\"  onchange=\"isCheck(this)\" name=\"doctemplateName\" value=\"");
                        out.print(obj[0]);
                        out.write(';');
                        out.print(obj[1]);
                        out.write('"');
                        out.write(' ');
 if(tempIds.indexOf((String)obj[0])>-1){out.print("checked=\"checked\"");} 
                        out.write(' ');
                        out.write('>');
                        out.print(index);
                        out.write(" </td>\r\n\t  <td class=\"");
...
if(!currentPageNumber.equals(pageCount)){
	    ...
	    if("shandongguotou".equals(com.js.util.config.SystemCommon.getCustomerName())){
            ...
            out.write("\r\n\t    \t <button class=\"btnButton4font\" onclick=\"saveCloseGt();\">保存退出</button>\r\n\t    \t");
      ...
      out.write("\t\t\t}\r\n        \t }\r\n   \t }\r\n    }else {\r\n            for(var i = 0 ; i < SenddocumentBaseActionForm.length ; i++ ) {\r\n                var chkObj = SenddocumentBaseActionForm[i] ;\r\n                 if(chkObj.type == \"checkbox\"){\r\n                        if(chkObj!=obj) {\r\n                              chkObj.checked = false ;\r\n                        }\r\n                 }\r\n   \t }\r\n    }\r\n}\r\n \r\n//保存退出\r\nfunction saveClose(){\r\n\tvar objs=document.getElementsByName(\"doctemplateName\");\r\n\tvar flag=false;\r\n\tvar tid=\"\";\r\n\tvar tname=\"\";\r\n\tif(objs.length>0){\r\n\t\tfor(var i=0;i<objs.length;i++){\r\n\t\t\tif(objs[i].checked){\r\n\t\t\t\ttid+=(objs[i].value.split(\";\")[0])+\";\";\r\n\t\t\t\ttname+=(objs[i].value.split(\";\"))[1]+\";\";\r\n\t\t\t\tflag=true;\r\n\t\t\t\t\r\n\t\t\t}\r\n\t\t}\r\n\t\tif(flag){\r\n\t\t\topener.window.document.all.templateId.value=tid;\r\n\t\t\topener.window.document.all.templateName.value=tname;\r\n\t\t\twindow.close();\r\n\t\t}else{\r\n\t\t\talert(\"请选择模板！\");\r\n\t\t\treturn false;\r\n\t\t}\r\n\t\t\r\n\t}else{\r\n\t\talert(\"无选择数据，请退出!\");\r\n\t\treturn false;\r\n\t}\r\n}\r\n\r\nfunction saveCloseGt(){\r\n\tvar objs=document.getElementsByName(\"doctemplateName\");\r\n");
      out.write("\tvar templateIdTemp = document.getElementById(\"templateIdTemp\");\r\n\tvar templateNameTemp = document.getElementById(\"templateNameTemp\");\r\n\tif(objs.length>0){\r\n\t\tif(templateIdTemp.value!=\"\"){\r\n\t\t\topener.window.document.all.templateId.value=templateIdTemp.value;\r\n\t\t\topener.window.document.all.templateName.value=templateNameTemp.value;\r\n\t\t\twindow.close();\r\n\t\t}else{\r\n\t\t\talert(\"请选择模板！\");\r\n\t\t\treturn false;\r\n\t\t}\r\n\t}else{\r\n\t\talert(\"无选择数据，请退出!\");\r\n\t\treturn false;\r\n\t}\r\n}\r\n//关闭\r\nfunction closer() {\r\n    window.close();\r\n}\r\n\r\nfunction checkOk(obj,tvalue,tText){\r\n\t\r\n\r\nif(confirm(\"确认选中吗？\")){\r\nopener.window.document.all.templateId.value=tvalue;\r\n\r\nopener.window.document.all.templateName.value=tText;\r\n\r\nwindow.close();\r\n}else{\r\n obj.checked=false;\r\n\r\n}\r\n\r\n\r\n}\r\nfunction closeOK() {\r\n\r\n\r\n\r\n    \r\n}\r\n\r\n\r\n\r\nfunction orderBy(type,sortType){\r\n\r\n\t\r\n\r\n}\r\n\r\nfunction unsearcher(){\r\n\r\n var myhref =\"/jsoa/SenddocumentBaseAction.do?action=sendtmepList\";\r\n window.location.href = myhref;\r\n}\r\n\r\nfunction searcher() {\r\n     if(document.all.tempFileName.value.indexOf(\"'\") >= 0){\r\n");
      out.write("    \talert(\"搜索条件不能包含单引号！\");\r\n        return ;\r\n    }\r\n   var myhref =\"/jsoa/SenddocumentBaseAction.do?action=sendtmepList\"\r\n\r\n    if(document.all.tempFileName.value!=\"\"){\r\n\t\tvar myhref =\"/jsoa/SenddocumentBaseAction.do?action=sendtmepList&tempFileName=\"+document.all.tempFileName.value;\r\n\t\t\r\n\t}\r\n\t window.location.href = myhref;\r\n}\r\n\r\nfunction isCheck(obj){\r\n\tvar templateIdTemp = document.getElementById(\"templateIdTemp\");\r\n\tvar templateNameTemp = document.getElementById(\"templateNameTemp\");\r\n\tvar id = obj.value.split(\";\")[0]+\";\";\r\n\tvar name = obj.value.split(\";\")[1]+\";\";\r\n\tif(obj.checked){\r\n\t\ttemplateIdTemp.value=templateIdTemp.value+id;\r\n\t\ttemplateNameTemp.value=templateNameTemp.value+name;\r\n\t}else{\r\n\t\ttemplateIdTemp.value = templateIdTemp.value.replace(id,\"\").replace(/(^\\s*)|(\\s*$)/g,\"\");\r\n\t\ttemplateNameTemp.value = templateNameTemp.value.replace(name,\"\").replace(/(^\\s*)|(\\s*$)/g,\"\");\r\n\t}\r\n}\r\n\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
