 ...
 * Generated at: 2023-01-06 09:47:18 UTC
...
public final class outStockGoodsList_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String addGoods = request.getParameter("addGoods")==null?"0":request.getParameter("addGoods");
      ...
      out.print(addGoods.equals("0")?"查看物品信息":"领用物品信息");
...
String addcolumn = request.getParameter("addcolumn")==null?"7":request.getParameter("addcolumn");
      ...
      try {
        ...
        // /routine/resource_manager/outStockGoodsList.jsp(60,36) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_logic_005fpresent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /routine/resource_manager/outStockGoodsList.jsp(61,38) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("searchGoodsTypeList");
              // /routine/resource_manager/outStockGoodsList.jsp(61,38) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(addGoods.equals("2")) out.print("<span style='display:none'>");
...
if(addGoods.equals("2")) out.print("</span>");
      ...
      out.print((request.getParameter("addGoods")!=null&&request.getParameter("addGoods").equals("2"))?"/jsoa/GoodsAction.do?addGoods=2&stockId="+request.getParameter("stockId")+"&addcolumn="+addcolumn+"&chuku="+request.getParameter("chuku"):"/jsoa/GoodsAction.do?flag=view");
      out.write("'\" value=\"重置\" >\r\n                              </td>\r\n                            </tr>\r\n                            ");
if(request.getParameter("addGoods") != null && "2".equals(request.getParameter("addGoods"))) {
      out.write("\r\n                            <input type=\"hidden\" name=\"addGoods\" value=\"2\">\r\n                            <input type=\"hidden\" name=\"stockId\" value=\"");
...
if(addRight.booleanValue() && addGoods.equals("0")){
      ...
      out.write("\">\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\" id=\"goodsTable\">\r\n    \r\n                      <tr align=\"center\">\r\n                        <td  width=\"40px\" class=\"listTableHead\" nowrap><input type=\"checkbox\" value=\"1\" name=\"selectAllBox\" onclick=\"selectAll(this);\"></td>\r\n                        <td class=\"listTableHead\"> 存货编号 </td>\r\n                        <td class=\"listTableHead\"> 物品仓库 </td>\r\n                        <td class=\"listTableHead\"> 物品类别 </td>\r\n                        <td class=\"listTableHead\"> 存货名称 </td>\r\n                        <td class=\"listTableHead\"> 计量单位 </td>\r\n                        <td class=\"listTableHead\"> 单价 </td>\r\n");
//if(!addGoods.equals("1")){
      out.write("\r\n                        <td class=\"listTableHead\"> 数量 </td>\r\n                        <td class=\"listTableHead\"> 金额 </td>\r\n                        <td class=\"listTableHead\" style=\"display:none\"> 最低库存 </td>\r\n\t\t\t\t\t\t<td style=\"display:none\">规格型号</td>\r\n");
//}
      out.write("\r\n\t\t\t\t\t\t");
if(!addGoods.equals("2")){
      ...
      out.write("\r\n                      </tr>\r\n                      ");
					  ...
					  List outStockGoodsList = (List)request.getAttribute("outStockList");
      ...
      try {
        ...
        // /routine/resource_manager/outStockGoodsList.jsp(177,22) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f1.setId("goodsList");
        // /routine/resource_manager/outStockGoodsList.jsp(177,22) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
goodsObj = (Object[]) goodsList;
					...
					if(index%2 != 0){listClass="listTableLine2";}
						...
						String curMoney = format.format(Double.parseDouble(goodsObj[6].toString()));

						float _amount = 0;
						DecimalFormat format2 = new DecimalFormat("#0.00");
						float _money = 0;
						if(outStockGoodsList != null && outStockGoodsList.size() > 0){
							for (Iterator it = outStockGoodsList.iterator(); it.hasNext(); ) {
								Object[] obj = (Object[])it.next();
								if(goodsObj[0].toString().equals(obj[0].toString())){
									_amount = Float.parseFloat(obj[1].toString());
									curKc = format.format(_amount);
									_money = Float.parseFloat(obj[2].toString());
									curMoney = format2.format(_money);
									break;
								}
							}
						}
...
if(goodsObj[9]!=null&&!"".equals(goodsObj[9].toString())){
            ...
            out.write("',0,'");
            out.print(goodsObj[16]);
            out.write("',event);\"  onclick=\"JSMainWinOpen('/jsoa/GoodsAction.do?flag=modify&goodsId=");
            out.print(goodsObj[0]);
...
if(!addGoods.equals("2")){
            ...
            out.print(goodsObj[0]);
            out.write("')\" >&nbsp;<img src=\"images/del.gif\" title=\"删除\" style=\"cursor:pointer\" onclick=\"delSingle('");
            out.print(goodsObj[0]);
            out.write("')\" >\r\n\t\t\t\t\t\t &nbsp;</td>\r\n\t\t\t\t\t\t  ");
}
            out.write("\r\n                      </tr>\r\n\t\t\t\t\t  ");
...
if(!deleteSuccess.booleanValue()){
 ...
 if(request.getParameter("chuku") != null && request.getParameter("chuku").equals("1")){ 
	...
	if(BrowserJudge.isMSIE(request)){
      ...
      out.print(domainId);
      out.write("+\"_\"+(goodsTable.rows[j + 1].cells[1].innerHTML).replace(/^\\s+|\\s+$/g,\"\")){\r\n\t\t\t\t\t\t\t\t\talert(goodsTable.rows[j + 1].cells[4].children[0].innerHTML+\"已经选择过,每张单据只能出现一条该物品记录！\");\r\n\t\t\t\t\t\t\t\t\treturn false;\r\n\t\t\t\t\t\t\t\t}\r\n\t\t\t\t\t\t\t}\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t}\r\n\t\t\t\t} else{\r\n\t\t\t\t\tif(document.all.goodsId.checked){\r\n\t\t\t\t\t\tfor( var i = 0 ; i < opener.document.all.goodsId.length;i++){\r\n\t\t\t\t\t\t\tif(opener.document.all.goodsId[i].value == ");
      out.print(domainId);
      out.write("+\"_\"+(goodsTable.rows[1].cells[1].innerHTML).replace(/^\\s+|\\s+$/g,\"\")){\r\n\t\t\t\t\t\t\t\talert(goodsTable.rows[1].cells[4].children[0].innerHTML+\"已经选择过,每张单据只能出现一条该物品记录！\");\r\n\t\t\t\t\t\t\t\treturn false;\r\n\t\t\t\t\t\t\t}\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t\t}else{ //单据上只有一个物品\r\n\t\t\t\tif(document.all.goodsId.length){\r\n\t\t\t\t\tfor(var j = 0; j < document.all.goodsId.length; j ++){\r\n\t\t\t\t\t\tif(document.all.goodsId[j].checked){\r\n\t\t\t\t\t\t\tif(opener.document.all.goodsId.value == ");
      out.print(domainId);
      out.write("+\"_\"+(goodsTable.rows[j + 1].cells[1].innerHTML).replace(/^\\s+|\\s+$/g,\"\")){\r\n\t\t\t\t\t\t\t\talert(goodsTable.rows[j + 1].cells[4].children[0].innerHTML+\"已经选择过,每张单据只能出现一条该物品记录！\");\r\n\t\t\t\t\t\t\t\treturn false;\r\n\t\t\t\t\t\t\t}\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t}\r\n\t\t\t\t}else{\r\n\t\t\t\t\tif(document.all.goodsId.checked){alert(opener.document.all.goodsId);\r\n\t\t\t\t\t\tif(opener.document.all.goodsId.value == ");
      out.print(domainId);
      out.write("+\"_\"+(goodsTable.rows[1].cells[1].innerHTML).replace(/^\\s+|\\s+$/g,\"\")){\r\n\t\t\t\t\t\t\talert(goodsTable.rows[1].cells[4].children[0].innerHTML+\"已经选择过,每张单据只能出现一条该物品记录！\");\r\n\t\t\t\t\t\t\treturn false;\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t}\r\n\t\t");
      ...
      out.print(domainId);
      out.write("_\" + goodsTable.rows[j + 1].cells[1].innerText + \">\" + goodsTable.rows[j + 1].cells[1].innerText;\r\n\t\t\t\t\t\t\t\t\t");

								}else{
									
      out.write("\r\n\t\t\t\t\t\t\t\t\tvar tmp = goodsTable.rows[j + 1].cells[0].children[2].value || \"&nbsp;\";\r\n\t\t\t\t\t\t\t\t\tstrValue = \"<input type=hidden name=goodsId value=\" + tmp + \">\" + tmp;\r\n\t\t\t\t\t\t\t\t\t");

								}
								
      out.write("\r\n\t\t\t\t\t\t\t\toCell1.innerHTML = strValue;\r\n\t\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\t\tcase 1:\r\n\t\t\t\t\t\t\t\tvar tmp = goodsTable.rows[j + 1].cells[4].children[1].value || \"&nbsp;\";\r\n\t\t\t\t\t\t\t\tstrValue = \"<input type=hidden name=goodsName value=\" + tmp + \">\" + tmp;\r\n\t\t\t\t\t\t\t\toCell2.innerHTML = strValue;\r\n\t\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\t\tcase 2:\r\n\t\t\t\t\t\t\t\tvar tmp = goodsTable.rows[j + 1].cells[10].children[0].value || \"&nbsp;\";\r\n\t\t\t\t\t\t\t\tstrValue =\"<input type=hidden name=goodsSpecs value=\" + tmp + \">\" + tmp;\r\n\t\t\t\t\t\t\t\toCell3.innerHTML = strValue;\r\n\t\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\t\tcase 3:\r\n\t\t\t\t\t\t\t\tvar tmp = goodsTable.rows[j + 1].cells[5].children[0].value || \"&nbsp;\";\r\n\t\t\t\t\t\t\t\tstrValue = \"<input type=hidden name=goodsUnit value=\" + tmp + \">\" + tmp;\r\n\t\t\t\t\t\t\t\toCell4.innerHTML = strValue;\r\n\t\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\t\tcase 4:\r\n\t\t\t\t\t\t\t\tstrValue = \"<input type=text class=inputtext value=1 size=10 name=amount onblur=javascript:CheckAndCount();total_money();>\";\r\n\t\t\t\t\t\t\t\toCell5.innerHTML = strValue;\r\n\t\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\t\tcase 5:\r\n\t\t\t\t\t\t\t\tstrValue = \"<input type=text class=inputtext readonly=true value=\" + goodsTable.rows[j + 1].cells[6].innerHTML + \" size=10 name=price maxlength=9  >\";\r\n");
      out.write("\t\t\t\t\t\t\t\toCell6.innerHTML = strValue;\r\n\t\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\t\tcase 6:\r\n\t\t\t\t\t\t\t\tstrValue = \"<input type=text class=inputtext readonly=true value=\" + goodsTable.rows[j + 1].cells[6].innerHTML + \" size=10 maxlength=9 name=money >\";\r\n\t\t\t\t\t\t\t\toCell7.innerHTML = strValue;\r\n\t\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\t\tcase 7:\r\n\t\t\t\t\t\t\t\tstrValue = \"<input type=text name=useNamestr   readonly=true value=\" + ssUseMan + \">\"+ \"&nbsp;\"+\"<input type=hidden name=kc  value=\" + goodsTable.rows[j + 1].cells[7].innerHTML  + \">\"+ \"&nbsp;\";\r\n\t\t\t\t\t\t\t\toCell8.innerHTML = strValue; \r\n\t\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t}\r\n\t\t\t\t\topener.total_money();\r\n\t\t\t\t\taddNum++;\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t}else{\r\n\t\t\tif(document.all.goodsId.checked){\r\n\t\t\t\t//var row = detailTable.insertRow();\r\n\t\t\t\tvar tableObj = tableadd(\"detailTable\",1);\r\n              \t\r\n\t\t\t\tvar oCell1 = tableObj.insertCell(0);\r\n\t\t\t\tvar oCell2 = tableObj.insertCell(1);\r\n\t\t\t\tvar oCell3 = tableObj.insertCell(2);\r\n\t\t\t \tvar oCell4 = tableObj.insertCell(3);\r\n\t\t\t\tvar oCell5 = tableObj.insertCell(4);\r\n\t\t\t\tvar oCell6 = tableObj.insertCell(5);\r\n");
      out.write("\t\t\t\tvar oCell7 = tableObj.insertCell(6);\r\n\t\t\t\tvar oCell8 = tableObj.insertCell(7);\r\n\t\t\t\tvar oCell9 = tableObj.insertCell(8);\r\n\t\t\t\r\n\t\t\t\tfor(var k = 0; k <=");
      out.print(addcolumn);
      out.write("; k ++){\r\n\t\t\t\t\t//cell=row.insertCell();\r\n\t\t\t\t\tswitch(k){\r\n\t\t\t\t\t\tcase ");
      out.print(addcolumn);
      out.write(":\r\n\t\t\t\t\t\t\tstrValue = \"<img src=/jsoa/images/del.gif alt=删除该物品 onclick=javascript:document.all.detailTable.deleteRow(parentElement.parentElement.rowIndex);total_money(); style=cursor:pointer>\";\r\n\t\t\t\t\t\t\toCell9.innerHTML = strValue;\r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\tcase 0:\r\n\t\t\t\t\t\t\t");
      ...
      out.write("\r\n\t\t\t\t\t\t\t\tstrValue = \"<input type=hidden name=goodsId value=");
      out.print(domainId);
      out.write("_\" + goodsTable.rows[1].cells[1].innerText + \">\" + goodsTable.rows[1].cells[1].innerText;\r\n\t\t\t\t\t\t\t\t");

							}else{
								
      out.write("\r\n\t\t\t\t\t\t\t\tvar tmp = goodsTable.rows[1].cells[0].children[2].value || \"&nbsp;\";\r\n\t\t\t\t\t\t\t\tstrValue = \"<input type=hidden name=goodsId value=\" + tmp + \">\" + tmp;\r\n\t\t\t\t\t\t\t\t");

							}
							
      out.write("\r\n\t\t\t\t\t\t\toCell1.innerHTML = strValue;\r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\tcase 1:\r\n\t\t\t\t\t\t\tvar tmp = goodsTable.rows[1].cells[4].children[1].value || \"&nbsp;\";\r\n\t\t\t\t\t\t\tstrValue = \"<input type=hidden name=goodsName value=\" + tmp + \">\" + tmp;\r\n\t\t\t\t\t\t\toCell2.innerHTML = strValue;\r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\tcase 2:\r\n\t\t\t\t\t\t\tvar tmp = goodsTable.rows[1].cells[10].children[0].value || \"&nbsp;\";\r\n\t\t\t\t\t\t\tstrValue =\"<input type=hidden name=goodsSpecs value=\" + tmp + \">\" + tmp;\r\n\t\t\t\t\t\t\toCell3.innerHTML = strValue;\r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\tcase 3:\r\n\t\t\t\t\t\t\tvar tmp = goodsTable.rows[1].cells[5].children[0].value || \"&nbsp;\";\r\n\t\t\t\t\t\t\tstrValue = \"<input type=hidden name=goodsUnit value=\" + tmp + \">\" + tmp;\r\n\t\t\t\t\t\t\toCell4.innerHTML = strValue;\r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\tcase 4:\r\n\t\t\t\t\t\t\tstrValue = \"<input type=text class=inputtext value=1 size=10 name=amount onblur=javascript:CheckAndCount();total_money();>\";\r\n\t\t\t\t\t\t\toCell5.innerHTML = strValue;\r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\tcase 5:\r\n\t\t\t\t\t\t\tstrValue = \"<input type=text class=inputtext readonly=true value=\" + goodsTable.rows[1].cells[6].innerHTML + \" size=10 name=price maxlength=9  >\";\r\n");
      out.write("\t\t\t\t\t\t\toCell6.innerHTML = strValue;\r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\tcase 6:\r\n\t\t\t\t\t\t\tstrValue = \"<input type=text class=inputtext readonly=true value=\" + goodsTable.rows[1].cells[6].innerHTML + \" size=10 name=money maxlength=9 >\";\r\n\t\t\t\t\t\t\toCell7.innerHTML = strValue;\r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t\tcase 7:\r\n\t\t\t\t\t\t\tstrValue = \"<input type=text name=useNamestr   readonly=true value=\" + ssUseMan + \">\"+ \"&nbsp;\"+\"<input type=hidden name=kc  value=\" + goodsTable.rows[1].cells[7].innerHTML + \">\"+ \"&nbsp;\";\r\n\t\t\t\t\t\t\toCell8.innerHTML = strValue; \r\n\t\t\t\t\t\t\tbreak;\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t\t\topener.total_money();\r\n\t\t\t\taddNum++;\r\n\t\t\t}\r\n\t\t}\r\n\t}\r\n\ttry{\r\n\t\tvar goods_num = opener.document.all.detailTable.rows.length - 1;\r\n\t\tvar total_money = 0.00;\r\n\t\tvar cutNumber = Math.pow(10,2);\r\n\t\tif(goods_num == 0){\r\n\t\t\topener.document.all.ptMoney.value = 0;\r\n\t\t}else if(goods_num==1){\r\n\t\t\topener.document.all.ptMoney.value = opener.document.all.money.value;\r\n\t\t}else{\r\n\t\t\tfor(i = 0;i < goods_num; i++){\r\n\t\t\t\ttotal_money = total_money * 1 + (opener.document.all.money[i].value) * 1;\r\n");
      out.write("\t\t\t}\r\n\t\t\topener.document.all.ptMoney.value = Math.round(total_money * cutNumber)/cutNumber;\r\n\t\t}\r\n\t}catch(e){}\r\n\tif(addNum > 0) alert(\"物品添加成功！\");\r\n\tif (flag == 2){\r\n\t\twindow.close();\r\n\t} else{\r\n\t\tcheckReset();\r\n\t}\r\n}\r\n\r\nfunction checkReset() {\r\n\t");

	if( j > 0 ){
		
      out.write("\r\n        for(var i = 0; i < document.getElementsByName(\"goodsId\").length; i++){\r\n            document.getElementsByName(\"goodsId\")[i].checked = false;\r\n        }\r\n\t\t");
