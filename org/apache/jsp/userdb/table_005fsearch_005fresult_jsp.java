...
public final class table_005fsearch_005fresult_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int i = 0 ;
            ...
            out.write("\r\n\r\n<body  class=\"MainFrameBox\" onKeyDown=\"if(event.keyCode==13) query();\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n ");
            //  html:form
            ...
            try {
              ...
              // /userdb/table_search_result.jsp(45,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/TableAction.do");
              // /userdb/table_search_result.jsp(45,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  try {
                    ...
                    // /userdb/table_search_result.jsp(56,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("modellist");
                    // /userdb/table_search_result.jsp(56,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("modellist");
                    // /userdb/table_search_result.jsp(56,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setScope("request");
                    int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
                    if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      java.lang.Object modellist = null;
                      ...
                      modellist = (java.lang.Object) _jspx_page_context.findAttribute("modellist");
                      do {
                        out.write("\r\n\t\t\t\t\t");

						Object[] modelArr = (Object[]) modellist;
						out.print("<option value=\""+modelArr[0]+"\""+(modelArr[0].equals(request.getParameter("model"))?"selected":"")+">"+modelArr[2]+"</option>");
                  ...
                  if (_jspx_meth_html_005ftext_005f0(_jspx_th_html_005fform_005f0, _jspx_page_context))
                    return;
                  out.write("</td>\r\n\t<td nowrap align=\"right\">\r\n    <input type=\"button\" class=\"btnButton2Font\" onclick=\"query()\" value=\"查询\" />\r\n    <input type=\"button\" class=\"btnButton2Font\" onclick=\"javascript:window.location.href='/jsoa/TableAction.do'\" value=\"重置\" />\r\n\t</td>\r\n\t<td width=\"16\"></td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"inlineBottomLine\">\r\n  <tr>\r\n    <td align=\"left\" nowrap>\r\n\t\t    <div id=\"PanleDIV\" class=\"tabPanelSelected\" onClick=\"changePanle(this,'/jsoa/TableAction.do');\">\r\n\t        <div class=\"tabPanelLeft\"></div>\r\n\t        <div class=\"tabPanelCenter\">数据表设置</div>\r\n\t        <div class=\"tabPanelRight\"></div>      \r\n\t      </div>\r\n\t       <div class=\"btnBQspace AlignLeft\"></div>\r\n\t\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/CustomFormAction.do');\">\r\n\t        <div class=\"tabPanelLeft\"></div>\r\n\t        <div class=\"tabPanelCenter\">表单设置</div>\r\n\t        <div class=\"tabPanelRight\"></div>      \r\n\t      </div>\r\n\t       <div class=\"btnBQspace AlignLeft\"></div>\r\n");
                  out.write("\t\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/WFProcessAction.do?moduleId=1');\">\r\n\t        <div class=\"tabPanelLeft\"></div>\r\n\t        <div class=\"tabPanelCenter\">流程设置</div>\r\n\t        <div class=\"tabPanelRight\"></div>      \r\n\t      </div>\r\n\t      <!-- \r\n\t       <div class=\"btnBQspace AlignLeft\"></div>\r\n\t\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/ModelAction.do');\">\r\n\t        <div class=\"tabPanelLeft\"></div>\r\n\t        <div class=\"tabPanelCenter\">数据表类别</div>\r\n\t        <div class=\"tabPanelRight\"></div>      \r\n\t      </div>\r\n\t      -->\r\n\t      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/BaseSetAction.do?flag=list');\">\r\n\t        <div class=\"tabPanelLeft\"></div>\r\n\t        <div class=\"tabPanelCenter\">基础数据</div>\r\n\t        <div class=\"tabPanelRight\"></div>      \r\n\t      </div>\r\n    </td>\r\n    <td>&nbsp;</td>\r\n    <td align=\"right\" nowrap>\r\n    <input type=\"button\" value=\"新增\" class=\"btnButton2Font\" onclick=\"javascript:addTable()\">\r\n");
                  out.write("    <input type=\"button\" class=\"btnButton2Font\" onclick=\"javascript:copyData()\" value=\"复制表\"/>\r\n    <input type=\"button\" value=\"删除\" class=\"btnButton2Font\" onclick='javascript:if(!checkboxIsChecked(document.all.id)){alert(\"请选择要删除的记录！\");}else{if(confirm(\"确定删除吗?\")) {del();}}' />\r\n    <input type=\"button\"  class=\"btnButton4font\" onClick=\"chSearch(this)\" value =\"查询\" />\r\n    </td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n\t<tr >\r\n\t\t<td width=\"40\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"chkSelect\" onclick=\"selectID(this);\"></td>\r\n\t\t<!--<td width=\"15%\" class=\"listTableHead\">编号</td>-->\r\n\t\t<!--<td width=\"15%\" class=\"listTableHead\">所属分类</td>-->\r\n\t\t<td class=\"listTableHead\" onclick=\"sort('1');\">表名称<img  name=\"img1\"  title=\"按名称排序\" style=\"cursor:pointer\" src=\"/jsoa/images/blanksort.gif\"/></td>\r\n\t\t<!--<td width=\"15%\" class=\"listTableHead\">系统名称</td>-->\r\n\t\t<!-- <td width=\"15%\" class=\"listTableHead\">创建者</td> -->\r\n\t\t<td width=\"10%\" nowrap class=\"listTableHead\">创建时间</td>\r\n");
                  out.write("\t\t<td width=\"10%\" nowrap class=\"listTableHeadLast\"> 处理</td>\r\n\t</tr>\r\n\r\n\r\n\t\t");

			int index=0;
			int flag=0;
			if(request.getParameter("pager.offset") != null){
				i = Integer.parseInt((request.getParameter("pager.offset")==null || "null".equals(request.getParameter("pager.offset")))?"0":request.getParameter("pager.offset"));
				flag=i;
			}
                  ...
                  try {
                    ...
                    // /userdb/table_search_result.jsp(140,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f1.setId("tableList");
                    // /userdb/table_search_result.jsp(140,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f1.setName("tableList");
                    // /userdb/table_search_result.jsp(140,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
//=i+1
                        ...
                        out.write('"');
                        out.write('>');
if(obj[6]!=null) out.print(obj[6]); else out.print("&nbsp;");
                        out.write("</td>-->\r\n\t\t<!--<td class=\"");
                        out.print(listClass);
                        out.write('"');
                        out.write('>');
if(obj[3]!=null) out.print(obj[3]); else out.print("&nbsp;");
                        out.write("</td>-->\r\n\t\t<td class=\"");
                        out.print(listClass);
                        out.write("\"><a href=\"javascript:void(0);\" onclick=\"javascript:MM_openBrWindow('/jsoa/TableInfoAction.do?operate=load&tableId=");
                        out.print(obj[0]);
                        out.write("','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=400,height=300')\">");
if(obj[1]!=null) out.print(obj[1]); else out.print("&nbsp;");
                        out.write("</a></td>\r\n\t\t<!--<td class=\"");
                        out.print(listClass);
                        out.write('"');
                        out.write('>');
if(obj[2]!=null) out.print(obj[2]); else out.print("&nbsp;");
                        out.write("</td>\r\n\t\t<!-- <td class=\"");
//=listClass
                        out.write('"');
                        out.write('>');
//if(obj[4]!=null) out.print(obj[4]); else out.print("&nbsp;");
                        out.write("</td> -->\r\n\t\t<td class=\"");
                        out.print(listClass);
                        out.write("\" nowrap>");
if(obj[5]!=null){if(obj[5].toString().length()>10) out.print(obj[5].toString().substring(0,10)); else out.print(obj[5]);} else out.print("&nbsp;");
                        out.write("</td>\r\n\t\t<td class=\"");
                        out.print(listClass);
                        out.write(" listTableLineLastTD\">\r\n<a href=\"javascript:void(0);\" onclick=\"javascript:MM_openBrWindow('/jsoa/TableInfoAction.do?operate=load&tableId=");
                        out.print(obj[0]);
                        out.write("','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=400,height=300')\">");
                        if (_jspx_meth_html_005fimg_005f0(_jspx_th_logic_005fiterate_005f1, _jspx_page_context))
                          return;
                        out.write("</a>&nbsp;<a href=\"javascript:void(0);\" onclick=\"javascript:if(confirm('确定删除吗?')) {delone('");
                        out.print(obj[2]);
                        out.write("');}\">");
                        if (_jspx_meth_html_005fimg_005f1(_jspx_th_logic_005fiterate_005f1, _jspx_page_context))
                          return;
                        out.write("</a>&nbsp;<a href=\"javascript:void(0);\" onclick=\"javascript:setChildTable('");
                        out.print(obj[0]);
                        out.write('\'');
                        out.write(',');
                        out.write('\'');
                        ...
                        out.print(obj[5]);
                        out.write("','edit')\">");
                        if (_jspx_meth_html_005fimg_005f2(_jspx_th_logic_005fiterate_005f1, _jspx_page_context))
                          return;
                        out.write("</a>\r\n<a href=\"javascript:void(0);\" onclick=\"doStatistic('");
                        out.print(obj[0]);
                        out.write("')\">");
                        if (_jspx_meth_html_005fimg_005f3(_jspx_th_logic_005fiterate_005f1, _jspx_page_context))
                          return;
                        out.write("</a>&nbsp;\r\n\t\t</td>\r\n\t</tr>\t\t\r\n\t");
...
String pagerURL = "/jsoa/TableAction.do";
                  out.write("\r\n\t\t");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n</td></tr></table>\r\n<iframe name=\"myIframe\" id=\"myIfram\" style=\"display:none;\"></iframe>\r\n</body> \r\n");
      ...
      out.write("\r\n\r\n<script language=\"javascript\">\r\n\t//统计设置\r\n\tfunction doStatistic(tableId){\r\n\t\tvar url=\"/jsoa/StatisticsManageAction.do?action=manageLst&statsTableId=\"+tableId;\r\n\t\tJSMainWinOpen(url,\"\",\"\");\r\n\t} \r\n\tfunction add(){\t\t\r\n\t\tMM_openBrWindow(\"/jsoa/userdb/table_add.jsp\",\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=300\") ;\r\n\t}\r\n\tfunction addTable(){\t\r\n\t\tMM_openBrWindow(\"/jsoa/TableInfoAction.do?operate=add\",\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=300\") ;\r\n\t}\r\n\t//按名称排序-2016-7.27\r\n\t function sort(mark){\r\n         var sname=document.getElementById(\"searchname\").value;\r\n         var operate=\"search\";\r\n        // var tablename=document.all.tablename.value;\r\n         var model=document.all.model.value;\r\n         var desc=document.all.desc.value;\r\n         if(desc==\"1\"){ \r\n              desc = \"2\";\r\n         }else if (desc == \"2\"){\r\n             desc = \"1\";\r\n         }else{\r\n             desc = \"1\";\r\n         }\r\n         var hhref= \"/jsoa/TableAction.do?mark=\"+mark+\"&sname=\"+sname+\"&operate=\"+operate+\"&model=\"+model+\"&desc=\"+desc ;\r\n");
      out.write("         window.location.href =hhref;\r\n    }\r\n\r\n\tfunction del(){\r\n\t\tTableActionForm.operate.value=\"batchdelete\";\r\n\t\tTableActionForm.submit();\r\n\t}\r\n\r\n\tfunction delone(name){\r\n\t\tTableActionForm.operate.value=\"signledelete\";\r\n\t\tTableActionForm.tablename.value=name;\r\n\t\tTableActionForm.submit();\r\n\t}\r\n\r\n\tfunction setChildTable(id,code,desname,name,model,filepath,owner,date,tag){\r\n\t\tvar url=\"/jsoa/AssociateAction.do?operate=list&tablename=\"+name+\"&tableid=\"+id;\r\n\t\tJSMainWinOpen(url,\"\",\"\");\r\n\t\t//window.location.href=url;\r\n\t}\r\n\r\n\tfunction query(){\r\n        document.getElementById(\"pager.offset\").value = 0;\r\n\t\tTableActionForm.operate.value=\"search\";\r\n\t\tTableActionForm.submit();\r\n\t}\r\n\r\n\tfunction selectAll(name) {\r\n    var obj=document.all[name];\r\n    if (obj&&obj.length) {\r\n      for (i=0;i<obj.length;i++) {\r\n\t\t  if (!obj[i].disabled)\r\n\t\t\t  obj[i].checked=true;\r\n      }\r\n      return;\r\n    }\r\n    if (obj) {\r\n      obj.checked=true;\r\n    }\r\n  }\r\n\r\n  function clearAll(name) {\r\n    var obj=document.all[name];\r\n    if (obj&&obj.length) {\r\n");
      out.write("      for (i=0;i<obj.length;i++) {\r\n        if (!obj[i].disabled)\r\n\t\t\tobj[i].checked=false;\r\n      }\r\n      return;\r\n    }\r\n    if (obj) {\r\n      obj.checked=false;\r\n    }\r\n  }\r\n  function selectID(obj){\r\n\t  if (obj.checked)\r\n\t\t  selectAll('id');\r\n\t  else\r\n\t\t  clearAll('id');\r\n  }\r\n  function changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n  }\r\nfunction chSearch(obj){\r\n\tif(obj.value == \"查询\"){\r\n\t\tobj.value = \"关闭查询\";\r\n\t\tdocument.all.searchTable.style.display=\"\";\r\n\t}else{\r\n\t\tobj.value = \"查询\";\r\n\t\tdocument.all.searchTable.style.display=\"none\";\r\n\t}\r\n}\r\nfunction copyData(){\r\n\tvar copyedID = \"\";\r\n  \tvar obj=document.getElementsByName(\"id\");\r\n    if (obj&&obj.length) {\r\n      for (i=0;i<obj.length;i++) {\r\n        if (obj[i].checked) copyedID+=obj[i].value+\",\";\r\n      }      \r\n    }\r\n    if(copyedID==\"\"){\r\n    \talert(\"请选择要复制的数据表!\");\r\n    }else{\r\n    \t//alert(copyedID);\r\n    \t//window.open(\"/jsoa/TableAction.do?operate=copyData&tableId=\"+copyedID,\"myIframe\");\r\n    \t//location.reload();\r\n    \tdocument.location.href=\"/jsoa/TableAction.do?operate=copyData&tableId=\"+copyedID;\r\n");
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /userdb/table_search_result.jsp(64,4) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyleClass("inputText");
      // /userdb/table_search_result.jsp(64,4) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setProperty("sname");
      // /userdb/table_search_result.jsp(64,4) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fimg_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
          throws java.lang.Throwable {
    javax.servlet.jsp.PageContext pageContext = _jspx_page_context;
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  html:img
    ...
    try {
      ...
      _jspx_th_html_005fimg_005f0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_logic_005fiterate_005f1);
      // /userdb/table_search_result.jsp(157,196) name = border type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f0.setBorder("0");
      // /userdb/table_search_result.jsp(157,196) name = src type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f0.setSrc("/jsoa/images/modi.gif");
      // /userdb/table_search_result.jsp(157,196) name = alt type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f0.setAlt("修改");
  ...
  private boolean _jspx_meth_html_005fimg_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
          throws java.lang.Throwable {
    javax.servlet.jsp.PageContext pageContext = _jspx_page_context;
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  html:img
    org.apache.struts.taglib.html.ImgTag _jspx_th_html_005fimg_005f1 = (org.apache.struts.taglib.html.ImgTag) _005fjspx_005ftagPool_005fhtml_005fimg_0026_005fsrc_005fborder_005falt_005fnobody.get(org.apache.struts.taglib.html.ImgTag.class);
    boolean _jspx_th_html_005fimg_005f1_reused = false;
    try {
      _jspx_th_html_005fimg_005f1.setPageContext(_jspx_page_context);
      _jspx_th_html_005fimg_005f1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_logic_005fiterate_005f1);
      // /userdb/table_search_result.jsp(157,363) name = border type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f1.setBorder("0");
      // /userdb/table_search_result.jsp(157,363) name = src type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f1.setSrc("/jsoa/images/del.gif");
      // /userdb/table_search_result.jsp(157,363) name = alt type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f1.setAlt("删除");
      ...
      _005fjspx_005ftagPool_005fhtml_005fimg_0026_005fsrc_005fborder_005falt_005fnobody.reuse(_jspx_th_html_005fimg_005f1);
  ...
  private boolean _jspx_meth_html_005fimg_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
          throws java.lang.Throwable {
    javax.servlet.jsp.PageContext pageContext = _jspx_page_context;
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  html:img
    org.apache.struts.taglib.html.ImgTag _jspx_th_html_005fimg_005f2 = (org.apache.struts.taglib.html.ImgTag) _005fjspx_005ftagPool_005fhtml_005fimg_0026_005fsrc_005fborder_005falt_005fnobody.get(org.apache.struts.taglib.html.ImgTag.class);
    boolean _jspx_th_html_005fimg_005f2_reused = false;
    try {
      _jspx_th_html_005fimg_005f2.setPageContext(_jspx_page_context);
      _jspx_th_html_005fimg_005f2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_logic_005fiterate_005f1);
      // /userdb/table_search_result.jsp(157,617) name = border type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f2.setBorder("0");
      // /userdb/table_search_result.jsp(157,617) name = src type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f2.setSrc("/jsoa/images/taskchild.gif");
      // /userdb/table_search_result.jsp(157,617) name = alt type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f2.setAlt("设置子表");
      ...
      _005fjspx_005ftagPool_005fhtml_005fimg_0026_005fsrc_005fborder_005falt_005fnobody.reuse(_jspx_th_html_005fimg_005f2);
  ...
  private boolean _jspx_meth_html_005fimg_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
          throws java.lang.Throwable {
    javax.servlet.jsp.PageContext pageContext = _jspx_page_context;
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  html:img
    org.apache.struts.taglib.html.ImgTag _jspx_th_html_005fimg_005f3 = (org.apache.struts.taglib.html.ImgTag) _005fjspx_005ftagPool_005fhtml_005fimg_0026_005fsrc_005fborder_005falt_005fnobody.get(org.apache.struts.taglib.html.ImgTag.class);
    boolean _jspx_th_html_005fimg_005f3_reused = false;
    try {
      _jspx_th_html_005fimg_005f3.setPageContext(_jspx_page_context);
      _jspx_th_html_005fimg_005f3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_logic_005fiterate_005f1);
      // /userdb/table_search_result.jsp(158,67) name = border type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f3.setBorder("0");
      // /userdb/table_search_result.jsp(158,67) name = src type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f3.setSrc("/jsoa/images/tj.gif");
      // /userdb/table_search_result.jsp(158,67) name = alt type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f3.setAlt("统计设置");
      ...
      _005fjspx_005ftagPool_005fhtml_005fimg_0026_005fsrc_005fborder_005falt_005fnobody.reuse(_jspx_th_html_005fimg_005f3);
