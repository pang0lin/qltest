...
public final class EmpInhabitancyExport_jsp extends org.apache.jasper.runtime.HttpJspBase
...
response.setHeader("Content-disposition", "attachment;filename="+new String("居住证办理".getBytes("GBK"),"iso8859-1")+".xls");
	...
	isDate = request.getAttribute("isDate").toString();
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n<head>\r\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=GBK\">\r\n\r\n</head>\r\n\r\n<body>\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"1\" cellpadding=\"0\" cellspacing=\"1\">\r\n\t<tr align=\"center\">\r\n\t\t<td width=\"10%\" class=\"\" nowrap=\"nowrap\">申办人</td>\r\n\t\t<td width=\"10%\" class=\"\">初办时间</td>\r\n\t\t<td width=\"20%\" class=\"\" nowrap=\"nowrap\">居住证年限</td>\r\n\t\t<td width=\"15%\" class=\"\" nowrap=\"nowrap\">续办时间</td>\r\n\t\t<td width=\"15%\" class=\"\" nowrap=\"nowrap\">备注</td>\r\n\t  </tr>\r\n\r\n\t\t");
		...
		String listClass="";
            ...
            try {
              ...
              // /personnel_manager/EmpInhabitancyExport.jsp(46,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /personnel_manager/EmpInhabitancyExport.jsp(46,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /personnel_manager/EmpInhabitancyExport.jsp(46,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
