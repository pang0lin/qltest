...
public final class officebuildList_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      out.write("\r\n          \r\n          ");
            ...
            if(request.getAttribute("buildList")!=null){
	           for(int i=0;i<buildList.size();i++){
	            Object[] obj = (Object[]) buildList.get(i);
	            index ++;
                j ++;
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\tif(confirm(\"您确认要删除该条记录么?\")){\r\n\t document.OfficeRoomActionForm.action = \"/jsoa/OfficeRoomAction.do?action=delete&id=\"+para+\"&pager.offset=");
      out.print(deloffset);
