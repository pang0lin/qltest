 ...
 * Generated at: 2023-01-06 09:58:25 UTC
...
public final class item_005fselect_005fact_005fback_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getParameter("wechatShowDoc")!=null){
	...
	wechatShowDoc2 = request.getParameter("wechatShowDoc");
      ...
      out.write("\">\r\n\t\t\t\t\r\n\t\t\t\t<div class='infoTitle'>流程退回</div>\r\n\t\t\t\t\r\n\t\t\t\t<div class=\"item\">\r\n\t\t\t\t\t<div class=\"title\">退回节点:</div>\r\n\t\t\t\t\t<div class=\"content\" >\r\n\t\t\t\t\t\t<select class=\"select\" name=\"backToAllInfo\">\r\n\t\t\t\t\t\t  \t");
      ...
      out.write("\r\n\t\t\t\t\t\t\t<option value=\"0\">发起人</option>\r\n\t\t\t\t  \t\t</select>\r\n\t    \t\t\t</div>\r\n\t\t\t\t</div>\t\r\n\t\t\t\t\t\t\r\n\t\t\t\t<div class=\"item\">\r\n\t\t\t        <div class=\"content\">\r\n\t\t\t        \t<textarea id=\"include_comment\" name=\"include_comment\" rows=\"6\" maxlength=\"1000\" placeholder=\"请输入退回意见\"></textarea>\r\n\t\t\t        </div>\r\n                </div>\r\n                \r\n\t\t\t</form>\r\n\t\t</div>\r\n\t\t\r\n\t\t<!-- 按钮 -->\r\n\t\t<div class=\"footer\">\r\n\t  \t\t<div class=\"buttons\">\r\n\t  \t\t\t<div class=\"button\" onclick=\"submitForm()\">办理完毕</div>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t\t\r\n\t</BODY>\r\n</HTML>\r\n<script type=\"text/javascript\">\r\n\t\t");
