...
public final class systemmanager_005fuser_005funable_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int offset1=index;
	 ...
	 String listClass="listTableLine1";
            ...
            try {
              ...
              // /setup/systemmanager_user_unable.jsp(110,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("userList");
              // /setup/systemmanager_user_unable.jsp(110,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("userList");
              // /setup/systemmanager_user_unable.jsp(110,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
//=index
                  ...
                  out.write('"');
                  out.write('>');
                  out.print((obj[2]==null||obj[2].toString().equals(""))?"&nbsp;":obj[2]);
                  out.write("</td>-->\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
if("0".equals(obj[3].toString())){out.print("男");}else{out.print("女");}
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(StaticParam.getOrgByNum(obj[6]+"") );
                  out.write("</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
...
if("0".equals(obj[5].toString())){out.print("否");}else{out.print("是");}
                  out.write("</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">\r\n\t\t\t&nbsp;<img src=\"/jsoa/images/huifu.gif\" title=\"恢复\" style=\"cursor:pointer\" onclick=\"javascript:recoverMe(");
                  out.print(obj[0]);
                  out.write(");\">\r\n\t\t\t</td>\r\n\t  </tr>\r\n\t");
...
String search="&cnName=" + cnName + "&enName=" + enName + "&orgName=" +orgName + "&isSuper=" + isSuper;
...
if(com.js.util.config.SystemCommon.getAudit()!=0&&com.js.util.config.SystemCommon.getAutoAudit()!=1){ 
      ...
      out.print(offset1);
      out.print(search);
      out.write("&status=disabled&action=delete&id=\"+id;\r\n        }\r\n    }else{\r\n        alert(\"请选择要删除的用户！\");\r\n    }\r\n}\r\n\r\nfunction updateMe(id){\r\n    if(id!=\"\"){\r\n        JSMainWinOpen('/jsoa/ToUserAddAction.do?pager.offset=");
      out.print(offset1);
      out.print(search);
      out.write("&status=disabled&action=update&userid='+id+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=580');\r\n    }\r\n}\r\n\r\nfunction deleteMe(id){\r\n    if(window.confirm(\"确实要删除吗？\")){\r\n        if(id!=\"\"){\r\n            ");
if(com.js.util.config.SystemCommon.getAudit()!=0&&com.js.util.config.SystemCommon.getAutoAudit()!=1){ 
      out.write("\r\n                alert(\"数据已提交审计管理员审核！\");\r\n            ");
}
      out.write("\r\n            window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/UserAction.do?pager.offset=");
      out.print(offset1);
      out.print(search);
      out.write("&status=disabled&action=delete&id=\"+id+\",\";\r\n    \t}\r\n    }\r\n}\r\n\r\nfunction deleteAll(){\r\n    if(window.confirm(\"确实要删除所有禁用用户吗？\")){\r\n        ");
if(com.js.util.config.SystemCommon.getAudit()!=0&&com.js.util.config.SystemCommon.getAutoAudit()!=1){ 
      out.write("\r\n                alert(\"数据已提交审计管理员审核！\");\r\n            ");
}
      out.write("\r\n        window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/UserAction.do?status=disabled&action=deleteAll\";\r\n    }\r\n}\r\n\r\nfunction recoverBatch(){\r\n   var id=getBoxIds();\r\n   if(id!=\"\"){\r\n       if(window.confirm(\"确实要恢复吗？\")){\r\n            ");
if(com.js.util.config.SystemCommon.getAudit()!=0&&com.js.util.config.SystemCommon.getAutoAudit()!=1){ 
      out.write("\r\n                alert(\"数据已提交审计管理员审核！\");\r\n            ");
}
      out.write("\r\n           window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/UserAction.do?pager.offset=");
      out.print(offset1);
      out.print(search);
      out.write("&status=disabled&action=recover&id=\"+id;\r\n        }\r\n    }else{\r\n        alert(\"请选择要恢复的用户！\");\r\n    }\r\n}\r\n\r\nfunction recoverMe(id){\r\n    if(window.confirm(\"确实要恢复吗？\")){\r\n    \tif(id!=\"\"){\r\n    \t   ");
if(com.js.util.config.SystemCommon.getAudit()!=0&&com.js.util.config.SystemCommon.getAutoAudit()!=1){ 
      out.write("\r\n                alert(\"数据已提交审计管理员审核！\");\r\n            ");
}
      out.write("\r\n            window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/UserAction.do?pager.offset=");
  ...
  private boolean _jspx_meth_html_005fform_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /setup/systemmanager_user_unable.jsp(35,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fform_005f0.setAction("/ListUserAction.do?status=disabled");
      // /setup/systemmanager_user_unable.jsp(35,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /setup/systemmanager_user_unable.jsp(40,2) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyleClass("inputtext");
      // /setup/systemmanager_user_unable.jsp(40,2) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setProperty("cnName");
      // /setup/systemmanager_user_unable.jsp(40,2) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftext_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /setup/systemmanager_user_unable.jsp(44,3) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setStyleClass("inputtext");
      // /setup/systemmanager_user_unable.jsp(44,3) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setProperty("userAccount");
      // /setup/systemmanager_user_unable.jsp(44,3) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftext_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /setup/systemmanager_user_unable.jsp(47,5) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setStyleClass("inputtext");
      // /setup/systemmanager_user_unable.jsp(47,5) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setProperty("enName");
      // /setup/systemmanager_user_unable.jsp(47,5) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /setup/systemmanager_user_unable.jsp(54,7) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f0.setProperty("orgId");
      // /setup/systemmanager_user_unable.jsp(54,7) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftext_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /setup/systemmanager_user_unable.jsp(55,3) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f3.setStyleClass("inputtext");
      // /setup/systemmanager_user_unable.jsp(55,3) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f3.setProperty("orgName");
      // /setup/systemmanager_user_unable.jsp(55,3) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fselect_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /setup/systemmanager_user_unable.jsp(57,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fselect_005f0.setProperty("isSuper");
      // /setup/systemmanager_user_unable.jsp(57,8) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fselect_005f0.setStyle("width:115px");
  ...
  private boolean _jspx_meth_html_005foption_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /setup/systemmanager_user_unable.jsp(58,4) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005foption_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /setup/systemmanager_user_unable.jsp(59,4) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005foption_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /setup/systemmanager_user_unable.jsp(60,4) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
