 ...
 */
package org.apache.jsp.wap2.channel;
...
public final class channelList_005f3g_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int beginIndex=Integer.parseInt(request.getParameter("beginIndex")==null?"0":request.getParameter("beginIndex"));
      ...
      out.print(basePath);
      out.write("/wap2/index_3g.jsp\">桌面</A></DIV></SPAN>\r\n           <SPAN id=title>最新知识</SPAN>\r\n           <A class=btn_1 href=\"javascript:history.back();\">返回</A>\r\n\t       </DIV>\r\n       <DIV class=height2></DIV> \r\n<div>\r\n ");
if(list!=null&&list.size()>0){ 
		for(int i=0;i<list.size();i++){
			InformationPO po=(InformationPO)list.get(i);	
	
      out.write("\r\n\t  ");
if(!po.getInformationType().equals("3")){ 
      out.write("\r\n\t  \r\n\t  <DIV class=lista1>\r\n         <DIV class=l1>\r\n            <A class=listing href=\"");
      out.print(basePath);
      out.write("/wap/action/ChannelAction.do?method=infoContent&infoID=");
      out.print(po.getInformationId() );
      out.write("&beginIndex=");
      out.print(beginIndex );
      out.write("\">\r\n            ");
      out.print(po.getInformationTitle() );
      out.write("</A>\r\n         </DIV>\r\n         <SPAN>");
      out.print(po.getInformationIssuer()+"/"+po.getInformationIssueTime().toString().replace(".0", "") );
      out.write("&nbsp;&nbsp;&nbsp;&nbsp;</SPAN>\r\n       </DIV>\r\n\t  ");
}else{
      out.write("\r\n\t  <DIV class=lista1>\r\n         <DIV class=l1>\r\n             <A class=listing href=\"");
      out.print(basePath);
      out.write("/wap2/wapdownload.jsp?");
      out.print(com.js.util.util.BASE64.BASE64EncoderNoBR("FileName="+po.getInformationHeadFile()+"&name="+po.getInformationTitle()+"&moduleCode=oa_netdisk_knowlge&path=information&informationId="+po.getInformationId()+"&type=channel&beginIndex="+beginIndex) );
      out.write("\">\r\n              ");
      out.print(po.getInformationTitle() );
      out.write("</A>\r\n         </DIV>\r\n         <SPAN>");
      out.print(po.getInformationIssuer()+"/"+po.getInformationIssueTime().toString().replace(".0", ""));
...
if(upIndex>=0)upUrl=basePath+"/wap/action/ChannelAction.do?method=infoList&beginIndex="+upIndex;
if(nextIndex<recordCount)nextUrl=basePath+"/wap/action/ChannelAction.do?method=infoList&beginIndex="+nextIndex;
