...
public final class archivesFile_005fcollect_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getAttribute("sortProperty")!=null) {
	...
	String pigeonholeStatus ="";
	if(request.getParameter("pigeonholeStatus") !=null){
		pigeonholeStatus = request.getParameter("pigeonholeStatus").toString();
	}
	...
	int pageSize= 0;
        ...
        pageSize = Integer.parseInt(request.getAttribute("maxPageItems").toString());
            ...
            try {
              ...
              // /archives/archivesFile_collect.jsp(138,4) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/archivesAction.do?action=archivesSearch");
              // /archives/archivesFile_collect.jsp(138,4) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("\"/>\r\n\t\t<tr>\r\n\t\t  <td width=\"25%\">&nbsp;&nbsp;标题：&nbsp;&nbsp;&nbsp;<input onkeypress=\"return look() ;\" onkeyup=\"checkQuery(this,'标题')\" onblur=\"value=checkQuery1(this,'标题')\" name=\"fileName\" type=\"text\"  value=\"");
                  out.print(fileName==""?"":fileName);
                  out.write("\" class=\"inputtext\"  maxlength=\"10\"/></td>\r\n\t\t  <td width=\"30%\" height=\"30\">归档类别：\r\n\t\t <select name=\"pigeonholeStatus\" class=\"inputtext\" style=\"width:120px\">\r\n\t\t\t  <option value=\"-1\" ");
if(pigeonholeStatus !="" && "-1".equals(pigeonholeStatus)){
                  out.write("selected");
}
...
if(pigeonholeStatus !="" && "1".equals(pigeonholeStatus)){
                  ...
                  out.write(">待归档</option>\r\n\t\t\t  <option value=\"0\"  ");
if(pigeonholeStatus !="" && "0".equals(pigeonholeStatus)){
                  out.write("selected");
}
                  out.write(">已归档</option>\r\n\t\t  </select>\r\n      </td>\r\n\t  </tr>\r\n\t    <tr>\r\n\t\t  <td align=\"right\" colspan=\"2\">\r\n\t\t   ");
                  out.write("\r\n\t\t   <input type=\"button\" class=\"btnButton4Font\" onClick=\"search('");
                  out.print(action);
...
if("yes".equals(isAddRight)){
		...
		if("yes".equals(isModiRight)){
            ...
            out.write("\r\n\t\t");
if (("logout".equals(fileState) || "nopigeonhole2".equals(fileState)) && !"".equals(isModiRight) && "yes".equals(isModiRight)){
	 
            out.write("<button class=\"btnButton4Font\" onClick=\"delBatch('");
            out.print(fileState);
            out.write("')\">删除</button>\r\n\t");
}
            out.write("\r\n\t<input type=\"button\" class=\"btnButton2Font\" id=\"btnButton2FontShow\" onClick=\"showSearch();\" value=\"查询\"/>\r\n\t<input type=\"button\" class=\"btnButton2Font\" id=\"btnButton2FontClose\" onClick=\"closeSearch();\" style=\"display:none\" value=\"关闭查询\"/>\r\n        <!--<button class=\"btnButton2Font\" onClick=\"exportData();\">导出</button>-->\r\n\t</td>\r\n  </tr>\r\n</table>\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n   <form action=\"\" name=\"form1\" method=\"post\">\r\n     <tr align=\"center\">\r\n\t\t<td  width=\"40\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"selectAll\" onClick=\"javascript:selectAllItem();\"></td>\r\n\t\t<td width=\"10%\" class=\"listTableHead\" onclick=\"sort('dossierNO');\"> 序号<!--  &nbsp;<img id=\"dossierNO_sort\" name=\"dossierNO_sort\"  title=\"按序号排序\" style=\"cursor:hand\" src=\"/jsoa/images/blanksort.gif\"/>--></td>\r\n\t\t<td class=\"listTableHead\" onclick=\"sort('fileName');\"> 标题<!--&nbsp;<img id=\"fileName_sort\" name=\"fileName_sort\"  title=\"按标题排序\" style=\"cursor:hand\" src=\"/jsoa/images/blanksort.gif\"/>--></td>\r\n");
            out.write("\t\t<td width=\"10%\" class=\"listTableHead\" onclick=\"sort('");
            out.print(!"1".equals(request.getParameter("archivesType"))?"fileNo":"dossierNO");
            out.write("');\"> ");
            out.print(!"1".equals(request.getParameter("archivesType"))?"文号":"档案号");
            out.write("<!--&nbsp;<img id=\"");
            out.print(!"1".equals(request.getParameter("archivesType"))?"fileNo":"dossierNO");
            out.write("_sort\" name=\"");
            out.print(!"1".equals(request.getParameter("archivesType"))?"fileNo":"dossierNO");
            out.write("_sort\"  title=\"按");
            out.print(!"1".equals(request.getParameter("archivesType"))?"文号":"档案号");
            out.write("排序\" style=\"cursor:hand\" src=\"/jsoa/images/blanksort.gif\"/>--></td>\r\n\t\t<td width=\"10%\" class=\"listTableHead\" onclick=\"sort('fileKey');\"> 主题词<!--&nbsp;<img id=\"fileKey_sort\" name=\"fileKey_sort\"  title=\"按主题词排序\" style=\"cursor:hand\" src=\"/jsoa/images/blanksort.gif\"/>--></td>\r\n\t\t<td width=\"10%\" class=\"listTableHead\" onclick=\"sort('pigeonholeDate');\"> 归档日期<!--&nbsp;<img id=\"pigeonholeDate_sort\" name=\"pigeonholeDate_sort\"  title=\"按归档日期排序\" style=\"cursor:hand\" src=\"/jsoa/images/blanksort.gif\"/>--></td>\r\n\t\t<td width=\"10%\" class=\"listTableHead\" onclick=\"sort('pigeonholeStatus');\"> 状态<!--&nbsp;<img id=\"pigeonholeStatus_sort\" name=\"pigeonholeStatus_sort\"  title=\"按状态排序\" style=\"cursor:hand\" src=\"/jsoa/images/blanksort.gif\"/>--></td>\r\n\t\t<td width=\"8%\" nowrap class=\"listTableHead\">操作</td>\r\n\t </tr>\r\n      ");
		...
		String listClass="listTableLine1";
            ...
            try {
              ...
              // /archives/archivesFile_collect.jsp(227,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /archives/archivesFile_collect.jsp(227,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("ArchivesFileList");
              // /archives/archivesFile_collect.jsp(227,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		if(index%2 != 0){
			...
			listClass="listTableLine1";
                  ...
                  out.print(obj[0]);
                  out.write('"');
if(modiArchivesFileIds.indexOf(obj[0].toString())<0 || obj[12]!=null && obj[12].toString().equals("0")){
                  out.write("disabled");
}
                  out.write("></td>\r\n\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
if(obj[13]!=null&&"0".equals(obj[13])){
                  ...
                  out.write("&nbsp;</td>\r\n\t  <td class=\"");
                  out.print(listClass);
                  out.write("\" style=\"word-break:break-all\"><a href=\"javascript:view('");
                  out.print(obj[0]);
                  out.write("')\">");
                  out.print(obj[3]);
                  out.write("</a></td>\r\n\t  ");

	  	if(!"1".equals(request.getParameter("archivesType"))){
                  ...
                  out.write('"');
                  out.write('>');
 if(obj[12].toString().equals("1")){out.println("<font color=red>待归档</font>");}
	  else if(obj[12].toString().equals("0")){out.println("<font color=blue>已归档</font>");}
                  out.write(" </td>\r\n\t  <td class=\"");
                  out.print(listClass);
...
if(obj[12]!=null && obj[12].toString().equals("1")){
                  out.write("<img style=\"cursor:hand\" border=\"0\" width=\"16\" height=\"16\" src=\"images/guidang2.gif\" alt=\"归档\" onclick=\"modify('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
 ...
 int deloff = j==1 ? pageSize2-15:pageSize2;
  ...
  deloff = j==1 ? pageSize2-15:pageSize2;
	   if(deloff<0) deloff = 0;
            ...
            out.write("   window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/archivesAction.do?action=delArchivesFile&fileId=\"+id+\"&fileState=\"+fileState+\"&archivesType=");
            out.print(archivesType);
            out.write("&pager.offset=");
            out.print(deloff);
            out.write("\";\r\n    }\r\n}\r\nfunction delBatch(fileState) {\r\n    var strId=getCheckBoxID();\r\n        if(strId!=\"\"){\r\n     if(confirm(\"确实要批量删除吗？\")){\r\n\tif (document.all.selProcess) {\r\n     \twindow.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/archivesAction.do?action=delBatchArchivesFile&ids=\"+getCheckBoxID()+\"&fileState=\"+fileState + \"&noproc=1&archivesType=");
            out.print(archivesType);
            out.write("\";\r\n\t} else {\r\n        window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/archivesAction.do?action=delBatchArchivesFile&ids=\"+getCheckBoxID()+\"&fileState=\"+fileState + \"&noproc=&archivesType=");
            out.print(archivesType);
            ...
            out.write("\t\t\t\t}\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\nfunction exportData() {\r\n    window.open(\"/jsoa/archivesAction.do?action=viewArchivesFile&flag=export&pager.offset=");
            out.print(request.getParameter("pager.offset"));
            out.write("\");\r\n}\r\n\r\nfunction search(type){\r\n\tif(type==\"viewArchivesFile\"){//卷宗管理（所有）\r\n\t\tdocument.archivesActionForm.action=\"archivesAction.do?action=viewArchivesFile&archivesType=");
            out.print(archivesType);
            out.write("\";\r\n\t\tdocument.archivesActionForm.target = \"_self\";\r\n\t\tdocument.archivesActionForm.submit();\r\n\t}else if(type==\"viewNoPigeonholeArchivesFile\"){//未归档文件\r\n\t\tdocument.archivesActionForm.action=\"archivesAction.do?action=viewNoPigeonholeArchivesFile&noproc=1&archivesType=");
            out.print(archivesType);
            out.write("\";\r\n\t\tdocument.archivesActionForm.target = \"_self\";\r\n\t\tdocument.archivesActionForm.submit();\r\n\t}else if(type==\"viewLogoutArchivesFile\"){//注销文件\r\n\t\tdocument.archivesActionForm.action=\"archivesAction.do?action=viewLogoutArchivesFile&noproc=1&archivesType=");
            out.print(archivesType);
            out.write("\";\r\n\t\tdocument.archivesActionForm.target = \"_self\";\r\n\t\tdocument.archivesActionForm.submit();\r\n\t}else{\r\n\t\tdocument.archivesActionForm.action=\"archivesAction.do?action=\"+type+\"&noproc=1&archivesType=");
            out.print(archivesType);
            ...
            out.write("&archivesType=");
            out.print(archivesType);
            out.write("\";\r\n\t}else if(type==\"viewNoPigeonholeArchivesFile2\"){\r\n\t\twindow.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/archivesAction.do?action=viewNoPigeonholeArchivesFile2&noproc=1&archivesType=");
            out.print(archivesType);
            out.write("\";\r\n\t}else if(type==\"viewLogoutArchivesFile\"){\r\n\t\twindow.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/archivesAction.do?action=viewLogoutArchivesFile&noproc=1&archivesType=");
            out.print(archivesType);
            out.write("\";\r\n\t}else if(type==\"viewNoPigeonholeArchivesFileCollect\"){\r\n\t    window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/archivesAction.do?action=viewNoPigeonholeArchivesFileCollect&noproc=1&archivesType=");
            out.print(archivesType);
            out.write("\";\r\n\t}\r\n}\r\n\r\nfunction initSort() {\r\n    var sortProperty = \"");
            out.print(sortProperty);
            out.write("\";\r\n\tvar sortType = \"");
