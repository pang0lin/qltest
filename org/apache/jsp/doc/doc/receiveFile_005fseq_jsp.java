...
public final class receiveFile_005fseq_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getParameter("seqNameR")!=null){
seqNameR=java.net.URLDecoder.decode(request.getParameter("seqNameR"),"UTF-8");
}
      ...
      if(showTag){
            ...
            try {
              ...
              // /doc/doc/receiveFile_seq.jsp(112,2) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("ReceiveDocumentBaseAction.do?action=receiveSeqList");
              // /doc/doc/receiveFile_seq.jsp(112,2) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n     <tr align=\"center\">\r\n\t\t<td  width=\"40\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"chkSelect\" style=\"cursor:'hand'\" onclick=\"selectAll(this)\"></td>\r\n\t\t<td class=\"listTableHead\">流水号名称</td>\r\n\t   <td class=\"listTableHead\" width=\"35%\">对应流程名称</td>\r\n\t\t\t<!--<td class=\"listTableHead\">文件类型</td>-->\r\n              <!-- <td class=\"listTableHead\">是否启用流水号</td>-->\r\n        <td class=\"listTableHead\" width=\"15%\">是否有年度</td>\r\n\t\t<td width=\"8%\" nowrap class=\"listTableHeadLast\">处理</td>\r\n\t </tr>\r\n\t ");
	 ...
	 String listClass="listTableLine1";
                  ...
                  try {
                    ...
                    // /doc/doc/receiveFile_seq.jsp(125,5) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("mylist");
                    // /doc/doc/receiveFile_seq.jsp(125,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("mylist");
                    // /doc/doc/receiveFile_seq.jsp(125,5) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		Object[] obj = (Object[])mylist;
			...
			if(index%2 != 0){
				...
				listClass="listTableLine1";
                        ...
                        out.print(listClass);
                        out.write("\">\r\n\t\t");
                        out.print(obj[5].toString().equals("1")?"是":"否");
                        out.write("\r\n\t  </td>\r\n\t  <td class=\"");
                        out.print(listClass);
...
String pagerURL = "/jsoa/ReceiveDocumentBaseAction.do";
            out.write("\r\n\t\t  ");
