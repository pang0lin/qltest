...
public final class pop_005fmail_005fdrop_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(BrowserJudge.isMSIE(request)){ 
      out.write("\r\n\t\t\t\t\t\t\t\t\t<button id='button2' class=\"btnButton2Font\" onclick=\"downLoadMail()\">下载</button>\r\n\t\t\t\t\t\t\t\t\t<button id='button3' class=\"btnButton2Font\" onclick=\"delMail()\">彻底删除</button>\r\n\t\t\t\t\t\t\t\t\t<button id='button4' class=\"btnButton2Font\" onclick=\"delAll()\">清空</button>\r\n\t\t\t\t\t\t\t\t");
}else{ 
      out.write("\r\n\t\t\t\t\t\t\t\t\t<input type=\"button\" id='button2' class=\"btnButton2Font\" onclick=\"downLoadMail()\" value=\"下载\"/>\r\n\t\t\t\t\t\t\t\t\t<input type=\"button\" id='button3' class=\"btnButton2Font\" onclick=\"delMail()\" value=\"彻底删除\" />\r\n\t\t\t\t\t\t\t\t\t<input type=\"button\" id='button4' class=\"btnButton2Font\" onclick=\"delAll()\" value=\"清空\" />\r\n\t\t\t\t\t\t\t\t");
} 
...
List list = (List) request.getAttribute("webMailListInDB");
      ...
      try {
        ...
        // /webmail/pop_mail_drop_list.jsp(105,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("webMailListInDB");
        // /webmail/pop_mail_drop_list.jsp(105,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("webMailListInDB");
        // /webmail/pop_mail_drop_list.jsp(105,7) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          Integer size=0;
            ...
            out.print(listClass);
            out.write("\">\r\n\t\t                               ");
if(from!=null&&!from.equals("")&&from.split(",").length>2){ 
            out.write("\r\n\t\t                                    ");
            out.print(from.split(",")[0]+","+from.split(",")[1]+"..." );
            out.write("\r\n\t\t                                ");
}else{
            out.write("\r\n\t\t                                    ");
            out.print(from!=null&&!from.equals("")?from:"我" );
            out.write("\r\n\t\t                                ");
} 
            out.write("\r\n\t\t                                \r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
...
} else if(obj[0]!=null&&AffixManager.getInstance().getMailAffixFlag(obj[0].toString())){
            out.write("\r\n\t\t\t\t\t\t\t\t\t      <img src='/jsoa/images/fj2.gif' align='absmiddle'>\r\n\t\t\t\t\t\t\t\t\t   ");
 }
