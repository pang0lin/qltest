...
public final class oacollectEmplist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String collectId=null==request.getParameter("collectId")?(null==request.getAttribute("collectId")?"":request.getAttribute("collectId").toString()):request.getParameter("collectId");
...
String[] empNum = (String[])request.getAttribute("empNum");
            ...
            try {
              ...
              // /oacollect/oacollectEmplist.jsp(80,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/oaSysRemindAction");
              // /oacollect/oacollectEmplist.jsp(80,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("get");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n  <tr>\r\n\t\t<td width=\"40px\"  nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"sAll\" onclick=\"selectAll(this);\"></td>\r\n\t\t<td width=\"25%\" class=\"listTableHead\" id=\"tdWidth\">采集任务</td>\t\t\r\n\t\t<td width=\"15%\" class=\"listTableHead\" id=\"tdWidth\">采集用户</td>\t\t\r\n\t\t<td width=\"25%\" class=\"listTableHead\" id=\"tdWidth\">采集部门</td>\t\r\n\t\t<td width=\"15%\" class=\"listTableHead\" id=\"tdWidth\">采集状态</td>\t\r\n\t\t<td width=\"10%\" class=\"listTableHead\" id=\"tdWidth\">提醒次数</td>\t\t\r\n\t\t<td class=\"listTableHead\" id=\"tdWidth\">操作</td>\r\n  </tr>\r\n  ");
  ...
  for(int i=0;i<myList.size();i++){
 	...
 	if(index%2 != 0){
 	     ...
 	     listClass="listTableLine1";
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(empMap.get(obj[1].toString())==null?"&nbsp;":empMap.get(obj[1].toString()) );
                  out.write("</a></td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(null==obj[3]?"":("0".equals(obj[3].toString())?"未采集":("1".equals(obj[3].toString())?"已采集":obj[3].toString())));
                  out.write("</td>\t\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(null==obj[4]?"":obj[4].toString());
                  out.write("</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">\r\n\t\t<img alt=\"提醒\" style=\"cursor:hand\" border=\"0\" src=\"images/la_ba.gif\" onclick=\"doRemind('");
                  out.print(obj[0] );
                  out.write("')\"/>\r\n\t\t</td>\r\n  </tr>\r\n  ");
