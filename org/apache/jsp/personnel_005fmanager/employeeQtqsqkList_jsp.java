 ...
 * Generated at: 2023-01-06 09:52:53 UTC
...
public final class employeeQtqsqkList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
canAdd="0";
 ...
 if(canAdd.equals("1")){
      ...
      try {
        ...
        // /personnel_manager/employeeQtqsqkList.jsp(150,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("qtqsqkList");
        // /personnel_manager/employeeQtqsqkList.jsp(150,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("qtqsqkList");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object qtqsqkList = null;
          ...
          qtqsqkList = (java.lang.Object) _jspx_page_context.findAttribute("qtqsqkList");
          do {
            out.write("\r\n\t\t");

		  qtqsqkObj = (Object[]) qtqsqkList;
		  index ++;
...
if(index%2 != 0){listClass="listTableLine2";}
            ...
            out.print((""+qtqsqkObj[1]));
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print((""+qtqsqkObj[2]));
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\" style=\"word-break:break-all;\">");
            out.print(qtqsqkObj[3]);
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\" style=\"word-break:break-all;\">");
            out.print(qtqsqkObj[4]==null?"&nbsp;":qtqsqkObj[4]);
            out.write("&nbsp;</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(qtqsqkObj[5]);
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(qtqsqkObj[6]);
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(qtqsqkObj[7]);
            out.write("</td>\r\n\t\t   ");
 if("chinaLife".equalsIgnoreCase(SystemCommon.getCustomerName())){ 
            out.write("\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(qtqsqkObj[8]);
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(qtqsqkObj[9]);
            out.write("</td>\r\n\t\t  ");
} 
            out.write("\r\n\t\t  ");
 if(canAdd.equals("1")){
            out.write("\r\n\t\t  <td class=\"listTableLine3 listTableLineLastTD\" nowrap>\r\n\t\t  \t<img src=\"images/modi.gif\" alt=\"修改\" style=\"cursor:pointer\" onClick=\"modify('");
            out.print(qtqsqkObj[0]);
...
if(!deleteSuccess.booleanValue()){
      out.write("\r\n<script language=\"javascript\">\r\nalert(\"删除失败！您选择的其他亲属信息正在使用\");\r\n</script>\r\n");
}
      out.write("\r\n</html>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction search(){\r\n    form2.submit();\r\n}\r\nfunction delSingle(id){\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=\"/jsoa/EmployeeQtqsqkAction.do?action=delete&qtqsqkId=\" + id+\"&empID=");
      out.print(empID);
      out.write("&open=");
      out.print(open);
      out.write("\" ;\r\n    }\r\n}\r\nfunction modify(id){\r\n    MM_openBrWindow('/jsoa/EmployeeQtqsqkAction.do?action=modify&qtqsqkId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=600,height=350')\r\n}\r\n\tfunction view(id){\r\n    MM_openBrWindow('/jsoa/EmployeeQtqsqkAction.do?action=view&qtqsqkId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
