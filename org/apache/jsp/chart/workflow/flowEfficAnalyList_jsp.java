 ...
 * Generated at: 2023-01-06 09:49:21 UTC
...
public final class flowEfficAnalyList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int index=0;
if(request.getAttribute("pager.offset")!=null&&!"".equals(request.getAttribute("pager.offset"))
		&&!"null".equals(request.getAttribute("pager.offset"))){
    index=Integer.parseInt(request.getAttribute("pager.offset").toString());
}else if(request.getParameter("pager.offset")!=null&&!"".equals(request.getParameter("pager.offset"))
		&&!"null".equals(request.getParameter("pager.offset"))){
    index=Integer.parseInt(request.getParameter("pager.offset"));
}
int offset1=index;

            out.write("\r\n<body class=\"MainFrameBox\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\" id=\"searchbar\" style=\"display:none\">\r\n   <form name=\"frm\" action=\"/jsoa/chartWorkFlow.do?action=flowEfficAnalyListData\" method=\"post\">\r\n     <input type=\"hidden\" name=\"exportLog\" value=\"\">\r\n\t  <tr>\r\n\t\t  <td align=\"center\">流程名称：</td>\r\n\t\t  <td>\r\n\t\t\t<input type=\"text\" class=\"inputtext\" name=\"processName\" id=\"processName\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.processName}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            ...
            try {
              ...
              // /chart/workflow/flowEfficAnalyList.jsp(72,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/oaSysRemindAction");
              // /chart/workflow/flowEfficAnalyList.jsp(72,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("get");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n  <tr>\r\n\t\t<td width=\"40px\"  nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"sAll\" onclick=\"selectAll(this);\"></td>\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\">流程名称</td>\t\t\r\n\t\t<td width=\"33%\" class=\"listTableHead\" id=\"tdWidth\">流程耗时\r\n\t\t");
		  ...
		  if(orderBy == null || !orderBy.equals("sumxiao")){
                  out.write("\r\n\t\t<img src=\"images/blanksort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('sumxiao','desc');\" title=\"按流程耗时排序\">\r\n\t\t");
}else if(orderBy.equals("sumxiao") && sortType.equals("desc")){
                  out.write("\r\n\t\t<img src=\"images/downsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('sumxiao','asc');\" title=\"按流程耗时排序\">\r\n\t\t");
}else if(orderBy.equals("sumxiao") && sortType.equals("asc")){
                  out.write("\r\n\t\t<img src=\"images/upsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('sumxiao','desc');\" title=\"按流程耗时排序\">\r\n\t\t");
}
                  out.write("\r\n\t\t</td>\r\n\t\t<td width=\"30%\" class=\"listTableHead\" id=\"tdWidth\">有效时间/无效时间（比率）</td>\t\t\r\n\t\t<td width=\"15%\" class=\"listTableHead\" id=\"tdWidth\">有效时间/无效时间（小时）</td>\t\t\r\n  </tr>\r\n  ");
  ...
  for(int i=0;i<resultList.size();i++){
 	...
 	float  youxiao= Float.parseFloat(tempMap.get("youxiao").toString());
	float  wuxiao= Float.parseFloat(tempMap.get("wuxiao").toString());
	float  sumxiao = Float.parseFloat(tempMap.get("sumxiao").toString());
	DecimalFormat fnum = new DecimalFormat("##0.00");
	String tableWidthYouxiao ="0.00";
	String tableWidthWuxiao = "0.00";
	if(youxiao!=0||wuxiao!=0){
		tableWidthYouxiao = fnum.format(youxiao/(sumxiao)*100);
		tableWidthWuxiao = fnum.format(wuxiao/(sumxiao)*100);
	}
	 //循环，取出最大的（有效时间+无效时间）
	 float maxY=new Float("0.00");
	 for(int y=0;y<resultList.size();y++){
		 Map tempMapy=(Map)resultList.get(y);
		 float  maxTemp=Float.parseFloat(tempMapy.get("sumxiao").toString());
		 if(y==0){
			 maxY=maxTemp;
		 }else{
			 if(maxTemp>maxY){
	 ...
	 //流程之间的时间比
	 String processBilV="0.00";
	 if(maxY!=0){
		 processBilV=fnum.format((sumxiao)/maxY*100); 
	 }
	String porcessId=tempMap.get("porcessId").toString();
  
                  out.write("\r\n  <tr>\r\n        <td class=\"");
                  out.print(listClass);
                  out.write("\" ><input type=\"checkbox\"  name=\"batchId\" value=\"");
                  out.print(tempMap.get("porcessId"));
                  out.write("\"></td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\" ><a href=\"#\" onclick=\"leaderSee('");
                  out.print(tempMap.get("porcessId"));
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
                  out.print(tempMap.get("porcessName"));
                  out.write("')\">");
                  out.print(tempMap.get("porcessName"));
                  out.write("</a></td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  ...
                  out.write(' ');
                  out.write('>');
if(Double.valueOf(processBilV)!=0){
                  out.write("\r\n\t\t\t\t\t\t\t  <table>\r\n\t\t\t\t\t\t\t  <tr>\r\n\t\t\t\t\t\t\t  <td   width=\"");
                  out.print(processBilV);
                  out.write("%\" >\r\n\t\t\t\t\t\t\t  <div id=\"");
                  out.print("bars_"+porcessId+"porcess"+i);
                  out.write("\" name=\"bar_100\" \r\n\t\t\t\t\t\t\t  style=\"background-color:#54DB3C;border:1px solid black;height:15px;line-height:15px\">");
                  out.print(String.valueOf(tempMap.get("sumxiao").toString()));
                  out.write("</div>\r\n\t\t\t\t\t\t\t  </td>\r\n\t\t\t\t\t\t\t  <td></td>\r\n\t\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t\t  </table>\r\n\t\t\t\t\t\t\t  \r\n\t\t\t\t\t\t\t  ");
}else{
                  out.write("\r\n\t\t\t\t\t\t\t  ");
                  out.print(String.valueOf(tempMap.get("sumxiao").toString()));
...
if(Double.valueOf(tableWidthYouxiao)!=0&&Double.valueOf(tableWidthWuxiao)!=0) {
                  out.write("\r\n\t\t\t\t\t\t\t  <td  width=\"");
                  out.print(tableWidthYouxiao);
                  out.write("%\" ><div id=\"");
                  out.print("bars_"+porcessId+"youxiao"+i);
                  out.write("\" name=\"bar_100\" \r\n\t\t\t\t\t\t\t  style=\"background-color:#5FA9D6;border:1px solid black;height:15px;line-height:15px\">");
                  out.print(tableWidthYouxiao);
                  out.write("%</div>\r\n\t\t\t\t\t\t\t  </td>\r\n\t\t\t\t\t\t\t  <td  width=\"");
                  out.print(tableWidthWuxiao);
                  out.write("%\" ><div id=\"");
                  out.print("bars_"+porcessId+"wuxiao"+i);
                  out.write("\" name=\"bar_100\" \r\n\t\t\t\t\t\t\t  style=\"background-color:#AEDFB7;border:1px solid black;height:15px;line-height:15px\">");
                  out.print(tableWidthWuxiao);
                  out.write("%</div>\r\n\t\t\t\t\t\t\t  </td>\r\n\t\t\t\t\t\t\t  ");
}else{ 
                  out.write("\r\n\t\t\t\t\t\t\t  <td  width=\"50%\" >");
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(String.valueOf(tempMap.get("youxiao").toString()));
                  out.write('/');
                  out.print(String.valueOf(tempMap.get("wuxiao")));
                  out.write("</td>\r\n  </tr>\r\n  ");
