...
public final class EmpCizhiStatistics_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if("00".equals(month)){
            ...
            out.write("\r\n\t\t</td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td align=\"right\">\r\n\t\t\t<button  class=\"btnButton2Font\" onclick=\"JSMainWinOpen('/jsoa/EmpStatisticsAction.do?action=listEmpCizhiExport&yearMonth=");
            out.print(yearMonth);
            out.write("')\">导出</button>\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<br />\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\"  border=\"1\" align=\"center\" cellpadding=\"1\" cellspacing=\"0\" bordercolorlight=\"#000000\" bordercolordark=\"#FFFFFF\">\r\n\t<tr align=\"center\">\r\n\t\t<th width=\"2%\" nowrap=\"nowrap\">序号</th>\r\n\t\t<th width=\"8%\" nowrap=\"nowrap\">姓名</th>\r\n\t\t<th width=\"15%\" nowrap=\"nowrap\">部门</th>\r\n\t\t<th width=\"10%\" nowrap=\"nowrap\">岗位</th>\r\n\t\t<th width=\"10%\" nowrap=\"nowrap\">到职日期</th>\r\n\t\t<th width=\"10%\" nowrap=\"nowrap\">离职日期</th>\r\n\t\t<th width=\"10%\" nowrap=\"nowrap\">离职类型</th>\r\n\t\t<th width=\"10%\" nowrap=\"nowrap\">离职原因</th>\r\n\t\t<th width=\"10%\" nowrap=\"nowrap\">人员性质</th>\r\n\t  </tr>\r\n\t  ");
	  	...
	  	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            ...
            try {
              ...
              // /personnel_manager/EmpCizhiStatistics.jsp(102,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /personnel_manager/EmpCizhiStatistics.jsp(102,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /personnel_manager/EmpCizhiStatistics.jsp(102,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		countRecordCount ++;
                  ...
                  out.write("&nbsp;</td>\r\n\t\t<td>");
                  out.print(obj[3]!=null?obj[3].toString().substring(0,10):"");
                  out.write("&nbsp;</td>\r\n\t\t<td>");
                  out.print(obj[4]!=null?obj[4].toString().substring(0,10):"");
                  out.write("&nbsp;</td>\r\n\t\t<td>");
