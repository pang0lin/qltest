...
public final class item_005fsubmit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//根据组织取所有用户
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String mainNextActivityId = request.getParameter("mainNextActivityId");//下一节点ID
	String mainNextActivityName = request.getParameter("mainNextActivityName");//下一节点名称
	...
	String subProcWorkId = request.getParameter("subProcWorkId") == null ? "0"
							: request.getParameter("subProcWorkId"); //子过程的workID
	//修改批示意见对应ID
	...
	if (dealTips != null && !dealTips.equals("")) {
		...
		dealTips = "来自上一环节:" + mainNextActivityName + ";  办理人："
				+ userName + "; " + df.format(new Date()) + " " + dealTips;
	}
	...
	//workFlowBD.operateWork(para, mainTransactUser, mainNeedPassRound, mainPassRoundUser);
	...
	if (result.intValue() < 0) {
		...
		if ("3".equals(activityClass)) {
			...
			workLogVO.setSendUserId(userId);
			workLogVO.setSendUserName(userName);
			workLogVO.setSendAction("送" + com.js.oa.weixin.common.util.WorkflowForWeiXinUtil.decordStr(mainNextActivityName));
			//workLogVO.setReceiveUserId(mainTransactUser+"");
		...
		if (request.getParameter("mainNeedPassRound") != null
				&& !"".equals(request.getParameter("passRoundName"))) {
			//记录阅件发送用户
			workLogVO = new WorkLogVO();
			workLogVO.setSendUserId(userId);
			workLogVO.setSendUserName(userName);
			workLogVO.setSendAction("送" + com.js.oa.weixin.common.util.WorkflowForWeiXinUtil.decordStr(mainNextActivityName) + "阅件");
			//workLogVO.setReceiveUserId(mainTransactUser+"");
			workLogVO.setReceiveUserName(request.getParameter("passRoundName"));
