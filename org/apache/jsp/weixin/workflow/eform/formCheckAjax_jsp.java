...
public final class formCheckAjax_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try{
	...
	String mSql="select page_id from tpage where page_name='"+pageName+"'";	
	conn=new com.js.util.util.DataSourceBase().getDataSource().getConnection();
	java.sql.Statement stmt=conn.createStatement();
	ResultSet result=stmt.executeQuery(mSql);
	if(result.next()){
