 ...
 * Generated at: 2023-01-06 10:02:52 UTC
...
if(com.js.util.util.BrowserJudge.isMSIE(request)){ 
      ...
      out.write("\r\n\t\t\t\t\t\t  ");
							...
							if(mbd.hasRight(userId, "09*01*01")) {
      ...
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/oaCollectAction.do?action=taskList')\"><img id=\"menuImg_");
      out.print(menuIndex );
      out.write("\" src=\"/jsoa/imges/shanj.gif\" />&nbsp;任务发布</div></td>\r\n\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t  ");
} 
      out.write("\r\n\t\t\t\t\t\t  <tr id=\"mainTR_");
      out.print(++menuIndex);
      out.write("\">   \r\n\t\t\t\t\t\t    <td><div id=\"topDIV");
      ...
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/oaCollectAction.do?action=collectList')\"><img id=\"menuImg_");
      out.print(menuIndex );
      out.write("\"  src=\"/jsoa/imges/shanj.gif\" />&nbsp;数据填报</div></td>\r\n\t\t\t\t\t\t  </tr>   \r\n\t\t\t\t\t\t  ");
      ...
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/oaCollectAction.do?action=taskListMonitor')\"><img id=\"menuImg_");
      out.print(menuIndex );
      out.write("\" src=\"/jsoa/imges/shanj.gif\" />&nbsp;在办监控</div></td>\r\n\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t  <tr id=\"mainTR_");
      out.print(++menuIndex);
      out.write("\">\r\n\t\t\t\t\t\t    <td><div id=\"topDIV");
      out.print(menuIndex );
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/oaCollectAction.do?action=taskListMonitorDone')\"><img id=\"menuImg_");
      out.print(menuIndex );
      out.write("\" src=\"/jsoa/imges/shanj.gif\" />&nbsp;办结查阅</div></td>\r\n\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t  ");
} 
      out.write("\r\n\t\t\t\t\t\t  <tr id=\"mainTR_");
      out.print(++menuIndex);
      out.write("\">   \r\n\t\t\t\t\t\t    <td><div id=\"topDIV");
      ...
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/oacollect/oacollectfileframe.jsp')\"><img id=\"menuImg_");
      out.print(menuIndex );
      out.write("\"  src=\"/jsoa/imges/shanj.gif\" />&nbsp;文件采集</div></td>\r\n\t\t\t\t\t\t  </tr> \r\n\t\t\t\t\t\t</table>\r\n\t\t\t\t   </div>\r\n\t\t\t\t</td>\r\n  \t\t\t</tr>\r\n\t\t</table>\r\n</BODY>\r\n</HTML>\r\n<script src=\"/jsoa/js/imenu.js\"></script>");
