...
public class TaskAccessoryPO implements Serializable {
  ...
  public TaskAccessoryPO(Long accessoryid, String accessoryname, String accessorysavename, TaskPO task, Long domain_id) {
