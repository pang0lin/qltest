 ...
 * Generated at: 2023-01-06 10:00:53 UTC
...
public final class auditLogYiShenHeList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Map map=(Map)request.getAttribute("proLeaders");
Map classNameMap=(Map)request.getAttribute("proClassName");
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
	        ...
	        java.util.regex.Pattern p1 = java.util.regex.Pattern.compile("(\\d+)/(\\d+)/(\\d+)");
	            	java.util.regex.Matcher m2 = p1.matcher(end_date);
	            	m2.find();
	            	e_year= m2.group(1);
	            	e_month = m2.group(2);
	            	e_day = m2.group(3);
            ...
            out.write("\r\n\t\t<tr>\r\n\t\t\t<td width=\"8%\"  height=\"28\" nowrap>提交人姓名：</td>\r\n\t\t\t<td width=\"20%\"><input type=\"text\" class=\"inputText\" name=\"submitEmpname\" value=\"");
            out.print(submitEmpname);
            out.write("\"/></td>\r\n\t\t\t<td width=\"8%\"  nowrap align=right>提交人部门：</td>\r\n\t\t\t<td width=\"20%\"><input type=\"text\" class=\"inputText\" name=\"submitOrgName\" value=\"");
            out.print(submitOrgName);
            out.write("\"/></td>\t\r\n\t\t\t<td width=\"8%\"  height=\"28\" nowrap>所属模块：</td>\r\n\t\t\t<td width=\"20%\"><input type=\"text\" class=\"inputText\" name=\"auditModule\" value=\"");
            out.print(auditModule);
            out.write("\"/></td>\r\n\t\t\t<td width=\"3%\" rowspan=\"2\"></td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t\t<td width=\"8%\"  height=\"28\" nowrap>审核人：</td>\r\n\t\t\t<td width=\"20%\"><input type=\"text\" class=\"inputText\" name=\"checkEmpname\" value=\"");
            out.print(checkEmpname);
            ...
            out.write(',');
            out.print(e_day);
            out.write(");\t\t\t  \r\n\t\t\t  </script><input type=\"checkbox\" name=\"searchDate\" value=\"1\" ");
if("1".equals(searchDate)){out.print("checked");}
            out.write(">\r\n\t\t\t</td>\r\n\t\t\t<td align=\"right\">\r\n\t\t\t\t<input type=\"button\" class=\"btnButton4Font\" onClick=\"search();\" style=\"cursor:pointer\" value=\"查询\"/>\r\n\t\t\t\t<input type=\"button\" class=\"btnButton2Font\" onClick=\"clearr();\" style=\"cursor:pointer\" value=\"重置\"/>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\t           \r\n</table>\r\n</form> \r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"inlineBottomLine\">\r\n  \r\n  <tr> \r\n     <td align=\"right\" nowrap>\r\n\t\t<input type=\"button\" id=\"hiddenSearch\"  class=\"btnButton4Font\" onClick=\"hidserch()\" value=\"查询\"/>\r\n\t </td>\r\n  \r\n  </tr>\r\n  \r\n</table>\r\n\r\n<div id=\"docinfo0\" name=\"docinfo0\">\r\n\r\n   <table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n         <tr >\r\n           <td class=\"listTableHead\" width=\"20%\" >提交人姓名</td>\r\n           <td class=\"listTableHead\" width=\"20%\" nowrap>提交人部门</td>\r\n           <td class=\"listTableHead\" width=\"10%\" nowrap>所属模块</td>\r\n           <td width=\"15%\" class=\"listTableHead\" nowrap>提交时间</td>\r\n           <td class=\"listTableHead\" width=\"10%\" nowrap>审核人</td>\r\n");
            out.write("           <td class=\"listTableHead\" width=\"15%\" nowrap>审核时间</td>\r\n           <td class=\"listTableHead\" width=\"10%\" nowrap>状态</td>\r\n         </tr>   \r\n         \r\n         ");
        ...
        String startTime,endTime,rate;
            ...
            try {
              ...
              // /audit/auditLogYiShenHeList.jsp(150,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("mylist");
              // /audit/auditLogYiShenHeList.jsp(150,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
			...
			String time=dateFormat.format(obj[3]);
			String onclick = "";
			String num = request.getParameter("pager.offset")==null?"0":request.getParameter("pager.offset");
			if("1".equals(obj[7].toString())||"3".equals(obj[7].toString())||"6".equals(obj[7].toString())
			         ||"9".equals(obj[7].toString())){
			     
			     onclick = "JSMainWinOpen('"+obj[8]+obj[0]+"&disabled=disabled&flag=detail&pager.offset="+num+"','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=580')";
			     //onclick = "switchLog('"+obj[8]+obj[0]+"&disabled=disabled&flag=detail&pager.offset="+num+"');";
			}
			if("2".equals(obj[7].toString())){
			     onclick = "approveAuditOrgGroup('"+obj[8]+obj[0]+"&disabled=disabled&flag=detail&pager.offset="+num+"');";
			}
			if("4".equals(obj[7].toString())){//IP审计
			     onclick = "approveAuditIp('"+obj[8]+obj[0]+"&disabled=disabled&flag=detail&pager.offset="+num+"');";
			}
			if("5".equals(obj[7].toString())){//门户审计
			     onclick = "approveAuditPortal('"+obj[8]+obj[0]+"&disabled=disabled&flag=detail&pager.offset="+num+"');";
			}
			if("7".equals(obj[7].toString())){//菜单审计
			     onclick = "approveAudit('"+obj[8]+obj[0]+"&disabled=disabled&flag=detail&pager.offset="+num+"');";
			}
			if("8".equals(obj[7].toString())){//扩展菜单审计
			     onclick = "approveAuditModuleMenu('"+obj[8]+obj[0]+"&disabled=disabled&flag=detail&pager.offset="+num+"');";
			}
                  ...
                  out.print(listClass);
                  out.write("\" nowrap>");
                  out.print(dateFormat.format(obj[10]) );
                  out.write("</td>\r\n               <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(obj[9].toString().equals("0")?"未通过":"通过" );
                  out.write("</td>\r\n           </tr>\r\n       ");
...
String pagerURL = "/jsoa/AuditLogAction.do";
            out.write("\r\n\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\r\n<script>\r\n<!--\r\nfunction changeURL(url){\r\n  location.href=url;\r\n}\r\n\r\nfunction openDetail(id){\r\n   location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/RelProjectAction.do?flag=detail&id=\"+id;\r\n}\r\nfunction selectAll(obj){\r\n    var result=obj.checked;\r\n    if(document.getElementsByName(\"batchId\").length>0){\r\n        \r\n            for(var i=0;i<document.getElementsByName(\"batchId\").length;i++){\r\n                if(!document.getElementsByName(\"batchId\")[i].disabled){\r\n             document.getElementsByName(\"batchId\")[i].checked=result;\r\n            }\r\n               \r\n       \r\n    }\r\n}\r\n}\r\nfunction setEnter(){\r\n\t if(document.getElementById(\"searchBar\").style.display==\"\"){\r\n\t\t search();\r\n\t }\r\n\t}\r\nfunction search() {\r\n\tvar start_date=document.getElementsByName(\"start_date\")[0].value;\r\n\tvar end_date=document.getElementsByName(\"end_date\")[0].value;\r\n\tdocument.form1.action+=\"&start_date=\"+start_date+\"&end_date=\"+end_date;\r\n    form1.submit();\r\n}\r\nfunction clearr(){\r\n    window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/AuditLogAction.do?action=yiShenHeList\";\r\n");
      out.write("}\r\nfunction hidserch()\r\n{    \r\n     var stable=document.getElementById(\"searchBar\");\r\n     var sbutton=document.getElementById(\"hiddenSearch\");\r\n     if(stable.style.display==\"none\")\r\n     {\r\n      stable.style.display=\"\";\r\n      sbutton.innerHTML=\"关闭查询\";\r\n      \r\n     }else{\r\n     stable.style.display=\"none\";\r\n     sbutton.innerHTML=\"查询\";\r\n     \r\n     }\r\n}\r\n//开关审计\r\nfunction switchLog(url){\r\n\tJSMainWinOpen(url,\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600\");\r\n}\r\n//审核AuditOrgGroup群组\r\nfunction approveAuditOrgGroup(url){\r\n\tJSMainWinOpen(url,\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600\");\r\n}\r\n//审核Auditip， ip审计明细\r\nfunction approveAuditIp(url){\r\n\tJSMainWinOpen(url,\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600\");\r\n}\r\n//审核门户\r\nfunction approveAuditPortal(url){\r\n\tJSMainWinOpen(url,\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600\");\r\n}\r\n//通用\r\nfunction approveAudit(url){\r\n\tJSMainWinOpen(url,\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600\");\r\n");
      out.write("}\r\n//扩展菜单门户\r\nfunction approveAuditModuleMenu(url){\r\n\t ");
if(!BrowserJudge.isMSIE(request)){ 
      out.write("\r\n\t\talert('扩展菜单功能暂时无法在");
      out.print(BrowserJudge.Browser(session) );
      out.write("上使用，请换用IE浏览器！');\r\n\t\treturn;\r\n\t");
} 
