 ...
 * Generated at: 2023-01-06 09:48:02 UTC
...
//System.out.println("----voitureMtRight--->>>>"+voitureMtRight);
...
if(voitureAddRight.equals("true")) {
            out.write("\r\n\t  <div id=\"PanleDIV\"  class=\"tabPanelSelected\" onClick=\"changePanle(this,'/jsoa/VoitureTypeAction.do?flag=view');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">车辆类别设置</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n      ");
} 
            out.write("      \r\n     \r\n      \r\n      ");
if(voitureAddRight.equals("true")) {
            out.write("\r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/WFProcessAction.do?moduleId=11');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">流程设置</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n      ");
} 
            out.write("\r\n\t</td>\r\n\t\t  <td align=\"right\">");
if(voitureAddRight.equals("true")){
            out.write("<button  class=\"btnButton2Font\"  onclick=\"MM_openBrWindow('VoitureTypeAction.do?flag=add','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=600,height=300')\"> 新增</button>");
}
            out.write("\r\n\t\t");
if(voitureMtRight.equals("true")){
            out.write("<button  class=\"btnButton2Font\"  onclick=\"delBatchAll()\">删除</button></td>");
}
            out.write("\r\n  </tr>\r\n</table>\r\n</td>\r\n</tr>\r\n\r\n\r\n\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n\t<form  name=\"VoitureActionForm\" method=\"post\" action=\"/jsoa/VoitureAction.do\">\r\n\t\t<tr align=\"center\">\r\n\t\t\t<td width=\"40\" height=\"27\" class=\"listTableHead\" nowrap>\r\n\t\t\t\t<input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n\t\t\t<td  class=\"listTableHead\"> 车辆类别名称 </td>\r\n\t\t\t<td width=\"8%\" class=\"listTableHeadLast\" nowrap=\"nowrap\"> 处理 </td>\r\n\t\t</tr>\r\n\t");
		...
		pageSize2=Integer.parseInt(request.getParameter("pager.offset"));
            ...
            try {
              ...
              // /routine/voiture_manager/typeList.jsp(100,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /routine/voiture_manager/typeList.jsp(100,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
String pagerURL = "/jsoa/VoitureTypeAction.do";
            out.write("\r\n\t  ");
