...
public final class selectWorkFlow_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String boardroomId = request.getParameter("boardroomId")==null? "":request.getParameter("boardroomId");
	String boardroomName = request.getParameter("boardroomName")==null? "":request.getParameter("boardroomName");
	
	String applyDate = request.getParameter("applyDate")!=null?request.getParameter("applyDate"):"";
          ...
          do {
            ...
            out.write(".css\" REL=\"stylesheet\" TYPE=\"text/css\" />\r\n<script SRC=\"js/js.js\" LANGUAGE=\"javascript\"></script>\r\n\r\n<title>选择会议申请流程</title>\r\n\r\n\r\n<body class=\"FlowBody\">\r\n<br/>\r\n<table WIDTH=\"100%\" BORDER=\"0\" CELLPADDING=\"0\" CELLSPACING=\"1\">\r\n  <tr>\r\n    <td VALIGN=\"top\" class=main>\r\n      <table WIDTH=\"99%\" BORDER=\"0\" ALIGN=\"center\" CELLPADDING=\"1\" CELLSPACING=\"0\">\r\n        <tr>\r\n          <td HEIGHT=\"350\" VALIGN=\"top\">\t\t\t  \r\n              <table WIDTH=\"95%\" BORDER=\"0\" ALIGN=\"center\" CELLPADDING=\"0\" CELLSPACING=\"1\">\r\n                 <tr>\r\n                    <td HEIGHT=\"24\" COLSPAN=\"2\" style=\"font-size:13px;\"><b>会议申请流程</b></td>\r\n                 </tr>\r\n\t\t\t\t\t ");
					   ...
					   for(int	j =	0; j < boradRoomApplyFlowlist.size(); j++){
						  ...
						  linkValue="processType="+processType+"&remindField="+remindField+"&processId="+processId+"&tableId="+tableId+"&processName="+processName;
      ...
      out.write("\r\n <script language=\"javascript\">\r\n function MM_openBrWindow(theURL,winName,features) { //v2.0\r\n  JSMainWinOpen(theURL,winName,features);\r\n}\r\n function newForm(selProcess){\r\n\t ");
		...
		if(boardroomId!=null && !"".equals(boardroomId)){
	 
      out.write("\r\n\t location.href=\"/jsoa/BoardRoomAction.do?action=addBoardroomApplyView&boardroomId=");
      out.print(boardroomId);
      out.write("&boardroomName=");
      out.print(boardroomName);
      out.write("&\"+selProcess+\"&moduleId=15&applyDate=");
      out.print(applyDate);
      out.write("&relProjectId=");
      out.print(relProjectId);
      out.write("\";\r\n\t ");
} else {
      out.write("\r\n\t location.href=\"/jsoa/BoardRoomAction.do?action=addBoardroomApplyView&\"+selProcess+\"&moduleId=15&applyDate=");
      out.print(applyDate);
      out.write("&relProjectId=");
      out.print(relProjectId);
      out.write("\";\r\n\t ");
