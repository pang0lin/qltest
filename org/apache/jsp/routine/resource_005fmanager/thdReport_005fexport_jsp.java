 ...
 * Generated at: 2023-01-06 09:46:59 UTC
...
public final class thdReport_005fexport_jsp extends org.apache.jasper.runtime.HttpJspBase
...
showTitle = searchType.equals("4")?"物品流向统计表":showTitle;
 ...
 slFormat.applyPattern("0.00");
  String goodsType = request.getAttribute("goodsType")==null?"":request.getAttribute("goodsType").toString();
      ...
      out.write("\r\n<table width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"3\" cellspacing=\"0\">\r\n  <tr>\r\n    <td height=\"30\" colspan=\"9\" align=\"center\" class=\"head\">");
      out.print(searchStock.substring(searchStock.indexOf(",") +1));
      out.write("物品退货表</td>\r\n  </tr>\r\n  <tr>\r\n    <td align=\"center\" colspan=\"9\"><div align=\"center\">");
      out.print(goodsType);
      out.write("&nbsp;&nbsp;&nbsp;&nbsp;日期：");
	 ...
	 double je = 0 ;
      ...
      try {
        ...
        // /routine/resource_manager/thdReport_export.jsp(78,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("intoStockList");
        // /routine/resource_manager/thdReport_export.jsp(78,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
	 ...
	 je = ArithUtil.add(je , Double.parseDouble(reportObj[6].toString()));
            ...
            out.write("</td>\r\n      <td><div align=\"right\">");
            out.print(Math.abs(new Double(slFormat.format(Float.parseFloat(reportObj[4].toString()))).doubleValue()));
            out.write("</div></td>\r\n     <td><div align=\"right\">");
            out.print(decimalFormat.format(Float.parseFloat(reportObj[5].toString())));
            out.write("</div></td>\r\n      <td><div align=\"right\">");
            out.print(Math.abs(new Double(decimalFormat.format(Float.parseFloat(reportObj[6].toString()))).doubleValue()));
            out.write("</div></td>\r\n      </tr>\r\n\t");
      ...
      out.write("\r\n\t <tr>\r\n      <td>合计</td>\r\n\t   <td>&nbsp;</td>\r\n      <td>&nbsp;</td>\r\n\t  <td>&nbsp;</td>\r\n      <td>&nbsp;</td>\r\n      <td>&nbsp;</td>\r\n      <td><div align=\"right\">");
      out.print(Math.abs(new Double(slFormat.format(sl)).doubleValue()));
      out.write("</div></td>\r\n      <td>&nbsp;</td>\r\n      <td><div align=\"right\">");
      out.print(Math.abs(new Double(decimalFormat.format(je)).doubleValue()));
      out.write("</div></td>\r\n    </tr>\r\n</table>\r\n<table width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"3\" cellspacing=\"0\">\r\n <tr>\r\n  <td colspan=\"8\">\r\n    制表人：");
