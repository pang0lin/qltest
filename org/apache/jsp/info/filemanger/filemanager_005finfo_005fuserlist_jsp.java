 ...
 * Generated at: 2023-01-06 09:56:10 UTC
...
public final class filemanager_005finfo_005fuserlist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String processId = resource.getString("processId");
String tableId = resource.getString("tableId");

            out.write("\r\n</head>\r\n<body  class=\"MainFrameBox\">\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"10px\" class=\"searchbar\" style=\"display:none\" id=\"searchtable\" name=\"searchtable\">\r\n  <form name=\"searchform\" action=\"/jsoa/InfoProFileAction.do?action=list\" method=\"post\">\r\n    <tr>\r\n\t  <td width=\"10%\">文件编号：&nbsp;&nbsp;</td>\r\n\t  <td ><input type=\"text\" name=\"fileNum\" class=\"inputtext\"  value=\"\"></td>\r\n\t  <td>文件名称：</td>\r\n      <td><input type=\"text\" name=\"fileSaveName\" class=\"inputtext\" value=\"\"></td>\r\n\t  <td  align=\"right\">\r\n\t\t\t<input type=\"button\" class=\"btnButton2font\" onClick=\"searchBtn();\" value='");
  ...
  String department="";
            ...
            try {
              ...
              // /info/filemanger/filemanager_info_userlist.jsp(204,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("userFileList");
              // /info/filemanger/filemanager_info_userlist.jsp(204,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("userFileList");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object userFileList = null;
                ...
                userFileList = (java.lang.Object) _jspx_page_context.findAttribute("userFileList");
                do {
                  out.write("\r\n  \t");

                 Object[] obj = (Object[]) userFileList;
                 index ++;
				 if(index%2 != 0){
				 ...
				 if(obj[7]!=null){
					 department = obj[7].toString().split(";")[0];
				 }
				 if(obj[8]!=null){
                  ...
                  out.write("<td class=\"");
                  out.print(listClass);
                  out.write("\" ><a title=\"\" href=\"#\" onclick=\"JSMainWinOpen('/jsoa/download.jsp?");
                  out.print(com.js.util.util.BASE64.BASE64EncoderNoBR("FileName="+obj[13]+"&name="+obj[15]+"&moduleCode=oa_netdisk_project&path=proFile"));
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj[5]==null?"&nbsp;":sdf.format(obj[5]));
                  out.write("&nbsp;</td>\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  ...
                  out.write("&nbsp;</td>\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write("\" >\r\n\t\t  \r\n\t\t  <img alt=\"修订\"  border=\"0\"  src=\"images/rwhb.gif\" style=\"cursor:pointer\" onclick=\"newForm('");
                  out.print(processId);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
                  out.print(tableId);
                  out.write("','程序文件修订','1','null','0','null','");
                  out.print(obj[0]);
                  out.write("')\" >\r\n\t\t ");

		 	if(b){
		 		
                  out.write("\t\r\n\t\t  <img alt=\"修改\"  border=\"0\"  src=\"images/modi.gif\" style=\"cursor:pointer\" onclick=\"MM_openBrWindow('/jsoa/InfoProFileAction.do?action=modify&fileId=");
                  out.print(obj[0]);
                  out.write("','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600');\" >\r\n\t\t  <img alt=\"删除\"  border=\"0\"  src=\"images/del.gif\" style=\"cursor:pointer\" onclick=\"deleteOne('");
                  out.print(obj[0]);
                  out.write("')\" >\r\n\t\t \t\t ");
...
String pagerURL = "/jsoa/InfoProFileAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/filemanger/filemanager_info_userlist.jsp(48,77) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("common");
      // /info/filemanger/filemanager_info_userlist.jsp(48,77) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/filemanger/filemanager_info_userlist.jsp(49,82) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("common");
      // /info/filemanger/filemanager_info_userlist.jsp(49,82) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
