...
public final class EmpAttendanceList_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write(".css\" rel=\"stylesheet\" type=\"text/css\" />\r\n<script\tsrc=\"js/js.js\" language=\"javascript\"></script>\r\n<!--  STYLE\tCHANGE START -->\r\n\r\n<script language=\"JavaScript\" type=\"text/JavaScript\">\r\n<!--\r\nfunction MM_openBrWindow(theURL,winName,features) { //v2.0\r\n  JSMainWinOpen(theURL,winName,features);\r\n}\r\ndocument.onkeydown=look;\r\nfunction look(){\r\n\tif(event.keyCode==13){\r\n\t\tsearch();\r\n\t}\r\n}\r\n//-->\r\n</script>\r\n<script language=\"JavaScript\" src=\"js/date0.js\"></script>\r\n</head>\r\n\r\n<body  class=\"MainFrameBox\">\r\n\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n\r\n<!-- SEARCH\tPART -->\r\n<table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n\t<form action=\"/jsoa/EmpAttendanceAction.do?action=list\" name=\"form1\" method=\"post\" onsubmit=\"return false;\">\r\n\t\t<tr>\r\n\t\t\t<td width=\"40%\" nowrap=\"nowrap\">\r\n\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;年月：&nbsp;&nbsp;&nbsp;&nbsp;\r\n\t\t\t\t<input type=\"text\" name=\"yearMonth\" value=\"");
            out.print(request.getAttribute("yearMonth")!=null?request.getAttribute("yearMonth"):"");
            out.write("\" size=\"20\" maxlength=\"6\" class=\"inputtext\"/>\r\n\t\t\t</td>\r\n\t\t\t<td nowrap=\"nowrap\">\r\n\t\t\t\t姓名：\r\n\t\t\t\t<input type=\"text\" name=\"empName\" value=\"");
            out.print(request.getAttribute("empName")!=null?request.getAttribute("empName"):"");
            out.write("\" size=\"20\" maxlength=\"20\" class=\"inputtext\"/>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\r\n\t\t<tr>\r\n\t\t\t<td nowrap=\"nowrap\">\r\n\t\t\t</td>\r\n\t\t\t<td align=\"right\">\r\n\t\t\t<button class=\"btnButton2Font\" onclick=\"search();\" style=\"cursor:pointer\">查询</button>\r\n\t\t\t<button class=\"btnButton2Font\" onclick=\"clearr();\" style=\"cursor:pointer\">重置</button>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\t</form>\r\n</table>\r\n<!-- SEARCH\tPART -->\r\n\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<table width=\"100%\"\theight=\"25\"\tborder=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"inlineBottomLine\">\r\n\t<tr height=\"22\">\r\n        <td align=\"right\">\r\n\t\t\t<button class=\"btnButton2Font\" onclick=\"add();\" style=\"cursor:pointer\">新增</button>\r\n\t\t\t<button class=\"btnButton2Font\" onclick=\"batchDel();\" style=\"cursor:pointer\">删除</button>\r\n\t\t\t<button class=\"btnButton2Font\" onclick=\"exportExcel();\" style=\"cursor:pointer\">导出</button>\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n\t<tr align=\"center\">\r\n\t\t<td width=\"2%\" class=\"listTableHead\" nowrap=\"nowrap\" rowspan=\"2\"><input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n");
            out.write("\t\t<td width=\"8%\" class=\"listTableHead\" nowrap=\"nowrap\" rowspan=\"2\">年月</td>\r\n\t\t<td width=\"8%\" class=\"listTableHead\" rowspan=\"2\">姓名</td>\r\n\t\t<td width=\"10%\" class=\"listTableHead\" nowrap=\"nowrap\" colspan=\"2\">合计</td>\r\n\t\t<td width=\"15%\" class=\"listTableHead\" nowrap=\"nowrap\" colspan=\"3\">累计加班工时</td>\r\n\t\t<td width=\"25%\" class=\"listTableHead\" nowrap=\"nowrap\" colspan=\"5\">扣除工时</td>\r\n\t\t<td width=\"20%\" class=\"listTableHead\" nowrap=\"nowrap\" rowspan=\"2\">备注</td>\r\n\t\t<td width=\"8%\" class=\"listTableHead\" nowrap rowspan=\"2\">处理</td>\r\n\t  </tr>\r\n\t  <tr align=\"center\">\r\n\t\t<td width=\"5%\" class=\"listTableHead\" nowrap=\"nowrap\">应出工时</td>\r\n\t\t<td width=\"10%\" class=\"listTableHead\">实际出勤/加班</td>\r\n\t\t<td width=\"5%\" class=\"listTableHead\" nowrap=\"nowrap\">延时</td>\r\n\t\t<td width=\"5%\" class=\"listTableHead\" nowrap=\"nowrap\">双休</td>\r\n\t\t<td width=\"5%\" class=\"listTableHead\" nowrap=\"nowrap\">法定</td>\r\n\t\t<td width=\"5%\" class=\"listTableHead\" nowrap=\"nowrap\">请假</td>\r\n\t\t<td width=\"5%\" class=\"listTableHead\" nowrap=\"nowrap\">休工</td>\r\n\t\t<td width=\"5%\" class=\"listTableHead\" nowrap=\"nowrap\">调休</td>\r\n");
            out.write("\t\t<td width=\"5%\" class=\"listTableHead\" nowrap>未打卡</td>\r\n\t\t<td width=\"5%\" class=\"listTableHeadLast\" nowrap>迟到</td>\r\n\t  </tr>\r\n\r\n\t\t");
		...
		String listClass="listTableLine1";
            ...
            try {
              ...
              // /personnel_manager/EmpAttendanceList.jsp(123,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /personnel_manager/EmpAttendanceList.jsp(123,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /personnel_manager/EmpAttendanceList.jsp(123,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		listClass = index%2!=0?"listTableLine2":"listTableLine1";
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj[12]!=null?obj[12].toString():"");
                  out.write("&nbsp;</td>\r\n\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\" style=\"word-break:break-all\">\r\n\t\t\t");
                  out.print(obj[13]!=null?obj[13].toString():"");
                  out.write("\r\n\t\t\t&nbsp;\r\n\t\t</td>\r\n\t\t<td nowrap=\"nowrap\" class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\" nowrap>\r\n\t\t\t<img style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" alt=\"修改\" onclick=\"MM_openBrWindow('/jsoa/EmpAttendanceAction.do?action=load&id=");
                  out.print(obj[0]);
...
String pagerURL = "/jsoa/EmpAttendanceAction.do";
            out.write("\r\n      ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\nfunction add(){\r\n\tMM_openBrWindow('/jsoa/EmpAttendanceAction.do?action=new','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600');\r\n}\r\n\r\nfunction del(id) {\r\n     ");

     int deloffset =  countRecordCount == 1 ? offset1-15:offset1 ;
     deloffset = deloffset < 0 ? 0 : deloffset ;
     
      out.write("\r\n     if(confirm(\"确实要删除吗？\")){\r\n         window.location.href=\"/jsoa/EmpAttendanceAction.do?action=delete&id=\"+id+\"&pager.offset=");
      out.print(deloffset);
      out.write("\";\r\n    }\r\n }\r\n\r\nfunction search(){\r\n\tif(legalCharacters(document.all.yearMonth)){\r\n\t\talert(\"年月不能包含有特殊字符！\"+\"\\\\\\\"'`<>^/\");\r\n\t\tdocument.form1.yearMonth.focus();\r\n\t\treturn;\r\n    }\r\n\tif(legalCharacters(document.all.empName)){\r\n\t\talert(\"姓名不能包含有特殊字符！\"+\"\\\\\\\"'`<>^/\");\r\n\t\tdocument.form1.empName.focus();\r\n\t\treturn;\r\n    }\r\n\tdocument.form1.submit();\r\n}\r\n\r\nfunction clearr(){\r\n\tlocation.href=\"/jsoa/EmpAttendanceAction.do?action=list\";\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\nfunction batchDel(){\r\n\tif(getCheckBoxID() != ''){\r\n\t\tvar ids = getCheckBoxID();\r\n\t\tids = ids.substring(0, ids.length-1);\r\n\t\tif(confirm(\"确实要删除吗？\")){\r\n\t\t\twindow.location.href=\"/jsoa/EmpAttendanceAction.do?action=batchDel&ids=\"+ids+\"&pager.offset=");
      out.print(deloffset);
      ...
      out.write("\tform1.action = \"/jsoa/EmpAttendanceAction.do?action=export\";\r\n\tform1.submit();\r\n\tform1.action = \"/jsoa/EmpAttendanceAction.do?action=list\";\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
