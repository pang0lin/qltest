...
public final class DocumentEditExcel_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  System.out.println("ddddddddddddddd22");
...
if(request.getParameter("sendfileNUM") != null){
      out.write("\r\n      webform.WebOffice.WebSetBookMarks(\"发文字号\",\"");
      out.print(request.getParameter("sendfileNUM"));
      out.write("\");\r\n  ");
}
      out.write("\r\n  ");
if(request.getParameter("sendFileGrade") != null){
      out.write("\r\n      webform.WebOffice.WebSetBookMarks(\"缓急程度\",\"");
      out.print(request.getParameter("sendFileGrade"));
      out.write("\");\r\n  ");
}
      out.write("\r\n  ");
if(request.getParameter("documentSendFileWriteOrg") != null){
      out.write("\r\n      webform.WebOffice.WebSetBookMarks(\"拟稿单位\",\"");
      out.print(request.getParameter("documentSendFileWriteOrg"));
      out.write("\");\r\n  ");
}
      out.write("\r\n  ");
if(request.getParameter("documentSendFileTopicWord") != null){
      out.write("\r\n      webform.WebOffice.WebSetBookMarks(\"主题词\",\"");
      out.print(request.getParameter("documentSendFileTopicWord"));
      out.write("\");\r\n  ");
}
      out.write("\r\n  ");
if(request.getParameter("toPerson1") != null){
      out.write("\r\n      webform.WebOffice.WebSetBookMarks(\"主送\",\"");
      out.print(request.getParameter("toPerson1"));
      out.write("\");\r\n  ");
}
      out.write("\r\n  ");
if(request.getParameter("toPerson2") != null){
      out.write("\r\n      webform.WebOffice.WebSetBookMarks(\"抄送\",\"");
      out.print(request.getParameter("toPerson2"));
      out.write("\");\r\n  ");
}
      out.write("\r\n  ");
if(request.getParameter("documentSendFilePrintNumber") != null){
      out.write("\r\n      webform.WebOffice.WebSetBookMarks(\"共印\",\"");
      out.print(request.getParameter("documentSendFilePrintNumber"));
      out.write("\");\r\n  ");
}
      out.write("\r\n  ");
if(request.getParameter("documentSendFileSendTime") != null){
      out.write("\r\n      webform.WebOffice.WebSetBookMarks(\"印发日期\",\"");
      out.print(request.getParameter("documentSendFileSendTime"));
      out.write("\");\r\n  ");
}
      out.write("\r\n  ");
if(request.getParameter("sendFileRedHeadId") != null && !"-1".equals(request.getParameter("sendFileRedHeadId"))&&!"".equals(request.getParameter("sendFileRedHeadId"))){
      com.js.doc.doc.service.SendFileBD sendFileBD = new com.js.doc.doc.service.SendFileBD();
      Object[] obj = sendFileBD.getHeadInfo(request.getParameter("sendFileRedHeadId"));
      
      out.write("\r\n      webform.WebOffice.WebSetBookMarks(\"红头\",\"\");\r\n      ");

      if(obj != null && obj.length > 1 && obj[1] != null && !obj[1].toString().equals("")){
      ...
      out.write("  webform.WebOffice.WebSetProtect(true,\"\");                   //锁定文档\r\n\r\n}\r\n\r\nself.moveTo(0,0);\r\nself.resizeTo(screen.availWidth,screen.availHeight);\r\n\r\n</script>\r\n</head>\r\n<script language=\"javascript\">\r\nfunction showSign(){\r\n    ");

    String ShowSign = request.getParameter("ShowSign")==null?"0":request.getParameter("ShowSign");
	if(!ShowSign.equals("-1")){//判断是不是在已批文件的锁定状态，是锁定则不控制痕迹
      ...
      out.print(mHTMLPath);
      out.write("\">\r\n    <table border=0  cellspacing='0' cellpadding='0' width=\"100%\" height=\"100%\" align=\"center\" class=\"TBStyle\">\r\n      <tr style=\"display:none\">\r\n        <td align=\"right\" class=\"TDTitleStyle\" width=\"64\">主题</td>\r\n        <td class=\"TDStyle\"><input type=\"text\" name=\"Subject\" value=\"");
      out.print(mSubject);
      out.write("\" class=\"IptStyle\" onblur=\"SetBookmarks('Caption',this.value);\" style=\"WIDTH:50%\"><span color=\"blue\">|选择\"Word公文模板\"，输入\"主题\"内容，光标移开，WORD内容自动修改</span></td>\r\n      </tr>\r\n      <tr style=\"display:none\">\r\n        <td align=right class=\"TDTitleStyle\" width=64>作者</td>\r\n        <td class=\"TDStyle\"><input type=\"text\" name=\"Author\" value=\"");
      out.print(mAuthor);
      out.write("\" class=\"IptStyle\" ></td>\r\n      </tr>\r\n      <tr style=\"display:none\">\r\n        <td align=right class=\"TDTitleStyle\" width=64>时间</td>\r\n        <td class=\"TDStyle\"><input type=\"text\" name=\"FileDate\" value=\"");
//=FormatDate(mFileDate,"yyyy-MM-dd")
      out.write("\" readonly class=\"IptStyle\" ></td>\r\n      </tr>\r\n      <tr>\r\n        <!--td align=right valign=top  class=\"TDTitleStyle\" width=64>内容</td-->\r\n        <td align=right valign=top style=\"display:none\" class=\"TDTitleStyle\" width=\"79\" hegith=\"90%\">\r\n\t   <b>HTML按钮</b><br><font color=\"red\"><b>功能列表</b></font>\r\n           <input type=button class=button value=\"显示痕迹\" ");
      out.print(mDisabled);
