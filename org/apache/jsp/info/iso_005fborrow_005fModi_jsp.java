...
public final class iso_005fborrow_005fModi_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.oa.info.isodoc.po.IsoBorrowUserPO");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    int nowDay1=today.getDate();
    int nowMonth1=today.getMonth()+1;
    int nowYear1=today.getYear()+1900;

    int nowDay2=today.getDate();
    int nowMonth2=today.getMonth()+1;
    int nowYear2=today.getYear()+1900;
	...
	String inforChannelId="";
	String documentNO="";
	String userId="";
	String userName="";
	String orgId="";
	String orgName="";
	String isoBorrowUserId="";
	String borrowReason="";

	if(request.getAttribute("isoBorrowUserPO")!=null){
	  po=(IsoBorrowUserPO) request.getAttribute("isoBorrowUserPO");
     if(po!=null){
	  informationId =""+po.getInformationId();
	  informationName = ""+po.getInformationName();
	  inforChannelName = ""+po.getInforChannelName();
	  inforChannelId = ""+po.getInforChannelId();
	  documentNO = ""+po.getDocumentNO();
	  userId = ""+po.getUserId();
	  userName = ""+po.getUserName();
	  orgId = ""+po.getOrgId();
	  isoBorrowUserId=""+po.getIsoBorrowUserId();
	  orgName=""+po.getOrgName();
	  if(po.getBorrowReason()!=null&&!po.getBorrowReason().toString().equals("null"))
	  borrowReason=""+po.getBorrowReason();

	  java.util.Date beginTime=po.getBorrowBeginTime();
	  java.util.Date endTime=po.getBorrowEndTime();





        nowDay1=  beginTime.getDate();
       nowMonth1=beginTime.getMonth()+1;
       nowYear1=beginTime.getYear()+1900; 

        nowDay2= endTime.getDate();
       nowMonth2=endTime.getMonth()+1;
       nowYear2=endTime.getYear()+1900;
	...
	int inWorkType2 = ("null".equals(request.getParameter("workType")) || request.getParameter("workType")==null)?-1:Integer.parseInt(request.getParameter("workType"));//流程类型 0随机流程,1业务流程


	String  iniUserId=session.getAttribute("userId").toString();
...
if(inWorkType2 != 0 ) {
      ...
      try {
        ...
        // /info/iso_borrow_Modi.jsp(162,4) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("IsoBorrowAction");
        // /info/iso_borrow_Modi.jsp(162,4) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.print(orgId);
            out.write("\">\r\n\t\t\t\t<input type=\"hidden\" name=\"isoBorrowUserId\" value=\"");
            out.print(isoBorrowUserId);
            ...
            if (_jspx_meth_bean_005fmessage_005f10(_jspx_th_html_005fform_005f0, _jspx_page_context))
              return;
            out.write("：</td><td colspan=\"3\"><textarea style=\"width:90%;\" Class=\"inputTextarea\" rows=\"10\" name=\"borrowReason\">");
            out.print(borrowReason);
            out.write("</textarea> </td>\r\n\t\t\t   </tr>         \r\n\r\n\t\t\t\t\r\n\r\n\t\t\t\t<tr>\r\n\t\t\t\t   <td colspan=\"4\">&nbsp;\r\n\t\t\t\t   </td>\r\n\t\t\t\t</tr>\r\n\r\n\t\t\t\t\r\n\r\n\t\t\t\t<tr><td height=\"40\">&nbsp;</td></tr>\r\n\t\t\t\t");

				String formName = "IsoInfoActionForm";//在包含页中指定form的名称
				String saveCheckFn = "initPara()";//保存时校验表单的javascript函数名称
				String mainLinkFile = "/jsoa/IsoBorrowAction.do?action=load";//文件办理时打开的页面链接
				String passLinkFile ="/jsoa/IsoBorrowAction.do?action=load";
...
if (com.js.util.util.BrowserJudge.isMobile(request)) {
      ...
      out.write("\r\n\t\t\t</table>\r\n\t\t</div>\r\n\t\t\r\n\t\t<div id=\"docinfo1\" style=\"display:none;\">\r\n\t\t\t\t");
				...
				if(inWorkType2 != 0 ) {
      out.write("\r\n\t\t\t\t\t<table width=\"100%\" border=\"0\" cellpadding=\"1\" cellspacing=\"1\">\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t<INPUT TYPE=\"hidden\" name=\"jsflowUrl\" value=\"/jsoa/jsflow/jsflow_view.jsp?processId=");
      out.print(request.getParameter("processId"));
      out.write("&table=");
      out.print(request.getParameter("table"));
      out.write("&record=");
      out.print(request.getParameter("record"));
      out.write("\">\r\n\t\t\t\t\t\t\t<iframe id=\"jsflow\" height=\"500\" width=\"100%\" src=\"\"></iframe>\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t</table>\r\n\t\t\t\t");
}
      out.write("\r\n\t\t\t</div>\t\r\n\t\t</td>\r\n  </tr>\r\n</table>\r\n</div>\r\n\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n</html>\r\n<iframe id=\"delifr\" name=\"delifr\" style=\"display:none\"></iframe>\r\n<iframe id=\"chooseIfr\" name=\"chooseIfr\" style=\"display:none\"></iframe>\r\n<script language=\"javascript\">\r\n<!--\r\n\r\n//检查页面参数有效性\r\nfunction initPara() {\r\n\r\n\r\n \r\n       var beginDate=new Date(document.all.borrowBeginTime.value);\r\n\t\tvar endDate=new Date(document.all.borrowEndTime.value);\r\n\t\tif(beginDate>endDate){\r\n\t\t\talert(\"结束日期必须在开始日期之后！\");\r\n\t\t\treturn false;\r\n\t\t}\r\n        if(document.all.borrowReason.value!=\"\"){\r\n\t\t var  rea=document.all.borrowReason.value;\r\n\t\t if(rea.length>200){\r\n\t\t  \r\n\t\t  alert(\"借阅原因不能大于200字符！\");\r\n\t\t  return false;\r\n\t\t \r\n\t\t }\r\n\t\t\r\n\t\t\r\n\t\t}\r\n\r\n\r\nreturn true;\r\n\r\n}\r\n\r\n\r\n\r\nfunction modify(contentId,userId){\r\n\r\n\tvar orderId=document.all.cardOrderId.value;\r\n\tMM_openBrWindow('/jsoa/IsoInfoActionForm.do?action=load&infoId='+contentId+'&userId='+userId+'&editType=2&cardOrderId='+orderId,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=300');\r\n");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/iso_borrow_Modi.jsp(9,7) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("iso");
      // /info/iso_borrow_Modi.jsp(9,7) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setKey("ISO.modi");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/iso_borrow_Modi.jsp(145,36) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("information");
      // /info/iso_borrow_Modi.jsp(145,36) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/iso_borrow_Modi.jsp(151,36) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setBundle("information");
      // /info/iso_borrow_Modi.jsp(151,36) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setKey("info.processinfo");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/iso_borrow_Modi.jsp(171,36) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setBundle("iso");
      // /info/iso_borrow_Modi.jsp(171,36) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/iso_borrow_Modi.jsp(174,10) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setBundle("iso");
      // /info/iso_borrow_Modi.jsp(174,10) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setKey("ISO.filecatalog");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/iso_borrow_Modi.jsp(177,19) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f5.setBundle("iso");
      // /info/iso_borrow_Modi.jsp(177,19) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f5.setKey("ISO.borrowperson");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/iso_borrow_Modi.jsp(178,19) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f6.setBundle("iso");
      // /info/iso_borrow_Modi.jsp(178,19) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f6.setKey("ISO.borrowerdep");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/iso_borrow_Modi.jsp(181,8) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f7.setBundle("iso");
      // /info/iso_borrow_Modi.jsp(181,8) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f7.setKey("ISO.borrowtime");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/iso_borrow_Modi.jsp(181,80) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f8.setBundle("information");
      // /info/iso_borrow_Modi.jsp(181,80) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f8.setKey("info.from");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/iso_borrow_Modi.jsp(185,6) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f9.setBundle("information");
      // /info/iso_borrow_Modi.jsp(185,6) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f10(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /info/iso_borrow_Modi.jsp(192,10) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f10.setBundle("iso");
      // /info/iso_borrow_Modi.jsp(192,10) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f10.setKey("ISO.borrowreason");
