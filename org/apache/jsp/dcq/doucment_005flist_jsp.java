...
public final class doucment_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  for(int i=0;i<myList.size();i++){
 	...
 	if(index%2 != 0){
 	     ...
 	     listClass="listTableLine1";
            ...
            out.write("\r\n  <tr>\r\n        <td class=\"");
            out.print(listClass);
            out.write("\"><input type=\"checkbox\" disabled=\"disabled\" name=\"batchId\" value=\"");
            out.print(obj[0]);
            out.write("\"></td>\r\n        <td class=\"");
            out.print(listClass);
            out.write('"');
            ...
            out.write('"');
            out.write('>');
            out.print(null==obj[2]||"null".equalsIgnoreCase(obj[2].toString()) ? "" : obj[2].toString().substring(0, obj[2].toString().length()-2) );
            out.write("&nbsp;</td>\r\n        <td class=\"");
            out.print(listClass);
            out.write('"');
            out.write('>');
            ...
            out.print(listClass);
            out.write("\">\r\n          ");
if(obj[4]!=null&&!"".equals(obj[4]+"")&&"0".equals(obj[4]+"")){
             out.print("未处理");
          }else{
             out.print("已处理");
          } 
            out.write("\r\n        </td>\r\n\t\t<td class=\"");
            out.print(listClass);
            out.write(" listTableLineLastTD\">\r\n\t\t&nbsp;\r\n\t\t<img title=\"发起流程\" style=\"cursor:pointer\" border=\"0\" src=\"images/newDoc.gif\" onclick=\"newFlowForm('");
            out.print(obj[0]);
            out.write('\'');
            out.write(',');
            out.write('\'');
            out.print(obj[5]);
            out.write("')\"/>\r\n\t\t<img title=\"催办信息\" style=\"cursor:pointer\" border=\"0\" src=\"images/press.png\" onclick=\"showPress('");
            out.print(obj[0]);
            out.write("')\"/>\r\n\t\t</td>\r\n  </tr>\r\n  ");
...
String pagerURL = "/jsoa/businessShowAction.do";
            out.write("\r\n\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n<input type=\"hidden\" id=\"curId\">\r\n<input type=\"hidden\" id=\"oId\">\r\n<input type=\"hidden\" id=\"sql\" value=\"select docTitle,docNo,kword,deptName from dcq_recivefile where file_id=\">\r\n<input type=\"hidden\" id=\"fields\" value=\"receiveFileTitle,receiveFileFileNumber,receiveTextField2,receiveFileSendFileUnit\">\r\n<input type=\"hidden\" id=\"fileType\" value=\"recive\">\r\n</body>\r\n<script language=\"javascript\">\r\nfunction newFlowForm(id,oid){\r\n\tdocument.getElementById(\"curId\").value = id;\r\n\tdocument.getElementById(\"oId\").value = oid;\r\n\tMM_openBrWindow(\"/jsoa/GovReceiveFileAction.do?action=see&processId=382&processName=收文处理单&processType=1&tableId=48&remindField=\",\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600\");\r\n}\r\n\r\nfunction showPress(fileId){\r\n\tJSMainWinOpen3(\"/jsoa/dcq/recivefile_showPress.jsp?fileType=recive&fileId=\" + fileId, \"\", \"\");\r\n}\r\nfunction getCurId(){\r\n\treturn document.getElementById(\"curId\").value;\r\n}\r\nfunction MM_openBrWindow(theURL,winName,features) { //v2.0\r\n");
