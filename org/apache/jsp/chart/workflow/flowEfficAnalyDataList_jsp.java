...
public final class flowEfficAnalyDataList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int kindCount=0;
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
		  ...
		  if(orderBy == null || !orderBy.equals("sumxiao")){
            out.write("\r\n\t\t<img src=\"images/blanksort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('sumxiao','desc');\" title=\"按节点耗时排序\">\r\n\t\t");
}else if(orderBy.equals("sumxiao") && sortType.equals("desc")){
            out.write("\r\n\t\t<img src=\"images/downsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('sumxiao','asc');\" title=\"按节点耗时排序\">\r\n\t\t");
}else if(orderBy.equals("sumxiao") && sortType.equals("asc")){
            out.write("\r\n\t\t<img src=\"images/upsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('sumxiao','desc');\" title=\"按节点耗时排序\">\r\n\t\t");
}
	  ...
	  String listClass="listTableLine1";
            ...
            try {
              ...
              // /chart/workflow/flowEfficAnalyDataList.jsp(114,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("resultList");
              // /chart/workflow/flowEfficAnalyDataList.jsp(114,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("resultList");
              // /chart/workflow/flowEfficAnalyDataList.jsp(114,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setScope("request");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object resultList = null;
                ...
                resultList = (java.lang.Object) _jspx_page_context.findAttribute("resultList");
                do {
                  out.write("\r\n        ");

        Map tempMap= (Map)resultList;
		index ++;
		countRecordCount ++;
		...
		float maxTime=new Float(request.getAttribute("maxTime").toString());//最长时间
		...
		if(youxiao!=0||wuxiao!=0){
		 ...
		 if(maxTime!=0){
			 processBilV=fnum.format((youxiao+wuxiao)/maxTime*100); 
		 }
                  ...
                  out.write("</td>\r\n\t    <td class=\"");
                  out.print(listClass);
                  out.write("\">\r\n\t    <a href=\"#\"  onclick=\"leaderSee('");
                  out.print(tempMap.get("activityId"));
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
                  out.print(tempMap.get("activityName"));
                  out.write("')\" >\r\n\t    ");
                  out.print(tempMap.get("activityName"));
                  out.write("&nbsp;</a> </td>\r\n\t    \r\n\t\t<td class=\"");
                  out.print(listClass);
...
if(Double.valueOf(tableWidthYouxiao)!=0&&Double.valueOf(tableWidthWuxiao)!=0) {
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(String.valueOf(fnum.format(Float.parseFloat(tempMap.get("youxiao").toString()))));
                  out.write("\r\n\t\t\t\t\t\t\t\t\t/");
                  out.print(String.valueOf(fnum.format(Float.parseFloat(tempMap.get("wuxiao").toString()))));
                  out.write("&nbsp;</td>\r\n\t  </tr>\r\n\t  ");
		...
		if(index%2 != 0){
            ...
            out.write('"');
            out.write('>');
            out.print(request.getAttribute("youxiaosum"));
            out.write('+');
            out.print(request.getAttribute("wuxiaosum"));
            out.write("&nbsp;</td>\r\n\t  </tr>\r\n</table>\r\n<!-- LIST TITLE PART -->\r\n<br>\r\n<!-- PAGER -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n <tr>\r\n    <td>&nbsp;&nbsp;\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\nfunction orderBy(orderBy,sortType){\r\n\twindow.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/chartWorkFlow.do?action=flowEfficAnalyDataList&processId=");
      out.print(request.getAttribute("processId"));
      out.write("&processName=");
      out.print(request.getAttribute("processName"));
      out.write("\"+\r\n\t\"&parent.pager.offset=");
      ...
      out.write("\tobject.tempValue+=2.5;\r\n\telement.style.width=object.tempValue+\"%\";\r\n\tvar timeout=setTimeout(displayBars,10,object);\r\n\tif(tempValue>=width-3.5)\r\n\t{\r\n\t\tclearTimeout(timeout);\r\n\t}\r\n}\r\n//----滚动条状态结束-------\r\n//查看信息\r\nfunction leaderSee(list_id,activityName){\r\n\twindow.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/chartWorkFlow.do?action=flowEfficAnalyUserDataList&processId=");
      out.print(request.getAttribute("processId"));
      out.write("&processName=");
      out.print(request.getAttribute("processName"));
      out.write("&parent.pager.offset=");
      out.print(offset1);
      out.write("&activityId=\"+list_id+\"&activityName=\"+activityName;\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
