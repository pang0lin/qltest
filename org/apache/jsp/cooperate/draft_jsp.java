      ...
      try {
        ...
        String level;
            ...
            try {
              ...
              // /cooperate/draft.jsp(80,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /cooperate/draft.jsp(80,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
			...
			if(level.equals("10")){
				...
				level="紧急";
                  ...
                  out.write("</td>\r\n               <td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\"><img src=\"/jsoa/images/del.gif\" style=\"cursor:pointer\" onclick=\"delSingle('");
                  out.print(obj[0] );
                  out.write("');\"></td>\r\n           </tr>\r\n       ");
