...
public final class fsalarylist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List showList=(List)request.getAttribute("showList");
...
String collectEnable=null==request.getAttribute("collectEnable")?"":request.getAttribute("collectEnable").toString();
String collectDateEnable=null==request.getAttribute("collectDateEnable")?"":request.getAttribute("collectDateEnable").toString();
String empName=null==request.getParameter("empName")?"":request.getParameter("empName");
String orgName=null==request.getParameter("orgName")?"":request.getParameter("orgName");
...
int offset1=index;
boolean isPad=com.js.util.util.BrowserJudge.isIpad(request);
...
if(isPad){
            ...
            out.write(" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\" id=\"searchbar\" style=\"display:none\">\r\n   <form name=\"frm\" action=\"/jsoa/fSalaryAction.do?action=list\" method=\"post\">\r\n     <input type=\"hidden\" name=\"exportLog\" value=\"\">\r\n\t  <tr>\r\n\t\t  <td align=\"center\">用户：</td>\r\n\t\t  <td>\r\n\t\t\t<input type=\"text\" class=\"inputtext\" id=\"empName\" name=\"empName\" value=\"");
            out.print(empName);
            out.write("\"/>\r\n\t\t\t</td>\r\n\t\t  <td align=\"left\">部门：<input type=\"text\" class=\"inputtext\" id=\"orgName\" name=\"orgName\" value=\"");
            out.print(orgName);
            out.write("\"/></td>\r\n\t\t  <td>\r\n\t\t\t&nbsp;\r\n\t\t  </td>\r\n\t\t  </tr>\r\n\t\t  <tr>\r\n\t\t  <td align=\"center\">录入开始时间：</td>\r\n\t\t  <td ><script language=javascript>\r\n\t\t\t\t\tvar dtpDate = createDatePickerByDateStr(\"oprStartTime\",\"");
...
if(isPad){
            ...
            out.write(" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">  \r\n  <tr>\r\n  \t  <td align=\"left\" width=\"10%\">\r\n  \t    工资管理\r\n  \t  </td>\r\n\t  <td align=\"right\" >\r\n\t   ");

	   String canEidt=request.getAttribute("canEdit")==null?
			   (new com.js.system.manager.service.ManagerService().hasRight(
					   session.getAttribute("userId").toString(), "07*55*10")?"1":"")
			   :request.getAttribute("canEdit").toString();
	    if("1".equals(canEidt)){
	    
            out.write("  \r\n\t \t<button class=\"btnButton4font\" onClick=\"javascript:allDelete();\">删除</button>\r\n\t    <button class=\"btnButton4font\" onClick=\"javascript:allDeletePiCi();\">批次删除</button>\r\n\t \t\t");
	    ...
	    if("1".equals(canEidt)){
            ...
            out.write("\r\n      \t<input type=\"button\" class=\"btnButton2font\" onClick=\"javascript:uploadtemplate(6,2);\" value=\"导入\"/>\r\n      \t<input type=\"button\" class=\"btnButton2font\" onClick=\"javascript:downloadtemplate(6);\" value=\"下载模版\"/>\r\n      \t\t");
...
if(isPad){
            ...
            out.write(" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n");
            //  html:form
            ...
            try {
              ...
              // /finance/fsalary/fsalarylist.jsp(127,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/oaSysRemindAction");
              // /finance/fsalary/fsalarylist.jsp(127,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if(null!=showList&&showList.size()>0){ 
			for(int i=0;i<showList.size();i++){
				Object obj[]=(Object[])showList.get(i);
                  ...
                  out.write("\r\n\t\t\t<td  class=\"listTableHead\" id=\"tdWidth\" width=\"100px\">");
                  out.print(obj[2] );
                  out.write("</td>\t\r\n\t\t");
	}
			} 
                  out.write("\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\"  width=\"130px\">录入时间</td>\r\n\t\t<td width=\"100px\"  class=\"listTableHead\"  id=\"tdWidth\">操作</td>\r\n  </tr>\r\n  ");

  String listClass="listTableLine1";
  for(int i=0;null!=datas&&i<datas.length;i++){
     index ++;
 	if(index%2 != 0){
 	     ...
 	     listClass="listTableLine1";
                  ...
                  out.print(datas[i][0]);
                  out.write("\"></td>\r\n        ");
for(int j=1;j<(datas[i].length-2);j++){ 
                  out.write("\r\n        <td class=\"");
                  out.print(listClass);
                  out.write("\" title=");
                  out.print((null==datas[i][j]||"".equals(datas[i][j].toString()))?"&nbsp;":datas[i][j].toString());
                  out.write('>');
                  out.print((null==datas[i][j]||"".equals(datas[i][j].toString()))?"&nbsp;":datas[i][j].toString());
                  out.write("</td>\r\n\t\t");
} 
                  ...
                  out.print(listClass);
                  out.write("\">\r\n\t\t");
                  out.print(null==datas[i][datas[i].length-2]?"":(datas[i][datas[i].length-2].toString().length()>=16?datas[i][datas[i].length-2].toString().substring(0,16):datas[i][datas[i].length-2].toString()));
                  out.write("\r\n\t\t</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">\r\n\t\t<img title=\"查看\" style=\"cursor:pointer\" border=\"0\" src=\"images/readme.gif\" onclick=\"leaderShow('");
                  out.print(datas[i][0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
                  out.print(datas[i][datas[i].length-1]);
                  out.write("','f_salary')\"/>\r\n\t\t ");

	    if("1".equals(canEidt)){
	    
                  out.write("\t\r\n\t\t<img title=\"修改\" style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" onclick=\"leaderModi('");
                  out.print(datas[i][0]);
...
String pagerURL = "/jsoa/fSalaryAction.do";
            out.write("\r\n\t\t\t\t\t\t\t\t\t");
