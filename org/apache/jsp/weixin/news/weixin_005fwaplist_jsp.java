...
public final class weixin_005fwaplist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
com.js.oa.weixin.common.bean.WeiXinBean weixinBean=new com.js.oa.weixin.common.bean.WeiXinBean();
      ...
      out.write("\" placeholder=\"请输入标题\" />\r\n\t\t   \t\t\t<div class=\"sousuo-11\" onclick=\"javascript:submitForm();\"><img src=\"images/weixin/ss.png\"></div>\r\n\t\t   \t\t</div>\r\n\t\t   \t</div>\r\n\t   \t</FORM>\r\n\t   \t\r\n\t   \t<!-- 信息列表 -->\r\n\t\t<div class=\"list\">\r\n\t\t\t");
			...
			if(showList!=null && showList.size()>0){
				for(int i=0; i<showList.size(); i++){
					...
					String userAccount = com.js.system.util.StaticParam.getUserAccountsByEmpId(obj[17]+"");
					String titleColor = "";
      ...
      out.print(path);
      out.write("/innerNewsAction.do?method=readInfo&readId=");
      out.print(obj[1]);
      out.write("&title=");
      out.print(obj[2]);
      ...
      out.write("<img class=\"picshow\" border='0' src='/jsoa/images/weixin/news.png'/>");
      ...
      out.write("\r\n\t\t</div>\r\n  \r\n  \t\t<!-- 分页 -->\r\n\t\t");
		...
		if (size > WapUtil.LIMITED) {
			if (upIndex >= 0){
				upUrl = path + "/innerNewsAction.do?method=getDetailContent&conType="+conType+"&beginIndex=" + upIndex;
			...
			if (nextIndex < size){
				nextUrl = path + "/innerNewsAction.do?method=getDetailContent&conType="+conType+"&beginIndex=" + nextIndex;
				if (null != keyword && !"".equals(keyword))
