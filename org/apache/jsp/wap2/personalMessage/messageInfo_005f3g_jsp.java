...
public final class messageInfo_005f3g_jsp extends org.apache.jasper.runtime.HttpJspBase
...
boolean currentUserIsSender = po.getSenderId() != null && po.getSenderId().equals(session.getAttribute("userId"));
      ...
      out.print(path);
      out.write("/wap2/personalMessage/replyAccess_3g.jsp?action=del&beginIndex=");
      out.print(beginIndex );
      out.write("&chatId=");
...
if(currentUserIsSender){
      ...
      out.write("</div>\r\n\t\t\t\t\t<div class=\"clear\"></div>\r\n\t\t</div>\r\n\t\t<div class=\"list_2\">\r\n\t\t\t\t\t<div class=\"t1\">消息内容:</div>\r\n\t\t\t\t\t<div class=\"t2\" style=\"word-wrap:break-word\">");
      out.print(HTMLEncoding.htmlEncoding(po.getChatContent()));
      out.write("</div>\r\n\t\t\t\t\t<div class=\"clear\"></div>\r\n\t\t</div>\r\n\t\t");
if(!currentUserIsSender){
      out.write("\r\n\t\t<div class=\"list_2\">\r\n\t\t\t\t\t<div class=\"t1\">回复内容:</div>\r\n\t\t\t\t\t<div class=\"t2\">\r\n\t\t\t\t\t<textarea name=\"reply_content\" rows=\"2\"></textarea>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t\t<div class=\"clear\"></div>\t\t\r\n\t\t</div>\r\n\t\t<div class=\"list_2\" align=\"center\">\r\n\t\t\t<input class=\"button2\" type=\"button\" value=\"回复\" onclick=\"javascript:document.form1.submit();\" />\r\n\t\t\t<div class=\"clear\"></div>\t\t\r\n\t\t</div>\r\n\t\t");
}
      out.write("\r\n\t</div>\r\n\t</form>\r\n</div>\r\n</body>\r\n</html>\r\n");
