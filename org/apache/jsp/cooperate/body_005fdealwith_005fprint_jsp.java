...
public final class body_005fdealwith_005fprint_jsp extends org.apache.jasper.runtime.HttpJspBase
...
boolean bflag=false;if(BrowserJudge.isMSIE(request))bflag=true;
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\r\n\t\t</table>\r\n    </td>\r\n  </tr>\r\n  <!-- 协同正文属性 end -->\r\n  <!-- 协同正文内容 -->\r\n  <tr>\r\n     <td style=\"padidng:1px;padding-top:0px;\">\r\n         <table width=\"100%\" height=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n            <tr>\r\n                <td class=\"bigTitle\" valign=\"top\" align=\"center\" style=\"background:#a0a0a0;\">\r\n                ");
 if( BrowserJudge.isChrome(request) || BrowserJudge.isSafari(request)) { 
            ...
            out.write("\r\n                      <table width=\"95%\" height=\"90%\" border=\"0\" cellpadding=\"10\" cellspacing=\"0\" class=\"docBoxNoPanelForFlow\" id=\"main_print\">\r\n                           <tr>\r\n                              <td valign=\"top\">\r\n                                  <table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">\r\n       \r\n                                     <tr>\r\n                                         <td valign=\"top\">\r\n                                         <div id=\"coBodyContentHTML\"> \r\n                                         ");
            ...
            out.print(com.js.util.util.BASE64.BASE64EncoderNoBR("FileName="+obj[2]+"&name="+obj[1].toString()+"&path=cooperate&moduleCode="+moduleCode));
            out.write('"');
            out.write('>');
            out.print(obj[1] );
            out.write("</a>&nbsp;&nbsp;\r\n                                         ");
...
if(request.getAttribute("relProjectName")==null){
            ...
            out.write("\r\n                      <p height=\"5\"></p>\r\n                      <table width=\"95%\" height=\"50\" id=\"supplementTable\" border=\"0\" cellpadding=\"10\" cellspacing=\"0\" class=\"docBoxNoPanelForFlow\" id=\"table_2\" style=\"padding-top:2px;display:none;\" >\r\n                           <tr>\r\n                              <td>\r\n                                  <table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">\r\n                                     <tr>\r\n                                        <td>正文补充</td>\r\n                                     </tr>\r\n                                     ");
            ...
            out.print(com.js.util.util.BASE64.BASE64EncoderNoBR("FileName="+obj[2]+"&name="+obj[1].toString()+"&moduleCode="+moduleCode+"&path=cooperate"));
            out.write('"');
            out.write('>');
            out.print(obj[1] );
            out.write("</a>&nbsp;&nbsp;\r\n                                     ");
            ...
            out.write(" \r\n                      <p height=\"5\"></p>                      \r\n                      <table width=\"95%\" id=\"opinionTable\" height=\"50\" valign=\"top\" border=\"0\" cellpadding=\"1\" cellspacing=\"0\" class=\"docBoxNoPanelForFlow\" id=\"table_1\" style=\"display:none;\" >\r\n                           <tr>\r\n                              <td height=\"50\">\r\n                                  <table height=\"50\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">\r\n                                     <tr>\r\n                                        <td nowrap height=\"26\">&nbsp;&nbsp;办理意见</td>\r\n                                     </tr>\r\n                                     \r\n                                     ");
        ...
        if(subOpinion!=null && subOpinion.size()>0){        	
         ...
         if(opinionAttach!=null && opinionAttach.size()>0){        	
            ...
            out.write("\r\n                <a href=\"/jsoa/download.jsp?");
            out.print(com.js.util.util.BASE64.BASE64EncoderNoBR("FileName="+fileSaveName+"&name="+fileName+"&moduleCode="+moduleCode+"&path=cooperate"));
            out.write('"');
            out.write('>');
            out.print(fileName );
            out.write("</a>&nbsp;\r\n\t                  \r\n         ");
