 ...
 * Generated at: 2023-01-06 09:46:35 UTC
...
public final class reportWMList_005f3g_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	int beginIndex=Integer.parseInt(request.getParameter("beginIndex")==null?"0":request.getParameter("beginIndex"));
      ...
      out.write("</SPAN>\r\n           <A class=btn_1 href=\"");
      out.print(path);
      out.write("/wap/action/WapReportAction.do?method=showReportIndex\">返回</A>\r\n       </DIV>\r\n       <DIV class=height2></DIV>\r\n\t");
if(reportlist!=null&&reportlist.size()>0){
      ...
      out.print(path);
      out.write("/wap2/report/wapReadWMReport_3g.jsp?repId=");
...
conHead = "";
	...
	if(recordCount>WapUtil.LIMITED){
		if(upIndex>=0)upUrl=path+"/wap/action/WapReportAction.do?method=getWapWMRepList&amp;beginIndex=" + upIndex + "&amp;repUser=" + repUser + "&amp;repType=" + repType;
		if(nextIndex<recordCount)nextUrl=path+"/wap/action/WapReportAction.do?method=getWapWMRepList&amp;beginIndex=" + nextIndex+ "&amp;repUser=" + repUser+ "&amp;repType=" + repType;
