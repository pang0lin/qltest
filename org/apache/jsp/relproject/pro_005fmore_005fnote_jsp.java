...
public final class pro_005fmore_005fnote_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if("1".equals(userRoll)){
      out.write("\r\n\t\t<button  onclick=\"add();\"  class=\"btnButton4font\" >新建留言</button>\r\n\t\t");
} 
      out.write('\r');
      out.write('\n');
      out.write('	');
if(projectId_!=null){
      ...
      out.write("\r\n\t</td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n<tr>\r\n   \r\n\t<TD width=\"75%\" class=\"listTableHead\">留言内容</TD>\r\n\t<TD width=\"8%\" class=\"listTableHead\">留言人</TD>\r\n\t<TD width=\"10%\" class=\"listTableHead\">留言时间</TD>\r\n\t<TD width=\"7%\" class=\"listTableHead\">操作</TD>\r\n\t\r\n</tr>\r\n");
      //  logic:iterate
      ...
      try {
        ...
        // /relproject/pro_more_note.jsp(102,0) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("list");
        // /relproject/pro_more_note.jsp(102,0) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("list");
        // /relproject/pro_more_note.jsp(102,0) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            out.write("\r\n     <tr >\r\n\t  <td class=\"");
            out.print(listClass);
            out.write("\"  style=\"padding:0px;padding-left:3px;\" ><a style=\"cursor:pointer\" onclick=\"javascript:openNote('");
            out.print(obj[0] );
            out.write("')\">");
            out.print(obj[1] );
            out.write("</a></td>\r\n\t  <td class=\"");
            ...
            out.print(listClass);
            out.write("\" style=\"padding:0px;padding-left:3px;\">\r\n\t   ");
if(session.getAttribute("userId").toString().equals(obj[4].toString())){ 
            out.write("\r\n\t       <img src=\"/jsoa/images/modi.gif\" style=\"cursor:pointer\" title=\"修改\" onclick=\"updateNote('");
            out.print(obj[0] );
            out.write("')\">\r\n           <img src=\"/jsoa/images/del.gif\" style=\"cursor:pointer\" title=\"删除\" onclick=\"deleteNote('");
            out.print(obj[0] );
            out.write("')\">\r\n           ");
}else{ 
            out.write("&nbsp;");
