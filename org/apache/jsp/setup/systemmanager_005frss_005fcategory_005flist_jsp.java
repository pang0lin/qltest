 ...
 * Generated at: 2023-01-06 09:51:12 UTC
...
public final class systemmanager_005frss_005fcategory_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int offset1=index;
      ...
      out.write("\t\t\t\t\t\t\t\t      </div>\r\n\t\t\t\t\t\t\t\t      <div id=\"PanleDIV\"  class=\"tabPanelSelected\" onClick=\"changePanle(this,'/jsoa/rssCategory.do?method=goRssCategoryList');\">\r\n\t\t\t\t\t\t\t\t        <div class=\"tabPanelLeft\"></div>\r\n\t\t\t\t\t\t\t\t        <div class=\"tabPanelCenter\">RSS分类</div>\r\n\t\t\t\t\t\t\t\t        <div class=\"tabPanelRight\"></div>      \r\n\t\t\t\t\t\t\t\t      </div>\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td align=\"right\">\r\n\t\t\t\t\t\t\t\t    <input type=\"button\" class=\"btnButton2Font\" onclick=\"addRssCategory()\" value=\"新增\" />\r\n\t\t\t\t\t\t\t\t\t<input type=\"button\" class=\"btnButton2Font\" onclick=\"delX()\" value=\"删除\" />\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t</table>\r\n\r\n\t\t\t\t\t\t<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td width=\"40\" class=\"listTableHead\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\">\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td  class=\"listTableHead\">\r\n\t\t\t\t\t\t\t\t\t名称\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td width=\"15%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t\t\t\t创建时间\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t    <td width=\"8%\" class=\"listTableHead\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t处理\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n                            ");

                            List list = (List) request.getAttribute("rssCategoryList");
      ...
      try {
        ...
        // /setup/systemmanager_rss_category_list.jsp(79,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("rssCategoryList");
        // /setup/systemmanager_rss_category_list.jsp(79,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("rssCategoryList");
        // /setup/systemmanager_rss_category_list.jsp(79,7) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setScope("request");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object rssCategoryList = null;
          ...
          rssCategoryList = (java.lang.Object) _jspx_page_context.findAttribute("rssCategoryList");
          do {
            out.write("\r\n\t\t\t\t\t\t\t\t");

											Object[] obj = (Object[]) rssCategoryList;
											String categoryName = obj[1].toString();
...
String pagerURL = "/jsoa/rssCategory.do";
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t</table>\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t</table>\r\n</form>\r\n\t</body>\r\n</html>\r\n<script language=\"javascript\">\r\n\tvar wleft=window.screenLeft;\r\n\tvar wtop=window.screenTop-96;\r\n\r\n\tfunction addRssCategory(){\r\n\t  var url=\"");
      out.print(request.getContextPath());
      out.write("/setup/systemmanager_rss_category_saveorupdate.jsp\";\r\n\t  JSMainWinOpenNew(url,\"新增RSS类别\",'menubar=0,scrollbars=0,left='+wleft+',top='+wtop+',width=450,height=250,resizable=no'); \r\n\t}\r\n\t\r\n\tfunction modify(categoryId){\r\n\t   var url=\"");
      out.print(request.getContextPath());
      out.write("/rssCategory.do?method=proModRssCategory&categoryId=\"+categoryId;\r\n\t   JSMainWinOpenNew(url,\"修改Rss类别\",'menubar=0,scrollbars=0,left='+wleft+',top='+wtop+',width=450,height=250,resizable=no');\r\n\t}\r\n\t\r\n\t\r\n\t function selectAllItem(){\r\n\t    var result=document.all.selectAll.checked;\r\n\t    if(document.all.batchDel){\r\n\t        if(isNaN(document.all.batchDel.length)){\r\n\t            document.all.batchDel.checked=result;\r\n\t        }else{\r\n\t            for(var i=0;i<document.all.batchDel.length;i++){\r\n\t                document.all.batchDel[i].checked=result;\r\n\t            }\r\n\t        }\r\n\t    }\r\n\t}\r\n\t\r\n function delSingle(id){\r\n\t mailForm.action='");
      out.print(webapp);
      out.write("'+\"/rssCategory.do?method=delRssCategory&delType=single&categoryId=\"+id;\r\n\tif(confirm(\"确任要删除吗？\")){\r\n        mailForm.submit();\r\n        return true;\r\n    }else{\r\n        return false;\r\n    }\r\n }\r\n \r\n  function delX(){\r\n     var ids=getCheckBoxID();\r\n\t mailForm.action='");
      out.print(webapp);
      out.write("'+\"/rssCategory.do?method=delRssCategory&delType=single&categoryIds=\"+ids;\r\n\t if(ids==null||ids==''){\r\n\t   alert('请选择要删除的记录！');\r\n\t    return false;\r\n     }else{\r\n\t\t if(confirm(\"确任要删除吗？\")){\r\n\t             mailForm.submit();\r\n\t             return true;\r\n\t     }else{\r\n\t\t\t   return false;\r\n\t\t }\r\n\t  }\r\n }\r\n \r\n function delAll(){\r\n  mailForm.action='");
      out.print(webapp);
      out.write("'+\"/rssCategory.do?method=delRssCategory&delType=all\";\r\n  var obj=document.getElementsByName('batchDel');\r\n if(obj.length>0){\r\n  if(confirm(\"确任要清空吗？\")){\r\n       mailForm.submit();\r\n       return true;\r\n    }else{\r\n\t   return false;\r\n  }\r\n }else{\r\n   alert('无操作数据！');\r\n   return false;\r\n }\r\n }\r\n\r\n function getCheckBoxID() {\r\n    var strCheckBox = \"\" ;\r\n    var k=0;\r\n    for(var i = 0 ; i < document.all.mailForm.length ; i++ ) {\r\n      var obj = document.all.mailForm[i] ;\r\n      if(obj.type == \"checkbox\"  && obj.name==\"batchDel\"){\r\n\t\tif(obj.checked) {\r\n             \tk++;\r\n                strCheckBox += obj.value  ;\r\n                strCheckBox += \",\" ;\r\n\t\t }\r\n      }\r\n    }\r\n    return strCheckBox ;\r\n}\r\n\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\n\r\n</script>\r\n");
