...
public final class baseSet_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_packages.add("com.js.oa.userdb.po");
...
if(request.getAttribute("reload")!=null){ 
            out.write("\r\n<script language=\"JavaScript\">\r\nlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/BaseSetAction.do?flag=list\";\r\n</script>\r\n");
} 
            out.write("\r\n<script language=\"JavaScript\" src=\"js/checkForm.js\"></script>\r\n</head>\r\n<body  class=\"MainFrameBox\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<form name=\"frm\" action=\"/jsoa/BaseSetAction.do\" method=\"get\">\r\n\t\t<input type=\"hidden\" name=\"flag\" value=\"list\">\r\n\t\t<input type=\"hidden\" name=\"tablename\">\r\n\t\t<input type=\"hidden\" name=\"domainid\" value=\"");
...
if("shandongguotou".equals(com.js.util.config.SystemCommon.getCustomerName())){
            ...
            try {
              ...
              // /userdb/baseSet.jsp(109,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("baseList");
              // /userdb/baseSet.jsp(109,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("baseList");
              // /userdb/baseSet.jsp(109,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setScope("request");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object baseList = null;
                ...
                baseList = (java.lang.Object) _jspx_page_context.findAttribute("baseList");
                do {
                  out.write("\r\n\t\t");
			
			index++;				
			BaseSetPO obj = (BaseSetPO) baseList;
			...
			if(index%2 != 0){
				listClass="listTableLine2";
                  ...
                  out.write("\r\n\r\n\t<tr>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"><input type=checkbox name=\"baseId\" value=\"");
                  out.print(obj.getBaseId() );
                  out.write("\"></td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"><a href=\"javascript:modi('");
                  out.print(obj.getBaseId() );
                  out.write("')\">");
                  out.print(obj.getBaseName() );
                  out.write("</a>&nbsp;</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(obj.getBaseContent()==null||"null".equals(obj.getBaseContent())?"":obj.getBaseContent() );
                  out.write("&nbsp;</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">\r\n\t\t\t<img src=\"/jsoa/images/modi.gif\" border=\"0\" style=\"cursor:pointer;\" title=\"修改\" onclick=\"modi('");
                  out.print(obj.getBaseId() );
                  out.write("');\"></a>&nbsp;\r\n\t\t\t<img border=\"0\" src=\"/jsoa/images/del.gif\" style=\"cursor:pointer;\" title=\"删除\" onclick=\"if(confirm('确定删除吗?')) {delone('");
                  out.print(obj.getBaseId() );
                  out.write("');}\"/>\r\n\t\t</td>\r\n\t</tr>\r\n\t\t\r\n\t");
...
String pagerURL = "/jsoa/BaseSetAction.do";
            out.write("\r\n\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\r\n<script language=\"javascript\">\r\nfunction modi(id){\r\n\twindow.open(\"/jsoa/BaseSetAction.do?flag=load&baseId=\"+id);\r\n}\r\nfunction addType(){\r\n\twindow.open(\"/jsoa/userdb/baseType_add.jsp\");\r\n}\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\nfunction delone(baseId){\r\n\tlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/BaseSetAction.do?flag=del&baseId=\"+baseId;\r\n}\r\nfunction del(){\r\n\tvar baseIds = document.getElementsByName(\"baseId\");\r\n\tvar baseId = \"\";\r\n\tfor(var i=0;i<baseIds.length;i++){\r\n\t\tif(baseIds[i].checked){\r\n\t\t\tbaseId+=baseIds[i].value+\",\";\r\n\t\t}\r\n\t}\r\n\t//alert(baseId);\r\n\tif(\"\"==baseId){\r\n\t\talert(\"请选择要删除的项！\");\r\n\t\treturn;\r\n\t}\r\n\tif(confirm(\"确定要删除该记录！\")){\r\n\tlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/BaseSetAction.do?flag=dels&baseIds=\"+baseId;\r\n\t}\r\n}\r\nfunction selectID(obj){\r\n\tvar baseIds = document.getElementsByName(\"baseId\");\r\n\tif(obj.checked){\r\n\t\tfor(var i=0;i<baseIds.length;i++){\r\n\t\t\tbaseIds[i].checked=true;\r\n");
      out.write("\t\t}\r\n\t}else{\r\n\t\tfor(var i=0;i<baseIds.length;i++){\r\n\t\t\tbaseIds[i].checked=false;\r\n\t\t}\r\n\t}\r\n}\r\nfunction query(){\r\n\tdocument.all.frm.submit();\r\n}\r\nfunction chSearch(obj){\r\n\tif(obj.value == \"查询\"){\r\n\t\tobj.value = \"关闭查询\";\r\n\t\tdocument.all.searchTable.style.display=\"\";\r\n\t}else{\r\n\t\tobj.value = \"查询\";\r\n\t\tdocument.all.searchTable.style.display=\"none\";\r\n\t}\r\n}\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
