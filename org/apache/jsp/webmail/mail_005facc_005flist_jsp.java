...
public final class mail_005facc_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(BrowserJudge.isMSIE(request)){ 
      out.write("\r\n\t\t\t\t\t\t\t\t    <button class=\"btnButton2Font\" onclick=\"createMailAcc()\">新建</button>\r\n\t\t\t\t\t\t\t\t\t<button class=\"btnButton2Font\" onclick=\"delMailAcc()\">删除</button>\r\n\t\t\t\t\t\t\t\t\t<button class=\"btnButton2Font\" onclick=\"modMailAcc()\">修改</button>\r\n\t\t\t\t\t\t\t\t\t<button class=\"btnButton2Font\" onclick=\"setMailAcc()\">设为默认邮箱</button>\r\n\t\t\t\t\t\t\t\t\t");
}else{ 
      out.write("\r\n\t\t\t\t\t\t\t\t\t<input type=\"button\" class=\"btnButton2Font\" onclick=\"createMailAcc()\" value=\"新建\" />\r\n\t\t\t\t\t\t\t\t\t<input type=\"button\" class=\"btnButton2Font\" onclick=\"delMailAcc()\" value=\"删除\" />\r\n\t\t\t\t\t\t\t\t\t<input type=\"button\" class=\"btnButton2Font\" onclick=\"modMailAcc()\" value=\"修改\" />\r\n\t\t\t\t\t\t\t\t\t<input type=\"button\" class=\"btnButton2Font\" onclick=\"setMailAcc()\" value=\"设为默认邮箱\" />\r\n\t\t\t\t\t\t\t\t\t");
} 
      ...
      out.write("\t\t\t\t\t\t\t\t<td width=\"15%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t\t\t\t操作\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t</tr>\r\n\r\n\t\t\t\t\t\t\t");
List list = (List) request.getAttribute("mailAccList");
      ...
      try {
        ...
        // /webmail/mail_acc_list.jsp(107,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("mailAccList");
        // /webmail/mail_acc_list.jsp(107,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("mailAccList");
        // /webmail/mail_acc_list.jsp(107,7) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setScope("request");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object mailAccList = null;
          ...
          mailAccList = (java.lang.Object) _jspx_page_context.findAttribute("mailAccList");
          do {
            out.write("\r\n\t\t\t\t\t\t\t\t");

											Object[] obj = (Object[]) mailAccList;
											String defaultFlag = obj[1].toString();
											String mailAccUser = obj[2].toString();
											String pop = obj[3].toString();
											String smtp = obj[4].toString();
											String bakFlag = obj[5].toString();
											String smtpPort = obj[6].toString();
											String popPort = obj[7].toString();
											String smtpJMFS ="SSL";
											if(obj[8] !=null){
											   smtpJMFS = obj[8].toString();
											}
											String popJMFS = "SSL";
											if(obj[9] != null){
											   popJMFS = obj[9].toString();
											}
											index++;
											if(index%2 != 0){
            ...
            out.print(listClass);
            out.write("\">\r\n\t\t                                ");
            out.print((defaultFlag!=null&&defaultFlag.equals("1"))?"是":"否" );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t\t");
            out.print((mailAccUser==null||mailAccUser.equals(""))?"":mailAccUser );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t  ");
            out.print((pop==null||pop.equals(""))?"":pop );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t  ");
            out.print((popPort==null||popPort.equals(""))?"":popPort );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t  ");
            out.print((popJMFS==null||popJMFS.equals(""))?"SSL":popJMFS );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t        <td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t  ");
            out.print((smtp==null||smtp.equals(""))?"":smtp );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t  ");
            out.print((smtpPort==null||smtpPort.equals(""))?"":smtpPort );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t  ");
            out.print((smtpJMFS==null||smtpJMFS.equals(""))?"SSL":smtpJMFS );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t    <td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t  ");
            out.print((bakFlag!=null&&bakFlag.equals("1"))?"保留":"不保留" );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t  <td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t<img src=\"images/modi.gif\" title=\"修改\" style=\"cursor:pointer\" onclick=\"modMailAccTemp(");
            out.print(obj[0]);
            out.write(")\" >\r\n\t\t\t\t\t\t\t\t\t<img src=\"images/del.gif\" title=\"删除\" style=\"cursor:pointer\" onclick=\"delMailAccTemp(");
            out.print(obj[0]);
            out.write(")\" >\r\n\t\t\t\t\t\t\t\t\t<img src=\"images/lc.gif\" title=\"设为默认邮箱\" style=\"cursor:pointer\" onclick=\"setMailAccTemp(");
            out.print(obj[0]);
            out.write(")\" >\r\n\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t");
...
String pagerURL = "/jsoa/webMailAcc.do";
      out.write("\r\n\t\t\t\t\t\t\t\t\t");
