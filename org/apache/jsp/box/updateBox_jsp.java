 ...
 * Generated at: 2023-01-06 09:42:34 UTC
...
String id=request.getParameter("id");
		BoxEJBBean boxEJBBean=new BoxEJBBean();
		BoxPO boxPO=boxEJBBean.getOne(id);
	 
      out.write("\r\n<table width=\"100%\" height=\"100%\" border=\"0\" cellpadding=\"10\" cellspacing=\"0\" class=\"docBoxNoPanel\">\r\n  <tr>\r\n    <td valign=\"top\">\r\n\t<div id=\"docinfo0\" style=\"display:;\">\r\n\t   <table width=\"100%\" border=\"0\" cellpadding=\"2\" cellspacing=\"1\">\r\n\t\t\t    <form name=\"AddressActionForm\" method=\"post\" action=\"handleBox.jsp?action=update&id=");
      out.print(boxPO.getId() );
      out.write("\" >\r\n\t\t\t\t<input type=\"hidden\" name=\"con\" value=\" \">\r\n\t\t\t\t<input type=\"hidden\" name=\"done\" value=\" \">\r\n\t\t\t\t<input type=\"hidden\" name=\"refreshType\" value=\"1\"/>\r\n\t\t\t\t<tr>\r\n\t\t\t\t  <td width=\"80\" nowrap>设置名称&nbsp;<label class=\"MustFillColor\">*</label>：</td>\r\n\t\t\t\t  <td><input type=\"text\" name=\"netAddressName\" maxlength=\"10\" size=\"50\"  class=\"inputText\" value=\"");
      out.print(boxPO.getName() );
      out.write("\"></td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t  <td nowrap>设置网址&nbsp;<label class=\"MustFillColor\">*</label>：</td>\r\n\t\t\t\t  <td><input type=\"text\" name=\"netAddressUrl\" maxlength=\"50\" size=\"50\"  class=\"inputText\" value=\"");
      out.print(boxPO.getNetStr() );
      out.write("\"></td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t\r\n\t\t\t\t<tr>\r\n\t\t\t\t  <td nowrap>设置简介&nbsp;<label class=\"MustFillColor\">*</label>：</td>\r\n\t\t\t\t  <td><input type=\"text\" name=\"synopsis\" maxlength=\"16\" size=\"50\"  class=\"inputText\" value=\"");
      out.print(boxPO.getSynopsis() );
      out.write("\"></td>\r\n\t\t\t\t</tr>\r\n\t\t\t   <tr>\r\n\t\t\t\t  <td nowrap>图片&nbsp;<label class=\"MustFillColor\">*</label>：<input type=\"hidden\" name=\"empLivingPhoto\" value=\"");
      ...
      out.print(request.getRealPath("/upload/box")+"\\"+boxPO.getSaveImg() );
