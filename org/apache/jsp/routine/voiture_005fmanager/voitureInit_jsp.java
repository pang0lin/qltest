 ...
 * Generated at: 2023-01-06 09:47:47 UTC
...
public final class voitureInit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(BrowserJudge.isFirefox(request)){ 
 ...
 out.print(java.text.DateFormat.getDateInstance(java.text.DateFormat.LONG  ,java.util.Locale.CHINA).format((new java.util.Date(nowYear-1900, nowMonth-1, nowDay))));
            ...
            try {
              ...
              // /routine/voiture_manager/voitureInit.jsp(120,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("VoitureApplyAction");
              // /routine/voiture_manager/voitureInit.jsp(120,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(BrowserJudge.likeFirefox(request)){ 
                  out.write("\r\n<table border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\"  width=\"100%\">\r\n                      <tr  align=\"center\" >\r\n                        <td width=\"160px\" rowspan=\"2\" align=\"center\" nowrap  class=\"listTableHead2\">车辆名称</td>\r\n\t\t\t\t\t\t<td width=\"192px\" rowspan=\"2\" align=\"center\"  class=\"listTableHead2\"  >0:00-7:59</td>\r\n                        ");

                        for(int i=8;i<20;i++){
                        
                  out.write("\r\n                        <td width=\"60px\" class=\"listTableHead2\" colspan=\"2\" >");
                  out.print(i);
                  out.write("</td>\r\n                        ");

                        }
                        
                  out.write("\r\n\t\t\t\t\t\t<td width=\"96px\" rowspan=\"2\" align=\"center\" class=\"listTableHead2\"  >20:00-23:59</td>\r\n\t\t\t\t\t\t<td rowspan=\"2\" align=\"center\"  class=\"listTableHead2Last\"  >处理</td>\r\n                    </tr>\r\n\t\t\t\t\t<tr align=\"center\">\r\n\t\t\t\t\t ");
                  ...
                  out.write("\r\n                      <td width=\"30px\" class=\"listTableHead2\" >");
                  out.print(minute);
                  out.write("</td>\r\n                        ");
                  ...
                  out.write("\r\n\t\t\t\t\t</tr>\r\n\t                   ");
                         ...
                         List searchDate=request.getAttribute("list")==null?new ArrayList():(List)request.getAttribute("list");
...
for(int j=0;j<searchDate.size();j++){
						Object []obj = (Object[])searchDate.get(j);
						  ...
						  String styleNum = "1";
							if(j%2 != 0){listClass="listTableLine2";styleNum="2";}
						String voiturePlace[]= new VoitureManagerService().getVoitureInfo(obj[0].toString(),formatter.format(searchStartDate));
						  
                  out.write("\r\n                      <tr>\r\n\r\n                      \t <td width=\"160px\" align=\"left\" wrap class=\"");
                  out.print(listClass);
                  out.write("\">\r\n                                   <input type=\"hidden\" name=\"cancel\">\r\n                       <a\thref=\"javascript:void(0);\" onclick=\"MM_openBrWindow('VoitureApplyAction.do?flag=info&voitureId=");
                  out.print(obj[0]);
                  out.write("','','LEFT=0,TOP=0,scrollbars=yes,resizable=yes,width=600,height=280')\" title=\"");
                  out.print(obj[1].toString());
                  out.write('"');
                  out.write('>');
                  out.write(' ');
                  out.print(obj[1]);
                  out.write("</a></td>\r\n\t\t\t\t\t\t  <td width=\"192px\" class=\"");
                  out.print(listClass);
                  out.write("\" style=\"padding:0px\"> \r\n\t\t\t\t\t\t   ");
 for( int i = 0 ; i <96 ; i++){
							if(voiturePlace[i].equals("false")){
                  out.write("\r\n                            <div class=\"zao0008wei");
                  out.print(styleNum );
                  out.write("\">&nbsp;</div>\r\n                            ");
}else{
                  out.write("\r\n                            <div class=\"zao0008shi\">&nbsp;</div>\r\n                        ");
}}
                  out.write("</td>\r\n                          ");
for(int k=0;k<24;k++){
                  out.write("\r\n\t\t\t\t\t\t   <td width=\"30px\" class=\"");
...
if(voiturePlace[96+k*6+l].equals("false")){
                  ...
                  out.write("\r\n                            <div class=\"ye2024shi\">&nbsp;</div>\r\n                        ");
}}
                  out.write("</td>\r\n\t\t\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\" align=\"center\" ><img\tsrc=\"images/sq.gif\" title=\"申请\"\tstyle=\"cursor:pointer\"\tonclick=\"apply('");
                  out.print(obj[0]);
                  out.write("')\"></td>\r\n                      </tr>\r\n                      ");
}}
                  out.write("\r\n  </table>\r\n");
}else{ 
                  out.write("\r\n<table border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\"  width=\"100%\">\r\n                      <tr  align=\"center\" >\r\n                        <td width=\"160px\" rowspan=\"2\" align=\"center\" nowrap  class=\"listTableHead2\">车辆名称</td>\r\n\t\t\t\t\t\t<td width=\"192px\" rowspan=\"2\" align=\"center\"  class=\"listTableHead2\" colspan=\"96\"  >0:00-7:59</td>\r\n                        ");

                        for(int i=8;i<20;i++){
                        
                  out.write("\r\n                        <td width=\"60px\" class=\"listTableHead2\" colspan=\"12\" >");
                  out.print(i);
                  out.write("</td>\r\n                        ");
...
String widthString = "";
						if(BrowserJudge.isNotPc(request)){
							widthString = "width=30px";
						}
                  out.write("\r\n\t\t\t\t\t\t<td width=\"96px\" rowspan=\"2\" align=\"center\" class=\"listTableHead2\" colspan=\"48\"  >20:00-23:59</td>\r\n\t\t\t\t\t\t<td rowspan=\"2\" ");
                  out.print(widthString );
                  out.write(" align=\"center\"  class=\"listTableHead2Last\"  >处理</td>\r\n                    </tr>\r\n\t\t\t\t\t<tr align=\"center\">\r\n\t\t\t\t\t ");
                  ...
                  out.write("\r\n                      <td width=\"30px\" class=\"listTableHead2\" colspan=\"6\" >");
                  out.print(minute);
                  out.write("</td>\r\n                        ");
...
for(int j=0;j<searchDate.size();j++){
 ...
 for( int i = 0 ; i <96 ; i++){
                  ...
                  out.write("\r\n                            <td class=\"");
                  out.print(listClass);
                  out.write(" zao0008wei");
                  out.print(styleNum );
                  out.write("\">&nbsp;</td>\r\n                            ");
}else{
                  out.write("\r\n                            <td class=\"");
                  out.print(listClass);
                  out.write(" zao0008shi\">&nbsp;</td>\r\n                        ");
}}
                  out.write("<!-- </td> -->\r\n                          ");
for(int k=0;k<24;k++){
                  out.write("\r\n\t\t\t\t\t\t   <!-- <td width=\"30px\" class=\"");
...
String pagerURL = "/jsoa/VoitureAction.do";
                  out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\nfunction search(){\r\n    frm1.submit();\r\n}\r\n\r\nfunction cleared(){\r\n   document.location.href=\"VoitureAction.do?flag=view&init=0\";\r\n}\r\n\r\nfunction apply(id){\r\n\tMM_openBrWindow(\"VoitureApplyAction.do?flag=add&voitureId=\"+id+\"&moduleId=11\",\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=400,height=300\");\r\n}\r\n\r\nfunction useApply(){\r\n\tMM_openBrWindow(\"VoitureApplyAction.do?flag=add&moduleId=11\",\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=400,height=300\");\r\n}\r\nfunction hidserch()\r\n{\r\n     var stable=document.getElementById(\"searchtable\");\r\n     var sbutton=document.getElementById(\"hiddenSearch\");\r\n     if(stable.style.display==\"none\")\r\n     {\r\n      stable.style.display=\"\";\r\n      hiddenSearch.innerHTML=\"关闭查询\";\r\n      \r\n     }else{\r\n     \r\n     stable.style.display=\"none\";\r\n     hiddenSearch.innerHTML=\"查询\";\r\n     \r\n     }\r\n}\r\n\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
