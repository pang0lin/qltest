 ...
 * Generated at: 2023-01-06 09:51:16 UTC
...
public final class systemmanager_005frss_005fchannel_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//} 
      out.write("\t\t\r\n\t\t\t\t\t\t\t\t<td width=\"15%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t\t\t\t名称\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td width=\"40%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t\t\t\t地址\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td width=\"15%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t\t\t\t所属类别\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td width=\"15%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t\t\t\t创建时间\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t    <td width=\"10%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t\t\t\t处理\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n                           ");
                            ...
                            List list = (List) request.getAttribute("rssChannelList");
      ...
      try {
        ...
        // /setup/systemmanager_rss_channel_list.jsp(99,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("rssChannelList");
        // /setup/systemmanager_rss_channel_list.jsp(99,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("rssChannelList");
        // /setup/systemmanager_rss_channel_list.jsp(99,7) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setScope("request");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object rssChannelList = null;
          ...
          rssChannelList = (java.lang.Object) _jspx_page_context.findAttribute("rssChannelList");
          do {
            out.write("\r\n\t\t\t\t\t\t\t\t");

											Object[] obj = (Object[]) rssChannelList;
											String channelName = obj[1].toString();
											String channelUrl = obj[2].toString();
											String categoryId = obj[3].toString();
											String createTime = obj[5].toString();
...
//} 
            ...
            out.print(listClass);
            out.write("\">\r\n\t\t                                ");
            out.print(channelUrl );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t                                ");
            out.print(RssCategoryForm.getCategoryNameById(categoryId) );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t\t");
...
if(select.equals("")){ 
            ...
            out.write("\r\n\t\t\t\t\t\t\t\t      <img src=\"images/toolbar/tedxt.gif\" title=\"订阅\" id=\"order_");
            out.print(obj[0]);
            out.write("\" style=\"cursor:pointer;\" onclick=\"orderRss(");
            out.print(obj[0]);
            out.write(',');
            out.print(obj[3]);
            out.write(")\">\r\n\t\t\t\t\t\t\t\t\t");
}else{
            out.write("\r\n\t\t\t\t\t\t\t\t\t  <img src=\"images/toolbar/qx.gif\" title=\"取消订阅\" id=\"order_");
            out.print(obj[0]);
            out.write("\" style=\"cursor:pointer\" onclick=\"removeOrder(");
            out.print(obj[0]);
            out.write(',');
            out.print(obj[3]);
            out.write(")\" >\r\n\t\t\t\t\t\t\t\t\t");
...
String pagerURL = "/jsoa/rssCategoryChannel.do";
      out.write("\r\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t</table>\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t</table>\r\n</form>\r\n<iframe id=\"channelInfoIframe\" name=\"channelInfoIframe\" style=\"display:none;\" marginheight=\"0\" marginwidth=\"0\" width=\"0\" height=\"0\"></iframe>\r\n</body>\r\n</html>\r\n<script language=\"javascript\">\r\n\tvar wleft=window.screenLeft;\r\n\tvar wtop=window.screenTop-96;\r\n\t\r\n\tfunction orderRss(channelId,categoryId){\r\n\t   channelForm.action=\"");
      out.print(request.getContextPath());
      out.write("/rssOrder.do?method=orderRssChannel&categoryId=\"+categoryId+\"&channelId=\"+channelId;\r\n\t   channelForm.target=\"channelInfoIframe\";\r\n\t   channelForm.submit();\r\n\t   \t   \r\n\t   if(window.parent.menuTop){\r\n\t     window.parent.menuTop.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/menu/left_top.jsp\";\r\n\t   }if(window.parent.menuTop_1001){\r\n\t     window.parent.menuTop_1001.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/ChannelMenuAction.do?channelType=0&userChannelName=知识管理\";\r\n\t   }\r\n\t   document.getElementById('td_'+channelId).innerHTML=\"<img src='images/toolbar/qx.gif' title='取消订阅' id='remove_\"+channelId+\"' style='cursor:pointer' onclick='removeOrder(\"+channelId+\",\"+categoryId+\")'>\";\r\n\t   document.getElementById('order_'+channelId).style.display=\"none\";\r\n    }\r\n    \r\n    function removeOrder(channelId,categoryId){\r\n\t   channelForm.action=\"");
      out.print(request.getContextPath());
      out.write("/rssOrder.do?method=removeRssOrder&channelId=\"+channelId;\r\n\t   channelForm.target=\"channelInfoIframe\";\r\n\t   channelForm.submit();\r\n\t   \r\n\t   if(window.parent.menuTop){\r\n\t     window.parent.menuTop.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/menu/left_top.jsp\";\r\n\t   }if(window.parent.menuTop_1001){\r\n\t     window.parent.menuTop_1001.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/ChannelMenuAction.do?channelType=0&userChannelName=知识管理\";\r\n\t   }\r\n\t   document.getElementById('td_'+channelId).innerHTML=\"<img src='images/toolbar/tedxt.gif' title='订阅' id='remove_\"+channelId+\"' style='cursor:pointer' onclick='orderRss(\"+channelId+\",\"+categoryId+\")'>\";\r\n       document.getElementById('order_'+channelId).style.display=\"none\";\r\n    }\r\n    \r\n\tfunction addRssChannel(){\r\n\t  var url=\"");
      out.print(request.getContextPath());
      out.write("/rssCategoryChannel.do?method=goProAddRssChannel\";\r\n\t   //jumpMain(url);\r\n\t  JSMainWinOpenNew(url,\"新增RSS频道\",'menubar=0,scrollbars=0,left='+wleft+',top='+wtop+',width=790,height=580,resizable=no'); \r\n\t}\r\n\t\r\n\tfunction goRssCategoryList(){\r\n\t  var url=\"");
      out.print(request.getContextPath());
      out.write("/rssCategory.do?method=goRssCategoryList\";\r\n\t   jumpMain(url);\r\n\t}\r\n\t\r\n\tfunction modify(channelId){\r\n\t   var url=\"");
      out.print(request.getContextPath());
      out.write("/rssCategoryChannel.do?method=proModRssChannel&channelId=\"+channelId;\r\n\t   JSMainWinOpenNew(url,\"修改Rss频道\",'menubar=0,scrollbars=0,left='+wleft+',top='+wtop+',width=450,height=250,resizable=no');\r\n\t}\r\n\t\t\r\n\t\r\n   function delSingle(id){\r\n\t channelForm.action='");
      out.print(webapp);
      out.write("'+\"/rssCategoryChannel.do?method=delRssChannel&delType=single&channelId=\"+id;\r\n\tif(confirm(\"确任要删除吗？\")){\r\n        channelForm.submit();\r\n        return true;\r\n    }else{\r\n        return false;\r\n    }\r\n }\r\n \r\n  function delX(){\r\n     var ids=getCheckBoxID();\r\n\t channelForm.action='");
      out.print(webapp);
      out.write("'+\"/rssCategoryChannel.do?method=delRssChannel&delType=single&channelIds=\"+ids;\r\n\t if(ids==null||ids==''){\r\n\t   alert('请选择要删除的记录！');\r\n\t    return false;\r\n     }else{\r\n\t\t if(confirm(\"确任要删除吗？\")){\r\n\t             channelForm.submit();\r\n\t             return true;\r\n\t     }else{\r\n\t\t\t   return false;\r\n\t\t }\r\n\t  }\r\n }\r\n \r\n function delAll(){\r\n  channelForm.action='");
      out.print(webapp);
      out.write("'+\"/rssCategoryChannel.do?method=delRssChannel&delType=all\";\r\n  var obj=document.getElementsByName('batchDel');\r\n if(obj.length>0){\r\n  if(confirm(\"确任要清空吗？\")){\r\n       channelForm.submit();\r\n       return true;\r\n    }else{\r\n\t   return false;\r\n  }\r\n }else{\r\n   alert('无操作数据！');\r\n   return false;\r\n }\r\n }\r\n\r\n function getCheckBoxID() {\r\n    var strCheckBox = \"\" ;\r\n    var k=0;\r\n    for(var i = 0 ; i < document.all.channelForm.length ; i++ ) {\r\n      var obj = document.all.channelForm[i] ;\r\n      if(obj.type == \"checkbox\"  && obj.name==\"batchDel\"){\r\n\t\tif(obj.checked) {\r\n             \tk++;\r\n                strCheckBox += obj.value  ;\r\n                strCheckBox += \",\" ;\r\n\t\t }\r\n      }\r\n    }\r\n    return strCheckBox ;\r\n}\r\n\r\n\t function selectAllItem(){\r\n\t    var result=document.all.selectAll.checked;\r\n\t    if(document.all.batchDel){\r\n\t        if(isNaN(document.all.batchDel.length)){\r\n\t            document.all.batchDel.checked=result;\r\n\t        }else{\r\n\t            for(var i=0;i<document.all.batchDel.length;i++){\r\n\t                document.all.batchDel[i].checked=result;\r\n");
