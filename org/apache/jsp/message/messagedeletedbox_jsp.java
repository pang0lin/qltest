...
public final class messagedeletedbox_jsp extends org.apache.jasper.runtime.HttpJspBase
...
response.setDateHeader ("Expires", 0);
      ...
      out.write("\r\n<body leftmargin=\"0\" topmargin=\"0\" >\r\n<body  class=\"MainFrameBox\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n  <tr>\r\n    <td align=\"right\" nowrap>\r\n\t<button class=\"btnButton4Font\" onclick=\"delQuiteReceive()\">彻底删除</button>\r\n\t<button class=\"btnButton4Font\" onclick=\"delAllReceive()\">彻底清空</button></td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n<form name=\"form1\" action=\"\" method=\"post\">\r\n<TBODY>\r\n\t<tr align=middle bgcolor=\"bbc0c3\">\r\n\t\t<td width=\"2%\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n\t\t<td width=\"12%\" class=\"listTableHead\">收信人/发信人</td>\r\n\t\t<td class=\"listTableHead\">内容</td>\r\n\t\t<td width=\"20%\" class=\"listTableHead\">发送时间</td>\r\n\t\t<td width=\"20%\" class=\"listTableHeadLast\">接收时间</td>\r\n\t</tr>\r\n");
	...
	if(request.getParameter("pager.offset")!=null){
      ...
      try {
        ...
        // /message/messagedeletedbox.jsp(66,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fnotEmpty_005f0.setName("deletedAllList");
        ...
        if (_jspx_eval_logic_005fnotEmpty_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /message/messagedeletedbox.jsp(67,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("desList");
              // /message/messagedeletedbox.jsp(67,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("deletedAllList");
              // /message/messagedeletedbox.jsp(67,1) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(obj[5].toString().equals("系统管理员") ){
                  out.write("\r\n\t\t\t\t\t\t\t\t\t  系统\r\n\t\t\t\t\t\t\t\t\t  ");
}else if((obj[1] != null && obj[5] == null) || (obj[1] == null && obj[5] != null) ){
                  out.write("\r\n\t\t\t\t\t\t\t\t\t 　外发\r\n\t\t\t\t\t\t\t\t\t  ");
}else if(obj[1] != null && obj[5] != null){
                  out.write("\r\n                                      ");
                  out.print(obj[1]);
                  out.write("\r\n\t\t\t\t\t\t\t\t\t  ");
}
