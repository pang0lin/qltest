...
public final class wapClassList_005f3g_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String fan="";
	List list=(List)request.getAttribute("linkClass");
	...
	if("".equals(id)){
		fan=path+"/wap/action/WapContactAction.do?action=addLinkMan&beginIndex="+beginIndex+"&type="+type;
	}else{
	fan=path+"/wap/action/WapContactAction.do?action=addLinkMan&modity=y&beginIndex="+beginIndex+"&linkManId="+id+"&type="+type;
		//fan=path+"/wap/action/WapContactAction.do?action=linkMan&beginIndex="+beginIndex+"&id="+id+"&type="+type;
	}

      out.write("\r\n<HTML xmlns=\"http://www.w3.org/1999/xhtml\">\r\n<HEAD>\r\n<TITLE>分类管理-移动办公系统</TITLE>\r\n<META content=\"text/html; charset=UTF-8\" http-equiv=Content-Type>\r\n<META name=viewport content=\"width=device-width; initial-scale=1.0; maximum-scale=1.0; user-scalable=0;\">\r\n<META name=apple-touch-fullscreen content=YES>\r\n<META name=apple-mobile-web-app-capable content=no>\r\n<LINK rel=apple-touch-icon href=\"");
      out.print(path);
      ...
      out.print(fan );
      out.write("\">返回</A></DIV></SPAN>\r\n           <SPAN id=title>分类管理</SPAN>\r\n           <A class=btn_1 href=\"");
      out.print(path);
      out.write("/wap2/contact/wapClassMore_3g.jsp?type=");
      out.print(type );
      out.write("&id=");
      out.print(id );
      out.write("\">新增</A>\r\n       </DIV>\r\n       <DIV class=height2></DIV>\r\n       ");
for(int i=0;i<list.size();i++){ 
        PersonClassPO personClassPO=(PersonClassPO)list.get(i);  
      out.write("\r\n\t\t<DIV class=lista1>\r\n         <DIV class=l1>\r\n            <A class=listing href=\"");
      out.print(path );
      out.write("/wap/action/WapContactAction.do?action=classListMore&id=");
      out.print(id );
      out.write("&type=");
      out.print(type );
      out.write("&classId=");
      out.print(personClassPO.getId() );
      out.write("&beginIndex=");
      out.print(beginIndex );
      out.write("\">分类：");
      out.print(personClassPO.getClassName() );
      out.write("&nbsp;</A>\r\n         </DIV>\r\n         <SPAN>");
      out.print("描述："+personClassPO.getClassDescribe() );
      out.write("&nbsp;</SPAN>\r\n       </DIV>\r\n");
}
	...
	if(contactCount>WapUtil.LIMITED){
		if(upIndex>=0)upUrl=path+"/wap/action/WapContactAction.do?action=classList&id="+id+"&beginIndex="+upIndex+"&type="+type;
		if(nextIndex<contactCount)nextUrl=path+"/wap/action/WapContactAction.do?action=classList&id="+id+"&beginIndex="+nextIndex+"&type="+type;
      out.write("\r\n\t\t <DIV class=page>\r\n       ");
if(upUrl.indexOf("#")<0){
