...
public final class kq_005fsigntime_005fset_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String local = session.getAttribute("org.apache.struts.action.LOCALE").toString();
 ...
 String offset="";
   ...
   kqSigntimePO=(KqSigntimePO)request.getAttribute("kqSigntimePO");
    ...
    signid=new Long(kqSigntimePO.getId()).toString();
     offset=new Long(kqSigntimePO.getOffset()).toString();
   }
 String offsetid="";
 String offsettime="";
   ...
   kqOffsetPO=(KqOffsetPO)request.getAttribute("kqOffsetPO");
...
offsetid=new Long(kqOffsetPO.getId()).toString();
offsettime=new Long(kqOffsetPO.getOffsetTime()).toString();
}
            ...
            out.print(offsetid);
            out.write("\" />\r\n             <input  type=\"text\" name=\"offsettime\" id=\"offsettime\"  value=\"");
            out.print(offsettime);
            out.write("\" />&nbsp;分钟   \r\n          </td>\r\n\t\t</tr>\r\n\t\t\r\n                <tr>\r\n                    <td height=\"20\">&nbsp;</td>\r\n                </tr>\r\n\t\t\r\n\t</table>\r\n\t</form>\r\n\t<table>\r\n\t\t<tr>\r\n\t\t\t<td colspan=\"2\">\r\n\t\t\t\t<button class=\"btnButton2font\" onclick=\"set();\">");
            if (_jspx_meth_bean_005fmessage_005f0(_jspx_th_html_005fhtml_005f0, _jspx_page_context))
              return;
            out.write("</button>\t\r\n\t\t\t\t\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\t</table>\r\n</tr>\r\n</table>\r\n</td></tr></table>\r\n</body>\r\n\r\n<script language=\"javascript\">\r\n\r\nfunction set() {\r\n \r\n \r\n if(document.getElementById(\"offset\").value.search(\"^-?\\\\d+$\")!=0){\r\n        alert(\"打卡时间请输入一个整数!\");\r\n        return false;\r\n    }\r\n\r\n if(document.getElementById(\"offsettime\").value.search(\"^-?\\\\d+$\")!=0){\r\n        alert(\"善意迟到请输入一个整数!\");\r\n        return false;\r\n    }\r\n  form1.submit();\r\n}\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+cURL;\r\n}\r\n\r\n</script>\r\n");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /kq/kq_signtime_set.jsp(172,52) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("personalwork");
      // /kq/kq_signtime_set.jsp(172,52) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
