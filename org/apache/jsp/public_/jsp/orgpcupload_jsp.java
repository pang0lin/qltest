 ...
 * Generated at: 2023-01-06 09:58:12 UTC
...
public final class orgpcupload_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  if(mode.equals("add")){
	...
	for (int j=0;j<fileList.size();j++)
	{
		...
		if(!fileItem.isFormField())//如果是<input type="file">
		{
    		...
    		{
    			if(fileNameTemp.endsWith(banType[i]) || fileNameTemp.indexOf(".")<0)
   				{
   					fileItem.delete();
