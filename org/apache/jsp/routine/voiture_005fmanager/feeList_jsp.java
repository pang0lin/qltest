...
public final class feeList_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\t<form  action=\"/VoitureFeeAction.do\"  name=\"form1\" method=\"post\">\r\n\t\t<tr align=\"center\">\r\n\t\t\t<td width=\"8%\" class=\"listTableHead\"> 车牌号 </td>\r\n\t\t\t<td width=\"16%\"  class=\"listTableHead\"> 型号 </td>\r\n\t\t\t<td width=\"25%\" class=\"listTableHead\"> 名称 </td>\r\n\t\t\t<td width=\"15%\" class=\"listTableHead\"> 司机 </td>\r\n\t\t\t<td width=\"10%\" class=\"listTableHead\"> 上次费用日期 </td>\r\n\t\t\t<td width=\"8%\" class=\"listTableHeadLast\" nowrap> 处理 </td>\r\n\t\t</tr>\r\n\t\t</tr>\r\n\t\t");
            ...
            try {
              ...
              // /routine/voiture_manager/feeList.jsp(78,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("voitureFeeList");
              // /routine/voiture_manager/feeList.jsp(78,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("voitureFeeList");
              // /routine/voiture_manager/feeList.jsp(78,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setScope("request");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object voitureFeeList = null;
                ...
                voitureFeeList = (java.lang.Object) _jspx_page_context.findAttribute("voitureFeeList");
                do {
                  out.write("\r\n\t\t");

			Object[] obj = (Object[])voitureFeeList;
		
                  out.write("\r\n\t\t");

			listorder=listorder+1;
			if(obj[0]!=null){
			voitureId=obj[0].toString();
			if(obj[1]!=null)
			num=obj[1].toString();
			if(obj[2]!=null)
			model=obj[2].toString();
			if(obj[3]!=null)
			name=obj[3].toString();
			if(obj[4]!=null)
			motorman=obj[4].toString();
			if(obj[5]!=null){
			maintainTime=obj[5].toString();
...
if(listorder%2 != 0){listClass="listTableLine2";}
                  ...
                  out.write("&nbsp; </td>\r\n\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\"><div align=\"left\"><img  style=\"cursor:pointer\" border=\"0\" src=\"images/clfy.gif\" alt=\"车辆费用\" onclick=\"detailFee('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n<!-- PAGER -->\r\n\r\n</td></tr></table>\r\n\r\n\r\n</body>\r\n<script language=\"javascript\">\r\n//车辆费用\r\nfunction detailFee(id,name,num){\r\nwindow.location.href=\"/jsoa/VoitureFeeAction.do?action=listDetail&voitureId=\"+id+\r\n\t \"&name=\"+(encodeURI(encodeURI(name)))+\"&num=\"+(encodeURI(encodeURI(num)));\r\n}\r\n//添加\r\nfunction add() {\r\n    var hhref  = \"/jsoa/VoitureFeeAction.do?action=addwindow\" ;\r\n     MM_openBrWindow(hhref,\"\",\"TOP=0,LEFT=0,scrollbars=no,resizable=no,width=570,height=390\") ;\r\n}\r\n\r\nfunction modify(id){\r\n\tMM_openBrWindow('LibraryAction.do?action=modify&libraryId='+id,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=670,height=390')\r\n}\r\n\r\nfunction delBatch() {\r\n    var strId=getCheckBoxID();\r\n        if(strId!=\"\"){\r\n     if(confirm(\"确实要删除吗？\")){\r\n     \twindow.location.href=\"/jsoa/LibraryAction.do?action=delBatch&ids=\" + getCheckBoxID()+\"&pager.offset=");
            out.print(nowPage);
            out.write("\" ;\r\n    }\r\n    }else{\r\n             alert(\"请选择要删除的记录!\");\r\n             return;\r\n         }\r\n}\r\n\r\nfunction del(id){\r\n    if(confirm(\"确实要删除吗？\")){\r\n      window.location.href=\"/jsoa/LibraryAction.do?action=delLibrary&libraryId=\"+id+\"&pager.offset=");
            out.print(nowPage );
