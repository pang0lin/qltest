 ...
 * Generated at: 2023-01-06 09:45:04 UTC
...
public final class pro_005fmore_005fforum_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String subClass=request.getAttribute("classId").toString();
String queryClass=allClass.equals("none")?subClass:allClass;
String proId=request.getAttribute("proId").toString();
...
String promanagerIds=(String)request.getAttribute("promanagerIds");
      ...
      out.write(")&nbsp;&nbsp;&nbsp;负责人：<a href=\"javascript:void(0);\" onclick=\"JSMainWinOpen2('/jsoa/chat/chatForProject.jsp?id=");
      out.print(promanagerIds);
      out.write("','','',445,283)\" title=\"给负责人发消息\">");
...
if(projectId_!=null){
      ...
      out.write("\r\n\t</td>\r\n  </tr>\r\n</table>\r\n<table width=\"100%\" height=\"25\"  border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"background:url(/jsoa/images/bg_td.gif); border:1px solid #a9a9a9;table-layout:fixed;\">\r\n <tr>\r\n ");
      ...
      out.print(poclassmm.getClassName() );
...
if(classId != null && !"".equals(classId)){
      ...
      out.write("\r\n\t\t               &nbsp;版主：\r\n\t\t              ");
		                  ...
		                  for(int j=0;j<empSimpleName.length;j++){
		                  
		                     String empname = empSimpleName[j].substring(empSimpleName[j].indexOf("<")+1,empSimpleName[j].indexOf("/"));
		              
      out.write("\r\n\t\t                    <a href=\"javascript:void(0);\" onclick=\"openEmalPage('");
      out.print(empSimpleName[j]);
      out.write("')\" title=\"版主信箱\">\r\n\t\t                   ");
      out.print(empname);
      out.write("\r\n\t\t                   </a>&nbsp;");
}
      out.write("\r\n\t\t             ");
...
if("1".equals(userRoll)){
      out.write("\r\n                    <td align=\"right\" id=\"isShow\" valign=\"middle\" nowrap=\"nowrap\">\r\n                      \r\n                     \r\n                       ");

                       if("1".equals(addBulletinRight)&&!("1".equals(classHasJunior))) {
                       
      out.write("\r\n                        <a style=\"cursor:pointer;\" class=\"button\" onClick=\"guanli('/jsoa/ForumAction.do?action=shenchalist&classId=");
      out.print(poclassmm.getId());
      out.write("')\" ><span><img src=\"/jsoa/images/shencha.gif\"  align=\"absmiddle\"/>&nbsp;帖子审查</span></a>\r\n                        <a style=\"cursor:pointer;\" class=\"button\" onClick=\"add('bulletin')\"><span><img src=\"/jsoa/images/sendgonggao.gif\" align=\"absmiddle\" />&nbsp;新增公告</span></a>\r\n\r\n                       ");
}
      out.write("\r\n                        ");

                       if(!("1".equals(classHasJunior))) {
                       
      out.write("\r\n                      <a style=\"cursor:pointer;\" class=\"button\" onClick=\"add('forum')\"><span><img src=\"/jsoa/images/sendtiezi.gif\" border=\"0\" align=\"absmiddle\" />&nbsp;发表贴子</span></a>\r\n                       ");
}
      out.write("\r\n                      \r\n                     </td>\r\n                     ");
} 
      ...
      if (_jspx_meth_bean_005fmessage_005f3(_jspx_page_context))
        return;
      out.write("</td>\r\n                      <td width=\"14%\" class=\"border_leftbottom\" >");
...
if("1".equals(addBulletinRight)&&!("1".equals(classHasJunior))){
      ...
      out.write(" nowrap class=\"border_leftbottom\" >");
      ...
      try {
        ...
        // /relproject/pro_more_forum.jsp(209,0) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("list");
        // /relproject/pro_more_forum.jsp(209,0) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("list");
        // /relproject/pro_more_forum.jsp(209,0) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        isnew=true;
		   ...
		   if(curUserId.equals(forumAuthorId))
            ...
            out.write("\r\n\r\n                    <tr >\r\n\t\t\t\t\t\r\n                      <td  class=\"");
            out.print(listClass);
            out.write("\"  style=\"padding:0px;padding-left:3px;\" >\r\n                       \r\n                        ");
...
java.util.Locale.setDefault(java.util.Locale.CHINA);
            out.write("\r\n                      <td class=\"");
            out.print(listClass);
            out.write(" listTableLineLastTD\"  nowrap style=\"padding:0px;padding-left:3px;\">\r\n                      ");
if("1".equals(isOwner)  && "0".equals(forumNotUpd)){
            out.write("&nbsp;<img style=\"cursor:pointer\" src=\"/jsoa/images/modi.gif\" alt=\"");
...
if("1".equals(addBulletinRight)){
            out.write("&nbsp;<img style=\"cursor:pointer\" src=\"/jsoa/images/del.gif\" alt=\"");
...
if("1".equals(forumIsSoul)&&!"2".equals(forumType)) {
            out.write("&nbsp;<img style=\"cursor:pointer\" src=\"/jsoa/images/canclegood.gif\" alt=\"");
            ...
            out.write("&nbsp;<img style=\"cursor:pointer\" src=\"/jsoa/images/addgood.gif\" alt=\"");
            ...
            out.write("&nbsp;<img style=\"cursor:pointer\" src=\"/jsoa/images/upsort1.gif\" alt=\"置顶\" onClick=\"setTop('1','");
            out.print(obj[0]);
            out.write('\'');
            out.write(',');
            out.write('\'');
...
if(0!=Integer.valueOf(obj[23].toString())){ 
            out.write("&nbsp;<img style=\"cursor:'hand'\" src=\"/jsoa/images/upsort2.gif\" alt=\"取消置顶\" onClick=\"setTop('0','");
            out.print(obj[0]);
            out.write('\'');
            out.write(',');
            out.write('\'');
...
if("1".equals(forumNotPrint)){
            out.write("&nbsp;<img style=\"cursor:pointer\" src=\"/jsoa/bbs/images/allowprint.gif\" alt=\"允许拷贝\" onClick=\"setAuth('print','0','");
            out.print(obj[0]);
            out.write('\'');
            out.write(',');
            out.write('\'');
            ...
            out.write("&nbsp;<img style=\"cursor:pointer\" src=\"/jsoa/bbs/images/notprint.gif\" alt=\"禁止拷贝\" onClick=\"setAuth('print','1','");
            out.print(obj[0]);
            out.write('\'');
            out.write(',');
            out.write('\'');
...
if("1".equals(forumNotUpd)){
            out.write("&nbsp;<img style=\"cursor:pointer\" src=\"/jsoa/bbs/images/allowupd.gif\" alt=\"允许修改\" onClick=\"setAuth('upd','0','");
            out.print(obj[0]);
            out.write('\'');
            out.write(',');
            out.write('\'');
            ...
            out.write("&nbsp;<img style=\"cursor:pointer\" src=\"/jsoa/bbs/images/notupd.gif\" alt=\"禁止修改\" onClick=\"setAuth('upd','1','");
            out.print(obj[0]);
            out.write('\'');
            out.write(',');
            out.write('\'');
...
if("1".equals(forumNotFlow)){
            out.write("&nbsp;<img style=\"cursor:pointer\" src=\"/jsoa/bbs/images/allowflow.gif\" alt=\"允许跟帖\" onClick=\"setAuth('flow','0','");
            out.print(obj[0]);
            out.write('\'');
            out.write(',');
            out.write('\'');
            ...
            out.write("&nbsp;<img style=\"cursor:pointer\" src=\"/jsoa/bbs/images/notflow.gif\" alt=\"禁止跟帖\" onClick=\"setAuth('flow','1','");
            out.print(obj[0]);
            out.write('\'');
            out.write(',');
            out.write('\'');
...
String pagerURL = "/jsoa/RelProjectClassAction.do";
      out.write("\r\n\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /relproject/pro_more_forum.jsp(202,104) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("bbs");
      // /relproject/pro_more_forum.jsp(202,104) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /relproject/pro_more_forum.jsp(203,65) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("bbs");
      // /relproject/pro_more_forum.jsp(203,65) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /relproject/pro_more_forum.jsp(204,63) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setBundle("bbs");
      // /relproject/pro_more_forum.jsp(204,63) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /relproject/pro_more_forum.jsp(205,63) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setBundle("bbs");
      // /relproject/pro_more_forum.jsp(205,63) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /relproject/pro_more_forum.jsp(206,65) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setBundle("bbs");
      // /relproject/pro_more_forum.jsp(206,65) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f5(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /relproject/pro_more_forum.jsp(207,152) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f5.setBundle("common");
      // /relproject/pro_more_forum.jsp(207,152) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
