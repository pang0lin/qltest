...
public final class subsidiarywork_005flookinto_005fUserList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String read=request.getParameter("read");
	...
	if(request.getAttribute("maxPageItems") !=null){
      ...
      out.write("\r\n<table width=\"100%\">\r\n    <tr>\r\n        <td>\r\n            <form name=\"form1\" method=\"POST\" action=\"/jsoa/LookIntoAction.do?action=viewbrowserUser&surveyId=");
      ...
      out.write("\">\r\n\t\t\t<button class=\"btnButton2font\" onclick=\"form1.submit();\">查询</button>\r\n\t\t    <button class=\"btnButton2font\" onclick=\"window.location.href='/jsoa/LookIntoAction.do?action=viewbrowserUser&surveyId=");
      out.print(request.getParameter("surveyId"));
      out.write("&read=");
      out.print(read);
...
if("1".equals(read)){
      ...
      out.print(obj[3]!=null?new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format((Date)obj[3]):"");
      out.write('"');
      out.write('>');
      out.print(obj[0]);
      out.write("</a>");
