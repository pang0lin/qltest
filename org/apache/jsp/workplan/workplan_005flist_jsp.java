 ...
 * Generated at: 2023-01-06 09:42:07 UTC
...
public final class workplan_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(startDate==null || startDate.equals("null")){
	...
	startDateTemp=DateHelper.string2Date(startDate, "yyyy/MM/dd");
}
if(startDate==null || startDate.equals("null")){
	endDateTemp=new Date();
}else{
	endDateTemp=DateHelper.string2Date(endDate, "yyyy/MM/dd");
}

Date nowDate=new Date();
boolean isManager=false;
if(request.getAttribute("isManager")!=null && "1".equals(request.getAttribute("isManager").toString())){
	isManager=true;
}
...
if("1".equals(searchDate)){out.print("checked");}
		...
		boolean canUpdate=false;
            ...
            try {
              ...
              // /workplan/workplan_list.jsp(135,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("workplanList");
              // /workplan/workplan_list.jsp(135,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("workplanList");
              // /workplan/workplan_list.jsp(135,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setScope("request");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object workplanList = null;
                ...
                workplanList = (java.lang.Object) _jspx_page_context.findAttribute("workplanList");
                do {
                  out.write("\r\n\t\t\t");

			obj = (Object[]) workplanList;
			workDate=obj[4]==null?"":obj[4].toString();
			if(workDate.indexOf(" ")>0){
				workDate=workDate.substring(0,workDate.indexOf(" "));
			}
			beforDate=DateHelper.beforDate(nowDate);
			tempDate=DateHelper.string2Date(workDate);
			//tempDate.before(nowDate)
			if(beforDate.after(tempDate)){
				canUpdate=false;
			}else{
				canUpdate=true;
			}
...
if(index%2 == 0){
                  ...
                  out.write(">\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\" align=\"left\">\t\t\t\t\r\n\t\t\t\t<input type=\"checkbox\" id=\"workplanId\" name=\"workplanId\" value=\"");
                  out.print(obj[0]);
                  out.write('"');
                  out.write(' ');
if(!canUpdate && !isManager){out.print("disabled=true");}
                  out.write(">\r\n\t\t\t\t</td>\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\" align=\"left\">");
