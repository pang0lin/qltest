...
public final class archivesClass_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    String modiArchivesClassIds = "0";
	if(request.getAttribute("modiArchivesClassIds") !=null){
		modiArchivesClassIds = request.getAttribute("modiArchivesClassIds").toString();
	}
    ...
    if(request.getAttribute("maxPageItems") !=null){
    	pageSize = Integer.parseInt(request.getAttribute("maxPageItems").toString());
            ...
            try {
              ...
              // /archives/archivesClass.jsp(85,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /archives/archivesClass.jsp(85,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  out.write("\r\n\t\t\t\t");
					...
					ArchivesClassVO archivesClassVO = (ArchivesClassVO)List;
					String classId = archivesClassVO.getClassId().toString();
                                        Integer level = archivesClassVO.getClassLevel();
                                        String space = "";
                                        for (int i = 2; i < level.intValue(); i++) {
                                            space += "&nbsp;&nbsp;";
                                        }
					j ++;
					index ++;
                  ...
                  out.write('"');
                  out.write(' ');
if(modiArchivesClassIds.indexOf(classId)<0){
                  out.write("disabled");
}
                  out.write("></td>\r\n\t\t\t<td class=\"");
                  out.print(listClass);
                  ...
                  out.write("</td>\r\n\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\" nowrap><div align=\"left\">\r\n\t\t\t");
if(modiArchivesClassIds.indexOf(classId)>=0){
...
String pagerURL = "/jsoa/archivesClassAction.do";
            out.write('\r');
            out.write('\n');
            out.write('	');
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("</td>\r\n\t</td>\r\n  </tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction load(){\r\n    var canDelete = document.all.canDelete.value;\r\n    if(canDelete ==\"No\"){\r\n        alert(\"您选择档案分类不能被删除！（ 提示：选择的记录中可能含有子分类或案卷记录 ）\");\r\n         window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/archivesClassAction.do?action=viewArchivesClass\";\r\n    }\r\n\r\n    }\r\n\r\nfunction getCheckBoxID() {\r\n    var strCheckBox = \"\" ;\r\n    for(var i = 0 ; i < document.all.form1.length ; i++ ) {\r\n        var obj = document.all.form1[i] ;\r\n         if(obj.type == \"checkbox\" && obj.name==\"batchDel\"){\r\n\t\tif(obj.checked) {\r\n                \tstrCheckBox += obj.value  ;\r\n                    \tstrCheckBox += \",\" ;\r\n\t\t}\r\n         }\r\n    }\r\n    return strCheckBox ;\r\n}\r\nfunction modify(id){\r\n\tJSMainWinOpen('archivesClassAction.do?action=viewUpdateArchivesClass&classId='+id+'&pager.offset=");
            out.print(pageSize2);
            out.write("','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=230')\r\n}\r\nfunction del(id){\r\n    if(confirm(\"确实要删除吗？\")){\r\n");
 int deloff = j==1?pageSize2-15:pageSize2;
   if(deloff<0) deloff= 0;
 
            out.write("\r\n        window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/archivesClassAction.do?action=deleteArchivesClass&classId=\"+id+\"&pager.offset=");
            out.print(deloff);
            out.write("\";\r\n    }\r\n}\r\nfunction delBatch() {\r\n    var strId=getCheckBoxID();\r\n        if(strId!=\"\"){\r\n     if(confirm(\"确实要删除吗？\")){\r\n     \twindow.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/archivesClassAction.do?action=deleteBatchArchivesClass&ids=\" + getCheckBoxID() ;\r\n    }\r\n    }else{\r\n             alert(\"请选择要删除的记录!\");\r\n             return;\r\n         }\r\n}\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            if(document.all.batchDel.disabled ==false){\r\n                document.all.batchDel.checked=result;\r\n\t\t\t\t}\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                if(document.all.batchDel[i].disabled ==false){\r\n                document.all.batchDel[i].checked=result;\r\n\t\t\t\t}\r\n            }\r\n        }\r\n    }\r\n}\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\n//-->\r\n</script>\r\n");
  ...
  private boolean _jspx_meth_bean_005fwrite_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /archives/archivesClass.jsp(104,76) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f0.setName("List");
      // /archives/archivesClass.jsp(104,76) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f0.setProperty("classId");
      // /archives/archivesClass.jsp(104,76) name = format type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fwrite_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /archives/archivesClass.jsp(105,40) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f1.setName("List");
      // /archives/archivesClass.jsp(105,40) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fwrite_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /archives/archivesClass.jsp(106,30) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f2.setName("List");
      // /archives/archivesClass.jsp(106,30) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f2.setProperty("classReadName");
  ...
  private boolean _jspx_meth_bean_005fwrite_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /archives/archivesClass.jsp(109,88) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f3.setName("List");
      // /archives/archivesClass.jsp(109,88) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f3.setProperty("classId");
      // /archives/archivesClass.jsp(109,88) name = format type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fwrite_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /archives/archivesClass.jsp(109,234) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f4.setName("List");
      // /archives/archivesClass.jsp(109,234) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f4.setProperty("classId");
      // /archives/archivesClass.jsp(109,234) name = format type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
