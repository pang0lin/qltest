...
public final class downloadCount2excel_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try{ 	   
	...
	String title = java.net.URLEncoder.encode("下载统计","UTF-8");
    ...
    //创建一个工作表    
    jxl.write.WritableSheet ws = wwb.createSheet("下载统计表", 10);
    ws.setRowView(0, 500);
    ws.setColumnView(0, 15);//设置第一列宽度
    ws.setColumnView(1, 15);//设置倒数第二列宽度
    ...
    for(int j=0;j<dataList.size();j++){
    	...
    	int rowNum = j+1;
    	ws.addCell(new jxl.write.Label(0, rowNum, obj[0].toString(), nwcf));
    	ws.addCell(new jxl.write.Label(1, rowNum, obj[1].toString(), nwcf));
