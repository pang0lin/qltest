 ...
 * Generated at: 2023-01-06 09:50:33 UTC
...
public final class systemmanager_005forganization_005fdepartment_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(departmentNo==null || "null".equals(departmentNo)){
   departmentNo="";
}
if(departmentName==null || "null".equals(departmentName)){
   departmentName="";
}
...
String action = request.getParameter("departmentView");
if(action == null) action = "departmentView";

            out.write("\r\n  \r\n  <body  class=\"MainFrameBox\" >\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n\t<table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\" id=\"searchbar\" style=\"display:none\">\r\n\t  <form name=\"frm\" action=\"/jsoa/OrganizationAction.do\" method=\"get\">\r\n\t  \t<input type=\"hidden\" name=\"action\" value=\"departmentView\">\r\n\t\t<tr>\r\n\t\t  <td width=\"20\" rowspan=\"2\" valign=\"top\"></td>\r\n\t\t  <td width=\"33%\">部门编码：\r\n\t\t\t  <input type=\"text\" class=\"inputtext\" name=\"departmentNo\" size=\"20\" value=\"");
            out.print(departmentNo);
            out.write("\">\r\n\t\t\t</td>\r\n\t\t\t<td width=\"33%\">部门名称：\r\n\t\t\t\t<input type=\"text\" class=\"inputtext\" name=\"departmentName\" size=\"20\" value=\"");
...
String url="/OrganizationAction.do?pager.offset="+indexTmp;
            out.write("\r\n\t\t ");
            //  html:form
            ...
            try {
              ...
              // /setup/systemmanager_organization_department.jsp(76,3) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction(url);
              // /setup/systemmanager_organization_department.jsp(76,3) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.print(action);
                  out.write("\">\r\n\t\t <input type=\"hidden\" name=\"departmentNo\" value=\"");
                  out.print(departmentNo);
                  out.write("\">\r\n\t\t <input type=\"hidden\" name=\"departmentName\" value=\"");
                  out.print(departmentName);
                  out.write("\">\r\n\t\t <input type=\"hidden\" name=\"pager.offset\" value=\"");
                  out.print(indexTmp);
                  out.write("\">\r\n\t\t \r\n\t     <tr align=\"center\">\r\n\t\t\t<td  width=\"5%\" class=\"listTableHead\"><input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n\t\t\t<td class=\"listTableHead\" width=\"15%\">部门编号</td>\r\n\t\t\t<td class=\"listTableHead\" width=\"30%\">部门名称</td>\r\n\t\t\t<td class=\"listTableHead\" width=\"40%\">部门路径</td>\r\n\t\t\t<td class=\"listTableHead\" width=\"10%\">部门状态</td>\r\n\t\t </tr>\r\n\t       ");
			...
			String orgStatus = "";
                  ...
                  try {
                    ...
                    // /setup/systemmanager_organization_department.jsp(95,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("departmentList");
                    // /setup/systemmanager_organization_department.jsp(95,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("departmentList");
                    int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
                    if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      java.lang.Object departmentList = null;
                      ...
                      departmentList = (java.lang.Object) _jspx_page_context.findAttribute("departmentList");
                      do {
                        out.write("\r\n\t\t\t\t");

			    obj = (Object[]) departmentList;
				index ++;
				org_id=Integer.parseInt(obj[0].toString());
				if(index%2 != 0){
				...
				if("0".equals(obj[3].toString())){
					...
					orgStatus = "禁用";
				}else if("4".equals(obj[3].toString())){
					orgStatus = "已删除";
...
String pagerURL = "/jsoa/OrganizationAction.do";
            out.write("\r\n\t ");
