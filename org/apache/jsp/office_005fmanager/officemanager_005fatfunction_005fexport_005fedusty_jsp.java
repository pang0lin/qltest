 ...
 * Generated at: 2023-01-06 10:01:49 UTC
...
public final class officemanager_005fatfunction_005fexport_005fedusty_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.system.vo.usermanager.EdustoryVO");
...
response.setHeader("Content-disposition", "attachment;filename="+new String("教育经历".getBytes("GBK"),"iso8859-1")+".xls");
...
EdustoryVO empVO = null;
    ...
    DateFormat df = DateFormat.getDateInstance(DateFormat.LONG, Locale.CHINESE);
      ...
      try {
        ...
        // /office_manager/officemanager_atfunction_export_edusty.jsp(29,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("empList");
        // /office_manager/officemanager_atfunction_export_edusty.jsp(29,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("empList");
        // /office_manager/officemanager_atfunction_export_edusty.jsp(29,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        orgName = empObj[3]==null?"&nbsp;":empObj[3].toString();
            ...
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
            out.print(empVO.getSchools()==null?"&nbsp;":empVO.getSchools());
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
            out.print(empVO.getSpeciality()==null?"&nbsp;":empVO.getSpeciality());
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
            out.print(empVO.getEducation()==null?"&nbsp;":empVO.getEducation());
            out.write("&nbsp;</td>     \r\n        </tr>\r\n    ");
