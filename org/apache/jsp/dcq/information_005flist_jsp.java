...
public final class information_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  for(int i=0;i<myList.size();i++){
 	...
 	if(index%2 != 0){
 	     ...
 	     listClass="listTableLine1";
            ...
            out.print(listClass);
            out.write("\">\r\n          ");
if(obj[4]!=null&&!"".equals(obj[4]+"")&&"Y".equals(obj[4]+"")){
             out.print("重要");
          }else{
             out.print("不重要");
          } 
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n<input type=\"hidden\" id=\"curId\">\r\n<input type=\"hidden\" id=\"oId\">\r\n<input type=\"hidden\" id=\"sql\" value=\"select announcementTitle,orgID,releasedate from dcq_information where informationId=\">\r\n<input type=\"hidden\" id=\"fields\" value=\"receiveFileTitle,receiveFileSendFileUnit,field18\">\r\n<input type=\"hidden\" id=\"fileType\" value=\"notice\">\r\n</body>\r\n<script language=\"javascript\">\r\nfunction newFlowForm(id,oid){\r\n\tdocument.getElementById(\"curId\").value = id;\r\n\tdocument.getElementById(\"oId\").value = oid;\r\n    MM_openBrWindow(\"/jsoa/GovReceiveFileAction.do?action=see&processId=384&processName=通知公告审批单&processType=1&tableId=50&remindField=\",\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600\");\r\n}\r\n\r\nfunction MM_openBrWindow(theURL,winName,features) { //v2.0\r\n  JSMainWinOpen(theURL,winName,features);\r\n}\r\n//-->\r\n//切换页签\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\n//全选\r\nfunction selectAll(obj){\r\n    if(document.all.batchId){\r\n        if(document.all.batchId.length){\r\n");
