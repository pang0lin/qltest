...
title=com.js.util.util.CharacterTool.unescape(title);
String mark="1";//标记此方法可用：1,不可用：0
Map map=new com.js.oa.jsflow.util.InitWorkFlowData().getClassMethod(mark,request);
String wfWorkId=(String)request.getAttribute("wfWorkId");

CustomFormEJBBean ces = new CustomFormEJBBean();

String haierFileId = "";
haierFileId = (String)request.getAttribute("haierFileId");
System.out.println("---"+session.getAttribute("browserVersion"));
...
if(request.getAttribute("submitFailed") != null){
            ...
            out.write("\">\r\n<input type=\"hidden\" name=\"haierFileId\" id=\"haierFileId\" value=\"");
            out.print(haierFileId);
            out.write("\">\r\n<input type=\"hidden\" name=\"infoDetals\" id=\"infoDetals\" value=\"");
            out.print(request.getParameter("infoDetals"));
...
*/
            ...
            out.write(";\">\r\n\t\t\t      <td colspan=\"2\" align=\"right\">相关项目:\r\n\t\t\t      <select class=\"selectproject\" name=\"relproject\" id=\"relproject\" >\r\n\t\t\t         <option value=\"-1\">==请选择==</option>\r\n\t\t\t         ");
...
if(!"".equals(hide_Field2)){
	String[] ids = hide_Field2.split(",");
	for(String id:ids){
		FieldNames+=ces.getFieldNametById(id);
	}
}
...
if(request.getParameter("fieldId")!=null){
	...
	String fieldName = request.getParameter("fieldName");
            ...
            out.write("\r\n<script src=\"/jsoa/eform/js/bankOfBeijing.js\"></script>\r\n<script type=\"text/javascript\">\r\nbobForm(\"");
            out.print(id );
            out.write('"');
            out.write(',');
            out.write('"');
