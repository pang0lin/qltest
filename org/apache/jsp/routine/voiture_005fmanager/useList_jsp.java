 ...
 * Generated at: 2023-01-06 09:47:54 UTC
...
public final class useList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
com.js.system.manager.service.ManagerService mbd = new com.js.system.manager.service.ManagerService();
 if(mbd.hasRight(userId,"cl-2552-60")){
  voitureFeedBackRight="true";
        ...
        String voitureMtRight = request.getAttribute("voitureMtRight")==null?"":request.getAttribute("voitureMtRight").toString();
        String voitureAddRight = request.getAttribute("voitureAddRight")==null?"":request.getAttribute("voitureAddRight").toString();
        String voitureAdminRight = request.getAttribute("voitureAdminRight")==null?"":request.getAttribute("voitureAdminRight").toString();
        
        String canShList = request.getAttribute("canShList")==null?"":request.getAttribute("canShList").toString();
		String canModifyList = request.getAttribute("canModifyList")==null?"":request.getAttribute("canModifyList").toString();
    java.util.Date searchFillDate=new java.util.Date();
    if(request.getParameter("searchFillDate")!=null){
    	searchFillDate =  new java.util.Date(String.valueOf(request.getParameter("searchFillDate")).replace('-','/') );
    }
    	//java.util.Date today=new java.util.Date();
    int nowDay=searchFillDate.getDate();
    int nowMonth=searchFillDate.getMonth()+1;
    int nowYear=searchFillDate.getYear()+1900;

            out.write('\r');
            out.write('\n');

	String fromDel = request.getParameter("isdel");
	String isDel=request.getAttribute("isDel")==null?"":request.getAttribute("isDel").toString();
        //System.out.println("***************** idDEL: " + isDel);
        if (fromDel != null && fromDel.length() > 0) {
        if(isDel.equals("false") || isDel.length() <= 0){

            out.write("\r\n<script>\r\nalert(\"对不起!您删除的申请记录已经被审核或已经发车!\");\r\n</script>\r\n");
} }
        ...
        pageSize = Integer.parseInt(request.getAttribute("maxPageItems").toString());
            ...
            out.write("\r\n<body class=\"MainFrameBox\" onKeyDown=\"if(event.keyCode==13) search();\">\r\n\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<!-- SEARCH\tPART -->\r\n<table width=\"100%\"\tid=\"searchtable\"  style=\"display:none;\" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n<form name=\"frm1\" action=\"/jsoa/VoitureApplyAction.do\" method=\"post\">\r\n\t<tr>\r\n\t  <td width=\"20\" rowspan=\"5\"></td>\r\n\t  <td>\r\n\t\t   车牌号：&nbsp;\r\n\t\t  <input type=\"text\" onKeyPress=\"return look() ;\" onKeyUp=\"value=checkQuery(this,'车牌号')\" onBlur=\"value=checkQuery1(this,'车牌号')\" name=\"searchNum\" class=\"inputtext\" style=\"width:120px\" size=\"20\" value='");
            out.print(request.getParameter("searchNum")!=null?request.getParameter("searchNum"):"");
            out.write("'>\r\n\t  </td>\r\n\t  <td >\r\n\t\t  申请人：&nbsp;&nbsp;\r\n\t\t  <input type=\"text\" onKeyPress=\"return look() ;\" onKeyUp=\"value=checkQuery(this,'使用人')\" onBlur=\"value=checkQuery1(this,'使用人')\" name=\"searchEmpName\" size=\"20\" style=\"width:120px\" value=\r\n\t\t  '");
            out.print(request.getParameter("searchEmpName")!=null?request.getParameter("searchEmpName"):"");
            out.write("' class=\"inputtext\"/>\r\n\t  </td>\r\n\t  <td>司机：&nbsp;&nbsp;&nbsp;&nbsp;\r\n        <input type=\"text\" onKeyPress=\"return look() ;\" onKeyUp=\"value=checkQuery(this,'司机')\" onBlur=\"value=checkQuery1(this,'司机')\" name=\"searchMotorMan\" class=\"inputtext\" style=\"width:120px\" size=\"20\" value='");
            out.print(request.getParameter("searchMotorMan")!=null?request.getParameter("searchMotorMan"):"");
            out.write("'></td>\r\n\t  <td width=\"16\" rowspan=\"5\"></td>\r\n\t</tr>\r\n\t<tr>\r\n <td colspan=\"1\">\r\n\t\t  状态：&nbsp;&nbsp;&nbsp;\r\n\t\t  ");

		  String searchStatus=request.getParameter("searchStatus")!=null?request.getParameter("searchStatus"):"0";
		  String one=searchStatus.equals("0")?"selected":"";
		  String two=searchStatus.equals("1")?"selected":"";
		  String three=searchStatus.equals("2")?"selected":"";
		  String four=searchStatus.equals("3")?"selected":"";
		  String five=searchStatus.equals("4")?"selected":"";
		  
            out.write("\r\n\t\t  <select name=\"searchStatus\" class=\"inputtext\" style=\"width:120px\">\r\n\t\t\t  <option value=\"0\" ");
            out.print(one);
            ...
            out.print(five);
            out.write(">已取消</option>\r\n\t\t  </select>\r\n\t  </td>\r\n\t  <td>\r\n\t\t  目的地：&nbsp;&nbsp;\r\n\t\t  <input type=\"text\" onKeyPress=\"return look() ;\" onKeyUp=\"value=checkQuery(this,'目的地')\" onBlur=\"value=checkQuery1(this,'目的地')\" name=\"searchDestination\" style=\"width:120px\" class=\"inputtext\" size=\"18\" value='");
            out.print(request.getParameter("searchDestination")!=null?request.getParameter("searchDestination"):"");
            out.write("' >\r\n\t  </td>\r\n\t   <td >填写日期：\r\n\t\t  <script language=\"javascript\">\r\n\t\t  var dtpDate = createDatePicker(\"searchFillDate\",");
            out.print(nowYear);
            out.write(',');
            out.print(nowMonth);
            out.write(',');
...
if ("1".equals(request.getParameter("isDate"))) {
            out.write("checked");
}
            out.write(" style=\"cursor:pointer\">\r\n\t  </td>\r\n\t</tr>\r\n\t<tr>\r\n\t  <td align=\"right\" colspan=\"3\">\r\n\t    <button  class=\"btnButton2Font\" onClick=\"search();\" style=\"cursor:pointer\">查询</button>\r\n\t\t<button  class=\"btnButton2Font\" onClick=\"cleared();return false;\" style=\"cursor:pointer\">重置</button></td>\r\n\t</tr>\r\n  </form>\r\n</table>\r\n<!-- SEARCH\tPART -->\r\n\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<table width=\"100%\"\theight=\"25\"\tborder=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n\t<tr>\r\n\t\t<td align=\"right\">");
if(voitureAddRight.equals("true")||voitureAdminRight.equals("true")){
            out.write("<button  class=\"btnButton2Font\" onClick=\"MM_openBrWindow('VoitureApplyAction.do?flag=useadd','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=800,height=500')\">新增</button>");
}
            out.write("\r\n\t\t");
if(voitureMtRight.equals("true")){
            out.write("<button  class=\"btnButton2Font\" onClick=\"delBatch()\">删除</button>");
}
            out.write("\r\n\t\t<button id=\"hiddenSearch\"  class=\"btnButton4Font\" onClick=\"hidserch()\">查询</button></td>\r\n\t</tr>\r\n</table>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n<form  name=\"VoitureApplyActionForm\" method=\"post\" action=\"/jsoa/VoitureApplyAction.do\">\r\n  <tr align=\"center\">\r\n\t<td width=\"40\" class=\"listTableHead\" nowrap>\r\n\t\t<input type=\"checkbox\" name=\"selectAll\" onClick=\"javascript:selectAllItem();\"></td>\r\n\t<td width=\"12%\" class=\"listTableHead\"> 车牌号 </td>\r\n\t<td width=\"12%\" class=\"listTableHead\"> 司机 </td>\r\n\t<td width=\"12%\" class=\"listTableHead\"> 申请人 </td>\r\n\t<td width=\"12%\" class=\"listTableHead\"> 用车人 </td>\r\n\t<td  class=\"listTableHead\"> 目的地 </td>\r\n\t<td width=\"10%\" class=\"listTableHead\"> 状态 </td>\r\n\t<td width=\"12%\" class=\"listTableHead\"> 填写日期 </td>\r\n\t<td width=\"8%\" class=\"listTableHeadLast\" nowrap=\"nowrap\"> 处理 </td>\r\n  </tr>\r\n\t");
		...
		pageSize2=Integer.parseInt(request.getParameter("pager.offset"));
            ...
            try {
              ...
              // /routine/voiture_manager/useList.jsp(180,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /routine/voiture_manager/useList.jsp(180,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(index%2 != 0){listClass="listTableLine2";}
 ...
 if("true".equals(voitureMtRight)&&(!"3".equals(obj[5]+"")||!"2".equals(obj[5]+"")||!"4".equals(obj[5]+"")||canModifyList.indexOf(","+obj[0].toString()+",")>-1)){
				 ...
				 out.print("&nbsp;");
                  ...
                  out.write("</td>\t\t\t\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"><a href=\"javascript:void(0);\" onClick=\"javascript:modiApply('");
                  out.print(obj[0]);
                  out.write("')\">");
                  out.print(obj[1]);
                  out.write("</a></td>\r\n\t\t\t\t<td class=\"");
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj[4]==null||obj[4]=="null"?"&nbsp;":obj[4]);
                  out.write("&nbsp;</td>\r\n\t\t\t\t");
if ("1".equals(obj[5]+"")){
                  out.write("\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"><b>未审核</b></td>\r\n\t\t\t\t");
}else if ("2".equals(obj[5]+"")){
                  out.write("\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\">进行中</td>\r\n\t\t\t\t");
}else if ("3".equals(obj[5]+"")){
                  out.write("\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\">已完成</td>\r\n\t\t\t\t");
}else if ("4".equals(obj[5]+"")){
                  out.write("\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\">已取消</td>\r\n\t\t\t\t");
}else {
				...
				*/
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(DateFormat.getDateInstance(DateFormat.DEFAULT).format((Date)obj[6]));
                  out.write("</td>\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">&nbsp;\r\n\t\t\t\t");

				if(canShList.indexOf(","+obj[0].toString()+",")>=0){
					if("true".equals(voitureMtRight)&&!"3".equals(obj[5]+"")&&!"2".equals(obj[5]+"")&&!"4".equals(obj[5]+"")&&canModifyList.indexOf(","+obj[0].toString()+",")>-1){
                  out.write("<img src=\"images/del.gif\" title=\"删除\" style=\"cursor:pointer\" onClick=\"del('");
                  out.print(obj[0]);
                  out.write("')\" >");
}
					if(voitureAdminRight.equals("true") && "2".equals(obj[5]+"")){
                  out.write("<img src=\"images/paste.gif\" title=\"录入\" style=\"cursor:pointer\" onClick=\"input('");
                  out.print(obj[0]);
                  out.write("')\" >");
}
					if(voitureAdminRight.equals("true") && "3".equals(obj[5]+"")){
                  out.write("<img src=\"images/paste.gif\" title=\"修改录入\" style=\"cursor:pointer\" onClick=\"modiInput('");
                  out.print(obj[0]);
                  out.write("')\" >");
}
					if(!"4".equals(obj[5]+"")&&!"3".equals(obj[5]+"")&&"true".equals(obj[7]+"")){
                  out.write("<img src=\"images/quash.gif\" title=\"取消\" style=\"cursor:pointer\" onClick=\"cancelApply('");
                  out.print(obj[0]);
                  out.write("')\" >");
}
					if(voitureAdminRight.equals("true")&&!"3".equals(obj[5]+"")){
                  out.write("<img src=\"images/taskreport.gif\" title=\"审核\" style=\"cursor:pointer\" onClick=\"auditingApply('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
                  ...
                  out.write("')\" >");
					...
					if(("true".equals(obj[7]+"")||voitureFeedBackRight.equals("true"))&&"3".equals(obj[5]+"")){
                  out.write("<img src=\"images/wjbl.gif\" title=\"反馈意见\" style=\"cursor:pointer\" onClick=\"feedBack('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
...
String pagerURL = "/jsoa/VoitureApplyAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n<!-- PAGER -->\r\n\r\n</td></tr></table>\r\n</body>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction getCheckBoxID() {\r\n    var strCheckBox = \"\" ;\r\n    var k=0;\r\n    for(var i = 0 ; i < document.all.VoitureApplyActionForm.length ; i++ ) {\r\n        var obj = document.all.VoitureApplyActionForm[i] ;\r\n         if(obj.type == \"checkbox\"  && obj.name==\"batchDel\"){\r\n\t\tif(obj.checked) {\r\n             \tk++;\r\n                \tstrCheckBox += obj.value  ;\r\n                    \tstrCheckBox += \",\" ;\r\n\t\t}\r\n         }\r\n    }\r\n    //document.all.checkboxNumber.value = k;\r\n    return strCheckBox ;\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\nfunction input(id){\r\n\tMM_openBrWindow('VoitureSendAction.do?flag=add&applyId='+id+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=840,height=720');\r\n");
            out.write("}\r\n\r\nfunction modiInput(id){\r\n\tMM_openBrWindow('VoitureSendAction.do?flag=modi&applyId='+id+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=840,height=720');\r\n}\r\n\r\nfunction print(id){\r\n\tMM_openBrWindow('VoitureSendAction.do?flag=print&applyId='+id+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=720,height=520');\r\n}\r\n\r\nfunction modiApply(applyId){\r\n\tMM_openBrWindow('VoitureApplyAction.do?flag=modi&noProc=1&record='+applyId+'&canview=1','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=720,height=400');\r\n}\r\n\r\nfunction cancelApply(applyId){\r\n\tMM_openBrWindow('VoitureCancelAction.do?flag=add&applyId='+applyId+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=720,height=300');\r\n}\r\n\r\nfunction auditingApply(applyId,voitureNum){\r\n\tMM_openBrWindow('VoitureAuditingAction.do?flag=add&voitureNum='+voitureNum+'&applyId='+applyId+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=720,height=400');\r\n}\r\n\r\n\r\nfunction del(id){\r\n ");

  int deloff = j==1?pageSize2-15:pageSize2;
  if(deloff<0) deloff = 0 ;
 
            out.write("\r\n    if(confirm(\"确实要删除这条记录吗？\")){\r\n    window.location.href=\"/jsoa/VoitureApplyAction.do?flag=del&delId=\"+id+\",\"+ \"&pager.offset=");
            out.print(deloff);
            out.write("\" + \"&isdel=true\";\r\n    }\r\n}\r\n\r\nfunction delBatch() {\r\n     if(getCheckBoxID()==\"\"){\r\n    \talert(\"请选择要删除的记录!\");\r\n             return;\r\n        }\r\n   else\tif(confirm(\"确实要删除这些记录吗？\")){\r\n         window.location.href=\"/jsoa/VoitureApplyAction.do?flag=del&delId=\" + getCheckBoxID();\r\n     }\r\n}\r\n\r\n\r\nfunction search(){\r\n    frm1.action=\"VoitureApplyAction.do?flag=search\";\r\n    frm1.submit();\r\n}\r\n\r\nfunction cleared(){\r\n   window.location.href = \"/jsoa/VoitureApplyAction.do?flag=useview\" ;\r\n}\r\nfunction feedBack(vId,ismy){\r\n\r\n  MM_openBrWindow('VoitureSendAction.do?flag=feedBack&voitureId='+vId+'&ismy='+ismy,'','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=600,height=300');\r\n}\r\nfunction hidserch()\r\n{\r\n     var stable=document.getElementById(\"searchtable\");\r\n     var sbutton=document.getElementById(\"hiddenSearch\");\r\n     if(stable.style.display==\"none\")\r\n     {\r\n      stable.style.display=\"\";\r\n      hiddenSearch.innerHTML=\"关闭查询\";\r\n      \r\n     }else{\r\n     \r\n     stable.style.display=\"none\";\r\n     hiddenSearch.innerHTML=\"查询\";\r\n");
            out.write("     \r\n     }\r\n}\r\n//-->\r\n</script>\r\n\r\n");
