...
public final class jsflow_005foftenlist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String desktopID=request.getAttribute("desktopID")==null?"":request.getAttribute("desktopID").toString();
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("  <tr>\r\n   \r\n    <td align=\"right\" nowrap>\r\n        <button class=\"btnButton2font\" onclick=\"javascript:setOftenIDS(1);\">设为常用</button>\r\n        <button class=\"btnButton2font\" onclick=\"javascript:setOftenIDS(0);\">取消常用</button>         \r\n\t </td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n              <tr>\r\n                  <td width=\"40\" nowrap class=\"listTableHead\">\r\n                      <input type=\"checkbox\" value=\"1\" onclick=\"selectAll(this);\">\r\n                  </td>\r\n                  <td class=\"listTableHead\">流程名称</td>\r\n                  <td width=\"15%\" class=\"listTableHead\">流程分类</td>\r\n                  <td width=\"8%\" nowrap class=\"listTableHeadLast\">操作</td>\r\n                </tr>\r\n                      \r\n                      ");
            ...
            try {
              ...
              // /jsflow/jsflow_oftenlist.jsp(63,22) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("workList");
              // /jsflow/jsflow_oftenlist.jsp(63,22) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  out.write(" listTableLineLastTD\">\r\n                              ");
                              ...
                              if(desktopID.indexOf(","+obj[2].toString()+",")>=0){
                            	  //已经在桌面显示
                            	  
                  out.write("\r\n                            \t  <img style=\"cursor:pointer\" src=\"images/desk_show.gif\" title=\"取消常用\" onclick=\"setOften('");
                  out.print(obj[2]);
                  out.write("',0);\">\r\n                            \t  ");

                              }else{
                            	  
                  out.write("\r\n                            \t  <img style=\"cursor:pointer\" src=\"images/desk_notshow.gif\" title=\"设为常用\"  onclick=\"setOften('");
                  out.print(obj[2]);
                  out.write("',1);\">\r\n                            \t  ");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction setOften(processId,oftenType){\r\n\tlocation.href=\"/jsoa/FlowListAction.do?moduleId=");
            out.print(request.getParameter("moduleId"));
            out.write("&action=oftenList&processId=\"+processId+\"&type=\"+oftenType;\r\n}\r\nfunction setOftenIDS(flag){\r\n\tvar batchIdObj=document.getElementsByName(\"batchId\");\r\n\tvar ids=\"\";\r\n\tfor(var i=0;i<batchIdObj.length;i++){\r\n\t\tif(batchIdObj[i].checked){\r\n\t\t\tif(ids==\"\"){\r\n\t\t\t\tids=batchIdObj[i].value;\r\n\t\t\t}else{\r\n\t\t\t\tids+=\",\"+batchIdObj[i].value;\r\n\t\t\t}\r\n\t\t}\r\n\t}\r\n\r\n\tif(ids==\"\"){\r\n\t\talert(\"请选择要设置的流程!\");\r\n\t}else{\r\n\t\tlocation.href=\"/jsoa/FlowListAction.do?moduleId=");
            out.print(request.getParameter("moduleId"));
            out.write("&action=oftenList&processId=\"+ids+\"&type=\"+flag;\r\n\t}\r\n\t\t\t\r\n}\r\nfunction selectAll(obj){\r\n\tvar flag=obj.checked;\r\n\tvar batchIdObj=document.getElementsByName(\"batchId\");\r\n\tfor(var i=0;i<batchIdObj.length;i++){\r\n\t\tbatchIdObj[i].checked=flag;\r\n\t}\r\n}\r\n//-->\r\n</script>\r\n");
