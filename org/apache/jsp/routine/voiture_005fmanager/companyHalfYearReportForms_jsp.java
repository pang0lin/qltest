...
public final class companyHalfYearReportForms_jsp extends org.apache.jasper.runtime.HttpJspBase
...
endDate=request.getParameter("endDate").toString();
            ...
            out.write("\t\t\t\t\t\t<td rowspan=\"2\"><font color=\"#000000\" >其它杂费 </td>\r\n\t\t\t\t\t\t<td rowspan=\"2\"><font color=\"#000000\" >定损事故处理费 </td>\r\n\t\t\t\t\t\t<td rowspan=\"2\"><font color=\"#000000\" >合计 </td>\r\n                      </tr>\r\n\t\t\t\t\t  <tr>\r\n\t\t\t\t\t\t<!--<td  > 保管费 </td>-->\r\n\t\t\t\t\t\t<td  > 数量 </td>\r\n\t\t\t\t\t\t<td  > 金额 </td>\r\n\r\n\t\t\t\t\t  </tr>\r\n\r\n\r\n                      ");
					  ...
					  double brandFee2=0;//上牌费
					  double accidentFee=0;//事故处理费
            ...
            try {
              ...
              // /routine/voiture_manager/companyHalfYearReportForms.jsp(107,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("totalList");
              // /routine/voiture_manager/companyHalfYearReportForms.jsp(107,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("totalList");
              // /routine/voiture_manager/companyHalfYearReportForms.jsp(107,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                ...
                do {
                  ...
                  out.write("\r\n                          ");
                          ...
                          if(obj[0]!=null){
							  ...
							  if(obj[13]!=null){
							  brandFee2=Double.parseDouble(obj[13].toString());
							  brandFeeTotal2+=brandFee2;
							  }
							  if(obj[14]!=null){
							  ...
							  oneRecordTotal=oilFee+fixFee+washFee+taxFee+insureFee+
											 ...
											 purchaseTax+brandFee2+otherFee+bridgeFee+
											 guideFee+accidentFee+monthFee;
                  ...
                  out.write("&nbsp;</td>\r\n\t\t\t\t\t\t  <td>");
                  out.print(fmt.format(brandFee2));
                  out.write("&nbsp;</td>\r\n\t\t\t\t\t\t  <td>");
            ...
            out.write("&nbsp;</td>\r\n\r\n\t\t\t\t\t\t  <td>");
            out.print(fmt.format(brandFeeTotal2));
            out.write("&nbsp;</td>\r\n\t\t\t\t\t\t  <td>");
