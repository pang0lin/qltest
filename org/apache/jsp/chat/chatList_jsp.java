...
public static double r(double d, int i) {
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String userID = session.getAttribute("userId").toString();	
      ...
      out.write(".css\" rel=\"stylesheet\" type=\"text/css\" />\r\n\t</head>\r\n\t<script language=\"javascript\">\r\n\t\t//此处为string类添加三个成员\r\n\t\tString.prototype.Trim = function(){ return Trim(this);}\r\n\t\tString.prototype.LTrim = function(){return LTrim(this);}\r\n\t\tString.prototype.RTrim = function(){return RTrim(this);}\r\n\r\n\t\t//此处为独立函数\r\n\t\tfunction LTrim(str)\r\n\t\t{\r\n\t\t    var i;\r\n\t\t    for(i=0;i<str.length;i++)\r\n\t\t    {\r\n\t\t        if(str.charAt(i)!=\" \"&&str.charAt(i)!=\" \")break;\r\n\t\t    }\r\n\t\t    str=str.substring(i,str.length);\r\n\t\t    return str;\r\n\t\t}\r\n\t\tfunction RTrim(str)\r\n\t\t{\r\n\t\t    var i;\r\n\t\t    for(i=str.length-1;i>=0;i--)\r\n\t\t    {\r\n\t\t        if(str.charAt(i)!=\" \"&&str.charAt(i)!=\" \")break;\r\n\t\t    }\r\n\t\t    str=str.substring(0,i+1);\r\n\t\t    return str;\r\n\t\t}\r\n\t\tfunction Trim(str)\r\n\t\t{\r\n\t\t    return LTrim(RTrim(str));\r\n\t\t}\r\n\t</script>\r\n<body class=\"MainFrameBox\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n\r\n\t\t<form name=\"form1\" action=\"/jsoa/getChat.do?action=search&str=all\"\r\n\t\t\tmethod=\"post\" onSubmit=\"return checkinputs(document.form1);\">\r\n");
      out.write("\t\t\t<table  width=\"100%\" id=\"searchTable\" style=\"display:none\"\tborder=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n\t\t\t\t<tr>\r\n\r\n\t\t\t\t\t<td>\r\n\r\n\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t");
						...
						if (receivename == null || receivename.equalsIgnoreCase("null")) {
							receivename = "";
						}
					
      out.write("\r\n\r\n\t\t\t\t\t<td align=\"left\">\r\n\t\t\t\t\t\t&nbsp;&nbsp;发件人：\r\n\t\t\t\t\t\t<input type=\"text\" name=\"username\" size=\"12\" value=\"");
      out.print(username);
      out.write("\" />\r\n\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;\r\n\t\t\t\t\t\t&nbsp;收件人：\r\n\t\t\t\t\t\t<input type=\"text\" name=\"receivename\" size=\"12\" value=\"");
      out.print(receivename);
...
String toString = "";
  if(request.getAttribute("toUserId")==null){ 
      ...
      out.write("\r\n\t\t\t\t\t\t<a href=\"/jsoa/getChat.do?action=getAll&str=noread&username=");
      out.print(username+toString );
      ...
      out.write("\r\n\t\t\t\t\t</td>\r\n\r\n\t\t\t\t\t<td width=\"11%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t发件人\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td width=\"11%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t收件人\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td  class=\"listTableHead\">\r\n\t\t\t\t\t\t内容\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td width=\"12%\" class=\"listTableHead\">\r\n\t\t\t\t\t附件大小\t");
						...
						if (str.equals("all") || str.equals("noread")
								|| str.equals("isread")|| str.equals("timeup")|| str.equals("timedown")) {
					
      out.write("\r\n\t\t\t\t\t\t<a href=\"/jsoa/getChat.do?action=getAll&str=small&username=");
      out.print(username+toString );
      ...
      out.write("\r\n\r\n\t\t\t\t\t\t<a href=\"/jsoa/getChat.do?action=getAll&str=big&username=");
      out.print(username+toString );
      ...
      out.write("\r\n\t\t\t\t\t\t\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td width=\"15%\" class=\"listTableHeadLast\">\r\n\t\t\t\t\t\t发送时间\r\n\r\n\t\t\t\t\t\t");
						...
						if (str.equals("all") || str.equals("noread")
								|| str.equals("isread")|| str.equals("big")
								|| str.equals("small")) {
					
      out.write("\r\n\t\t\t\t\t\t<a href=\"/jsoa/getChat.do?action=getAll&str=timeup&username=");
      out.print(username+toString );
      out.write("\"><img\r\n\t\t\t\t\t\t\t\tsrc=\"/jsoa/images/blanksort.gif\" border=\"0\" title=\"按发送时间排序\">\r\n\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t");
      ...
      out.write("\r\n\r\n\t\t\t\t\t\t<a href=\"/jsoa/getChat.do?action=getAll&str=timedown&username=");
      out.print(username+toString );
      out.write("\"><img\r\n\t\t\t\t\t\t\t\tsrc=\"/jsoa/images/downsort.gif\" border=\"0\" title=\"按发送时间排序\">\r\n\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\t");
...
java.util.List list=(java.util.List)request.getAttribute("mylist");
                  ...
                  String sendUserId,toUserId,name,toName,content,isread,chatHasaccessory,accessorySize,chatTime;
      ...
      try {
        ...
        // /chat/chatList.jsp(286,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("mylist");
        // /chat/chatList.jsp(286,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("mylist");
        // /chat/chatList.jsp(286,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            out.write("\r\n\t\t\t\t\t");
								...
								countRecordCount++;
								sendUserId = obj[1].toString();
								toUserId = obj[7].toString();
								name = chatDB.getName(sendUserId);
								toName = chatDB.getName(toUserId);
								content = obj[2].toString();
								isread = obj[5].toString();
								chatHasaccessory = obj[3].toString();
								accessorySize = obj[6].toString();
								chatTime = obj[4].toString();
											index++;
...
if (isread.equals("1")) {
            out.write("\r\n\t\t\t\t\t\t\t<div style=\"display:inline;cursor:pointer;width:18px;height:16px;background:url(images/icons.gif);background-repeat:no-repeat; background-position:-48px 1px\">&nbsp;</div>\r\n\t\t\t\t\t\t\t");
} else {
...
if (isread.equals("1")) {
            out.write("\r\n\t\t\t\t\t\t\t<div style=\"cursor:pointer;width:18px;height:16px;background:url(images/icons.gif);background-repeat:no-repeat; background-position:-48px 1px\">&nbsp;</div>\r\n\t\t\t\t\t\t\t");
} else {
...
if("1".equals(isread)){
            ...
            out.write("\">\r\n\t\t\t\t\t\t\t");
								...
								double kb = 1024;
										double accessorySize1 = Double.parseDouble(accessorySize);

										out.print(r(accessorySize1 / 1024, 2));
      ...
      out.write("\r\n\r\n\r\n\t\t\t</table>\r\n\r\n\r\n\t\t\t\r\n\t\t</form>\r\n\t\t\t<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"pagebar\">\r\n <tr>\r\n    <td>\r\n\t  ");
	  	...
	  	String pagerURL = "/jsoa/getChat.do";
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n</td></tr></table>\r\n\r\n\t</body>\r\n</html>\r\n<script language=\"javascript\">\r\n\r\n     function checkinputs(obj){\t\t\r\n\t\t if(obj.username.value==\"\")\r\n\t\t  {\r\n\t\t    return false;\r\n\t\t  }\r\n\t\treturn true;\r\n\t }\r\n\r\n\t  function showChat(elem,id,isread){ \r\n\t  \t\tif(\"1\"==isread)\r\n\t  \t\t{\r\n\t  \t\t\t$.ajax({\r\n\t\t\t\t   \t\t\ttype: \"GET\",\r\n\t\t\t\t   \t\t\turl: \"/jsoa/ajaxGetData.jsp\",\r\n\t\t\t\t   \t\t\tdata: \"method=updatePersonalMsg&parameters=chatId@-@\"+id,\r\n\t\t\t\t   \t\t\tasync: false,\r\n\t\t\t\t   \t\t\tsuccess: function(data)\r\n\t\t\t\t   \t\t\t{\r\n\t   \t\t\t\t\t\t\telem.style.fontWeight=\"normal\";\r\n\t     \t\t\t\t\t\telem.previousSibling.previousSibling.previousSibling.firstChild.style.backgroundPosition=\"-48px -15px\";\r\n\t  \t\t\t\t   \t\t}\r\n\t\t\t\t  \t   });  \r\n\t\t\t}\t\t\r\n\t\t\t");
if(BrowserJudge.isFirefox(request)){
      out.write("    \r\n\t\t\tvar wid=620;\r\n\t\t\tvar heigh=465;\t\r\n\t\t\t");
}else{
      out.write("\r\n\t\t\tvar wid=620;\r\n\t\t\tvar heigh=465;\r\n\t\t\t");
}
      out.write("\r\n\t\t\tJSMainWinOpen2('/jsoa/chat/showChat.jsp?id='+id+'','','',wid,heigh);\r\n\t  }\r\n  \t\r\n     function  delChat() {   \t   \r\n\t  var errflag=false; \r\n\t   var temp=\"\";  \r\n\t      for (var i = 0; i < document.getElementsByName(\"batchDel\").length; i++) {\t\t       \r\n\t\t            if (document.getElementsByName(\"batchDel\")[i].checked) {\r\n\t\t    \t\t                \r\n\t\t                temp=temp+document.getElementsByName(\"batchDel\")[i].value+\",\";\t\r\n\t\t                if(!errflag){\r\n\t\t                errflag=true; \r\n\t\t                   }           \r\n\t\t            }                    \r\n\t\t        } \t\r\n\t      var timeScan;\r\n\t      timeScan=document.all.timeScan.options[document.all.timeScan.selectedIndex].value;\r\n\t      if(errflag==false&&timeScan==\"\"){   \r\n\t\t          alert(\"请选择要删除的聊天记录\"); \r\n\t\t       } else {   \r\n\t\t       \r\n\t\t       if(confirm(\"是否删除个人消息记录！\")){\r\n\t\t       ");
if(request.getAttribute("toUserId")!=null){ 
      out.write("\r\n\t\t\t\t \twindow.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/chat/handleChat.jsp?myaction=delete&chatId=\"+temp+\"&deltype=\"+timeScan+\"&toUserId=");
      out.print(request.getAttribute("toUserId").toString() );
      out.write("&username=");
      out.print(username );
      out.write("\";   \r\n\t\t\t\t");
}else{
      out.write("\r\n\t\t\t        window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/chat/handleChat.jsp?myaction=delete&chatId=\"+temp+\"&deltype=\"+timeScan;  \r\n\t\t\t    ");
}
      out.write("\r\n\t\t       \r\n\t\t        //window.location.href=\"/jsoa/chat/handleChat.jsp?myaction=delete&chatId=\"+temp+\"&deltype=\"+timeScan;  \r\n\t\t       }      \r\n\t       }   \r\n        }  \r\n     //标记已读\r\n     function markAsRead()\r\n     {\r\n     \tvar errflag=false; \r\n\t   \tvar temp=\"\";  \r\n\t    for (var i = 0; i < document.getElementsByName(\"batchDel\").length; i++)\r\n\t    {\t\t       \r\n        \tif (document.getElementsByName(\"batchDel\")[i].checked) \r\n        \t{         \r\n\t\t    \ttemp=temp+document.getElementsByName(\"batchDel\")[i].value+\",\";\t\r\n\t\t        if(!errflag)\r\n\t\t        {\r\n\t\t        \terrflag=true; \r\n\t\t        }           \r\n\t\t    }                    \r\n\t\t} \t\r\n\t    var timeScan;\r\n\t    timeScan=document.all.timeScan.options[document.all.timeScan.selectedIndex].value;\r\n\t    if(errflag==false&&timeScan==\"\")\r\n\t    {   \r\n\t\t\talert(\"请选择要标记已读的记录！\");        \r\n\t\t} \r\n\t\telse \r\n\t\t{   \r\n\t\t    if(confirm(\"是否标记已读的记录！\"))\r\n\t\t\t{\r\n\t\t\t");
if(request.getAttribute("toUserId")!=null){ 
      out.write("\r\n\t\t\t\t window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/chat/handleChat.jsp?myaction=markAsRead&chatId=\"+temp+\"&markype=\"+timeScan+\"&toUserId=");
      out.print(request.getAttribute("toUserId").toString() );
      out.write("&username=");
      out.print(username );
      out.write("\";   \r\n\t\t\t");
}else{
      out.write("\r\n\t\t        window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/chat/handleChat.jsp?myaction=markAsRead&chatId=\"+temp+\"&markype=\"+timeScan;   \r\n\t\t    ");
}
      out.write("\r\n\t\t    }      \r\n\t    }   \r\n     }   \r\n\t function selectAllItem(){\r\n\t    var result=document.all.selectAll.checked;\t    \r\n\t    if(document.all.batchDel){\r\n\t        if(isNaN(document.all.batchDel.length)){\r\n\t            document.all.batchDel.checked=result;\r\n\t        }else{\r\n\t            for(var i=0;i<document.all.batchDel.length;i++){\r\n\t                document.all.batchDel[i].checked=result;\r\n\t            }\r\n\t        }\r\n\t    }\r\n\t} \r\nfunction clear1()\r\n{\r\n  window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/getChat.do?action=getAll&str=all\";\r\n}\r\nfunction query1()\r\n{\r\nform1.submit();\r\n}\r\n\r\nfunction changePanle(cURL){\r\n   \r\n\tlocation.href=cURL;\r\n}\r\nfunction chSearch(obj){\r\n\tif(obj.value == \"查询\"){\r\n\t\tobj.value = \"关闭查询\";\r\n\t\tdocument.all.searchTable.style.display=\"\";\r\n\t}else{\r\n\t\tobj.value = \"查询\";\r\n\t\tdocument.all.searchTable.style.display=\"none\";\r\n\t}\r\n}\r\n</script>\r\n");
