...
public final class search_005fmail_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String boxType=(String)request.getAttribute("boxType");
...
if("1".equals(boxType)||"2".equals(boxType)){
      out.write("\r\n\t\t\t\t\t\t\t\t\t  收件人\r\n\t\t\t\t\t\t\t\t\t");
} else{
      out.write("\r\n\t\t\t\t\t\t\t\t\t  发件人\r\n\t\t\t\t\t\t\t\t\t");
} 
      out.write("\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td width=\"45%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t\t\t\t主题\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t   <td width=\"15%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t\t\t\t日期\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t <td width=\"5%\" class=\"listTableHead\">\r\n\t\t\t\t\t\t\t\t\t大小\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\r\n\t\t\t\t\t\t\t");
List list = (List) request.getAttribute("webMailListInDB");
      ...
      try {
        ...
        // /webmail/search_mail.jsp(142,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("webMailListInDB");
        // /webmail/search_mail.jsp(142,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("webMailListInDB");
        // /webmail/search_mail.jsp(142,7) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            out.write("\r\n\t\t\t\t\t\t\t\t");
											...
											String sendDate = obj[3].toString();
											String hasAttach = obj[4].toString();
											String too = String.valueOf(obj[5]);
											Integer size = Integer.parseInt(obj[8].toString());
											if(size<(1024*1024)){
            ...
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t ");
if("1".equals(boxType)&&hasAttach!=null&&"1".equals(hasAttach)){ 
            out.write("\r\n\t\t\t\t\t\t\t\t\t    <img src='/jsoa/images/fj2.gif' align='absmiddle'>\r\n\t\t\t\t\t\t\t\t\t   ");
} 
            out.write("\r\n\t\t\t\t\t\t\t\t\t    ");
if("0".equals(boxType)&&AffixManager.getInstance().getMailAffixFlag((String)obj[0])){ 
            out.write("\r\n\t\t\t\t\t\t\t\t\t    <img src='/jsoa/images/fj2.gif' align='absmiddle'>\r\n\t\t\t\t\t\t\t\t\t   ");
} 
            out.write("\r\n\t\t\t\t\t\t\t\t\t\t<a href=\"javascript:void(0);\" onclick=\"mailDetail('");
            out.print(obj[6]);
            out.write("')\">");
            out.print((subject==null||"".equals(subject))?"&nbsp;":subject );
            out.write("</a>\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t  ");
            out.print((sendDate==null||"".equals(sendDate))?"&nbsp;":sendDate );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t      ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.print(webapp);
      out.write("'+\"/webMail.do?method=searchWebMail\";\r\n\t   mailForm.submit();\r\n   }\r\n  function mailDetail(obj){\r\n\t  var url=\"");
