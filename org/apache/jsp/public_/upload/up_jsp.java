 ...
 * Generated at: 2023-01-06 09:57:35 UTC
...
String base=request.getSession().getServletContext().getRealPath("/upload/edit/");
...
try {
	...
	for (int i = 0 ;i < items.size(); i++){
		...
		if(fiName!=null&&!"".equals(fiName)&&!"null".equals(fiName)){
			fileName = base + File.separator + fiName;
			if (!item.isFormField() && fiName.length() > 0) {
