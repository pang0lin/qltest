 ...
 * Generated at: 2023-01-06 09:43:52 UTC
...
public final class kq_005fholiday_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getAttribute("reload")!=null){ 
      out.write("\r\n<script language=\"JavaScript\">\r\nlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/KqHolidayAction.do?action=list\";\r\n</script>\r\n");
} 
      out.write('\r');
      out.write('\n');
      //  html:html
 ...
 if("1".equals(com.js.util.config.SystemCommon.getUseWeiXinQYH())){ 
            ...
            out.write("\r\n\t\t</td>\r\n\t  <td align=\"right\">\r\n\t\t  <button  class=\"btnButton2Font\" onClick=\"javascript:JSMainWinOpen('KqHolidayAction.do?action=add','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600');\" >新增</button>\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n\r\n\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n\t  <tr align=\"center\">\r\n\t\t<td  width=\"20%\"class=\"listTableHead\">假日名称</td>\r\n\t\t<td width=\"20%\" class=\"listTableHead\">开始时间</td>\r\n\t\t<td width=\"20%\" class=\"listTableHead\">结束时间</td>\r\n\t\t<td  class=\"listTableHead\">假日说明</td>\r\n\t\t<td width=\"8%\" nowrap class=\"listTableHeadLast\">");
	  ...
	  String listClass="listTableLine1";
            ...
            try {
              ...
              // /kq/kq_holiday_list.jsp(150,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /kq/kq_holiday_list.jsp(150,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /kq/kq_holiday_list.jsp(150,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
String pagerURL = "/jsoa/KqHolidayAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n\r\n\r\nfunction del(id){\r\n if(confirm(\"你确定要删除吗？\"))\r\n {\r\n  window.location.href= ((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/KqHolidayAction.do?action=del&holidayid=\"+id ;\r\n  }\r\n}\r\n\r\nfunction update(id)\r\n{\r\n\r\nJSMainWinOpen(((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+'/jsoa/KqHolidayAction.do?action=update&holidayid='+id,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600')\r\n\r\n}\r\n\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+cURL;\r\n}\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /kq/kq_holiday_list.jsp(145,50) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("personalwork");
      // /kq/kq_holiday_list.jsp(145,50) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
