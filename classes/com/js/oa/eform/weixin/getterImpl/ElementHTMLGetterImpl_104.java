...
public class ElementHTMLGetterImpl_104 implements ElementHTMLGetter {
  public String getHTML(String field, String noWriteField, String domainId, String fieldId, HttpServletRequest request, String computeFieldStr, String[][] fieldTemp, int maxlen, String type, boolean isNum) {
    ...
    if (noWriteField.indexOf("," + fieldTemp[0][0] + ",") < 0 && 
      ...
      mustField1 = String.valueOf(mustField1) + "<input type=hidden name=mustWrite id=mustWrite value=" + 
    ...
    if (temp.startsWith("@")) {
      ...
      String parentId = temp.substring(temp.indexOf(".*[") + 3, 
          temp.length() - 1);
      ...
      if (temp.startsWith("#[interface:")) {
        ...
        map.put("userName", hSession.getAttribute("userName")
            .toString());
        ...
        map.put("userAccount", hSession.getAttribute("userAccount")
            .toString());
        ...
        if (data != null) {
          ...
          for (int i = 0; i < data.length; i++) {
            html = String.valueOf(html) + "var " + field + 
              ...
              field + " name=" + field + 
              " value=" + data[i][0] + (
              (fieldValue.indexOf(String.valueOf(data[i][0]) + 
                ",") >= 0) ? " checked " : "") + 
              ">';\n";
            html = String.valueOf(html) + "if(document.getElementById('" + 
              fieldTemp[0][0] + "-" + field + 
              ...
              "').innerHTML+='" + data[i][1] + ((
              fieldTemp[0][3].equals("1") && 
              i == data.length - 1 && hideField.indexOf("," + fieldTemp[0][0] + ",") < 0 && hideField.indexOf(fieldTemp[0][5]) < 0) ? (
