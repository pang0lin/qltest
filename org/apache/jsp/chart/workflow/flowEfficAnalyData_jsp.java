...
public final class flowEfficAnalyData_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int kindCount=0;
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("）节点效率分析\r\n\t\t</td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<th align=\"left\">[<label class=\"mustFillcolor\">报表</label>][<a href=\"/jsoa/chartWorkFlow.do?action=flowEfficAnalyChart&processId=");
            out.print(request.getAttribute("processId"));
            out.write("\r\n\t\t&processName=");
            out.print(request.getAttribute("processName"));
            out.write("&parent.pager.offset=");
            out.print(request.getAttribute("parentpageroffset"));
            out.write("\">图示</a>]</th>\r\n\t\t<td align=\"right\">\r\n\t\t\t<button  class=\"btnButton2Font\" onclick=\"JSMainWinOpen('/jsoa/chartWorkFlow.do?action=flowEfficAnalyDataExport&processId=");
            out.print(request.getAttribute("processId"));
            out.write("&processName=");
            out.print(request.getAttribute("processName"));
            out.write("')\">导出</button>\r\n\t\t\t<button  class=\"btnButton2Font\" onclick=\"backtoprocesslist();\">返回</button>\r\n\t\t\t\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<br />\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\"  border=\"1\" align=\"center\" cellpadding=\"1\" cellspacing=\"0\" bordercolorlight=\"#000000\" bordercolordark=\"#FFFFFF\">\r\n\t<tr align=\"center\">\r\n\t\t<th width=\"2%\" nowrap=\"nowrap\" >序号</th>\r\n\t\t<th width=\"18%\">节点</th>\r\n\t\t<th width=\"18%\" nowrap=\"nowrap\">有效时间(小时)</th>\r\n\t\t<th width=\"18%\" nowrap=\"nowrap\" >无效时间(小时)</th>\r\n\t  </tr>\r\n\t  ");
	  ...
	  int i;
            ...
            try {
              ...
              // /chart/workflow/flowEfficAnalyData.jsp(99,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("resultList");
              // /chart/workflow/flowEfficAnalyData.jsp(99,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("resultList");
              // /chart/workflow/flowEfficAnalyData.jsp(99,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		//level=Integer.parseInt(obj[27].toString());
                  ...
                  out.write("&nbsp;</td>\r\n\t\t<td>");
                  out.print(tempMap.get("youxiao"));
                  out.write("&nbsp;</td>\r\n\t\t<td>");
                  out.print(tempMap.get("wuxiao"));
                  out.write("&nbsp;</td>\r\n\t  </tr>\r\n\t  ");
