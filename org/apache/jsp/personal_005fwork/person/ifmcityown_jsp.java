...
public final class ifmcityown_jsp extends org.apache.jasper.runtime.HttpJspBase
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /personal_work/person/ifmcityown.jsp(30,0) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("cities");
              // /personal_work/person/ifmcityown.jsp(30,0) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("cities");
              // /personal_work/person/ifmcityown.jsp(30,0) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            out.write("\r\n<!--通过脚本控制，将内容显示在城市列表中-->\r\n<script language=\"javascript\">\r\n        var linkManState  = parent. PersonOwnActionForm.linkManState  ;\r\n\tvar linkManStateSelect  = parent.document.all.linkManStateSelect ;\r\n        var linkManStateText = parent.document.all.linkManStateText ;\r\n        var linkManStateSelectSpan = parent.document.all.linkManStateSelectSpan ;\r\n        var linkManStateTextSpan = parent.document.all.linkManStateTextSpan ;\r\n        for (var x = linkManStateSelect.length ; x >=0 ; x-- ) {\r\n           linkManStateSelect.options[x]=null;\r\n           linkManStateSelect.options.remove(x);\r\n        }\r\n        //没有找到城市，则用文本框手工输入数据\r\n        if(cityArr.length == 0) {\r\n               linkManStateTextSpan.style.display =  \"\" ;\r\n               if(type==\"1\")linkManStateText.value = linkManState.value ;\r\n               else linkManStateText.value = \"\";\r\n               linkManStateSelectSpan.style.display =  \"none\" ;\r\n        }else {\r\n        //有城市，则用下拉框选择数据\r\n           linkManStateTextSpan.style.display =  \"none\" ;\r\n");
            out.write("           linkManStateText.value = \"\" ;\r\n           linkManStateSelectSpan.style.display =  \"\" ;\r\n           linkManStateSelect.add(parent.document.createElement(\"OPTION\"));\r\n           linkManStateSelect.options[0].value = \"\" ;\r\n           linkManStateSelect.options[0].innerText = \"--\"+Personalwork.innercontact_select+\"--\" ;\r\n          for(var i =0  ;  i < cityArr.length ; i++ ) {\r\n              linkManStateSelect.add(parent.document.createElement(\"OPTION\"));\r\n              linkManStateSelect.options[i+1].value = cityArr[i] ;\r\n              linkManStateSelect.options[i+1].innerText = cityArr[i] ;\r\n              if(cityArr[i] == linkManState.value && type==\"1\" )  linkManStateSelect.options[i+1].selected = true ;\r\n          }\r\n        }\r\n        //alert(cityArr) ;\r\n</script>\r\n</body>\r\n");
