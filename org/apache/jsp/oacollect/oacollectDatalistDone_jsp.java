 ...
 * Generated at: 2023-01-06 10:03:43 UTC
...
public final class oacollectDatalistDone_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if("1".equals(searchTime)){out.print("checked");}
            ...
            try {
              ...
              // /oacollect/oacollectDatalistDone.jsp(100,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/oaCollectAction");
              // /oacollect/oacollectDatalistDone.jsp(100,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  for(int i=0;i<myList.size();i++){
 	...
 	if(index%2 != 0){
 	     ...
 	     listClass="listTableLine1";
                  ...
                  out.write("</td>\t\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">\r\n\t\t<img title=\"填报\" style=\"cursor:pointer\" border=\"0\" src=\"images/sendgonggao.gif\" onclick=\"collectList('");
                  out.print(obj[0] );
                  out.write("')\"/>\r\n\t\t</td>\r\n  </tr>\r\n  ");
