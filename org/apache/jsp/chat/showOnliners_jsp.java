...
import com.js.oa.online.action.OnlinerAction;
import java.util.*;
import java.util.*;
import com.js.util.util.BrowserJudge;
import com.js.util.page.Page;

public final class showOnliners_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.oa.online.action.OnlinerAction");
    _jspx_imports_classes.add("com.js.util.config.SystemCommon");
    _jspx_imports_classes.add("com.js.util.page.Page");
...
if(BrowserJudge.isFirefox(request)){
	...
	List onlinerList = (List) request.getAttribute("onlinerList");
		
	List userOnlinList = (List)request.getAttribute("userOnlinList");;
	
	String rtxstatusx = (String) request.getAttribute("rtxstatusx");
	String showOnline = (String) request.getAttribute("showOnline");
	
	rtxstatusx = rtxstatusx==null?"":rtxstatusx;

	String emailType = (String) request.getAttribute("emailType");
	emailType = emailType==null?"":emailType;
	
	String isSetWebEmail = (String) request.getAttribute("isSetWebEmail");
	isSetWebEmail = isSetWebEmail == null ? "" : isSetWebEmail;

	String status1 = (String) request.getAttribute("status1");
	status1 = status1 == null ? "" : status1;
	...
	String currentOrgShow=request.getParameter("orgShow");
	if(currentOrgShow==null || "null".equals(currentOrgShow) || "".equals(currentOrgShow)){
		currentOrgShow="0";
	}

      out.write("\r\n<html>\r\n\t<head>\r\n\t<title>在线用户列表</title>\r\n\t\t<meta http-equiv=\"Content-Type\" content=\"text/html; charset=GBK\"/>\r\n\t\t<style type=\"text/css\">\r\n\t\tbody,bable,form {margin: 0px;padding: 0px;font-family: \"宋体\";font-size: 12px;background-color: #FFF;}\r\n\t\t.boder_bottom {border-bottom: 1px solid #BDBDBD;}\r\n\t\t</style>\r\n\t\t<script type=\"text/javascript\">\r\n\t\t   function showAlway(){\r\n\t\t\t      var showOnline=document.getElementById(\"onLine\").checked;\r\n\t\t\t      var username=document.getElementsByName(\"username\")[0].value;\r\n\t\t\t \t  window.location.href=\"/jsoa/OnlinerAction.do?method=showOnliner&orgShow=");
      out.print(currentOrgShow);
      out.write("&action=showOnline&bumen=null&username=\"+username+\"&onLine=\"+showOnline;\r\n\t\t   }\r\n    \t</script>\r\n\t\t<link href=\"/jsoa/skin/");
      out.print(session.getAttribute("skin").toString());
      out.write("/style-");
      out.print(session.getAttribute("browserVersion"));
      out.write(".css\"\trel=\"stylesheet\" type=\"text/css\" />\r\n\t</head>\r\n\t<body onclick=\"yinc()\">\r\n\t\t<form action=\"/jsoa/OnlinerAction.do?method=showOnliner&action=showOnline\" name=\"myform\" method=\"post\">\r\n\t\t\t<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" height=\"43\" style=\"font-size: 13px; background-image: url(/jsoa/images/bgc.bmp); repeat: repeat-x;\">\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td align=\"left\" valign=\"middle\" width=\"60px\">&nbsp;&nbsp;姓名：\r\n\t\t\t\t\t\t\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td align=\"left\" valign=\"middle\" width=\"140px\">\r\n\t\t\t\t\t\t<input type=\"text\" name=\"username\" size=\"12\" value=\"");
      out.print(username);
      out.write("\" style=\"width:125px\"/>\r\n\t\t\t\t\t\t<input type=\"hidden\" name=\"orgShow\" id=\"orgShow\" size=\"12\" value=\"");
      out.print(currentOrgShow);
      out.write("\" />\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td align=\"left\">\r\n\t\t\t\t\t\t<input type=\"submit\" name=\"Submit\" class=\"btnButton2font\" value=\"查找\" style=\"font-size: 12px;\" />\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td align=\"left\">\r\n\t\t\t\t\t\t<input type=\"checkbox\" name=\"onLine\" id=\"onLine\" onclick=\"javaScript:showAlway();\" ");
if("true".equals(showOnline)) {
      out.write(" checked");
} 
      out.write(" />&nbsp;<font style=\"font-size: 12px;top:1px \">显示离线人员</font>\t\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\t\t\t</table>\r\n\t\t</form>\r\n\t\t");
      ...
      out.write("\r\n\t\t<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" style=\"font-size: 12px; text-indent: 5px;\">\r\n\t\t\t<tr height=\"22\"\tstyle=\"background-image: url(/jsoa/images/z_tiao.gif)\">\r\n                <td align=\"left\" valign=\"middle\">状态</td>\r\n\t\t\t\t<td width=\"2\" align=\"left\" valign=\"middle\"><img src=\"/jsoa/images/shut.gif\" /></td>\r\n\t\t\t\t<td align=\"left\" valign=\"middle\">姓名</td>\r\n\t\t\t\t<td width=\"2\" align=\"left\" valign=\"middle\"><img src=\"/jsoa/images/shut.gif\" /></td>\r\n\t\t\t\t<td align=\"left\" valign=\"middle\">部门</td>\r\n\t\t\t\t<td width=\"2\" align=\"left\" valign=\"middle\"><img src=\"/jsoa/images/shut.gif\" /></td>\r\n\t\t\t\t");

				if(showDuty){
					
      out.write("\r\n\t\t\t\t\t<td align=\"left\" valign=\"middle\">职务</td>\r\n\t\t\t\t\t<td width=\"2\" align=\"left\" valign=\"middle\"><img src=\"/jsoa/images/shut.gif\" /></td>\r\n\t\t\t\t\t");

				}
				if(showStation){
					
      out.write("\r\n\t\t\t\t\t<td align=\"left\" valign=\"middle\">岗位</td>\r\n\t\t\t\t\t<td width=\"2\" align=\"left\" valign=\"middle\"><img src=\"/jsoa/images/shut.gif\" /></td>\r\n\t\t\t\t\t");

				}
				
      out.write("\r\n\t\t\t\t<td align=\"left\" valign=\"middle\">发送消息\t</td>\r\n\t\t\t</tr>\r\n\r\n\t\t\t");
			...
			if(onlinerList!=null){
				java.util.Map<String, String> userStatusMap = new HashMap<String, String>();
				// 遍历得到userId的以逗号分隔的字符串
				StringBuilder userIds = new StringBuilder();
				for(int i = 0; i < onlinerList.size(); ++i){
					Object[] objArr = (Object[])onlinerList.get(i);
					userIds.append(objArr[0]);
					if(i != onlinerList.size() - 1){
						userIds.append(",");
					}
				}
				// 访问数据库查询
				if(userIds!=null && !"".equals(userIds.toString())){
					OnlinerAction onlinerAction = new OnlinerAction();
					userStatusMap = onlinerAction.queryUserStatus(userIds.toString());
				}				
				
			for (int i = 0; i < onlinerList.size(); i++) {//遍历所有在线用户信息
				Object[] obj = (Object[]) onlinerList.get(i);//
				phone = obj[6] == null ? "" : obj[6].toString();//用户手机号码
				email = obj[5] == null ? "" : obj[5].toString();//用户email	
...
if(obj[12]!=null && obj[12]!="" ) {
      ...
      out.write("\r\n\t\t\t\r\n\t\t\t    \r\n\t\t\t    <td height=\"22\" class=\"boder_bottom\">\r\n\t\t\t\t\t");
if(obj[12]!=null && obj[12]!="" ) {
      out.write("\r\n\t\t\t\t\t<img src=\"/jsoa/images/concat_person.gif\" title=\"在线\"\tstyle=\"cursor: pointer;\"/>\r\n\t\t\t\t\t\t");
 
						// 1：在线； 2：忙碌； 3：离开
						String userId = (String)obj[0];
						int userStatus = Integer.parseInt(userStatusMap.get(userId)==null?"3":userStatusMap.get(userId).toString());
						switch(userStatus){
							case 2 : 
      out.write('忙');
      out.write('碌');
...
; break;
      ...
      out.write("\r\n\t\t\t\t\t<img src=\"/jsoa/images/concat_person_off.gif\" title=\"离线\"\tstyle=\"cursor: pointer;\" />\r\n\t\t\t\t\t");
 }
      out.write("\r\n\t\t\t\t</td>   \r\n\t\t\t    <td class=\"boder_bottom\"><img src=\"/jsoa/images/kong_1.gif\" /></td>\r\n\t\t\t\t<td height=\"22\" class=\"boder_bottom\">\r\n\t\t\t\t\t\t<a style=\"cursor: pointer\"\tonclick=\"edit('");
      out.print(obj[0].toString());
      out.write("','see','");
      out.print(new com.js.util.util.MD5().toMD5("key-md5"	+ obj[0].toString()));
      out.write("')\">\r\n\t\t\t\t\t\t");
if(obj[12]!=null && obj[12]!="" ) {
      out.write("\r\n\t\t\t\t           <font color=\"\"> \r\n\t\t\t\t        ");
}else{
      out.write("\r\n\t\t\t\t           <font style=\"color:#8A8A8A;\">\r\n\t\t\t\t        ");
}
      out.write("\r\n\t\t\t\t\t\t");
      out.print(obj[1].toString());
      out.write("\r\n\t\t\t\t\t\t</font>\r\n\t\t\t\t\t\t</a>\r\n\t\t\t\t\t\r\n\t\t\t\t\t<img src=\"/jsoa/images/kong_1.gif\" />\r\n\t\t\t\t</td>\r\n\r\n\t\t\t\t<td class=\"boder_bottom\"><img src=\"/jsoa/images/kong_1.gif\" /></td>\r\n\t\t\t\t<td class=\"boder_bottom\">\r\n\t\t\t\t\r\n\t\t\t\t\t");

					if (obj[2] != null) {//如果部门名称不为空
							orgNames = obj[2].toString().split("\\.");//解析部门名称，获取最后一个名称
							li = orgNames.length - 1;
							//out.print(orgNames[li]);
...
if(obj[12]!=null && obj[12]!="" ) {
      ...
      out.write("\r\n\t\t\t\t\t</font>\r\n\t\t\t\t\t<img src=\"/jsoa/images/kong_1.gif\" /></td>\r\n\t\t\t\t\t<td class=\"boder_bottom\"><img src=\"/jsoa/images/kong_1.gif\" /></td>\r\n\t\t\t\t\t");
      ...
      out.write("\r\n\t\t\t\t<td class=\"boder_bottom\">\r\n\t\t\t\t<div style=\"margin-top:1px\">\r\n\t\t\t\t\t");
					...
					if(obj[4].toString().equals(session.getAttribute("userAccount").toString()) || "admin".equals(obj[4].toString())) {//如果是自己账户或者是admin账户
      ...
      out.write("\r\n\t\t\t\t\t<img ");
if(obj[12]!=null && obj[12]!="" ) {
      out.write(" src=\"/jsoa/images/la_ba.gif\" ");
}else{
      out.write(" src=\"/jsoa/images/la_ba_off.gif\"  ");
} 
      out.write(" title=\"发即时消息\" border=\"0\"\tstyle=\"cursor: pointer;\" onClick=\"javascript:jschat('");
      out.print(obj[0].toString());
      out.write("')\" />\r\n\t\t\t\t\t\t");
if("0".equals(emailType)){
      out.write("\r\n\t\t\t\t\t\t\t<img ");
if(obj[12]!=null && obj[12]!="" ) {
      out.write(" src=\"/jsoa/images/mail.gif\" ");
}else{
      out.write(" src=\"/jsoa/images/mail_off.gif\"  ");
} 
      out.write(" border=\"0\" title=\"发内部邮件\"\tstyle=\"cursor: pointer;\" onClick=\"javascript:jsopenEmalPage1('");
      out.print(obj[0].toString());
      out.write("')\" />\r\n\t\t\t\t\t\t");
}else{
...
if(obj[12]!=null && obj[12]!="" ) {
      ...
      out.write(" border=\"0\" title=\"发外部邮件\" style=\"cursor: pointer;\" onClick=\"javascript:sendWebEmail1('");
      ...
      out.write("\r\n\t\t\t\t\t\t<img ");
if(obj[12]!=null && obj[12]!="" ) {
      out.write(" src=\"/jsoa/imges/duanxin.gif\" ");
}else{
      out.write(" src=\"/jsoa/images/duanxin_off.gif\"  ");
} 
      out.write(" border=\"0\" title=\"发手机短息\" style=\"cursor: pointer;\" onClick=\"javascript:jsopenURL1('");
      out.print(phone);
      out.write("')\" />\r\n\t\t\t\t\t\t\r\n\t\t\t\t\t\t");
ta = "0";
						...
						if ("true".equals(status1)) {
							if(userOnlinList!=null && !userOnlinList.isEmpty()){
								
								for(int z = 0; z < userOnlinList.size(); z++) {
									if(obj[0].toString().equals((Long) userOnlinList.get(z)))
									ta = "1";
								}
							}
							if ("0".equals(ta)) {
      ...
      out.write("\r\n\t\t\t\t\t\t\t<img src=\"/jsoa/images/rtx/blank.gif\" border=\"0\" style=\"cursor: pointer;\" onload=\"rtxonline('");
      out.print(obj[7] == null ? "" : obj[7]);
      out.write("');\"/>\r\n\t\t\t\t\t\t");
}
					}
...
String pagerURL = "/jsoa/OnlinerAction.do";
      out.write("\r\n\t\t\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t</table>\r\n\t</body>\r\n</html>\r\n\r\n<script>   \r\nfunction edit(id,loadType,key) {\r\n    var hhref= ((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/PersonInnerAction.do?action=load\" ;\r\n\thhref +=\"&key=\"+key;\r\n    hhref +=\"&order=\" ;\r\n    hhref += \"&color=\" ;\r\n    hhref += \"&desc=\" ;\r\n    hhref += \"&pager.offset=");
      out.print(0);
