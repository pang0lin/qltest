...
public final class oasysremindlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.oa.oasysremind.bean.OASysRemindEJBBean");
  }
...
String remindTableName=null==request.getParameter("remindTableName")?"":request.getParameter("remindTableName");
String remindObjName=null==request.getParameter("remindObjName")?"":request.getParameter("remindObjName");
...
int offset1=index;
            ...
            out.write("\r\n<body class=\"MainFrameBox\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\" id=\"searchbar\" style=\"display:none\">\r\n   <form name=\"frm\" action=\"/jsoa/oaSysRemindAction.do?action=list\" method=\"post\">\r\n     <input type=\"hidden\" name=\"exportLog\" value=\"\">\r\n\t  <tr>\r\n\t\t  <td align=\"center\">提醒内容：</td>\r\n\t\t  <td>\r\n\t\t\t<input type=\"text\" class=\"inputtext\" name=\"remindTableName\" value=\"");
            out.print(remindTableName);
            out.write("\"/>\r\n\t\t\t</td>\r\n\t\t  <td>提醒人：</td>\r\n\t\t  <td>\r\n\t\t\t<input type=\"text\" class=\"inputtext\" name=\"remindObjName\" value=\"");
            out.print(remindObjName);
            out.write("\"/>\r\n\t\t\t</td>\t\t \r\n\t\t  <td></td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t  <td align=\"center\">提醒时间：</td>\r\n\t\t  <td colspan=\"3\"><script language=javascript>\r\n\t\t\t\t\tvar dtpDate = createDatePickerByDateStr(\"oprStartTime\",\"");
...
if("1".equals(searchTime)){out.print("checked");}
            ...
            try {
              ...
              // /oasysremind/oasysremindlist.jsp(98,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/oaSysRemindAction");
              // /oasysremind/oasysremindlist.jsp(98,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("get");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n  <tr>\r\n\t\t<td width=\"40px\"  nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"sAll\" onclick=\"selectAll(this);\"></td>\r\n\t\t<td width=\"20%\" class=\"listTableHead\" id=\"tdWidth\">提醒内容</td>\t\t\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\">提醒人</td>\t\r\n\t\t<td width=\"10%\" class=\"listTableHead\" id=\"tdWidth\">提醒开始时间</td>\t\t\r\n\t\t<td width=\"10%\" class=\"listTableHead\" id=\"tdWidth\">提醒结束时间</td>\t\r\n\t\t<td width=\"10%\" class=\"listTableHead\" id=\"tdWidth\">操作</td>\r\n  </tr>\r\n  ");
  ...
  for(int i=0;i<myList.size();i++){
	...
	String obj7=obj[7].toString();
 	String tableName=obj7.split(",")[1];
 	String name="";
 	if(obj[5]!=null){
		String obj5=obj[5].toString();
		if(obj5.indexOf("1")>=0){//如果选中发起人，则obj[5]中有 "1"
	 		name+="发起人,";
	 	}
	 	if(obj5.indexOf("2")>=0){//如果选中选择字段，则obj[5]中有 "2" 
	 	 	String obj6=obj[6].toString();
	 		String[] fieldName=obj6.split(",");
	 	 	OASysRemindEJBBean remind = new OASysRemindEJBBean();
	 		for(int j=0;j<fieldName.length;j++){
	 			name += remind.getFieldDesname(fieldName[j], tableName)+",";
	 		}
	 	}
	}
 	if(null !=obj[2] && !obj[2].equals("") && !"null".equals(obj[2])){
 		name+=obj[2].toString();
 	}
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(null==obj[4]?"":obj[4].toString().substring(0,10));
                  out.write("&nbsp;</td>\t\t\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">\r\n\t\t<img alt=\"修改\" style=\"cursor:hand\" border=\"0\" src=\"images/modi.gif\" onclick=\"leaderModi('");
                  out.print(obj[0] );
                  out.write("')\"/>\r\n\t\t<img alt=\"删除\" style=\"cursor:hand\" border=\"0\" src=\"images/del.gif\" onclick=\"DeleteIt('");
                  out.print(obj[0]);
                  out.write("');\" >\r\n\t\t</td>\r\n  </tr>\r\n  ");
...
String pagerURL = "/jsoa/oaSysRemindAction.do";
            out.write("\r\n\t\t\t\t\t\t\t\t\t");
