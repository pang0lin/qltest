...
public final class associate_jsp extends org.apache.jasper.runtime.HttpJspBase
...
response.setDateHeader ("Expires", 0);
	...
	String tname = request.getParameter("tablename");
      ...
      try {
        ...
        // /userdb/associate.jsp(41,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("/AssociateAction.do");
        // /userdb/associate.jsp(41,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		if(request.getParameter("pager.offset") != null){
            ...
            try {
              ...
              // /userdb/associate.jsp(99,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("associatelist");
              // /userdb/associate.jsp(99,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("associatelist");
              // /userdb/associate.jsp(99,1) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setScope("request");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object associatelist = null;
                ...
                associatelist = (java.lang.Object) _jspx_page_context.findAttribute("associatelist");
                do {
                  out.write("\r\n\t\t");

			if(index>=flag && index<flag+15){
				 index++;
			Object[] obj = (Object[]) associatelist;
...
if(obj[1]!=null) out.print(obj[1]); else out.print("&nbsp;");
                  ...
                  out.write('"');
                  out.write('>');
if(obj[5]!=null) out.print(obj[5]); else out.print("&nbsp;");
                  out.write("&nbsp;</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
if(obj[8]!=null) out.print(obj[8].toString()); else out.print("&nbsp;");
                  out.write("&nbsp;</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\">&nbsp;");
if(obj[9]!=null){if(obj[9].toString().length()>=10) out.print(obj[9].toString().substring(0,10)); else out.print(obj[9]);} else out.print("&nbsp;");
                  out.write("</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  ...
                  if (_jspx_meth_html_005fimg_005f0(_jspx_th_logic_005fiterate_005f0, _jspx_page_context))
                    return;
                  out.write("</a>&nbsp;<a href=\"javascript:if(confirm('确定删除吗?')) {delone('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
...
String pagerURL = "/jsoa/AssociatetAction.do?tableid="+tid;
            out.write("\r\n\t\t\t\t\t\t\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n</td></tr></table>\r\n</body>\r\n</html>\r\n\r\n<script language=\"javascript\">\r\n\tfunction add(){\t\t//MM_openBrWindow(\"/jsoa/userdb/associate_add.jsp?tableid=");
      out.print(tid);
      out.write("&tablename=");
      out.print(tname);
      out.write("\",\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=500,height=300\") ;\r\n\tMM_openBrWindow(\"/jsoa/AssociateAction.do?operate=add&tableid=");
      out.print(tid);
      out.write("&tablename=");
      out.print(tname);
      out.write("\",\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=500,height=300\") ;\r\n\t\r\n\t}\r\n\r\n\tfunction del(){\r\n\t\tAssociateActionForm.operate.value=\"batchdelete\";\r\n\t\tAssociateActionForm.submit();\r\n\t}\r\n\r\n\tfunction delone(key,name){\r\n\t\tAssociateActionForm.operate.value=\"signledelete\";\r\n\t\tAssociateActionForm.limitid.value=key;\r\n\t\tAssociateActionForm.action+=\"?assname=\"+name;\r\n\t\tAssociateActionForm.submit();\r\n\t}\r\n\r\n\tfunction setValues(lid,lfname,prytid,pryfid){\r\n\t\tvar url=\"/jsoa/AssociateAction.do?operate=edit&lid=\"+lid+\"&lfname=\"+lfname+\"&prytid=\"+prytid+\"&pryfid=\"+pryfid+\"&tableid=");
      out.print(tid);
      out.write("&tablename=");
      out.print(tname);
      out.write("\";\r\n\r\n\t\tMM_openBrWindow(url,\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=500,height=300\") ;\r\n\t}\r\n\r\n\tfunction selectAll(name) {\r\n    var obj=document.all[name];\r\n    if (obj&&obj.length) {\r\n      for (i=0;i<obj.length;i++) {\r\n\t\t  if (!obj[i].disabled)\r\n\t\t\t  obj[i].checked=true;\r\n      }\r\n      return;\r\n    }\r\n    if (obj) {\r\n      obj.checked=true;\r\n    }\r\n  }\r\n\r\n  function clearAll(name) {\r\n    var obj=document.all[name];\r\n    if (obj&&obj.length) {\r\n      for (i=0;i<obj.length;i++) {\r\n        if (!obj[i].disabled)\r\n\t\t\tobj[i].checked=false;\r\n      }\r\n      return;\r\n    }\r\n    if (obj) {\r\n      obj.checked=false;\r\n    }\r\n  }\r\n  function selectID(obj){\r\n\t  if (obj.checked)\r\n\t\t  selectAll('id');\r\n\t  else\r\n\t\t  clearAll('id');\r\n  }\r\n\r\n  function openNew(url){\r\n\tMM_openBrWindow(url,\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=300\") ;\r\n}\r\nfunction changePanle(obj,url){\r\n\t    location.href=url;\r\n\t}\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
  ...
  private boolean _jspx_meth_html_005fimg_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /userdb/associate.jsp(114,121) name = border type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f0.setBorder("0");
      // /userdb/associate.jsp(114,121) name = src type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f0.setSrc("/jsoa/images/modi.gif");
      // /userdb/associate.jsp(114,121) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f0.setStyle("cursor:'hand'");
      // /userdb/associate.jsp(114,121) name = alt type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fimg_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /userdb/associate.jsp(114,294) name = border type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f1.setBorder("0");
      // /userdb/associate.jsp(114,294) name = src type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f1.setSrc("/jsoa/images/del.gif");
      // /userdb/associate.jsp(114,294) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f1.setStyle("cursor:'hand'");
      // /userdb/associate.jsp(114,294) name = alt type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
