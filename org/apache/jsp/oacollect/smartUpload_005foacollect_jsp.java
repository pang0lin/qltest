...
public final class smartUpload_005foacollect_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.oa.oacollect.bean.OACollectFileEJBBean");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String currenid = "0";
	if (request.getParameter("currenid") != null
			&& !"null".equals(request.getParameter("currenid"))) {
						...
						|| fileType.indexOf(fileSuffix) >= 0)//对扩展名无限制,或者当前文件扩展名符合限制
				{
					...
					//} else {
						...
						filePath = request.getSession()
								.getServletContext().getRealPath("/")+ "upload/"+cal.get(Calendar.YEAR)+"/"+path+"/";
						...
						list.add(cal.get(Calendar.YEAR)+"_"+myRandom);
						list.add(fileName);
						list.add(fileSuffix);
      ...
      out.write("\r\n<SCRIPT LANGUAGE=\"JavaScript\">\r\n          alert(\"您的个人文档空间不足!\");\r\n      </script>\r\n\r\n");
			...
			try {
				if (listObj != null && listObj.size() > 0) {
					OACollectFileEJBBean collectFileEJBBean = new OACollectFileEJBBean();
						boolean result = false;
						result =collectFileEJBBean.uploadPiLiang(listObj);
				}
			} catch (Exception e) {
				e.printStackTrace();
			}
