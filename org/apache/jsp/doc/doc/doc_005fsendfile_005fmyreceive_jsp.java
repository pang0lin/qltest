...
public final class doc_005fsendfile_005fmyreceive_jsp extends org.apache.jasper.runtime.HttpJspBase
    implements org.apache.jasper.runtime.JspSourceDependent,
                 org.apache.jasper.runtime.JspSourceImports {


private String getSendDate(String processIds,String recordId){
	String sendDate="";
	Connection conn=null;
	try{
		conn=new com.js.util.util.DataSourceBase().getDataSource().getConnection();
		Statement stmt=conn.createStatement();
		java.sql.ResultSet rs=stmt.executeQuery("SELECT WORKDONEWITHDATE FROM jsf_work WHERE workstatus=100 AND WORKPROCESS_ID IN("+processIds+") AND WORKRECORD_ID="+recordId + " ORDER BY wf_work_id DESC");
		if(rs.next()){
...
private String getAllProcessIds(){
	String processIds="0";
	Connection conn=null;
	try{
		conn=new com.js.util.util.DataSourceBase().getDataSource().getConnection();
		Statement stmt=conn.createStatement();
		java.sql.ResultSet rs=stmt.executeQuery("SELECT wf_workflowprocess_id FROM jsf_workflowprocess wfp JOIN jsf_package p ON wfp.wf_package_id=p.wf_package_id WHERE wfp.WF_PACKAGE_ID=p.WF_PACKAGE_ID AND p.WF_MODULE_ID=2");
		while(rs.next()){
			processIds+=","+rs.getString(1);
		}
		rs.close();
		stmt.close();
		conn.close();		
...
String processIds=getAllProcessIds();
...
int endDate1 = endDate.getDate();
 ...
 if(request.getAttribute("tag")!=null&&!request.getAttribute("tag").toString().equals("")){
 tagAtt=request.getAttribute("tag").toString();
 }
 if(request.getParameter("tag")!=null&&!request.getParameter("tag").toString().equals("")){
  tagAtt=request.getParameter("tag").toString();
 }
            ...
            try {
              ...
              // /doc/doc/doc_sendfile_myreceive.jsp(131,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/GovReceiveFileBoxAction.do?action=list");
              // /doc/doc/doc_sendfile_myreceive.jsp(131,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
	 ...
	 String listClass="listTableLine1";
                  ...
                  try {
                    ...
                    // /doc/doc/doc_sendfile_myreceive.jsp(204,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("mylist");
                    // /doc/doc/doc_sendfile_myreceive.jsp(204,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("mylist");
                    // /doc/doc/doc_sendfile_myreceive.jsp(204,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
obj = (Object[])mylist;
		 ...
		 if(obj[13]!=null&&!"".equals(""+obj[13])){
			...
			int ff=sendFileBD.getOutSeeNum(""+session.getAttribute("userId"));
			if(ff>0){
			 notRead=false;
			} 
		 }else if(obj[11]!=null&&"1".equals(""+obj[11])){
		 notRead=false;		 
		 }
                        ...
                        out.print(listClass);
                        out.write("\" nowrap>");
                        out.print(notRead?"<b><label>":"");
                        out.print(obj[1]==null?"&nbsp;":obj[1].toString().replace('〔','[').replace('〕',']'));
                        out.print(notRead?"</label></b>":"");
                        out.write("&nbsp;</td>\r\n\t\t\t <td class=\"");
                        out.print(listClass);
                        out.write("\">\r\n\t\t\t\t ");
                        out.print(notRead?"<b>":"");
                        out.write("\r\n\t\t\t\t <a href=\"javascript:void(0);\" style=\"cursor:pointer\" title=\"");
                        ...
                        out.write("\" nowrap>");
                        out.print(notRead?"<b><label>":"");
                        out.print(getSendDate(processIds,obj[0].toString()) );
                        out.write("</td>\r\n\t\t\t <!-- <td class=\"");
                        out.print(listClass);
                        out.write('"');
                        out.write('>');
			 ...
			 if(obj[10]!=null && !"null".equals(obj[10].toString())){
			 
                        out.write("\r\n    <a href=\"/jsoa/download.jsp?");
                        out.print(com.js.util.util.BASE64.BASE64EncoderNoBR("FileName="+obj[10].toString()+obj[14].toString()+"&name="+obj[2].toString()+obj[14].toString()+"&moduleCode=doc_sendfile_receive&path=govdocumentmanager"));
                        out.write("\">下载正文</a>\r\n\t\t\t ");
}else{
                        out.write("\r\n\t\t\t <a href=\"#\" onclick=\"alert('该收文无正文！');\">下载正文</a>\r\n\t\t\t ");
}
                        out.write("\r\n\t\t\t ");
                        out.print(notRead?"</label></b>":"");
                        out.write("\r\n\t\t\t </td> -->\r\n\t\t\t <td class=\"");
                        out.print(listClass);
                        out.write(" listTableLineLastTD\"><img  style=\"cursor:pointer\" border=\"0\" src=\"images/del.gif\" alt=\"删除\" onclick=\"del('");
                        out.print(obj[0]);
                        out.write("','','");
                        out.print(obj[9]);
                        out.write("')\"></td>\r\n\t\t </tr>\r\n\t ");
...
String pagerURL = "/jsoa/GovReceiveFileBoxAction.do";
                  out.write('\r');
                  out.write('\n');
                  out.write('	');
...
int deloffset =  countRecordCount == 1 ? offset1-15:offset1 ;
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/doc_sendfile_myreceive.jsp(138,2) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyleClass("inputtext");
      // /doc/doc/doc_sendfile_myreceive.jsp(138,2) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setProperty("queryTitle");
      // /doc/doc/doc_sendfile_myreceive.jsp(138,2) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftext_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/doc_sendfile_myreceive.jsp(141,20) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setStyleClass("inputtext");
      // /doc/doc/doc_sendfile_myreceive.jsp(141,20) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setProperty("queryOrg");
      // /doc/doc/doc_sendfile_myreceive.jsp(141,20) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftext_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/doc_sendfile_myreceive.jsp(145,2) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setStyleClass("inputtext");
      // /doc/doc/doc_sendfile_myreceive.jsp(145,2) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setProperty("queryNumber");
      // /doc/doc/doc_sendfile_myreceive.jsp(145,2) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fselect_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/doc_sendfile_myreceive.jsp(152,2) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fselect_005f0.setProperty("querySecret");
      // /doc/doc/doc_sendfile_myreceive.jsp(152,2) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005foption_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/doc_sendfile_myreceive.jsp(153,4) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005foption_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/doc_sendfile_myreceive.jsp(154,4) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005foption_005f1.setValue("普通");
  ...
  private boolean _jspx_meth_html_005foption_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/doc_sendfile_myreceive.jsp(155,4) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005foption_005f2.setValue("机密");
  ...
  private boolean _jspx_meth_html_005foption_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/doc_sendfile_myreceive.jsp(156,4) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005foption_005f3.setValue("秘密");
  ...
  private boolean _jspx_meth_html_005foption_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/doc_sendfile_myreceive.jsp(157,4) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005foption_005f4.setValue("绝密");
  ...
  private boolean _jspx_meth_html_005fcheckbox_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/doc_sendfile_myreceive.jsp(173,2) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fcheckbox_005f0.setValue("1");
      // /doc/doc/doc_sendfile_myreceive.jsp(173,2) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fcheckbox_005f0.setProperty("queryItem");
      // /doc/doc/doc_sendfile_myreceive.jsp(173,2) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
