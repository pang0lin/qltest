 ...
 */
package org.apache.jsp.wap2.news;
...
public final class waplist_005f3g_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(!conType.equals("_events_")&&!conType.equals("_meets_")){
...
if(conType.equals("_news_")||conType.equals("_notices_")){ 
    if(!obj[6].toString().equals("3")){
      ...
      out.print(path);
      out.write("/wap.do?method=readInfo&conType=");
      out.print(conType );
      out.write("&readId=");
      out.print(obj[1]);
      out.write("&title=");
      ...
      out.write("\r\n       <DIV class=lista1>\r\n         <DIV class=l1>\r\n             <A class=listing href=\"/jsoa/wap2/wapdownload.jsp?");
      out.print(com.js.util.util.BASE64.BASE64EncoderNoBR("FileName="+obj[13]+"&name="+obj[2]+"&path=information&informationId="+obj[1]+"&type="+conType+"&beginIndex="+beginIndex) );
      out.write("\">\r\n             ");
      out.print(obj[2]);
      out.write("</A>\r\n         </DIV>\r\n         <SPAN>");
      out.print(obj[16]);
	...
	if(upIndex>=0)upUrl=path+"/wap.do?method=getDetailContent&conType="+conType+"&beginIndex="+upIndex;
	if(nextIndex<recordCount)nextUrl=path+"/wap.do?method=getDetailContent&conType="+conType+"&beginIndex="+nextIndex;
