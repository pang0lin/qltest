...
public final class employeeGnwgxList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
canAdd="0";
 ...
 if(canAdd.equals("1")){
      ...
      try {
        ...
        // /personnel_manager/employeeGnwgxList.jsp(145,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("gnwgxList");
        // /personnel_manager/employeeGnwgxList.jsp(145,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("gnwgxList");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object gnwgxList = null;
          ...
          gnwgxList = (java.lang.Object) _jspx_page_context.findAttribute("gnwgxList");
          do {
            out.write("\r\n\t\t");

		  gnwgxObj = (Object[]) gnwgxList;
		  index ++;
...
if(index%2 != 0){listClass="listTableLine2";}
            ...
            out.print((""+gnwgxObj[1]));
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print((""+gnwgxObj[2]));
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\" style=\"word-break:break-all;\">");
            out.print(gnwgxObj[3]);
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\" style=\"word-break:break-all;\">");
            out.print(gnwgxObj[4]==null?"&nbsp;":gnwgxObj[4]);
            out.write("&nbsp;</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(gnwgxObj[5]);
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(gnwgxObj[6]);
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(gnwgxObj[7]);
            out.write("</td>\r\n\t\t  ");
 if(canAdd.equals("1")){
            out.write("\r\n\t\t  <td class=\"listTableLine3 listTableLineLastTD\" nowrap>\r\n\t\t  \t<img src=\"images/modi.gif\" alt=\"修改\" style=\"cursor:pointer\" onClick=\"modify('");
            out.print(gnwgxObj[0]);
...
if(!deleteSuccess.booleanValue()){
      out.write("\r\n<script language=\"javascript\">\r\nalert(\"删除失败！您选择的国内外主要社会关系情况正在使用\");\r\n</script>\r\n");
}
      out.write("\r\n</html>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction search(){\r\n    form2.submit();\r\n}\r\nfunction delSingle(id){\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=\"/jsoa/EmployeeGnwgxAction.do?action=delete&gnwgxId=\" + id+\"&empID=");
      out.print(empID);
      out.write("&open=");
      out.print(open);
      out.write("\" ;\r\n    }\r\n}\r\nfunction modify(id){\r\n    MM_openBrWindow('/jsoa/EmployeeGnwgxAction.do?action=modify&gnwgxId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=600,height=350')\r\n}\r\n\tfunction view(id){\r\n    MM_openBrWindow('/jsoa/EmployeeGnwgxAction.do?action=view&gnwgxId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
