...
public final class boardRoomUseList_jsp extends org.apache.jasper.runtime.HttpJspBase
	...
	if(request.getAttribute("boardroomApplyType") !=null){
		boardroomApplyType = request.getAttribute("boardroomApplyType").toString();
            ...
            try {
              ...
              // /routine/boardroom/boardRoomUseList.jsp(80,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/BoardRoomAction.do?action=boardRoomUseSearch");
              // /routine/boardroom/boardRoomUseList.jsp(80,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  try {
                    ...
                    // /routine/boardroom/boardRoomUseList.jsp(96,5) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("List");
                    // /routine/boardroom/boardRoomUseList.jsp(96,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("boardroomApplyTypeList");
                    // /routine/boardroom/boardRoomUseList.jsp(96,5) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(request.getParameter("orderbytime")==null){
            ...
            out.write("</a></td>\r\n\t\t<td class=\"listTableHead\" width=\"15%\">会议室名称<a href=\"javascript:orderby('/jsoa/BoardRoomAction.do?action=boardRoomUseSearch&flag=all&orderbystatus=");
	...
	SimpleDateFormat timeFormat = new SimpleDateFormat("HH:mm");
		...
		if(request.getParameter("pager.offset")!=null){
            ...
            try {
              ...
              // /routine/boardroom/boardRoomUseList.jsp(176,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setId("List");
              // /routine/boardroom/boardRoomUseList.jsp(176,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n<iframe name=\"myIframe\" id=\"myIframe\" style=\"display:none\"></iframe>\r\n</body>\r\n<script language=\"javascript\">\r\n\r\n\r\nfunction search(){\r\n    //\tdocument.BoardRoomActionForm.submit();\r\n    var hhref = \"&flag=all&searchBoardRomeName=\"+document.all.searchBoardRomeName.value+\"&searchBoardRomeEmcee=\"+document.all.searchBoardRomeEmcee.value\r\n\t\t    +\"&searchBoardRomeMotif=\"+document.all.searchBoardRomeMotif.value+\"&searchApplyName=\"+document.all.searchApplyName.value+\"&boardroomApplyType=\"\r\n\t\t    +document.all.boardroomApplyType.value+\"&searchStartDate=\"+document.all.searchStartDate.value+\"&searchEndDate=\"+document.all.searchEndDate.value;\r\n\tif(document.all.searchDatecheckbox.checked){\r\n    hhref += \"&searchDatecheckbox=1\";\r\n\t}\r\n\twindow.location.href=\"/jsoa/BoardRoomAction.do?action=boardRoomUseSearch&saveType=boardRoomUseSearch\"+hhref;\r\n}\r\n\r\nfunction cleared(){\r\n    /* window.location.href=\"/jsoa/BoardRoomAction.do?action=useBoardroomView\"; */\r\n    window.location.href=\"/jsoa/BoardRoomAction.do?action=useBoardroomView&flag=all\";\r\n");
 ...
 int  deloff = j==1? pageSize2-15:pageSize2;
         if(deloff<0) deloff =0 ;
            ...
            out.print(deloff);
            out.write(",\"myIframe\");\r\n\t\t//window.location.href=\"/jsoa/BoardRoomAction.do?action=cancelBoardroomApply&boardroomApplyId=\"+id+\"&pager.offset=\"+");
            out.print(deloff);
