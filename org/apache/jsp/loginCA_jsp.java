...
public final class loginCA_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String original=com.js.oa.logon.util.CAXmlUtil.generateRandomNum();

      out.write('\r');
      out.write('\n');
if("1".equals(SystemCommon.gethuanbaobuCA())){
      out.write("\r\n<object classid=\"clsid:707C7D52-85A8-4584-8954-573EFCE77488\" id=\"JITDSignOcx\" width=\"0\" codebase=\"/jsoa/JITDSign.cab#version=2,0,24,19\"></object>\r\n");
} 
...
if("1".equals(SystemCommon.gethuanbaobuCA())){
      ...
      out.write("\r\n\t\t\r\n}\r\n</script>\r\n\r\n</head>\r\n<body onUnload=\"javascript:unLoad();\" onLoad=\"javascript:doDataProcess();load();checkIE11();initHeight();jumpErr();\">\r\n");
      //  html:form
      ...
      try {
        ...
        // /loginCA.jsp(124,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("/CheckUser");
        // /loginCA.jsp(124,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setMethod("post");
        int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
        if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n<input type=\"hidden\" name=\"checkBrow\" id=\"checkBrow\" value=\"\"/>\r\n<input type=\"hidden\" name=\"checkCA\" id=\"checkCA\" value=\"");
            out.print(request.getAttribute("checkCA"));
...
String CA=(String)request.getAttribute("CA");
if("false".equals(CA)){
