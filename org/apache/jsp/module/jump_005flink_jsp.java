...
public final class jump_005flink_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String userId = session.getAttribute("userAccount").toString();
...
obj=service.getMenuActionAndPara(menuId,flag);
action=obj[0].toString();
parameters=obj[1]==null?"":obj[1].toString();


parameters=parameters.replaceAll("\\@\\$\\@userId\\@\\$\\@",userId);
parameters=parameters.replaceAll("\\@\\$\\@orgId\\@\\$\\@",orgId);
parameters=parameters.replaceAll("\\@\\$\\@userAccount\\@\\$\\@",userAccount);
parameters=parameters.replaceAll("\\@\\$\\@userName\\@\\$\\@",userName);

String currentServer=request.getServerName();
String scheme=request.getScheme();

action=action.replaceAll("\\@\\$\\@currentServer\\@\\$\\@",scheme+"://"+currentServer);
