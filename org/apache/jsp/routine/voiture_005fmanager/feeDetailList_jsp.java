...
public final class feeDetailList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
name=java.net.URLDecoder.decode(request.getParameter("name").toString(), "utf-8");

if(request.getParameter("num")!=null)
num=java.net.URLDecoder.decode(request.getParameter("num").toString(), "utf-8");
...
voitureId=request.getParameter("voitureId").toString();
            ...
            out.print(name+"("+num+")");
            out.write("\r\n\t\t</td>\r\n\t\t<td align=\"right\">\r\n\t\t<div align=\"right\">");
if(voitureAddRight.equals("true")){
            out.write("\r\n\t\t<button  class=\"btnButton2Font\" onclick=\"add()\">新增\r\n\t\t</button>");
}
            out.write("\r\n\t\t");
if(voitureMtRight.equals("true")){
            out.write("<button  class=\"btnButton2Font\" style=\"cursor:pointer\" onclick=\"delBatch()\">删除</button>");
}
            out.write("\r\n\t\t</div>\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n\r\n\r\n\r\n\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\t<form  action=\"/VoitureFeeAction.do\"  name=\"form1\" method=\"post\">\r\n\t\t<input type=\"hidden\" name=\"name\" value=\"");
            out.print(name);
            out.write("\">\r\n\t\t<input type=\"hidden\" name=\"num\" value=\"");
            out.print(num);
            out.write("\">\r\n\t\t<tr align=\"center\">\r\n\t\t\t<td width=\"40\" height=\"28\" class=\"listTableHead\" nowrap>\r\n\t\t\t\t<input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n\t\t\t<td class=\"listTableHead\"> 发生日期 </td>\r\n\t\t\t<td width=\"10%\" class=\"listTableHead\"> 是否保养 </td>\r\n\t\t\t<td width=\"8%\" class=\"listTableHeadLast\" nowrap> 处理 </td>\r\n\t\t</tr>\r\n\t\t");

			int listorder=0;
			String nowPage="";
			if(request.getParameter("pager.offset") != null&&!request.getParameter("pager.offset").toString().equals("null")){
			nowPage=request.getParameter("pager.offset").toString();
			listorder = Integer.parseInt(nowPage);
			}
			if(request.getAttribute("new.offset") != null&&!request.getAttribute("new.offset").toString().equals("null")){
			nowPage=request.getAttribute("new.offset").toString();
			listorder = Integer.parseInt(nowPage);
			}
			String maintainTime="";
			String id="";
            ...
            try {
              ...
              // /routine/voiture_manager/feeDetailList.jsp(115,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("voitureFeeDetailList");
              // /routine/voiture_manager/feeDetailList.jsp(115,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("voitureFeeDetailList");
              // /routine/voiture_manager/feeDetailList.jsp(115,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setScope("request");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object voitureFeeDetailList = null;
                ...
                voitureFeeDetailList = (java.lang.Object) _jspx_page_context.findAttribute("voitureFeeDetailList");
                do {
                  out.write("\r\n\t\t");

			Object[] obj = (Object[])voitureFeeDetailList;
			...
			obj[4]=obj[4].equals("1")?"是":"否";
			String listClass="listTableLine1";
if(listorder%2 != 0){listClass="listTableLine2";}
                  ...
                  out.write("</td>\r\n\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\" valign=\"middle\">\r\n\t\t\t");
if(voitureMtRight.equals("true")){
...
String pagerURL = "/jsoa/VoitureFeeAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n<!-- PAGER -->\r\n\r\n</td></tr></table>\r\n\r\n</body>\r\n<script language=\"javascript\">\r\n//添加\r\nfunction add() {\r\n    var hhref  = \"/jsoa/VoitureFeeAction.do?action=addwindow&voitureId=\"+");
            out.print(voitureId);
            out.write(" ;\r\n     MM_openBrWindow(hhref,\"\",\"TOP=0,LEFT=0,scrollbars=no,resizable=no,width=570,height=450\") ;\r\n}\r\n\r\nfunction modify(id){\r\n\tMM_openBrWindow('VoitureFeeAction.do?action=modify&voitureFeeId='+id+\"&voitureId=\"+");
            out.print(voitureId);
            out.write("+\"&pager.offset=");
            out.print(nowPage);
            out.write("\",'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=670,height=450')\r\n}\r\n\r\nfunction delBatch() {\r\n\tvar num=document.all.num.value;\r\n    var name=document.all.name.value;\r\n    var strId=getCheckBoxID();\r\n        if(strId!=\"\"){\r\n     if(confirm(\"确实要删除吗？\")){\r\n    \twindow.location.href=\"/jsoa/VoitureFeeAction.do?action=delBatch&ids=\"+strId+\"&voitureId=\"+");
            out.print(voitureId);
            out.write("+\"&name=\"+name+\"&num=\"+num;\r\n    }\r\n    }else{\r\n             alert(\"请选择要删除的记录!\");\r\n             return;\r\n         }\r\n}\r\n\r\nfunction del(id){\r\n\r\n    if(confirm(\"确实要删除吗？\")){\r\n\tvar num=document.all.num.value;\r\n    var name=document.all.name.value; window.location.href=\"/jsoa/VoitureFeeAction.do?action=delVoitureFee&voitureFeeId=\"+id+\"&voitureId=\"+");
            out.print(voitureId);
