...
public final class form_005fsetbatchfieldvalue_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int filterSQL=0;
if(com.js.util.config.SystemCommon.getCustomerName().equals("haier")||com.js.util.config.SystemCommon.getCustomerName().equals("TXFH")){
	filterSQL=1;
}else{
	filterSQL=StaticParam.filterSQL(sql, para);
}
if(filterSQL>0){
	String fields=request.getParameter("subFields");
	...
	try{	
		...
		while(rs.next()){
			...
			for(int i=0;i<fieldArr.length;i++){
				...
				buffer.append("<fielddata>").append(rs.getString((i+1))==null?"*!KongValue!*":CharacterTool.replaceXMLTags(rs.getString((i+1)))).append("</fielddata>");
				buffer.append("</data>");
			}	
			buffer.append("</datas>");
		}
