...
public final class workflow_005factiveinfo_jsp extends org.apache.jasper.runtime.HttpJspBase
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /jsflow/workflow_activeinfo.jsp(44,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/ActivityAction");
              // /jsflow/workflow_activeinfo.jsp(44,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("\">\r\n\t<tr>\r\n\t\t<td width=\"2%\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"sa\" onclick=\"selectAll(this);\"></td>\r\n\t\t<td width=\"20%\" class=\"listTableHead\">");
                  ...
                  if (_jspx_meth_bean_005fmessage_005f3(_jspx_th_html_005fform_005f0, _jspx_page_context))
                    return;
                  out.write("</td>\r\n\t\t<td width=\"37%\" class=\"listTableHead\">");
		 ...
		 if(request.getParameter("pager.offset") != null){
			index = Integer.parseInt(request.getParameter("pager.offset"));
                  ...
                  try {
                    ...
                    // /jsflow/workflow_activeinfo.jsp(64,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("activityList");
                    // /jsflow/workflow_activeinfo.jsp(64,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("activityList");
                    int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
                    if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      java.lang.Object activityList = null;
                      ...
                      activityList = (java.lang.Object) _jspx_page_context.findAttribute("activityList");
                      do {
                        out.write("\r\n\t\t");
Object[] obj = (Object[]) activityList;
			index ++;
			...
			if(index%2 != 0){listClass="listTableLine2";}
                        ...
                        out.write("\"></td>\r\n\t\t<td class=\"");
                        out.print(listClass);
                        out.write("\"><a href=\"javascript:listActi('");
                        out.print(obj[0]);
                        out.write("');\">");
                        out.print(obj[1]);
                        out.write("</a></td>\r\n\t\t <td class=\"");
                        out.print(listClass);
                        out.write("\">\r\n                                  ");
switch(Integer.parseInt(obj[4].toString())){
                                      case 0:
                                      out.print(Resource.getValue(local,"workflow","workflow.newactivityson"));
                                      break;
                                      case 1:
                                      out.print(Resource.getValue(local,"workflow","workflow.newactivitystandard"));
                                      break;
                                      case 2:
                                      out.print(Resource.getValue(local,"workflow","workflow.newactivityvirtual"));
									  break;
									  /**********增加自动回复节点显示 ***********/
									  case 3:
									  out.print(Resource.getValue(local,"workflow","workflow.newactivityautoback"));
									  /**********增加自动回复节点显示 ************/
                                      break;
                                  }
                        out.write("\r\n\t\t</td>\r\n\t\t<td class=\"");
                        ...
                        out.write('"');
                        out.write('>');
if(obj[2] != null) out.print(obj[2]);
                        out.write("&nbsp;</td>\r\n\t\t<td class=\"");
                        out.print(listClass);
                        out.write("\"><a href=\"javascript:MM_openBrWindow('/jsoa/ActivityAction.do?action=relation&processId=");
                        out.print(request.getAttribute("processId"));
...
String pagerURL = "/jsoa/ActivityAction.do";
            out.write("\r\n\t\t\t\t\t\t\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.print(Resource.getValue(local,"workflow","workflow.activitydelthis"));
            out.write("\")){\r\n    \twindow.location.href=\"/jsoa/ActivityAction.do?action=singleDelete&activityId=\"+id+\"&processId=");
            out.print(request.getAttribute("processId"));
            out.write("&tableId=");
            out.print(request.getAttribute("tableId"));
            out.write("&moduleId=");
            ...
            out.print(Resource.getValue(local,"workflow","workflow.activitydelsel"));
            out.write("\")){\r\n           document.all.action.value = \"batchDelete\";\r\n           ActivityActionForm.submit();\r\n    \t}\r\n    }else{\r\n    \talert(\"");
            out.print(Resource.getValue(local,"workflow","workflow.activityseldel"));
            out.write("\");\r\n    }\r\n}\r\n\r\nfunction deleteAll(id){\r\n    if(confirm(\"");
            out.print(Resource.getValue(local,"workflow","workflow.activitydelall"));
            out.write("\")){\r\n\twindow.location.href = \"/jsoa/ActivityAction.do?action=deleteAll&processId=\"+id+\"&processId=");
            out.print(request.getAttribute("processId"));
            out.write("&tableId=");
            out.print(request.getAttribute("tableId"));
            out.write("&moduleId=");
            out.print(request.getAttribute("moduleId"));
            out.write("\";\r\n    }\r\n}\r\n\r\nfunction modify(id){\r\n    MM_openBrWindow(\"/jsoa/ActivityAction.do?action=modify&activityId=\"+id+\"&processId=");
            out.print(request.getAttribute("processId"));
            out.write("&tableId=");
            out.print(request.getAttribute("tableId"));
            out.write("&moduleId=");
            out.print(request.getAttribute("moduleId"));
            out.write("\",'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600');\r\n}\r\nfunction listActi(id){\r\n    MM_openBrWindow(\"/jsoa/ActivityAction.do?action=modify&activityId=\"+id+\"&processId=");
            out.print(request.getAttribute("processId"));
            out.write("&tableId=");
            out.print(request.getAttribute("tableId"));
            out.write("&moduleId=");
            out.print(request.getAttribute("moduleId"));
            out.write("&hideButton=1\",'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600');\r\n}\r\n\r\nfunction selectAll(obj){\r\n    if(document.all.batchId){\r\n        if(document.all.batchId.length){\r\n            for(var i = 0; i < document.all.batchId.length; i ++){\r\n            \tif(obj.checked){\r\n                    document.all.batchId[i].checked = true;\r\n                }else{\r\n                    document.all.batchId[i].checked = false;\r\n                }\r\n            }\r\n        }else{\r\n            if(obj.checked){\r\n                document.all.batchId.checked = true;\r\n            }else{\r\n                document.all.batchId.checked = false;\r\n            }\r\n\r\n        }\r\n\r\n    }\r\n}\r\n\r\nfunction setFlowPhoto(){\r\n   MM_openBrWindow(\"/jsoa/jsflow/jsflow_view.jsp?processId=");
            out.print(request.getAttribute("processId"));
            out.write("&manager=1\",\"\",\"\");\r\n}\r\n//-->\r\n</script>\r\n");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_activeinfo.jsp(36,344) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("common");
      // /jsflow/workflow_activeinfo.jsp(36,344) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_activeinfo.jsp(37,71) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("common");
      // /jsflow/workflow_activeinfo.jsp(37,71) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setKey("comm.delselect");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_activeinfo.jsp(51,40) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setBundle("workflow");
      // /jsflow/workflow_activeinfo.jsp(51,40) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setKey("workflow.activityname");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_activeinfo.jsp(52,40) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setBundle("workflow");
      // /jsflow/workflow_activeinfo.jsp(52,40) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setKey("workflow.activitytype");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_activeinfo.jsp(53,40) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setBundle("workflow");
      // /jsflow/workflow_activeinfo.jsp(53,40) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setKey("workflow.activitydescription");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_activeinfo.jsp(54,40) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f5.setBundle("workflow");
      // /jsflow/workflow_activeinfo.jsp(54,40) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f5.setKey("workflow.activitysetup");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_activeinfo.jsp(55,50) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f6.setBundle("workflow");
      // /jsflow/workflow_activeinfo.jsp(55,50) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f6.setKey("workflow.categoryoperation");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_activeinfo.jsp(92,392) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f7.setBundle("workflow");
      // /jsflow/workflow_activeinfo.jsp(92,392) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f7.setKey("workflow.activitysetup");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_activeinfo.jsp(93,110) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f8.setBundle("common");
      // /jsflow/workflow_activeinfo.jsp(93,110) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_activeinfo.jsp(93,253) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f9.setBundle("common");
      // /jsflow/workflow_activeinfo.jsp(93,253) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
