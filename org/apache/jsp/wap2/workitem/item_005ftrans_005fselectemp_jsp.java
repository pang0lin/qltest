 ...
 * Generated at: 2023-01-06 09:46:48 UTC
...
conn.close();
      ...
      out.write("\">\r\n\t\r\n\t<div class=\"f_1\">事项转办</div>\r\n    <div class=\"box_2\">\r\n    \t<div class=\"list_2\">\r\n\t\t\t\t<div class=\"t1\">自动返回:</div>\r\n\t\t\t\t<div class=\"t2\"><input type=\"checkbox\" name=\"actionType\" value=\"tranByReturn\"/>\r\n\t\t\t\t</div>\r\n\t\t\t\t<div class=\"clear\"></div>\r\n\t\t</div> \r\n    \t<div class=\"list_2\">\r\n\t\t\t\t<div class=\"t1\">批示意见:</div>\r\n\t\t\t\t<div class=\"t2\">\r\n\t\t\t\t<textarea id=\"include_comment\" name=\"include_comment\" rows=\"2\" maxlength=\"1000\"></textarea>\r\n\t\t\t\t</div>\r\n\t\t\t\t<div class=\"clear\"></div>\r\n\t\t</div>    \r\n    \t<div class=\"list_2\">\r\n\t\t\t<div class=\"t1\">办理人：</div>\r\n\t\t\t<div class=\"t2\">\r\n\t\t\t\r\n    \r\n    \r\n\r\n  ");
    ...
    if("0".equals(tranType)){
      ...
      out.print(selectedOprater );
      out.write("\">\r\n\t\t\t");

		}
		if(selectedOprater!=null && !"null".equals(selectedOprater)){
			if(selectedOprater.split(",").length>1){
				selectedOprater=selectedOprater.split(",")[1];
			}
		}else{
			selectedOprater="";
		}
...
if(!"".equals(selectedOprater)){ 
      out.write("\r\n\t\t<br><br><input class=\"button2\" type=\"button\" onclick=\"javascript:submitForm();\" value=\"确定\"/>\r\n\t\t");
}
      ...
      out.write("<br/>\r\n\t\t<input class=\"button2\" type=\"button\" onclick=\"javascript:submitForm();\" value=\"确定\"/>\r\n\t\t");
		...
		}else if(participantType==6 || participantType==14 || participantType==0 || participantType==7 || participantType==11 || participantType==2){
      ...
      out.print(path);
      out.write("/wap2/workitem/item_submit_trans.jsp?fromSelUser=1\";\r\n\tdocument.frm.submit();\r\n}\r\nfunction searchEmp(){\r\n\tdocument.frm.action=\"");
      out.print(path);
      out.write("/wap2/workitem/item_select_emp_search_3g.jsp?fromParent=trans\";\r\n\tdocument.frm.submit();\r\n}\r\nfunction endForm(){\r\n\tdocument.frm.action=\"\";\r\n\tdocument.frm.submit();\r\n}\r\n</script>");
