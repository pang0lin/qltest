...
public class WeixinManageAction extends Action {
  private static Logger log = Logger.getLogger(WeixinManageAction.class);
  
  private static Properties prop = null;
  
  private static String path = WeixinManageAction.class.getClassLoader().getResource("/com/js/oa/weixin/manage/weixin.properties").getPath();
  ...
  private static void store() {
    try {
      ...
      prop.store(out, "weixin config file");
    } catch (IOException e) {
      e.printStackTrace();
    } 
  }
