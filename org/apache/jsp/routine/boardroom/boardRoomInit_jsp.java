 ...
 * Generated at: 2023-01-06 09:48:34 UTC
...
public final class boardRoomInit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(c_flag){
            ...
            out.write("');\" title=\"下一天\"><img src=\"/jsoa/skin/");
            out.print(session.getAttribute("skin"));
 ...
 out.print(java.text.DateFormat.getDateInstance(java.text.DateFormat.LONG  ,java.util.Locale.CHINA).format((new java.util.Date(nowYear-1900, nowMonth-1, nowDay))));
            out.write("\r\n\t  </div>\r\n\t</td>\r\n\t<td align=\"right\">\r\n\t\t<button class=\"btnButton4Font\" onClick=\"useApply()\">使用申请</button>\r\n\t</td>\r\n  </tr>\r\n</table>\r\n\r\n");
            //  html:form
            ...
            try {
              ...
              // /routine/boardroom/boardRoomInit.jsp(121,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("BoardRoomAction");
              // /routine/boardroom/boardRoomInit.jsp(121,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n<table border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"1\" class=\"listTable \" style=\"border-bottom:0px;\" width=\"100%\">\r\n                      <tr  align=\"center\" >\r\n                        <td    rowspan=\"2\" align=\"center\" nowrap  class=\"listTableHead\">会议室名称</td>\r\n\t\t\t\t\t\t<td width=\"95\" rowspan=\"2\" align=\"center\"  class=\"listTableHead\"  >0:00-7:59</td>\r\n                        ");
                  ...
                  out.write("\r\n\t\t\t\t\t</tr>\r\n\t</table>\r\n\t\t\t\t<table border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\" width=\"100%\">\r\n                      ");
...
for(int j=0;j<searchDate.size();j++){
						...
						String voiturePlace[]= new BoardRoomBD().getBoardRoomInfo(obj[0].toString(),formatter.format(searchStartDate));
 ...
 for( int i = 0 ; i <96 ; i++){
							if(voiturePlace[i].equals("false")){
                  out.write("\r\n                            <div style=\"font-size:1px;background-color:white;width:1px;padding:0px;margin:0px;height:100%;float:left;\">&nbsp;</div>\r\n                            ");
}else{
                  out.write("\r\n                            <div style=\"font-size:1px;background-color:gray;width:1px;padding:0px;margin:0px;height:100%;float:left;\">&nbsp;</div>\r\n                        ");
}}
                  out.write("</td>\r\n                          ");
for(int k=0;k<24;k++){
                  out.write("\r\n\t\t\t\t\t\t    <td width=\"18\" class=\"");
 ...
 for(int l = 0 ; l <6; l++){
                  out.write("\r\n                            ");
if(voiturePlace[96+k*6+l].equals("false")){
                  out.write("\r\n\t\t\t\t\t\t\t<div style=\"font-size:1px;background-color:white;width:3px;padding:0px;margin:0px;height:100%;float:left;\">&nbsp;</div>\r\n                            ");
}else{
                  out.write("\r\n                            <div style=\"font-size:1px;background-color:gray;width:3px;padding:0px;margin:0px;height:100%;float:left;\">&nbsp;</div>\r\n                            ");
}}
                  out.write("\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t");
}
                  out.write("\r\n\t\t\t\t\t\t  <td width=\"96\" class=\"");
                  ...
                  out.write("\" style=\"padding:0px\">\r\n\t\t\t\t\t\t  ");
							...
							if(voiturePlace[i].equals("false")){
                  out.write("\r\n                            <div style=\"font-size:1px;background-color:white;width:2px;padding:0px;margin:0px;height:100%;float:left;\">&nbsp;</div>\r\n                            ");
}else{
                  out.write("\r\n                            <div style=\"font-size:1px;background-color:gray;width:2px;padding:0px;margin:0px;height:100%;float:left;\">&nbsp;</div>\r\n                        ");
}}
                  out.write("</td>\r\n\t\t\t\t\t\t<td width=\"30\"   class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\"  ><img\tsrc=\"images/sq.gif\" alt=\"申请\"\tstyle=\"cursor:pointer\"\tonclick=\"apply('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t<br />\r\n\t<button class=\"btnButton4Font\" onClick=\"showBoardInfo('");
            out.print(request.getParameter("searchStartDate"));
            out.write("')\">显示会议信息</button>\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n");
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\nfunction search(){\r\n    frm1.submit();\r\n}\r\n\r\nfunction cleared(){\r\n    document.location.href=\"BoardRoomAction.do?action=boardRoomView&init=0\";\r\n}\r\n\r\nfunction apply(id,name,processId){\r\n   // var\tselProcess = document.all.selProcess.value;\r\n    MM_openBrWindow('BoardRoomAction.do?action=addBoardroomApplyView&boardroomId='+id+'&boardroomName='+name+'&'+'&moduleId=15','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=350,height=150')\r\n}\r\n\r\nfunction lookState(id,name,type){\r\n    //alert(id);\r\n    MM_openBrWindow('/jsoa/BoardRoomAction.do?action=statuDetail&boardRoomId='+id+'&name='+name+'&type='+type+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=700,height=350')\r\n}\r\n\r\nfunction useApply(){\r\n\tMM_openBrWindow('BoardRoomAction.do?action=addBoardroomApplyView&moduleId=15','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=350,height=250')\r\n}\r\n\r\nfunction showBoardInfo(arg1){\r\n\tif(arg1==null || arg1 == '' || arg1 == 'null'){\r\n\t\tvar d = new Date();\r\n\t\targ1 = d.getYear() + '/' + (d.getMonth()+1) + '/' + d.getDate();\r\n");
      out.write("\t}\r\n\tMM_openBrWindow('/jsoa/BoardRoomAction.do?action=boardRoomUseInfo&searchStartDate='+arg1+'&searchEndDate='+arg1,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=700,height=350')\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
