...
public final class visit_005fcst_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String name=(String)request.getAttribute("cstName");
String proName=(String)request.getAttribute("proName");
String chargeUserId=(String)request.getAttribute("chargeUserId");
String chargeUser=(String)request.getAttribute("chargeUser");
String pjia=(String)request.getAttribute("visitTitle");
      ...
      try {
        ...
        // /crm/visit_cst_list.jsp(51,8) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("/cstVisit.do?method=sreachCstVisitList");
        // /crm/visit_cst_list.jsp(51,8) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setMethod("post");
        int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
        if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n\t   \t\t\t<input type=\"hidden\" name=\"chargeUserId\" value=\"");
            out.print(chargeUserId==null||chargeUserId.equals("")||chargeUserId.equals("null")?"":chargeUserId);
            out.write("\"/>\r\n\t\t\t\t<tr>\r\n\t\t\t\t<td nowrap width=\"22%\">项目名称：<input type=\"text\" name=\"proName\" value=\"");
            out.print(proName==null||proName.equals("")||proName.equals("null")?"":proName);
            out.write("\" class=\"inputText\" style=\"width:65%\"></td>\r\n\t\t\t\t<td nowrap width=\"25%\">客户名称：<input type=\"text\" name=\"custmerName\" value=\"");
            out.print(name==null||name.equals("")||name.equals("null")?"":name);
            out.write("\" class=\"inputText\" style=\"width:70%\"></td>\r\n\t\t\t\t<td nowrap>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;回访人员：\r\n\t\t\t\t  <input type=\"text\" name=\"chargeUser\" class=\"inputText\" onClick=\"selectPeople('chargeUserId','chargeUser','0')\" title=\"点击请选择\" value=\"");
            out.print(chargeUser==null||chargeUser.equals("")||chargeUser.equals("null")?"":chargeUser);
            out.write("\" readonly=\"true\" style=\"cursor:pointer; width:60%\"></td>\r\n\t\t\t\t<td nowrap width=\"23%\">所属行业：");
            if (_jspx_meth_html_005fselect_005f0(_jspx_th_html_005fform_005f0, _jspx_page_context))
              return;
            out.write("</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<tr>\r\n\t\t\t\t<td nowrap width=\"25%\">评&nbsp;&nbsp; 价：\r\n\t\t\t       \t");
            //  html:select
            ...
            try {
              ...
              // /crm/visit_cst_list.jsp(64,11) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fselect_005f1.setProperty("visitTitle");
              // /crm/visit_cst_list.jsp(64,11) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fselect_005f1.setStyle("width:65%");
...
if(pjia!=null&&pjia.equals("优秀")){
                  out.write("selected");
}
                  out.write(">优秀</option>\r\n\t\t\t\t    \t<option value=\"良好\"");
if(pjia!=null&&pjia.equals("良好")){
                  out.write("selected");
}
                  out.write(">良好</option>\r\n\t\t\t\t    \t<option value=\"一般\"");
if(pjia!=null&&pjia.equals("一般")){
                  out.write("selected");
}
                  out.write(">一般</option>\r\n\t\t\t\t    \t<option value=\"较差\"");
if(pjia!=null&&pjia.equals("较差")){
                  out.write("selected");
}
                  out.write(">较差</option>\r\n\t\t\t\t    ");
            ...
            out.write("\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td colspan=\"2\" nowrap>回访时间：");
 
				String start=(String)request.getAttribute("startTime");
      ...
      out.write("\r\n\t  </table>\r\n\t  \t\t<form name=\"mailForm\" method=\"post\">\r\n\t\t<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n\r\n\t\t\t<tr>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t\t<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td align=\"right\">\r\n\t\t\t\t\t\t\t\t    <input type=\"button\"class=\"btnButton2Font\" onClick=\"JSMainWinOpen('/jsoa/cstVisit.do?method=cstVisitProAdd')\" value=\"新建\"/>\r\n");
...
List list = (List) request.getAttribute("cstVisitList");
      ...
      try {
        ...
        // /crm/visit_cst_list.jsp(149,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("cstVisitList");
        // /crm/visit_cst_list.jsp(149,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("cstVisitList");
        // /crm/visit_cst_list.jsp(149,7) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setScope("request");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object cstVisitList = null;
          ...
          cstVisitList = (java.lang.Object) _jspx_page_context.findAttribute("cstVisitList");
          do {
            out.write("\r\n\t\t\t\t\t\t\t\t");

											Object[] obj = (Object[]) cstVisitList;
											String cstName = obj[1].toString();
											String visitType = obj[2].toString();
											String visitTitle = obj[3].toString();
											String createUserName = obj[4].toString();
											String visitTime = obj[5].toString();
											String visitTypeName = obj[7].toString();
											String hangYeName = obj[12].toString();
											index++;
											if(index%2 != 0){
            ...
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t  ");
            out.print(hangYeName );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t        <td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t  ");
            out.print(createUserName );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t  ");
            out.print(visitTitle );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t  ");
            out.print(visitTime );
...
String pagerURL = "/jsoa/cstVisit.do";
      out.write("\r\n\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.print(webapp);
      out.write("'+\"/cstVisit.do?method=cstRemove&id=\"+ids;\r\n     if(ids==null||ids==''){\r\n   alert('请选择要删除的记录！');\r\n    return false;\r\n    \t}else{\r\n\t if(confirm(\"确任要删除吗？\")){\r\n             mailForm.submit();\r\n             return true;\r\n\t\t    }else{\r\n\t\t        return false;\r\n\t\t    }\r\n     }\r\n }else{\r\n \t mailForm.action='");
      out.print(webapp);
      out.write("'+\"/cstVisit.do?method=cstRemove&id=\"+obj;\r\n\t\t if(confirm(\"确任要删除吗？\")){\r\n          mailForm.submit();\r\n          return true;\r\n\t    }else{\r\n\t        return false;\r\n\t    }\r\n }    \r\n}\r\n\r\nfunction update(obj){\r\n  var url=\"/jsoa/cstVisit.do?method=cstVisitProMod&id=\"+obj;\r\n  JSMainWinOpen(url);\r\n}\r\n\t\r\n  function getCheckBoxID() {\r\n    var strCheckBox = \"\" ;\r\n    var k=0;\r\n    for(var i = 0 ; i < document.all.mailForm.length ; i++ ) {\r\n        var obj = document.all.mailForm[i] ;\r\n         if(obj.type == \"checkbox\"  && obj.name==\"batchDel\"){\r\n\t\tif(obj.checked) {\r\n             \tk++;\r\n                strCheckBox += obj.value  ;\r\n                strCheckBox += \",\" ;\r\n\t\t}\r\n         }\r\n    }\r\n    return strCheckBox ;\r\n}\r\n  \r\nfunction changeDate(dateStr){\r\n\tvar strs = dateStr.split('/');\r\n\treturn strs[0] + \"年\" + strs[1] + \"月\" + strs[2] + \"日\";\r\n}\r\n\r\nfunction getDiaStr(start,end){\r\n\r\n\tvar str1 = \"提示：您确定要导出\" + changeDate(start);\r\n\t\r\n\tif(start!=end){\r\n\t\tstr1 = str1 + \"至\" + changeDate(end);\r\n\t}else{\r\n\t\tstr1 = str1 + \"当日\";\r\n\t}\r\n");
      out.write("\t\r\n\treturn str1 + \"的项目信息吗？\";\r\n}\r\n   \r\nfunction exportXLS(){\r\n\tmailForm.target=\"_blank\";\r\n\tvar chargeUserId=document.all.chargeUserId.value;\r\n\tvar custmerName=document.all.custmerName.value;\r\n\tvar proName=document.all.proName.value;\r\n\tvar chargeUser=document.all.chargeUser.value;\r\n\tvar visitTitle=document.all.visitTitle.value;\r\n\tvar startTime=document.all.startTime.value;\r\n\tvar endTime=document.all.endTime.value;\r\n\t\r\n\tif(!confirm(getDiaStr(startTime,endTime))){  \r\n\t\treturn ;      \r\n    }\r\n\t\r\n\tvar hangYeName=document.all.hangYeName.value;\r\n\tvar param=\"\";\r\n\t\r\n\tparam+=\"&all=all\";\r\n\tparam+=\"&chargeUserId=\"+chargeUserId+\"&custmerName=\"+custmerName;\r\n\tparam+=\"&proName=\"+proName+\"&chargeUser=\"+chargeUser+\"&visitTitle=\"+visitTitle;\r\n\tparam+=\"&startTime=\"+startTime+\"&endTime=\"+endTime+\"&hangYeName=\"+hangYeName;\r\n\tmailForm.action=\"/jsoa/cstVisit.do?method=sreachCstVisitList&export=export\"+param;\r\n\tmailForm.submit();\r\n}\r\n\r\nfunction clearr(){\r\n    window.location.href=\"/jsoa/cstVisit.do?method=getCstVisitList\";\r\n}\r\n\r\n</script>\r\n");
  ...
  private boolean _jspx_meth_html_005fselect_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /crm/visit_cst_list.jsp(58,32) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fselect_005f0.setProperty("hangYeName");
      // /crm/visit_cst_list.jsp(58,32) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005foptions_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /crm/visit_cst_list.jsp(59,8) name = collection type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005foptions_005f0.setCollection("cstHTypeList");
      // /crm/visit_cst_list.jsp(59,8) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005foptions_005f0.setProperty("id");
      // /crm/visit_cst_list.jsp(59,8) name = labelProperty type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
