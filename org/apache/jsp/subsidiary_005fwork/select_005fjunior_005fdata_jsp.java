 ...
 * Generated at: 2023-01-06 09:50:19 UTC
	...
	if("".equals(range) || range.indexOf("*")>=0){
		...
		while(rs.next()){
			...
			buffer.append("<node>")
				...
				.append("<name>").append(orgName+"(已参与答题"+questionnaireBD.getBrowserCount(orgId,Long.parseLong(questionnaireId))+"人)").append("</name>")
