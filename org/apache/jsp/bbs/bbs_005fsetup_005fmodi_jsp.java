 ...
 * Generated at: 2023-01-06 10:09:01 UTC
...
public final class bbs_005fsetup_005fmodi_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _005fjspx_005ftagPool_005fhtml_005ftext_0026_005ftitle_005fstyleClass_005fstyle_005fsize_005freadonly_005fproperty_005fnobody;
  private org.apache.jasper.runtime.TagHandlerPool _005fjspx_005ftagPool_005fhtml_005ftext_0026_005ftitle_005fstyleClass_005fstyle_005fsize_005fproperty_005fnobody;
  ...
  public void _jspInit() {
    ...
    _005fjspx_005ftagPool_005fhtml_005ftext_0026_005ftitle_005fstyleClass_005fstyle_005fsize_005freadonly_005fproperty_005fnobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
    _005fjspx_005ftagPool_005fhtml_005ftext_0026_005ftitle_005fstyleClass_005fstyle_005fsize_005fproperty_005fnobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _005fjspx_005ftagPool_005fhtml_005ftext_0026_005ftitle_005fstyleClass_005fstyle_005fsize_005freadonly_005fproperty_005fnobody.release();
    _005fjspx_005ftagPool_005fhtml_005ftext_0026_005ftitle_005fstyleClass_005fstyle_005fsize_005fproperty_005fnobody.release();
...
String local = session.getAttribute("org.apache.struts.action.LOCALE").toString();
      ...
      out.write("\r\n<!--\r\n *  注释:论坛 最后修改\r\n * <p>Description:论坛分类修改页面</p>\r\n * <p>Copyright: Copyright (c) 2008</p>\r\n * <p>Company: Beijing JS  C0. Ltd.</p>\r\n *  \r\n * @version jsoa 1.0\r\n */\r\n-->\r\n");

//String range = session.getAttribute("browseRange")+"";
//选人 修改成全部用户
String range = session.getAttribute("grantRange").toString();
String rangetemp=range;
//classSort 当前记录的classSort
String classSort = ""+request.getAttribute("classSort") ;

 String isproject=(String)request.getAttribute("isproject");
	   String addhtmlStr1 = "";
	   java.text.DecimalFormat df = new java.text.DecimalFormat("00");
       for(int i=0;i<24;i++){
          	for(int j=0;j<2;j++){
          	
          	   addhtmlStr1 += "<option value="+df.format(i)+":";
          	   if(j==0){addhtmlStr1 += "00";}else{addhtmlStr1 += "30";}
          	   if(i==8&&j==1){addhtmlStr1 += " selected ";}
          	   addhtmlStr1 += ">"+df.format(i)+":";
          	   if(j==0){addhtmlStr1 += "00";}else{addhtmlStr1 += "30";}
          	   addhtmlStr1 += "</option>";
          	}
        }
        addhtmlStr1 += "<option value='24:00'>24:00</option></select>至";
           
        String addhtmlStr2 = "";
        for(int i=0;i<24;i++){
            for(int j=0;j<2;j++){                  
                addhtmlStr2 += "<option value="+df.format(i)+":";
                if(j==0){addhtmlStr2 += "00";}else{addhtmlStr2 += "30";}
                if(i==18&&j==0){addhtmlStr2 += " selected ";}else{addhtmlStr2 += " ";}
                addhtmlStr2 += ">"+df.format(i)+":";
                if(j==0){addhtmlStr2 += "00";}else{addhtmlStr2 += "30";}
        	    addhtmlStr2 += "</option>";
            }
        }
        addhtmlStr2 += "</option><option value='24:00'>24:00</option></select>";
        addhtmlStr2 +="&nbsp;<img width=12 height=12 border=0 src=/jsoa/images/addarrow.gif style=cursor:pointer onClick='javascript:addROW();' alt=增加>&nbsp;";
	    addhtmlStr2 +="&nbsp;<img width=12 height=12 border=0 src=/jsoa/images/delarrow.gif style=cursor:pointer onClick='del();' alt='删除'>&nbsp;";

        String addhtmlStr3= "<select name='startPeriod0'>"+addhtmlStr1+"<select name='endPeriod0'>"+addhtmlStr2;

        //显示设置的开放时间段

        String checkNameNum = (String)request.getAttribute("checkNameNum");
        String FullDay = (String)request.getAttribute("FullDay");


        String htmlStr = "";
        String startPeriod=(String)request.getAttribute("startPeriod")+",";
	    String endPeriod=(String)request.getAttribute("endPeriod")+",";
	    String _s="";
	    String _d="";
        ...
        if (!"1".equals(FullDay)) {          
            ...
            String[] endPeriods   = endPeriod.split(",");
            int maxNum = Integer.parseInt(checkNameNum);
            for(int ii=0;ii<maxNum;ii++){
                  
		          htmlStr += "<tr><td><select name='startPeriod"+ii+"'>";
		          for(int i=0;i<24;i++){
		             for(int j=0;j<2;j++){
			         _s=df.format(i)+":"+(j==0?"00":"30");
			         htmlStr += "<option value="+df.format(i)+":";
			         if(j==0){htmlStr +="00";}else{htmlStr +="30"; }
			         if(_s.equals(startPeriods[ii])){htmlStr +=" selected >";}else{htmlStr +=">"; }
			         htmlStr += df.format(i)+":";
			         if(j==0){htmlStr +="00";}else{htmlStr +="30"; }
			         htmlStr += "</option>";
		          ...
		          htmlStr +="<option value='24:00'";
		          if("24:00".equals(startPeriod)){htmlStr +=" selected >";}else{htmlStr +=">"; }
		          htmlStr +="24:00</option></select>至";
		          htmlStr +="<select name='endPeriod"+ii+"'>";
		          for(int i=0;i<24;i++){
		          	 for(int j=0;j<2;j++){
					     _d=df.format(i)+":"+(j==0?"00":"30");
					     htmlStr += "<option value="+df.format(i)+":";
					     if(j==0){htmlStr +="00";}else{htmlStr +="30"; }
					     if(_d.equals(endPeriods[ii])){htmlStr +=" selected >";}else{htmlStr +=">"; }
					     htmlStr += df.format(i)+":";
					     if(j==0){htmlStr +="00";}else{htmlStr +="30"; }
					     htmlStr += "</option>";
				      }
		          ...
		          htmlStr +="<option value='24:00'";
		          if("24:00".equals(endPeriod)){htmlStr +=" selected >";}else{htmlStr +=">"; }
		          htmlStr +="24:00</option></select>";
			      htmlStr +="&nbsp;<img width=12 height=12 border=0 src=/jsoa/images/addarrow.gif style=cursor:pointer onClick='javascript:addROW();' alt=增加>&nbsp;";
			      htmlStr +="&nbsp;<img width=12 height=12 border=0 src=/jsoa/images/delarrow.gif style=cursor:pointer onClick='del();' alt='删除'>&nbsp;";
		          htmlStr +="</td></tr>";
		     }
		   
          } else {
           
              htmlStr = "<tr><td><select name='startPeriod0'>";
	          for(int i=0;i<24;i++){
	          	 for(int j=0;j<2;j++){	          	
		          	   htmlStr += "<option value="+df.format(i)+":";
		          	   if(j==0){htmlStr += "00";}else{htmlStr += "30";}
		          	   if(i==8&&j==1){htmlStr += " selected ";}
		          	   htmlStr += ">"+df.format(i)+":";
		          	   if(j==0){htmlStr += "00";}else{htmlStr += "30";}
		          	   htmlStr += "</option>";
	          	 }
	           }
	           htmlStr += "<option value='24:00'>24:00</option></select>至<select name='endPeriod0'>";
	           ...
	           for(int i=0;i<24;i++){
	              for(int j=0;j<2;j++){
	                  ...
	                  htmlStr += "<option value="+df.format(i)+":";
	                  if(j==0){htmlStr += "00";}else{htmlStr += "30";}
	                  if(i==18&&j==0){htmlStr += " selected ";}else{htmlStr += " ";}
	                  htmlStr += ">"+df.format(i)+":";
	                  if(j==0){htmlStr += "00";}else{htmlStr += "30";}
	          	  htmlStr += "</option>";
	              }
	           }
	           htmlStr += "</option><option value='24:00'>24:00</option></select>";
	           htmlStr +="&nbsp;<img width=12 height=12 border=0 src=/jsoa/images/addarrow.gif style=cursor:pointer onClick='javascript:addROW();' alt=增加>&nbsp;";
		       htmlStr +="&nbsp;<img width=12 height=12 border=0 src=/jsoa/images/delarrow.gif style=cursor:pointer onClick='del();' alt='删除'>&nbsp;";
	           htmlStr +="</td></tr>";
...
if(BrowserJudge.isFirefox(request)){
            ...
            try {
              ...
              // /bbs/bbs_setup_modi.jsp(256,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("ForumClassAction.do?action=update");
              // /bbs/bbs_setup_modi.jsp(256,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  try {
                    ...
                    // /bbs/bbs_setup_modi.jsp(272,5) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_html_005fhidden_005f1.setProperty("editId");
                    // /bbs/bbs_setup_modi.jsp(272,5) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                  ...
                  try {
                    ...
                    // /bbs/bbs_setup_modi.jsp(273,5) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_html_005fhidden_005f2.setProperty("pager.offset");
                    // /bbs/bbs_setup_modi.jsp(273,5) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                  ...
                  try {
                    ...
                    // /bbs/bbs_setup_modi.jsp(274,5) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_html_005fhidden_005f3.setProperty("queryText");
                    // /bbs/bbs_setup_modi.jsp(274,5) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                  ...
                  if (_jspx_meth_html_005fhidden_005f9(_jspx_th_html_005fform_005f0, _jspx_page_context))
                    return;
                  out.write("\r\n\t\t\t\t  <td width=\"80\" height=\"25\" nowrap=\"nowrap\">");
...
if("Y".equals(isproject)){
                  ...
                  out.write("\r\n\t\t\t\t  <!--\r\n\t\t\t\t       old code\r\n\t\t\t\t       <a href=\"#\" onClick=\"javascript:openEndow('classOwnerId','classOwnerName',ForumClassActionForm.classOwnerId.value,ForumClassActionForm.classOwnerName.value,'user','yes','user','");
                  out.print(range);
                  ...
                  try {
                    ...
                    // /bbs/bbs_setup_modi.jsp(311,7) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_html_005fselect_005f0.setProperty("allForumClass");
                    // /bbs/bbs_setup_modi.jsp(311,7) name = onchange type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    ...
                    if (_jspx_eval_html_005fselect_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      do {
                        ...
                        try {
                          ...
                          // /bbs/bbs_setup_modi.jsp(313,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                          _jspx_th_logic_005fiterate_005f0.setId("forumClass");
                          // /bbs/bbs_setup_modi.jsp(313,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
						  ...
						  String tmp = obj[6]+"" ;
						   if((obj[3]!=null&&(""+obj[3]).indexOf(classSort)==-1)) { //修改的时候目录下有帖子的||当前记录以及其下面的记录  不显示
                              ...
                              // /bbs/bbs_setup_modi.jsp(322,9) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                  ...
                  if (_jspx_meth_html_005fselect_005f1(_jspx_th_html_005fform_005f0, _jspx_page_context))
                    return;
                  out.write("\r\n\t\t\t\t   <input type=\"radio\" name=\"insertSite\" value=\"0\"  />");
				  ...
				  String banPrint = (String)request.getAttribute("banPrint");
				  if("".equals(banPrint)) banPrint = "0";
				
                  out.write("\r\n\t\t\t\t<tr>\r\n\t\t\t\t  <td>禁止打印拷贝：</td>\r\n\t\t\t\t  <td>\r\n\t\t\t\t    <input type=\"radio\" name=\"banPrint\" value=\"1\" ");
if(banPrint.equals("1")) {
                  out.write("checked");
}
                  out.write("/>是\r\n\t\t\t\t    <input type=\"radio\" name=\"banPrint\" value=\"0\" ");
if(banPrint.equals("0")) {
                  out.write("checked");
}
                  ...
                  if (_jspx_meth_bean_005fmessage_005f11(_jspx_th_html_005fform_005f0, _jspx_page_context))
                    return;
                  out.write("：</td>\r\n\t\t\t\t  <td>\r\n\t\t\t\t      <input type=\"radio\" value=\"1\" style=\"cursor:'hand'\" name=\"_fullDay\" onclick=\"showPeriod(this)\" ");
                  ...
                  if (_jspx_meth_bean_005fmessage_005f13(_jspx_th_html_005fform_005f0, _jspx_page_context))
                    return;
                  out.write("&nbsp;&nbsp;\r\n\t\t\t\t\t  \r\n\t\t\t\t      <input type=\"hidden\" name=\"checkNameNum\" value=\"");
                  out.print(checkNameNum);
                  out.write("\"/>\r\n\t\t\t\t\t  \r\n\t\t\t\t\t       <table id=\"tbl_2\" style=\"display:none\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n\t\t\t\t\t\t\t");
                  out.print(htmlStr);
                  out.write("\r\n\t\t\t\t\t\t</table>\r\n\t\t\t\t\t  \r\n\t\t\t\t\t  <input type=\"hidden\" id=\"fullDay\" name=\"fullDay\" value=\"");
                  if (_jspx_meth_bean_005fwrite_005f0(_jspx_th_html_005fform_005f0, _jspx_page_context))
                    return;
                  out.write("\">\r\n\t\t\t\t\t  <input type=\"hidden\" id=\"isproject\" name=\"isproject\" value=\"");
                  out.print(isproject);
                  out.write("\">\r\n\t\t\t\t  </td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t<!-- 增加开放时间-->\r\n\r\n\t\t\t\t<tr>\r\n\t\t\t\t  <td>&nbsp;</td>\r\n\t\t\t\t  <td>\r\n\t\t\t\t     <table>\r\n\t\t\t\t        <tr>\r\n\t\t\t\t\t  <td>\r\n\t\t\t\t\t    ");
    ...
    if("Y".equals(isproject)){
    	range=request.getAttribute("userOrgGroup")==null? rangetemp:request.getAttribute("userOrgGroup").toString();
    
      out.write("\r\n    document.getElementById(\"currentSortCodeTr\").style.display = \"none\" ;\r\n    \r\n    ");
}
      out.write("\r\n   \tForumClassActionForm.classUserName.title=\"请点击选择\";\r\n    ForumClassActionForm.classUserName.onclick= function() {\r\n\t\t\topenEndow('userOrgGroup','classUserName',ForumClassActionForm.userOrgGroup.value,ForumClassActionForm.classUserName.value,'user','no','userorggroup','");
      out.print(range);
      out.write("');\r\n\t\t\t} \r\n    \r\n    ForumClassActionForm.classOwnerName.title=\"请点击选择\";\r\n    ForumClassActionForm.classOwnerName.onclick= function() {\r\n           \r\n    var classValues=ForumClassActionForm.classOwnerIds.value;\r\n    ForumClassActionForm.classOwnerIds.value=classValues.replace(/\\*/g,\"$\")\r\n    openEndow('classOwnerIds','classOwnerName',ForumClassActionForm.classOwnerIds.value,ForumClassActionForm.classOwnerName.value,'user','no','user','");
      out.print(range);
      out.write("');\r\n\t} \r\n   \r\n");
...
if(!(null==message || "true".equals(message) || "false".equals(message)||"null".equals(message)) ) {
      ...
      out.write("\";\r\n        if(done==\"done\") {\r\n           var hhref =((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/ForumClassAction.do?action=list\";\r\n            hhref += \"&pager.offset=\"+off ;\r\n            hhref += \"&queryText=\"+queryText;\r\n             hhref += \"&isproject=");
      out.print(isproject);
      out.write("\";\r\n            opener.location.href = hhref  ;\r\n            window.close();\r\n         }\r\n");
}
      out.write("\r\n\tshowPeriod(document.getElementById(\"fullDay\"));\r\n\t\r\n\r\n}\r\n//重置\r\nfunction resetter() {\r\n      ForumClassActionForm.reset();\r\n      initpage();\r\n}\r\n//初始化页面:控制显示\r\nfunction initpage() {\r\n    ForumClassActionForm.editType.value = \"none\" ;\r\n    //document.all.currentSortCodeSpan.style.display = \"none\" ;\r\n    //document.all.currentSortCodeTr.style.display = \"none\" ;\r\n    initChildForumArray(ForumClassActionForm.allForumClass.value);\r\n    initEditRecordSite() ;\r\n}\r\n//组织参数\r\nfunction initForum() {\r\n     var father = ForumClassActionForm.allForumClass.value ;\r\n     if(father == \"\") { // 选择无\r\n        ForumClassActionForm.parentSort.value = \"\" ;\r\n        ForumClassActionForm.classLevel.value = \"1\" ;\r\n        ForumClassActionForm.classParent.value = \"0\" ;\r\n     } else {\r\n            var son = ForumClassActionForm.currentSortCode.value ;\r\n             for(var i = 0 ; i <forumClassArray.length ; i++ ) {\r\n                  if(forumClassArray[i][0] == father) {\r\n                      ForumClassActionForm.parentSort.value = forumClassArray[i][3] ;\r\n");
      out.write("                      ForumClassActionForm.classLevel.value = parseInt(forumClassArray[i][2])+1 ;\r\n                      ForumClassActionForm.classParent.value =forumClassArray[i][0] ;\r\n                      if(\"2\" == forumClassArray[i][6] ) {\r\n                          alert(bbs.hasforum)  ;\r\n                          return false ;\r\n                      }\r\n                      break ;\r\n                  }\r\n            }\r\n     }\r\nreturn true  ;\r\n}\r\n\r\n//判断分类是否存在\r\nfunction noRecord() {\r\n    var val = ForumClassActionForm.className.value ;\r\n    for(var i =0 ; i< childForumClassArray.length ;  i++ ) {\r\n        if(childForumClassArray[i][1] == val ) {\r\n                alert(bbs.forumnamereapt) ;\r\n       \t \tForumClassActionForm.className.focus() ;\r\n       \t\tForumClassActionForm.className.select();\r\n       \t\treturn false ;\r\n        }\r\n    }\r\n    return true;\r\n}\r\n\r\n//初始页面显示(当前记录的位置)\r\nfunction initEditRecordSite() {\r\n    var curClassSort = \"");
      out.print(classSort);
      out.write("\" ;\r\n    var fatherClassSort = \"\" ;\r\n    var childClassSort = \"\" ;\r\n    var fatherId = ForumClassActionForm.allForumClass.value ;\r\n    for(var i = 0 ; i < forumClassArray.length ; i++ ) {\r\n        if(forumClassArray[i][0]==fatherId)\r\n             fatherClassSort = forumClassArray[i][3] ;\r\n    }\r\n    curClassSort = getClassSortNum(fatherClassSort,curClassSort) ;\r\n    for(var i = 0  ; i < childForumClassArray.length ; i++ ) {\r\n        childClassSort = childForumClassArray[i][3] ;\r\n        childClassSort = getClassSortNum(fatherClassSort,childClassSort) ;\r\n        if(parseInt(curClassSort) < parseInt(childClassSort))  { //前面的内容\r\n            ForumClassActionForm.currentSortCode.value = childForumClassArray[i][4] ;\r\n            ForumClassActionForm.insertSite[0].checked = true ;\r\n            break ;\r\n        }else if(i  == childForumClassArray.length-1)  {\r\n            ForumClassActionForm.currentSortCode.value = childForumClassArray[i][4] ;\r\n            ForumClassActionForm.insertSite[1].checked = true ;\r\n        }\r\n");
      out.write("    }\r\n}\r\n\r\nfunction getClassSortNum(fatherClassSort,classSort) {\r\n    if(classSort.indexOf(fatherClassSort+\"_\")!=-1) { //有内容\r\n         classSort = classSort.substring((fatherClassSort+\"_\").length,classSort.length) ;\r\n         if(classSort.indexOf(\"$\")!=-1) {\r\n             classSort = classSort.substring(0,classSort.indexOf(\"$\")) ;\r\n         }else { //无\r\n             classSort = \"\" ;\r\n         }\r\n    }else { //无\r\n        classSort = \"\" ;\r\n    }\r\n    return classSort ;\r\n}\r\n\r\n//检查页面参数有效性\r\nfunction initPara() {\r\n    return ( initForum()&& noRecord()&&\r\n    checkText(ForumClassActionForm.className,15,bbs.bbsname)&&\r\n    //checkText(ForumClassActionForm.classOwnerName,25,\"版主\")&&\r\n    checkTextLengthOnly(ForumClassActionForm.classRemark,250,bbs.description)&&\r\n    checkQuery(ForumClassActionForm.className,bbs.bbsname)\r\n    ) ;\r\n}\r\n\r\n//保存退出\r\nfunction saveClose() {\r\nif(ForumClassActionForm.classOwnerIds.value==\"\"){\r\n       ForumClassActionForm.classOwnerName.value=\"\";\r\n   }\r\n   \r\n   if(ForumClassActionForm.userOrgGroup.value==\"\"){\r\n");
      out.write("       ForumClassActionForm.classUserName.value=\"\";\r\n   }\r\n    var classOwnerIdLength = ForumClassActionForm.classOwnerIds.value.length;\r\n    var classOwnerNameLength = ForumClassActionForm.classOwnerName.value.length;\r\n    var classUserNameLength = ForumClassActionForm.classUserName.value.length;\r\n    var userOrgGroupLength = ForumClassActionForm.userOrgGroup.value.length;\r\n    if(ForumClassActionForm.classOwnerName.value==\"\"){\r\n       alert(\"请选择版主！\");\r\n       ForumClassActionForm.classOwnerName.focus;\r\n       return false;\r\n    }\r\n    if(classOwnerIdLength>80 || classOwnerNameLength>50) {\r\n       alert(\"您选择的版主太多，请少选一些！\");\r\n       ForumClassActionForm.classOwnerName.focus;\r\n       return false;\r\n    }\r\n\r\n    if(userOrgGroupLength>2000 || classUserNameLength>1000) {\r\n       alert(\"您选择的用户太多，请少选一些！\");\r\n       ForumClassActionForm.classUserName.focus;\r\n       return false;\r\n    }\r\n    \r\n    if(initPara()==false) return   false;\r\n    if(!checkEmail(ForumClassActionForm.classEmail,\"EMail\")){\r\n       return false;\r\n");
      ...
      out.write("\tdocument.getElementById('checkNameNum').value=rowCount+1;\r\n\r\n        var rowstr = \"<select name='startPeriod\"+rowCount+\"'>\";\r\n        rowstr = rowstr + \"");
      out.print(addhtmlStr1);
      out.write("\";\r\n        rowstr = rowstr + \"<select name='endPeriod\"+rowCount+\"'>\";\r\n        rowstr = rowstr + \"");
      out.print(addhtmlStr2);
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(158,7) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(158,7) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setKey("bbs.modibbs");
  ...
  private boolean _jspx_meth_html_005fhidden_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(265,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f0.setProperty("done");
      // /bbs/bbs_setup_modi.jsp(265,8) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(275,5) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f4.setProperty("classParent");
  ...
  private boolean _jspx_meth_html_005fhidden_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(276,5) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f5.setProperty("classParentName");
  ...
  private boolean _jspx_meth_html_005fhidden_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(277,5) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f6.setProperty("classSort");
  ...
  private boolean _jspx_meth_html_005fhidden_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(278,5) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f7.setProperty("classLevel");
  ...
  private boolean _jspx_meth_html_005fhidden_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(279,5) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f8.setProperty("editType");
  ...
  private boolean _jspx_meth_html_005fhidden_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(280,5) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f9.setProperty("editSort");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(281,49) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(281,49) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  html:text
    org.apache.struts.taglib.html.TextTag _jspx_th_html_005ftext_005f0 = (org.apache.struts.taglib.html.TextTag) _005fjspx_005ftagPool_005fhtml_005ftext_0026_005fstyleClass_005fstyle_005fsize_005freadonly_005fproperty_005fnobody.get(org.apache.struts.taglib.html.TextTag.class);
    boolean _jspx_th_html_005ftext_005f0_reused = false;
    try {
      _jspx_th_html_005ftext_005f0.setPageContext(_jspx_page_context);
      _jspx_th_html_005ftext_005f0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_005fform_005f0);
      // /bbs/bbs_setup_modi.jsp(284,8) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyleClass("inputtext");
      // /bbs/bbs_setup_modi.jsp(284,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setProperty("className");
      // /bbs/bbs_setup_modi.jsp(284,8) name = readonly type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setReadonly(true);
      // /bbs/bbs_setup_modi.jsp(284,8) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setSize("50");
      // /bbs/bbs_setup_modi.jsp(284,8) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyle("width:372px");
      int _jspx_eval_html_005ftext_005f0 = _jspx_th_html_005ftext_005f0.doStartTag();
      if (_jspx_th_html_005ftext_005f0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
        return true;
      }
      _005fjspx_005ftagPool_005fhtml_005ftext_0026_005fstyleClass_005fstyle_005fsize_005freadonly_005fproperty_005fnobody.reuse(_jspx_th_html_005ftext_005f0);
  ...
  private boolean _jspx_meth_html_005ftext_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  html:text
    org.apache.struts.taglib.html.TextTag _jspx_th_html_005ftext_005f1 = (org.apache.struts.taglib.html.TextTag) _005fjspx_005ftagPool_005fhtml_005ftext_0026_005fstyleClass_005fstyle_005fsize_005fproperty_005fnobody.get(org.apache.struts.taglib.html.TextTag.class);
    boolean _jspx_th_html_005ftext_005f1_reused = false;
    try {
      _jspx_th_html_005ftext_005f1.setPageContext(_jspx_page_context);
      _jspx_th_html_005ftext_005f1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_005fform_005f0);
      // /bbs/bbs_setup_modi.jsp(286,6) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setStyleClass("inputtext");
      // /bbs/bbs_setup_modi.jsp(286,6) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setProperty("className");
      // /bbs/bbs_setup_modi.jsp(286,6) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setSize("50");
      // /bbs/bbs_setup_modi.jsp(286,6) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setStyle("width:372px");
      int _jspx_eval_html_005ftext_005f1 = _jspx_th_html_005ftext_005f1.doStartTag();
      if (_jspx_th_html_005ftext_005f1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
        return true;
      }
      _005fjspx_005ftagPool_005fhtml_005ftext_0026_005fstyleClass_005fstyle_005fsize_005fproperty_005fnobody.reuse(_jspx_th_html_005ftext_005f1);
  ...
  private boolean _jspx_meth_bean_005fmessage_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(291,10) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(291,10) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f10(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(292,6) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f10.setProperty("classOwnerIds");
  ...
  private boolean _jspx_meth_html_005ftext_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  html:text
    org.apache.struts.taglib.html.TextTag _jspx_th_html_005ftext_005f2 = (org.apache.struts.taglib.html.TextTag) _005fjspx_005ftagPool_005fhtml_005ftext_0026_005ftitle_005fstyleClass_005fstyle_005fsize_005freadonly_005fproperty_005fnobody.get(org.apache.struts.taglib.html.TextTag.class);
    boolean _jspx_th_html_005ftext_005f2_reused = false;
    try {
      _jspx_th_html_005ftext_005f2.setPageContext(_jspx_page_context);
      _jspx_th_html_005ftext_005f2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_005fform_005f0);
      // /bbs/bbs_setup_modi.jsp(295,10) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setStyleClass("inputtext");
      // /bbs/bbs_setup_modi.jsp(295,10) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setProperty("classOwnerName");
      // /bbs/bbs_setup_modi.jsp(295,10) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setSize("50");
      // /bbs/bbs_setup_modi.jsp(295,10) name = readonly type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setReadonly(true);
      // /bbs/bbs_setup_modi.jsp(295,10) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setStyle("width:372px");
      // /bbs/bbs_setup_modi.jsp(295,10) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setTitle("请点击选择");
      int _jspx_eval_html_005ftext_005f2 = _jspx_th_html_005ftext_005f2.doStartTag();
      if (_jspx_th_html_005ftext_005f2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
        return true;
      }
      _005fjspx_005ftagPool_005fhtml_005ftext_0026_005ftitle_005fstyleClass_005fstyle_005fsize_005freadonly_005fproperty_005fnobody.reuse(_jspx_th_html_005ftext_005f2);
  ...
  private boolean _jspx_meth_html_005ftext_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  html:text
    org.apache.struts.taglib.html.TextTag _jspx_th_html_005ftext_005f3 = (org.apache.struts.taglib.html.TextTag) _005fjspx_005ftagPool_005fhtml_005ftext_0026_005ftitle_005fstyleClass_005fstyle_005fsize_005fproperty_005fnobody.get(org.apache.struts.taglib.html.TextTag.class);
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(297,23) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f3.setStyleClass("inputtext");
      // /bbs/bbs_setup_modi.jsp(297,23) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f3.setProperty("classOwnerName");
      // /bbs/bbs_setup_modi.jsp(297,23) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f3.setSize("50");
      // /bbs/bbs_setup_modi.jsp(297,23) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f3.setStyle("width:372px");
      // /bbs/bbs_setup_modi.jsp(297,23) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f3.setTitle("请点击选择");
      int _jspx_eval_html_005ftext_005f3 = _jspx_th_html_005ftext_005f3.doStartTag();
      if (_jspx_th_html_005ftext_005f3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
        return true;
      }
      _005fjspx_005ftagPool_005fhtml_005ftext_0026_005ftitle_005fstyleClass_005fstyle_005fsize_005fproperty_005fnobody.reuse(_jspx_th_html_005ftext_005f3);
  ...
  private boolean _jspx_meth_bean_005fmessage_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(309,23) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(309,23) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f11(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(309,75) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f11.setProperty("classLevel");
  ...
  private boolean _jspx_meth_html_005foption_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(312,7) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005foption_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(312,29) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(312,29) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(334,5) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f5.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(334,5) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f12(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(334,54) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f12.setProperty("parentSort");
  ...
  private boolean _jspx_meth_html_005fhidden_005f13(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(335,7) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f13.setProperty("classParent");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(341,23) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f6.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(341,23) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fselect_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(343,7) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(345,58) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f7.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(345,58) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(346,58) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f8.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(346,58) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(350,23) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f9.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(350,23) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f14(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(352,6) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f14.setProperty("userOrgGroup");
  ...
  private boolean _jspx_meth_html_005ftextarea_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(353,6) name = cols type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setCols("50");
      // /bbs/bbs_setup_modi.jsp(353,6) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setStyleClass("inputtextarea");
      // /bbs/bbs_setup_modi.jsp(353,6) name = rows type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setRows("5");
      // /bbs/bbs_setup_modi.jsp(353,6) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setProperty("classUserName");
      // /bbs/bbs_setup_modi.jsp(353,6) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setStyleId("classUserName");
      // /bbs/bbs_setup_modi.jsp(353,6) name = readonly type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f10(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(369,34) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f10.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(369,34) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftextarea_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(370,23) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f1.setStyleClass("inputtextarea");
      // /bbs/bbs_setup_modi.jsp(370,23) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f1.setProperty("classRemark");
      // /bbs/bbs_setup_modi.jsp(370,23) name = rows type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f1.setRows("5");
      // /bbs/bbs_setup_modi.jsp(370,23) name = cols type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f11(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(376,10) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f11.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(376,10) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_logic_005fequal_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(378,105) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_logic_005fequal_005f0.setName("ForumClassActionForm");
      // /bbs/bbs_setup_modi.jsp(378,105) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_logic_005fequal_005f0.setProperty("fullDay");
      // /bbs/bbs_setup_modi.jsp(378,105) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f12(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(378,197) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f12.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(378,197) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_logic_005fnotEqual_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(379,105) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_logic_005fnotEqual_005f0.setName("ForumClassActionForm");
      // /bbs/bbs_setup_modi.jsp(379,105) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_logic_005fnotEqual_005f0.setProperty("fullDay");
      // /bbs/bbs_setup_modi.jsp(379,105) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f13(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(379,203) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f13.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(379,203) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fwrite_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(387,63) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f0.setName("ForumClassActionForm");
      // /bbs/bbs_setup_modi.jsp(387,63) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f0.setProperty("fullDay");
  ...
  private boolean _jspx_meth_html_005fcheckbox_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(399,9) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fcheckbox_005f0.setValue("1");
      // /bbs/bbs_setup_modi.jsp(399,9) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fcheckbox_005f0.setStyle("cursor:'hand'");
      // /bbs/bbs_setup_modi.jsp(399,9) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f14(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(399,80) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f14.setBundle("bbs");
      // /bbs/bbs_setup_modi.jsp(399,80) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fcheckbox_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(402,9) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fcheckbox_005f1.setValue("1");
      // /bbs/bbs_setup_modi.jsp(402,9) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fcheckbox_005f1.setStyle("cursor:'hand'");
      // /bbs/bbs_setup_modi.jsp(402,9) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f15(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(415,103) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f15.setBundle("common");
      // /bbs/bbs_setup_modi.jsp(415,103) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f16(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(416,102) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f16.setBundle("common");
      // /bbs/bbs_setup_modi.jsp(416,102) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f17(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbs/bbs_setup_modi.jsp(417,118) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f17.setBundle("common");
      // /bbs/bbs_setup_modi.jsp(417,118) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
