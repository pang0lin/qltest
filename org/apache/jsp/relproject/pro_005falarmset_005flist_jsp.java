...
public final class pro_005falarmset_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(managerBD.hasRight(userId,"07*19*02")){ 
...
}if(managerBD.hasRight(userId,"04*07*02")){ 
		  ...
		  String listClass="listTableLine1";
            ...
            try {
              ...
              // /relproject/pro_alarmset_list.jsp(113,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /relproject/pro_alarmset_list.jsp(113,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /relproject/pro_alarmset_list.jsp(113,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
	       ...
	       Object[] obj = (Object[])list;
			...
			if(index%2 != 0){
				...
				listClass="listTableLine1";
                  ...
                  out.write("</td>\r\n\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"><div id=\"colorDisplay\" style=\"vertical-align:middle;line-height:15px;height:15px;width:100%;cursor:pointer;background-color:");
                  out.print(null==obj[3]?"":obj[3].toString());
                  out.write("\"></div></td>\r\n\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(obj[4].equals("1")?"有效":obj[4].equals("0")?"无效":"");
                  out.write("</td>\r\n\t\t\t<td  class=\"");
                  out.print(listClass);
                  ...
                  out.write("')\">&nbsp;<img  style=\"cursor:pointer\" border=\"0\" src=\"images/del.gif\" alt=\"删除\" onclick=\"DeleteIt('");
                  out.print(obj[0].toString());
                  out.write("')\"></td>\r\n\t\t  </tr>\r\n\t");
 ...
 String pagerURL = "/jsoa/RelProClassAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /relproject/pro_alarmset_list.jsp(42,7) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("personalwork");
      // /relproject/pro_alarmset_list.jsp(42,7) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /relproject/pro_alarmset_list.jsp(96,125) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("common");
      // /relproject/pro_alarmset_list.jsp(96,125) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
