...
public final class archivesBorrowFile_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if ("nologout".equals(fileState)){
            out.write("\r\n\t<button class=\"btnButton2Font\" onclick=\"JSMainWinOpen('/jsoa/archivesAction.do?action=viewAddArchivesFile','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=670,height=410')\"\">新增</button>\r\n\t<button class=\"btnButton2Font\" onClick=\"logoutBatch();\">注销</button>\r\n\t");
}
if ("logout".equals(fileState) || "nopigeonhole".equals(fileState)){
            ...
            out.write("\r\n\t</td>\r\n  </tr>\r\n</table>\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n   <form action=\"\" name=\"form1\" method=\"post\">\r\n     <tr align=\"center\">\r\n\t\t<td class=\"listTableHead\"> 文号 </td>\r\n\t\t<td class=\"listTableHead\"> 题名 </td>\r\n\t\t<td class=\"listTableHead\"> 借阅人 </td>\r\n\t\t<td class=\"listTableHead\" width=\"20%\"> 借阅人组织 </td>\r\n\t\t<td class=\"listTableHead\"> 借阅目的 </td>\r\n\t\t<td class=\"listTableHead\" width=\"10%\"> 借阅日期 </td>\r\n\t\t<td class=\"listTableHead\"> 借阅份数 </td>\r\n\t\t<td width=\"8%\" nowrap class=\"listTableHeadLast\">处理</td>\r\n\t </tr>\r\n     ");
		...
		String listClass="listTableLine1";
            ...
            try {
              ...
              // /archives/archivesBorrowFile.jsp(77,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /archives/archivesBorrowFile.jsp(77,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("ArchivsBorrowFileList");
 ...
 if(obj[2] !=null && !"".equals(obj[2].toString())){
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj[3].toString().substring(0,10));
                  out.write("</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
...
if (isModiRight.length() > 0) {
                  ...
                  out.write("\r\n\r\n\t\t");
 if(obj[11] !=null && "2".equals(obj[11].toString())){
                  out.write("\r\n\t\t<img  style=\"cursor:hand\" border=\"0\" src=\"images/finsh.gif\" alt=\"归还\" onclick=\"Restitute('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
                  ...
                  out.write("\r\n\t<!--\t");
 if(obj[11] !=null && "3".equals(obj[11].toString())){
                  out.write("申请被退回");
}
                  out.write(" -->\r\n\t\t&nbsp;</div></td>\r\n\r\n\t  </tr>\r\n\t  ");
