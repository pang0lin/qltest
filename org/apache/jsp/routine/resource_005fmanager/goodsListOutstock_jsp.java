...
public final class goodsListOutstock_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String addcolumn = request.getParameter("addcolumn")==null?"8":request.getParameter("addcolumn");
      ...
      try {
        ...
        // /routine/resource_manager/goodsListOutstock.jsp(105,36) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_logic_005fpresent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /routine/resource_manager/goodsListOutstock.jsp(106,38) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("searchGoodsTypeList");
              // /routine/resource_manager/goodsListOutstock.jsp(106,38) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(!addGoods.equals("1")){
      ...
      try {
        ...
        // /routine/resource_manager/goodsListOutstock.jsp(263,22) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f1.setId("goodsList");
        // /routine/resource_manager/goodsListOutstock.jsp(263,22) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if("salesreturn".equals(mode)){
      out.write("\r\n                           strValue = \"<input type=text name=returnReason maxlength=25/>\";\r\n                        ");
}
...
if(!"outStock".equals(mode) && !"salesreturn".equals(mode)){
      ...
      out.write("\r\n                        \tstrValue = \"<input type=text name=useNamestr   readonly=true value=\" + ssUseMan + \">\"+ \"&nbsp;\"+\"<input type=hidden name=kc  value=\" + ssUseMan + \">\"+ \"&nbsp;\";\r\n                        ");
}
      out.write("\r\n                        \r\n                        ");
if("salesreturn".equals(mode)){
      out.write("\r\n                          strValue = \"<input type=text name=returnReason id=returnReason  readonly=true maxlength=25>\";\r\n                        ");
}
      out.write("\r\n                        \r\n                        \r\n                        oCell8.innerHTML = strValue; \r\n                        break;\r\n                        case 8:\r\n                        strValue =\"<img src=/jsoa/images/del.gif alt=删除该物品 onclick=javascript:document.all.detailTable.deleteRow(parentElement.parentElement.rowIndex);total_money(); style=cursor:pointer>\";\r\n                       \r\n                        oCell9.innerHTML = strValue;\r\n                        break;\r\n                    }\r\n                    //cell.innerHTML = strValue;\r\n                   // if( k == 9)\r\n\t\t\t\t\t// cell.align=\"right\";\r\n\t\t\t\t\t//else\r\n                    //cell.align = \"left\";\r\n                }\r\n\t\t\t\topener.total_money();\r\n            }\r\n        }\r\n    }\r\n    try{\r\n\t");
