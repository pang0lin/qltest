 ...
 * Generated at: 2023-01-06 09:46:27 UTC
...
public final class infoContent_005f3g_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String beginIndex = request.getParameter("beginIndex").toString();
      ...
      out.print(path);
      out.write("/wap/action/ChannelAction.do?method=infoList&beginIndex=");
...
Map map=(Map)request.getAttribute("contentMap");
      ...
      out.write("</div>\r\n\t<div class=\"box_2\">\r\n\r\n\t<div class=\"list_2\">\r\n\t\t\t\t");
      out.print(map.get("content")!=null?TestMain.filter((String)map.get("content")):"" );
      out.write("\r\n\t\t\t\t<div class=\"clear\"></div>\r\n\t</div>\t\r\n\t\t\t");
if(map.get("filelist")!=null&&!"null".equals(map.get("filelist"))){ 
      ...
      out.write("\t\t\r\n\t<div class=\"list_2\">\r\n\t\t\t\t<div class=\"t1\">发布人：</div>\r\n\t\t\t\t<div class=\"t2\">");
      out.print(map.get("sendUser") );
      out.write("</div>\r\n\t\t\t\t<div class=\"clear\"></div>\r\n\t</div>\r\n\t<div class=\"list_2\">\r\n\t\t\t\t<div class=\"t1\">发起时间：</div>\r\n\t\t\t\t<div class=\"t2\">");
      out.print(map.get("sendTime").toString().substring(0,19) );
      out.write("</div>\r\n\t\t\t\t<div class=\"clear\"></div>\r\n\t</div>\t\t\t\r\n</div>\r\n</body>\r\n</html>");
