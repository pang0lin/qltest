...
public final class senddocument_005fword_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getParameter("wordName")!=null){
	wordName=java.net.URLDecoder.decode(request.getParameter("wordName"),"UTF-8");
}
String processName="";
if(request.getParameter("processName")!=null){
	processName=java.net.URLDecoder.decode(request.getParameter("processName"),"UTF-8");
}
String templateName="";
if(request.getParameter("templateName")!=null){
	templateName=java.net.URLDecoder.decode(request.getParameter("templateName"),"UTF-8");
}
...
if(managerBD.hasRight(session.getAttribute("userId").toString(),"03*15*86")){ 
            ...
            try {
              ...
              // /doc/doc/senddocument_word.jsp(169,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("SenddocumentBaseAction.do?action=word");
              // /doc/doc/senddocument_word.jsp(169,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n     <tr align=\"center\">\r\n\t\t<td  width=\"40\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"chkSelect\" style=\"cursor:'hand'\" onclick=\"selectAll(this)\"></td>\r\n\t\t<td class=\"listTableHead\" width=\"20%\">机关代字</td>\r\n\t\t<td class=\"listTableHead\" >对应流程");
if(orderBy == null || !orderBy.equals("processId")){
                  out.write("\r\n            <img src=\"images/blanksort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('processId','desc');\" alt=\"按对应流程排序\">\r\n        ");
}else if(orderBy.equals("processId") && sortType.equals("desc")){
                  out.write("\r\n            <img src=\"images/downsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('processId','asc');\" alt=\"按对应流程排序\">\r\n        ");
}else if(orderBy.equals("processId") && sortType.equals("asc")){
                  out.write("\r\n            <img src=\"images/upsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('processId','desc');\" alt=\"按对应流程排序\">\r\n        ");
}
                  out.write("</td>\r\n\t\t<td class=\"listTableHead\" width=\"50%\">对应模板</td>\r\n\t\r\n\t\t<!--<td class=\"listTableHead\">使用范围</td>-->\r\n\t\t<td width=\"8%\" nowrap class=\"listTableHeadLast\">处理</td>\r\n\t </tr>\r\n\t ");
	 ...
	 String listClass="listTableLine1";
                  ...
                  try {
                    ...
                    // /doc/doc/senddocument_word.jsp(188,5) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("mylist");
                    // /doc/doc/senddocument_word.jsp(188,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("mylist");
                    // /doc/doc/senddocument_word.jsp(188,5) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		 ...
		 if(obj[9]!=null){
			 ...
			 if(objStr!=null&&objStr.length()>3){
				 ...
				 for(int i=0;i<objs.length;i++){
					 String mobanArr[]=objs[i].split("\\.doc");			  
				     moban+=mobanArr[0]+";";
				 }
...
//=obj[4]==null?"&nbsp;":obj[4]
                        out.write("\r\n\t  </td>-->\r\n\t  <td class=\"");
                        out.print(listClass);
                        out.write(" listTableLineLastTD\" nowrap>\r\n\t\t<img  style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" alt=\"修改\" onclick= \"moder('");
                        out.print(obj[0]);
                        out.write("','1')\">&nbsp;<img  style=\"cursor:pointer\" border=\"0\" src=\"images/del.gif\" alt=\"删除\" onclick=\"del('");
                        out.print(obj[0]);
                        out.write("')\" >&nbsp;\r\n\t  </td>\r\n\t</tr>\r\n   ");
