...
String copedTableId=session.getAttribute("copyedTable")==null?"":session.getAttribute("copyedTable").toString();
...
int i = 0 ;
            ...
            try {
              ...
              // /userdb/table.jsp(44,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/TableAction.do");
              // /userdb/table.jsp(44,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("\"/>\r\n\t\t<input type=\"hidden\" id =\"pager.offset\" name=\"pager.offset\" value=\"");
                  ...
                  try {
                    ...
                    // /userdb/table.jsp(55,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("modellist");
                    // /userdb/table.jsp(55,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("modellist");
                    // /userdb/table.jsp(55,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    ...
                    if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      do {
						...
						out.print("<option value=\""+modelArr[0]+"\">"+modelArr[2]+"</option>");
...
if("shandongguotou".equals(com.js.util.config.SystemCommon.getCustomerName())){
                  ...
                  out.write("\r\n\t      \r\n    </td>\r\n    <td>&nbsp;</td>\r\n    <td align=\"right\" nowrap>    \r\n    <!-- button class=\"btnButton2Font\" onclick=\"javascript:add()\">新增</button -->\r\n    <input type=\"button\" class=\"btnButton2Font\" onclick=\"javascript:addTable()\" value=\"新增\"/>\r\n    <input type=\"button\" class=\"btnButton2Font\" onclick=\"javascript:copyData()\" value=\"复制表\"/>\r\n    <input type=\"button\" class=\"btnButton2Font\" onclick='javascript:if(!checkboxIsChecked(document.all.id)){alert(\"请选择要删除的记录！\");}else{if(confirm(\"确定删除吗?\")) {del();}}' value=\"删除\"/>\r\n    <input type=\"button\" class=\"btnButton4font\" onClick=\"chSearch(this)\" value=\"查询\"/>\r\n    </td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n\t<tr >\r\n\t\t<td width=\"40\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"chkSelect\" onclick=\"selectID(this);\"></td>\r\n\t\t<td class=\"listTableHead\" onclick=\"sort('1');\">表名称<img  name=\"img1\"  title=\"按名称排序\" style=\"cursor:pointer\" src=\"/jsoa/images/blanksort.gif\"/></td>\t\t\r\n\t\t<!--<td width=\"20%\" class=\"listTableHead\">分类</td>-->\r\n");
                  out.write("\t\t<!-- <td width=\"15%\" class=\"listTableHead\">编号</td> -->\r\n\t\t<!--<td width=\"20%\" class=\"listTableHead\">系统名称</td>-->\r\n\t\t<!-- <td width=\"15%\" class=\"listTableHead\">创建者</td> -->\r\n\t\t<td width=\"10%\" class=\"listTableHead\">创建时间</td>\r\n\t\t<td width=\"10%\" nowrap class=\"listTableHeadLast\"> 处理</td>\r\n\t</tr>\r\n\r\n\r\n\t\t");
			...
			if(request.getParameter("pager.offset") != null && !request.getParameter("pager.offset").equals("null")){
				...
				flag=i;
                  ...
                  try {
                    ...
                    // /userdb/table.jsp(149,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f1.setId("tableList");
                    // /userdb/table.jsp(149,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f1.setName("tableList");
                    // /userdb/table.jsp(149,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(obj[5]!=null){if(obj[5].toString().length()>10) out.print(obj[5].toString().substring(0,10)); else out.print(obj[5]);} else out.print("&nbsp;");
                        out.write("</td>\r\n\t\t<td class=\"");
                        out.print(listClass);
                        out.write(" listTableLineLastTD\">\r\n\t\t\t<a href=\"javascript:MM_openBrWindow('/jsoa/TableInfoAction.do?operate=load&tableId=");
                        out.print(obj[0]);
                        out.write("&pager.offset=");
                        out.print(request.getParameter("pager.offset"));
                        out.write("&dbname=");
if(obj[1]!=null) out.print(obj[1]); else out.print("&nbsp;");
                        out.write("',\r\n\t\t\t\t\t\t'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=400,height=300')\">");
                        if (_jspx_meth_html_005fimg_005f0(_jspx_th_logic_005fiterate_005f1, _jspx_page_context))
                          return;
                        out.write("</a>&nbsp;<img border=\"0\"  src=\"/jsoa/images/del.gif\" title=\"删除\" onclick=\r\n\t\t\t\t\"javascript:if(confirm('确定删除吗?')) {delone('");
                        out.print(obj[2]);
                        out.write("');}\"/>&nbsp;<a href=\"javascript:void(0);\" \r\n\t\t\tonclick=\"javascript:setChildTable('");
                        out.print(obj[0]);
                        out.write('\'');
                        out.write(',');
                        out.write('\'');
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.print(copedTableId);
      out.write("\";\r\n  \r\n  function copyData(){\r\n  \tcopyedID=\"\";\r\n  \tvar name=\"id\";\r\n  \tvar obj=document.all[name];\r\n    if (obj&&obj.length) {\r\n      for (i=0;i<obj.length;i++) {\r\n        if (obj[i].checked)\r\n\t\t\t     copyedID+=obj[i].value+\",\";\r\n      }      \r\n    }else{\r\n    \tif (obj.checked)\r\n         copyedID+=obj.value+\",\";\r\n    }\r\n    if(copyedID==\"\"){\r\n    \talert(\"请选择要复制的数据表!\");\r\n    }else{\r\n    \tdocument.location.href=\"/jsoa/TableAction.do?operate=copyData&tableId=\"+copyedID;\r\n    }\r\n  }\r\n  \r\n  function pasteData(){\r\n  \tif(copyedID==\"\"){\r\n  \t\talert(\"请先复制数据表!\");\r\n  \t}else{\r\n  \t\tdocument.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/TableAction.do?operate=pasteData\";\r\n  \t\tcopyedID=\"\";\r\n  \t}\r\n  \t\r\n  }\r\n  function goClass(){\r\n     location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/ModelAction.do\";\r\n  }\r\n  function changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\nfunction chSearch(obj){\r\n\tif(obj.value == \"查询\"){\r\n\t\tobj.value = \"关闭查询\";\r\n");
      out.write("\t\tdocument.all.searchTable.style.display=\"\";\r\n\t}else{\r\n\t\tobj.value = \"查询\";\r\n\t\tdocument.all.searchTable.style.display=\"none\";\r\n\t}\r\n}\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /userdb/table.jsp(63,4) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyleClass("inputText");
      // /userdb/table.jsp(63,4) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setProperty("sname");
      // /userdb/table.jsp(63,4) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fimg_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /userdb/table.jsp(169,76) name = border type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f0.setBorder("0");
      // /userdb/table.jsp(169,76) name = src type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f0.setSrc("/jsoa/images/modi.gif");
      // /userdb/table.jsp(169,76) name = alt type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fimg_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /userdb/table.jsp(173,54) name = border type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f1.setBorder("0");
      // /userdb/table.jsp(173,54) name = src type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f1.setSrc("/jsoa/images/taskchild.gif");
      // /userdb/table.jsp(173,54) name = alt type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f1.setAlt("设置子表");
  ...
  private boolean _jspx_meth_html_005fimg_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /userdb/table.jsp(175,70) name = border type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f2.setBorder("0");
      // /userdb/table.jsp(175,70) name = src type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f2.setSrc("/jsoa/images/tj.gif");
      // /userdb/table.jsp(175,70) name = alt type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f2.setAlt("统计设置");
