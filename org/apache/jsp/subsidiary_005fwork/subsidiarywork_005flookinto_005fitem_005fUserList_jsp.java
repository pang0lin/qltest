...
public final class subsidiarywork_005flookinto_005fitem_005fUserList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
boolean online = com.js.system.util.SysSetupReader.getInstance().hasRtxOnline(session.getAttribute("domainId").toString());
	...
	if(request.getAttribute("maxPageItems") !=null){
      ...
      out.write("\r\n<table width=\"100%\">\r\n    <tr>\r\n        <td>\r\n            <form name=\"form1\" method=\"POST\" action=\"/jsoa/LookIntoAction.do?action=viewItemBrowserUser&items=");
      ...
      out.write("\">\r\n\t\t\t<button class=\"btnButton2font\" onclick=\"form1.submit();\">查询</button>\r\n\t\t    <button class=\"btnButton2font\" onclick=\"window.location.href='/jsoa/LookIntoAction.do?action=viewItemBrowserUser&items=");
      out.print(request.getParameter("items"));
