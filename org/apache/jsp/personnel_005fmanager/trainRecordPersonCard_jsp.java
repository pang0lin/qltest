...
public final class trainRecordPersonCard_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(!deleteSuccess.booleanValue()){
	...
	java.util.Date newDate = new java.util.Date();
      ...
      try {
        ...
        // /personnel_manager/trainRecordPersonCard.jsp(101,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("/TrainRecordAction.do?flag=search");
        // /personnel_manager/trainRecordPersonCard.jsp(101,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setMethod("post");
        int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
        if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\t\t<tr align=\"center\">\r\n\t\t\t<td class=\"listTableHead\" width=\"23%\"> 培训名称 </td>\r\n\t\t\t<td class=\"listTableHead\" width=\"10%\"> 开始日期 </td>\r\n\t\t\t<td class=\"listTableHead\" width=\"10%\"> 结束日期 </td>\r\n\t\t\t<td class=\"listTableHead\" width=\"23%\"> 培训种类 </td>\r\n\t\t\t<td class=\"listTableHeadLast\" width=\"34%\"> 参与人 </td>\r\n\t\t</tr>\r\n\t\t");
            ...
            try {
              ...
              // /personnel_manager/trainRecordPersonCard.jsp(121,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("trainRecordList");
              // /personnel_manager/trainRecordPersonCard.jsp(121,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("trainRecordList");
...
if(index%2 != 0){listClass="listTableLine2";}
                  ...
                  out.write("</td>\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write("\"><a href=\"javascript:toview('");
                  out.print(trainRecordObj[7]);
                  out.write("')\">");
...
if(!currentPageNumber.equals(pageCount)){
   ...
   if(deloff<0) deloff = 0;
      ...
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=600,height=350')\r\n}\r\n\tfunction toview(id){\r\n    MM_openBrWindow('/jsoa/TrainClassAction.do?flag=view&trainClassId=' + id  ,'','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=600,height=350')\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
