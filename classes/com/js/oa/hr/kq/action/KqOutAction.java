...
public class KqOutAction extends Action {
  public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws NumberFormatException, Exception {
    KqOutActionForm form = (KqOutActionForm)actionForm;
    String tag = "list";
    ...
    if (action.equals("list")) {
      ...
      if (action.equals("add")) {
        ...
        if (httpServletRequest.getParameter("processId") == null) {
          ...
          if (flowList != null && flowList.size() == 1) {
            ...
            StringBuffer forwardURL = new StringBuffer("/KqOutAction.do?action=add&moduleId=8&");
      ...
      if (action.equals("update")) {
        ...
        if (outId == null)
          outId = httpServletRequest.getParameter("record"); 
        KqOutPO kqOutPO = new KqOutPO();
        kqOutPO = kqOutBD.searchById((new Long(outId)).longValue());
        httpServletRequest.setAttribute("kqOutPO", kqOutPO);
        tag = "update";
      } 
    } 
  ...
  private void list(HttpServletRequest httpServletRequest) throws NumberFormatException, Exception {
    ...
    Page page = new Page(
        "po.id,po.userId,po.userName,po.orgId,po.orgName,po.place,po.startTime,po.endTime,po.cause,po.projectId,po.status", 
        "com.js.oa.hr.kq.po.KqOutPO po ", 
        whereSql);
