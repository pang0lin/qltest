 ...
 * Generated at: 2023-01-06 09:54:18 UTC
...
public final class archivesWaitPigeonhole_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        String tsFlag = (String)request.getParameter("ts");
        int index=0;
        int pageSize2=0;
	...
	if(request.getAttribute("searchCaption") !=null && ! "null".equals(request.getAttribute("searchCaption").toString())){
	searchCaption = request.getAttribute("searchCaption").toString();
	}
	String searchType ="";
	...
	String searchState ="";
	if(request.getAttribute("searchState") !=null){
		searchState = request.getAttribute("searchState").toString();
	}
            ...
            try {
              ...
              // /archives/archivesWaitPigeonhole.jsp(46,2) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/archivesAction.do?action=viewArchivesWaitPigeonhole");
              // /archives/archivesWaitPigeonhole.jsp(46,2) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n\t<tr>\r\n\t  <td width=\"20\" rowspan=\"2\"></td>\r\n\t  <td width=\"40%\" height=\"30\"  nowrap>标题：\r\n\t\t<input name=\"searchCaption\" type=\"text\"  onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'标题')\" onblur=\"value=checkQuery1(this,'标题')\" value=\"");
                  out.print(searchCaption);
                  out.write("\" maxlength=\"30\" size=\"30\" class=\"inputtext\" />\r\n      </td>\r\n\t  <td width=\"30%\" height=\"30\"  nowrap>归档类别：\r\n\t\t <select name=\"searchState\" class=\"inputtext\" style=\"width:120px\">\r\n\t\t\t  <option value=\"-1\" ");
if(searchState !="" && "-1".equals(searchState)){
                  out.write("selected");
}
                  out.write(">--请选择--</option>\r\n\t\t\t  <option value=\"0\"  ");
if(searchState !="" && "0".equals(searchState)){
                  out.write("selected");
}
...
if(searchState !="" && "1".equals(searchState)){
 ...
 //if (tsFlag != null && "0".equals(tsFlag)) {
                  out.write("\r\n      <td align=\"right\">\r\n\t      <button class=\"btnButton2Font\" onClick=\"search('");
                  out.print(searchType);
                  out.write("');\">查询</button>\r\n              <button class=\"btnButton2Font\" onClick=\"cleared('");
                  out.print(searchType);
                  out.write("');\">重置</button>\r\n\t  </td>\r\n          <td width=\"16\" rowspan=\"2\" align=\"top\"></td>\r\n         ");
 //} else {
                  out.write("\r\n\t  <!-- <td>&nbsp;</td>\r\n\t  <td width=\"16\" rowspan=\"2\" align=\"top\"></td>\r\n\t</tr>\r\n\t<tr>\r\n\t  <td height=\"40\">来源：\r\n\t\t<select name=\"searchType\">\r\n\t\t\t\t<option value=\"0\" ");
if(searchType !="" && "0".equals(searchType)){
                  out.write("selected");
}
                  out.write(">请选择</option>\r\n\t\t\t\t<option value=\"ZSGL\" ");
if(searchType !="" && "ZSGL".equals(searchType)){
                  out.write("selected");
}
                  out.write(">知识管理</option>\r\n\t\t\t\t<option value=\"GWGL\" ");
if(searchType !="" && "GWGL".equals(searchType)){
                  out.write("selected");
}
                  out.write(">公文管理</option>\r\n\t\t\t\t<option value=\"GZLC\" ");
if(searchType !="" && "GZLC".equals(searchType)){
                  out.write("selected");
}
                  out.write(">工作流程</option>\r\n\t\t</select>\r\n\r\n\r\n\t  &nbsp;&nbsp;&nbsp;状态：\r\n\t  <select name=\"searchState\">\r\n\t\t\t\t<option value=\"-1\" ");
if(searchState !="" && "-1".equals(searchState)){
                  out.write("selected");
}
                  out.write(">请选择</option>\r\n\t\t\t\t<option value=\"0\" ");
...
if(searchState !="" && "2".equals(searchState)){
 ...
 //} 
            ...
            out.write("\r\n</table>\r\n\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"1\" cellspacing=\"0\">\r\n  <tr>\r\n    <td align=\"right\">\r\n\t\t<button class=\"btnButton2font\" onclick=\"delAll();\">删除</button>\r\n        <button class=\"btnButton2font\" onclick=\"exportData('");
            out.print(searchType);
            out.write("');\">导出</button>\r\n    </td>\r\n    </tr>\r\n</table>\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n   <form action=\"\" name=\"form1\" method=\"post\">\r\n     <tr align=\"center\">\r\n\t\t<td  width=\"35\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n\t\t<td class=\"listTableHead\"> 标题 </td>\r\n\t\t<td width=\"22%\" class=\"listTableHead\"> 归档来源 </td>\r\n\t\t<td width=\"10%\" class=\"listTableHead\"> 状态 </td>\r\n\t\t<!--<td width=\"10%\" class=\"listTableHead\"> 发布人 </td>-->\r\n\t\t<td width=\"10%\" class=\"listTableHead\"> 日期 </td>\r\n\t\t<td width=\"8%\" nowrap class=\"listTableHeadLast\">处理 </td>\r\n\t </tr>\r\n       ");
		...
		String listClass="listTableLine1";
            ...
            try {
              ...
              // /archives/archivesWaitPigeonhole.jsp(124,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /archives/archivesWaitPigeonhole.jsp(124,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("ArchivesWaitPigeonholeList");
              // /archives/archivesWaitPigeonhole.jsp(124,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		if(index%2 != 0){
			...
			listClass="listTableLine1";
                  ...
                  out.write("\r\n\t  <tr>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"><input type=\"checkbox\" name=\"improve\" value=\"");
                  out.print(obj[0]);
                  out.write('"');
                  out.write(' ');
 if("1".equals(obj[7].toString())){
                  ...
                  out.write("></td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"><a href=\"#\" onclick=\"JSMainWinOpen('/jsoa/archivesfile/");
                  out.print(obj[4]);
 ...
 if("GWGL-SWGL".equals(obj[3].toString())){
                  out.write("公文管理-收文管理");
}
                  out.write("\r\n\t\t\t\t\t");
 if("GWGL-FWGL".equals(obj[3].toString())){
                  out.write("公文管理-发文管理");
}
...
if("0".equals(obj[7].toString())){
                  out.write("\r\n\t\t<img style=\"cursor:hand\" border=\"0\" src=\"images/guidang2.gif\" alt=\"归档\" onclick='modify(\"");
                  out.print(obj[0]);
                  out.write('"');
                  out.write(',');
                  out.write('"');
		...
		String imgClick = ArchivesUtil.clickImg(obj[3].toString(),obj[1].toString());
		
                  out.write("\r\n\t\t<img title=\"查看原件\" style=\"cursor:pointer\" border=\"0\" src=\"images/konwledge_view.gif\" onclick=\"");
                  out.print(imgClick );
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\n\r\n  function selectAllItem(){\r\n\t  var result=document.all.selectAll.checked;\r\n\t  var a = document.getElementsByName(\"improve\");\r\n\t  if(a.length>1){\r\n\t\t  for(var i=0;i<document.all.improve.length;i++){\r\n\t\t\t  if(!document.all.improve[i].disabled)\r\n\t\t\t  document.all.improve[i].checked=result;\r\n\t\t  }\r\n\t  }\r\n\t  if(a.length==1){\r\n\t\t   if(!document.all.improve.disabled)\r\n\t\t  document.all.improve.checked=result;\r\n\t  }\r\n}\r\n\r\nfunction modify(id,fileId,caption,typeName,fileName){\r\n\tJSMainWinOpen('archivesAction.do?action=viewAddArchivesFile&type=waitPigeonhole&waitPigeonholeId='+id+'&fileId='+fileId+'&caption='+caption+'&typeName='+typeName+'&fileName='+fileName+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=670,height=570','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=670,height=410')\r\n}\r\n\r\nfunction del(id,fileId,typeName,index){\r\n    if(confirm(\"确实要删除此文件吗？\")){\r\n        var url = ((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/archivesAction.do?action=delArchivesWaitPigeonhole&waitPigeonholeId=\"+id+\"&fileId=\"+fileId+\"&typeName=\"+typeName+\"&searchState=-1&isSearch=1&searchType=\"+typeName+\"&pager.offset=\" + index;\r\n");
      out.write("\t//alert(url);\r\n        window.location.href=url;\r\n    }\r\n}\r\nfunction delAll(){\r\n\t  var copyitem=\"\";\r\n\t  var a = document.getElementsByName(\"improve\");\r\n\t  if(a.length>1){\r\n\t\t  for(var i=0;i<document.all.improve.length;i++){\r\n\t\t\t if(document.all.improve[i].checked){\r\n\t\t\t\t var tmp=document.all.improve[i].value;\r\n\t\t\t\t copyitem+=tmp+\",\";\r\n\t\t\t }\r\n\t\t}\r\n\t  }\r\n\t  if(a.length==1){\r\n\t\t if(document.all.improve.checked){\r\n\t\t\t var tmp=document.all.improve.value;\r\n\t\t\t copyitem=tmp;\r\n\t\t }\r\n\t  }\r\n\r\n      if(copyitem==\"\"){\r\n\t\talert(\"请选择需要删除的文件！\");\r\n\t\treturn false;\r\n      }\r\n\t  var temps=copyitem.substring(copyitem.length-1,copyitem.length);\r\n\t  if(temps==\",\"){\r\n\t\ttemps=copyitem.substring(0,copyitem.length-1);\r\n\t  }else{\r\n\t\ttemps=copyitem;\r\n\t  }\r\n\t  if(confirm(\"确实要全部删除吗？\")){\r\n\t\t  //alert(\"/jsoa/archivesAction.do?action=delArchivesWaitPigeonholeAll&id=\"+ temps+\"&searchType=");
      out.print(request.getParameter("searchType"));
      out.write("\");\r\n       \t  window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/archivesAction.do?action=delArchivesWaitPigeonholeAll&id=\"+ temps+\"&searchType=");
      out.print(request.getParameter("searchType"));
      out.write("\";\r\n    }\r\n}\r\nfunction search(type){\r\n\tvar slt = document.archivesActionForm.searchState.value;\r\n    document.archivesActionForm.action = \"archivesAction.do?action=viewArchivesWaitPigeonhole&search=1&searchType=\"+type+\"&searchState=\"+slt;\r\n    document.archivesActionForm.target = \"_self\";\r\n    document.archivesActionForm.submit();\r\n}\r\nfunction exportData(type) {\r\n    document.archivesActionForm.action += \"&flag=export&pager.offset=");
      out.print(request.getParameter("pager.offset"));
      out.write("&searchState=-1&search=1&searchType=\"+type;\r\n    document.archivesActionForm.target = \"_blank\";\r\n    document.archivesActionForm.submit();\r\n}\r\n\r\nfunction cleared(type){\r\n    //window.location.href=\"/jsoa/archivesAction.do?action=viewArchivesWaitPigeonhole&searchState=-1&search=1&searchType=\"+document.all.searchType.value;\r\n    document.all.searchCaption.value = \"\";\r\n    document.archivesActionForm.action = \"archivesAction.do?action=viewArchivesWaitPigeonhole&searchState=-1&search=1&searchType=\"+type;\r\n    document.archivesActionForm.target = \"_self\";\r\n    document.archivesActionForm.submit();\r\n    }\r\nfunction LY_ONKEYDOWN(){\r\n    if(event.keyCode == 13 ){\r\n    \tdocument.archivesActionForm.action = \"archivesAction.do?action=viewArchivesWaitPigeonhole&searchState=-1&search=1&searchType=\"+type;\r\n        document.archivesActionForm.target = \"_self\";\r\n        document.archivesActionForm.submit();\r\n    \t}\r\n    }\r\nfunction yuanJian(url){\r\n\tif(url==\"wu&finish=1\"){\r\n\t\talert(\"请检查流程是否丢失！\");\r\n\t}else{\r\n\t\tJSMainWinOpen(url,'','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=670,height=570','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=670,height=410');\r\n");
