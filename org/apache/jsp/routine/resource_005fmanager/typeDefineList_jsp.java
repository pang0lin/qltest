...
public final class typeDefineList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int pageSize= 0;
     ...
     int j = 0;
      ...
      try {
        ...
        // /routine/resource_manager/typeDefineList.jsp(46,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("/TypeDefineAction.do");
        // /routine/resource_manager/typeDefineList.jsp(46,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(new ManagerService().hasRightType(userId, "物品管理-仓库管理")){
          ...
          if(new ManagerService().hasRightType(userId, "物品管理-仓库管理")){
            ...
            out.write("\r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanelSelected\" onClick=\"changePanle(this,'/jsoa/TypeDefineAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">类别定义</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n      ");
} 
            out.write("\r\n\t</td>\r\n    <td align=\"right\" nowrap>\r\n                <input type=\"button\" class=\"btnButton2Font\" onClick=\"add()\" value=\"新增\" />\r\n            </td>\r\n       </tr>\r\n</table>\r\n</td>\r\n</tr>\r\n\r\n\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n<tr >\r\n\t<td width=\"46%\"  class=\"listTableHead\">类别名称</td>\r\n\t<td width=\"46%\"  class=\"listTableHead\">所属模块</td>\r\n\t<td width=\"8%\"  class=\"listTableHeadLast\">处理</td>\r\n</tr>\r\n\r\n\r\n\r\n");
            ...
            try {
              ...
              // /routine/resource_manager/typeDefineList.jsp(106,37) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("typeDefineList");
              // /routine/resource_manager/typeDefineList.jsp(106,37) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("typeDefineList");
              // /routine/resource_manager/typeDefineList.jsp(106,37) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setScope("request");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object typeDefineList = null;
                ...
                typeDefineList = (java.lang.Object) _jspx_page_context.findAttribute("typeDefineList");
                do {
                  out.write("\r\n                                    ");

                                    	Object[] obj = (Object[]) typeDefineList;
										String mode ="";
										if(obj[2].toString().equals("1"))
										mode = "采购进货";
										else if(obj[2].toString().equals("2"))
										mode = "领用出库";
										else if(obj[2].toString().equals("3"))
										mode = "物品退库";
										else if(obj[2].toString().equals("4"))
										mode = "物品退货";
                                        index ++;
                                        j ++;
                  ...
                  out.print(obj[0]);
                  out.write(")\" >&nbsp;<img src=\"images/del.gif\" alt=\"删除\" style=\"cursor:pointer\" onClick=\"del(");
                  out.print(obj[0]);
                  out.write(")\" >&nbsp;</td>\r\n                                      </tr>\r\n                                    ");
...
String pagerURL = "/jsoa/TypeDefineAction.do";
            out.write("\r\n                                      ");
...
if(!currentPageNumber.equals(pageCount)){
     ...
     deloffset = deloffset < 0 ? 0 : deloffset ;
      ...
      out.write("\r\nif(confirm(\"您确认要删除该条记录么?\")){\r\ndocument.TypeDefineActionForm.action = \"/jsoa/TypeDefineAction.do?action=delete&id=\"+para+\"&pager.offset=");
      out.print(deloffset);
      out.write("\";\r\ndocument.TypeDefineActionForm.target=\"_self\";\r\ndocument.TypeDefineActionForm.submit();\r\n}\r\n\r\n}\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\n//添加帖子\r\nfunction add() {\r\n  \r\n    var hhref = \"/jsoa/TypeDefineAction.do?action=add\" ;\r\n    MM_openBrWindow(hhref,'','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width='+700+',height='+380) ;\r\n}\r\n\r\nfunction update(para) {\r\n  \r\n    var hhref = \"/jsoa/TypeDefineAction.do?action=modify&id=\"+para+\"&pager.offset=");
      out.print(pageSize2);
      out.write("\" ;\r\n    MM_openBrWindow(hhref,'','TOP=0,LEFT=0,scrollbars=no,resizable=no,width='+700+',height='+380) ;\r\n}\r\n\r\nfunction view(para) {\r\n  \r\n    var hhref = \"/jsoa/TypeDefineAction.do?action=view&id=\"+para ;\r\n    MM_openBrWindow(hhref,'','TOP=0,LEFT=0,scrollbars=no,resizable=no,width='+700+',height='+380) ;\r\n}\r\n\r\nfunction myexport(para) {\r\n  \r\n    var hhref = \"/jsoa/KeepWatchSetAction.do?action=view&planID=\"+para+\"&export=1\" ;\r\n\tdocument.KeepWatchPlanActionForm.action = hhref ;\r\n\tdocument.KeepWatchPlanActionForm.target=\"_blank\";\r\n\tdocument.KeepWatchPlanActionForm.submit();\r\n  //  MM_openBrWindow(hhref,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width='+screenwidth+',height='+screenheight) ;\r\n}\r\n\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\n//>-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
