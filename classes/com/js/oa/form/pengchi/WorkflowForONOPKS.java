...
public class WorkflowForONOPKS extends Workflow {
  public String complete(HttpServletRequest request) {
    String result = super.complete(request);
    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm");
    String recordId = request.getParameter("recordId");
    String comment = request.getParameter("include_comment");
    String sql = "Select ukzj,ddgs,ddh,ddlx,ddhz From jst_3438 Where jst_3438_id=?";
    ...
    String sql1 = "Select ukzj From jst_3437 Where jst_3437_foreignkey=?";
  ...
  public void backForONOP(HttpServletRequest request) {
    back(request);
    ...
    try {
      ...
      rs.close();
      pstmt.close();
      String thsql = "update  jst_3438 set thbz=? where jst_3438_id=?";
