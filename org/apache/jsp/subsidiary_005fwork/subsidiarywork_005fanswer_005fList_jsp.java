...
public final class subsidiarywork_005fanswer_005fList_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      try {
        ...
        searchStatus = request.getAttribute("searchStatus").toString();
            ...
            try {
              ...
              // /subsidiary_work/subsidiarywork_answer_List.jsp(64,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/QuestionnaireAction.do?action=answerSearch");
              // /subsidiary_work/subsidiarywork_answer_List.jsp(64,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n\t\t<tr>\r\n\t\t  <td width=\"20\" rowspan=\"1\" ></td>\r\n\t\t  <td colspan=\"\">\r\n\t\t\t标题:&nbsp;&nbsp;&nbsp;&nbsp;\r\n                        <input name=\"searchTitle\" onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'标题')\" onblur=\"value=checkQuery1(this,'标题')\" type=\"text\"  value=\"");
...
if(searchStatus !="" && "0".equals(searchStatus)){
		...
		if(request.getParameter("pager.offset")!=null){
            ...
            try {
              ...
              // /subsidiary_work/subsidiarywork_answer_List.jsp(120,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /subsidiary_work/subsidiarywork_answer_List.jsp(120,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("answerList");
...
if ("0".equals(obj[3].toString())){
                  ...
                  out.write("</td>\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\"><div align=\"left\">\r\n\t\t  \t<a style=\"cursor:pointer\" href=\"javascript:actorName('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
                  ...
                  out.write('\'');
                  out.print(obj[1]);
                  out.write("')\"><img src=\"/jsoa/images/tpr.gif\" border=\"0\" alt=\"投票人\" alt=\"投票人\"/></a>&nbsp;<a style=\"cursor:pointer\" href=\"javascript:Statistic('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
                  out.print(obj[1]);
                  out.write("')\"><img src=\"/jsoa/images/tj.gif\" border=\"0\" alt=\"统计\"/></a>\r\n\t\t  <!--img  style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" alt=\"修改\" onclick=\"modify('");
                  out.print(obj[0]);
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("         window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/QuestionnaireAction.do?action=deleteBatchQuestionnaire&ids=\" + getCheckBoxID()+\"&pager.offset=\"+pageSize2 ;\r\n    }\r\n    }else{\r\n             alert(\"请选择要删除的问卷!\");\r\n             return;\r\n         }\r\n}\r\nfunction openFSDW(id,filemc){\r\n\tMM_openBrWindow('SkwjAction.do?action=selectFsDw&fileId='+id+'&fileMc='+filemc+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=600')\r\n}\r\nfunction search(){\r\n    document.QuestionnaireActionForm.submit();\r\n}\r\nfunction cleared(){\r\n    window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/QuestionnaireAction.do?action=answerListView\";\r\n    }\r\nfunction LY_ONKEYDOWN(){\r\n    if(event.keyCode == 13 ){\r\n    \tdocument.QuestionnaireActionForm.submit();\r\n    \t}\r\n    }\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
