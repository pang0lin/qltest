...
public final class code_005fmodi_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getAttribute("reload")!=null){ 
            ...
            out.write("\r\n</head>\r\n");
NewCodePO po = (NewCodePO)request.getAttribute("po"); 
            out.write("\r\n<body class=\"MainFrameBox Pupwin\">\r\n<form name=\"frm\" id=\"frm\" action=\"/jsoa/NewCodeAction.do?action=modi\" method=\"post\">\r\n<input type=\"hidden\" id=\"codeId\" name=\"codeId\" value=\"");
            out.print(po.getCodeId());
            out.write("\">\r\n<input type=\"hidden\" id=\"codeStatus\" name=\"codeStatus\" value=\"");
            out.print(po.getCodeStatus());
            out.write("\">\r\n<table width=\"100%\" border=\"0\" cellpadding=\"1\" cellspacing=\"10\" class=\"docBoxNoPanel\">\r\n <tr>\r\n \r\n\t<td style=\"width:100px;\">文号名称：</td>\r\n\t<td colspan=\"3\"><input type=\"text\" name=\"codeName\" id=\"codeName\" value=\"");
            out.print(po.getCodeName() );
            out.write("\" style=\"width:400px;\" />\r\n\t\r\n\t</td>\r\n\t</tr><tr><td style=\"width:100px;\">文号描述：</td>\r\n\t<td  colspan=\"3\"><input type=\"text\" id=\"codeContent\" name=\"codeContent\" value=\"");
            out.print( po.getCodeContent()==null||"null".equals(po.getCodeContent())?"":po.getCodeContent());
