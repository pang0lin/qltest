...
public final class workflow_005flist_005freceivefile_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String orgIdString = session.getAttribute("orgIdString").toString();
    ...
    if (null != tmp) {
      ...
      out.write("\r\n              <table WIDTH=\"95%\" BORDER=\"0\" ALIGN=\"center\" CELLPADDING=\"0\" CELLSPACING=\"1\">\r\n                 <tr>\r\n                    <td HEIGHT=\"24\" COLSPAN=\"2\" ><b>收文流程</b></td>\r\n                 </tr>\r\n\t\t\t\t\t ");
      ...
      out.write("','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=400')\">\r\n\t\t\t\t\t\t\t\t<a HREF=\"javascript:void(0);\" onclick=\"JSMainWinOpen('/jsoa/GovReceiveFileAction.do?action=see&processId=");
      out.print(processId);
