...
public final class workflow_005fmyflow_005fadd_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String bs = null!=request.getAttribute("appBh") ? request.getAttribute("appBh").toString() : "";
String appBh="gzlclist";
if("draftForm".equals(bs)){
	appBh="draftForm";
}
      ...
      out.write("<script src=\"/jsoa/weixin/public/cmdbuttonForWeiXin.jsp?button=Close,SaveToDraft,Send\"></script>");
			...
			if(request.getParameter("record")!=null){
				if("draftForm".equals(request.getParameter("action"))){	
			
      out.write("\r\n\t\t<script src=\"/jsoa/public/jsp/cmdbutton.jsp?button=Close,SaveToDraft,Send,Print\"></script>\r\n\t\t");
}else{ 
      out.write("\r\n\t\t<script src=\"/jsoa/public/jsp/cmdbutton.jsp?button=Close,Saveclose,Send,Print\"></script>\r\n\t\t");
}}else{
