...
public class task_SmsStop {
  ...
  public static taskResultBean taskSmsStop(long taskSmsID) {
    ...
    try {
      mobset.task_SmsStop(corpID, loginName, password, timeStamp, taskSmsID, errCode, errMsg);
