...
public final class boardRoomApplyList_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      try {
		...
		if("0".equals(type)){
            ...
            try {
              ...
              // /routine/boardroom/boardRoomApplyList.jsp(101,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /routine/boardroom/boardRoomApplyList.jsp(101,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("boardRoomApplyList");
...
if("2".equals(obj[4].toString())){
                  ...
                  out.print(listClass);
                  out.write("\">\r\n\t\t\t\t\t\t  ");
if(obj[4] !=null && !"".equals(obj[4].toString()) && "1".equals(obj[4].toString())){
                  out.write('审');
                  out.write('批');
                  out.write('中');
}
                  out.write("\r\n\t\t\t\t\t\t  ");
if(obj[4] !=null && !"".equals(obj[4].toString()) && "0".equals(obj[4].toString())){
                  out.write("<font color=\"#0000FF\">批准</font>");
}
                  out.write("\r\n\t\t\t\t\t\t  ");
if(obj[4] !=null && !"".equals(obj[4].toString()) && "2".equals(obj[4].toString())){
                  out.write("<font color=\"#FF0000\">未通过</font>");
}
                  out.write("\r\n\t\t\t\t\t\t   ");
if(obj[4] !=null && !"".equals(obj[4].toString()) && "3".equals(obj[4].toString())){
                  out.write("<font color=\"#FF0000\">退回</font>");
}
                  out.write("\r\n\t\t\t\t\t\t  &nbsp;\r\n\t\t\t\t\t\t  </td>\r\n\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">\r\n\t\t");
if(obj[4] !=null && !"".equals(obj[4].toString()) && "0".equals(obj[4].toString())){
                  out.write("\r\n\t\t<img src=\"images/resume.gif\" style=\"cursor:pointer\" alt=\"取消\" onclick=\"cancell('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n\r\n<script language=\"javascript\">\r\n<!--\r\nfunction getCheckBoxID() {\r\n    var strCheckBox = \"\" ;\r\n    var k=0;\r\n    for(var i = 0 ; i < document.all.form1.length ; i++ ) {\r\n        var obj = document.all.form1[i] ;\r\n         if(obj.type == \"checkbox\"  && obj.name==\"batchDel\"){\r\n\t\tif(obj.checked) {\r\n             \tk++;\r\n                \tstrCheckBox += obj.value  ;\r\n                    \tstrCheckBox += \",\" ;\r\n\t\t}\r\n         }\r\n    }\r\n    document.all.checkboxNumber.value = k;\r\n    return strCheckBox ;\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\nfunction modify(id,name){\r\n\tJSMainWinOpen('BoardRoomAction.do?action=selectBoardroomApplyView&boardroomApplyId='+id+'&boardroomName='+name+'&type=modi','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=580')\r\n");
            out.write("}\r\n\r\nfunction view(id,name,meetingId){\r\n\tJSMainWinOpen('BoardRoomAction.do?action=selectBoardroomApplyView&boardroomApplyId='+id+'&boardroomName='+name+'&type=view&isView=true&meetingId='+meetingId+'&executeStatus=true','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=580')\r\n}\r\n\r\nfunction apply(id){\r\n\tJSMainWinOpen('BoardRoomAction.do?action=addBoardroomApplyView&boardroomId='+id+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=390')\r\n}\r\n\r\nfunction lookState(id,name,type){\r\nJSMainWinOpen('BoardRoomAction.do?action=lookStateBoardroomApply&boardroomId='+id+'&name='+name+'&type='+type+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=700,height=350')\r\n}\r\n\r\nfunction manage(id,name,type){\r\nJSMainWinOpen('BoardRoomAction.do?action=manageBoardroomApplyView&boardroomId='+id+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=700,height=500')\r\n}\r\n\r\nfunction approve(id,name,type,place,boardroomId){\r\n\r\n\tif(confirm(\"确实要批准这条记录吗？\")){\r\n    window.location.href=\"/jsoa/BoardRoomAction.do?action=approveBoardroomApply&boardroomApplyId=\"+id+\"&name=\"+name+\"&type=\"+type+\"&place=\"+place+\"&boardroomId=\"+boardroomId+\"\";\r\n");
            out.write("    }\r\n}\r\n\r\nfunction dissent(id,name,type,place,boardroomId){\r\n\r\n    if(confirm(\"确实不批准这条记录吗？\")){\r\n    window.location.href=\"/jsoa/BoardRoomAction.do?action=dissentBoardroomApply&boardroomApplyId=\"+id+\"&name=\"+name+\"&type=\"+type+\"&place=\"+place+\"&boardroomId=\"+boardroomId+\"\";\r\n    }\r\n}\r\n\r\nfunction cancell(id,name,type,place,boardroomId,meetingTimeId){\r\n\r\n\tif(confirm(\"确实要取消这次申请吗？\")){ \r\n\t\twindow.location.href=\"/jsoa/BoardRoomAction.do?action=deleteBoardroomApply&boardroomApplyId=\"+id+\"&name=\"+name+\"&type=\"+type+\"&place=\"+place+\"&boardroomId=\"+boardroomId+\"&meetingTimeId=\"+meetingTimeId+\"&pager.offset=\"+");
            out.print(deloff);
            out.write(";\r\n    }\r\n}\r\n\r\n\r\n//-->\r\n</script>\r\n");
