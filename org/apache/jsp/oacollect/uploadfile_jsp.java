...
if(request.getAttribute("close")==null){
	if(request.getParameter("importF")==null){
		...
		if (!myFile.isMissing()) {
			...
			String saveName=myRandom+"."+houzhui;//生成新文件名
      ...
      out.write("\";\r\n\t\t    fileName=encodeURI(encodeURI(fileName));\r\n\t\t    location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/OACollectFileAction.do?action=uploadfile&fileNameSys=");
      out.print(timeset+houzhui );
      out.write("&collectId=");
      ...
      out.write(".css\" rel=\"stylesheet\" type=\"text/css\" />\r\n\t  </head>\r\n\t  <body class=\"MainFrameBox Pupwin\">\r\n\t  <FORM name=\"form1\" id=\"form1\" METHOD=\"POST\" ACTION=\"/jsoa/oacollect/uploadfile.jsp?collectId=");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.collectId }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      ...
      out.write("\t   \tfunction shangchuan(){\r\n\t   \t\tvar fileName = document.getElementById(\"fileName\").value;\r\n\t   \t\tdocument.getElementById(\"form1\").action+=\"&path=\"+fileName;\r\n\t   \t\tvar formObj = document.getElementById(\"form1\");\r\n\t   \t\tformObj.submit();\r\n\t   \t}\r\n\t   </script>\r\n\t   </form>\r\n\t</body>\r\n</html>\r\n");
}
}else{
      out.write("\r\n<html>\r\n  <head>\r\n\t<meta http-equiv=\"pragma\" content=\"no-cache\">\r\n\t<meta http-equiv=\"cache-control\" content=\"no-cache\">\r\n\t<meta http-equiv=\"expires\" content=\"0\"> \r\n  </head>\r\n    <body>\r\n\t<SCRIPT language=JavaScript>\r\n\t\t");
if("1".equals(request.getAttribute("flag").toString())){ 
      out.write("\r\n\t\t\talert(\"文件上传完成！\");\r\n\t\t\twindow.opener.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+'/jsoa/OACollectFileAction.do?action=fileList&displayFlag=suoluetu&collectId=");
