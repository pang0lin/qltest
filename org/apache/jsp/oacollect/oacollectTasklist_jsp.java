...
public final class oacollectTasklist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if("1".equals(searchTime)){out.print("checked");}
            ...
            try {
              ...
              // /oacollect/oacollectTasklist.jsp(102,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/oaSysRemindAction");
              // /oacollect/oacollectTasklist.jsp(102,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  for(int i=0;i<myList.size();i++){
 	...
 	String inuse=null==obj[4]?"":obj[4].toString();
                  ...
                  out.write("\"></td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"><a href=\"#\" onclick=\"leaderModi('");
                  out.print(obj[0] );
                  out.write("')\">");
                  out.print(obj[1] );
                  out.write("</a></td>\r\n\t\t<td class=\"");
                  ...
                  out.write("');\" >\r\n\t\t");
if(inuse.equals("1")) {
                  out.write("\t\t\t\t     \r\n\t\t<img  style=\"cursor:pointer\" border=\"0\" src=\"imges/noused.gif\" title=\"终止\" onClick=\"del('");
                  out.print(obj[0] );
                  out.write("','0')\">\r\n        ");
}else{
                  out.write(" \r\n\t\t<img  style=\"cursor:pointer\" border=\"0\" src=\"imges/used.gif\" title=\"填报\" onClick=\"del('");
                  out.print(obj[0] );
                  out.write("','1')\">\r\n\t\t");
} 
                  out.write("\r\n\t\t</td>\r\n  </tr>\r\n  ");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.print(offset1);
            out.write("&id='+list_id,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600');\r\n}\r\n//禁用/启用记录\r\nfunction del(id,b) {\r\n      var status;\r\n      if(b==\"1\")\r\n      {\r\n      status=\"填报\";\r\n      }else\r\n      {\r\n       status=\"终止\";\r\n      }\r\n      if(confirm(\"是否\"+status+\"采集?\")){\r\n   window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/oaCollectAction.do?action=updateCollectTaskEnable&fromTabFlag=taskList&ids=\"+id+\"&inuse=\"+b ;\r\n   // parent.location.reload();\r\n    }\r\n }\r\n//进入数据采集实现列表\r\nfunction collectList(list_id){\r\n\twindow.location.href= ((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/collectDealwithAction.do?action=getPage&fromFlag=task&fromTabFlag=taskList&collectId=\"+list_id;\r\n}\r\n//提醒 \r\nfunction collectRemind(list_id){\r\n\twindow.location.href= ((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/oaCollectAction.do?action=collectEmpList&fromFlag=task&fromTabFlag=taskList&collectId=\"+list_id;\r\n");
            out.write("}\r\n//删除信息\r\nfunction DeleteIt(list_id){\r\n  if(confirm(\"确定要删除吗？\")){\r\n\tvar ifDeleteFile=\"0\";\r\n\twindow.location.href= ((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/oaCollectAction.do?action=collectTaskDelete&pager.offset=");
            out.print(offset1);
            out.write("&ids=\"+list_id+\"&ifDeleteFile=\"+ifDeleteFile;\r\n  }\r\n }\r\n function deleteResult(rlt){\r\n    if(rlt.indexOf(\"success\")>0){\r\n      window.document.location.reload();      \r\n    }else{\r\n      alert(\"删除失败！请与管理员联系！\");\r\n    }\r\n }\r\n //批量删除\r\nfunction allDelete(){\r\n  var _id=\"\";\r\n  var obj=document.all.batchId;\r\n  if(obj){\r\n     if(obj.length){\r\n       for(var i=0;i<obj.length;i++){\r\n         if(obj[i].checked){\r\n            _id+=obj[i].value+\",\";\r\n         }\r\n       }\r\n       if(_id.length>0){\r\n          _id=_id.substring(0,_id.length-1);\r\n       }\r\n     }else{\r\n       if(obj.checked){\r\n          _id+=obj.value;\r\n       }\r\n     }\r\n  }\r\n  if(_id!=\"\"){\r\n  DeleteIt(_id);\r\n  }else{\r\n  alert(\"请选择要删除的信息！\");\r\n  }\r\n}\r\nfunction showSearch(){\r\n  document.getElementById(\"searchbar\").style.display=\"\";\r\n  document.getElementById(\"btnButton2FontShow\").style.display=\"none\";\r\n  document.getElementById(\"btnButton2FontClose\").style.display=\"\";\r\n}\r\nfunction closeSearch(){\r\n  document.getElementById(\"searchbar\").style.display=\"none\";\r\n  document.getElementById(\"btnButton2FontShow\").style.display=\"\";\r\n");
            out.write("  document.getElementById(\"btnButton2FontClose\").style.display=\"none\";\r\n}\r\n\r\nfunction setEnter(){\r\n if(document.getElementById(\"searchbar\").style.display==\"\"){\r\n  searchSubmit();\r\n }\r\n}\r\nfunction searchSubmit(){\r\n\tdocument.frm.action=\"/jsoa/oaCollectAction.do?action=taskList\";\r\n\tdocument.frm.submit();\r\n}\r\n\r\nfunction searchReset(){\r\n\tdocument.frm.collectTitle.value=\"\";\r\n\tdocument.frm.searchTime.checked=false;\r\n\tdocument.frm.submit();\r\n}\r\nfunction changeURL(url){\r\n\t  location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+url;\r\n\t}\r\n</script>\r\n");
