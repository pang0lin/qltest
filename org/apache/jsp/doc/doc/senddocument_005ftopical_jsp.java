...
public final class senddocument_005ftopical_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String sortTopical="";
if(request.getParameter("sortTopical")!=null){
sortTopical=java.net.URLDecoder.decode(request.getParameter("sortTopical"),"UTF-8");
}
...
if(managerBD.hasRight(session.getAttribute("userId").toString(),"03*15*86")){ 
            ...
            try {
              ...
              // /doc/doc/senddocument_topical.jsp(153,2) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("SenddocumentBaseAction.do?action=zjkytopical");
              // /doc/doc/senddocument_topical.jsp(153,2) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n     <tr align=\"center\">\r\n\t\t<td width=\"40\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"chkSelect\" style=\"cursor:'hand'\" onclick=\"selectAll(this)\"></td>\r\n\t\t<td width=\"30%\" class=\"listTableHead\">区域类别</td>\r\n\t\t<td width=\"10%\" class=\"listTableHead\">类别词</td>\r\n\t\t<td class=\"listTableHead\">类属词</td>\r\n\t\t<td width=\"8%\" nowrap class=\"listTableHeadLast\">处理</td>\r\n\t </tr>\r\n\t ");
	 ...
	 String listClass="listTableLine1";
                  ...
                  try {
                    ...
                    // /doc/doc/senddocument_topical.jsp(164,5) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("mylist");
                    // /doc/doc/senddocument_topical.jsp(164,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("mylist");
                    // /doc/doc/senddocument_topical.jsp(164,5) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
	  ...
	  String [] leiArr=new String []{"",""};
		if(obj[2]!=null&&obj[2].toString().length()>0){
		    leiArr=obj[2].toString().split("\\|");
		}
