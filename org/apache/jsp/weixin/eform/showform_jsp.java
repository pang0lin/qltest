 ...
 */
package org.apache.jsp.weixin.eform;
...
for(int fi=0;fi<boxFieldList.size();fi++){
	...
	if(fieldObj[12]!=null&&"1".equals(fieldObj[12])){
      ...
      out.write("\r\n\tJSRequest.sendPOST(\"/jsoa/weixin/workflow/eform/fetchdata_inteface.jsp?transValue=\"+obj.value+\"&curIndex=\"+curIndex+\"&fieldId=");
      out.print(fieldObj[0]);
	...
	if(fieldObj[8]!=null && fieldObj[8].startsWith("$[interface")){
      ...
      out.write("&fieldName=");
      out.print(fieldObj[1]);
      out.write("&submitPersonId=\"+submitPersonId+\"&inputValue=\"+inputValue+interfacePara,\"\",\"\");\r\n");
...
if("2".equals(fieldObj[3])||"3".equals(fieldObj[3])){
 ...
 if(com.js.util.config.SystemCommon.getSYWorkflowHR()==1){
      ...
      out.write("<script language=javascript src=\"/jsoa/eform/js/form.js\"></script>\r\n<input type=\"hidden\" name=\"user_Id\" id=\"user_Id\" value=\"");
		   ...
		   //新表单
			...
			if(fieldArr!=null){
				...
				//System.out.println("a:"+fieldArr[i][0]+"         b:"+fieldArr[i][1]);
					...
					if(fieldArr[i][0]!=null && (!fieldArr[i][1].trim().equals(""))){
						if(noDisplayFields.indexOf(","+fieldArr[i][1]+",")>=0){
