...
public final class seaMoonList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int offset1=index;
            ...
            try {
              ...
              // /setup/seamoon/seaMoonList.jsp(80,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/oaSysRemindAction");
              // /setup/seamoon/seaMoonList.jsp(80,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("get");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n  <tr>\r\n\t\t<td width=\"40px\"  nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"sAll\" onclick=\"selectAll(this);\"></td>\r\n\t\t<td width=\"35%\" class=\"listTableHead\" id=\"tdWidth\">用户名</td>\t\t\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\">密码卡SN</td>\t\r\n\t\t<td width=\"10%\" class=\"listTableHead\" id=\"tdWidth\">状态</td>\t\t\r\n\t\t<td width=\"12%\" class=\"listTableHead\" id=\"tdWidth\">操作</td>\r\n  </tr>\r\n  ");
  ...
  for(int i=0;i<myList.size();i++){
 	...
 	String inuse=null==obj[4]?"":obj[4].toString();
                  ...
                  out.write("\"></td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"><a href=\"javascript:void(0);\" onclick=\"leaderModi('");
                  out.print(obj[0] );
                  out.write("')\">");
                  out.print(null==obj[3]?"&nbsp;":("".equals(obj[3])?"&nbsp;":obj[3].toString()));
                  out.write("</a></td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(null==obj[0]?"":obj[0].toString());
                  out.write("</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(null==obj[4]?"":("0".equals(obj[4].toString())?"无效":("1".equals(obj[4].toString())?"有效":obj[4].toString())));
                  out.write("</td>\t\r\n\t\t<td class=\"");
                  out.print(listClass);
                  ...
                  out.print(obj[0]);
                  out.write("');\" >\r\n\t\t<img title=\"登录测试\" style=\"cursor:pointer\" border=\"0\" src=\"images/private.gif\" onclick=\"seaMoonTest('");
                  out.print(obj[0]);
                  out.write("');\" >\r\n\t\t<img title=\"同步\" style=\"cursor:pointer\" border=\"0\" src=\"images/export.gif\" onclick=\"seaMoonSyn('");
                  out.print(obj[0]);
                  out.write("');\" >\r\n\t\t</td>\r\n  </tr>\r\n  ");
...
String pagerURL = "/jsoa/seaMoonAction.do";
            out.write("\r\n\t\t\t\t\t\t\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n<script language=\"javascript\">\r\nvar flag=\"");
            out.print(flag);
            out.write("\";\r\nif(\"deletesuccess\"==flag){\r\nalert(\"删除成功！\");\r\n}\r\nif(\"deleteerror\"==flag){\r\nalert(\"删除失败！\");\r\n}\r\n//切换页签\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\n//新建\r\nfunction addNewInfo(){\r\n   JSMainWinOpen('/jsoa/seaMoonAction.do?action=forSeaMoonAdd&pager.offset=");
            out.print(offset1);
            out.write("','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600');\r\n}\r\n//测试\r\nfunction seaMoonTest(sn){\r\n   JSMainWinOpen('/jsoa/seaMoonAction.do?action=forSeaMoonTest&pager.offset=");
            out.print(offset1);
            out.write("&sn='+sn,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600');\r\n}\r\n//同步\r\nfunction seaMoonSyn(sn){\r\n   JSMainWinOpen('/jsoa/seaMoonAction.do?action=forSeaMoonSyn&pager.offset=");
            out.print(offset1);
            out.write("&sn='+sn,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600');\r\n}\r\n//全选\r\nfunction selectAll(obj){\r\n    if(document.all.batchId){\r\n        if(document.all.batchId.length){\r\n            for(var i = 0; i < document.all.batchId.length; i ++){\r\n                if(obj.checked){\r\n                    if(!document.all.batchId[i].disabled){\r\n                    document.all.batchId[i].checked = true;\r\n                    }\r\n                }else{\r\n                    document.all.batchId[i].checked = false;\r\n                }\r\n            }\r\n        }else{\r\n            if(obj.checked){\r\n                if(!document.all.batchId.disabled){\r\n                document.all.batchId.checked = true;\r\n                }\r\n            }else{\r\n                document.all.batchId.checked = false;\r\n            }\r\n        }\r\n    }\r\n}\r\n//修改信息\r\nfunction leaderModi(list_id){\r\n   JSMainWinOpen('/jsoa/seaMoonAction.do?action=forSeaMoonModi&pager.offset=");
            out.print(offset1);
            out.write("&id='+list_id,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600');\r\n}\r\n//禁用/启用记录\r\nfunction del(id,b) {\r\n      var status;\r\n      if(b==\"1\")\r\n      {\r\n      status=\"填报\";\r\n      }else\r\n      {\r\n       status=\"终止\";\r\n      }\r\n      if(confirm(\"是否\"+status+\"采集?\")){\r\n   window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/seaMoonAction.do?action=updateCollectTaskEnable&fromTabFlag=seaMoonList&ids=\"+id+\"&inuse=\"+b ;\r\n   // parent.location.reload();\r\n    }\r\n }\r\n//进入数据采集实现列表\r\nfunction collectList(list_id){\r\n\twindow.location.href= ((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/collectDealwithAction.do?action=getPage&fromFlag=task&fromTabFlag=seaMoonList&collectId=\"+list_id;\r\n}\r\n//提醒 \r\nfunction collectRemind(list_id){\r\n\twindow.location.href= ((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/seaMoonAction.do?action=collectEmpList&fromFlag=task&fromTabFlag=seaMoonList&collectId=\"+list_id;\r\n");
            out.write("}\r\n//删除信息\r\nfunction DeleteIt(list_id){\r\n  if(confirm(\"确定要删除吗？\")){\r\n\twindow.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+ \"/jsoa/seaMoonAction.do?action=seaMoonDelete&pager.offset=");
            out.print(offset1);
