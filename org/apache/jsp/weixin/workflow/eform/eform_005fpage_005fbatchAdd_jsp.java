 ...
 * Generated at: 2023-01-06 10:00:01 UTC
...
public final class eform_005fpage_005fbatchAdd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/weixin/workflow/eform/showform_batchAdd.jsp", Long.valueOf(1499751476000L));
  }
...
js=new com.js.oa.eform.service.CustomFormBD().getJSCode(pageId); 
      ...
      out.write("        if(mustWrite.length>1){\r\n        \tvar mustNames = \",\"; \r\n        \tfor(var i =0; i < mustWrite.length; i ++){\r\n        \t\tif(mustNames.indexOf(\",\"+mustWrite[i].value+\",\")<0){\r\n        \t\t\tmustNames += mustWrite[i].value+\",\";\r\n        \t\t}\r\n        \t}\r\n        \tmustNames = mustNames.substring(1);\r\n        \tvar mustNamess = mustNames.split(\",\");\r\n            //如果页面不止一个必填项\r\n            for(var i =0; i < mustNamess.length-1; i ++){\r\n                //var obj = eval(\"document.all.\" + mustWrite[i].value);\r\n                var objs = document.getElementsByName(mustNamess[i]);\r\n                for(var x=0;x<objs.length;x++){\r\n                \tvar obj = objs[x];\r\n                    var objType = \"\";\r\n                    if(obj.type){\r\n                       objType = obj.type.toUpperCase();\r\n                    }else{\r\n                        if(obj.length){\r\n\t\t\t\t\t\t\tfor(var k=0;k<obj.length;k++){\r\n\t\t\t\t\t\t\t\t//i++;\r\n\t\t\t\t\t\t\t\tobjType = obj[k].type.toUpperCase();\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\tvar objTemp = obj[k];\r\n\t\t\t\t\t\t\t\tif(objType == \"TEXT\" || objType == \"PASSWORD\" || objType == \"TEXTAREA\" || objType == \"SELECT-ONE\"){\r\n");
