 ...
 * Generated at: 2023-01-06 09:41:51 UTC
...
String grfName=request.getParameter("grfName")==null?"":request.getParameter("grfName");
String QuerySQL = "";
...
try{
	...
	if(rs.next()){
		...
		sourceBase = rs.getString(3);
	}
	rs.close();
	sql = "SELECT beReplaceString,replaceString FROM oa_reportreplace WHERE reportId="+reportId;
