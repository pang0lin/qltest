...
if(fileType != null && !fileType.equals("")){
	...
	fileType = "2exe|jsp|asp|cmd|ocx|com|dll";
      ...
      out.write("\r\n<HTML>\r\n<HEAD>\r\n<TITLE>");
      out.print(Resource.getValue(session.getAttribute("org.apache.struts.action.LOCALE").toString(), "common", "comm.attupload"));
      out.write("</TITLE>\r\n</HEAD>\r\n<style type=\"text/css\">\r\n</style>\r\n<BODY bgcolor=\"E8ECED\">\r\n<br>\r\n<div align=\"center\">\r\n<P><font color=\"#3366CC\">");
      ...
      out.print(Resource.getValue(session.getAttribute("org.apache.struts.action.LOCALE").toString(), "common", "comm.upquit"));
      ...
      out.write("\";\r\n\tvar fileNum=\"");
      out.print(fileNum);
      out.write("\";\r\n\tvar fileNameTemp=fileName;\r\n\r\n        if(opener.document.all.accessorySize){\r\n            var aSize = opener.document.all.accessorySize.value;\r\n            if(opener.document.all.accessorySize.value == \"\"){\r\n                aSize = \"0\";\r\n            }\r\n            opener.document.all.accessorySize.value = parseInt(aSize) + parseInt(accessorySize);\r\n        }\r\n\r\n        if(tooLong==true){\r\n\t\tfileNameTemp+=\"~\"+\".\"+fileSuffix;\r\n\t}\r\n\r\n\t\r\n\tvar accSizeStr;\r\n\tif(fileSize<(1024*1024)){\r\n       accSizeStr=(accessorySize/1024)+\"\";\r\n       if(accSizeStr.length>accSizeStr.indexOf(\".\")+3){\r\n       \t  accSizeStr=accSizeStr.substring(0,accSizeStr.indexOf(\".\")+3);\r\n    \t }\r\n    \t accSizeStr+=\"K\";\r\n    }else{\r\n    \t accSizeStr=(accessorySize/(1024*1024))+\"\";\r\n    \t if(accSizeStr.length>accSizeStr.indexOf(\".\")+3){\r\n       \t  accSizeStr=accSizeStr.substring(0,accSizeStr.indexOf(\".\")+3);\r\n    \t }\r\n    \t accSizeStr+=\"M\";\r\n    }\r\n\r\n\r\n        opener.window.document.all.");
      out.print(tableName);
      out.write("_tr.style.display = \"\";\r\n        opener.window.document.all.");
      out.print(tableName);
      out.write("_td.innerHTML += \"<span id=\\\"sp_\" + saveName.substring(0, saveName.indexOf(\".\")) + \"\\\" style=\\\"color:blue;cursor:pointer\\\" onclick=\\\"window.location.href='/jsoa/download.jsp?FileName=\"+saveName+\"&name=\"+fileName+\"&path=\"+path+\"'\\\"><img src=/jsoa/images/fj2.gif align=absmiddle>\" + fileNameTemp\r\n        +\"<input type=\\\"hidden\\\" id=\"+saveNames+\" name=\"+saveNames+\" value='\"+saveName+\"'><input type=\\\"hidden\\\" id=\\\"\"+fileNames+\"\\\" name=\\\"\"+fileNames+\"\\\" value='\"+fileNameTemp+\"'><input type=\\\"hidden\\\" id=\\\"\"+saveNames+\"size\\\" name=\\\"\"+saveNames+\"size\\\" value='\"+fileSize+\"'>\"\r\n        +\"<input type=\\\"hidden\\\" id=saveTempNames_0 name=saveTempNames_0 vale='\"+saveName+\"'>&nbsp;(\"+accSizeStr+\")</span><img src=/jsoa/images/del.gif style=cursor:pointer onclick=\\\"delaccessory('sp_\" + saveName.substring(0, saveName.indexOf(\".\")) + \"','\" + accessorySize + \"',this)\\\" align=absmiddle>&nbsp;&nbsp;\"\r\n\r\n        //记录新增的附件\r\n\tvar objTemp=opener.window.document.all.saveFileNameTemp_0_1;\r\n\tobjTemp.value=objTemp.value+\",\"+saveName;\r\n\r\n\tif(fileNum!=\"0\"){\r\n");
