 ...
 * Generated at: 2023-01-06 09:57:46 UTC
...
public final class doc_005freceivewatch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
byte[] queryStringByte = org.apache.commons.codec.binary.Base64.decodeBase64(_queryString.getBytes("UTF-8"));    
String queryString ="&"+java.net.URLDecoder.decode(new String(queryStringByte), "UTF-8");	
...
if("ynnt".equals(SystemCommon.getCustomerName())){
	...
	index++;
      ...
      out.write("\t$(\"input[name='checkSingle']\").each(function(){\r\n\t\t$(this).attr(\"checked\",$(\"#selectAll\").attr(\"checked\"));\r\n\t});\r\n}\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>\r\n<script src=\"/jsoa/js/imenu.js\"></script>");
