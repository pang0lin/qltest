...
public final class wf_005fstepanduser_005forgfirst_jsp extends org.apache.jasper.runtime.HttpJspBase
...
switch (participantType){
	...
	case 7:
		//上一节点办理人的上级领导
		leaderList = new com.js.oa.jsflow.service.WorkFlowBD().getLeaderList(session.getAttribute("userId").toString());
...
if(bflag){ 
      ...
      out.write("\t\t\t\tvar optValue = oSelect.options[i].value;\r\n\t\t\t\tif(optValue.indexOf(\"#\"+id+\"#\")>0){\r\n\t\t\t\t\toSelect.remove(i);\r\n\t\t\t\t\tbreak;\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t\tj=j-1;\r\n\t\t}\r\n\t}\r\n}\r\nfunction showAllGroupUser(allNodeArrayGroup,id){\r\n\tfor(i = 0;i < allNodeArrayGroup.length;i ++){\r\n\t\topenMainFrame(\"$\"+allNodeArrayGroup[i][0]+\"$#\"+id+\"#\",allNodeArrayGroup[i][1]);\r\n\t}\r\n}\r\nfunction openMainFrame(opValue,opText){\r\n\tvar oSelect=window.parent.document.frm1.selectObject;\r\n\tvar nLen =oSelect.length;\r\n\tvar hasOpt = false;\r\n\tfor(i=0;i<nLen;i++){\r\n\t\tvar optObj = oSelect.options[i];\r\n\t\tif(opValue.indexOf(optObj.value)>=0 || optObj.value.indexOf(opValue)>=0){\r\n\t\t\thasOpt = true;\r\n\t\t}\r\n\t}\r\n//alert(window.parent.document.frm1.participantType.value);\r\n\t//添加到列表框\r\n\tif(!hasOpt){\r\n\r\n\t\t//判断是不是单人\r\n\t\tif(window.parent.document.frm1.participantType.value!=10 && ((window.parent.document.frm1.approveMode[0].childNodes[0].checked && opValue.indexOf(\"$\")==-1) || (window.parent.document.frm1.approveMode[0].checked && opValue.indexOf(\"$\")!=-1 && nLen>0)))\r\n\t\t{\r\n\t\t\talert(\"审批方式为单人，您不能选择多人办理！\");\r\n");
...
if(bflag){ 
	...
	if( participantType==4 ){
      ...
      out.write("_Id\")){\r\n\tvar selectUser = \"\";\r\n\tvar selectUserName = \"\";\r\n\tif(window.parent.opener.document.getElementById(\"thisDocProcess\")==null){\r\n\t\tselectUser = eval(\"window.parent.opener.document.all.");
      out.print(participantUserField);
      out.write("_Id.value\");\r\n\t\tselectUserName = eval(\"window.parent.opener.document.all.");
      out.print(participantUserField);
      out.write("_Name.value\");\r\n\t}else if(window.parent.opener.document.getElementById(\"thisDocProcess\").value==\"1\"){\r\n\t\tselectUser = eval(\"window.parent.opener.document.all.sendFieldSelectMoreEmp.value\");\r\n\t\tselectUserName = eval(\"window.parent.opener.document.all.sendFieldSelectMoreEmp_name.value\");\r\n\t}else{\r\n\t\tselectUser = eval(\"window.parent.opener.document.all.receiveFieldSelectMoreEmp.value\");\r\n\t\tselectUserName = eval(\"window.parent.opener.document.all.receiveFieldSelectMoreEmp_name.value\");\r\n\t}\r\n\t\r\n\tif(selectUserName.indexOf(\",\")!=-1){\r\n\t\tselectUserName = selectUserName.substring(0,selectUserName.length-1);\r\n\t} else{\r\n\t\tselectUser = \"$\"+selectUser +\"$\";\r\n\t}\r\n\t//新节点\r\n\tString.prototype.replaceAll=function(s1,s2)\r\n\t{var demo=this;\r\n\t while(demo.indexOf(\"$$\")!=-1)\r\n\t demo=demo.replace(s1,s2);\r\n\t return demo;\r\n\t}\r\n\tselectUser = selectUser.replaceAll(\"$$\",\",\");\r\n\tselectUser = selectUser.substring(1,selectUser.length-1);\r\n\tloadXML('userorggroup','no','");
      out.print(show);
      out.write("','','");
      out.print(range);
