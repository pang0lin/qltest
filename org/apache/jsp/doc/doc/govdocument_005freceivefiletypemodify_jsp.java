...
public final class govdocument_005freceivefiletypemodify_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getParameter("saveType")!=null)
 saveType = request.getParameter("saveType").toString();
String update_info=null;
if(request.getAttribute("update_info")!=null)
update_info=request.getAttribute("update_info").toString();
if(update_info!=null&&update_info.equals("successful")){

            out.write("\r\n<script language=\"javascript\">\r\nwindow.alert(\"收文类型修改成功！\");\r\n\r\n</script>\r\n");
}else if(update_info!=null&&update_info.equals("same")){
...
nowPage=request.getParameter("pager.offset").toString();
            ...
            try {
              ...
              // /doc/doc/govdocument_receivefiletypemodify.jsp(53,3) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/GovReceiveFileTypeAction.do?actionFlag=update");
              // /doc/doc/govdocument_receivefiletypemodify.jsp(53,3) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  if (_jspx_meth_html_005ftextarea_005f0(_jspx_th_html_005fform_005f0, _jspx_page_context))
                    return;
                  out.write("<input type=\"hidden\" name=\"tmpId\" value='");
                  ...
                  if (_jspx_meth_html_005fhidden_005f3(_jspx_th_html_005fform_005f0, _jspx_page_context))
                    return;
                  out.write("<img src=\"images/group.gif\">&nbsp;<img src=\"images/select.gif\" style=\"cursor:pointer\" onclick=\"openEndow('tmpId','userName',document.all.tmpId.value,document.all.userName.value,'user','no','userorggroup','*0*');\">\r\n\t  </td>\r\n\t</tr>\r\n   \r\n  ");
            ...
            out.write("\r\n</table>\r\n  </div>\r\n  <br/>\r\n  <table>\r\n <tr>\r\n     <td colspan=\"2\">\r\n\t\t<input type=\"button\" class=\"btnButton4font\" onclick=\"modify();\" value=\"保存退出\"/>\r\n\t\t<button class=\"btnButton2font\" onclick=\"window.location.reload();\">重置</button>\r\n\t\t<button class=\"btnButton2font\" onClick=\"cl();\">退出</button>\r\n\t </td>\r\n   </tr>\r\n  </table>\r\n  </td>\r\n  </tr>\r\n </table>\r\n\r\n\r\n</body>\r\n\r\n<script language=\"javascript\">\r\n\r\nfunction load(){\r\n\r\n    var reload = document.all.saveType.value;\r\n    if (reload == \"modify\"){\r\n        try{\r\n\t\t\twindow.opener.location.href=\"/jsoa/GovReceiveFileTypeAction.do?actionFlag=list&pager.offset=");
            out.print(nowPage);
            out.write("\" ;\r\n\t\t\twindow.close();\r\n           }\r\n    \t\tcatch(e)\r\n\t\t{\r\n\t\t    window.close();\r\n\t\t}\r\n\r\n    }\r\n}\r\nfunction cl(){\r\nwindow.close();\r\n}\r\nfunction modify(){\r\n    if(textIsEmpty(document.all.receiveFileTypeName)){\r\n        alert(\"请输入收文类型名称！\");\r\n        document.all.receiveFileTypeName.focus();\r\n        return;\r\n    }else{\r\n        beforeSubmit();\r\n        document.all.saveType.value=\"modify\";\r\n        document.GovReceiveFileTypeActionForm.action=\"/jsoa/GovReceiveFileTypeAction.do?actionFlag=update&pager.offset=");
            out.print(nowPage);
  ...
  private boolean _jspx_meth_html_005fhidden_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/govdocument_receivefiletypemodify.jsp(55,3) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/govdocument_receivefiletypemodify.jsp(58,7) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyleClass("inputText");
      // /doc/doc/govdocument_receivefiletypemodify.jsp(58,7) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setProperty("receiveFileTypeName");
      // /doc/doc/govdocument_receivefiletypemodify.jsp(58,7) name = maxlength type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setMaxlength("50");
      // /doc/doc/govdocument_receivefiletypemodify.jsp(58,7) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftextarea_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,5) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setProperty("userName");
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,5) name = readonly type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setReadonly(true);
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,5) name = rows type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setRows("5");
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,5) name = cols type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setCols("50");
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,5) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fwrite_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,144) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f0.setName("GovReceiveFileTypeActionForm");
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,144) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f0.setProperty("userId");
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,144) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fwrite_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,228) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f1.setName("GovReceiveFileTypeActionForm");
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,228) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f1.setProperty("groupId");
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,228) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fwrite_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,313) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f2.setName("GovReceiveFileTypeActionForm");
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,313) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f2.setProperty("orgId");
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,313) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/govdocument_receivefiletypemodify.jsp(64,398) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/govdocument_receivefiletypemodify.jsp(65,5) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f2.setProperty("orgId");
  ...
  private boolean _jspx_meth_html_005fhidden_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/govdocument_receivefiletypemodify.jsp(65,37) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
