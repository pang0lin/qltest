...
public final class jump_005fworkflow_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try{
	...
	sqlBuffer.append("work.workstatus,work.WORKFILETYPE, work.WORKCURSTEP , work.WORKTITLE ,")
	         ...
	         .append("where work.WORKPROCESS_ID=").append(processId)
	         .append(" and work.WORKTABLE_ID=").append(tableId)
	         .append(" and work.WORKRECORD_ID=").append(recordId);
	if("-1".equals(tableId) &&!"true".equals(isPrincipal)){
		sqlBuffer.append(" and wf_curemployee_id=").append(userId);
	}
	sqlBuffer.append(" order by work.workstatus desc");
	...
	String workStatus,title,processName,curStep,deadline,submitPerson,submitTime,
	       ...
	       submitPersonId,allowCancel,stepCount,mainlink,
