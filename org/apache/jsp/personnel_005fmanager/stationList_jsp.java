 ...
 * Generated at: 2023-01-06 09:52:48 UTC
...
if(!deleteSuccess.booleanValue()){
      out.write("\r\n<script language=\"javascript\">\r\nalert(\"删除失败！您选择的岗位正在使用\");\r\n</script>\r\n");
}
      out.write("\r\n<body   class=\"MainFrameBox\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<tr>\r\n  <td>\r\n     <table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\" id=\"searchbar\" style=\"display:none\">\r\n       <form action=\"\" id=\"fuserForm\"  method=\"post\" >\r\n\t\t<tr>\r\n\t\t    <td  nowrap=\"nowrap\">\r\n\t\t\t\t岗位名称：\r\n\t\t\t\t<input type=\"text\" id=\"empPositionName\" name=\"empPositionName\" size=\"10\" maxlength=\"50\" styleClass=\"inputtext\" style=\"width:30%\" value=\"");
      out.print(request.getAttribute("empPositionName")== null||request.getAttribute("empPositionName").equals("")?"":request.getAttribute("empPositionName") );
      out.write("\"/>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\t    <tr>\r\n\t\t  <td align=\"right\">\r\n\t\t     <button class=\"btnButton2Font\" onClick=\"search();\" >查询</button>\r\n\t\t     <button class=\"btnButton2Font\" onClick=\"document.getElementById('empPositionName').value ='';search();\" >重置</button>\r\n\t\t     \r\n\t\t  </td>\r\n\t\t</tr>\r\n\t   </form>\r\n     </table>\r\n  </td>\r\n</tr>\r\n<tr>\r\n<td>\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"inlineBottomLine\">\r\n  <tr>\r\n  ");
if(!"1".equals(fromSystem)){ 
      out.write("\r\n    <td>\r\n    ");
//if (newRight3||newRight4){ 
      out.write("\r\n\t  <div id=\"PanleDIV\"  class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/DutyAction.do?action=view');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">职务</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n    ");
//}if(managerBD.hasRight(userId, "04*01*02")){
      out.write("  \r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanelSelected\" onClick=\"changePanle(this,'/jsoa/StationAction.do');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">岗位</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n    ");
//} 
      ...
      try {
        ...
        // /personnel_manager/stationList.jsp(178,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("stationList");
        // /personnel_manager/stationList.jsp(178,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("stationList");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object stationList = null;
          ...
          stationList = (java.lang.Object) _jspx_page_context.findAttribute("stationList");
          do {
            out.write("\r\n\t\t");

		  stationObj = (Object[]) stationList;
		  index ++;
		  j++;
...
if(index % 2 == 0){
            ...
            out.print(stationObj[0]);
            out.write("\" name=\"stationId\"></td>\r\n\t\t  \r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write('"');
            out.write('>');
            ...
            out.write('"');
            out.write('>');
            out.print(stationObj[4]);
            out.write("</td>\r\n\t\t   <td class=\"");
            out.print(listClass);
            out.write('"');
            out.write('>');
            out.print((stationObj[2]==null || "".equals(stationObj[2].toString()))?"&nbsp;":stationObj[2]);
            out.write("</td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write(" listTableLineLastTD\" nowrap>\r\n\t\t  ");
if((SystemCommon.getMultiDepart()==0)||(!"0".equals(stationObj[3].toString()))||
				  ("1".equals(fromSystem)&&session.getAttribute("sysManager").toString().indexOf("1")>=0)){// 
            out.write("\r\n\t\t  <img src=\"images/modi.gif\" alt=\"修改\" style=\"cursor:pointer\" onClick=\"modify('");
            out.print(stationObj[0]);
            out.write("')\" >&nbsp;\r\n\t\t  <img src=\"images/del.gif\" alt=\"删除\" style=\"cursor:pointer\" onClick=\"delSingle('");
            out.print(stationObj[0]);
            out.write("')\" >&nbsp;\r\n\t\t  ");
}else{ 
            out.write("&nbsp;");
...
String pagerURL = "/jsoa/StationAction.do";
      out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
   ...
   if(deloff<0) deloff = 0;
      ...
      out.write("\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=\"/jsoa/StationAction.do?flag=delete&fromSystem=");
      out.print(fromSystem );
      out.write("&stationId=\" + id + \"&pager.offset=");
      out.print(deloff);
      out.write("\";\r\n    }\r\n}\r\nfunction selectAll(obj){\r\n    if(document.all.stationId){\r\n        if(document.all.stationId.length){\r\n            for(var i = 0; i < document.all.stationId.length; i ++){\r\n                if(obj.checked){\r\n                    document.all.stationId[i].checked = true;\r\n                }else{\r\n                    document.all.stationId[i].checked = false;\r\n                }\r\n            }\r\n        }else{\r\n            if(obj.checked){\r\n                document.all.stationId.checked = true;\r\n            }else{\r\n                document.all.stationId.checked = false;\r\n            }\r\n        }\r\n    }\r\n}\r\nfunction batchDelete(){\r\n\r\n        if(checkboxIsChecked(document.all.stationId)){\r\n            var id = \"\";\r\n            if(document.all.stationId.length){\r\n                for(var i = 0; i < document.all.stationId.length; i ++){\r\n                    if(document.all.stationId[i].checked){\r\n                        id += document.all.stationId[i].value + \",\";\r\n                    }\r\n                }\r\n            }else{\r\n");
      out.write("                if(document.all.stationId.checked){\r\n                    id = document.all.stationId.value;\r\n                }\r\n            }\r\n            if(id.indexOf(\",\") > 0){\r\n                id = id.substring(0, id.length - 1);\r\n            }\r\n            if(confirm(\"确实要删除吗？\")){\r\n            window.location.href = \"/jsoa/StationAction.do?flag=delete&fromSystem=");
      out.print(fromSystem );
      out.write("&stationId=\" + id + \"");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("\";;\r\n            }\r\n        }else{\r\n            alert(\"请选择要删除的记录！\");\r\n        }\r\n}\r\n\r\nfunction modify(id){\r\n    MM_openBrWindow('/jsoa/StationAction.do?flag=modify&fromSystem=");
      out.print(fromSystem );
      out.write("&stationId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=540,height=260')\r\n}\r\n\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\nfunction uploadtemplate(a,b)\r\n{\r\n    var wleft=window.screenLeft;\r\n\tvar wtop=window.screenTop;\r\n    window.open(\"/jsoa/public/jsp/uploadorgtemplate.jsp?type=\"+a+\"&fromSystem=");
      out.print(fromSystem );
      out.write("&userType=\"+b,\"newpage\",'menubar=0,scrollbars=0,left='+wleft+',top='+wtop+',width=450,height=267,resizable=no');\r\n}\r\n\r\nfunction downloadtemplate(a)\r\n{\r\n var downl=document.getElementById(\"downloadtemplate\");\r\n  downl.href=\"/jsoa/DownloadOrgTemplateAction.do?type=\"+a;\r\n  downl.click();\r\n // window.open(\"/jsoa/DownloadOrgTemplateAction.do?type=\"+a,\"\",\"\");\r\n}\r\n// xinqingsong 2013-12-06\r\nfunction showSearch(){\r\n\t  document.getElementById(\"searchbar\").style.display=\"\";\r\n\t  document.getElementById(\"btnButton2FontShow\").style.display=\"none\";\r\n\t  document.getElementById(\"btnButton2FontClose\").style.display=\"\";\r\n}\r\nfunction closeSearch(){\r\n\t  document.getElementById(\"searchbar\").style.display=\"none\";\r\n\t  document.getElementById(\"btnButton2FontShow\").style.display=\"\";\r\n\t  document.getElementById(\"btnButton2FontClose\").style.display=\"none\";\r\n}\r\nfunction search(){\r\n\tvar empPositionName=document.getElementById(\"empPositionName\").value;\r\n\t//var form = document.getElementById(\"fuserForm\");\r\n\tif(empPositionName!=null){\r\n\t\t\r\n\t\twindow.location.href=\"/jsoa/StationAction.do?flag=view&fromSystem=");
      out.print(fromSystem );
      out.write("&empPositionName=\"+empPositionName;\r\n\t\t\r\n\t}else{\r\n\t\t\r\n\t\talert(\"条件不能为空！\");\r\n\t\tdocument.getElementById(\"empPositionName\").focus();\r\n\t}\r\n}\t\r\n\t\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
