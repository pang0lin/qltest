 ...
 * Generated at: 2023-01-06 09:47:30 UTC
...
public final class intoStockModify_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.getAttribute("stockName")+"采购"+(mode.equals("stock")?"进货":"退货")+"流程等待您处理!";
...
if(request.getAttribute("haveWorkFlow")!=null&&"1".equals(request.getAttribute("haveWorkFlow")+"")){
      out.write("\r\n<body scroll=\"no\" class=\"MainFrameBox Pupwin\" onLoad=\"resizeWin(800,550);document.all.ptTypeDefine.value=");
      out.print(request.getAttribute("ptTypeDefineSelected")==null?"0":request.getAttribute("ptTypeDefineSelected"));
      ...
      out.write("\r\n<body   class=\"MainFrameBox Pupwin\" onLoad=\"resizeWin(800,600);document.all.ptTypeDefine.value=");
      ...
      try {
        ...
        // /routine/resource_manager/intoStockModify.jsp(136,4) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("/IntoStockAction");
        // /routine/resource_manager/intoStockModify.jsp(136,4) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(request.getParameter("resubmit")!=null&&request.getParameter("resubmit").toString().equals("1")&&request.getParameter("work") != null){
            ...
            try {
              ...
              // /routine/resource_manager/intoStockModify.jsp(159,24) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fselect_005f0.setProperty("ptTypeDefine");
              // /routine/resource_manager/intoStockModify.jsp(159,24) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(!"false".equals(modifyFlag)){
            out.write("\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t  <td colspan=\"4\" valign=\"top\">&nbsp;&nbsp;<button  class=\"btnButton2Font\" onclick=\"javascript:addGoods(); return false;\">增加</button></td>\r\n\t\t\t\t\t</tr>");
}
...
if(!"false".equals(modifyFlag)){
            ...
            out.write("\r\n\t\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t\t  ");
							  ...
							  if(ptDetail != null){
								  ...
								  while(iter.hasNext()){
									  ...
									  aa += Math.abs(ptDetailPO.getAmount().floatValue());
									  bb += Math.abs(ptDetailPO.getGoodsMoney().floatValue());
            ...
            out.print(new java.math.BigDecimal(Math.abs(ptDetailPO.getAmount().floatValue())).setScale(2,java.math.BigDecimal.ROUND_HALF_UP));
            out.write('"');
            out.write(' ');
            out.write(' ');
if(request.getAttribute("haveWorkFlow")!=null&&"1".equals(request.getAttribute("haveWorkFlow")+"")){
            ...
            out.write(" size=\"10\" name=\"amount\" ></td>\r\n\t\t\t\t\t\t\t\t\t\t  <td><input type=\"text\" class=\"inputtext\" value=\"");
            out.print(ptDetailPO.getMcost());
            out.write("\" size=\"10\" name=\"price\"  maxlength=\"9\" ");
if(request.getAttribute("haveWorkFlow")!=null&&"1".equals(request.getAttribute("haveWorkFlow")+"")){
            out.write(" readonly=\"readonly\" ");
}else {
            out.write(" onBlur=\"javascript:CheckAndCount();total_money();\" ");
            ...
            out.write("></td>\r\n\t\t\t\t\t\t\t\t\t\t  <td><input type=\"text\" class=\"inputtext\" value=\"");
            out.print(new java.math.BigDecimal(Math.abs(ptDetailPO.getGoodsMoney().floatValue())).setScale(2,java.math.BigDecimal.ROUND_HALF_UP));
...
if(request.getAttribute("haveWorkFlow")!=null&&"1".equals(request.getAttribute("haveWorkFlow")+"")){
 ...
 if(mode.equals("salesreturn")){ String returnReason = ptDetailPO.getReturnReason() == null ? "" : ptDetailPO.getReturnReason();
            ...
            out.write("\r\n\t\t\t\t\t\t\t\t\t\t  ");
if(!"false".equals(modifyFlag)){
            out.write("\r\n\t\t\t\t\t\t\t\t\t\t  <td><img src=\"/jsoa/images/del.gif\" alt=\"删除该物品\" onClick=\"javascript:document.all.detailTable.deleteRow(parentElement.parentElement.rowIndex);total_money();\" style=\"cursor:pointer\"></td>\r\n\t\t\t\t\t\t\t\t\t\t  ");
}
            out.write("\r\n\t\t\t\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t\t\t  ");
...
if(request.getAttribute("haveWorkFlow")!=null&&"1".equals(request.getAttribute("haveWorkFlow")+"")){
            out.write("\r\n\t\t\t\t<!--流程START-->\r\n\t\t\t\t\t");
					...
					String saveCheckFn = "worksave()";//保存时校验表单的javascript函数名称
					String mainLinkFile = "/jsoa/IntoStockAction.do?flag=modify";//文件办理时打开的页面链接
					String passLinkFile = "/jsoa/IntoStockAction.do?flag=modify";
...
if (BrowserJudge.isMSIE11AndTrend(request) || BrowserJudge.isChrome(request) || 
  ...
  private boolean _jspx_meth_bean_005fwrite_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/intoStockModify.jsp(145,24) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f0.setName("IntoStockActionForm");
      // /routine/resource_manager/intoStockModify.jsp(145,24) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/intoStockModify.jsp(145,83) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/intoStockModify.jsp(149,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/intoStockModify.jsp(156,23) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setTitle("请点击选择");
      // /routine/resource_manager/intoStockModify.jsp(156,23) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setProperty("ptOrgName");
      // /routine/resource_manager/intoStockModify.jsp(156,23) name = readonly type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setReadonly(true);
      // /routine/resource_manager/intoStockModify.jsp(156,23) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyleClass("inputtextarea");
      // /routine/resource_manager/intoStockModify.jsp(156,23) name = onclick type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setOnclick("selectOrg();");
      // /routine/resource_manager/intoStockModify.jsp(156,23) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/intoStockModify.jsp(156,157) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftext_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/intoStockModify.jsp(174,7) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setProperty("supp");
      // /routine/resource_manager/intoStockModify.jsp(174,7) name = maxlength type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setMaxlength("25");
      // /routine/resource_manager/intoStockModify.jsp(174,7) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setSize("25");
      // /routine/resource_manager/intoStockModify.jsp(174,7) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setStyleClass("inputtext");
      // /routine/resource_manager/intoStockModify.jsp(174,7) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/intoStockModify.jsp(174,103) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/intoStockModify.jsp(178,184) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftext_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/intoStockModify.jsp(184,24) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setProperty("ptHandleName");
      // /routine/resource_manager/intoStockModify.jsp(184,24) name = maxlength type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setMaxlength("20");
      // /routine/resource_manager/intoStockModify.jsp(184,24) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setSize("25");
      // /routine/resource_manager/intoStockModify.jsp(184,24) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setStyleClass("inputtext");
      // /routine/resource_manager/intoStockModify.jsp(184,24) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftext_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/intoStockModify.jsp(187,25) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f3.setProperty("invoiceNO");
      // /routine/resource_manager/intoStockModify.jsp(187,25) name = maxlength type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f3.setMaxlength("20");
      // /routine/resource_manager/intoStockModify.jsp(187,25) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f3.setSize("25");
      // /routine/resource_manager/intoStockModify.jsp(187,25) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f3.setStyleClass("inputtext");
      // /routine/resource_manager/intoStockModify.jsp(187,25) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftextarea_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/intoStockModify.jsp(193,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setProperty("remark");
      // /routine/resource_manager/intoStockModify.jsp(193,8) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setStyleId("remark");
      // /routine/resource_manager/intoStockModify.jsp(193,8) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setStyleClass("inputtextarea");
      // /routine/resource_manager/intoStockModify.jsp(193,8) name = cols type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setCols("50");
      // /routine/resource_manager/intoStockModify.jsp(193,8) name = rows type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setRows("3");
      // /routine/resource_manager/intoStockModify.jsp(193,8) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
