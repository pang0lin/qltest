...
public final class gzbqNew_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String path = request.getContextPath();
      ...
      out.write("\r\n\t<body onload=\"reset();setHeader('javascript:closeWindow();', '新增工作便签');\" class=\"wapcss\">\r\n\t\t<div class=\"form\">\r\n\t\t\t<form action=\"");
      out.print(path );
      out.write("/weiXinGzbqAction.do?action=add\" method=\"post\" id=\"form1\">\r\n\t\t\t\t<input type=\"hidden\" id=\"contents\" name=\"contents\"/>\r\n\t\t\t\t\r\n\t\t\t\t<div class=\"item\">\r\n\t\t            <div class=\"content\">\r\n\t\t                 <textarea id=\"contentT\" name=\"contentT\" rows=\"12\" placeholder=\"请输入工作便签内容\" maxlength=\"300\"></textarea>\r\n\t\t            </div>\r\n              \t</div>\r\n\r\n\t\t\t</form>\r\n\t\t</div>\r\n\t\t\r\n\t\t<!-- 按钮 -->\r\n\t\t<div class=\"footer\">\r\n\t      \t<div class=\"buttons\">\r\n\t  \t\t\t<div class=\"button\" onclick=\"javascript:save()\">保存</div>\r\n\t      \t\t<div id=\"closeWindow\" class=\"button gray\" onclick=\"javascript:closeWindow();\">关闭</div>\r\n\t\t  \t</div>\r\n       \t</div>\r\n\t\t");
