...
public final class examinationDo_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(close.equals("1")){
      ...
      try {
        ...
        // /examination/examinationDo.jsp(57,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("/ExaminationMyPaperAction.do?action=putin");
        // /examination/examinationDo.jsp(57,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setMethod("post");
        // /examination/examinationDo.jsp(57,1) name = target type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.print(id);
            out.write("\">\r\n  <input type=\"hidden\" name=\"examinerId\" value=\"");
            out.print(examinerId);
		 ...
		 for(int j = 0 ; j < stockSel.length ; j ++){	
		  ExaminationStockPO po = new ExaminationStockPO();
           po = new ExaminationStockBD().load(new Long(stockSel[j]));	 
            ...
            out.write("\r\n\t\t<tr style=\"dispaly:none\">\r\n\t\t<td style=\" display:none;\"><iframe  src=\"/jsoa/examination/refresh.jsp\" frameborder=\"0\"></iframe></td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t<td align=\"center\" height=\"45\"> <input type=\"button\" class=\"btnButton4font\" style=\"cursor:pointer\" onClick=\"javascript:save('exit');\" value=\"答题完毕\"/></td>\r\n\t\t</tr>\r\n\t   </table>\r\n\t</div>\r\n  </td>\r\n</tr>\r\n</table>\r\n");
