...
public final class layoutList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int offset1 = index ;
  ...
  String listClass="listTableLine1";
            ...
            try {
              ...
              // /portalsetup/layoutList.jsp(59,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /portalsetup/layoutList.jsp(59,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /portalsetup/layoutList.jsp(59,1) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
	  ...
	  menuType=Integer.parseInt(String.valueOf(obj[7]));
	  index ++;
    ...
    if(index%2 != 0){listClass="listTableLine2";}
                  ...
                  out.write("&nbsp;</td>\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\" nowrap><img style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" title=\"修改\" onclick=\"MM_openBrWindow('/jsoa/CustomDesktopLayoutAction.do?action=load&modifyId=");
                  out.print(obj[0]);
                  out.write("&pager.offset=");
                  out.print(offset1);
                  out.write("','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=300')\">&nbsp;<img style=\"cursor:pointer\" border=\"0\" src=\"images/del.gif\" title=\"删除\" onclick=\"del('");
                  out.print(obj[0]);
                  out.write("')\">&nbsp;<img style=\"cursor:pointer\" border=\"0\" src=\"images/setup.gif\" title=\"设计窗口\" onclick=\"edit('");
                  out.print(((String [])obj[4].toString().split("/"))[obj[4].toString().split("/").length-1]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
                  out.print(obj[1]);
...
String pagerURL = "/jsoa/CustomDesktopLayoutAction.do";
            out.write('\r');
            out.write('\n');
            out.write('	');
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\nvar flag=\"");
      out.print(flag);
      out.write("\";\r\nif(\"foraudit\"==flag){\r\n\talert(\"数据已提交审核管理员审核！\");\r\n}\r\nfunction getCheckBoxID() {\r\n    var retString=\"\" ;\r\n    for(var i = 0 ; i < InformationHeadActionForm.length ; i++ ) {\r\n        var obj = InformationHeadActionForm[i] ;\r\n         if(obj.type == \"checkbox\" && obj.name.substring(0,8) == \"batchDel\"){\r\n\t\tif(obj.checked) {\r\n                \tretString += obj.value  ;\r\n                        retString += \",\" ;\r\n\t\t}\r\n         }\r\n    }\r\n    return retString ;\r\n}\r\nfunction delAll() {\r\n     if(confirm(\"确实要全部删除吗？\")){\r\n         window.location.href=\"/jsoa/InformationHeadAction.do?action=delAll\";\r\n    }\r\n}\r\n\r\nfunction delBatch() {\r\n    var delIds=getCheckBoxID();\r\n    if(delIds==\"\"){\r\n        alert(\" 请选择要删除的记录！\");\r\n    }else{\r\n        if(confirm(\"确实要删除吗？\")){\r\n            window.location.href=\"/jsoa/InformationHeadAction.do?action=delBatch&ids=\" + delIds+\"&pager.offset=");
      out.print(offset1);
      out.write("\";\r\n        }\r\n    }\r\n }\r\n\r\nfunction del(id) {\r\n     if(confirm(\"确实要删除吗？\")){\r\n         //alert(id);\r\n         window.location.href=\"/jsoa/CustomDesktopLayoutAction.do?pager.offset=");
      out.print(offset1);
      out.write("&action=del&id=\"+id+\",\";\r\n    }\r\n }\r\n\r\nfunction edit(file,b) {\r\n     var encodefile=encodeURIComponent(file);\r\n     MM_openBrWindow('/jsoa/portal2/transition.jsp?file='+encodefile+'&name='+b,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600');\r\n     //MM_openBrWindow('/jsoa/portal/default.htm','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600');\r\n }\r\n\r\n function selectAllItem(){\r\n      var result=document.all.selectAll.checked;\r\n      var obj = document.all.tags(\"input\");\r\n      if(obj != null){\r\n          if(obj.length){\r\n              for(var i = 0;i < obj.length;i ++){\r\n                  if(obj[i].type == \"checkbox\" && obj[i].name.substring(0,8) == \"batchDel\"){\r\n                \tobj[i].checked=result;\r\n                  }\r\n              }\r\n          }\r\n      }\r\n }\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
