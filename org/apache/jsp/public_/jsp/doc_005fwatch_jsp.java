...
public final class doc_005fwatch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(queryString.indexOf("&edit")>-1){
  ...
  for(int j=0;j<fileNames.length;j++){
	  String nameNoIndex = names[j].substring(names[j].indexOf(".")+1);
	  String fileBase64 = com.js.util.util.BASE64.BASE64EncoderNoBR("FileName="+fileNames[j].trim()+"&name="+names[j].trim()+"&path="+path+(("1".equals(edit))?"&edit=1":""));
            ...
            out.print(listClass);
            out.write("\" ><span style=\"cursor:pointer;\" onclick=\"JSMainWinOpen4('/jsoa/download.jsp?");
