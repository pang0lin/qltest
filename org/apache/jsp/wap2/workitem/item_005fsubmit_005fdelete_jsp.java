...
if(to!=null && to.length()>1){
	...
	com.js.system.service.messages.RemindUtil.sendMessageToUsersNoURL(title, "", to, "jsflow", new java.util.Date(), new java.util.Date("2050/1/1"));
}
...
String showDoc = request.getParameter("showDoc")!=null&& "doc".equals(request.getParameter("showDoc"))?"&amp;showDoc=doc":"";
      ...
      out.print(app );
      out.write("/wap2/js/frost.js\"></SCRIPT>\r\n<META name=GENERATOR content=\"MSHTML 8.00.6001.19154\">\r\n</head>\r\n<body>\r\n\t<div class=\"main\">\r\n\t\t<div id=\"top\">\r\n\t\t\t<span id=\"lp2\"><div class=\"btn_3\"><a href=\"/jsoa/WorkDealWithAction.do?action=list&amp;status=0");
      out.print(showDoc );
