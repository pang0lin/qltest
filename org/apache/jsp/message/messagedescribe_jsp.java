...
public final class messagedescribe_jsp extends org.apache.jasper.runtime.HttpJspBase
...
response.setDateHeader ("Expires", 0);
      ...
      try {
        ...
        // /message/messagedescribe.jsp(63,37) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fnotEmpty_005f0.setName("describeList");
        ...
        if (_jspx_eval_logic_005fnotEmpty_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /message/messagedescribe.jsp(64,37) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("desList");
              // /message/messagedescribe.jsp(64,37) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("describeList");
              // /message/messagedescribe.jsp(64,37) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(obj[1] == null ){
                  ...
                  out.write("</td>\r\n                                      <td class=\"");
                  out.print(listClass);
                  out.write("\"><a style=\"cursor:pointer\" href=\"javascript:writeMsg('");
                  out.print(obj[0]);
                  out.write("')\">");
                  out.print(obj[2]);
                  out.write("</a></td>\r\n                                      <td class=\"");
                  ...
                  out.print(obj[3].toString().substring(0,19));
                  out.write("</td>\r\n                                      </tr>\r\n                                    ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n</html>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction load(recordCount2) {\r\n\r\n    if(recordCount2 >1000)\r\n    \talert(\"您的收件箱短信已经超过1000封，为了节约系统资源，请彻底删除一些已处理的短信，谢谢合作！！！\");\r\n    }\r\nfunction getCheckBoxID() {\r\n    var strCheckBox = \"\" ;\r\n    var k=0;\r\n\tif(document.all.form1.length){\r\n    for(var i = 0 ; i < document.all.form1.length ; i++ ) {\r\n        var obj = document.all.form1[i] ;\r\n         if(obj.type == \"checkbox\"  && obj.name==\"batchDel\"){\r\n\t\tif(obj.checked) {\r\n             \tk++;\r\n                \tstrCheckBox += obj.value  ;\r\n                    \tstrCheckBox += \",\" ;\r\n\t\t}\r\n         }\r\n    }\r\n\t}\r\n    document.all.checkboxNumber.value = k;\r\n    return strCheckBox ;\r\n}\r\n\r\nfunction writeMsg(describe_id){\r\n\tMM_openBrWindow('MessageAction.do?action=redayMsg&describeId='+describe_id,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=790,height=542')\r\n}\r\n\r\nfunction delQuiteReceive() {\r\n     var strId=getCheckBoxID();\r\n     var checkboxNumber = document.all.checkboxNumber.value;\r\n");
      out.write("     var j = document.all.jNumber.value\r\n     var pageSize2 = document.all.pageSize2.value;\r\n     var pageSize3 = document.all.pageSize3.value;\r\n     //if(checkboxNumber==j && pageSize2>=pageSize3){\r\n     //   pageSize2 = pageSize2-pageSize3;\r\n      //  }\r\n     if(strId!=\"\"){\r\n      if(confirm(\"确实要删除这些短信吗？\")){\r\n\r\n         window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/MessageAction.do?action=delQuiteReceive&ids=\" + getCheckBoxID()+\"&pager.offset=\"+pageSize2 ;\r\n         }\r\n\t  }else{\r\n             alert(\"请选择要删除的短信!\");\r\n             return;\r\n         }\r\n}\r\nfunction delAllReceive() {\r\n     if(confirm(\"确实将所有的短信删除吗？\")){\r\n         window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/MessageAction.do?action=realClearDescribe\";\r\n    }\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n");
