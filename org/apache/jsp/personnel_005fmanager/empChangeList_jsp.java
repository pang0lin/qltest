...
public final class empChangeList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
response.setDateHeader ("Expires", 0);
	...
	java.util.Date newDate = new java.util.Date();
		...
		String searchChangeEmp = "";
		if(request.getAttribute("searchChangeEmp") !=null) {
			searchChangeEmp = request.getAttribute("searchChangeEmp").toString();
		}
		String searchChangeOldOrg = "";
		if(request.getAttribute("searchChangeOldOrg") !=null) {
			searchChangeOldOrg = request.getAttribute("searchChangeOldOrg").toString();
		}
		String searchChangeNewOrg = "";
		if(request.getAttribute("searchChangeNewOrg") !=null) {
			searchChangeNewOrg = request.getAttribute("searchChangeNewOrg").toString();
		}
		String searchChangeChangeType = "";
		if(request.getAttribute("searchChangeChangeType") !=null) {
			searchChangeChangeType = request.getAttribute("searchChangeChangeType").toString();
		}
            ...
            try {
              ...
              // /personnel_manager/empChangeList.jsp(100,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/EmpChangeAction.do?action=empChangeSearch");
              // /personnel_manager/empChangeList.jsp(100,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n\t<tr>\r\n\t  <td width=\"20\" rowspan=\"3\"></td>\r\n\t  <td colspan=\"\" width=\"293\" > 调整人员：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n\t\t<input name=\"searchChangeEmp\" type=\"text\" onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'调整人员')\" onblur=\"value=checkQuery1(this,'调整人员')\"  value=\"");
                  out.print(searchChangeEmp);
                  out.write("\" maxlength=\"5\" size=\"15\" class=\"inputtext\" onkeydown=\"LY_ONKEYDOWN();\" style=\"width:105px;\"/>\r\n\t  </td>\r\n\t  <td colspan=\"\" width=\"318\" >调整类型：&nbsp;&nbsp;\r\n\t\t<select name=\"searchChangeChangeType\" class=\"inputtext\" style=\"width:105px;\">\r\n\t\t  <option value=\"0\">请选择</option>\r\n\t\t  ");
                  //  logic:iterate
                  ...
                  try {
                    ...
                    // /personnel_manager/empChangeList.jsp(109,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("List");
                    // /personnel_manager/empChangeList.jsp(109,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("empEmpTypeList");
                    // /personnel_manager/empChangeList.jsp(109,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
Object[] obj = (Object[]) List;
                        ...
                        out.write('"');
                        out.write(' ');
if(obj[0].toString().equals(searchChangeChangeType)){
                        out.write("selected");
}
                        out.write('>');
                        out.print(obj[1]);
                  ...
                  out.write("\r\n\t\t  </select>\r\n\t   </td>\r\n\t   <td width=\"298\"></td>\r\n\t   <td width=\"16\" rowspan=\"3\"></td>\r\n\t</tr>\r\n\t<tr>\r\n\t  <td colspan=\"\">调整前部门：&nbsp;&nbsp;&nbsp;\r\n\t\t<input onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'调整前部门')\" onblur=\"value=checkQuery1(this,'调整前部门')\" name=\"searchChangeOldOrg\" type=\"text\"  value=\"");
                  out.print(searchChangeOldOrg);
                  out.write("\" maxlength=\"15\" size=\"15\" class=\"inputtext\" onkeydown=\"LY_ONKEYDOWN();\" style=\"width:105px;\"/>\r\n\t  </td>\r\n\t  <td colspan=\"\">调整后部门：\r\n\t\t<input onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'调整后部门')\" onblur=\"value=checkQuery1(this,'调整后部门')\" name=\"searchChangeNewOrg\" type=\"text\"  value=\"");
                  out.print(searchChangeNewOrg);
                  ...
                  out.print(e_day);
                  out.write(");\r\n\t\t   </script>\r\n\t\t    ");
 if(request.getAttribute("htrqchecked") != null && "1".equals((String)request.getAttribute("htrqchecked"))){ 
                  out.write("\r\n\t\t    <input type=\"checkbox\" name=\"htrq\" value=\"1\" checked>\r\n\t\t\t");
}else{
                  out.write("\r\n\t\t\t<input type=\"checkbox\" name=\"htrq\" value=\"0\" >\r\n\t\t\t");
}
                  out.write("\r\n       </td>\r\n\t   \t<td align=\"right\" width=\"10%\" nowrap>\r\n\t\t    <input type=\"submit\" class=\"btnButton2font\" onClick=\"search();\" value=\"查询\"/>\r\n\t\t\t<input type=\"button\"  class=\"btnButton2Font\" onclick=\"cleared();\" style=\"cursor:pointer\" value=\"重置\" />\r\n\t  </td>\r\n\t</tr>\r\n");
  ...
  ManagerService mbd = new ManagerService();
		...
		if (mbd.hasRight(curUserId, "07*01*03")) { 
            out.write("\r\n\t\t\t<button  class=\"btnButton2Font\"  onclick=\"MM_openBrWindow('EmpChangeAction.do?action=addEmpChangeView','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=600,height=350')\">新增</button>\r\n\t\t");
}
            out.write("\r\n\t\t");
 if (mbd.hasRight(curUserId, "07*01*03")) { 
            out.write("\r\n\t\t\t<button  class=\"btnButton2Font\"  onclick=\"delBatch()\">删除</button>\r\n\t\t\t<button  class=\"btnButton2Font\"  onclick=\"exportExcel()\">导出</button>\r\n\t\t");
}
            out.write("\r\n\t\t<button id=\"hiddenSearch\"  class=\"btnButton4Font\" onClick=\"hidserch()\">查询</button>\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n\r\n\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n\t<form  name=\"form1\" method=\"post\">\r\n\t\t<tr align=\"center\">\r\n\t\t\t<td width=\"40\" class=\"listTableHead\" nowrap>\r\n\t\t\t<input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n\t\t\t<td width=\"10%\" class=\"listTableHead\"> 调整日期 </td>\r\n\t\t\t<td width=\"10%\" class=\"listTableHead\"> 调整人员 </td>\r\n\t\t\t<td  class=\"listTableHead\"> 调整前部门 </td>\r\n\t\t\t<td width=\"20%\" class=\"listTableHead\"> 调整后部门 </td>\r\n\t\t\t<td width=\"10%\" class=\"listTableHead\"> 调整前职务 </td>\r\n\t\t\t<td width=\"10%\" class=\"listTableHead\"> 调整后职务 </td>\r\n\t\t\t<td width=\"10%\" class=\"listTableHead\"> 类型 </td>\r\n\t\t\t<td width=\"8%\" class=\"listTableHeadLast\" nowrap=\"nowrap\"> 处理 </td>\r\n\t\t</tr>\r\n\r\n\t");
		...
		pageSize2=Integer.parseInt(request.getParameter("pager.offset"));
            ...
            try {
              ...
              // /personnel_manager/empChangeList.jsp(219,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setId("List");
              // /personnel_manager/empChangeList.jsp(219,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setName("personnelList");
...
if(index%2 != 0){listClass="listTableLine2";}
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj[1].toString().substring(0,10));
                  out.write("</td>\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
...
if(obj[7] !=null){
 ...
 if (mbd.hasRight(curUserId, "07*01*03")) { 
                  out.write("<img  style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" alt=\"修改\" onclick=\"modify('");
                  out.print(obj[0]);
...
String pagerURL = "/jsoa/EmpChangeAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n<!-- PAGER -->\r\n\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction getCheckBoxID() {\r\n    var strCheckBox = \"\" ;\r\n    var k=0;\r\n    for(var i = 0 ; i < document.all.form1.length ; i++ ) {\r\n        var obj = document.all.form1[i] ;\r\n         if(obj.type == \"checkbox\"  && obj.name==\"batchDel\"){\r\n\t\tif(obj.checked) {\r\n             \tk++;\r\n                \tstrCheckBox += obj.value  ;\r\n                    \tstrCheckBox += \",\" ;\r\n\t\t}\r\n         }\r\n    }\r\n    document.all.checkboxNumber.value = k;\r\n    return strCheckBox ;\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\nfunction modify(id){\r\n\tMM_openBrWindow('EmpChangeAction.do?action=selectEmpChangeView&empChangeId='+id+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=350')\r\n");
            out.write("}\r\n\r\nfunction view(id){\r\n\tMM_openBrWindow('EmpChangeAction.do?action=selectSkwjDwdmSee&skwjDwdmId='+id+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=300')\r\n}\r\n\r\nfunction del(id){\r\n    \tvar checkboxNumber = document.all.checkboxNumber.value;\r\n");
 int deloff = j==1 ?pageSize2-15:pageSize2;
   if(deloff<0) deloff = 0 ;
 
            out.write("\r\n\tvar dateCondition = \"&beginDate=\"+document.all.beginDate.value+\"&endDate=\"+document.all.endDate.value;\r\n  ");
 if(request.getAttribute("htrqchecked") != null && "1".equals((String)request.getAttribute("htrqchecked"))){ 
            out.write("\r\n\t  dateCondition = \"&htrq=1&beginDate=\"+document.all.beginDate.value+\"&endDate=\"+document.all.endDate.value;\r\n  ");
}
            out.write("\r\n    if(confirm(\"确实要删除这条调整记录吗？\")){\r\n\r\n\t   window.location.href=\"/jsoa/EmpChangeAction.do?action=deleteEmpChange&empChangeId=\"+id+\"&pager.offset=");
            out.print(deloff);
            out.write("&searchChangeEmp=");
            out.print(searchChangeEmp);
            out.write("&searchChangeChangeType=");
            out.print(searchChangeChangeType);
            out.write("&searchChangeOldOrg=");
            out.print(searchChangeOldOrg);
            out.write("&searchChangeNewOrg=");
            out.print(searchChangeNewOrg);
            out.write("\"+dateCondition;\r\n    }\r\n}\r\n\r\nfunction delBatch() {\r\n    \tvar strId=getCheckBoxID();\r\n        var checkboxNumber = document.all.checkboxNumber.value;\r\n        var j = document.all.jNumber.value\r\n        var pageSize2 = document.all.pageSize2.value;\r\n        var pageSize3 = document.all.pageSize3.value;\r\n    if(checkboxNumber==j && pageSize2>=pageSize3){\r\n        pageSize2 = pageSize2-pageSize3;\r\n        }\r\n    \tvar dateCondition = \"&beginDate=\"+document.all.beginDate.value+\"&endDate=\"+document.all.endDate.value;\r\n  ");
 if(request.getAttribute("htrqchecked") != null && "1".equals((String)request.getAttribute("htrqchecked"))){ 
            out.write("\r\n\t  dateCondition = \"&htrq=1&beginDate=\"+document.all.beginDate.value+\"&endDate=\"+document.all.endDate.value;\r\n  ");
}
            out.write("\r\n      if(strId!=\"\"){\r\n\t\tif(confirm(\"确实要删除这些调整记录吗？\")){\r\n\t         window.location.href=\"/jsoa/EmpChangeAction.do?action=deleteBatchEmpChange&ids=\" + getCheckBoxID()+\"&pager.offset=\"+pageSize2+\"&searchChangeEmp=");
            out.print(searchChangeEmp);
            out.write("&searchChangeChangeType=");
            out.print(searchChangeChangeType);
            out.write("&searchChangeOldOrg=");
            ...
            out.write("&searchChangeNewOrg=");
            out.print(searchChangeNewOrg);
            out.write("\"+dateCondition;\r\n\t    }\r\n    }else{\r\n             alert(\"请选择要删除的调整记录!\");\r\n             return;\r\n         }\r\n}\r\nfunction search(){\r\n\tdocument.EmpChangeActionForm.action=\"/jsoa/EmpChangeAction.do?action=empChangeSearch\";\r\n    document.EmpChangeActionForm.submit();\r\n}\r\nfunction cleared(){\r\n    window.location.href=\"/jsoa/EmpChangeAction.do?action=empChangView\";\r\n    }\r\nfunction LY_ONKEYDOWN(){\r\n    if(event.keyCode == 13 ){\r\n    \tdocument.EmpChangeActionForm.submit();\r\n    \t}\r\n    }\r\n\r\nfunction exportExcel(){\r\n\t\r\n\tvar idValue=\"\";\r\n\tvar input = document.getElementsByTagName(\"input\");\r\n\tfor(var i = 0; i < input.length; i ++){               \r\n\t  if(input[i].type == \"checkbox\")               \r\n\t   {                 \r\n\t      if (input[i].checked){                       \r\n\t            idValue+=input[i].value+\",\";            \r\n\t      }                \r\n\t  }          \r\n\t}\r\n\t\r\n\tEmpChangeActionForm.action=(window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\"))+\"/jsoa/EmpChangeAction.do?action=empChangeSearch&export=1&idvalues=\"+idValue;\t\r\n");
            out.write("\tdocument.EmpChangeActionForm.submit();\r\n}\r\nfunction goURL(url){\r\n  location.href=url;\r\n}\r\nfunction hidserch()\r\n{\r\n     var stable=document.getElementById(\"searchtable\");\r\n     var sbutton=document.getElementById(\"hiddenSearch\");\r\n     if(stable.style.display==\"none\")\r\n     {\r\n      stable.style.display=\"\";\r\n      hiddenSearch.innerHTML=\"关闭查询\";\r\n      \r\n     }else{\r\n     \r\n     stable.style.display=\"none\";\r\n     hiddenSearch.innerHTML=\"查询\";\r\n     \r\n     }\r\n}\r\n//-->\r\n</script>\r\n");
