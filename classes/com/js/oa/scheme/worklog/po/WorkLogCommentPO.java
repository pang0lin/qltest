...
public class WorkLogCommentPO implements Serializable {
  ...
  public WorkLogPO getWorklog() {
    return this.worklog;
  }
  
  public void setWorklog(WorkLogPO worklog) {
  ...
  public boolean equals(Object other) {
    if (!(other instanceof WorkLogCommentPO))
      return false; 
    WorkLogCommentPO castOther = (WorkLogCommentPO)other;
