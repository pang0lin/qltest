...
import com.js.oa.routine.resource.bean.IntoOutStockEJBBean;
...
public final class outStockModify_jsp extends org.apache.jasper.runtime.HttpJspBase
    implements org.apache.jasper.runtime.JspSourceDependent,
                 org.apache.jasper.runtime.JspSourceImports {


//判断当前物品库存 是否  小于 申请的数量
public String[] judgeAmount(String goodsId,Float num){
	Connection conn = null;
	PreparedStatement pstmt = null;
	ResultSet rs = null;
	int amount = 0;
	String[] strs = new String[]{"0","0"};
	String sql ="select b.stock_amount from st_goodsstock b where b.goods_id=?";
	try{
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.oa.routine.resource.bean.IntoOutStockEJBBean");
...
int isKucun=0;
if(!"".equals(stockId)){
   Map kucunMark=new com.js.oa.routine.resource.bean.IntoOutStockEJBBean().getStockKucunMark(stockId);
   isKucunYj=Integer.parseInt(kucunMark.get("isKucunYj")+"");
   isKucun=Integer.parseInt(kucunMark.get("isKucun")+"");
}


String orgName = session.getAttribute("orgName").toString();
String orgId = session.getAttribute("orgId").toString();
String ssDeptName = request.getAttribute("ssDeptName")!=null?request.getAttribute("ssDeptName").toString():"";//leeyom 修改取领用单位
...
String workTitle =request.getAttribute("makeManName")+""+
request.getAttribute("stockName")+"领用"+(mode.equals("outStock")?"出库":"退库")+"流程等待您处理!";
String curModiFields = request.getAttribute("curWriteFields")!=null?request.getAttribute("curWriteFields").toString():"";
com.js.oa.routine.resource.action.OutStockActionForm myform = (com.js.oa.routine.resource.action.OutStockActionForm)request.getAttribute("myform");
...
if(close.equals("1")){
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\nwindow.close();\r\ntry{\r\n    opener.location.href = \"/jsoa/OutStockAction.do?flag=view&stockName=");
    ...
    if(close.equals("0")){
      ...
      out.write("\r\n<!--intoStockAdd.jsp-->\r\n");
if(request.getAttribute("haveWorkFlow")!=null&&"1".equals(request.getAttribute("haveWorkFlow")+"")){
      out.write("\r\n<body  class=\"MainFrameBox Pupwin\" style=\"position:absolute;width:100%;height:350px;overflow:auto;\"  onLoad=\"resizeWin(800,550);document.all.ssTypeDefine.value=");
      out.print(request.getAttribute("ssTypeDefineSelected")==null?"0":request.getAttribute("ssTypeDefineSelected"));
      out.write(";loadToolbar('commandBar');\" onResize=\"loadToolbar('commandBar');\">\r\n<table width=\"100%\" height=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n  <tr height=\"27\">\r\n    <td height=\"27\" id=\"popToolbar\"><div id=\"commandBar\"></div>\r\n\t</td>\r\n  </tr>\r\n  <tr>\r\n<td style=\"padidng:1px;padding-top:0px;\">\r\n");
}else{
      out.write("\r\n<body  class=\"MainFrameBox Pupwin\" style=\"position:absolute;width:100%;height:350px;overflow:auto;\" onLoad=\"resizeWin(800,550);document.all.ssTypeDefine.value=");
      out.print(request.getAttribute("ssTypeDefineSelected"));
      out.write(";\">\r\n");
}
...
if(request.getAttribute("haveWorkFlow")!=null&&"1".equals(request.getAttribute("haveWorkFlow")+"")){
      ...
      try {
        ...
        // /routine/resource_manager/outStockModify.jsp(195,4) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("/OutStockAction");
        // /routine/resource_manager/outStockModify.jsp(195,4) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setMethod("post");
        int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
        if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n                                    <input type=\"hidden\" name=\"checkAmount\" value=\"\" >\r\n\t\t\t\t<input type=\"hidden\" name=\"mode\" value=\"");
            out.print(mode);
...
if(request.getParameter("resubmit")!=null&&request.getParameter("resubmit").toString().equals("1")&&request.getParameter("work") != null){
            ...
            out.write("\">\r\n\t\t\t\t    </td>\r\n\t\t\t\t  </tr>\r\n\t\t\t\t  <tr>\r\n\t\t\t\t\t  <td width=\"80\" height=\"25\">");
            out.print(mode.equals("outStock")?"出库":"退库");
            out.write("单位&nbsp;<label class=\"mustFillcolor\">*</label>：</td>\r\n\t\t\t\t\t  <td width=\"40%\">\r\n\t\t\t\t\t  ");
if(curModiFields.indexOf("$ssDept$")>=0) {
            out.write("\r\n\t\t\t\t\t  ");
            if (_jspx_meth_html_005ftext_005f0(_jspx_th_html_005fform_005f0, _jspx_page_context))
              return;
            if (_jspx_meth_html_005fhidden_005f2(_jspx_th_html_005fform_005f0, _jspx_page_context))
              return;
            out.write("\r\n\t\t\t\t\t  <input type=\"hidden\" name=\"ssDept\" value=\"");
            out.print(ssDeptId);
            out.write("\">\r\n\t\t\t\t\t  ");
}else{ 
            out.write("\r\n\t\t\t\t\t  ");
            ...
            out.write("\r\n\t\t\t\t    </td>\r\n\r\n\t\t\t\t\t<td width=\"80\" height=\"25\">");
            out.print(mode.equals("outStock")?"使用":"退库");
            out.write("人：</td>\r\n\t\t\t\t\t  <td width=\"40%\">");
...
now.setTime((java.util.Date) request.getAttribute("ssDate"));
            out.write("\r\n\t\t\t\t\t\t    ");
if (curModiFields.indexOf("$ssDate$") >= 0) { 
            out.write("\r\n\t\t\t\t\t\t  <script language=\"javascript\">var dtpDate1 = createDatePicker(\"ssDate\",\"");
            ...
            out.write("\");</script>\r\n\t\t\t\t\t\t  ");
							...
							out.println(now.get(Calendar.YEAR)+"年"+(now.get(Calendar.MONTH) + 1)+"月"+now.get(Calendar.DATE)+"日");  
            out.write("\r\n                          <input type=\"hidden\" name=\"ssDate\" value=\"");
            out.print(now.get(Calendar.YEAR)+"/"+(now.get(Calendar.MONTH) + 1)+"/"+now.get(Calendar.DATE));
            out.write("\" >\r\n\t\t\t\t\t\t  ");
}
            out.write("\r\n\t\t\t\t\t\t  ");
            ...
            out.print(mode.equals("outStock")?"出库":"退库");
            out.write("类别：</td>\r\n\t\t\t\t\t  <td width=\"40%\">\r\n\t\t\t\t\t  ");
if (curModiFields.indexOf("$stock$") >= 0) { 
            out.write("\r\n\t\t\t\t\t    ");
            //  html:select
            ...
            try {
              ...
              // /routine/resource_manager/outStockModify.jsp(240,9) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fselect_005f0.setProperty("ssTypeDefine");
              // /routine/resource_manager/outStockModify.jsp(240,9) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            out.write("\r\n\t\t\t\t\t\t<input type=\"hidden\" name=\"ssTypeDefine\" >\r\n\r\n\t\t\t\t\t ");
 }
            out.write("\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t\t  ");
            if (_jspx_meth_html_005fhidden_005f6(_jspx_th_html_005fform_005f0, _jspx_page_context))
              return;
            out.write("\r\n\t\t\t\t  </tr>\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t  <td width=\"80\" height=\"25\">备&nbsp;&nbsp;&nbsp;&nbsp;注：</td>\r\n\t\t\t\t\t  <td colspan=\"3\">\r\n\t\t\t\t\t   ");
if (curModiFields.indexOf("$remark$") >= 0) { 
            out.write("\r\n\t\t\t\t\t\t  ");
            if (_jspx_meth_html_005ftextarea_005f0(_jspx_th_html_005fform_005f0, _jspx_page_context))
              return;
            out.write("\r\n\t\t\t\t\t\t");
}else{
						out.println(myform.getRemark() != null && !"null".equals(myform.getRemark()) ? myform.getRemark() : "");
...
if(request.getParameter("canview")!=null && "1".equals(request.getParameter("canview"))){
            ...
            out.write(">&nbsp;操作</td>\r\n\t\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t\t  ");
                          ...
                          IntoOutStockEJBBean outss=new IntoOutStockEJBBean();
							    float aa=0;
								float bb=0;
							  if(ssDetail != null){
								  ...
								  while(iter.hasNext()){
									  ...
									  aa += Math.abs(ssDetailPO.getAmount().floatValue());
									  bb += Math.abs(ssDetailPO.getGoodsMoney().floatValue());
									  float kcAmout= new Float(outss.getGoodsAmount(ssDetailPO.getGoodsId()+"",stockId));
									  String goodsIdStr= ssDetailPO.getGoodsId();
            ...
            out.print(ssDetailPO.getGoodsId());
            out.write("\"></td>\r\n\t\t\t\t\t\t\t\t\t\t  <td>");
            ...
            out.print(ssDetailPO.getGoodsSpecs()==null?"":ssDetailPO.getGoodsSpecs());
            out.write("\">&nbsp;</td>\r\n\t\t\t\t\t\t\t\t\t\t  <td>");
            ...
            out.write("\" size=\"10\" name=\"amount\" ");
if(request.getAttribute("haveWorkFlow")!=null&&"1".equals(request.getAttribute("haveWorkFlow")+"")){
            out.write(" readonly=\"readonly\" ");
}else {
            out.write(" onBlur=\"javascript:CheckAndCount();total_money();\" ");
} 
            out.write(">\r\n\t\t\t\t\t\t\t\t\t\t      <input type=\"hidden\" class=\"inputtext\" value=\"");
            out.print(Math.abs(ssDetailPO.getAmount().floatValue()));
            out.write("\" size=\"10\" name=\"amountHistory\" ");
if(request.getAttribute("haveWorkFlow")!=null&&"1".equals(request.getAttribute("haveWorkFlow")+"")){
            out.write(" readonly=\"readonly\" ");
} 
            out.write(" >\r\n\t\t\t\t\t\t\t\t\t\t  </td>\r\n\t\t\t\t\t\t\t\t\t\t  <td><input type=\"text\" class=\"inputtext\" readonly value=\"");
            out.print(ssDetailPO.getPrice());
            out.write("\" size=\"10\" name=\"price\" ");
if(request.getAttribute("haveWorkFlow")!=null&&"1".equals(request.getAttribute("haveWorkFlow")+"")){
            out.write(" readonly=\"readonly\" ");
}else {
            out.write(" onBlur=\"javascript:CheckAndCount();total_money();\" ");
            ...
            out.write("\" size=\"10\" name=\"money\"  maxlength=\"9\" ");
if(request.getAttribute("haveWorkFlow")!=null&&"1".equals(request.getAttribute("haveWorkFlow")+"")){
            out.write(" readonly=\"readonly\" ");
}else {
            out.write(" onBlur=\"javascript:CheckAndCount();total_money();\" ");
            ...
            out.write("></td>\r\n\t\t\t\t\t\t\t\t\t\t    ");
            out.write("\r\n\t\t\t\t\t\t\t\t\t\t  <td align=\"center\"><input type=hidden name=kc  value=\"");
            out.print(kcAmout );
            out.write("\">&nbsp;");
            out.print(request.getAttribute("SsUseMan") );
            out.write("</td>\r\n\t\t\t\t\t\t\t\t\t\t  <td ");
if(request.getParameter("canview")!=null && "1".equals(request.getParameter("canview"))){
            out.write(" style=\"display:none\" ");
}
            out.write("><img src=\"/jsoa/images/del.gif\" alt=\"删除该物品\" onclick=\"javascript:document.all.detailTable.deleteRow(parentElement.parentElement.rowIndex);total_money();\" style=\"cursor:pointer\"></td>\r\n\t\t\t\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t\t\t\t    ");
} 
            out.write("\r\n\t\t\t\t\t\t\t\t\t   <tr>\r\n\t\t\t\t                        <td align=\"center\" height=\"25\">合计</td>\r\n\t\t\t\t                        <td>&nbsp;</td>\r\n\t\t\t\t\t\t\t\t\t\t<td>&nbsp;</td>\r\n\t\t\t\t                        <td>&nbsp;</td>\r\n\t\t\t\t                        <td><input type=\"text\" name=\"sum_num\" class=\"inputtext\" value=\"");
            out.print(new java.math.BigDecimal(aa).setScale(2,java.math.BigDecimal.ROUND_HALF_UP));
            out.write("\" size=\"10\" readonly=\"readonly\"></td>\r\n                                        <td>&nbsp;</td>\r\n                                        <td><input type=\"text\" name=\"sum_money\" class=\"inputtext\" value=\"");
            out.print(new java.math.BigDecimal(bb).setScale(2,java.math.BigDecimal.ROUND_HALF_UP));
            out.write("\" size=\"10\" readonly=\"readonly\"></td>\r\n                                          ");
            out.write("\r\n                                        <td>&nbsp;</td>\r\n\t\t\t\t                        <td ");
if(request.getParameter("canview")!=null && "1".equals(request.getParameter("canview"))){
            out.write(" style=\"display:none\" ");
...
String checkFlag = request.getAttribute("checkFlag")==null?"N":request.getAttribute("checkFlag").toString();
            ...
            out.print(df2.format((java.util.Date) request.getAttribute("makeDate")));
            out.write("</td>\r\n\t\t\t\t\t\t<td width=\"100\">审核时间：</td>\r\n\t\t\t\t\t\t<td width=\"25%\">");
            out.print(request.getAttribute("checkDate")==null?"":df2.format((java.util.Date) request.getAttribute("checkDate")));
            out.write("</td>\r\n\t\t\t\t\t\t<td width=\"80\">");
            out.print(mode.equals("outStock")?"提料员":"经办人");
            out.write("：</td>\r\n\t\t\t\t\t\t<td width=\"25%\">&nbsp;</td>\r\n\t\t\t\t\t   </tr>\r\n\t\t\t\t\t       <tr>\r\n\t\t\t\t\t    <td width=\"100\">审核状态：</td>\r\n\t\t\t\t\t\t<td align=\"left\" colspan=\"5\">");
            out.print(checkFlag.equals("Y")?"已审核":"未审核");
            out.write("</td>\r\n\t\t\t\t\t   </tr>\r\n\t\t\t\t\t  </table>\r\n\t\t\t\t\t  </td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t \t");
if(request.getAttribute("haveWorkFlow")!=null&&"1".equals(request.getAttribute("haveWorkFlow")+"")){
            out.write("\r\n\t\t\t\t<!--流程START-->\r\n\t\t\t\t\t");

					String formName="OutStockActionForm";//表单FORM名称
					String saveCheckFn = "save()";//保存时校验表单的javascript函数名称
					String mainLinkFile = "/jsoa/OutStockAction.do?flag=modify";//文件办理时打开的页面链接
					String passLinkFile = "/jsoa/OutStockAction.do?flag=modify";
					String subProcHref = "/jsoa/JsFlowAddAction.do?action=add&moduleId=13";//新建子流程链接
					String titleFieldName = "";//作为显示标题的表单中的元素的名称,如果为""则按工作流程的标题
					titleFieldName ="workTitle";
					String[][] button =null;
...
if("outStock".equals(mode)&&"true".equals(request.getParameter("isModify")) && checkFlag.equals("Y")){
            out.write("\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td colspan=\"4\">\r\n\r\n\t\t\t\t\t<table width=\"100%\" border=\"0\">\r\n\t\t\t\t\t<!-- 当领用物品需要走流程时，已审核完成的物品不能再更改，此处屏蔽掉处理按钮 -->\r\n\t\t\t\t\t\t<tr ");
if(request.getAttribute("haveWorkFlow")!=null&&"1".equals(request.getAttribute("haveWorkFlow")+"")){
            out.write(" style=\"display:none\"");
} 
            out.write(">\r\n\t\t  \t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t<input type=\"button\" class=\"btnButton4font\" style=\"cursor:pointer\" onclick=\"javascript:directsave('update');\" value=\"保存退出\" />\r\n\t\t    \t\t\t\t<input type=\"button\" class=\"btnButton2font\" style=\"cursor:pointer\" onclick=\"window.location.href =  window.location.href;\" value=\"重置\" />\r\n\t\t    \t\t\t\t<input type=\"button\" class=\"btnButton2font\" style=\"cursor:pointer\" onclick=\"javascript:window.close();\" value=\"退出\" />\r\n\t\t  \t\t\t\t\t</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<input type=\"hidden\" name=\"flag\">\r\n\t\t\t\t\t</table>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t");
}
            out.write("\r\n\t\t\t  ");
...
if (BrowserJudge.isMSIE11AndTrend(request) || BrowserJudge.isChrome(request) || 
      ...
      out.print(isKucunYj);
      out.write("\";\r\n\tif(document.all.ssOrg.value==\"\"){\r\n        document.all.ssOrgName.value=\"\";\r\n    }\r\n    if(document.all.ssUseManID.value==\"\"){\r\n        document.all.ssUseMan.value=\"\";\r\n    }\r\n    ");

    if(mode.equals("outStock")){
    
      out.write("\r\n    if(document.all.ssUseMan.value == ''){\r\n        alert(\"领用人不能为空！\");\r\n        document.all.ssUseMan.focus();\r\n        return false;\r\n    }\r\n    ");
}
      out.write("\r\n    var amounts = document.getElementsByName(\"amount\");\r\n\tfor(var j = 0; j < amounts.length; ++j){\r\n\t\tif(isAmountNaN(amounts[j].value))\r\n\t\t\treturn false;\r\n\t}\r\n     var goodsIds=document.getElementsByName(\"goodsId\");\r\n     var kc=document.getElementsByName(\"kc\");\r\n     var amount=document.getElementsByName(\"amount\");\r\n     var amountHistory=document.getElementsByName(\"amountHistory\");\r\n     var goodsName=document.getElementsByName(\"goodsName\");\r\n     if(isKucunYj==\"1\"){\r\n          if(goodsIds!=null){\r\n\t\t      for(var i=0;i<goodsIds.length;i++){\r\n\t\t         var num=Number(kc[i].value)+Number(amountHistory[i].value);\r\n\t\t         if(Number(num)<Number(amount[i].value)){\r\n\t\t           alert(goodsName[i].value+\"最大不能超过\"+num);\r\n\t\t           return false;\r\n\t\t         }\r\n\t\t      }\r\n\t\t    }\r\n     }else{\r\n       if(goodsIds!=null){\r\n\t\t      for(var i=0;i<goodsIds.length;i++){\r\n\t\t         if(Number(kc[i].value)<Number(amount[i].value)){\r\n\t\t           alert(goodsName[i].value+\"最大不能超过\"+kc[i].value);\r\n\t\t           return false;\r\n");
      out.write("\t\t         }\r\n\t\t      }\r\n\t\t }\r\n     }\r\n  \r\n    if(document.all.remark.value.length > 100){\r\n        alert(\"备注不能超过100个汉字！\");\r\n        document.all.remark.focus();\r\n\t\treturn false;\r\n    }else if(document.all.ssDept.value == 0){\r\n        alert(\"请选择领用单位！\");\r\n        document.all.ssDept.focus();\r\n\t\treturn false;\r\n    }else if(document.all.ptMoney.value == 0 || document.all.ptMoney.value == \"\" || isNaN(document.all.ptMoney.value)){\r\n        alert(\"您还没有增加物品信息，请增加物品信息！\");\r\n\t\treturn false;\r\n    }else if(document.all.ssOrg.value == \"\"){\r\n\t\talert(\"请选择部门!\");\r\n\t}else{\r\n\t\t    document.all.ssDept.value = document.all.ssOrg.value;\r\n            document.all.flag.value = tag;\r\n            OutStockActionForm.submit();\r\n    }\r\n}\r\n\r\nvar xmlHttp = false;\r\ntry {\r\n\t xmlHttp = new ActiveXObject(\"Msxml2.XMLHTTP\");\r\n} catch (e) {\r\n\ttry {\r\n\t\txmlHttp = new ActiveXObject(\"Microsoft.XMLHTTP\");\r\n\t} catch (e2) {\r\n\t\txmlHttp = false;\r\n\t}\r\n}\r\nif (!xmlHttp && typeof XMLHttpRequest != 'undefined') {\r\n\txmlHttp = new XMLHttpRequest();\r\n}\r\n\r\nfunction getHttprequestData(goodsId, stockId){\r\n");
      out.write("\txmlHttp.open(\"GET\", \"/jsoa/routine/resource_manager/checkgoodsstock_httprequest.jsp?goodsId=\"+goodsId+\"&stockId=\"+stockId, true);\r\n\txmlHttp.onreadystatechange = getData;\r\n\txmlHttp.send(null);\r\n}\r\n\r\nfunction getData(){\r\n\tif (xmlHttp.readyState == 4) {\r\n\t\tif(xmlHttp.status == 200) {\r\n\t\t\tvar response = xmlHttp.responseText;\r\n                        document.getElementById(\"checkAmount\").value=eval(response);\r\n\t\t}\r\n\t}\r\n}\r\nfunction selectUser(){\r\nopenEndow('ssUseManID','ssUseMan',document.all.ssUseManID.value,document.all.ssUseMan.value,'user','yes','user','");
      out.print(range );
      out.write("');\r\n}\r\nfunction selectOrg(){\r\nopenEndow('ssOrg','ssOrgName',document.all.ssOrg.value,document.all.ssOrgName.value,'org','yes','org','");
      out.print(range );
  ...
  private boolean _jspx_meth_bean_005fwrite_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/outStockModify.jsp(203,23) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fwrite_005f0.setName("OutStockActionForm");
      // /routine/resource_manager/outStockModify.jsp(203,23) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/outStockModify.jsp(203,81) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f0.setProperty("ssMasterId");
  ...
  private boolean _jspx_meth_html_005fhidden_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/outStockModify.jsp(207,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/outStockModify.jsp(214,7) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setProperty("ssOrgName");
      // /routine/resource_manager/outStockModify.jsp(214,7) name = readonly type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setReadonly(true);
      // /routine/resource_manager/outStockModify.jsp(214,7) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyleClass("inputtextarea");
      // /routine/resource_manager/outStockModify.jsp(214,7) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setTitle("请点击选择");
      // /routine/resource_manager/outStockModify.jsp(214,7) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyle("width:75%");
      // /routine/resource_manager/outStockModify.jsp(214,7) name = onclick type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/outStockModify.jsp(214,139) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f2.setProperty("ssOrg");
  ...
  private boolean _jspx_meth_html_005ftext_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/outStockModify.jsp(217,7) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setProperty("ssOrgName");
      // /routine/resource_manager/outStockModify.jsp(217,7) name = readonly type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setReadonly(true);
      // /routine/resource_manager/outStockModify.jsp(217,7) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setStyleClass("inputtextarea");
      // /routine/resource_manager/outStockModify.jsp(217,7) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f1.setStyle("width:75%");
  ...
  private boolean _jspx_meth_html_005fhidden_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/outStockModify.jsp(217,104) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f3.setProperty("ssOrg");
  ...
  private boolean _jspx_meth_html_005ftext_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/outStockModify.jsp(222,23) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setProperty("ssUseMan");
      // /routine/resource_manager/outStockModify.jsp(222,23) name = readonly type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setReadonly(true);
      // /routine/resource_manager/outStockModify.jsp(222,23) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f2.setStyleClass("inputtextarea");
      // /routine/resource_manager/outStockModify.jsp(222,23) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/outStockModify.jsp(222,121) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f4.setProperty("ssUseManID");
  ...
  private boolean _jspx_meth_html_005fhidden_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  html:hidden
    org.apache.struts.taglib.html.HiddenTag _jspx_th_html_005fhidden_005f5 = (org.apache.struts.taglib.html.HiddenTag) _005fjspx_005ftagPool_005fhtml_005fhidden_0026_005fstyleClass_005fproperty_005fnobody.get(org.apache.struts.taglib.html.HiddenTag.class);
    ...
    try {
      ...
      // /routine/resource_manager/outStockModify.jsp(235,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f5.setProperty("ssMan");
      // /routine/resource_manager/outStockModify.jsp(235,8) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f5.setStyleClass("inputtext");
      int _jspx_eval_html_005fhidden_005f5 = _jspx_th_html_005fhidden_005f5.doStartTag();
      if (_jspx_th_html_005fhidden_005f5.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
        return true;
      }
      _005fjspx_005ftagPool_005fhtml_005fhidden_0026_005fstyleClass_005fproperty_005fnobody.reuse(_jspx_th_html_005fhidden_005f5);
  ...
  private boolean _jspx_meth_html_005fhidden_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/outStockModify.jsp(262,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f6.setProperty("ptMoney");
      // /routine/resource_manager/outStockModify.jsp(262,8) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005ftextarea_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/outStockModify.jsp(268,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setProperty("remark");
      // /routine/resource_manager/outStockModify.jsp(268,8) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setStyleClass("inputtextarea");
      // /routine/resource_manager/outStockModify.jsp(268,8) name = style type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftextarea_005f0.setStyle("width:98%");
      // /routine/resource_manager/outStockModify.jsp(268,8) name = rows type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /routine/resource_manager/outStockModify.jsp(272,6) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f7.setProperty("remark");
