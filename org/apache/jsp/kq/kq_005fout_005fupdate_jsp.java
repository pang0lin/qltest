 ...
 * Generated at: 2023-01-06 09:43:49 UTC
...
public final class kq_005fout_005fupdate_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if ("1".equals(request.getParameter("resubmit"))) {
    ...
    KqOutPO kqOutPO=(KqOutPO)request.getAttribute("kqOutPO");
    Calendar calendar=Calendar.getInstance();
      ...
      out.print(kqOutPO.getUserName());
      out.write("</td>\r\n      <td width=\"80\" nowrap>申请部门：</td>\r\n      <td >");
      out.print(kqOutPO.getOrgName());
      out.write("</td>\r\n     </tr>\r\n                              <tr>\r\n                              ");
  calendar.setTime(kqOutPO.getStartTime());
  ...
  calendar.setTime(kqOutPO.getEndTime());
      ...
      out.print(kqOutPO.getPlace()  );
      out.write("\"/></td>\r\n    </tr>\r\n\t\t\t<tr><input type=\"hidden\" name=\"outid\" value=\"");
      out.print(kqOutPO.getId());
...
if(!"1".equals(request.getParameter("printFlag")+"")){
	if("1".equals(new SystemCommon().getKeyboardTip())){
      ...
      out.write("</td>\r\n   </tr>\r\n  ");
                            ...
                            String mainLinkFile = "/jsoa/KqOutAction.do?action=update";//文件办理时打开的页面链接
                           String passLinkFile ="/jsoa/KqOutAction.do?action=update";
							String subProcHref = "/jsoa/JsFlowAddAction.do?action=add&moduleId=8";//新建子流程链接
