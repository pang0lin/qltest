 ...
 * Generated at: 2023-01-06 09:46:41 UTC
...
String[] user={transitionUser.split(",")[0]};
...
String[] para = {workId, stepCount, remindFieldValue.toString(), request.getParameter("mainLinkFile"),
                docTitle,actionType,userId,tranType,tranFromPersonId};
...
if("addperson".equals(actionType)){
    ...
    dealwithMap.put("isStandForWork",
                    request.getParameter("isStandForWork"));
    dealwithMap.put("standForUserId",
                    request.getParameter("standForUserId"));
    ...
    dealwithMap.put("commType",
                    request.getParameter("commType"));

    dealwithMap.put("userScope",
                    request.getParameter("userScope"));
    dealwithMap.put("scopeId",
                    request.getParameter("scopeId"));
    ...
    */
    ...
    workLogVO.setReceiveUserName(transitionUser.split(",")[1]);
    workLogVO.setProcessId(request.getParameter("processId"));
    workLogVO.setTableId(request.getParameter("tableId"));
    workLogVO.setRecordId(request.getParameter("recordId"));
    workLogVO.setDomainId(session.getAttribute("domainId").toString());
