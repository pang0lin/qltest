...
public class OrganizationVO implements Serializable {
  ...
  public OrganizationVO(Long orgId, long orgParentOrgId, String orgManagerEmpId, String orgName, int orgOrderCode, Date orgFoundDate, String orgDescripte, int orgLevel, int orgHasJunior, String lastupdate, int orgStatus, Set employees) {
    this.orgId = orgId;
  ...
  public OrganizationVO(Long orgId, String orgName) {
    this.orgId = orgId;
    this.orgName = orgName;
  }
