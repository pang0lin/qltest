...
public final class oacollectfilelist_005fsuoluetu_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(null!=request.getAttribute("canDelete")&&"1".equals(request.getAttribute("canDelete").toString())){ 
            ...
            try {
              ...
              // /oacollect/oacollectfilelist_suoluetu.jsp(144,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/OACollectFileAction");
              // /oacollect/oacollectfilelist_suoluetu.jsp(144,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("get");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n  <tr>\r\n\t\t<td width=\"25%\" class=\"listTableHead\" id=\"tdWidth\" align=\"left\"><input type=\"checkbox\" name=\"sAll\" onclick=\"selectAllItem(this);\"></td>\t\t\r\n\t\t<td width=\"25%\" class=\"listTableHead\" id=\"tdWidth\">&nbsp;</td>\r\n\t\t<td width=\"25%\" class=\"listTableHead\" id=\"tdWidth\">&nbsp;</td>\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\">&nbsp;</td>\r\n  </tr>\r\n  ");

  // po.id,po.collectId,po.collectTitle,po.fileName,po.filePath,po.collectEmpId,
  //po.collectEmpName,po.collectOrgName,po.collectEmpStatus,po.createDate,po.fileNameSys 
  String listClass="listTableLine1";
  if(null!=myList){
  double r=Math.ceil((double)myList.size()/(double)4);
  int len=myList.size();
  String suffix="";//文档后缀
  String allPic="bmp,jpg,jpeg,png,tiff,gif,pcx,tga,exif,fpx,svg,psd,cdr,pcd,dxf,ufo,eps,ai,raw";//图片的类型，此类型直接显示缩略图
  for(int i=0;i<r;i++){//以下内容为显示缩略图，一共4行，每行4个
 	...
 	if(index%2 != 0){
 	     ...
 	     listClass="listTableLine1";
                  ...
                  out.write("\r\n  <tr height=\"105px;\">\r\n  \t\t");
 for(int k=0;k<4;k++) {//4列
  		
                  out.write("\r\n  \t\t<td class=\"");
                  out.print(listClass);
                  out.write("\">\r\n        \t");

        	if(((i*4)+k+1)<=myList.size()){
        		Object[] obj=(Object[])myList.get((i*4)+k);   
        		if(null!=obj[3]&&!"".equals(obj[3].toString())){
                  ...
                  out.write("\r\n        \t\t\t<table height=\"100%\" width=\"100%\">\r\n\t  \t\t\t\t<tr height=\"80%\" valign=\"bottom\">\r\n\t  \t\t\t\t\t<td align=\"center\">\r\n        \t\t\t");
        			...
        			if(!"unknown".equals(suffix)&&allPic.indexOf(suffix+",")>0){//如果是图片
					  ...
					  if(obj[10]!=null && obj[10].toString().length()>6 && obj[10].toString().substring(4,5).equals("_")){
						src_myLove=obj[10].toString().substring(0,4);
					  }else{
						src_myLove="0000";
					  }
                  ...
                  out.print(obj[10]);
                  out.write("');\" ><img src=\"/jsoa/upload/");
                  out.print(src_myLove );
                  out.write("/collectfile/");
                  out.print(obj[10]);
                  out.write("\" width=\"70\" height=\"75\"  border=\"0\"></a><br/>\r\n        \t\t\t");
}else{
                  out.write("\r\n            \t\t\t<img style=\"width:70px;height:75px;\" src=\"/jsoa/netdisk/bigFileType/");
                  out.print(suffix.toUpperCase() );
                  out.write(".png\" border=0><br/>\r\n            \t\t");
}
                  out.write("\r\n        \t\t\t\t</td>\r\n  \t\t\t\t\t</tr>\r\n        \t\t\t");
                  ...
                  out.print(obj[0]);
                  out.write("\" onclick=\"clickObj(this);\"><!-- 复选框 -->\r\n        \t\t");

        		if(null!=obj[3]&&obj[3].toString().length()>15){
        		
                  out.write("\r\n        \t\t<a title=\"");
                  out.print(obj[3]);
                  out.write('"');
                  out.write('>');
                  out.print(obj[3].toString().substring(0,14));
                  out.write("</a><!-- 文件名称 -->\r\n        \t\t");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.print(fromFlagStr );
            out.write("&displayFlag=suoluetu&collectId=");
            out.print(request.getAttribute("collectId"));
