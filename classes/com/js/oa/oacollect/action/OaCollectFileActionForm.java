...
public class OaCollectFileActionForm extends ActionForm implements Serializable {
  private Long id;
  ...
  public OaCollectFileActionForm() {}
  
  public OaCollectFileActionForm(Long collectId, String collectTitle, String fileName, String filePath, Long collectEmpId, String collectEmpName, Long collectOrgId, String collectOrgName, Long collectEmpStatus, Long remindCount, Timestamp createDate, Long createdEmp, Long createdOrg) {
