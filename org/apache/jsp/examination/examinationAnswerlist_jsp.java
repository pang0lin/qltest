...
public final class examinationAnswerlist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
queryStr = "&searchExamName="+searchExamName+"&isTime="+isTime+"&start_date="+start_date+"&end_date="+end_date;
            ...
            out.write("\r\n<body  class=\"MainFrameBox\" onKeyDown=\"if(event.keyCode==13) document.form2.submit();\" onLoad=\"resizeWin(800,600);\">\r\n\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n       <form name=\"form2\" method=\"post\" action=\"/jsoa/ExaminationManageAction.do?action=read&id=");
            out.print(id);
            out.write("\">\r\n                            <tr>\r\n                              <td >\r\n                                  &nbsp;&nbsp;答题人姓名：\r\n                                 \t<input name=\"searchExamName\" onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'答题人姓名')\" onblur=\"value=checkQuery1(this,'答题人姓名')\" type=\"text\"  class=\"inputText\"  size=\"45\" value=\"");
            out.print(searchExamName);
            out.write("\" >\r\n                              </td>\r\n\t\t\t\t\t\t\t  <td width=\"22%\" >&nbsp;</td>\r\n\t\t\t </tr>\r\n\t\t\t <tr>\r\n\t\t\t <td>&nbsp;&nbsp;答题时间：&nbsp;&nbsp;&nbsp;<script language=javascript>\r\n\t\t\tvar dtpDate = createDatePicker(\"start_date\",");
            out.print(s_year);
            out.write(',');
            out.print(s_month);
            out.write(',');
...
if(isTime.equals("1")){
            ...
            try {
              ...
              // /examination/examinationAnswerlist.jsp(140,22) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /examination/examinationAnswerlist.jsp(140,22) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj[4].toString().substring(0,16));
                  out.write("</td>\r\n\t\t\t\t\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  ...
                  out.write("&nbsp;</td>\r\n                          <td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\" align=\"left\"><img  style=\"cursor:pointer\" border=\"0\" src=\"images/pf.gif\" title=\"阅卷\" onclick=\"read('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n\r\n<script language=\"javascript\">\r\n<!--\r\n\r\nfunction read(para1,para2,para3){\r\n\tMM_openBrWindow('/jsoa/examination/examinationAnswerPreview.jsp?id='+para2+'&empID='+para3+'&answerID='+para1,'','')\r\n}\r\n\r\n//-->\r\n</script>\r\n");
