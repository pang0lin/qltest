...
public final class rcapInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String from = null!=request.getAttribute("from") ? request.getAttribute("from").toString() : "";
	...
	if(!"weixin".equals(loginType2017)){
      ...
      out.write("\r\n\t<BODY onload=\"setHeader('javascript:closeWindow()', '日程信息');\" class=\"wapcss\">\r\n\t  \t<div class=\"form\">\r\n\t\t\t");
      ...
      out.write("\r\n\t\t\t</div>\r\n\t         \r\n\t\t     <div class=\"item\">\r\n\t       \t\t<div class=\"infoTitle\" style=\"width:97.5%; text-align: left;\"><b>");
      out.print(null==event.getEventTitle() ? "" : event.getEventTitle());
      ...
      out.write("\r\n\t  \t\t\t\t<div class=\"button gray\" onclick=\"window.history.back();\">关闭</div>\r\n\t  \t\t\t\t");
