...
public final class cancelList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if(request.getParameter("cancelStartDate")!=null){
    	today =  new java.util.Date(String.valueOf(request.getParameter("cancelStartDate")).replace('-','/') );
    }
    int nowDay=today.getDate();
    int nowMonth=today.getMonth()+1;
    int nowYear=today.getYear()+1900;

    if(request.getParameter("cancelEndDate")!=null){
    	today =  new java.util.Date(String.valueOf(request.getParameter("cancelEndDate")).replace('-','/') );
    }
    ...
    int nowYear1=today.getYear()+1900;
        ...
        pageSize = Integer.parseInt(request.getAttribute("maxPageItems").toString());
            ...
            out.write("\r\n<body   class=\"MainFrameBox\" onKeyDown=\"if(event.keyCode==13) search();\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n\r\n<!-- SEARCH\tPART -->\r\n<table width=\"100%\"\tborder=\"0\" id=\"searchtable\"  style=\"display:none;\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n<form name=\"frm1\" action=\"/jsoa/VoitureCancelAction.do\" method=\"post\">\r\n\t<tr>\r\n\t  <td width=\"20\" rowspan=\"5\" ></td>\r\n\t  <td>\r\n\t\t\t部门：&nbsp;&nbsp;&nbsp;&nbsp;\r\n\t\t  <input type=\"text\" onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'部门')\" onblur=\"value=checkQuery1(this,'部门')\" name=\"searchDept\" class=\"inputtext\" style=\"width:105px\" value='");
            out.print(request.getParameter("searchDept")!=null?request.getParameter("searchDept"):"");
            out.write("'>\r\n\t  </td>\r\n\t  <td>\r\n\t\t   申请人：&nbsp;&nbsp;&nbsp;\r\n\t\t  <input type=\"text\" onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'用车人')\" onblur=\"value=checkQuery1(this,'用车人')\" name=\"searchEmpName\" class=\"inputtext\" style=\"width:105px\" value='");
            out.print(request.getParameter("searchEmpName")!=null?request.getParameter("searchEmpName"):"");
            out.write("'>\r\n\t  </td>\r\n\t   <td colspan=\"2\">\r\n\t\t   取消方式：\r\n                   ");

		  String searchStatus=request.getParameter("searchCancelMode")!=null?request.getParameter("searchCancelMode"):"0";
		  ...
		  String five=searchStatus.equals("4")?"selected":"";
            ...
            out.write("\r\n\t\t  <select name=\"searchCancelMode\" class=\"inputtext\" style=\"width:105px\">\r\n\t\t\t  <option value=\"0\" ");
            out.print(one);
            out.write(">--请选择--</option>\r\n\t\t\t  <option value=\"1\" ");
            out.print(two);
            out.write(">正常取消</option>\r\n\t\t\t  <option value=\"2\" ");
            out.print(three);
            out.write(">不正常取消</option>\r\n\t\t\t  <option value=\"3\" ");
            out.print(four);
            out.write(">管理员取消</option>\r\n\t\t  </select>\r\n\t  </td>\r\n\t  <td width=\"16\" rowspan=\"5\"></td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td colspan=\"2\"> 取消日期：\r\n\t\t  <script language=\"javascript\">\r\n\t\t  var dtpDate = createDatePicker(\"cancelStartDate\",");
            out.print(nowYear);
            out.write(',');
            out.print(nowMonth);
            out.write(',');
            out.print(nowDay);
            out.write(");\r\n\t\t  </script>&nbsp;至\r\n\t\t  <script language=\"javascript\">\r\n\t\t  var dtpDate = createDatePicker(\"cancelEndDate\",");
            out.print(nowYear1);
            out.write(',');
            out.print(nowMonth1);
            out.write(',');
...
if(voitureMtRight.equals("true")){
		...
		pageSize2=Integer.parseInt(request.getParameter("pager.offset"));
            ...
            try {
              ...
              // /routine/voiture_manager/cancelList.jsp(167,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /routine/voiture_manager/cancelList.jsp(167,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(voitureMtRight.equals("true")){
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj[4].toString().substring(0,11));
                  out.write("&nbsp;</td>\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(obj[5].toString().substring(0,11));
                  out.write("&nbsp;</td>\r\n\t\t\t\t");
if (obj[6].toString().equals("1")){
                  out.write("\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\">正常取消</td>\r\n\t\t\t\t");
}else if (obj[6].toString().equals("2")){
                  out.write("\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\">不正常取消</td>\r\n\t\t\t\t");
}else if (obj[6].toString().equals("3")){
                  out.write("\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\">管理员取消</td>\r\n\t\t\t\t");
}else {
...
if(voitureMtRight.equals("true")){
                  out.write("\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\"><img src=\"images/del.gif\" alt=\"删除\" style=\"cursor:pointer\" onclick=\"del('");
                  out.print(obj[0]);
                  out.write("')\" >&nbsp;</td>\r\n\t\t\t\t");
}
                  out.write("\r\n\t\t\t</tr>\r\n\t\t");
...
String pagerURL = "/jsoa/VoitureCancelAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n<!-- PAGER -->\r\n\r\n</td></tr></table>\r\n\r\n</body>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction getCheckBoxID() {\r\n    var strCheckBox = \"\" ;\r\n    var k=0;\r\n    for(var i = 0 ; i < document.all.VoitureCancelActionForm.length ; i++ ) {\r\n        var obj = document.all.VoitureCancelActionForm[i] ;\r\n         if(obj.type == \"checkbox\"  && obj.name==\"batchDel\"){\r\n\t\tif(obj.checked) {\r\n             \tk++;\r\n                \tstrCheckBox += obj.value  ;\r\n                    \tstrCheckBox += \",\" ;\r\n\t\t}\r\n         }\r\n    }\r\n    //document.all.checkboxNumber.value = k;\r\n    return strCheckBox ;\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\nfunction del(id){\r\n    if(confirm(\"确实要删除这条记录吗？\")){\r\n");
            out.write("\tvar datecondition = \"\";\r\n\tif(document.all.isDate.checked){\r\n      datecondition = \"&cancelStartDate=\"+document.all.cancelStartDate.value+\"&cancelEndDate=\"+document.all.cancelEndDate.value+\"&isDate=\"+document.all.isDate.value;\r\n\t}\r\n\t");
 int deloff = j==1?pageSize2-15:pageSize2;
	  if(deloff<0) deloff = 0 ;
	  
            out.write("\r\n    window.location.href=\"/jsoa/VoitureCancelAction.do?flag=del&delId=\"+id+\",\"+ \"&searchDept=\"+document.all.searchDept.value+\"&searchEmpName=\"+document.all.searchEmpName.value+\"&searchCancelMode=\"+document.all.searchCancelMode.value+datecondition+\"&pager.offset=");
            out.print(deloff);
            out.write("\";\r\n    }\r\n}\r\n\r\nfunction delBatch() {\r\n     if(getCheckBoxID()==\"\"){\r\n    \talert(\"请选择要删除的记录!\");\r\n             return;\r\n        }\r\n   else\tif(confirm(\"确实要删除这些记录吗？\")){\r\n   var datecondition = \"\";\r\n\t   if(document.all.isDate.checked){\r\n      datecondition = \"&cancelStartDate=\"+document.all.cancelStartDate.value+\"&cancelEndDate=\"+document.all.cancelEndDate.value+\"&isDate=\"+document.all.isDate.value;\r\n\t}\r\n         window.location.href=\"/jsoa/VoitureCancelAction.do?flag=del&delId=\" + getCheckBoxID()+\"&searchDept=\"+document.all.searchDept.value+\"&searchEmpName=\"+document.all.searchEmpName.value+\"&searchCancelMode=\"+document.all.searchCancelMode.value+datecondition;\r\n     }\r\n}\r\n\r\n\r\nfunction search(){\r\n    frm1.action=\"VoitureCancelAction.do?flag=search\";\r\n    frm1.submit();\r\n}\r\n\r\nfunction cleared(){\r\n   window.location.href = \"/jsoa/VoitureCancelAction.do?flag=view\" ;\r\n}\r\nfunction hidserch()\r\n{\r\n     var stable=document.getElementById(\"searchtable\");\r\n     var sbutton=document.getElementById(\"hiddenSearch\");\r\n     if(stable.style.display==\"none\")\r\n");
