...
public final class item_005fselect_005fact_005fback_005f3g_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String showDoc = request.getParameter("showDoc")!=null&& "doc".equals(request.getParameter("showDoc"))?"&showDoc=doc":"";
      ...
      out.write("\">\r\n\t<div class=\"box_2\">\r\n\t  <div class=\"list_2\">\r\n\t\t\t\t<div class=\"t1\"> 退回节点:</div>\r\n\t\t\t\t<div class=\"t2\">\r\n      <select name=\"backToAllInfo\">\r\n\t  ");
      ...
      out.write("\r\n\t\t<option value=\"0\">发起人</option>\r\n\t  </select>\r\n\r\n    \t\t\t</div>\r\n\t\t\t\t<div class=\"clear\"></div>\r\n\t </div> \r\n\t <div class=\"list_2\">\r\n\t\t\t\t<div class=\"t1\">退回意见:</div>\r\n\t\t\t\t<div class=\"t2\"><textarea id=\"include_comment\" name=\"include_comment\" rows=\"2\" maxlength=\"1000\"></textarea></div>\r\n\t\t\t\t<div class=\"clear\"></div>\r\n\t </div>\r\n\t\r\n\t<div class=\"list_2\">\r\n\t   <div class=\"t12\">\r\n\t   <input class=\"button2\" type=\"button\" value=\"确定\" onclick=\"javascript:submitForm();\"/>\r\n\t   </div>\t\r\n\t   <div class=\"clear\"></div>\r\n\t</div>\t\r\n</div>\t\r\n</form>\r\n</div>\r\n</BODY>\r\n</HTML>\r\n<script>\r\nfunction submitForm(){\r\n\tdocument.frm.action=\"");
      out.print(app);
      out.write("/wap2/workitem/item_submit_back_3g.jsp\";\r\n\tdocument.frm.submit();\r\n}\r\n</script>");
