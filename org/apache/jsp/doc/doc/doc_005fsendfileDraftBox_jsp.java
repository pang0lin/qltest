 ...
 * Generated at: 2023-01-06 10:05:24 UTC
...
public final class doc_005fsendfileDraftBox_jsp extends org.apache.jasper.runtime.HttpJspBase
...
response.setDateHeader ("Expires", 0);
	  ...
	  Object[] draftObj = null;
            ...
            try {
              ...
              // /doc/doc/doc_sendfileDraftBox.jsp(53,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("draftList");
              // /doc/doc/doc_sendfileDraftBox.jsp(53,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("draftList");
              // /doc/doc/doc_sendfileDraftBox.jsp(53,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setScope("request");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object draftList = null;
                ...
                draftList = (java.lang.Object) _jspx_page_context.findAttribute("draftList");
                do {
                  out.write("\r\n\t\t  ");

		  draftObj = (Object[]) draftList;
		  index ++;
		  if(index%2 != 0){
			 ...
			 listClass="listTableLine1";
                  ...
                  out.print(draftObj[0]);
                  out.write("', '");
                  out.print(draftObj[4]);
                  out.write("', '");
                  out.print(draftObj[5]);
                  out.write("', '");
                  out.print(draftObj[6]);
                  out.write("', '");
                  out.print(draftObj[7]);
                  out.write("', '");
                  out.print(draftObj[8]);
                  out.write("')\">  ");
                  out.print(draftObj[2]);
                  out.write("</a></td>\r\n\t\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(draftObj[3]);
                  out.write("</td>\r\n              <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(com.js.doc.util.TimeTool.convertObjectToYearMonthDateMin(draftObj[9]));
                  out.write("</td>\r\n\t\t\t  <td class=\"");
                  out.print(listClass);
...
String pagerURL = "/jsoa/GovSendFileDraftBoxAction.do";
            out.write("\r\n\t\t ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\nfunction delSingle(draftId){\r\n\r\n   if(confirm(\"确实要删除吗？\")){\r\n    window.location.href = \"/jsoa/GovSendFileDraftBoxAction.do?flag=delSingle&sendFileId=\" + draftId;\r\n   }\r\n}\r\n\r\nfunction modify(draftId, processId, processName, processType, tableId, remindField){\r\n    JSMainWinOpen('/jsoa/GovSendFileAction.do?action=draftModify&sendFileId=' + draftId + '&processId=' + processId + '&processName=' + processName + '&processType=' + processType + '&tableId=' + tableId + '&remindField=' + remindField,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=580');\r\n}\r\n//-->\r\n</script>\r\n\r\n<script src=\"/jsoa/js/util.js\"></script>");
