 ...
 * Generated at: 2023-01-06 09:58:41 UTC
...
public final class hytzweekList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String type = null!=request.getAttribute("type") ? request.getAttribute("type").toString() : "week";
      ...
      out.write("\" placeholder=\"请输入标题\" />\r\n\t\t   \t\t\t<div class=\"sousuo-11\" onclick=\"javascript:submitForm();\"><img src=\"images/weixin/ss.png\"></div>\r\n\t\t   \t\t</div>\r\n\t\t   \t</div>\r\n\t   \t</FORM>\r\n\t   \t\r\n\t   \t<!-- 信息列表 -->\r\n\t\t<div class=\"list\">\r\n\t\t\t");
			...
			if(list!=null && list.size()>0){
				...
				for(int i=0; i<list.size(); i++){
					...
					title = (String) obj[1];
					String applayDate=obj[10]==null?"":obj[10].toString().substring(0, 10);
					...
					showTitle = empName + title;
					
      out.write("\r\n\t\t\t\t\t<a style=\"text-decoration: none;\" href=\"");
      out.print(path);
      out.write("/weixin/hytz/hytzInfo.jsp?type=week&boardroomApplyId=");
      out.print(obj[0]);
      out.write("&beginIndex=");
      out.print(beginIndex );
      out.write("\">\r\n\t\t\t\t\t\t<div class=\"item\">\r\n\t\t\t\t\t   \t\t<div class=\"content\">\r\n\t\t\t\t\t   \t\t\t<div class=\"first\">\r\n\t\t\t\t\t\t\t\t\t<div class=\"title\">");
      out.print(showTitle.length()>12 ? showTitle.substring(0, 12)+"..." : showTitle );
      out.write("</div>\r\n\t\t\t\t\t\t\t\t\t<div class=\"time\">");
      out.print(applayDate);
      out.write("</div>\r\n\t\t\t\t\t        \t</div>\r\n\t\t\t\t\t        </div>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</a>\r\n\t\t\t\t\t");
      ...
      out.write("\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t\t\r\n\t\t<!-- 分页 -->\r\n\t\t");
		...
		int size=Integer.parseInt(request.getAttribute(WapUtil.RECORD_COUNT).toString());
		...
		if (size > WapUtil.LIMITED) {
			if (upIndex >= 0){
				upUrl = path + "/weiXinHytzAction.do?action=listweek&type=week&beginIndex=" + upIndex;
			...
			if (nextIndex < size){
				nextUrl = path + "/weiXinHytzAction.do?action=listweek&type=week&beginIndex=" + nextIndex;
				if (null != keyword && !"".equals(keyword))
