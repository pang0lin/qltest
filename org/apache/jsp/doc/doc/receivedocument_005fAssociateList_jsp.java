...
public final class receivedocument_005fAssociateList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String  filetitle=request.getParameter("filetitle")==null?"":request.getParameter("filetitle").toString();
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /doc/doc/receivedocument_AssociateList.jsp(46,2) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("GovSendFileAction.do?action=sendAssociate");
              // /doc/doc/receivedocument_AssociateList.jsp(46,2) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n     <tr align=\"center\">\r\n\t\t<td  width=\"30%\" class=\"listTableHead\">转发文日期</td>\r\n\t\t<td  class=\"listTableHead\">发文机构</td>\r\n\t\t<td width=\"30%\" nowrap class=\"listTableHeadLast\">发文状态</td>\r\n\t </tr>\r\n\t ");
	 ...
	 String listClass="listTableLine1";
                  ...
                  try {
                    ...
                    // /doc/doc/receivedocument_AssociateList.jsp(55,5) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("mylist");
                    // /doc/doc/receivedocument_AssociateList.jsp(55,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("mylist");
                    // /doc/doc/receivedocument_AssociateList.jsp(55,5) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
	...
	java.util.Map workMap = wfcBD.getWorkInfo("2",""+obj[0]);
		...
		"&standForUserName=" + workMap.get("stamodifyndForUserName") + "&isEdit=1&submitPersonTime="+workMap.get("submitTime");
                        ...
                        out.write("');\">");
                                     ...
                                     if(obj[3] == null){
                                         ...
                                         //out.print(procObj[0]+"&nbsp;");
                                         //out.print("办理中");
                                    	 out.print(newProc.getDocCurstep(obj[4].toString(),obj[0].toString()));
