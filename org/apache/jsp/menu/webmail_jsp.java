...
if(com.js.util.util.BrowserJudge.isMSIE(request)){ 
      ...
      out.print(menuIndex );
      out.write("');getMailAcc()\"><img src=\"/jsoa/imges/shanj.gif\" />&nbsp;写邮件</div></td>\r\n\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t  <tr id=\"mainTR_");
      out.print(++menuIndex);
      out.write("\">\r\n\t\t\t\t\t\t    <td><div id=\"topDIV");
      out.print(menuIndex );
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/webMail.do?method=getPopMailDBList')\"><img src=\"/jsoa/imges/shanj.gif\" />&nbsp;收件箱</div></td>\r\n\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t  <tr id=\"mainTR_");
      out.print(++menuIndex);
      out.write("\">\r\n\t\t\t\t\t\t    <td><div id=\"topDIV");
      out.print(menuIndex );
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/webMail.do?method=getPopMailBakList')\"><img src=\"/jsoa/imges/shanj.gif\" />&nbsp;草稿箱</div></td>\r\n\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t  <tr id=\"mainTR_");
      out.print(++menuIndex);
      out.write("\">\r\n\t\t\t\t\t\t    <td><div id=\"topDIV");
      out.print(menuIndex );
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/webMail.do?method=getPopMailSendList')\"><img src=\"/jsoa/imges/shanj.gif\" />&nbsp;发件箱</div></td>\r\n\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t  <tr id=\"mainTR_");
      out.print(++menuIndex);
      out.write("\">\r\n\t\t\t\t\t\t    <td><div id=\"topDIV");
      out.print(menuIndex );
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/webMail.do?method=getPopMailDropList')\"><img src=\"/jsoa/imges/shanj.gif\" />&nbsp;废件箱</div></td>\r\n\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t  <tr id=\"mainTR_");
      out.print(++menuIndex);
      out.write("\">\r\n\t\t\t\t\t\t    <td><div id=\"topDIV");
      out.print(menuIndex );
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/webMail.do?method=searchWebMail')\"><img src=\"/jsoa/imges/shanj.gif\" />&nbsp;搜邮件</div></td>\r\n\t\t\t\t\t\t  </tr>\r\n\t\t\t\t\t\t  <tr id=\"mainTR_");
      out.print(++menuIndex);
      out.write("\">\r\n\t\t\t\t\t\t    <td><div id=\"topDIV");
      out.print(menuIndex );
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/webMailAcc.do?method=mailAccList')\"><img src=\"/jsoa/imges/shanj.gif\" />&nbsp;账户管理</div></td>\r\n\t\t\t\t\t\t  </tr>\t\t\t\r\n\t\t\t\t\t\t</table>\r\n\t\t\t\t   </div>\r\n\t\t\t\t</td>\r\n  \t\t\t</tr>\r\n\t\t</table>\r\n</BODY>\r\n</HTML>\r\n\r\n<script src=\"/jsoa/js/imenu.js\"></script>");
