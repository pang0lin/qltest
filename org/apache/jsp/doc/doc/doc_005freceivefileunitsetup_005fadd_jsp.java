...
public final class doc_005freceivefileunitsetup_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 response.setDateHeader ("Expires", 0);
      ...
      out.write("\r\n<script language=\"javascript\">\r\nGovComeFileUnitActionForm.comeFileUnitName.onkeydown=look;\r\nfunction look(){\r\n    if(event.keyCode==13){\r\n       return false ;\r\n    }\r\n}\r\n//初始化页面\r\nfunction init() {\r\n   var done = \"");
      out.print(request.getParameter("done"));
      out.write("\" ;\r\n   var con = \"");
      out.print(request.getParameter("con"));
      out.write("\" ;\r\n   if(done==\"done\") {\r\n        var hhref =\"/jsoa/GovComeFileUnitAction.do?action=list\";\r\n        opener.location.href = hhref  ;\r\n        window.close();\r\n    }else if(con==\"continue\"){\r\n        var hhref =\"/jsoa/GovComeFileUnitAction.do?action=list\";\r\n        opener.location.href = hhref  ;\r\n   }\r\n}\r\n\r\n//检查页面参数有效性\r\nfunction initPara() {\r\n    return (\r\n    checkText(GovComeFileUnitActionForm.comeFileUnitName,100,\"单位名称\")\r\n    ) ;\r\n}\r\n\r\n//保存继续\r\nfunction saveContinue() {\r\n    if(initPara()==false) return   ;\r\n    GovComeFileUnitActionForm.con.value = \"continue\";\r\n    GovComeFileUnitActionForm.done.value = \"\";\r\n    GovComeFileUnitActionForm.submit() ;\r\n}\r\n//保存退出\r\nfunction saveClose() {\r\n    if(initPara()==false) return   ;\r\n    GovComeFileUnitActionForm.done.value =\"done\" ;\r\n    GovComeFileUnitActionForm.submit() ;\r\n}\r\n\r\n//重置\r\nfunction resetter() {\r\n    GovComeFileUnitActionForm.reset() ;\r\n}\r\n\r\n//关闭\r\nfunction closer() {\r\n    window.close();\r\n}\r\n</script>\r\n<script  src=\"/jsoa/js/checkText.js\"  language=\"javascript\" ></script>\r\n");
  ...
  private boolean _jspx_meth_html_005fform_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/doc_receivefileunitsetup_add.jsp(24,4) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fform_005f0.setAction("/GovComeFileUnitAction.do?action=add");
      // /doc/doc/doc_receivefileunitsetup_add.jsp(24,4) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fform_005f0.setMethod("post");
      int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
      if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n\t  <input type=\"hidden\" name=\"done\"/>\r\n\t  <input  type=\"hidden\" name=\"con\"/>\r\n\t\t<tr>\r\n\t\t  <td width=\"85\" nowrap>来文单位：</td>\r\n\t\t  <td>\r\n\t\t  ");
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/doc/doc_receivefileunitsetup_add.jsp(30,4) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyleClass("inputText");
      // /doc/doc/doc_receivefileunitsetup_add.jsp(30,4) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setProperty("comeFileUnitName");
      // /doc/doc/doc_receivefileunitsetup_add.jsp(30,4) name = maxlength type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setMaxlength("100");
      // /doc/doc/doc_receivefileunitsetup_add.jsp(30,4) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
