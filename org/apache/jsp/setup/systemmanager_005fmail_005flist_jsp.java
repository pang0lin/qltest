...
public final class systemmanager_005fmail_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List list = (List) request.getAttribute("mailList");
      ...
      try {
        ...
        // /setup/systemmanager_mail_list.jsp(88,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("mailList");
        // /setup/systemmanager_mail_list.jsp(88,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("mailList");
        // /setup/systemmanager_mail_list.jsp(88,7) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setScope("request");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object mailList = null;
          ...
          mailList = (java.lang.Object) _jspx_page_context.findAttribute("mailList");
          do {
            out.write("\r\n\t\t\t\t\t\t\t\t");

											Object[] obj = (Object[]) mailList;
											String fromUser = obj[1].toString();
											String pwd = obj[2].toString();
											String smtp = obj[3].toString();
											String createTime = obj[4].toString();
											String port = obj[5].toString();
											String encryptionType = "SSL";
											if(obj[6] != null){
											   encryptionType = obj[6].toString();
											}
										index++;
										if(index%2 != 0){
            ...
            out.print(listClass);
            out.write("\">\r\n\t\t                                ");
            out.print(fromUser==null?"无账号":fromUser );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t\t");
            out.print((smtp==null||smtp.equals(""))?"无":smtp );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t\t");
            out.print((port==null||port.equals(""))?"无":port );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t    ");
            out.print((encryptionType == null || "".equals(encryptionType))?"SSL":encryptionType );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t\t\t\t\t");
            out.print(createTime==null?"":createTime );
            out.write("\r\n\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
