 ...
 * Generated at: 2023-01-06 09:51:51 UTC
...
public final class EmpAttendanceExport_jsp extends org.apache.jasper.runtime.HttpJspBase
...
response.setHeader("Content-disposition", "attachment;filename="+new String("员工考勤记录".getBytes("GBK"),"iso8859-1")+".xls");
...
int m = now.getMonth() + 1;
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n<head>\r\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=GBK\">\r\n</head>\r\n\r\n<body>\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"1\" cellpadding=\"0\" cellspacing=\"1\" >\r\n\t  <tr align=\"center\">\r\n\t\t<th width=\"8%\" nowrap=\"nowrap\" rowspan=\"2\">年月</th>\r\n\t\t<th width=\"8%\" rowspan=\"2\">姓名</th>\r\n\t\t<th width=\"10%\" nowrap=\"nowrap\" colspan=\"2\">合计</th>\r\n\t\t<th width=\"15%\" nowrap=\"nowrap\" colspan=\"3\">累计加班工时</th>\r\n\t\t<th width=\"25%\" nowrap=\"nowrap\" colspan=\"5\">扣除工时</th>\r\n\t\t<th width=\"25%\" nowrap=\"nowrap\" rowspan=\"2\">备注</th>\r\n\t  </tr>\r\n\t  <tr align=\"center\">\r\n\t\t<th width=\"5%\" nowrap=\"nowrap\">应出工时</th>\r\n\t\t<th width=\"10%\">实际出勤/加班</th>\r\n\t\t<th width=\"5%\" nowrap=\"nowrap\">延时</th>\r\n\t\t<th width=\"5%\" nowrap=\"nowrap\">双休</th>\r\n\t\t<th width=\"5%\" nowrap=\"nowrap\">法定</th>\r\n\t\t<th width=\"5%\" nowrap=\"nowrap\">请假</th>\r\n\t\t<th width=\"5%\" nowrap=\"nowrap\">休工</th>\r\n\t\t<th width=\"5%\" nowrap=\"nowrap\">调休</th>\r\n\t\t<th width=\"5%\" nowrap>未打卡</th>\r\n\t\t<th width=\"5%\" nowrap>迟到</th>\r\n\t  </tr>\r\n\r\n\t\t");
		...
		String listClass="";
            ...
            try {
              ...
              // /personnel_manager/EmpAttendanceExport.jsp(57,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /personnel_manager/EmpAttendanceExport.jsp(57,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /personnel_manager/EmpAttendanceExport.jsp(57,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
