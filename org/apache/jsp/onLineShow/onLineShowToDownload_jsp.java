...
public final class onLineShowToDownload_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String[] fileNames = com.js.util.util.BASE64.BASE64DecoderNoBR(request.getQueryString()).split("&&");
String filepath=fileNames[0];
String FileName=fileNames[1];
String name=fileNames[3];
