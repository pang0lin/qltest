...
public class KqLeaveAction extends Action {
  public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws NumberFormatException, Exception {
    KqLeaveActionForm form = (KqLeaveActionForm)actionForm;
    String tag = "list";
    ...
    if (action.equals("list")) {
      ...
      if (action.equals("add")) {
        ...
        if (httpServletRequest.getParameter("processId") == null) {
          ...
          if (flowList != null && flowList.size() == 1) {
            ...
            StringBuffer forwardURL = new StringBuffer("/KqLeaveAction.do?action=add&moduleId=5&");
      ...
      if (action.equals("update")) {
        ...
        if (leaveId == null)
          leaveId = httpServletRequest.getParameter("record"); 
        KqLeavePO kqLeavePO = new KqLeavePO();
        kqLeavePO = kqLeaveBD.searchById((new Long(leaveId)).longValue());
        httpServletRequest.setAttribute("kqLeavePO", kqLeavePO);
  ...
  private void list(HttpServletRequest httpServletRequest) throws NumberFormatException, Exception {
    ...
    Page page = new Page(
        "po.id,po.userId,po.userName,po.orgId,po.orgName,po.startTime,po.endTime,po.cause,po.status,po.leaveType", 
        "com.js.oa.hr.kq.po.KqLeavePO po ", 
        whereSql);
