...
public final class hprecordList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
response.setDateHeader ("Expires", 0);
	...
	java.util.Date newDate = new java.util.Date();
		...
		String searchHpTitle = "";
		if(request.getAttribute("searchHpTitle") !=null) {
			searchHpTitle = request.getAttribute("searchHpTitle").toString();
		}
		String searchHpType = "";
		if(request.getAttribute("searchHpType") !=null) {
			searchHpType = request.getAttribute("searchHpType").toString();
		}
		String searchHpPersonnelName = "";
		if(request.getAttribute("searchHpPersonnelName") !=null) {
			searchHpPersonnelName = request.getAttribute("searchHpPersonnelName").toString();
		}
            ...
            try {
              ...
              // /personnel_manager/hprecordList.jsp(92,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/HprecordAction.do?action=hprecordSearch");
              // /personnel_manager/hprecordList.jsp(92,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n<table width=\"100%\"\tborder=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n\t<tr>\r\n\t  <td colspan=\"\" width=\"40%\" nowrap=\"nowrap\">&nbsp;&nbsp;&nbsp;&nbsp;标题：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n\t\t<input name=\"searchHpTitle\" type=\"text\" onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'标题')\" onblur=\"value=checkQuery1(this,'标题')\"  value=\"");
                  out.print(searchHpTitle);
                  out.write("\" class=\"inputtext\" onkeydown=\"LY_ONKEYDOWN();\" style=\"width:305px;\"/>\r\n\t  </td>\r\n\t  <td width=\"20%\" nowrap=\"nowrap\">奖惩种类：\r\n\t\t<select name=\"searchHpType\" class=\"inputtext\" style=\"width:105px;\">\r\n\t\t  <option value=\"0\">请选择</option>\r\n\t\t  ");
                  //  logic:iterate
                  ...
                  try {
                    ...
                    // /personnel_manager/hprecordList.jsp(101,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("List");
                    // /personnel_manager/hprecordList.jsp(101,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("hortationPunishList");
                    // /personnel_manager/hprecordList.jsp(101,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
Object[] obj1 = (Object[]) List;
                        ...
                        out.write('"');
                        out.write(' ');
if(obj1[0].toString().equals(searchHpType)){
                        out.write("selected");
}
                        out.write('>');
                        out.print(obj1[1]);
                  ...
                  out.write("\r\n\t\t  </select>\r\n\t   </td>\r\n\t  <td nowrap=\"nowrap\">奖惩人员：\r\n\t\t<input onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'奖惩人员')\" onblur=\"value=checkQuery1(this,'奖惩人员')\" name=\"searchHpPersonnelName\" type=\"text\"  value=\"");
                  out.print(searchHpPersonnelName);
                  out.write("\" class=\"inputtext\" onkeydown=\"LY_ONKEYDOWN();\" style=\"width:105px;\"/>\r\n\t  </td>\r\n\t  <td colspan=\"\"></td>\r\n\t</tr>\r\n\t<tr>\r\n\t  <td nowrap=\"nowrap\">&nbsp;&nbsp;&nbsp;&nbsp;奖惩日期：&nbsp;\r\n\t\t  <script language=javascript>\r\n\t\t\t\tvar dtpDate = createDatePicker(\"beginDate\",");
                  out.print(b_year);
                  out.write(',');
                  out.print(b_month);
                  out.write(',');
...
if(request.getAttribute("htrqchecked")!=null&&"1".equals((String)request.getAttribute("htrqchecked"))){
 ...
 if(new ManagerService().
                    hasRight(session.getAttribute("userId").toString(),
                             "07*33*02")){ 
            out.write("\r\n\t\t\t<button  class=\"btnButton2Font\"  onclick=\"MM_openBrWindow('HprecordAction.do?action=addHprecordView','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=600,height=350')\">新增</button>\r\n\t\t\t");
}
            out.write("\r\n\t\t\t  ");
 if(new ManagerService().
                    hasRight(session.getAttribute("userId").toString(),
		...
		int index = 0;
            ...
            try {
              ...
              // /personnel_manager/hprecordList.jsp(184,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setId("List");
              // /personnel_manager/hprecordList.jsp(184,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setName("personnelList");
              // /personnel_manager/hprecordList.jsp(184,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(index%2 != 0){listClass="listTableLine2";}
                  ...
                  out.write("</td>\r\n\t\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"><a href=\"javascript:void(0);\" onClick=\"toview('");
                  out.print(obj[0]);
                  out.write("')\">");
                  out.print(obj[2]);
                  out.write("</a></td>\r\n\t\t\t\t<td class=\"");
...
String pagerURL = "/jsoa/HprecordAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\nfunction getCheckBoxID() {\r\n    var strCheckBox = \"\" ;\r\n    var k=0;\r\n    for(var i = 0 ; i < document.all.form1.length ; i++ ) {\r\n        var obj = document.all.form1[i] ;\r\n         if(obj.type == \"checkbox\"  && obj.name==\"batchDel\"){\r\n\t\tif(obj.checked) {\r\n             \tk++;\r\n                \tstrCheckBox += obj.value  ;\r\n                    \tstrCheckBox += \",\" ;\r\n\t\t}\r\n         }\r\n    }\r\n    document.all.checkboxNumber.value = k;\r\n    return strCheckBox ;\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\nfunction modify(id){\r\n\tMM_openBrWindow('HprecordAction.do?action=selectHprecordView&hprecordId='+id+'&pagerOffset='+document.all.pageSize2.value+'&beginDate='+document.all.beginDate.value+'&endDate='+document.all.endDate.value+'&searchHpTitle='+document.all.searchHpTitle.value+'&searchHpType='+document.all.searchHpType.value+'&searchHpPersonnelName='+document.all.searchHpPersonnelName.value+'&htrq='+document.all.htrq.value,'','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=600,height=350')\r\n");
      out.write("}\r\n\r\nfunction toview(id){\r\n    MM_openBrWindow('/jsoa/HprecordAction.do?action=toHprecordView&hprecordId=' + id + '','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=540,height=260')\r\n}\r\n\r\n\tfunction view(id){\r\n    MM_openBrWindow('/jsoa/HortationPunishClassAction.do?flag=toview&hortationPunishId=' + id + '','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=540,height=260')\r\n}\r\n\r\nfunction del(id){\r\n\t\tvar beginDate=document.all.beginDate.value;\r\n\t\tvar endDate=document.all.endDate.value;\r\n\t\tvar searchHpTitle=document.all.searchHpTitle.value;\r\n\t\tvar searchHpType=document.all.searchHpType.value;\r\n\t\tvar searchHpPersonnelName=document.all.searchHpPersonnelName.value;\r\n\t\tvar del;\r\n    \tvar checkboxNumber = document.all.checkboxNumber.value;\r\n        var j = document.all.jNumber.value;\r\n        var pageSize2 = document.all.pageSize2.value;\r\n        var pageSize3 = document.all.pageSize3.value;\r\n\t\tif(j==1)del=pageSize2-15;\r\n\t\telse del=pageSize2;\r\n\t\tif(del<0) del = 0;\r\n\r\n    if(confirm(\"确实要删除这条奖惩纪录吗？\")){\r\n    HprecordActionForm.action=\"/jsoa/HprecordAction.do?action=deleteHprecord&hprecordId=\"+id+\"&pager.offset=\"+del+\"&searchHpPersonnelName=\"+searchHpPersonnelName+\"&searchHpTitle=\"+searchHpTitle+\"&searchHpType=\"+searchHpType+\"&beginDate=\"+beginDate+\"&endDate=\"+endDate;\r\n");
      out.write("        document.HprecordActionForm.submit();\r\n    }\r\n}\r\n\r\nfunction delBatch() {\r\n    \tvar strId=getCheckBoxID();\r\n\t\tvar beginDate=document.all.beginDate.value;\r\n\t\tvar endDate=document.all.endDate.value;\r\n\t\tvar searchHpTitle=document.all.searchHpTitle.value;\r\n\t\tvar searchHpType=document.all.searchHpType.value;\r\n\t\tvar searchHpPersonnelName=document.all.searchHpPersonnelName.value;\r\n\t\tvar delBatch;\r\n    \tvar checkboxNumber = document.all.checkboxNumber.value;\r\n        var j = document.all.jNumber.value;\r\n        var pageSize2 = document.all.pageSize2.value;\r\n        var pageSize3 = document.all.pageSize3.value;\r\n\t\tif(j==1)delBatch=pageSize2-15;\r\n\t\telse delBatch=pageSize2;\r\n\t\tif(delBatch<0) delBatch = 0;\r\n        if(strId!=\"\"){\r\n\tif(confirm(\"确实要删除这些奖惩纪录吗？\")){\r\n\t\tHprecordActionForm.action=\"/jsoa/HprecordAction.do?action=deleteBatchHprecord&ids=\" + getCheckBoxID()+\"&pager.offset=\"+delBatch+\"&searchHpPersonnelName=\"+searchHpPersonnelName+\"&searchHpTitle=\"+searchHpTitle+\"&searchHpType=\"+searchHpType+\"&beginDate=\"+beginDate+\"&endDate=\"+endDate; ;\r\n");
      out.write("        document.HprecordActionForm.submit();\r\n    }\r\n    }else{\r\n             alert(\"请选择要删除的奖惩纪录!\");\r\n             return;\r\n         }\r\n}\r\nfunction search(){\r\n\tHprecordActionForm.action=\"/jsoa/HprecordAction.do?action=hprecordSearch\";\r\n    document.HprecordActionForm.submit();\r\n}\r\nfunction cleared(){\r\n    window.location.href=\"/jsoa/HprecordAction.do?action=hprecordView\";\r\n    }\r\nfunction LY_ONKEYDOWN(){\r\n    if(event.keyCode == 13 ){\r\n    \tdocument.HprecordActionForm.submit();\r\n    \t}\r\n    }\r\n\r\nfunction exportExcel() {\r\n\t//TrainRecordActionForm.target = \"_blank\";\r\n\tHprecordActionForm.action = \"/jsoa/HprecordAction.do?action=export\";\r\n\tHprecordActionForm.submit();\r\n\tHprecordActionForm.action = \"/jsoa/HprecordAction.do?action=hprecordSearch\";\r\n}\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
