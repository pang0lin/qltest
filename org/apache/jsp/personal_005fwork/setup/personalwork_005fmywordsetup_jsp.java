...
public final class personalwork_005fmywordsetup_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if("0".equals(SystemCommon.getShowPassword())){
      ...
      if(com.js.util.config.SystemCommon.getUserDefineSignaturePassword()==1){
            ...
            out.write("\r\n\t\t</td>\r\n\t  <td align=\"right\">\r\n\t\t  <button  class=\"btnButton2Font\" onclick=\"add()\">");
            ...
            if (_jspx_meth_bean_005fmessage_005f2(_jspx_th_html_005fhtml_005f0, _jspx_page_context))
              return;
            out.write("</button>\r\n\t     <!--button  class=\"btnButton2Font\" onclick=\"delAll()\">");
            ...
            try {
              ...
              // /personal_work/setup/personalwork_mywordsetup.jsp(168,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/OfficalDictionAction.do?action=list");
              // /personal_work/setup/personalwork_mywordsetup.jsp(168,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  if (_jspx_meth_bean_005fmessage_005f4(_jspx_th_html_005fform_005f0, _jspx_page_context))
                    return;
                  out.write("</td>\r\n\t\t<!--td width=\"12%\" class=\"listTableHead\">是否共享</td-->\r\n\t\t<td width=\"20%\" class=\"listTableHead\">");
	  ...
	  String listClass="listTableLine1";
                  ...
                  try {
                    ...
                    // /personal_work/setup/personalwork_mywordsetup.jsp(181,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("mylist");
                    // /personal_work/setup/personalwork_mywordsetup.jsp(181,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("mylist");
                    // /personal_work/setup/personalwork_mywordsetup.jsp(181,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		listClass = index%2!=0?"listTableLine2":"listTableLine1";
                        ...
                        out.write("\r\n\t\t<tr>\r\n\t\t   <td class=\"");
                        out.print(listClass);
                        out.write("\"><input type=\"checkbox\" style=\"cursor:'hand'\" ");
                        out.print((obj[3]!=null && !"".equals(obj[3].toString()))&&(obj[3]+"").equals("1")&&!curUserId.equals(""+obj[4])?"disabled":"&nbsp;");
                        out.write(" name=\"batchDel");
                        out.print(obj[0]);
                        out.write("\" value=\"");
                        out.print(obj[0]);
                        out.write('"');
                        ...
                        if (_jspx_meth_bean_005fmessage_005f7(_jspx_th_logic_005fiterate_005f0, _jspx_page_context))
                          return;
                        out.write("\" onclick=\"MM_openBrWindow('/jsoa/OfficalDictionAction.do?viewWord=yes&action=load&loadType=see&editId=");
                        out.print(obj[0]);
                        out.write("&pager.offset=");
                        out.print(offset1);
                        out.write("','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=300')\">");
                        out.print((obj[1]==null || "".equals(obj[1].toString()))?"&nbsp;":obj[1]);
                        out.write("</a></td>\r\n\t       <!--td class=\"");
                        out.print(listClass);
                        out.write('"');
                        out.write('>');
                        out.write(' ');
                        out.print((obj[3]==null || "".equals(obj[3].toString()))?"&nbsp;":"1".equals(""+obj[3])?Resource.getValue(local, "personalwork", "commonuse.yes"):Resource.getValue(local, "personalwork", "commonuse.no"));
                        out.write("</td--> \r\n\t\t   <td class=\"");
                        out.print(listClass);
                        out.write('"');
                        out.write('>');
...
if((obj[3]!=null && !"".equals(obj[3].toString()))&&(obj[3]+"").equals("1")&&!curUserId.equals(""+obj[4])) {
                    out.print("&nbsp;") ;
			   }else{
...
String pagerURL = "/jsoa/OfficalDictionAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("/personal_work/setup/personalwork_mywordsetup_add.jsp\";\r\n\t  MM_openBrWindow(url,\"新增RSS类别\",'menubar=0,scrollbars=0,left='+wleft+',top='+wtop+',width=450,height=250,resizable=no'); \r\n\t}\r\n\t\r\n   function modify(a,b){\r\n\t  var url=\"");
      out.print(request.getContextPath());
      out.write("/OfficalDictionAction.do?action=load&editId=\"+a+\"&pager.offset=\"+b;\r\n\t  MM_openBrWindow(url,\"新增RSS类别\",'menubar=0,scrollbars=0,left='+wleft+',top='+wtop+',width=450,height=250,resizable=no'); \r\n\t}\r\n\t\r\n\r\n\r\n//全部删除\r\nfunction delAll() {\r\n     if(confirm(Personalwork.commonuse_deleteall)){\r\n         window.location.href=\"/jsoa/OfficalDictionAction.do?action=delAll\";\r\n    }\r\n}\r\n\r\n//批量删除\r\nfunction delBatch() {\r\n    var ids = getCheckBoxID();\r\n    if(ids == \"\") {\r\n        alert(Personalwork.commonuse_noselected) ;\r\n    }else {\r\n         if(confirm(Personalwork.commonuse_delete)){\r\n            var countRecordCount = \"");
      out.print(countRecordCount);
      out.write("\" ;\r\n            var offset1 = parseInt(\"");
      out.print(offset1);
      out.write("\") ;\r\n            var idsArr = ids.split(\",\")  ;\r\n            var moveoffset = idsArr.length-1 ;\r\n            moveoffset = countRecordCount == moveoffset ? offset1 -15 :offset1 ; //得到符合条件的offset,来处理临界的情况\r\n            moveoffset = moveoffset < 0 ? 0 :moveoffset ;\r\n            window.location.href=\"/jsoa/OfficalDictionAction.do?action=delBatch&ids=\" + ids +\"&pager.offset=\"+moveoffset ;\r\n        }\r\n    }\r\n }\r\n\r\n//删除单个记录\r\nfunction del(id) {\r\n     ");

     int deloffset =  countRecordCount == 1 ? offset1-15:offset1 ;
     deloffset = deloffset < 0 ? 0 : deloffset ;
     
      out.write("\r\n     if(confirm(Personalwork.commonuse_delete)){\r\n         window.location.href=\"/jsoa/OfficalDictionAction.do?action=delBatch&ids=\"+id+\",&pager.offset=");
      out.print(deloffset);
      out.write("\" ;\r\n    }\r\n }\r\n\r\n//全选|全除\r\nfunction selectAll(obj) {\r\n    if(obj.checked) {\r\n    \tfor(var i = 0 ; i < OfficalDictionActionForm.length ; i++ ) {\r\n        \tvar chkObj = OfficalDictionActionForm[i] ;\r\n        \t if(chkObj.type == \"checkbox\"){\r\n\t\t\tif(chkObj!=obj&&chkObj.disabled==false) {\r\n                              chkObj.checked = true ;\r\n\t\t\t}\r\n        \t }\r\n   \t }\r\n    }else {\r\n            for(var i = 0 ; i < OfficalDictionActionForm.length ; i++ ) {\r\n                var chkObj = OfficalDictionActionForm[i] ;\r\n                 if(chkObj.type == \"checkbox\"){\r\n                        if(chkObj!=obj) {\r\n                              chkObj.checked = false ;\r\n                        }\r\n                 }\r\n   \t }\r\n    }\r\n}\r\nfunction getCheckBoxID() {\r\n    var retString=\"\" ;\r\n    for(var i = 0 ; i < OfficalDictionActionForm.length ; i++ ) {\r\n        var obj = OfficalDictionActionForm[i] ;\r\n         if(obj.type == \"checkbox\"){\r\n\t\tif(obj.checked&&obj!=OfficalDictionActionForm.chkSelect) {\r\n                \tretString += obj.value  ;\r\n");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/setup/personalwork_mywordsetup.jsp(41,7) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("personalwork");
      // /personal_work/setup/personalwork_mywordsetup.jsp(41,7) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/setup/personalwork_mywordsetup.jsp(157,52) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("common");
      // /personal_work/setup/personalwork_mywordsetup.jsp(157,52) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/setup/personalwork_mywordsetup.jsp(158,58) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setBundle("common");
      // /personal_work/setup/personalwork_mywordsetup.jsp(158,58) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/setup/personalwork_mywordsetup.jsp(159,60) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setBundle("personalwork");
      // /personal_work/setup/personalwork_mywordsetup.jsp(159,60) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setKey("personalwork.clear");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/setup/personalwork_mywordsetup.jsp(173,29) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setBundle("personalwork");
      // /personal_work/setup/personalwork_mywordsetup.jsp(173,29) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setKey("commonuse.vocabulary");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/setup/personalwork_mywordsetup.jsp(175,40) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f5.setBundle("personalwork");
      // /personal_work/setup/personalwork_mywordsetup.jsp(175,40) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f5.setKey("commonuse.creator");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/setup/personalwork_mywordsetup.jsp(176,50) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f6.setBundle("personalwork");
      // /personal_work/setup/personalwork_mywordsetup.jsp(176,50) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f6.setKey("personalwork.operation");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/setup/personalwork_mywordsetup.jsp(190,69) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f7.setBundle("personalwork");
      // /personal_work/setup/personalwork_mywordsetup.jsp(190,69) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f7.setKey("commonuse.view");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/setup/personalwork_mywordsetup.jsp(197,76) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f8.setBundle("personalwork");
      // /personal_work/setup/personalwork_mywordsetup.jsp(197,76) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f8.setKey("personalwork.modify");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f9(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/setup/personalwork_mywordsetup.jsp(197,261) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f9.setBundle("personalwork");
      // /personal_work/setup/personalwork_mywordsetup.jsp(197,261) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f9.setKey("personalwork.delete");
