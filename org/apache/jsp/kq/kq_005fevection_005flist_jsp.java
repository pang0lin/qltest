...
public final class kq_005fevection_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
boolean readAnonymous=mdb.hasRight(request.getSession(true).getAttribute("userId").toString(),"07*55*09");
	 ...
	 String status=request.getParameter("status")==null?"none":request.getParameter("status").toString();
	  String searchDate=request.getParameter("searchDate")==null?"none":request.getParameter("searchDate").toString();
...
e= new Date(end_date);
	...
	eday = String.valueOf(e.getDate());
      ...
      out.write("\r\n     <tr ");
      out.print(readAnonymous?"":"style='display:none'");
      ...
      out.print(status.equals("none")?"selected='selected'":"");
      out.write(" value=\"none\">全部</option>\r\n\t\t  <option ");
      out.print(status.equals("0")?"selected='selected'":"");
      out.write(" value=\"0\">正在审批</option>\r\n\t\t  <option ");
      out.print(status.equals("-1")?"selected='selected'":"");
      out.write(" value=\"-1\">退回</option>\r\n\t\t  <option ");
      out.print(status.equals("100")?"selected='selected'":"");
      out.write(" value=\"100\">审批通过</option>\r\n\t\t  <option ");
      out.print(status.equals("-2")?"selected='selected'":"");
      out.write(" value=\"-2\">取消</option>\r\n\t\t  </select>\r\n\t  </td>\r\n\t</tr>\r\n\t<tr>\r\n\t  <td>\r\n\t\t 时间：\r\n\t  </td>\r\n\t  <td colspan=\"3\">\r\n\t\t<script language=javascript>\r\n\t\tvar dtpDate = createDatePicker(\"start_date\",\"");
      out.print(byear);
      out.write('"');
      out.write(',');
      out.write('"');
      ...
      try {
        ...
        // /kq/kq_evection_list.jsp(146,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("list");
        // /kq/kq_evection_list.jsp(146,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("list");
        // /kq/kq_evection_list.jsp(146,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
	  ...
	  String beginDate=dateFormat.format(obj[6]); 
	   String endDate=dateFormat.format(obj[7]); 
	   String cause=obj[8]+"&nbsp;"; 
	   
	   
	  int status1=new Integer(obj[10].toString());
	  int re=new Integer(obj[11].toString());
	  String statusString="";
	  if(0==status1){
	   statusString="正在审批";
	   }else if(-1==status1){
	   ...
	   if(curUserId==new Long(obj[1].toString())&&100==status1&&1!=re)
	   {
	    isreturn=true;
...
if(isreturn){
            out.write("<img  style=\"cursor:pointer\" border=\"0\" src=\"images/cxtj.gif\" alt=\"归来\" onClick=\"isreturn('");
            out.print(obj[0]);
            out.write("')\" >");
}else{
            out.write("&nbsp;");
...
String pagerURL = "/jsoa/KqEvectionAction.do";
      out.write("\r\n     ");
