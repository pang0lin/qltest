 ...
 * Generated at: 2023-01-06 09:52:42 UTC
...
public final class hortationPunishList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//} 
      ...
      out.write("\t  </td>\r\n</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n\t<form name=\"ChannelActionForm\" method=\"post\" action=\"/jsoa/ChannelAction.do\">\r\n\t\t<tr align=\"center\">\r\n\t\t\t<td width=\"2%\" class=\"listTableHead\" nowrap>\r\n\t\t\t\t<input type=\"checkbox\" value=\"1\" name=\"selectAllBox\" onClick=\"selectAll(this);\" ></td>\r\n\t\t\t<td class=\"listTableHead\" width=\"24%\"> 奖惩名称</td>\r\n\t\t\t<td class=\"listTableHead\" width=\"10%\"> 奖惩类型</td>\r\n\t\t\t<td class=\"listTableHead\" width=\"50%\"> 适用情况</td>\r\n\t\t\t<td width=\"8%\" class=\"listTableHeadLast\" nowrap>处理</td>\r\n\t\t</tr>\r\n\t\t");
			...
			if(request.getAttribute("new.offset") != null)
			  ...
			  index1 = index;
			Object[] hortationPunishObj = null;
      ...
      try {
        ...
        // /personnel_manager/hortationPunishList.jsp(134,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("hortationPunishList");
        // /personnel_manager/hortationPunishList.jsp(134,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("hortationPunishList");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object hortationPunishList = null;
          ...
          hortationPunishList = (java.lang.Object) _jspx_page_context.findAttribute("hortationPunishList");
          do {
            out.write("\r\n\t\t");

		  hortationPunishObj = (Object[]) hortationPunishList;
		  index ++;
		  j++;
...
if(index % 2 == 0){
            ...
            out.print(hortationPunishObj[0]);
            out.write("\" name=\"hortationPunishId\"></td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write("\"><a href=\"javascript:void(0);\" onClick=\"toview('");
            out.print(hortationPunishObj[0]);
            out.write("')\">");
            out.print(hortationPunishObj[1]);
            out.write("</a></td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write('"');
            out.write('>');
            out.print((hortationPunishObj[2].equals("1")?"奖励":"处罚"));
            out.write("&nbsp;</td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write('"');
            out.write('>');
            out.print(hortationPunishObj[3]==null?"":hortationPunishObj[3]);
            out.write("&nbsp;</td>\r\n\t\t  <td class=\"");
            out.print(listClass);
...
String pagerURL = "/jsoa/HortationPunishClassAction.do";
      out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
   ...
   if(deloff<0) deloff = 0;
      ...
      out.write("\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=\"/jsoa/HortationPunishClassAction.do?flag=delete&hortationPunishId=\" + id + \"&pager.offset=");
      out.print(deloff);
      out.write("\";\r\n    }\r\n}\r\nfunction selectAll(obj){\r\n    if(document.all.hortationPunishId){\r\n        if(document.all.hortationPunishId.length){\r\n            for(var i = 0; i < document.all.hortationPunishId.length; i ++){\r\n                if(obj.checked){\r\n                    document.all.hortationPunishId[i].checked = true;\r\n                }else{\r\n                    document.all.hortationPunishId[i].checked = false;\r\n                }\r\n            }\r\n        }else{\r\n            if(obj.checked){\r\n                document.all.hortationPunishId.checked = true;\r\n            }else{\r\n                document.all.hortationPunishId.checked = false;\r\n            }\r\n        }\r\n    }\r\n}\r\nfunction batchDelete(){\r\n\r\n        if(checkboxIsChecked(document.all.hortationPunishId)){\r\n            var id = \"\";\r\n            if(document.all.hortationPunishId.length){\r\n                for(var i = 0; i < document.all.hortationPunishId.length; i ++){\r\n                    if(document.all.hortationPunishId[i].checked){\r\n                        id += document.all.hortationPunishId[i].value + \",\";\r\n");
      out.write("                    }\r\n                }\r\n            }else{\r\n                if(document.all.hortationPunishId.checked){\r\n                    id = document.all.hortationPunishId.value;\r\n                }\r\n            }\r\n            if(id.indexOf(\",\") > 0){\r\n                id = id.substring(0, id.length - 1);\r\n            }\r\n            if(confirm(\"确实要删除吗？\")){\r\n            window.location.href = \"/jsoa/HortationPunishClassAction.do?flag=delete&hortationPunishId=\" + id + \"");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("\";;\r\n            }\r\n        }else{\r\n            alert(\"请选择要删除的记录！\");\r\n        }\r\n}\r\n\r\nfunction modify(id){\r\n    MM_openBrWindow('/jsoa/HortationPunishClassAction.do?flag=modify&hortationPunishId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=540,height=260')\r\n}\r\nfunction toview(id){\r\n    MM_openBrWindow('/jsoa/HortationPunishClassAction.do?flag=toview&hortationPunishId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=540,height=260')\r\n}\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\n//-->\r\n</script>\r\n");
if(!deleteSuccess.booleanValue()){
      out.write("\r\n<script language=\"javascript\">\r\nalert(\"删除失败！您选择的奖惩种类设置正在使用\");\r\n</script>\r\n");
}
