...
public final class wapBbsList_005f3g_jsp extends org.apache.jasper.runtime.HttpJspBase
...
boolean isAnonymous = new ManagerService().hasRight(userId+"", "06*01*01");
      ...
      out.print(path);
      out.write("/wap2/index_3g.jsp\">桌面</A></DIV></SPAN>\r\n           <SPAN id=title>论坛公告</SPAN>\r\n           <A class=btn_1 href=\"");
      out.print(path);
      out.write("/wap2/index_3g.jsp\">返回</A>\r\n       </DIV>\r\n       <DIV class=height2></DIV>\r\n\t");
SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm");
	...
	String more=path+"/wap/action/WapBbsAction.do?action=bbsInfo"+type+"&kit=yes&beginIndex="+beginIndex+"&forumId="+forumPO.getId();
	
      out.write("\r\n\t\t\t<DIV class=lista1>\r\n         <DIV class=l1>\r\n            <A class=listing href=\"");
      out.print(more );
      out.write('"');
      out.write('>');
      out.print(title+"("+("1".equals(forumPO.getAnonymous()+"")?
            				(forumPO.getForumAuthorId()==userId||isAnonymous?forumPO.getForumAuthor()+"【匿名】":"匿名"):forumPO.getForumAuthor())+")" );
      out.write("</A>\r\n         </DIV>\r\n         <SPAN>");
      out.print("论区："+forumPO.getForumClass().getClassName()+"  日期："+format.format(forumPO.getForumIssueTime()) );
      out.write("</SPAN>\r\n       </DIV>\r\n");
}
	...
	if(size>WapUtil.LIMITED){
		if(upIndex>=0)upUrl=path+"/wap/action/WapBbsAction.do?action=bbsList&amp;beginIndex=" + upIndex ;
		if(nextIndex<size)nextUrl=path+"/wap/action/WapBbsAction.do?action=bbsList&amp;beginIndex=" + nextIndex;
      out.write("\r\n\t\t <DIV class=page>\r\n       ");
if(upUrl.indexOf("#")<0){
