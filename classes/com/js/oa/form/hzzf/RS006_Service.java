...
public class RS006_Service extends Workflow {
  ...
  private String getXmlData(String recordId, String proStatus) {
    String sql = "select e.useraccounts,e.empname,t.jst_3072_f3842,t.jst_3072_f3843,t.jst_3135_f5146 from jst_3135 t left join org_employee e on t.jst_3135_owner=e.emp_id where t.jst_3135_id=?";
    String xml = "";
    Connection conn = null;
    PreparedStatement pstmt = null;
    ResultSet rs = null;
    DataSourceBase base = new DataSourceBase();
    String useraccount = "", empname = "", startTime = "", endTime = "", days = "";
    ...
    try {
      ...
      buffer.append("<VALUE1>RS006出差申请表</VALUE1>");
      ...
      buffer.append("<VALUE7>" + days + "</VALUE7>");
      buffer.append("</P_INTG_DATA_TBL_ITEM>");
      buffer.append("</P_INTG_DATA_TBL>");
      buffer.append("</InputParameters>");
