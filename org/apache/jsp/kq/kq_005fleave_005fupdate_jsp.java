...
public final class kq_005fleave_005fupdate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    KqLeavePO kqLeavePO=(KqLeavePO)request.getAttribute("kqLeavePO");
    ...
    Long domainId = request.getSession().getAttribute("domainId") == null ?Long.valueOf("0") :Long.valueOf(request.getSession().getAttribute("domainId").toString());
...
if ("1".equals(request.getParameter("resubmit"))) {
      ...
      out.print(kqLeavePO.getUserName());
      out.write("</td>\r\n      <td width=\"80\" nowrap>申请部门：</td>\r\n      <td >");
      out.print(kqLeavePO.getOrgName());
      out.write("</td>\r\n     </tr>\r\n                              <tr>\r\n                              ");
  calendar.setTime(kqLeavePO.getStartTime());
  ...
  calendar.setTime(kqLeavePO.getEndTime());
...
if(kqLeavePO.getLeaveType()==new Integer(obj[0].toString())) {
      ...
      out.write("\r\n\t   \r\n\t  </td>\r\n    </tr>\r\n\t<tr><input type=\"hidden\" name=\"leaveId\" value=\"");
      out.print(kqLeavePO.getId());
...
if(!"1".equals(request.getParameter("printFlag")+"")){
	if("1".equals(new SystemCommon().getKeyboardTip())){
      ...
      out.write("</td>\r\n   </tr>\r\n  ");
                           ...
                           String passLinkFile ="/jsoa/KqLeaveAction.do?action=update";
							String subProcHref = "/jsoa/JsFlowAddAction.do?action=add&moduleId=5";//新建子流程链接
