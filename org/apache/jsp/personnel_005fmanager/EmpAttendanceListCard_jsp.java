 ...
 * Generated at: 2023-01-06 09:51:55 UTC
...
public final class EmpAttendanceListCard_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      try {
		...
		String listClass="listTableLine1";
            ...
            try {
              ...
              // /personnel_manager/EmpAttendanceListCard.jsp(105,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /personnel_manager/EmpAttendanceListCard.jsp(105,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /personnel_manager/EmpAttendanceListCard.jsp(105,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(!currentPageNumber.equals(pageCount)){
     ...
     deloffset = deloffset < 0 ? 0 : deloffset ;
      ...
      out.write("\r\n     if(confirm(\"确实要删除吗？\")){\r\n         window.location.href=\"/jsoa/EmpAttendanceAction.do?action=delete&id=\"+id+\"&checkYear=\"+document.form1.checkYear.value+\"&empName=\"+document.form1.empName.value+\"&pager.offset=");
      out.print(deloffset);
      out.write("\";\r\n    }\r\n }\r\n\r\nfunction clearr(){\r\n\tlocation.href=\"/jsoa/EmpAttendanceAction.do?action=list\";\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\nfunction batchDel(){\r\n\tif(getCheckBoxID() != ''){\r\n\t\tvar ids = getCheckBoxID();\r\n\t\tids = ids.substring(0, ids.length-1);\r\n\t\tif(confirm(\"确实要删除吗？\")){\r\n\t\t\twindow.location.href=\"/jsoa/EmpAttendanceAction.do?action=batchDel&ids=\"+ids+\"&checkYear=\"+document.form1.checkYear.value+\"&empName=\"+document.form1.empName.value+\"&pager.offset=");
      out.print(deloffset);
