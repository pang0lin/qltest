...
public final class pro_005fmore_005fevent_jsp extends org.apache.jasper.runtime.HttpJspBase
...
dateFormat.applyPattern("yyyy-MM-dd");//设置日期显示格式
SimpleDateFormat dateFormat_min = new SimpleDateFormat( "HH:mm");
dateFormat_min.applyPattern("HH:mm");
...
if("1".equals(userRoll)){
      out.write("\r\n\t\t<button class=\"btnButton4font\" onClick=\"MM_openBrWindow('scheme/calender/workmanager_calender_add.jsp?toAction=selectAllEvent&Year_Y=");
      out.print(year);
      out.write("&Month_Y=");
      out.print(month);
      out.write("&Day_Y=");
      out.print(day);
      out.write("&relProject=Y','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600')\">");
...
if(projectId_!=null){
      ...
      try {
        ...
        // /relproject/pro_more_event.jsp(106,0) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("list");
        // /relproject/pro_more_event.jsp(106,0) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("list");
        // /relproject/pro_more_event.jsp(106,0) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            out.write("\r\n                    ");
	                ...
	                Date endDate=null;  
	                String dateStr="";
					if(obj[8].toString().equals("0")){//如果是不定期日程
						if(obj[3]!=null&&obj[5]!=null){//如果开始和结束时间不为空的话
							dateStr=dateFormat.format(new Date(new Long(obj[2].toString())))+"&nbsp;"+dateFormat_min.format(new Date(new Integer(obj[3].toString())*1000+new Long(obj[2].toString())))+"&nbsp;至&nbsp;"+dateFormat.format(new Date(new Long(obj[4].toString())))+"&nbsp;"+dateFormat_min.format(new Date(new Integer(obj[5].toString())*1000+new Long(obj[4].toString())));
						}else{
							dateStr=dateFormat.format(new Date(new Long(obj[2].toString())))+"&nbsp;至&nbsp;"+dateFormat.format(new Date(new Long(obj[4].toString())));
						}
					    
						//dateStr=dateFormat.format(beginDate).toString()+"至"+dateFormat.format(endDate).toString();
					}else{//定期日程
						dateStr=obj[9].toString().substring(0,10)+"&nbsp;"+dateFormat_min.format(new Date(new Long("1284998400000")+new Long(obj[3].toString())));
						if(obj[10]!=null){//如果重复结束时间不为空
							dateStr=dateStr+"&nbsp;至&nbsp;"+dateFormat_min.format(new Date(new Long("1284998400000")+new Long(obj[10].toString())));
						}else{
							dateStr=dateStr+"~";
						}
						    dateStr=dateStr+dateFormat_min.format(new Date(new Long("1284998400000")+new Long(obj[5].toString())));
					}
            ...
            out.write("\r\n\t  </td>\r\n\t  <td class=\"");
            out.print(listClass);
            out.write("\" style=\"padding:0px;padding-left:3px;\">   <a href=\"javascript:void(0);\" onClick=\"MM_openBrWindow('/jsoa/eventAction.do?action=selectSingleEvent&eventId=");
            out.print(obj[0]);
            out.write("&empId=");
            out.print(obj[6]);
            ...
            out.write("</td>\r\n\t   <td class=\"");
            out.print(listClass);
            out.write(" listTableLineLastTD\" style=\"padding:0px;padding-left:3px;\">");
if(curUserId.equals(obj[6].toString())){
...
if(!currentPageNumber.equals(pageCount)){
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /relproject/pro_more_event.jsp(89,263) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("personalwork");
      // /relproject/pro_more_event.jsp(89,263) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setKey("calendar.newevent");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /relproject/pro_more_event.jsp(101,39) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("personalwork");
      // /relproject/pro_more_event.jsp(101,39) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setKey("calendar.dtime");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /relproject/pro_more_event.jsp(102,39) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setBundle("personalwork");
      // /relproject/pro_more_event.jsp(102,39) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setKey("calendar.title");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /relproject/pro_more_event.jsp(103,38) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setBundle("personalwork");
      // /relproject/pro_more_event.jsp(103,38) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setKey("calendar.creator");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /relproject/pro_more_event.jsp(104,43) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setBundle("personalwork");
      // /relproject/pro_more_event.jsp(104,43) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setKey("agent.operation");
