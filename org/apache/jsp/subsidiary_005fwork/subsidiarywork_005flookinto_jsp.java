 ...
 * Generated at: 2023-01-06 09:50:26 UTC
...
public final class subsidiarywork_005flookinto_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int offset1 = index ;
	...
	String canModiID=request.getAttribute("canModiID").toString();
            ...
            try {
              ...
              // /subsidiary_work/subsidiarywork_lookinto.jsp(63,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/LookIntoAction.do?action=list");
              // /subsidiary_work/subsidiarywork_lookinto.jsp(63,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
			...
			String modiRight = ""+request.getAttribute("modiRight") ;
			if("1".equals(addRight)) {
		
                  out.write("\r\n\t\t\t <button  class=\"btnButton2Font\"  onclick=\"MM_openBrWindow('/jsoa/subsidiary_work/subsidiarywork_lookinto_add.jsp','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=400')\">新增</button>\r\n\t\t");
}
			if("1".equals(modiRight)) {
		
                  out.write("\r\n\t\t\t <button  class=\"btnButton2Font\" style=\"cursor:pointer\" onclick=\"delBatch()\">删除</button>\r\n\t\t\t <!--button  class=\"btnButton2Font\"  style=\"cursor:pointer\" onclick=\"delAll()\">清空</button-->\r\n\t\t");
}
                  out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n\r\n\r\n\r\n\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\t<tr align=\"center\" valign=\"middle\">\r\n\t\t<td   width=\"2%\" height=\"24\" class=\"listTableHead\" nowrap><input type=\"checkbox\" name=\"chkSelect\" style=\"cursor:'hand'\" onclick=\"selectAll(this)\"></td>\r\n\t\t<td   width=\"42%\" class=\"listTableHead\"> 调查内容 </td>\r\n\t\t<td   width=\"36%\" class=\"listTableHead\"> 调查范围 </td>\r\n\t\t<td   width=\"10%\" class=\"listTableHead\"> 状态 </td>\r\n\t\t<td   width=\"8%\" class=\"listTableHeadLast\" nowrap> 处理 </td>\r\n\t</tr>\r\n\t");
                  //  logic:iterate
                  ...
                  try {
                    ...
                    // /subsidiary_work/subsidiarywork_lookinto.jsp(117,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("mylist");
                    // /subsidiary_work/subsidiarywork_lookinto.jsp(117,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("mylist");
                    // /subsidiary_work/subsidiarywork_lookinto.jsp(117,1) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(canModiID.indexOf(","+obj[0]+",")>=0){
                        ...
                        out.write("&nbsp;\r\n\t\t</td>\r\n\t\t<td  class=\"");
                        out.print(listClass);
                        out.write("\"  align=\"left\">\r\n\t\t\t<a href=\"javascript:void(0);\"  onclick=\"result('");
                        out.print(obj[0]);
                        out.write("')\">\r\n\t\t\t");
                        out.print(obj[1]);
                        out.write("\r\n\t\t\t</a>\r\n\t\t\t</td>\r\n\t\t\t<td  class=\"");
                        out.print(listClass);
                        out.write("\"  align=\"left\">\r\n\t\t\t");
 	 if(obj[2]!=null && !"".equals(obj[2].toString()))  out.print(obj[2]) ; else out.print("&nbsp;") ;  
                        out.write("\r\n\t\t\t</td>\r\n\t\t\t<td   class=\"");
                        out.print(listClass);
                        out.write("\" align=\"left\">\r\n\t\t\t");
                        out.print("1".equals(obj[3]+"")?"停用":"启用");
                        out.write("\r\n\t\t\t</td>\r\n                        ");
 if((canModiID.indexOf(","+obj[0]+","))>=0){
                        out.write("\r\n\t\t\t<td class=\"");
                        out.print(listClass);
                        ...
                        out.write("\r\n\t    <td class=\"");
                        out.print(listClass);
                        out.write(" listTableLineLastTD\"> &nbsp; </td>\r\n\t    ");
}
                        out.write("\r\n\t    </tr>\r\n\t");
...
String pagerURL = "/jsoa/LookIntoAction.do";
                  out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
     ...
     deloffset = deloffset < 0 ? 0 : deloffset ;
      ...
      out.write("\r\n     if(confirm(\"确实要删除吗？\")){\r\n         var hhref = \"/jsoa/LookIntoAction.do?action=delBatch\" ;\r\n         hhref += \"&ids=\"+id+\",\" ;\r\n         hhref += \"&pager.offset=");
      out.print(deloffset);
      out.write("\" ;\r\n         hhref += \"&surveyContent=\"+LookIntoActionForm.surveyContent.value ;\r\n         window.location.href = hhref ;\r\n    }\r\n }\r\n\r\n//修改\r\nfunction result(resultId) {\r\n  MM_openBrWindow(\"/jsoa/LookIntoAction.do?action=toVoteList&surveyId=\"+resultId,'','width=660,height=480,toolbar=no,location=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,left=0,top=0') ;\r\n}\r\n\r\nfunction edit(editId) {\r\n    var hhref = \"/jsoa/LookIntoAction.do?action=load\" ;\r\n    hhref += \"&editId=\"+editId ;\r\n    hhref += \"&pager.offset=");
      out.print(offset1);
      out.write("\" ;\r\n    hhref += \"&surveyContent1=\"+LookIntoActionForm.surveyContent.value ;\r\n    MM_openBrWindow(hhref,\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600\") ;\r\n}\r\n\r\n//查询\r\nfunction query1() {\r\n   LookIntoActionForm.submit();\r\n}\r\n\r\n//清除条件查询\r\nfunction clear1() {\r\n    LookIntoActionForm.surveyContent.value=\"\" ;\r\n    query1();\r\n}\r\n\r\n//全选|全除\r\nfunction selectAll(obj) {\r\n    if(obj.checked) {\r\n    \tfor(var i = 0 ; i < LookIntoActionForm.length ; i++ ) {\r\n        \tvar chkObj = LookIntoActionForm[i] ;\r\n        \t if(chkObj.type == \"checkbox\"){\r\n\t\t\tif(chkObj!=obj) {\r\n                              chkObj.checked = true ;\r\n\t\t\t}\r\n        \t }\r\n   \t }\r\n    }else {\r\n            for(var i = 0 ; i < LookIntoActionForm.length ; i++ ) {\r\n                var chkObj = LookIntoActionForm[i] ;\r\n                 if(chkObj.type == \"checkbox\"){\r\n                        if(chkObj!=obj) {\r\n                              chkObj.checked = false ;\r\n                        }\r\n                 }\r\n   \t }\r\n    }\r\n}\r\n\r\nfunction getCheckBoxID() {\r\n");
      out.write("    var retString=\"\" ;\r\n    for(var i = 0 ; i < LookIntoActionForm.length ; i++ ) {\r\n        var obj = LookIntoActionForm[i] ;\r\n         if(obj.type == \"checkbox\"){\r\n\t\tif(obj.checked&&LookIntoActionForm.chkSelect!=obj) {\r\n                \tretString += obj.value  ;\r\n                        retString += \",\" ;\r\n\t\t}\r\n         }\r\n    }\r\n    return retString ;\r\n}\r\n</script>\r\n<script  src=\"/jsoa/js/checkQuery.js\"  language=\"javascript\" ></script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /subsidiary_work/subsidiarywork_lookinto.jsp(69,3) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setStyleClass("inputtext");
      // /subsidiary_work/subsidiarywork_lookinto.jsp(69,3) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setProperty("surveyContent");
      // /subsidiary_work/subsidiarywork_lookinto.jsp(69,3) name = onkeypress type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setOnkeypress("return look() ;");
      // /subsidiary_work/subsidiarywork_lookinto.jsp(69,3) name = onkeyup type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setOnkeyup("value=checkQuery(this,'调查内容')");
      // /subsidiary_work/subsidiarywork_lookinto.jsp(69,3) name = onblur type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005ftext_005f0.setOnblur("value=checkQuery1(this,'调查内容')");
      // /subsidiary_work/subsidiarywork_lookinto.jsp(69,3) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
