...
public final class intoStockReport_005fexport_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  String goodsType = request.getAttribute("goodsType")==null?"":request.getAttribute("goodsType").toString();
	 ...
	 double je = 0 ;
      ...
      try {
        ...
        // /routine/resource_manager/intoStockReport_export.jsp(77,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("intoStockList");
        // /routine/resource_manager/intoStockReport_export.jsp(77,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
	 ...
	 je = ArithUtil.add(je , Double.parseDouble(reportObj[6].toString()));
            ...
            out.write("</div></td>\r\n      <td><div align=\"right\">");
            out.print(decimalFormat.format(Float.parseFloat(reportObj[6].toString())));
            out.write("</div></td>\r\n      </tr>\r\n\t");
      ...
      out.write("\r\n\t <tr>\r\n      <td>合计</td>\r\n\t  <td>&nbsp;</td>\r\n      <td>&nbsp;</td>\r\n      <td>&nbsp;</td>\r\n      <td>&nbsp;</td>\r\n      <td><div align=\"right\">");
      out.print(slFormat.format(sl));
      out.write("</div></td>\r\n      <td>&nbsp;</td>\r\n      <td><div align=\"right\">");
      out.print(decimalFormat.format(je));
      out.write("</div></td>\r\n    </tr>\r\n</table>\r\n<table width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"3\" cellspacing=\"0\">\r\n <tr>\r\n  <td colspan=\"8\">\r\n    制表人：");
