...
if(isAllow == null){
   isAllow = "0";
      ...
      out.write("\r\n\t\t\t\t//loadURL();\r\n\t\t\t\twindow.location.href=\"/jsoa/weiXinTzggAction.do?action=list\";\r\n\t\t\t\t");
...
if("0".equals(isAllow)) {
      ...
      out.write("\r\n\t\t\t\t\t<div class=\"Zsglitemfujian\" >\r\n        \t\t\t\t<div class=\"zsgl_fujian\">附件：\r\n\t\t\t     \t\t\t");
							...
							for(int i=0; i<filelist.size(); i++){
								...
								String src = "0000";
								if(filemap.get("accsave").toString()!=null && filemap.get("accsave").toString().length()>6 
