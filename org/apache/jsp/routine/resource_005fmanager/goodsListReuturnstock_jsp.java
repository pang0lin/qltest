 ...
 * Generated at: 2023-01-06 09:47:08 UTC
...
public final class goodsListReuturnstock_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String addcolumn = request.getParameter("addcolumn")==null?"8":request.getParameter("addcolumn");
      ...
      try {
        ...
        // /routine/resource_manager/goodsListReuturnstock.jsp(105,36) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_logic_005fpresent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /routine/resource_manager/goodsListReuturnstock.jsp(106,38) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("searchGoodsTypeList");
              // /routine/resource_manager/goodsListReuturnstock.jsp(106,38) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(addGoods.equals("1")) out.print("</span>");
      out.write("\r\n                              </td>\r\n                              <td width=\"2\" rowspan=\"2\" nowrap=\"nowrap\">\r\n                              </td>\r\n                            </tr>\r\n                            <tr>\r\n                                <td>\r\n                                   存货名称：\r\n                                    <input onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'存货名称')\" onblur=\"value=checkQuery1(this,'存货名称')\" type=\"text\" class=\"inputtext\" size=\"18\" name=\"searchGoodsName\" value=\"");
      out.print(searchGoodsName);
      out.write("\">\r\n                                </td>\r\n                                <td>\r\n                                    存货编号：\r\n                                    <input onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'存货编号')\" onblur=\"value=checkQuery1(this,'存货编号')\" type=\"text\" class=\"inputtext\" size=\"18\" name=\"searchGoodsId\" value=\"");
      out.print(searchGoodsId);
      out.write("\">\r\n                                </td>\r\n                                <td width=\"22%\" align=\"right\" rowspan=\"2\">\r\n                                  <button class=\"btnButton2Font\"  style=\"cursor:pointer\" onclick=\"search();\">查询</button>\r\n                                  <button class=\"btnButton2Font\"  style=\"cursor:pointer\" onclick=\"window.location.href='");
...
if(addRight.booleanValue() && addGoods.equals("0")){
      ...
      out.write("\r\n          <button class=\"btnButton4font\" onClick=\"chSearch(this)\">查询</button>\r\n      </td>\r\n       </tr>\r\n</table>\r\n</td>\r\n</tr>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\" id=\"goodsTable\">\r\n    <DIV id=\"mytips\" style=\"BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; DISPLAY: none; FONT-SIZE: 9pt; FILTER: progid: DXImageTransform.Microsoft.Shadow(color=#999999,direction=135,strength=3); BORDER-LEFT: gray 1px solid; WIDTH: 150px; COLOR: red; BORDER-BOTTOM: gray 1px solid; POSITION: absolute; HEIGHT: 120px; BACKGROUND-COLOR: #ffffff\">\r\n\t\t<p>&nbsp;</p>\r\n\t\t<p>&nbsp;</p>\r\n\t</DIV>\r\n    <form name=\"OutStockActionForm\" id=\"OutStockActionForm\" method=\"post\" action=\"/jsoa/OutStockAction.do\">\r\n       <input type=\"hidden\" name=\"OutStockfromMenu\" id=\"OutStockfromMenu\"  value=\"OutStock_Add\">\r\n       \r\n       <input type=\"hidden\" name=\"goodsIds_hidden\" id=\"goodsIds_hidden\"  value=\"\">\r\n       <input type=\"hidden\" name=\"chbm_hidden\" id=\"chbm_hidden\"  value=\"\">\r\n       <input type=\"hidden\" name=\"chmc_hidden\" id=\"chmc_hidden\"  value=\"\">\r\n");
      out.write("       <input type=\"hidden\" name=\"dj_hidden\" id=\"dj_hidden\"  value=\"\">\r\n       <input type=\"hidden\" name=\"goodsIds_hidden\" id=\"ggxh_hidden\"  value=\"\">\r\n       <input type=\"hidden\" name=\"jldw_hidden\" id=\"jldw_hidden\"  value=\"\">\r\n       <input type=\"hidden\" name=\"kc_hidden\" id=\"kc_hidden\"  value=\"\">\r\n       \r\n     \r\n       \r\n       <input type=\"hidden\" name=\"stockName\" id=\"stockName\"  value=\"");
      ...
      out.write("\">\r\n       <input type=\"hidden\" name=\"hasProcess\" id=\"hasProcess\"  value=\"");
      ...
      out.print(request.getAttribute("mode"));
      out.write("\">\r\n       <input type=\"hidden\" name=\"kc\" id=\"kc\"  value=\"");
      out.print(request.getAttribute("kc"));
      out.write("\"> \r\n        \r\n                      <tr align=\"center\">\r\n                        <td  width=\"40\" class=\"listTableHead\" nowrap><input type=\"checkbox\" value=\"1\" name=\"selectAllBox\" disabled onclick=\"selectAll(this);\"></td>\r\n                        <td class=\"listTableHead\">物品图片</td>\r\n                        <td class=\"listTableHead\"> 存货编号 </td>\r\n                        <td class=\"listTableHead\"> 物品仓库 </td>\r\n                        <td class=\"listTableHead\"> 物品类别 </td>\r\n                        <td class=\"listTableHead\"> 存货名称 </td>\r\n                        <td class=\"listTableHead\"> 计量单位 </td>\r\n                        <td class=\"listTableHead\"> 单价 </td>\r\n");
...
if(!addGoods.equals("1")){
      ...
      try {
        ...
        // /routine/resource_manager/goodsListReuturnstock.jsp(264,22) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f1.setId("goodsList");
        // /routine/resource_manager/goodsListReuturnstock.jsp(264,22) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
goodsObj = (Object[]) goodsList;
					  String goodsObj0 = goodsObj[0]==null?"":goodsObj[0].toString();
					   ...
					   && Float.parseFloat(curKc)<=0f ) flag =false;
					   if(flag){
                      index ++;
					  j++;
...
if(goodsObj[16]!=null &&!"".equals(goodsObj[16]+"")){ 
            ...
            out.write("\r\n                          </td>\r\n                          \r\n                          <td class=\"");
            out.print(listClass);
            out.write("\">  \r\n                              <input type=\"hidden\" name=\"chbm\" id=\"chbm\"  value=\"");
...
if(goodsObj[9]!=null&&!"".equals(goodsObj[9].toString())){
            ...
            out.print(goodsObj[2]);
            out.write("\r\n                            </a>\r\n                            <input type=\"hidden\" name=\"chmc\" id=\"chmc\"  value=\"");
            out.print(goodsObj[2]);
            out.write("\" >\r\n                          </td>\r\n                          <td class=\"");
            out.print(listClass);
            out.write("\" >\r\n                          <input type=\"hidden\" name=\"jldw\" id=\"jldw\"  value=\"");
            ...
            out.write('>');
								...
								String tmp2 =  tmp[1];
								if(tmp2.length() ==1){
								  price_dj=tmp3+_goodsPrice+"0";
								  out.println(tmp3+_goodsPrice+"0");
								}else{
									price_dj=tmp3+_goodsPrice;
								out.println(tmp3+_goodsPrice);
								}
								}
							  
            out.write("\r\n\t\t\t\t\t\t\t  <input type=\"hidden\" name=\"dj\" id=\"dj\"  value=\"");
            out.print(price_dj);
            out.write("\" >\r\n\t\t\t\t\t\t  </td>\r\n");
//if(!addGoods.equals("1")){
            out.write("\r\n\t\t\t\t\t\t  ");
            ...
            out.print(curKc);
            out.write("</a><input type=\"hidden\" name=\"kc\" id=\"kc\"  value=\"");
            out.print(curKc);
            out.write("\" ></td>\r\n\t\t\t\t\t\t  \r\n\t\t\t\t\t\t\t  ");
            ...
            out.write('>');
            out.print(curKc);
            out.write("<input type=\"hidden\" name=\"kc\" id=\"kc\"  value=\"");
            out.print(curKc);
            out.write("\" ></td>\r\n\t\t\t\t\t\t  \r\n\t\t\t\t\t\t  ");
...
//}
            ...
            out.write("\r\n                          <input type=\"hidden\" name=\"ggxh\" id=\"ggxh\"  value=\"");
            out.print(goodsObj[12]==null?"":goodsObj[12]);
            out.write("\" >\r\n                          </td>\r\n                          \r\n                        \r\n                          \r\n                        \r\n                          \r\n\t\t\t\t\t\t  ");
if(!addGoods.equals("1")){
            out.write("\r\n              <td class=\"");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n                      </td>\r\n  </tr>\r\n</table>\r\n\r\n");
if(addGoods.equals("1")){
      out.write("\r\n<table>\r\n<tr>\r\n    <td>\r\n        <!--<input type=\"button\" value=\"确定\" class=\"btnButton2Font\" onclick=\"allow();\">-->\r\n            <input type=\"button\" value=\"保存退出\" class=\"btnButton4Font\" ");
if("1".equals(stockShow)){ 
      out.write(" onclick=\"allow(2);\" ");
}else{ 
      out.write("  onclick=\"allow_old(2);\"");
}
      out.write(" >\r\n            <input type=\"button\" value=\"保存继续\" class=\"btnButton4Font\" ");
if("1".equals(stockShow)){ 
      out.write(" onclick=\"allow(1);\" ");
}else{ 
      out.write("  onclick=\"allow_old(1);\"");
}
...
if(!deleteSuccess.booleanValue()){
      ...
      out.write("\r\n</html>\r\n<script language=\"javascript\">\r\nfunction allow(flag){\r\n\t\r\n\t   var goodsIds= document.getElementsByName(\"goodsId\");\r\n\t   var chbm=document.getElementsByName(\"chbm\");\r\n\t   var chmc=document.getElementsByName(\"chmc\");\r\n\t   var jldw=document.getElementsByName(\"jldw\");\r\n\t   \r\n\t   var dj=document.getElementsByName(\"dj\");\r\n\t   var ggxh=document.getElementsByName(\"ggxh\");\r\n\t   var kc=document.getElementsByName(\"kc\");\r\n\t   \r\n\t   var goodsIds_hidden=\"\";\r\n\t   var chbm_hidden=\"\";\r\n\t   var jldw_hidden=\"\";\r\n\t   var chmc_hidden=\"\";\r\n\t   var dj_hidden=\"\";\r\n\t   var ggxh_hidden=\"\";\r\n\t   var kc_hidden=\"\";\r\n\t   for(var i=0;i<goodsIds.length;i++){\r\n\t\t   \r\n\t\t   if(goodsIds[i].checked){\r\n\t\t\t   if(goodsIds_hidden==null || goodsIds_hidden==\"\"){\r\n\t\t\t\t   \r\n\t\t\t\t   goodsIds_hidden=goodsIds_hidden+goodsIds[i].value;\r\n\t\t\t\t   chbm_hidden=chbm_hidden+chbm[i].value;\r\n\t\t\t\t   chmc_hidden=chmc_hidden+chmc[i].value;\r\n\t\t\t\t   dj_hidden=dj_hidden+dj[i].value;\r\n\t\t\t\t   jldw_hidden=jldw_hidden+jldw[i].value;\r\n\t\t\t\t   ggxh_hidden=ggxh_hidden+ggxh[i].value;\r\n");
      out.write("\t\t\t\t   kc_hidden=kc_hidden+kc[i+1].value;\r\n\t\t\t   }else{\r\n\t\t\t\t   goodsIds_hidden=goodsIds_hidden+\",\"+goodsIds[i].value;\r\n\t\t\t\t   chbm_hidden=chbm_hidden+\",\"+chbm[i].value;\r\n\t\t\t\t   chmc_hidden=chmc_hidden+\",\"+chmc[i].value;\r\n\t\t\t\t   dj_hidden=dj_hidden+\",\"+dj[i].value;\r\n\t\t\t\t   jldw_hidden=jldw_hidden+\",\"+jldw[i].value;\r\n\t\t\t\t   ggxh_hidden=ggxh_hidden+\",\"+ggxh[i].value;\r\n\t\t\t\t   kc_hidden=kc_hidden+\",\"+kc[i+1].value;\r\n\t\t\t   }\r\n\t\t   }\r\n\t   }\r\n\t   \r\n\t   document.getElementById(\"goodsIds_hidden\").value=goodsIds_hidden;\r\n\t   document.getElementById(\"chbm_hidden\").value=chbm_hidden;\r\n\t   document.getElementById(\"chmc_hidden\").value=chmc_hidden;\r\n\t   document.getElementById(\"dj_hidden\").value=dj_hidden;\r\n\t   document.getElementById(\"ggxh_hidden\").value=ggxh_hidden;\r\n\t   document.getElementById(\"jldw_hidden\").value=jldw_hidden;\r\n\t   document.getElementById(\"kc_hidden\").value=kc_hidden;\r\n\t  document.getElementById(\"OutStockActionForm\").submit();\r\n\t                           \r\n\t}\r\n// tips:图片名称 flag\r\nfunction show(tips,flag,url,event){\r\n");
...
if(BrowserJudge.isMSIE(request)){
      ...
      out.print(domainId);
      out.write("+\"_\"+goodsTable.rows[j + 1].cells[1].innerHTML ){\r\n\t\t\t\t\talert(goodsTable.rows[j + 1].cells[5].children[0].innerHTML+\"已经选择过,每张单据只能出现一条该物品记录！\");\r\n\t\t\t\t\treturn false;\r\n\t\t\t\t} //end 322 if\r\n\t\t\t\t} //end 321 if\r\n\t\t } //end 320 for\r\n\r\n\t\t} // end 319 for\r\n\t\t} //end 318 if\r\n\t\telse{\r\n\t\t\tif(document.all.goodsId.checked){\r\n\t\t\tfor( var i = 0 ; i < opener.document.all.goodsId.length;i++){\r\n            if(opener.document.all.goodsId[i].value == ");
      out.print(domainId);
      out.write("+\"_\"+goodsTable.rows[1].cells[1].innerHTML ){\r\n\t\t\t\t\talert(goodsTable.rows[1].cells[5].children[0].innerHTML+\"已经选择过,每张单据只能出现一条该物品记录！\");\r\n\t\t\t\t\treturn false;\r\n\t\t\t\t}}\r\n\t\t    }\r\n\r\n\t\t }\r\n\r\n\t }else{ //单据上只有一个物品\r\n\t\t if(document.all.goodsId.length){\r\n\t\t for(var j = 0; j < document.all.goodsId.length; j ++){\r\n                if(document.all.goodsId[j].checked){\r\n                if(opener.document.all.goodsId.value == ");
      out.print(domainId);
      out.write("+\"_\"+goodsTable.rows[j + 1].cells[1].innerHTML ){\r\n\t\t\t\t\talert(goodsTable.rows[j + 1].cells[5].children[0].innerHTML+\"已经选择过,每张单据只能出现一条该物品记录！\");\r\n\t\t\t\t\treturn false;\r\n\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t }}else{\r\n\t\t\tif(document.all.goodsId.checked){\r\n            if(opener.document.all.goodsId.value == ");
      out.print(domainId);
      out.write("+\"_\"+goodsTable.rows[1].cells[1].innerHTML ){\r\n\t\t\t\t\talert(goodsTable.rows[1].cells[5].children[0].innerHTML+\"已经选择过,每张单据只能出现一条该物品记录！\");\r\n\t\t\t\t\treturn false;\r\n\t\t\t\t}\r\n\t\t    }\r\n\r\n\t\t }\r\n\t }\r\n\t ");
}else{
      out.write("\r\n\t if(opener.document.all.goodsId){\r\n     if(opener.document.all.goodsId.length){ //单据上已经有多个物品\r\n\t   if(document.all.goodsId.length){\r\n\t\tfor( var i = 0 ; i < opener.document.all.goodsId.length;i++){\r\n          for(var j = 0; j < document.all.goodsId.length; j ++){\r\n                if(document.all.goodsId[j].checked){\r\n                if(opener.document.all.goodsId[i].value == (goodsTable.rows[j + 1].cells[1].innerHTML).replace(/^\\s+|\\s+$/g,\"\") ){\r\n\t\t\t\t\talert(goodsTable.rows[j + 1].cells[5].children[0].innerHTML+\" 已经选择过,每张单据只能出现一条该物品记录！\");\r\n\t\t\t\t\treturn false;\r\n\t\t\t\t} //end 322 if\r\n\t\t\t\t\r\n\t\t\t\t} //end 321 if\r\n\t\t } //end 320 for\r\n\r\n\t\t} // end 319 for\r\n\t\t} //end 318 if\r\n\t\telse{\r\n\t\t\tif(document.all.goodsId.checked){\r\n\t\t\tfor( var i = 0 ; i < opener.document.all.goodsId.length;i++){\r\n            if(opener.document.all.goodsId[i].value == (goodsTable.rows[1].cells[1].innerHTML).replace(/^\\s+|\\s+$/g,\"\") ){\r\n\t\t\t\t\talert(goodsTable.rows[1].cells[5].children[0].innerHTML+\" 已经选择过,每张单据只能出现一条该物品记录！\");\r\n\t\t\t\t\treturn false;\r\n\t\t\t\t}}\r\n");
      out.write("\t\t    }\r\n\r\n\t\t }\r\n\r\n\t }else{ //单据上只有一个物品\r\n\t\t if(document.all.goodsId.length){\r\n\t\t for(var j = 0; j < document.all.goodsId.length; j ++){\r\n                if(document.all.goodsId[j].checked){\r\n                if(opener.document.all.goodsId.value == (goodsTable.rows[j + 1].cells[1].innerHTML).replace(/^\\s+|\\s+$/g,\"\") ){\r\n\t\t\t\t\talert(goodsTable.rows[j + 1].cells[5].children[0].innerHTML+\" 已经选择过,每张单据只能出现一条该物品记录！\");\r\n\t\t\t\t\treturn false;\r\n\t\t\t\t}\r\n\t\t\t\t}\r\n                \r\n\t\t }}else{\r\n\t\t\tif(document.all.goodsId.checked){\r\n            if(opener.document.all.goodsId.value == (goodsTable.rows[1].cells[1].innerHTML).replace(/^\\s+|\\s+$/g,\"\") ){\r\n\t\t\t\t\talert(goodsTable.rows[1].cells[5].children[0].innerHTML+\"已经选择过,每张单据只能出现一条该物品记录！\");\r\n\t\t\t\t\treturn false;\r\n\t\t\t\t}\r\n\t\t    }\r\n\r\n\t\t }\r\n\t }\r\n\t ");
}
      out.write("\r\n  }\r\n  \r\n  if(document.all.goodsId){\r\n      if(document.all.goodsId.length){\r\n          for(var j = 0; j < document.all.goodsId.length; j ++){\r\n        \t  if(document.all.goodsId[j].checked){\r\n        \t  //alert(goodsTable.rows[j + 1].cells[8].innerHTML);\r\n        \t  if(Number(goodsTable.rows[j + 1].cells[7].innerHTML)==Number(0.00)){\r\n        \t\t  alert(\"不能选择单价为0的数据入库\");\r\n        \t\t  return false;\r\n        \t  }\r\n        \t\r\n        \t}\r\n          }\r\n      }\r\n  }   \r\n \r\n  //end 已选择物品判断\r\n    if(document.all.goodsId){\r\n    \t\r\n        if(document.all.goodsId.length){\r\n        \t\r\n            for(var j = 0; j < document.all.goodsId.length; j ++){\r\n                if(document.all.goodsId[j].checked){\r\n                ");
if(mmm==null){
...
if(BrowserJudge.isMSIE(request)){
      out.write("\r\n                        //if(navigator.userAgent.indexOf(\"MSIE\")>0){\r\n\t                        strValue = \"<input type=hidden name=goodsId value=");
      out.print(domainId );
      out.write("_\" + goodsTable.rows[1].cells[2].innerHTML + \">\" +\r\n\t                                   goodsTable.rows[1].cells[2].innerHTML;\r\n                        //}else{\r\n                        ");
}else{
      out.write("\r\n                        \tstrValue = \"<input type=hidden name=goodsId value=\" + goodsTable.rows[1].cells[2].innerHTML + \">\" +\r\n\t                                   goodsTable.rows[1].cells[2].innerHTML;\r\n                        //}\r\n                        ");
}
      out.write("\r\n                        oCell1.innerHTML = strValue;\r\n                        break;\r\n                        case 1:\r\n                        var tmp = goodsTable.rows[1].cells[5].children[0].innerHTML;\r\n\r\n                        strValue = \"<input type=hidden name=goodsName value=\" + tmp + \">\" +\r\n                                   goodsTable.rows[1].cells[5].innerHTML;\r\n                        oCell2.innerHTML = strValue;\r\n                        break;\r\n\t\t\t\t\t\tcase 2:\r\n\t\t\t\t\t\t strValue =\"<input type=hidden name=goodsSpecs value=\" + goodsTable.rows[ 1].cells[11].innerHTML + \">\" + goodsTable.rows[1].cells[11].innerHTML+\"&nbsp;\";\r\n\t\t\t\t\t\t oCell3.innerHTML = strValue;\r\n\t\t\t\t\t\t break;\r\n                        case 3:\r\n\r\n                        strValue = \"<input type=hidden name=goodsUnit value=\" + goodsTable.rows[1].cells[6].innerHTML + \">\" +\r\n                                   goodsTable.rows[1].cells[6].innerHTML;\r\n                        oCell4.innerHTML = strValue;\r\n                        break;\r\n                        case 4:\r\n");
      out.write("                        strValue = \"<input type=text class=inputtext value=1 size=10 name=amount onblur=javascript:CheckAndCount();total_money();>\";\r\n                        oCell5.innerHTML = strValue;\r\n                        break;\r\n                        case 5:\r\n                        strValue = \"<input type=text class=inputtext ");
      out.print("outStock".equals(mode)?"readonly=true":"");
...
if("salesreturn".equals(mode)){
      ...
      out.write("\r\n    var total_money = 0.00;\r\n\tvar cutNumber = Math.pow(10,2);\r\n    if(goods_num == 0){\r\n\t\topener.document.all.ptMoney.value = 0;\r\n\t}else if(goods_num==1){\r\n\t\topener.document.all.ptMoney.value = opener.document.all.money.value;\r\n\t}else{\r\n\r\n        for(i = 0;i < goods_num; i++){\r\n            total_money = total_money * 1 + (opener.document.all.money[i].value) * 1;\r\n\r\n        }\r\n        opener.document.all.ptMoney.value = Math.round(total_money * cutNumber)/cutNumber;\r\n    }\r\n    }catch(e){}\r\n/*\r\n    for (i = 0; i < document.all.goodsTable.rows.length-1; i ++){\r\n        j=opener.document.all.detail.rows.length;\r\n        var ischeck=false;\r\n        if(1==1){\r\n            ischeck=document.all.checkbox.checked;\r\n        }\r\n        if(1>1){\r\n            ischeck=document.all.checkbox[i].checked;\r\n        }\r\n        if (ischeck){\r\n            row=opener.document.all.detail.insertRow();\r\n            for(k=0;k<7;k++){\r\n                cell=row.insertCell();\r\n                switch (k){\r\n                    case 0:\r\n                    strValue=document.all.tb1.rows[i+1].cells[1].innerHTML;\r\n");
      out.write("                    strValue='<input type=\"text\" name=\"goods_id\" size=\"8\" class=\"file_text\" value=\"'+strValue+'\" readonly>'\r\n                    break;\r\n                    case 1:\r\n                    strValue=document.all.tb1.rows[i+1].cells[3].innerHTML;\r\n                    break;\r\n                    case 2:\r\n                    strValue=document.all.tb1.rows[i+1].cells[4].innerHTML;\r\n                    break;\r\n                    case 3:\r\n                    strValue='<input name=\"amount\" type=\"text\" size=\"8\" class=\"re_text\" value=\"1\" onblur=\"javascript:CheckAndCount();total_money();\">';\r\n                    break;\r\n                    case 4:\r\n                    strValue=document.all.tb1.rows[i+1].cells[5].innerHTML;\r\n                    strValue='<input type=\"text\" name=\"mcost\" size=\"8\" class=\"re_text\" value=\"'+strValue+'\" onblur=\"javascript:CheckAndCount();total_money();\">';\r\n                    break;\r\n                    case 5:\r\n                    strValue=document.all.tb1.rows[i+1].cells[5].innerHTML;\r\n");
      out.write("                    strValue='<input type=\"text\" size=\"8\" name=\"goods_money\" class=\"file_text\" value=\"'+strValue+'\" readonly>';\r\n                    break;\r\n                    case 6:\r\n                    strValue='<img src=\"../../back/images/delete.gif\" alt=\"删除该商品\" width=\"13\" height=\"13\" align=\"absmiddle\" onclick=\"javascript:document.all.detail.deleteRow(parentElement.parentElement.rowIndex);total_money();\" style=\"cursor:pointer\">';\r\n                    break;\r\n                }\r\n                cell.innerHTML=strValue;\r\n                cell.align=\"center\";\r\n            }\r\n        }\r\n    }*/\r\n\r\n    if (flag == 2) window.close();\r\n}\r\n\r\nfunction checkReset() {\r\n");
  if( j > 0 ){ 
      out.write("\r\n        for(var i = 0; i < document.all.goodsId.length; i++){\r\n            //alert(\"22\");\r\n            document.all.goodsId[i].checked = false;\r\n        }\r\n\r\n");
 } 
      out.write("\r\n    if (document.all.selectAllBox.checked)\r\n    \tdocument.all.selectAllBox.checked = false;\r\n/*\r\n    var detailTable = opener.document.all.detailTable;\r\n    if (detailTable.rows.length > 1) {\r\n        for (var i = detailTable.rows.length-1; i > 0; i--) {\r\n            detailTable.deleteRow(i);\r\n        }\r\n    }\r\n*/\r\n}\r\n\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\nfunction chSearch(obj){\r\n\tif(obj.value == \"查询\"){\r\n\t\tobj.value = \"关闭查询\";\r\n\t\tdocument.all.searchTable.style.display=\"\";\r\n\t}else{\r\n\t\tobj.value = \"查询\";\r\n\t\tdocument.all.searchTable.style.display=\"none\";\r\n\t}\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
