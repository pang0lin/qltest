...
public final class messagesended_jsp extends org.apache.jasper.runtime.HttpJspBase
...
response.setDateHeader ("Expires", 0);
      ...
      out.write("\r\n<body  class=\"MainFrameBox\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n  <tr>\r\n    <td align=\"right\" nowrap>\r\n\t<button class=\"btnButton2Font\" onclick=\"delReceive()\" >删除</button>\r\n\t<button class=\"btnButton4Font\" onclick=\"delQuiteReceive()\">彻底删除</button>\r\n\t<button class=\"btnButton2Font\" onclick=\"delAllReceive()\">清空</button></td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n<form name=\"form1\" action=\"\" method=\"post\">\r\n\r\n\t<tr>\r\n\t\t<td width=\"2%\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n\t\t<td width=\"12%\" class=\"listTableHead\">收信人</td>\r\n\t\t<td width=\"64%\" class=\"listTableHead\">内容</td>\r\n\t\t<td width=\"12%\" class=\"listTableHead\">发送时间</td>\r\n\t\t<td width=\"10%\" class=\"listTableHeadLast\">发送状态</td>\r\n\t</tr>\r\n                                    ");
					...
					List list=(List)request.getAttribute("sendedflowList");
					...
					if(list != null){
						...
						if(index%2 != 0){listClass="listTableLine2";}
                                                List listflow=(List)list.get(i);
                                                Object id = (Object) listflow.get(0);
                                                String receiveMan = (String) listflow.get(1);
                                                String msContent = (String) listflow.get(2);
                                                String sendType = (String) listflow.get(6);
                                    
      out.write("\r\n\r\n                                     <tr>\r\n                                      <td class=\"");
      out.print(listClass);
      out.write("\">\r\n                                       ");
if(sendType.equals("未发送")){
      out.write("\r\n                                      &nbsp;\r\n                                      ");
}else{
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("    //if(checkboxNumber==j && pageSize2>=pageSize3){\r\n        //pageSize2 = pageSize2-pageSize3;\r\n        //}\r\n        if(strId!=\"\"){\r\n\tif(confirm(\"确实要将这些短信删入废信箱吗？\")){\r\n         window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/MessageAction.do?action=delSendedBox&ids=\" + getCheckBoxID()+\"&pager.offset=\"+pageSize2 ;\r\n    }\r\n    }else{\r\n             alert(\"请选择要删除的短信!\");\r\n             return;\r\n         }\r\n}\r\nfunction delQuiteReceive() {\r\n     var strId=getCheckBoxID();\r\n     var checkboxNumber = document.all.checkboxNumber.value;\r\n     var j = document.all.jNumber.value\r\n     var pageSize2 = document.all.pageSize2.value;\r\n     var pageSize3 = document.all.pageSize3.value;\r\n     if(checkboxNumber==j && pageSize2>=pageSize3){\r\n        pageSize2 = pageSize2-pageSize3;\r\n        }\r\n        if(strId!=\"\"){\r\n     if(confirm(\"确实要永久删除这些短信吗？\")){\r\n\r\n         window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/MessageAction.do?action=delQuiteSendedBox&ids=\" + getCheckBoxID()+\"&pager.offset=\"+pageSize2 ;\r\n");
      out.write("    }}else{\r\n             alert(\"请选择要删除的短信!\");\r\n             return;\r\n         }\r\n}\r\nfunction delAllReceive() {\r\n     if(confirm(\"确实将所有的短信删入废信箱吗？\")){\r\n         window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/MessageAction.do?action=clearAllSended\";\r\n    }\r\n}\r\nfunction moveWaitdo() {\r\n    var strId=getCheckBoxID();\r\n    var checkboxNumber = document.all.checkboxNumber.value;\r\n    var j = document.all.jNumber.value\r\n    var pageSize2 = document.all.pageSize2.value;\r\n    var pageSize3 = document.all.pageSize3.value;\r\n    if(checkboxNumber==j && pageSize2>=pageSize3){\r\n        pageSize2 = pageSize2-pageSize3;\r\n        }\r\n        if(strId!=\"\"){\r\n\tif(confirm(\"确实要将这些邮件移入待办件箱吗？\")){\r\n         window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/MessageAction.do?action=moveWaitdo&ids=\" + getCheckBoxID()+\"&pager.offset=\"+pageSize2 ;\r\n    }}else{\r\n             alert(\"请选择要移动的邮件!\");\r\n             return;\r\n         }\r\n");
