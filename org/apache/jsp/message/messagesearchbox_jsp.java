 ...
 * Generated at: 2023-01-06 09:53:22 UTC
...
public final class messagesearchbox_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      try {
        ...
        String msgContent=request.getParameter("msgContent");
		 if(msgContent==null || "".equals(msgContent)|| "null".equals(msgContent)) msgContent="";
        String name_set = request.getParameter("name");
        String status_set = request.getParameter("status");//status="4"是发信箱，“3”废信箱,"1"是收信箱
		 if(status_set==null || "".equals(status_set)|| "null".equals(status_set)) status_set="4";
        String checkbox_set = request.getParameter("checkbox");
        String startdate_set = request.getParameter("start_date");
        ...
        if (startdate_set!=null){
            java.util.regex.Pattern p1 = java.util.regex.Pattern.compile("(\\d+)/(\\d+)/(\\d+)");
            java.util.regex.Matcher m1 = p1.matcher(startdate_set);
            m1.find();
            s_year= m1.group(1);
            s_month = m1.group(2);
            s_day = m1.group(3);
            }
	     String enddate_set = request.getParameter("end_date");
        if (enddate_set!=null){
            java.util.regex.Pattern p2 = java.util.regex.Pattern.compile("(\\d+)/(\\d+)/(\\d+)");
		java.util.regex.Matcher m2 = p2.matcher(enddate_set);
                m2.find();
		e_year= m2.group(1);
            	e_month = m2.group(2);
            	e_day = m2.group(3);
        ...
        pageSize = Integer.parseInt(request.getAttribute("maxPageItems").toString());
            ...
            try {
              ...
              // /message/messagesearchbox.jsp(140,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/MessageAction?action=searchView");
              // /message/messagesearchbox.jsp(140,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n<TBODY>\r\n\t<tr>\r\n\t\t<td width=\"20\" rowspan=2></td>\r\n\t\t<td width=\"32%\">内容：<input type=\"text\" name=\"msgContent\" style=\"width:60%;\" class=\"inputText\" value=\"");
                  out.print(msgContent);
                  out.write("\" onKeyDown=\"if(event.keyCode==13) search();\"></td>\r\n\t\t<td width=\"32%\">范围：<select name=\"status\" onchange=\"chang(this);\" style=\"width:60%;\">\r\n\t\t\t\t\t\t\t\t\t\t<option value=\"1\" ");
if(status_set !=null && status_set.equals("1")){out.print("selected");}
                  out.write(">收信箱</option>\r\n\t\t\t\t\t\t\t\t\t\t<option value=\"3\" ");
if(status_set !=null && status_set.equals("3")){out.print("selected");}
                  out.write(">废信箱</option>\r\n\t\t\t\t\t\t\t\t\t\t<option value=\"4\" ");
if(status_set !=null && status_set.equals("4")){out.print("selected");}
                  out.write(">发信箱</option>\r\n\t\t\t\t\t\t\t\t\t</select></td>\r\n\t\t<td width=\"32%\"><span id=\"poster\" style=\"\">发信人：</span><span id=\"mailto\" style=\"display:none\">收信人：</span> ");
if (name_set ==null){
                  out.write("\r\n                                                       <input type=\"text\" name=\"name\" class=\"inputText\" style=\"width:60%;\" onKeyDown=\"if(event.keyCode==13) search();\">\r\n                                                         ");
}else{
                  out.write("\r\n                                                       <input type=\"text\" name=\"name\" class=\"inputText\" value=\"");
                  out.print(name_set);
                  out.write("\" style=\"width:60%;\" onKeyDown=\"if(event.keyCode==13) search();\">\r\n                                                       ");
}
...
if(checkbox_set !=null && "checked".equals(checkbox_set)){out.print("checked");}
                  out.write("></td>\r\n\t\t<td align=\"right\">\r\n                                                    <button class=\"btnButton2Font\" onclick=\"search();\" >查询</button>\r\n                                                    <button class=\"btnButton2Font\" onclick=\"clearr();\" >重置</button>\r\n                                                  </td>\r\n\t</tr>\r\n</table>\r\n\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n  <tr>\r\n    <td align=\"right\" nowrap>\r\n\t");
if (status_set !=null && !"3".equals(status_set)){
                  out.write("<button class=\"btnButton2Font\" onclick=\"delSearch()\" >删除</button>");
}
if(status_set !=null){
                  out.write("<button class=\"btnButton4Font\" onclick=\"delQuiteSearch()\">彻底删除</button>");
}
                  out.write("</td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\t<tr>\r\n\t\t<td width=\"2%\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n                                      <td width=\"15%\" class=\"listTableHead\">发信人/收信人</td>\r\n                                      <td class=\"listTableHead\">内容</td>\r\n                                      <td width=\"15%\" class=\"listTableHead\">发送日期</td>\r\n                                      <td width=\"15%\" class=\"listTableHeadLast\">接收日期</td>\r\n                                    </tr>\r\n                                   ");
                  ...
                  try {
                    ...
                    // /message/messagesearchbox.jsp(208,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fnotEmpty_005f0.setName("searchBoxList");
                    ...
                    if (_jspx_eval_logic_005fnotEmpty_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      do {
                        ...
                        try {
                          ...
                          // /message/messagesearchbox.jsp(209,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                          _jspx_th_logic_005fiterate_005f0.setId("desList");
                          // /message/messagesearchbox.jsp(209,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                          _jspx_th_logic_005fiterate_005f0.setName("searchBoxList");
                          // /message/messagesearchbox.jsp(209,1) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                          _jspx_th_logic_005fiterate_005f0.setScope("request");
                          int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
                          if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                            java.lang.Object desList = null;
                            ...
                            desList = (java.lang.Object) _jspx_page_context.findAttribute("desList");
                            do {
                              out.write("\r\n                                    ");

                                    	Object[] obj = (Object[]) desList;
                                        index ++;
                                        j ++;
                              ...
                              out.print(listClass);
                              out.write("\">\r\n\t\t\t\t\t\t\t\t\t  ");
if( obj[5].toString().equals("系统管理员")){
                              out.write("系统\r\n\t\t\t\t\t\t\t\t\t  ");
}else if((obj[4] != null && obj[5] == null) || (obj[4] == null && obj[5] != null) ){
                              out.write("外发\r\n\t\t\t\t\t\t\t\t\t  ");
}else if(obj[4] != null && obj[5] != null && status_set.equals("1")){
                              out.print(obj[5]);
                              out.write("\r\n\t\t\t\t\t\t\t\t\t  ");
}else if(obj[4] != null && obj[5] != null && status_set.equals("4")){
                              out.print(obj[4]);
                              out.write("\r\n\t\t\t\t\t\t\t\t\t  ");
}else if(obj[4] != null && obj[3] != null && status_set.equals("3")){
                              out.print(obj[4]);
                              out.write("\r\n\t\t\t\t\t\t\t\t\t  ");
}else if(obj[5] != null && obj[2] != null && status_set.equals("3")){
                              out.print(obj[5]);
                              out.write("\r\n\t\t\t\t\t\t\t\t\t  ");
}
                              out.write("\r\n                                      <td class=\"");
...
if(obj[3] == null ){
                  ...
                  out.write("\r\n\t\t\t\t\t\t\t\t\t ");
									 ...
									 List list=(List)request.getAttribute("searchSendedFlow");
									 if(list != null){
                                     for(int i=0;i<list.size();i++){
										  ...
										  String listClass="listTableLine1";
										if(index%2 != 0){listClass="listTableLine2";}
                                      Object[] objflow=(Object[])list.get(i);	
...
if(objflow[1] == null ){
                  ...
                  out.write("</td>\r\n\t\t\t\t                      <td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">未发送 </td>                               \r\n                                      </tr>\r\n                                   ");
}}
                  out.write("\r\n                                ");
...
String pagerURL = "/jsoa/MessageAction.do";
            out.write("\r\n\t\t\t\t\t\t\t\t\t");
