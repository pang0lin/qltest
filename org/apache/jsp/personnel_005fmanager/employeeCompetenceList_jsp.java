...
public final class employeeCompetenceList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
canAdd="0";
 ...
 if(canAdd.equals("1")){
      ...
      try {
        ...
        // /personnel_manager/employeeCompetenceList.jsp(139,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("competenceList");
        // /personnel_manager/employeeCompetenceList.jsp(139,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("competenceList");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object competenceList = null;
          ...
          competenceList = (java.lang.Object) _jspx_page_context.findAttribute("competenceList");
          do {
            out.write("\r\n\t\t");

		  competenceObj = (Object[]) competenceList;
		  index ++;
...
if(index%2 != 0){listClass="listTableLine2";}
            ...
            out.print(competenceObj[1]);
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print((""+competenceObj[2]).substring(0,10));
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print((""+competenceObj[3]).substring(0,10));
            out.write("</td>\r\n\t\t  <td class=\"listTableLine3\">");
            out.print(competenceObj[4]==null?"&nbsp;":competenceObj[4]);
            out.write("</td>\r\n\t\t  ");
 if(canAdd.equals("1")){
            out.write("\r\n\t\t  <td class=\"listTableLine3 listTableLineLastTD\" nowrap>\r\n\t\t  \t<img src=\"images/modi.gif\" alt=\"修改\" style=\"cursor:pointer\" onClick=\"modify('");
            out.print(competenceObj[0]);
...
if(!deleteSuccess.booleanValue()){
      ...
      out.write("\r\n</html>\r\n<script language=\"javascript\">\r\n<!--\r\nfunction search(){\r\n    form2.submit();\r\n}\r\nfunction delSingle(id){\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=\"/jsoa/EmployeeCompetenceAction.do?action=delete&competenceId=\" + id+\"&empID=");
      out.print(empID);
      out.write("&open=");
      out.print(open);
      out.write("\" ;\r\n    }\r\n}\r\nfunction modify(id){\r\n    MM_openBrWindow('/jsoa/EmployeeCompetenceAction.do?action=modify&competenceId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=600,height=350')\r\n}\r\n\tfunction view(id){\r\n    MM_openBrWindow('/jsoa/EmployeeCompetenceAction.do?action=view&competenceId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
