...
public final class selectWorkFlow_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  java.util.List boradRoomApplyFlowlist = (java.util.List)request.getAttribute("voitureFlowlist") ;
...
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
      ...
      out.write("\r\n\t location.href=\"/jsoa/EquipmentAction.do?action=addEquipmentApplyView&equipmentId=");
      out.print(equipmentId);
      out.write("&\"+selProcess+\"&moduleId=14\";\r\n\t ");
}else{
      out.write("\r\n\t location.href=\"/jsoa/EquipmentAction.do?action=addEquipmentApplyView&\"+selProcess+\"&moduleId=14\";\r\n\t ");
}
