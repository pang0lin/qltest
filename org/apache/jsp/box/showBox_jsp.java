...
import java.util.*;
import com.js.oa.box.bean.BoxEJBBean;
...
public final class showBox_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.oa.box.bean.BoxEJBBean");
    _jspx_imports_classes.add("com.js.oa.online.bean.OnlinerEJBBean");
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (request.getParameter("pager.offset") != null)
      ...
      try {
        ...
        // /box/showBox.jsp(78,0) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("mylist");
        // /box/showBox.jsp(78,0) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("mylist");
        // /box/showBox.jsp(78,0) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          ...
          do {
            out.write("\r\n\t\t\t\t\t\t");
                        ...
                        Object[] obj = (Object[]) mylist;  
                             	countRecordCount++;
								String netStr = obj[1].toString();
								String synopsis = obj[4].toString();
								String Name = obj[5].toString();
								String saveImg = obj[3].toString();													
							
            out.write("\t\t\t\t\t\t\t\t\r\n\r\n\t\t\t\t\t\t\t<a class=\"Ico_aBox\" href=\"");
            out.print(netStr);
            out.write("\" target=\"blank\" style=\"cursor: hand\">\r\n\t\t\t\t\t\t\t\t<div class=\"Ico_aBox_icon INico1\">\r\n\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t\t<img name=\"\" src=\"");
            out.print(request.getRealPath("upload/box") + "\\"+ saveImg);
            out.write("\" onload=\"javascript:resizeimg(this,35,40)\"/>\r\n\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t<div class=\"Ico_aBox_sha\"></div>\r\n\t\t\t\t\t\t\t\t<div class=\"Ico_aBox_tit\">\r\n\t\t\t\t\t\t\t\t\t");
            out.print(Name );
...
String pagerURL = "/jsoa/getBox.do";
      out.write("\r\n\t\t");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n<!-- PAGER -->\t\r\n\t\t\r\n\t\t<br>\r\n\t\t<a style=\"cursor: hand\" onClick=\"MM_openBrWindow('/jsoa/box/addBox.jsp','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=360')\">设置百宝箱</a>\r\n\t\t<a style=\"cursor: hand\" onClick=\"MM_openBrWindow('/jsoa/getBox.do?action=getAll','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=400')\">管理百宝箱</a>\r\n\t</body>\r\n</html>");
