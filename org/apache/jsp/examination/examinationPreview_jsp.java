...
public final class examinationPreview_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String radioMark = request.getParameter("radioMark");
 String radioIds = request.getParameter("radioIds");
 ...
 int  i = -1;
      ...
      try {
        ...
        // /examination/examinationPreview.jsp(40,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("/ExaminationSelfTestAction.do?action=putin");
        // /examination/examinationPreview.jsp(40,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setMethod("post");
        // /examination/examinationPreview.jsp(40,1) name = target type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if(radioIds != null && !radioIds.equals("")){
		 ...
		 for(int j = 0 ; j < stockSel.length ; j ++){
            ...
            out.write(" &nbsp;<img  style=\"cursor:pointer\" border=\"0\" src=\"/jsoa/images/del.gif\" alt=\"删除\" onclick=\"del('");
            out.print(stockSel[j]);
            out.write("','1');\"></td>\r\n\t\t </tr>\r\n\t\t ");
		 ...
		 for(int j = 0 ; j < stockSel.length ; j ++){	
		  ExaminationStockPO po = new ExaminationStockPO();
           po = new ExaminationStockBD().load(new Long(stockSel[j]));	 
            ...
            out.print(po.getExaminationID());
            out.write("\" class=\"inputTextarea\" style=\"width:98%\" ></textarea>\r\n\t\t </td>\r\n\t\t </tr>\r\n\t\t ");
}
		   }
            out.write("\r\n        ");
}
