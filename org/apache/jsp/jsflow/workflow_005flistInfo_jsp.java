...
public final class workflow_005flistInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(workId==null || workId.toUpperCase().equals("NULL") || workId.trim().length()<1){
        ...
        if("100".equals(curStatus)){
        	where=" where aaa.WORKSTATUS =100 ";
        }
        ...
        try{
            ...
            if(request.getParameter("fromZhishi")!=null){
            	href+="&fromZhishi=1";
            }
        }catch(Exception e){
        	/*System.out.print("\n------------\n"+sql+"\n------------\n");*/
