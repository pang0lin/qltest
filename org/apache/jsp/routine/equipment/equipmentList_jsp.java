...
java.util.List voitureFlowlist = (java.util.List)request.getAttribute("voitureFlowlist") ;
    	...
    	response.setDateHeader ("Expires", 0);
        	...
        	String storemanOrder = request.getParameter("orderbystoreman");
        if (storemanOrder == null)
        	storemanOrder = "1";
        else if ("0".equals(storemanOrder))
               storemanOrder = "1";
        else storemanOrder = "0";

        String timeOrder = request.getParameter("orderbystyle");
        if (timeOrder == null)
        	timeOrder = "1";
      ...
      String maintenanceEquipmentIds = "0";
		if(request.getAttribute("maintenanceEquipmentIds") !=null){
		  maintenanceEquipmentIds = request.getAttribute("maintenanceEquipmentIds").toString();
		}
...
String url_0="/jsoa/EquipmentAction.do?action=equipmentView&processId="+tmpStr[0]+"&remindField=&tableId="+tmpStr[2]+"&moduleId=14&processName="+tmpStr[3];

            out.write("\r\n<body  class=\"MainFrameBox\" onKeyDown=\"if(event.keyCode==13) search();\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<table width=\"100%\" border=\"0\" id=\"searchtable\"  style=\"display:none;\" cellpadding=\"0\" cellspacing=\"0\" class=\"SearchBar\">\r\n\t");
            //  html:form
            ...
            try {
              ...
              // /routine/equipment/equipmentList.jsp(75,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/EquipmentAction.do?action=equipmentView");
              // /routine/equipment/equipmentList.jsp(75,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
                  ...
                  out.write("名称：\r\n\t\t  <input name=\"searchEquipmentName\" onKeyPress=\"return look() ;\" onKeyUp=\"value=checkQuery(this,'");
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
                  out.write('设');
                  out.write('备');
}else{
                  ...
                  out.write("名称')\" onBlur=\"value=checkQuery1(this,'");
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
                  out.write('设');
                  out.write('备');
}else{
                  ...
                  out.write("名称')\" type=\"text\" class=\"inputText\" onKeyDown=\"if(event.keyCode==13) search();\" value='");
                  out.print(request.getParameter("searchEquipmentName")!=null?request.getParameter("searchEquipmentName"):"");
                  out.write("' style=\"width:70%\"/></td>\r\n\t    </td>\r\n\t    <td width=\"30%\" height=\"25\" >保管员：\r\n          <input name=\"searchEmpName\" onKeyPress=\"return look() ;\" onKeyUp=\"value=checkQuery(this,'保管员')\" onBlur=\"value=checkQuery1(this,'借用人')\" type=\"text\"  class=\"inputText\" onKeyDown=\"if(event.keyCode==13) search();\" value='");
                  out.print(request.getParameter("searchEmpName")!=null?request.getParameter("searchEmpName"):"");
...
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
                  ...
                  try {
                    ...
                    // /routine/equipment/equipmentList.jsp(88,19) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("List");
                    // /routine/equipment/equipmentList.jsp(88,19) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("equipmentTypeList");
                    // /routine/equipment/equipmentList.jsp(88,19) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(request.getAttribute("noAddRight") == null && !"0".equals(flag)){
            out.write("\r\n\t\t\t\t\t  <input type=\"button\" class=\"btnButton2Font\" onclick=\"MM_openBrWindow('EquipmentAction.do?action=addEquipmentView','','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=600,height=400')\" value=\"新增\"/>\r\n\t\t\t\t\t  <input type=\"button\" class=\"btnButton2Font\"  id=\"btnButton2Download\" onClick=\"uploadtemplate(13,2);\" value=\"导入\"/>\r\n\t\t\t\t\t  <input type=\"button\" class=\"btnButton2Font\"  id=\"btnButton2Download\" onClick=\"exportEquipmentMessage();\" value=\"导出Excel\"/>\r\n                      <input type=\"button\" class=\"btnButton2Font\" id=\"btnButton2Download\" onClick=\"downloadtemplate(13);\" value=\"下载模板\"/>\r\n\t\t\t\t\t ");
}
	                  if(request.getAttribute("noModiRight") == null && !"0".equals(flag)){
...
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
            ...
            out.write("编码</td>\r\n\t\t\t\t\t\t<td width=\"17%\" class=\"listTableHead\">");
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
            out.write('设');
            out.write('备');
}else{
...
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
            ...
            out.write("类别<a href=\"javascript:orderby('/jsoa/EquipmentAction.do?action=equipmentView&orderbystyle=");
            out.print(timeOrder);
            out.write("')\">");
if(request.getParameter("orderbystyle")==null){
            out.write("\r\n\t<img src=\"/jsoa/images/blanksort.gif\" border=\"0\" title=\"按");
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
            out.write('设');
            out.write('备');
}else{
            ...
            out.write("\r\n\t<img src=\"/jsoa/images/downsort.gif\" border=\"0\" title=\"按");
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
            out.write('设');
            out.write('备');
}else{
            ...
            out.write("\r\n\t<img src=\"/jsoa/images/upsort.gif\" border=\"0\" title=\"按");
if(com.js.util.config.SystemCommon.getEquipmentUse().equals("0")){ 
            out.write('设');
            out.write('备');
}else{
            ...
            out.write("</a></td>\r\n\t\t\t\t\t\t<td width=\"15%\" class=\"listTableHead\">规格</td>\r\n\t\t\t\t\t\t<td width=\"10%\" class=\"listTableHead\">保管员<a href=\"javascript:orderby('/jsoa/EquipmentAction.do?action=equipmentView&orderbystoreman=");
            out.print(storemanOrder);
            out.write("')\">");
if(request.getParameter("orderbystoreman")==null){
            out.write("\r\n\t<img src=\"/jsoa/images/blanksort.gif\" border=\"0\" title=\"按保管员排序\">\r\n\t");
}else if("1".equals(storemanOrder)){
            out.write("\r\n\t<img src=\"/jsoa/images/downsort.gif\" border=\"0\" title=\"按保管员排序\">\r\n\t");
}else if("0".equals(storemanOrder)){
            out.write("\r\n\t<img src=\"/jsoa/images/upsort.gif\" border=\"0\" title=\"按保管员排序\">\r\n\t");
}
            out.write("</a></td>\r\n\t\t\t\t\t\t<td  class=\"listTableHead\">管理单位</td>\r\n                        <td width=\"8%\" class=\"listTableHead\">详细状态</td>\r\n                        <td width=\"8%\"  nowrap=\"nowrap\" class=\"listTableHeadLast\">处理</td>\r\n                      </tr>\r\n\r\n                      ");
            ...
            try {
              ...
              // /routine/equipment/equipmentList.jsp(163,22) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setId("List");
              // /routine/equipment/equipmentList.jsp(163,22) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setName("equipmentList");
...
if(request.getAttribute("noAddRight") == null && !"0".equals(flag)){
                  ...
                  out.write('>');
						...
						if(maintenanceEquipmentIds.indexOf(obj[0].toString())>-1){
...
if(obj[5] !=null && !"".equals(obj[5].toString())){
                  ...
                  out.write("</td>\r\n                          <td class=\"");
                  out.print(listClass);
                  out.write("\"><a href=\"javascript:void(0);\" onclick=\"lookState('");
                  out.print(obj[0]);
                  out.write("');\">详细状态</a></td>\r\n                          <td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\" nowrap>\r\n                          <input type=\"hidden\" name=\"");
                  out.print(obj[0]);
                  out.write("_delete\" id=\"");
                  out.print(obj[0]);
                  out.write("_delete\" value=\"");
                  out.print(obj[6] );
                  out.write("\">\r\n                              ");
if(maintenanceEquipmentIds.indexOf(obj[0].toString())>=0  && !"0".equals(flag)){
                  out.write("<img style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" title=\"修改\" onclick=\"modify('");
                  out.print(obj[0]);
                  out.write("')\">&nbsp;");
if(obj[6].toString().equals("1")){ 
                  out.write("<img style=\"cursor:pointer\" border=\"0\" src=\"images/del_gray.gif\" title=\"正在被使用，不能删除\">");
}else{ 
                  out.write("<img style=\"cursor:pointer\" border=\"0\" src=\"images/del.gif\" title=\"删除\" onclick=\"del('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
                  ...
                  out.write("&nbsp;");
if(obj[6].toString().equals("1")){ 
                  out.write("<img style=\"cursor:pointer\" border=\"0\" src=\"images/sq_gray.gif\" title=\"已被申请\">");
}else{ 
...
String pagerURL = "/jsoa/EquipmentAction.do";
            out.write("\r\n\t\t\t\t\t\t\t\t\t");
