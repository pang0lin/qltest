...
public final class netdisk_005faddfolder_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if("reload".equals(request.getAttribute("flag"))){ 
            out.write("\r\n<script type=\"text/javascript\">\r\nwindow.close();\r\n</script>\r\n");
} 
            out.write("\r\n</head>\r\n<body leftmargin=\"0\" topmargin=\"0\"  class=\"MainFrameBox Pupwin\" onkeydown=\"entySubmit()\">\r\n<table width=\"100%\" height=\"100%\" border=\"0\" cellpadding=\"10\" cellspacing=\"0\" class=\"docBoxNoPanel\" >\r\n<tr>\r\n <td valign=\"top\">\r\n    <form name=\"form1\" action=\"\" method=\"post\">\r\n\t  <table border=\"0\">\t\t\r\n\t\t\t<tr><td valign=\"top\" style=\"padding-top:5px;\">名称&nbsp;<label class=\"mustFillcolor\">*</label>：</td>\r\n\t\t\t<input type=\"hidden\" name=\"currenid\" value=\"");
            out.print(request.getParameter("currenid"));
            out.write("\">\r\n\t\t\t<input type=\"hidden\" name=\"fileidstring\" id=\"fileidstring\" value=\"");
            out.print(request.getParameter("fileidstring"));
            out.write("\">\r\n\t\t\t<input type=\"hidden\" name=\"flags\">\r\n\t\t\t  <td  valign=\"top\" colspan=\"2\" align=\"left\">\r\n\t\t\t   <input type=\"text\" name=\"foldername\"  maxLength=\"45\" size=\"45\">\t\t\t  \r\n\t\t\t  </td>\r\n\t\t\t</tr>\r\n\t\t</table>\r\n\t\t\t<br><br>\r\n\t\t\t  <table width=\"10%\" border=\"0\" cellspacing=\"1\" cellpadding=\"1\">\r\n\t\t\t\t  <tr>\r\n\t\t\t\t\t<td><input type=\"button\" class=\"btnButton4font\" id=\"saveAndExit\" style=\"cursor:pointer\" onClick=\"saveandexit();\" value=\"");
            if (_jspx_meth_bean_005fmessage_005f1(_jspx_th_html_005fhtml_005f0, _jspx_page_context))
              return;
            out.write("\" /></td>\r\n\t\t\t\t\t<td><input type=\"button\" class=\"btnButton4font\"  id=\"saveAndContinue\"  style=\"cursor:pointer\" onClick=\"saveandcon();\" value=\"");
            if (_jspx_meth_bean_005fmessage_005f2(_jspx_th_html_005fhtml_005f0, _jspx_page_context))
              return;
            out.write("\" /></td>\r\n\t\t\t\t\t<td><input type=\"button\" class=\"btnButton2font\" style=\"cursor:pointer\" onClick=\"resetme();\" value=\"");
      ...
      out.write("\r\n<script src=\"/jsoa/js/util.js\"></script>\r\n<script language=\"javascript\">\r\nfunction checkName(name){\r\n\tif(name.indexOf(\"%\")>=0){\r\n\t\treturn true;\r\n\t}else if(name.indexOf(\"\\\"\")>=0){\r\n\t\treturn true;\r\n\t}else if(name.indexOf(\".\")>=0){\r\n\t\treturn true;\r\n\t}else if(name.indexOf(\"'\")>=0){\r\n\t\treturn true;\r\n\t}\r\n\r\n}\r\nfunction saveandexit(){\r\n  var name=document.all.foldername.value;\r\n  var id=document.all.currenid.value;\r\n  var idstring=document.all.fileidstring.value;\r\n  if(name==\"\"||name.replace(/(^\\s*)|(\\s*$)/g,\"\")=='' || checkName(name)){\r\n    //alert(Personalwork.webdisk_inputfoldername);这个是以前的，报错：找不到对象\r\n    alert(\"请输入正确的文件夹名称！\");//吴凯2012.05.23修改\r\n\treturn false;\r\n  }else{\r\n\t  document.all.flags.value=\"exit\";\r\n\t  var url='");
      out.print(webapp);
      out.write("'+\"/NetdiskAction.do?action=checkFolderName&type=add&idString=\"+idstring+\"&currenid=\"+id+\"&foldername=\"+name;\r\n\t  setButtonDisabled(\"saveAndExit\",true);\r\n\t  setButtonDisabled(\"saveAndContinue\",true);\r\n\t  setTimeout(\"fobbidenBtn()\",8000);\r\n\t  sendG(url,getResult,null);\r\n  }\r\n}\r\n\r\n\r\nfunction saveandcon(){\r\n  var name=document.all.foldername.value;\r\n  var id=document.all.currenid.value;\r\n  var idstring=document.all.fileidstring.value;\r\n  if(name==\"\"||name.replace(/(^\\s*)|(\\s*$)/g,\"\")=='' || checkName(name)){\r\n    //alert(Personalwork.webdisk_inputfoldername);这个是以前的，报错：找不到对象\r\n    alert(\"请输入正确的文件夹名称！\");//吴凯2012.05.23修改\r\n\treturn false;\r\n  }else{\r\n    document.all.flags.value=\"conn\";\r\n\tvar url='");
      out.print(webapp);
      out.write("'+\"/NetdiskAction.do?action=checkFolderName&type=add&idString=\"+idstring+\"&currenid=\"+id+\"&foldername=\"+name;\r\n\tsetButtonDisabled(\"saveAndExit\",true);\r\n\t  setButtonDisabled(\"saveAndContinue\",true);\r\n\t  setTimeout(\"fobbidenBtn()\",8000);\r\n\tsendG(url,getResult,null);\r\n  }\r\n}\r\n\r\n\r\nfunction getResult(cartXML){\r\n      var cart = cartXML.getElementsByTagName(\"result\")[0];\r\n\t  var name = cart.getElementsByTagName(\"name\")[0].firstChild.nodeValue;\r\n      if(name=='true'){\r\n        alert('同级目录下文件夹名称不能重复！');\r\n        return false;\r\n      }else{\r\n        form1.action=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/NetdiskAction.do?action=addfolder\";\r\n        form1.submit();\r\n        opener.location.reload();\r\n        var a=document.all.flags.value;\r\n        if(a=='exit'){\r\n          //window.close();\r\n        }\r\n      }\r\n }\r\nfunction fobbidenBtn(){\r\n   \tsetButtonDisabled('saveAndExit',false);\r\n  \tsetButtonDisabled('saveAndContinue',false);\r\n}\r\n\r\n function entySubmit(){\r\n  if(event.keyCode==13){\r\n");
      out.write("    saveandcon();\r\n  }\r\n }\r\n\r\n\r\nfunction resetme(){\r\n  document.all.foldername.value=\"\";\r\n}\r\n</script>");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_addfolder.jsp(14,7) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("personalwork");
      // /netdisk/netdisk_addfolder.jsp(14,7) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setKey("webdisk.newfolder");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_addfolder.jsp(41,125) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("common");
      // /netdisk/netdisk_addfolder.jsp(41,125) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_addfolder.jsp(42,130) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setBundle("common");
      // /netdisk/netdisk_addfolder.jsp(42,130) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setKey("comm.savecontinue");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_addfolder.jsp(43,104) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setBundle("common");
      // /netdisk/netdisk_addfolder.jsp(43,104) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /netdisk/netdisk_addfolder.jsp(44,109) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setBundle("common");
      // /netdisk/netdisk_addfolder.jsp(44,109) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
