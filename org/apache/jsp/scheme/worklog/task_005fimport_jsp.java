...
public final class task_005fimport_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getAttribute("hasRepeat")!=null){
	if("hasRepeat".equals(request.getAttribute("hasRepeat").toString())){

      out.write("\r\n\talert(\"任务代号重复,请修改任务代号！\")\r\n        //opener.window.location.reload();\r\n         opener.searcher();\r\n        window.close();\r\n        ");
}
}
      out.write('\r');
      out.write('\n');
...
if("add".equals(mode)){
    ...
    for (int j=0;j<fileList.size();j++){
        ...
        else if(fileSize==0 || upLoadAllFileSize<fileSize)//系统对上传文件总大小无限制,或者当前上传文件的总大小小于系统限制
        {
            ...
            if(!(".xls".indexOf(fileSuffix)>=0))//判断时候合法
            {
                notAgree=true;
            }
...
if("0".equals(continueUpload)){
      ...
      out.write("\r\n\t\t\t\tlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/workLogAction.do?action=import&path=");
      out.print(path);
      out.write("&filename=");
      out.print(saveName);
      out.write("\";\r\n\t\t\t");
}else{
      out.write("\r\n\t\t\t\tlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/workLogAction.do?action=import&project_id=");
...
if(tooLong){
      ...
      out.write("\r\n<html>\r\n\t<head>\r\n\t\t<title>导入excel文件</title>\r\n\t\t<style type=\"text/css\"></style>\r\n\t\t<script src=\"/jsoa/js/js.js\" language=\"javascript\"></script>\r\n\t</head>\r\n\t<body bgcolor=\"E8ECED\" onload=\"resizeWin(400,280);\">\r\n\t\t<br>\r\n\t\t<div align=\"center\"><P><font color=\"#3366CC\">请选择要导入的excel文件</font></p></div>\r\n\t\t<table width=\"80%\" align=\"center\" border=0>\r\n\t\t<center>\r\n\t\t<form ENCTYPE=\"multipart/form-data\" NAME =\"frm\" ACTION = \"task_import.jsp?project_id=");
      out.print(project_id);
      out.write("&path=");
      out.print(path);
