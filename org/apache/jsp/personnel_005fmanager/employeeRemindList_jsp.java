...
public final class employeeRemindList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.oa.hr.personnelmanager.po.EmpRemindPO");
...
int index1 = 0;
      ...
      out.write("        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/PersonalKindAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">人员性质</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanelSelected\" onClick=\"changePanle(this,'/jsoa/EmpRemindAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">人事提醒</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n\t</td>\r\n\t  <td align=\"right\">\r\n\t\t  <input type=\"button\" class=\"btnButton2font\" style=\"cursor:pointer\" onClick=\"javascript:MM_openBrWindow('/jsoa/EmpRemindAction.do?flag=add&fromSystem=");
      out.print(fromSystem );
      out.write("','','scrollbars=yes,resizable=yes,width=650,height=320')\" value=\"新增\"/>\r\n\t\t  <input type=\"button\" class=\"btnButton2font\" style=\"cursor:pointer\" onClick=\"javascript:batchDelete()\" value=\"删除\"/>\r\n\t  </td>\r\n</tr>\r\n</table>\r\n</td>\r\n</tr> \r\n<!-- LIST TITLE PART -->\r\n\t<form name=\"WorkAddressActionForm\" method=\"post\" action=\"/jsoa/PersonalKindAction.do\">\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n\t\t<tr align=\"center\">\r\n\t\t\t<td width=\"40\" class=\"listTableHead\" nowrap>\r\n\t\t\t\t<input type=\"checkbox\" value=\"1\" name=\"selectAllBox\" onClick=\"selectAll(this);\" ></td>\r\n\t\t\t<td class=\"listTableHead\"> 提醒事项 </td>\r\n\t\t\t<td class=\"listTableHead\"  width=\"20%\"> 提醒人 </td>\r\n\t\t\t<td class=\"listTableHead\" > 提醒时间 </td>\r\n\t\t\t<td class=\"listTableHead\" width=\"15%\"> 类型 </td>\r\n\t\t\t<td width=\"8%\" class=\"listTableHeadLast\" nowrap>处理</td>\r\n\t\t</tr>\r\n\t\t");
      ...
      try {
        ...
        // /personnel_manager/employeeRemindList.jsp(129,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("empRemindList");
        // /personnel_manager/employeeRemindList.jsp(129,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("empRemindList");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object empRemindList = null;
          ...
          empRemindList = (java.lang.Object) _jspx_page_context.findAttribute("empRemindList");
          do {
            out.write("\r\n\t\t");

		  empRemindObj = (Object[]) empRemindList;
			
			 
			 String rtype = "";
			 if("1".equals(empRemindObj[3])){
			 	rtype="员工转正提醒";
			 }else if("2".equals(empRemindObj[3])){
			 	rtype="合同到期提醒";
			 }
...
if(index % 2 == 0){
            ...
            out.print(empRemindObj[0] );
            out.write("\" name=\"remindId\" id=\"remindId\"></td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write('"');
            out.write('>');
            out.print(empRemindObj[1]+rtype );
            out.write("</td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write('"');
            out.write('>');
            out.print(empRemindObj[4] );
            out.write("</td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write("\">到期前");
            out.print(empRemindObj[2] );
            out.write("天</td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write('"');
            out.write('>');
            ...
            out.write("</td>\r\n\t\t  <td class=\"");
            out.print(listClass);
            out.write(" listTableLineLastTD\" nowrap><img src=\"images/modi.gif\" alt=\"修改\" style=\"cursor:pointer\" onClick=\"modify('");
            out.print(empRemindObj[0] );
...
String pagerURL = "/jsoa/EmpRemindAction.do";
      out.write("\r\n\t\t  ");
...
if(!currentPageNumber.equals(pageCount)){
   ...
   if(deloff<0) deloff = 0;
      ...
      out.write("\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=\"/jsoa/EmpRemindAction.do?flag=delete&fromSystem=");
      out.print(fromSystem );
      out.write("&remindId=\" + id + \"&pager.offset=");
      out.print(deloff);
      out.write("\";\r\n    }\r\n}\r\nfunction selectAll(obj){\r\n    if(document.getElementsByName(\"remindId\")){\r\n     for(var i = 0; i < document.getElementsByName(\"remindId\").length; i ++){\r\n         if(obj.checked){\r\n             document.getElementsByName(\"remindId\")[i].checked = true;\r\n         }else{\r\n             document.getElementsByName(\"remindId\")[i].checked = false;\r\n         }\r\n     }\r\n    }\r\n}\r\nfunction batchDelete(){\r\n\r\n        if(checkboxIsChecked(document.getElementsByName(\"remindId\"))){\r\n            var id = \"\";\r\n             for(var i = 0; i < document.getElementsByName(\"remindId\").length; i ++){\r\n                 if(document.getElementsByName(\"remindId\")[i].checked){\r\n                     id += document.getElementsByName(\"remindId\")[i].value + \",\";\r\n                 }\r\n             }\r\n            if(id.indexOf(\",\") > 0){\r\n                id = id.substring(0, id.length - 1);\r\n            }\r\n            if(confirm(\"确实要删除吗？\")){\r\n            window.location.href = \"/jsoa/EmpRemindAction.do?flag=delete&fromSystem=");
      out.print(fromSystem );
      out.write("&remindId=\" + id + \"");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("\";;\r\n            }\r\n        }else{\r\n            alert(\"请选择要删除的记录！\");\r\n        }\r\n}\r\n\r\nfunction modify(id){\r\n    MM_openBrWindow('/jsoa/EmpRemindAction.do?flag=modify&fromSystem=");
      out.print(fromSystem );
      out.write("&remindId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=650,height=260')\r\n}\r\n\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
