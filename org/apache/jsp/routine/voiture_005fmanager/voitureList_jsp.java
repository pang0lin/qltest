...
public final class voitureList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  java.util.List voitureFlowlist = (java.util.List)request.getAttribute("voitureFlowlist") ;
		...
		String voitureMtRight =	String.valueOf(new ManagerService().hasRightTypeName(session.getAttribute("userId").toString(), "车辆管理", "维护"));
		String voitureAddRight = voitureMtRight;

		String maintenanceVoitureIds = "0";
		if(request.getAttribute("maintenanceVoitureIds") !=null){
		maintenanceVoitureIds = request.getAttribute("maintenanceVoitureIds").toString();
		}
...
if(voitureAddRight.equals("true") && !"0".equals(flag)){
            out.write("\r\n\t\t  <input type=\"button\"  class=\"btnButton2Font\" onclick='MM_openBrWindow(\"VoitureAction.do?flag=add\",\"\",\"TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=720,height=500\")' value=\"新增\" />");
}
            out.write("\r\n\t\t");
if(voitureMtRight.equals("true") && !"0".equals(flag)){
            out.write("<input type=\"button\"  class=\"btnButton2Font\" onclick=\"delBatchAll()\" value=\"删除\" />");
}
            out.write("</td>\r\n  </tr>\r\n</table>\r\n</td>\r\n</tr>\r\n\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n<form name=\"VoitureActionForm\" method=\"post\"\taction=\"/jsoa/VoitureAction.do\">\r\n\t<tr align=\"center\">\r\n\t");
if(voitureMtRight.equals("true") && !"0".equals(flag)){
            out.write("\r\n\t\t<td\twidth=\"40\"\t class=\"listTableHead\" nowrap>                   \r\n\t\t\t<input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\">\r\n                   </td> ");
}
            out.write("\r\n\t\t<td\t class=\"listTableHead\"> 车辆名称 </td>\r\n\t\t<td\twidth=\"16%\"\t  class=\"listTableHead\"> 型号 </td>\r\n\t\t<td\twidth=\"11%\"\t  class=\"listTableHead\"> 车牌号 </td>\r\n\t\t<td\twidth=\"10%\"       class=\"listTableHead\">司机</td>\r\n\t\t<td\twidth=\"8%\"\t  class=\"listTableHead\"> 类型 </td>\r\n\t\t<!--td\twidth=8%\"\t  class=\"listTableHead\"> 当前状态 </td-->\r\n\t\t<td\twidth=\"8%\"\t  class=\"listTableHead\"> 详细状态 </td>\r\n\t\t<td\twidth=\"8%\"   nowrap=\"nowrap\" class=\"listTableHeadLast\" > 处理 </td>\r\n\t  </tr>\r\n");
	...
	pageSize2=Integer.parseInt(request.getParameter("pager.offset"));
            ...
            try {
              ...
              // /routine/voiture_manager/voitureList.jsp(104,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /routine/voiture_manager/voitureList.jsp(104,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(voitureMtRight.equals("true") && !"0".equals(flag)){
                  ...
                  out.write(' ');
                  out.write('>');
if(maintenanceVoitureIds.indexOf(obj[0].toString())>0){
                  ...
                  out.write("</td-->\r\n\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"><a\thref=\"javascript:void(0);\" onclick=\"MM_openBrWindow('VoitureApplyAction.do?flag=info&voitureId=");
                  out.print(obj[0]);
                  out.write("','','LEFT=0,TOP=0,scrollbars=yes,resizable=no,width=600,height=280')\">详细状态</a></td>\r\n\t\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">");
if(voitureMtRight.equals("true") && !"0".equals(flag)&& maintenanceVoitureIds.indexOf(obj[0].toString())>0){
                  ...
                  out.write("&nbsp;<img\tsrc=\"images/sq.gif\" title=\"申请\" style=\"cursor:pointer\"\tonclick=\"apply('");
                  out.print(obj[0]);
                  out.write("')\">&nbsp;</td>\r\n\t\t</tr>\r\n\t");
