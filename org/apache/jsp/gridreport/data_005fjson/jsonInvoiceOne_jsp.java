 ...
 */
package org.apache.jsp.gridreport.data_005fjson;
...
public final class jsonInvoiceOne_jsp extends org.apache.jasper.runtime.HttpJspBase
...
/////////////////////////////////////////////////////////////////////////////////////////
//根据查询SQL,产生提供给报表生成需要的 JSON 数据
public static void JSON_GenDetailData(HttpServletResponse response, String QuerySQL, boolean ToCompress)
{
    try
    {
        try
        {
            ...
            ResponseText(response, JsonText.toString(), ToCompress);
        }
        catch(Exception e)
        {
            //output error message
...
/////////////////////////////////////////////////////////////////////////////////////////
//根据查询SQL,产生提供给报表生成需要的 JSON 数据，根据RecordsetQuerySQL获取报表明细数据，根据ParameterQuerySQL获取报表参数数据
public static void JSON_GenEntireData(HttpServletResponse response, String QuerySQL, String ParameterPart, boolean ToCompress)
{
    try
    {
        try
...
/////////////////////////////////////////////////////////////////////////////////////////
//根据查询SQL 产生提供给报表生成需要的 JSON 数据，这里只产生报表参数数据
...
public static void JSON_GenParameterData(HttpServletResponse response, String QuerySQL)
{
    try
    {
        ...
        ResponseText(response, JsonText.toString(), false);
    }
    catch(Exception e)
    {
    }
...
public static String JSON_Encode(String text)
{
  ...
  static {
    ...
    _jspx_dependants.put("/gridreport/data_json/../data/grcommon.jsp", Long.valueOf(1499751408000L));
    _jspx_dependants.put("/gridreport/data_json/../data/GenXmlData.jsp", Long.valueOf(1499751408000L));
    _jspx_dependants.put("/gridreport/data_json/GenJsonData.jsp", Long.valueOf(1499751408000L));
  }
...
String ParameterPart = JSON_GenParameterText(ParameterQuerySQL);

JSON_GenEntireData(response, RecordsetQuerySQL, ParameterPart, false); //GenNodeXmlData(response, RecordsetQuerySQL, false);
