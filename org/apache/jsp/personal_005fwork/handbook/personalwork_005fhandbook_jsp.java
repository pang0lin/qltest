...
public final class personalwork_005fhandbook_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int offset1 = index ;
DateFormat fmt = DateFormat.getDateInstance(DateFormat.FULL,java.util.Locale.CHINA);
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.print(local);
            out.write("/PersonalworkResource.js\" language=\"javascript\"></script>\r\n<script language=\"JavaScript\">\r\n<!--\r\nfunction MM_openBrWindow(theURL,winName,features) { //v2.0\r\n  JSMainWinOpen(theURL,winName,features);\r\n}\r\n//-->\r\n</script>\r\n</head>\r\n\r\n<body  class=\"MainFrameBox\">\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n\t\t<div style=\"padding-top:8px; width:100%; \">\r\n\t\t<font color=\"#0C408E\" style=\"font-family:'宋体';\">\r\n\t\t<b>便签：</b></font>\r\n\t\t<input type=\"text\" style=\"background-color:#FFF; height:20px; border:1px solid #6C92AD; width:95%\"  onclick=\"bian(this)\"  onblur=\"add(this)\" maxlength=\"300\"/>\r\n\t\t</div>\r\n  \r\n\t\t<table width=\"100%\"\theight=\"21\"\tborder=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"padding-bottom:2px;\" >\r\n<tr>\r\n\t<td align=\"right\">\r\n\t\r\n\t\t<input type=\"button\"  onclick=\"batchDel();\"  class=\"btnButton4font\" value=\"删除\" />\r\n\t\t\r\n\t</td>\r\n  </tr>\r\n</table>\r\n\t\r\n\t\t <!--<button class=\"btnButton2Font\" onclick=\"add()\">");
            if (_jspx_meth_bean_005fmessage_005f1(_jspx_th_html_005fhtml_005f0, _jspx_page_context))
              return;
            out.write("</button> -->\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\" style=\"border-top:1px solid #A9A9A9;\">\r\n    ");
            //  html:form
            ...
            try {
              ...
              // /personal_work/handbook/personalwork_handbook.jsp(80,4) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/NotePaperAction.do");
              // /personal_work/handbook/personalwork_handbook.jsp(80,4) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n\t<tr bgcolor=\"C9CDCF\">\r\n\t   <td width=\"40\" nowrap class=\"listTableHead\"><input type=\"checkbox\" value=\"1\" name=\"selAll\" onClick=\"selectAll(this);\"></td>\r\n\t    <td class=\"listTableHead\" >内容\r\n\t\t\r\n<!-- MIDDLE\tBUTTONS\t--></td>\r\n\t\t<td class=\"listTableHead\" width=\"18%\">");
                  if (_jspx_meth_bean_005fmessage_005f2(_jspx_th_html_005fform_005f0, _jspx_page_context))
                    return;
                  out.write("</td>\r\n\t\t<td class=\"listTableHeadLast\" nowrap width=\"8%\">");
	...
	String listClass="listTableLine1";
                  ...
                  try {
                    ...
                    // /personal_work/handbook/personalwork_handbook.jsp(93,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("mylist");
                    // /personal_work/handbook/personalwork_handbook.jsp(93,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("mylist");
                    // /personal_work/handbook/personalwork_handbook.jsp(93,1) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
obj = (Object[])mylist;
       ...
       if(index%2 != 0){listClass="listTableLine2";}
                        ...
                        out.print(listClass);
                        out.write(" \">\r\n\t\t\t    <!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->\r\n                ");
                        out.print(com.js.util.util.CharacterTool.escapeHTMLTags(obj[1]+""));
                        out.write("\r\n\t\t\t</td>\r\n\t\t\t<td class=\"");
                        out.print(listClass);
                        out.write('"');
                        out.write('>');
                        out.print((obj[3]==null || "".equals(obj[3].toString()))?"&nbsp;":(obj[3]+"").substring(0,(obj[3]+"").length()-2));
                        out.write("</td>\r\n\t\t\t<td class=\"");
                        out.print(listClass);
                        out.write(" listTableLineLastTD\" nowrap=\"nowrap\">\r\n\t\t\t    <img style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" alt=\"");
                        if (_jspx_meth_bean_005fmessage_005f4(_jspx_th_logic_005fiterate_005f0, _jspx_page_context))
                          return;
                        out.write("\" onClick=\"modi('");
                        out.print(obj[0]);
                        out.write('\'');
                        out.write(',');
                        out.write('\'');
...
String pagerURL = "/jsoa/NotePaperAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
     ...
     int deloffset =  countRecordCount == 1 ? offset1-8:offset1 ;
     deloffset = deloffset < 0 ? 0 : deloffset ;
     
      out.write("\r\n     if(confirm(Personalwork.commonuse_delete)){\r\n         window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/NotePaperAction.do?action=delBatch&ids=\"+id+\",&pager.offset=");
      out.print(deloffset);
      out.write("\" ;\r\n    }\r\n }\r\n\r\n//写便笺\r\nfunction add(a) {\r\n   \r\n   a.style.border = \"1px solid #6C92AD\";\r\n   var text = a.value.replace(/\\\\/g, \"\");\r\n   a.value=\"\";\r\n   if(\"\"!=text){\r\n   window.open(((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+'/jsoa/NotePaperAction.do?action=add1&NoteContent='+text,'MainDesktop','scrollbars=yes,resizable=yes') ;\r\n   }\r\n}\r\n\r\n//编辑\r\nfunction modi(id,color,offset) {\r\n    MM_openBrWindow('/jsoa/NotePaperAction.do?action=modi'+color+'&refreshType=1&editId='+id+'&pager.offset='+offset,'','left=400,top=250,scrollbars=yes,resizable=yes,width=300,height=260') ;\r\n}\r\n\r\n\r\nfunction bian(a)\r\n{\r\na.style.border = \"1px solid #F00\";\t\t\r\n\r\n}\r\nfunction selectAll(obj){\r\n    var result=obj.checked;\r\n    if(document.all.batchId){\r\n        if(isNaN(document.all.batchId.length)){\r\n            document.all.batchId.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchId.length;i++){\r\n                document.all.batchId[i].checked=result;\r\n            }\r\n        }\r\n");
      out.write("    }\r\n}\r\n\r\nfunction batchDel(){\r\n  var _id=getBatchIds();  \r\n  if(_id==\"\"){\r\n     alert(\"请选择要删除的记录！\");\r\n     return;\r\n  }\r\n  del(_id);\r\n}\r\n\r\nfunction getBatchIds(){\r\n  var _id=\"\";\r\n  var obj=document.all.batchId;\r\n  if(obj){\r\n     if(obj.length){\r\n       for(var i=0;i<obj.length;i++){\r\n         if(obj[i].checked){\r\n            _id+=obj[i].value+\",\";\r\n         }\r\n       }\r\n       if(_id.length>0){\r\n          _id=_id.substring(0,_id.length-1);\r\n       }\r\n     }else{\r\n       if(obj.checked){\r\n          _id+=obj.value;\r\n       }\r\n     }\r\n  }\r\n  return _id;\r\n}\r\n//function delProject(_id){\r\n//\tlocation.href=\"/jsoa/NotePaperAction.do?action=delBatch&ids=\"+_id;  \r\n//}\r\n\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/handbook/personalwork_handbook.jsp(41,7) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("personalwork");
      // /personal_work/handbook/personalwork_handbook.jsp(41,7) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/handbook/personalwork_handbook.jsp(74,54) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("common");
      // /personal_work/handbook/personalwork_handbook.jsp(74,54) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/handbook/personalwork_handbook.jsp(86,40) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setBundle("personalwork");
      // /personal_work/handbook/personalwork_handbook.jsp(86,40) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setKey("notepad.createtime");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/handbook/personalwork_handbook.jsp(87,50) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setBundle("personalwork");
      // /personal_work/handbook/personalwork_handbook.jsp(87,50) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setKey("agent.operation");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/handbook/personalwork_handbook.jsp(108,73) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setBundle("personalwork");
      // /personal_work/handbook/personalwork_handbook.jsp(108,73) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setKey("personalwork.modify");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /personal_work/handbook/personalwork_handbook.jsp(108,272) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f5.setBundle("personalwork");
      // /personal_work/handbook/personalwork_handbook.jsp(108,272) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f5.setKey("personalwork.delete");
