 ...
 * Generated at: 2023-01-06 09:43:19 UTC
...
if(request.getAttribute("reload")!=null){ 
            out.write("\r\n<script language=\"JavaScript\">\r\nlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/NewCodeAction.do?action=list\";\r\n</script>\r\n");
} 
            ...
            try {
              ...
              // /userdb/newCode/codeList.jsp(109,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("codeList");
              // /userdb/newCode/codeList.jsp(109,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("codeList");
              // /userdb/newCode/codeList.jsp(109,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		NewCodePO obj = (NewCodePO) codeList;
			...
			if(index%2 != 0){
				listClass="listTableLine2";
                  ...
                  out.write("');\"></a>&nbsp;\r\n\t\t\t<img src=\"/jsoa/imges/di1.gif\" border=\"0\" style=\"cursor:pointer;\" title=\"设置规则\" onclick=\"setCode('");
                  out.print(obj.getCodeId() );
...
String pagerURL = "/jsoa/NewCodeAction.do";
            out.write("\r\n\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\r\n<script language=\"javascript\">\r\nfunction MM_openBrWindow(theURL,winName,features) { //v2.0\r\n\t  JSMainWinOpen(theURL,winName,features);\r\n\t}\r\nfunction modi(id){\r\n\tJSMainWinOpen2(\"/jsoa/NewCodeAction.do?action=toModi&codeId=\"+id,\"\",\"\",500,200);\r\n}\r\nfunction setCode(id){\r\n\tJSMainWinOpen(\"/jsoa/NewCodeAction.do?action=codeSetList&codeId=\"+id,\"\",\"TOP=50,LEFT=50,scrollbars=yes,resizable=yes,width=600,height=400\");\r\n}\r\nfunction addCode(){\r\n\tJSMainWinOpen2(\"/jsoa/userdb/newCode/code_add.jsp\",\"\",\"\",500,200);\r\n}\r\n\r\nfunction delone(id){\r\n\tlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/NewCodeAction.do?action=delone&codeId=\"+id;\r\n}\r\n\r\nfunction query(){\r\n\tdocument.all.frm.submit();\r\n}\r\nfunction chSearch(obj){\r\n\tif(obj.value == \"查询\"){\r\n\t\tobj.value = \"关闭查询\";\r\n\t\tdocument.all.searchTable.style.display=\"\";\r\n\t}else{\r\n\t\tobj.value = \"查询\";\r\n\t\tdocument.all.searchTable.style.display=\"none\";\r\n\t}\r\n}\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\n</script>\r\n");
