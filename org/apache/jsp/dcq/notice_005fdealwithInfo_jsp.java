...
public final class notice_005fdealwithInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(null==oid || "".equals(oid) || null==personID || "".equals(personID)){
	
      out.write("\r\n\t<script type=\"text/javascript\">\r\n\talert(\"参数信息错误。\");\r\n\twindow.close();\r\n\t</script>\r\n\t");

}
List<Object[]> list = new BusinessShowBean().getInformationStatus(personID, oid);
      ...
      out.write("\r\n\t\t\t<div style=\"width: 80%; margin: 10px auto; text-align: center;\">\r\n\t\t\t\t<h2>发文办理情况</h2>\r\n\t\t\t\t<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td class=\"listTableHead\">反馈单位</td>\r\n\t\t\t\t\t\t<td class=\"listTableHead\">反馈人</td>\r\n\t\t\t\t\t\t<td class=\"listTableHead\">反馈内容</td>\r\n\t\t\t\t\t\t<td width=\"130\" class=\"listTableHead\">反馈时间</td>\r\n\t\t\t\t\t\t<td width=\"130\" class=\"listTableHead\">浏览时间</td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t\t");
