...
public final class zgrsExcel_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try{
	String title = request.getAttribute("title")==null?"人事考勤信息":request.getAttribute("title").toString();
	String sTitle = title;
    ...
    //标题
    String[] fieldTitle = (String[])request.getAttribute("fieldTitle");
    //接收数据
    ...
    WritableSheet ws = wwb.createSheet(sTitle, 10);
    ...
    for(int i=0;i<fieldTitle.length;i++){
    	ws.addCell(new Label(i, 0, fieldTitle[i], fwcf));
    }
    
    for(int i=0;i<list.size();i++){
    	String[] obj = (String[])list.get(i);
    	for(int y=0;y<fieldTitle.length;y++){
