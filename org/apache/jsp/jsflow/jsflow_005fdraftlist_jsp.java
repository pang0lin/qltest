        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /jsflow/jsflow_draftlist.jsp(62,22) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("workList");
              // /jsflow/jsflow_draftlist.jsp(62,22) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  out.write("\r\n                    \t");
						  ...
						  saveTime=obj[5].toString();
						  if(saveTime.indexOf(":")>0){
							  saveTime=saveTime.substring(0,saveTime.lastIndexOf(":"));
						  }
                  ...
                  out.write("\"></td>\r\n                              <td class=\"");
                  out.print(listClass);
                  out.write("\"><a href=\"javascript:void(0);\" onclick=\"reopenForm('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
                  ...
                  out.write("</td>\r\n                        \t\r\n                              <td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\"><img src=\"images/del.gif\" onclick=\"deleteItem('");
                  out.print(obj[0]);
                  out.write("');\"></td>\r\n                      \t  </tr>\r\n                      ");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n</body>\r\n<script language=\"javascript\">\r\n<!--\r\n\r\nfunction openForm(work,workType,table,record,processId,workFileType){\r\n    JSMainWinOpen('/jsoa/WorkFlowReSubmitAction.do?work='+work+'&workType='+workType+'&table='+table+'&record='+record+'&processId='+processId+'&workFileType='+workFileType,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600')\r\n}\r\n\r\nfunction openForm(work,workType,table,record,processId,workFileType){\r\n    JSMainWinOpen('/jsoa/WorkFlowReSubmitAction.do?work='+work+'&workType='+workType+'&table='+table+'&record='+record+'&processId='+processId+'&workFileType='+workFileType,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600')\r\n}\r\n\r\nfunction selectAll(obj){\r\n    if(document.all.batchId){\r\n        if(document.all.batchId.length){\r\n            for(var i = 0; i < document.all.batchId.length; i ++){\r\n                if(obj.checked){\r\n                    document.all.batchId[i].checked = true;\r\n                }else{\r\n");
            out.write("                    document.all.batchId[i].checked = false;\r\n                }\r\n            }\r\n        }else{\r\n            if(obj.checked){\r\n                document.all.batchId.checked = true;\r\n            }else{\r\n                document.all.batchId.checked = false;\r\n            }\r\n        }\r\n    }\r\n}\r\nfunction getBatchIDs(){\r\n\tvar ckObj=document.getElementsByName(\"batchId\");\r\n\tvar ids=\"\";\r\n\tfor(var i=0;i<ckObj.length;i++){\r\n\t\tif(ckObj[i].checked){\r\n\t\t\tids+=ckObj[i].value+\",\";\r\n\t\t}\r\n\t}\r\n\tif(ids.length>1){\r\n\t\tids=ids.substring(0,(ids.length-1));\r\n\t}\r\n\treturn ids;\r\n\t\r\n}\r\n\r\nfunction batchDelete(){\r\n\tvar ids=getBatchIDs();\r\n\tif(ids!=\"\"){\r\n\t\tdeleteItem(ids)\r\n\t}else{\r\n\t\talert(\"请选择要删除的记录!\");\r\n\t}\r\n}\r\nfunction deleteItem(ids){\r\n\tif(confirm(\"您确实要删除选中的记录吗!\")){\r\n\t\tlocation.href=\"/jsoa/FlowListAction.do?action=delete&ids=\"+ids;\r\n\t}\r\n}\r\n\r\nfunction op2(mainFile, work,workType,table,record,processId,workFileType,submitPerson,submitTime,activityId,activityName){\r\n    JSMainWinOpen(mainFile + '&work='+work+'&processType='+ workType +'&workType='+workType+'&tableId=' + table + '&table='+table+'&record='+record+'&recordId='+record+'&processId='+processId+'&processName=' + workFileType + '&activity='+activityId+'&activityName='+activityName+ '&workFileType='+workFileType+'&workStatus=");
            out.print(request.getParameter("workStatus"));
            out.write("&submitPerson=' + submitPerson + '&submitTime=' + submitTime,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600')\r\n}\r\nfunction chSearch(obj){\r\n\tif(obj.value == \"查询\"){\r\n\t\tobj.value = \"关闭查询\";\r\n\t\tdocument.all.searchTable.style.display=\"\";\r\n\t}else{\r\n\t\tobj.value = \"查询\";\r\n\t\tdocument.all.searchTable.style.display=\"none\";\r\n\t}\r\n}\r\n\r\nfunction reopenForm(wfWorkId,processId,tableId,recordId,relProjectId){\r\n\tJSMainWinOpen(\"/jsoa/jsflow/jsflow_reopenForm.jsp?wfWorkId=\"+wfWorkId+\"&processId=\"+processId+\"&tableId=\"+tableId+\"&recordId=\"+recordId+\"&relProjectId=\"+relProjectId,\"\",\"\");\r\n}\r\n//-->\r\n</script>\r\n");
