 ...
 * Generated at: 2023-01-06 09:48:43 UTC
...
public final class officebuild_005fsearch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String buidId = (String)request.getAttribute("buidId");
      ...
      out.write("\r\n\t\t\t\t</select>\r\n\t\t\t       &nbsp;&nbsp;&nbsp; 所属楼层：\r\n\t\t\t\t<select id=\"buidnumber\" name=\"buidnumber\" style=\"width:8%\" >\r\n                    <option value=\"\">--请选择--</option>\r\n                </select>\r\n                \r\n                           &nbsp;&nbsp;&nbsp;   状态：\r\n\t\t\t  \t<select id=\"useStatusId\" name=\"useStatusId\" style=\"width:8%\" >\r\n                    <option value=\"-1\">--请选择--</option>\r\n                    <option value=\"0\">未使用</option>\r\n                    <option value=\"1\">全部使用</option>\r\n                    <option value=\"2\">部分使用</option>\r\n                </select>\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t  <td>\r\n\t\t        工&nbsp; 位&nbsp;&nbsp;  数：\r\n\t\t     <select id=\"stationB\" name=\"stationB\" style=\"width:8%\" >\r\n                    <option value=\"-1\">--请选择--</option>\r\n                    <option value=\"0\">大于</option>\r\n                    <option value=\"1\">小于</option>\r\n                    <option value=\"2\">等于</option>\r\n             </select>   \r\n             &nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" id=\"useStationLeft\" name=\"useStationLeft\"  style=\"width:5%\"/> \r\n");
      out.write("\t\t     &nbsp;<select id=\"stationT\" name=\"stationT\" style=\"width:8%\" >\r\n                    <option value=\"-1\">--请选择--</option>\r\n                    <option value=\"0\">大于</option>\r\n                    <option value=\"1\">小于</option>\r\n                    <option value=\"2\">等于</option>\r\n             </select>\r\n             &nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" id=\"useStationRight\" name=\"useStationRight\"  style=\"width:5%\"/>\r\n\t\t  </td>\r\n\t\t</tr>\r\n\t\t<tr>\r\n\t\t  <td>\r\n\t\t        面&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;积：\r\n\t\t     <select id=\"areaB\" name=\"areaB\" style=\"width:8%\" >\r\n                    <option value=\"\">--请选择--</option>\r\n                    <option value=\"0\">大于</option>\r\n                    <option value=\"1\">小于</option>\r\n                    <option value=\"2\">等于</option>\r\n             </select>   \r\n             &nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" id=\"areaLeft\" name=\"areaLeft\"  style=\"width:5%\"/> \r\n\t\t     &nbsp;<select id=\"areaT\" name=\"areaT\" style=\"width:8%\" >\r\n                    <option value=\"\">--请选择--</option>\r\n");
      out.write("                    <option value=\"0\">大于</option>\r\n                    <option value=\"1\">小于</option>\r\n                    <option value=\"2\">等于</option>\r\n             </select>\r\n             &nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" id=\"areaRight\" name=\"areaRight\"  style=\"width:5%\"/>\r\n\t\t  </td>\r\n\t\t</tr>\r\n\t    <tr>\r\n\t\t  <td align=\"right\">\r\n\t\t     <button class=\"btnButton2Font\" onClick=\"search();\" >查询</button>\r\n\t\t     \r\n\t\t  </td>\r\n\t\t</tr>\r\n\t  </form>\r\n</table>\r\n <form  name=\"OfficeRoomActionForm\"  action=\"/OfficeRoomAction.do\" method=\"post\">\r\n <table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"inlineBottomLine\">\r\n  <tr>\r\n       <td>\r\n\t\t  <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/OfficeRoomAction.do?action=officeBasicShow&buildId=");
      out.print(buidId);
      ...
      out.write("\r\n          \r\n          ");
            ...
            if(request.getAttribute("officeList")!=null){
	           for(int i=0;i<officeList.size();i++){
	            Object[] obj = (Object[]) officeList.get(i);
	            index ++;
                j ++;
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n     </td>\r\n  </tr>\r\n </table>\r\n\r\n</form>\r\n</table>\r\n</body>\r\n</html>\r\n<script language=\"JavaScript\">\r\nfunction showSearch(){\r\n\t  document.getElementById(\"searchbar\").style.display=\"\";\r\n\t  document.getElementById(\"btnButton2FontShow\").style.display=\"none\";\r\n\t  document.getElementById(\"btnButton2FontClose\").style.display=\"\";\r\n\t}\r\nfunction closeSearch(){\r\n\t  document.getElementById(\"searchbar\").style.display=\"none\";\r\n\t  document.getElementById(\"btnButton2FontShow\").style.display=\"\";\r\n\t  document.getElementById(\"btnButton2FontClose\").style.display=\"none\";\r\n\t}\r\nfunction search(){\r\n\tvar buidId=document.getElementById(\"buidId\").value;\r\n\tif(buidId==null || buidId==\"\"){\r\n\t  alert(\"请选择隶属学楼！\");\r\n\t  return ;\r\n\t}\r\n\tif(buidId==null || buidId==\"\" ){\r\n\t\t buidId=document.getElementById(\"buidIds\").value;\r\n\t}\r\n\tvar buidnumber=document.getElementById(\"buidnumber\").value;\r\n\tvar useStatusId=document.getElementById(\"useStatusId\").value;\r\n\t\r\n\t\r\n\tvar stationB=document.getElementById(\"stationB\").value;//\r\n\tvar useStationLeft=document.getElementById(\"useStationLeft\").value;//\r\n");
      out.write("\tvar stationT=document.getElementById(\"stationT\").value;//\r\n\tvar useStationRight=document.getElementById(\"useStationRight\").value;//\r\n\tif(useStationLeft!=null){\r\n\t\t if(isNaN(useStationLeft)){\r\n\t\t        alert(\"请输入数字！\");\r\n\t\t        document.getElementById(\"useStationLeft\").value = \"\";\r\n\t\t        document.getElementById(\"useStationLeft\").focus();\r\n\t\t\t\treturn false;\r\n\t\t   }\r\n\t}\r\n\tif(useStationRight!=null){\r\n\t\t if(isNaN(useStationRight)){\r\n\t\t        alert(\"请输入数字！\");\r\n\t\t        document.getElementById(\"useStationRight\").value = \"\";\r\n\t\t        document.getElementById(\"useStationRight\").focus();\r\n\t\t\t\treturn false;\r\n\t\t   }\r\n\t}\r\n\r\n\tvar areaB=document.getElementById(\"areaB\").value;//\r\n\tvar areaLeft=document.getElementById(\"areaLeft\").value;//\r\n\tvar areaT=document.getElementById(\"areaT\").value;//\r\n\tvar areaRight=document.getElementById(\"areaRight\").value;//\r\n\t\r\n\tif(areaLeft!=null){\r\n\t\t if(isNaN(areaLeft)){\r\n\t\t        alert(\"请输入数字！\");\r\n\t\t        document.getElementById(\"areaLeft\").value = \"\";\r\n\t\t        document.getElementById(\"areaLeft\").focus();\r\n");
      out.write("\t\t\t\treturn false;\r\n\t\t   }\r\n\t}\r\n\tif(areaRight!=null){\r\n\t\t if(isNaN(areaRight)){\r\n\t\t        alert(\"请输入数字！\");\r\n\t\t        document.getElementById(\"areaRight\").value = \"\";\r\n\t\t        document.getElementById(\"areaRight\").focus();\r\n\t\t\t\treturn false;\r\n\t\t   }\r\n\t}\r\n\t\r\n\twindow.location.href=\"/jsoa/OfficeRoomAction.do?action=listOfficeBasicSearch&flag=1&useStatusId=\"+useStatusId+\r\n\t\"&buidId=\"+buidId+\r\n\t\"&buidnumber=\"+buidnumber+\r\n\t\"&stationB=\"+stationB+\r\n\t\"&areaB=\"+areaB+\r\n\t\"&stationT=\"+stationT+\r\n\t\"&areaT=\"+areaT+\r\n\t\"&areaLeft=\"+areaLeft+\r\n\t\"&areaRight=\"+areaRight+\r\n\t\"&useStationRight=\"+useStationRight+\r\n\t\"&useStationLeft=\"+useStationLeft;\r\n}\t\r\n\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\n\r\n//从后台取得所属单元楼的楼层数以及对应楼层的房间号\r\n\r\nfunction getXmlHttp(){\r\n\tvar xmlhttp;\r\n\t//开始初始化XMLHttpRequest对象\r\n\tif(window.XMLHttpRequest) { //Mozilla 浏览器\r\n\t\txmlhttp = new XMLHttpRequest();\r\n\t\tif (xmlhttp.overrideMimeType) {//设置MiME类别\r\n\t\t\txmlhttp.overrideMimeType('text/xml');\r\n\t\t}\r\n\t}\r\n\telse if (window.ActiveXObject) { // IE浏览器\r\n\t\ttry {\r\n");
      out.write("\t\t\txmlhttp = new ActiveXObject(\"Microsoft.XMLHTTP\");\r\n\t\t} catch (e) {\r\n\t\t\ttry {\r\n\t\t\t\txmlhttp = new ActiveXObject(\"MSXML2.XMLHTTP\");\r\n\t\t\t} catch (e) {\r\n\t\t\t\talert(\"您看到此信息，说明您的浏览器不支持XML解析。\\r\\n请在弹出页面中下载XML解析器并安装！\");\t\t\t\t\r\n\t\t\t}\r\n\t\t}\r\n\t}\r\n\treturn xmlhttp;\r\n}\r\n\r\n\r\nfunction getBuildNumber(obj)\r\n {\r\n    var buildId = obj.value;\r\n\t document.getElementById(\"buidnumber\").options.length=1;//清空相应select\r\n\tif(null==buildId||buildId.length<1||\"\"==buildId){\r\n\t\treturn;\r\n\t}\r\n\tif(buildId!=null)\r\n\t{\r\n\t\tvar content = \"\";\r\n\t \txmlhttpAjax= getXmlHttp();\r\n\t \txmlhttpAjax.open(\"POST\",\"/jsoa/routine/officeroom/officebuildajax.jsp?buildId=\"+buildId,false);\r\n\t \txmlhttpAjax.send(null);\r\n\t \tif (xmlhttpAjax.readyState==4 && xmlhttpAjax.status==200)\r\n\t \t{\r\n\t \t    content = xmlhttpAjax.responseText;\r\n\t \t    if(content!=null&&content!=\"\"){\r\n\t \t        document.getElementById(\"buidnumber\").options.length=1;//清空相应select\r\n\t\t\t\t for(var i = 1 ;i <=content;i++)\r\n\t\t\t\t {\r\n\t\t\t\t \t document.getElementById(\"buidnumber\").options.add(new Option(i,i)); \r\n\t\t\t\t }\r\n");
