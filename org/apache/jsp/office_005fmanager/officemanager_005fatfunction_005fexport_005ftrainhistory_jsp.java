...
public final class officemanager_005fatfunction_005fexport_005ftrainhistory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.system.vo.usermanager.TrainhistoryVO");
...
response.setHeader("Content-disposition", "attachment;filename="+new String("入职前培训经历".getBytes("GBK"),"iso8859-1")+".xls");

      out.write("\r\n<html>\r\n<head>\r\n    <title>导出</title>\r\n</head>\r\n<body>\r\n<table border=\"1\">\r\n    <tr>\r\n        <td align=\"center\"><b>姓名</b></td>\r\n        <td align=\"center\"><b>组织</b></td>\r\n        <td align=\"center\"><b>培训名称</b></td>\r\n        <td align=\"center\"><b>培训单位</b></td>\r\n        <td align=\"center\"><b>开始日期</b></td>\r\n        <td align=\"center\"><b>结束日期</b></td>\r\n        <td align=\"center\"><b>备注</b></td>\r\n    </tr>\r\n    ");
TrainhistoryVO empVO = null;
    Object[] empObj = null;
	String empName = "";
    String orgName = "";
    DateFormat df = DateFormat.getDateInstance(DateFormat.LONG, Locale.CHINESE);
      ...
      try {
        ...
        // /office_manager/officemanager_atfunction_export_trainhistory.jsp(29,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("empList");
        // /office_manager/officemanager_atfunction_export_trainhistory.jsp(29,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("empList");
        // /office_manager/officemanager_atfunction_export_trainhistory.jsp(29,4) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        orgName = empObj[3]==null?"&nbsp;":empObj[3].toString();
            ...
            out.print(orgName);
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
            out.print(empVO.getTrainName()==null?"&nbsp;":empVO.getTrainName());
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
            out.print(empVO.getTrainUnit()==null?"&nbsp;":empVO.getTrainUnit());
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
            out.print(empVO.getBeginDate()==null?"&nbsp;":df.format(empVO.getBeginDate()));
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
            out.print(empVO.getEndDate()==null?"&nbsp;":df.format(empVO.getEndDate()));
            out.write("&nbsp;</td>\r\n            <td align=\"left\">");
            out.print(empVO.getTrainMemo()==null?"&nbsp;":empVO.getTrainMemo());
            out.write("&nbsp;</td>      \r\n        </tr>\r\n    ");
