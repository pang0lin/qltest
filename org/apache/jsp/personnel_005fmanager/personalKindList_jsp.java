...
public final class personalKindList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//} 
      ...
      try {
        ...
        // /personnel_manager/personalKindList.jsp(135,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("personalKindList");
        // /personnel_manager/personalKindList.jsp(135,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("personalKindList");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object personalKindList = null;
          ...
          personalKindList = (java.lang.Object) _jspx_page_context.findAttribute("personalKindList");
          do {
            out.write("\r\n\t\t");

		  obj = (Object[]) personalKindList;
		  index ++;
		  j++;
...
String pagerURL = "/jsoa/PersonalKindAction.do";
      out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
   ...
   if(deloff<0) deloff = 0;
      ...
      out.write("\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=\"/jsoa/PersonalKindAction.do?action=delete&kindId=\" + id + \"&pager.offset=");
      out.print(deloff);
      out.write("\";\r\n    }\r\n}\r\nfunction selectAll(obj){\r\n    if(document.all.kindId){\r\n        if(document.all.kindId.length){\r\n            for(var i = 0; i < document.all.kindId.length; i ++){\r\n                if(obj.checked){\r\n                    document.all.kindId[i].checked = true;\r\n                }else{\r\n                    document.all.kindId[i].checked = false;\r\n                }\r\n            }\r\n        }else{\r\n            if(obj.checked){\r\n                document.all.kindId.checked = true;\r\n            }else{\r\n                document.all.kindId.checked = false;\r\n            }\r\n        }\r\n    }\r\n}\r\nfunction batchDelete(){\r\n\r\n        if(checkboxIsChecked(document.all.kindId)){\r\n            var id = \"\";\r\n            if(document.all.kindId.length){\r\n                for(var i = 0; i < document.all.kindId.length; i ++){\r\n                    if(document.all.kindId[i].checked){\r\n                        id += document.all.kindId[i].value + \",\";\r\n                    }\r\n                }\r\n            }else{\r\n                if(document.all.kindId.checked){\r\n");
      out.write("                    id = document.all.kindId.value;\r\n                }\r\n            }\r\n            if(id.indexOf(\",\") > 0){\r\n                id = id.substring(0, id.length - 1);\r\n            }\r\n            if(confirm(\"确实要删除吗？\")){\r\n            window.location.href = \"/jsoa/PersonalKindAction.do?action=delete&kindId=\" + id + \"");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("\";;\r\n            }\r\n        }else{\r\n            alert(\"请选择要删除的记录！\");\r\n        }\r\n}\r\n\r\nfunction modify(id){\r\n    MM_openBrWindow('/jsoa/PersonalKindAction.do?action=load&kindId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("','','TOP=10,LEFT=10,scrollbars=YES,resizable=no,width=600,height=350')\r\n}\r\n\tfunction view(id){\r\n    MM_openBrWindow('/jsoa/PersonalKindAction.do?action=view&kindId=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
