...
public final class searchResult_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.oa.search.model.SearchTbModel");
    _jspx_imports_classes.add("com.js.oa.search.model.Page");
  }
...
SearchTbModel[] arrModel=searchPage.getArrmodel();
String keys=(String)request.getAttribute("keys");
String classSearch=(String)request.getAttribute("classSearch");
...
response.setDateHeader ("Expires", 0);
      ...
      try {
        ...
        // /search/searchResult.jsp(24,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_html_005fform_005f0.setAction("/SearchClient");
        int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
        if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n    <br/>\r\n\t<div align=\"center\">\r\n\t分类：\r\n     <select id=\"classSearch\" name=\"classSearch\">\r\n        <option value=\"allMessage\"></option>\r\n        <option value=\"receiveFile\"  ");
if("receiveFile".equals(classSearch)){ 
            out.write("selected");
}
            out.write(">收文管理</option>\r\n        <option value=\"sendFile\" ");
if("sendFile".equals(classSearch)){ 
            out.write("selected");
}
            out.write(">发文管理</option>\r\n        <option value=\"forum\" ");
if("forum".equals(classSearch)){ 
            out.write("selected");
}
            out.write(">公共信息</option>\r\n        <option value=\"information\" ");
if("information".equals(classSearch)){ 
            out.write("selected");
}
            out.write(">知识管理</option>\r\n        <option value=\"netdisk_file\" ");
if("netdisk_file".equals(classSearch)){ 
            out.write("selected");
}
            out.write(">个人文档</option>\r\n        <option value=\"coordination\" ");
if("coordination".equals(classSearch)){ 
            out.write("selected");
}
            out.write(">协同工作</option>\r\n        <option value=\"workFlow\" ");
if("workFlow".equals(classSearch)){ 
            out.write("selected");
}
            out.write(">工作流程</option>\r\n     </select>\r\n          &nbsp; &nbsp;关键词：<input id=\"keys\" type=\"text\" name=\"keys\" align=\"center\" onkeypress=\"enterkey()\" value=\"");
            out.print(keys);
            out.write("\"/>\r\n           <input type=\"button\" value=\"检索\" onclick=\"check();\"  /><br/>\r\n    </div>\r\n<table  cellpadding=\"0\" cellspacing=\"0\" width=\"98%\" height=\"100%\" border=\"0\">\r\n    ");
if(null!=arrModel&&arrModel.length!=0){ 
            out.write("\r\n    ");
for(int i=0;i<arrModel.length;i++){ 
    	SearchTbModel model=arrModel[i];
            ...
            out.print(model.url);
            out.write("\" target=\"_blank\" style=\"color:#003366; font-weight:bold; padding-bottom:10px;\">");
            out.print(model.title);
            out.write("</a>\r\n    </span>\r\n    </div>\r\n    </td>\r\n    </tr>\r\n   <tr valign=\"top\" >\r\n   <td  align=\"left\"  style=\"padding-bottom:8px;\" style=\"margin:0px 15px; border-bottom:1px dashed #666666\">\r\n    &nbsp;&nbsp;&nbsp;");
            out.print(model.content.toString().replace("null", ""));
            out.write("<br/>\r\n    <div style=\"color:green\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
            out.print(model.date);
            out.write("--全文检索</div>\r\n     </td>\r\n     </tr>\r\n   </table>\r\n   </td>\r\n   </tr>\r\n    ");
} 
            out.write("\r\n    ");
}else{ 
            out.write("\r\n    <div  align=\"center\">\r\n    对不起，您要查询的内容：");
            out.print(keys);
            out.write("，查询结果为0，请换其他的关键字试试！\r\n    </div>\r\n    ");
} 
            out.write("\r\n</table>\r\n   ");
if(searchPage.getMaxPage()!=1){
            out.write("\r\n\t<table width=\"703\" border=\"0\" align=\"left\" height=\"44\" style=\"font-size: 13px;\">\r\n \t<tr>\r\n    <td>\r\n\t  ");
String pagerURL = "/jsoa/SearchClient.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t    <table>\r\n\t    <tr>\r\n\t    <td>\r\n\t    一共查到<font color='red'>");
            out.print(searchPage.getMaxRowCount());
            out.write("</font>条与<font color='red'>");
            out.print(keys);
            out.write("</font>相关的结果。\r\n\t    </td>\r\n\t    </tr>\r\n\t    </table>\r\n\t ");
} 
            out.write("\r\n\r\n\t \r\n");
      ...
      out.write("\r\n</body>\r\n<script type=\"text/javascript\">\r\n\r\nfunction check(){\r\n\tvar keys=document.getElementById(\"keys\");\r\n\tif(null==keys.value||\"\"==keys.value){\r\n\t\talert(\"请先输入要检索的关键字！\");\r\n\t\tkeys.focus();\r\n\t\treturn;\r\n\t}\r\n\tdocument.forms[0].submit();\r\n}\r\nfunction enterkey(){ \r\n\te = event.keyCode; \r\n\tvar keys=document.getElementById(\"keys\");\r\n\tif(null==keys.value||\"\"==keys.value){\r\n\t\talert(\"请先输入要检索的关键字！\");\r\n\t\tkeys.focus();\r\n\t\tevent.returnValue= false; \r\n\t\treturn;\r\n\t}\r\n  \tif(e==13){\r\n       document.forms[0].submit();\r\n    } \r\n} \r\n\r\nfunction jump(){\r\n\tvar jumpPage=document.getElementById(\"jumpPage\");\r\n\tif(null==jumpPage.value||\"\"==jumpPage.value){\r\n\t\talert(\"请先输入要跳转到的页面！\");\r\n\t\tjumpPage.value=\"\";\r\n\t\tjumpPage.focus();\r\n\t\treturn;\r\n\t}\r\n\tif(jumpPage.value<1||jumpPage.value>");
      out.print(searchPage.getMaxPage());
      out.write("){\r\n\t\talert(\"对不起，您输入的页码范围不正确，请重新输入！\");\r\n\t\tjumpPage.value=\"\";\r\n\t\tjumpPage.focus();\r\n\t\treturn;\r\n\t}\r\n\tif (isNaN(jumpPage.value)){\r\n\t\talert(\"请输入数字!\");\r\n\t\tjumpPage.value=\"\";\r\n\t\tjumpPage.focus();\r\n\t\treturn;\r\n\t}\r\n\t\r\n\tdocument.forms[0].action=\"SearchClient.do?jumpPage=\"+jumpPage.value+\"&keys=");
      out.print(keys);
      out.write("\";\r\n\tdocument.forms[0].submit();\r\n}\r\nfunction gotoPage(pageNum) {\r\n\tdocument.forms[0].action=\"SearchClient.do?jumpPage=\"+pageNum+\"&keys=");
      out.print(keys);
      out.write("\";\r\n    document.forms[0].submit();\r\n\treturn true;\r\n}\r\n</script>\r\n</html>");
