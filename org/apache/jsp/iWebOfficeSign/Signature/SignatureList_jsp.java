...
String whereSQl= managerBD.getRightFinalWhere(userId,orgId,"03*15*86", "Signature.createOrg", "Signature.createEmp");
...
if("yes".equals(haveRight)){
      ...
      out.write("        <div class=\"tabPanelCenter\">主题词</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>      \r\n      ");
          ...
          DBstep.iDBManager2000 DbaObj=new DBstep.iDBManager2000();
           if (DbaObj.OpenConnection())
           {
             try
             {
			   ...
			   ResultSet result=DbaObj.ExecuteQuery("select SignatureID,UserName,MarkName,MarkType,useName from Signature where domain_id="+session.getAttribute("domainId")+" and (createEmp="+userId+" or ( "+whereSQl+" ))"+ "order by SignatureID desc") ;
               while ( result.next() )
               {
                String mSignatureID=result.getString("SignatureID");
        
      out.write("\r\n\t<tr align=\"center\">\r\n\t\t<td class=\"listTableLine2\" style=\"text-align: left;\">");
