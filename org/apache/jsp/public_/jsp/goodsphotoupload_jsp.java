...
public final class goodsphotoupload_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(fileSize/1000000>0){
 ...
 if(com.js.util.util.BrowserJudge.isMSIE(request)) { 
      ...
      out.write("\r\n\t\timg.addEventListener(\"readystatechange\",orsc,true);\r\n        img.addEventListener(\"error\",oe,true);\r\n\t\t");
}
      out.write("\r\n        \r\n        var fileValue=document.all.photo.value;\r\n        img.src=fileValue;\r\n        fileValue=fileValue.toLowerCase();\r\n        fileValue=fileValue.substring(fileValue.lastIndexOf(\".\")+1);\r\n        if(\"jpg,gif,bmp,png\".indexOf(fileValue)>=0){\r\n            var fileOffsetWidth=img.offsetWidth;\r\n            var fileOffsetHeight=img.offsetHeight;\r\n\t\t\tif(200<fileOffsetWidth || 25<fileOffsetHeight){\r\n                    if(!confirm(\"系统允许您上传的图片最大为200X25,而您上传的图片大小为\"+fileOffsetWidth+\"X\"+fileOffsetHeight+\",这将导致显示不正常!\\n您确定要上传吗?\")){\r\n                        return false;\r\n                    }\r\n            }\r\n        }else{\r\n            alert(\"您只能上传jpg,gif,bmp,png格式的图片!\");\r\n            return false;\r\n        }\r\n    }catch(e){\r\n        alert(e);\r\n    }\r\n}\r\nfunction oe()\r\n{\r\n}\r\nfunction orsc()\r\n{\r\n    if(img.readyState!=\"complete\")return false;\r\n}\r\n</script>\r\n");
