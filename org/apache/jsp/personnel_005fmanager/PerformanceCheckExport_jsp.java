...
public final class PerformanceCheckExport_jsp extends org.apache.jasper.runtime.HttpJspBase
...
response.setHeader("Content-disposition", "attachment;filename="+new String("员工绩效考核".getBytes("GBK"),"iso8859-1")+".xls");
...
int m = now.getMonth() + 1;
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n<head>\r\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=GBK\">\r\n</head>\r\n\r\n<body>\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"1\" cellpadding=\"0\" cellspacing=\"1\" >\r\n\t<tr align=\"center\">\r\n\t\t<td width=\"10%\" nowrap=\"nowrap\">年度</td>\r\n\t\t<td width=\"10%\">考核人</td>\r\n\t\t<td width=\"5%\"  nowrap=\"nowrap\">月份</td>\r\n\t\t<td width=\"10%\"  nowrap=\"nowrap\">总分</td>\r\n\t\t<td width=\"5%\" nowrap=\"nowrap\">加分</td>\r\n\t\t<td width=\"22%\" nowrap=\"nowrap\">加分理由</td>\r\n\t\t<td width=\"5%\" nowrap=\"nowrap\">扣分</td>\r\n\t\t<td width=\"22%\" nowrap=\"nowrap\">扣分理由</td>\r\n\t  </tr>\r\n\r\n\t\t");
		...
		String listClass="";
            ...
            try {
              ...
              // /personnel_manager/PerformanceCheckExport.jsp(47,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /personnel_manager/PerformanceCheckExport.jsp(47,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("list");
              // /personnel_manager/PerformanceCheckExport.jsp(47,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
