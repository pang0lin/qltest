...
public final class wf_005freturn_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String local = session.getAttribute("org.apache.struts.action.LOCALE").toString();
      ...
      out.write(".css\" rel=\"stylesheet\" type=\"text/css\" />\r\n<script src=\"/jsoa/js/js.js\" language=\"javascript\"></script>\r\n<SCRIPT language=\"javascript\" src=\"/jsoa/js/openEndow.js\"></SCRIPT>\r\n</head>\r\n\r\n<body scroll=\"no\" onload=\"resizeWin(500,400);\"  >\r\n<table  border=\"0\" cellpadding=\"0\" cellspacing=\"0\" id=\"pup_main\">\r\n  <tr>\r\n    <td id=\"pup_top\"><table width=\"100%\" height=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n      <tr>\r\n        <td><div id=\"pup_topright\">");
      if (_jspx_meth_bean_005fmessage_005f1(_jspx_page_context))
        return;
      out.write("</div></td>\r\n        <td id=\"pup_topleft\">&nbsp;</td>\r\n      </tr>\r\n    </table></td>\r\n  </tr>\r\n  <tr>\r\n    <td align=\"center\" valign=\"top\">\r\n\t\t<div id=\"pup_content\">\r\n\t\t  <table width=\"100%\" height=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n            <tr>\r\n              <td colspan=\"2\">\r\n\t\t\t  <select name=\"selectObject\" id=\"selectObject\" size=\"2\" style=\"width:100%;height:100%;\">\r\n\t\t\t\t ");

				  com.js.oa.jsflow.service.WorkFlowButtonBD bd = new com.js.oa.jsflow.service.WorkFlowButtonBD();
				  java.util.List list = bd.getReceiveActivityList(request.getParameter("tableId"),request.getParameter("recordId"),session.getAttribute("userId")+"");
      ...
      if (_jspx_meth_bean_005fmessage_005f3(_jspx_page_context))
        return;
      out.write("\" class=\"btnButton2font\" onclick=\"window.close();\" />\r\n    </label></td>\r\n  </tr>\r\n</table>\r\n</body>\r\n</html>\r\n<SCRIPT LANGUAGE=\"JavaScript\">\r\n<!--\r\n//保存\r\n\r\nfunction include_save(){\r\n\tif(document.all.selectObject.value==''){\r\n\t\talert(\"");
      out.print(Resource.getValue(local,"filetransact","file.slewithdrawstep"));
      out.write("\");\r\n\t\treturn;\r\n\t}\r\n\twindow.opener.document.all.receiveActivityId.value=document.all.selectObject.value.split(\",\")[0];\r\n\twindow.opener.document.all.receiveActivityName.value=document.all.selectObject.value.split(\",\")[1];\r\n\twindow.opener.document.all.receiveUserName.value=document.all.selectObject.value.split(\",\")[2];\r\n\tif(confirm(\"");
      out.print(Resource.getValue(local,"filetransact","file.confirmwithdraw1"));
      out.write("\"+window.opener.document.all.receiveActivityName.value+\"？\")){\r\n\t\twindow.close();\r\n\t\twindow.opener.include_returnSubmit();\r\n\t}\r\n}\r\n//-->\r\n</SCRIPT>");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/wf_return.jsp(9,7) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("filetransact");
      // /jsflow/wf_return.jsp(9,7) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/wf_return.jsp(20,35) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("filetransact");
      // /jsflow/wf_return.jsp(20,35) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/wf_return.jsp(50,46) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setBundle("filetransact");
      // /jsflow/wf_return.jsp(50,46) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/wf_return.jsp(51,46) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setBundle("common");
      // /jsflow/wf_return.jsp(51,46) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
