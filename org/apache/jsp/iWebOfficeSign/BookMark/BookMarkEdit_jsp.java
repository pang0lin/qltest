 ...
 * Generated at: 2023-01-06 10:08:38 UTC
...
public final class BookMarkEdit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
{
  String mSql="select BookMarkName from BookMarks where BookMarkID<>"+ mBookMarkID +" and BookMarkName='" + mBookMarkName + "' and domain_id="+(session.getAttribute("domainId")==null?"-1":session.getAttribute("domainId").toString());
  try
  {
