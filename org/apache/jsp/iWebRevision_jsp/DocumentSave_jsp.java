...
public final class DocumentSave_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  {
    String strSql = "Select * from Document where RecordID = '"+ RecordID +"'";
    ResultSet rs = null;
    rs = ObjConnBean.ExecuteQuery(strSql);
    if (rs.next()) {
       strSql = "update Document set DocNo='"+DocNo+"',UserName='"+UserName+"',Security='"+Security+"',Draft='"+Draft+"',`Check`='"+Check+"',";
       strSql = strSql + " Title='"+Title+"',CopyTo='"+CopyTo+"',Subject='"+Subject+"',Copies='"+Copies+"' where RecordID = '"+RecordID+"'";
       ObjConnBean.ExecuteUpdate(strSql);
    }else{
      java.sql.PreparedStatement prestmt=null;
      try
      {
        String Sql="insert into Document (RecordID,DocNo,UserName,Security,Draft,`Check`,Title,CopyTo,Subject,Copies,DateTime) values (?,?,?,?,?,?,?,?,?,?,?) ";
