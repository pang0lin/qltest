...
public final class subsidiarywork_005fbirthdaycard_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      try {
       ...
       String url="/jsoa/ChannelAction.do?action=view&channelType=1&userChannelName=公共信息&userDefine=1&publicinfo=1";
            ...
            try {
              ...
              // /subsidiary_work/subsidiarywork_birthdaycard.jsp(116,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/BirthCardAction.do");
              // /subsidiary_work/subsidiarywork_birthdaycard.jsp(116,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n\t\t<tr align=\"center\" valign=\"middle\">\r\n\t\t\t<td width=\"40\" height=\"27\" class=\"listTableHead\" nowrap><input type=\"checkbox\" name=\"chkSelect\" style=\"cursor:'hand'\" onclick=\"selectAll(this)\"></td>\r\n\t\t\t<td width=\"46%\" class=\"listTableHead\"> 祝福语 </td>\r\n\t\t\t<td class=\"listTableHead\"> 送给 </td>\r\n\t\t\t<td width=\"8%\" class=\"listTableHeadLast\" nowrap> 处理 </td>\r\n\t\t\t</tr>\r\n\r\n\t\t");
                  //  logic:iterate
                  ...
                  try {
                    ...
                    // /subsidiary_work/subsidiarywork_birthdaycard.jsp(124,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("mylist");
                    // /subsidiary_work/subsidiarywork_birthdaycard.jsp(124,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("mylist");
                    // /subsidiary_work/subsidiarywork_birthdaycard.jsp(124,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(index%2 != 0){listClass="listTableLine2";}
                        ...
                        out.write("\">\r\n\t\t\t\t</td>\r\n\t\t\t\t<td  class=\"");
                        out.print(listClass);
                        out.write("\" align=\"left\">\r\n\t\t\t\t<span onclick=\"MM_openBrWindow('/jsoa/BirthCardAction.do?viewflg=1&action=load&editId=");
                        out.print(obj[0]);
                        out.write("&pager.offset=");
                        out.print(offset1);
                        out.write("','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=720,height=450')\">\r\n\t\t\t\t<a href=\"javascript:void(0);\">\r\n\t\t\t\t");
                        out.print((obj[1]==null || "".equals(obj[1].toString()))?"&nbsp;":(com.js.util.util.CharacterTool.escapeHTMLTags(obj[1]+"")));
                        out.write("\r\n\t\t\t\t</a></span></td>\r\n\t\t\t\t<td class=\"");
                        out.print(listClass);
                        out.write("\" align=\"left\">\r\n\t\t\t\t");
				...
				if(obj[2]!=null && !"".equals(obj[2].toString()))  out.print(obj[2]) ; else out.print("&nbsp;") ;
                        ...
                        out.write("\r\n\t\t\t\t</td>\r\n\t\t\t\t<td class=\"");
                        out.print(listClass);
                        out.write(" listTableLineLastTD\">\r\n\t\t\t\t\t<img  style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" alt=\"修改\" onclick=\"MM_openBrWindow('/jsoa/BirthCardAction.do?action=load&editId=");
                        out.print(obj[0]);
                        out.write("&pager.offset=");
                        out.print(offset1);
                        out.write("','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=720,height=450')\" >&nbsp;\r\n\t\t\t\t\t<img  style=\"cursor:pointer\" border=\"0\" src=\"images/del.gif\" alt=\"删除\" onclick=\"del('");
                        out.print(obj[0]);
                        out.write("')\" >&nbsp;\r\n\t\t\t\t\t<img  style=\"cursor:pointer\" border=\"0\" src=\"images/readme.gif\" alt=\"预览\" onclick=\"previews('");
                        out.print(obj[0]);
                        out.write("')\" >\r\n\t\t\t\t&nbsp;</td>\r\n\t\t\t</tr>\r\n\t\t");
...
String pagerURL = "/jsoa/BirthCardAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n\r\n//全部删除\r\nfunction delAll() {\r\n     if(confirm(\"确实要全部删除吗？\")){\r\n         window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/BirthCardAction.do?action=delAll\";\r\n    }\r\n}\r\n\r\n//批量删除\r\nfunction delBatch() {\r\n    var ids = getCheckBoxID();\r\n    if(ids == \"\") {\r\n        alert(\"没有选择记录！\") ;\r\n    }else {\r\n     if(confirm(\"确实要删除吗？\")){\r\n        var countRecordCount = \"");
      out.print(countRecordCount);
      out.write("\" ;\r\n        var offset1 = parseInt(\"");
      out.print(offset1);
      out.write("\") ;\r\n        var idsArr = ids.split(\",\")  ;\r\n        var moveoffset = idsArr.length-1 ;\r\n        moveoffset = countRecordCount == moveoffset ? offset1 -15 :offset1 ; //得到符合条件的offset,来处理临界的情况\r\n        moveoffset = moveoffset < 0 ? 0 :moveoffset ;\r\n        window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/BirthCardAction.do?action=delBatch&ids=\"+ids+\"&pager.offset=\"+moveoffset ;\r\n     }\r\n    }\r\n }\r\n\r\n//单个删除\r\nfunction del(id) {\r\n      ");

     int deloffset =  countRecordCount == 1 ? offset1-15:offset1 ;
     deloffset = deloffset < 0 ? 0 : deloffset ;
     
      out.write("\r\n     if(confirm(\"确实要删除吗？\")){\r\n         window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/BirthCardAction.do?action=delBatch&ids=\"+id+\",&pager.offset=");
      out.print(deloffset);
      out.write("\" ;\r\n    }\r\n }\r\n\r\n//全选|全除\r\nfunction selectAll(obj) {\r\n    if(obj.checked) {\r\n    \tfor(var i = 0 ; i < BirthCardActionForm.length ; i++ ) {\r\n        \tvar chkObj = BirthCardActionForm[i] ;\r\n        \t if(chkObj.type == \"checkbox\"){\r\n\t\t\tif(chkObj!=obj) {\r\n                              chkObj.checked = true ;\r\n\t\t\t}\r\n        \t }\r\n   \t }\r\n    }else {\r\n            for(var i = 0 ; i < BirthCardActionForm.length ; i++ ) {\r\n                var chkObj = BirthCardActionForm[i] ;\r\n                 if(chkObj.type == \"checkbox\"){\r\n                        if(chkObj!=obj) {\r\n                              chkObj.checked = false ;\r\n                        }\r\n                 }\r\n   \t }\r\n    }\r\n}\r\n\r\nfunction getCheckBoxID() {\r\n    var retString=\"\" ;\r\n    for(var i = 0 ; i < BirthCardActionForm.length ; i++ ) {\r\n        var obj = BirthCardActionForm[i] ;\r\n         if(obj.type == \"checkbox\"){\r\n\t\tif(obj.checked&&BirthCardActionForm.chkSelect!=obj) {\r\n                \tretString += obj.value  ;\r\n                        retString += \",\" ;\r\n");
      out.write("\t\t}\r\n         }\r\n    }\r\n    return retString ;\r\n}\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\n\r\nfunction previews(obj){\r\n\twindow.open(\"/jsoa/subsidiary_work/subsidiarywork_preview.jsp?wishCard=\"+obj);\r\n}\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
