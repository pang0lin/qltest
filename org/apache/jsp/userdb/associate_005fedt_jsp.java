...
public final class associate_005fedt_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getParameter("close") != null){
	...
	String prytid = request.getParameter("prytid");
	String pryfid = request.getParameter("pryfid");
	...
	if(request.getParameter("state") != null)
		out.print("<script>alert(\"已经存在该关联\");</script>");
            ...
            try {
              ...
              // /userdb/associate_edt.jsp(65,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/AssociateEdtAction.do");
              // /userdb/associate_edt.jsp(65,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.print(lid);
                  out.write(">\r\n <input type=\"hidden\" name=\"limitpryfield\" value=");
                  out.print(pryfid);
									...
									if(pryFieldList!=null){
										for(int j=0; j<pryFieldList.length; j++){
											if(pryFieldList[j][0]!=null && pryFieldList[j][0].equals(tbid)){
												out.print("<option value=\""+pryFieldList[j][1]+"\"");
												if(pryfid.equals(pryFieldList[j][1])){
													out.print(" selected='selected' ");
												}
												out.print(">"+pryFieldList[j][2]+"</option>");
											}
										}
									}
									out.print("</select>");
