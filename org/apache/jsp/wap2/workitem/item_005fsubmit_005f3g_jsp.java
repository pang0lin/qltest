...
public final class item_005fsubmit_005f3g_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String[] para = {mainNextActivityName,mainNextActivityId,workId,mainDeadLineTime,mainPressMotionTime,
                ...
                activityClass,subProcType, docTitle, emergence,nextTransactType,dealTips};
...
if(result.intValue() < 0){
    ...
    if(request.getParameter("mainNeedPassRound") != null && !"".equals(request.getParameter("passRoundName"))){
    	...
    	workLogVO.setSendUserId(userId);
        workLogVO.setSendUserName(userName);
        workLogVO.setSendAction("送"+mainNextActivityName+"阅件");
        //workLogVO.setReceiveUserId(mainTransactUser+"");
