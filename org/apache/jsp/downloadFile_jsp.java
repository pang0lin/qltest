...
try{
	...
	//System.out.println(_queryString);
	if(request.getAttribute("queryString")!=null)  _queryString = request.getAttribute("queryString")+"";
	//System.out.println(com.js.util.util.BASE64.BASE64DecoderNoBR(_queryString));
	String[] queryString = com.js.util.util.BASE64.BASE64DecoderNoBR(_queryString).split("&");
	
	String filedownload = queryString[0];
	String name = queryString[1];
	
	if(filedownload.indexOf("./")>=0 || filedownload.indexOf(".\\")>=0){
