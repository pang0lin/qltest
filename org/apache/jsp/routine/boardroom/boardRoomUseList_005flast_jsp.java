...
public final class boardRoomUseList_005flast_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.oa.routine.boardroom.po.BoardRoomApplyTypePO");
...
response.setDateHeader ("Expires", 0);
        ...
        pageSize = Integer.parseInt(request.getAttribute("maxPageItems").toString());
	  	...
	  	String statusOrder = request.getParameter("orderbystatus");
        if (statusOrder == null)
        	statusOrder = "1";
        else if ("0".equals(statusOrder))
               statusOrder = "1";
        else statusOrder = "0";

        String timeOrder = request.getParameter("orderbytime");
        if (timeOrder == null)
        	timeOrder = "1";
        else if ("0".equals(timeOrder))
               timeOrder = "1";
        else timeOrder = "0";
	...
	if(request.getAttribute("boardroomApplyType") !=null){
		boardroomApplyType = request.getAttribute("boardroomApplyType").toString();
            ...
            out.write("\r\n<body   class=\"MainFrameBox\" onKeyDown=\"if(event.keyCode==13) search();\" onload=\"document.all.boardroomApplyType.value='");
            out.print(boardroomApplyType);
            ...
            try {
              ...
              // /routine/boardroom/boardRoomUseList_last.jsp(79,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/BoardRoomAction.do?action=boardRoomUseSearch");
              // /routine/boardroom/boardRoomUseList_last.jsp(79,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("post");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n\t<tr>\r\n\t\t<td height=\"25\" >\r\n\t\t\t会议室名称：\r\n\t\t\t  <input name=\"searchBoardRomeName\" onKeyPress=\"return look() ;\" onKeyUp=\"value=checkQuery(this,'会议室名称')\" onBlur=\"value=checkQuery1(this,'会议室名称')\" type=\"text\" maxlength=\"15\" size=\"16\" class=\"inputText\" onKeyDown=\"if(event.keyCode==13) search();\" value='");
                  out.print(request.getParameter("searchBoardRomeName")!=null?request.getParameter("searchBoardRomeName"):"");
                  out.write("'/>\r\n                  &nbsp;主持人：<input name=\"searchBoardRomeEmcee\" onKeyPress=\"return look() ;\" onKeyUp=\"value=checkQuery(this,'主持人')\" onBlur=\"value=checkQuery1(this,'主持人')\" type=\"text\" maxlength=\"15\" size=\"16\" class=\"inputText\" onKeyDown=\"if(event.keyCode==13) search();\" value='");
                  out.print(request.getParameter("searchBoardRomeEmcee")!=null?request.getParameter("searchBoardRomeEmcee"):"");
                  out.write("'/>\r\n        </td>\r\n\t\t<td >会议主题：&nbsp;&nbsp;\r\n\t    <input name=\"searchBoardRomeMotif\"  onkeypress=\"return look() ;\" onKeyUp=\"value=checkQuery(this,'会议主题')\" onBlur=\"value=checkQuery1(this,'会议主题')\"  type=\"text\"  maxlength=\"40\" size=\"42\" class=\"inputText\" onKeyDown=\"if(event.keyCode==13) search();\" value='");
                  out.print(request.getParameter("searchBoardRomeMotif")!=null?request.getParameter("searchBoardRomeMotif"):"");
                  out.write("'/></td>\r\n\t</tr>\r\n\t<tr>\r\n\t<td height=\"25\" colspan=\"2\" >\r\n\t\t\t申请人：&nbsp;&nbsp;&nbsp;&nbsp;\r\n\t\t\t  <input name=\"searchApplyName\" onKeyPress=\"return look() ;\" onKeyUp=\"value=checkQuery(this,'申请人')\" onBlur=\"value=checkQuery1(this,'申请人')\" type=\"text\" maxlength=\"15\" size=\"16\" class=\"inputText\" onKeyDown=\"if(event.keyCode==13) search();\" value='");
                  out.print(request.getParameter("searchApplyName")!=null?request.getParameter("searchApplyName"):"");
                  out.write("'/>\r\n                  &nbsp;会议类型：<select name=\"boardroomApplyType\" >\r\n                                <option value=\"0\">请选择</option>\r\n                                ");
                  //  logic:iterate
                  ...
                  try {
                    ...
                    // /routine/boardroom/boardRoomUseList_last.jsp(95,32) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("List");
                    // /routine/boardroom/boardRoomUseList_last.jsp(95,32) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("boardroomApplyTypeList");
                    // /routine/boardroom/boardRoomUseList_last.jsp(95,32) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
Object[] obj = (Object[]) List;
                  ...
                  out.write("\r\n\t\t\t\t\t\t\t\t</select>\r\n        </td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td height=\"25\">预定日期：&nbsp;&nbsp;\r\n\t\t  <script language=javascript>\r\n\t\t\t\tvar searchStartDate = createDatePicker(\"searchStartDate\");\r\n\t\t   </script> 至\r\n\t\t   <script language=javascript>\r\n\t\t\t\tvar searchEndDate = createDatePicker(\"searchEndDate\");\r\n\t\t   </script>\r\n            <input type=\"checkbox\" value=\"1\" name=\"searchDatecheckbox\" ");
if ("1".equals(request.getParameter("searchDatecheckbox"))) {
                  out.write("checked");
}
                  out.write(" style=\"cursor:pointer\">\r\n\t    </td>\r\n\t\t<td align=\"right\">\r\n\t\t<input type=\"button\" class=\"btnButton2Font\" onClick=\"search();\" value=\"查询\" />\r\n\t\t<input type=\"button\" class=\"btnButton2Font\" onClick=\"cleared();\" value=\"重置\" /></td>\r\n\r\n\t</tr>\r\n\t\t<input type=\"hidden\" name=\"saveType\" value=\"boardRoomUseSearch\">\r\n\t");
            ...
            out.write("\r\n</table>\r\n\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n  <tr>\r\n  <td>\r\n\t    <div id=\"PanleDIV0\" class=\"tabPanelSelected\" onClick=\"changePanle('0');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">最近会议</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n      <div class=\"btnBQspace AlignLeft\"></div>    \r\n\t    <div id=\"PanleDIV3\" class=\"tabPanel\" onClick=\"changePanle('1');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">全部会议</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div></td>\r\n    <td height=\"18\" align=\"right\">\r\n\t\t<input type=\"button\" id=\"hiddenSearch\"  class=\"btnButton4Font\" onClick=\"hidserch()\" value=\"查询\" />\r\n\t\t</td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\t<form  name=\"form1\" method=\"post\">\r\n\t<tr>\r\n\t   <td class=\"listTableHead\" width=\"23%\">会议主题</td>\r\n\t    <td  class=\"listTableHead\" width=\"18%\">会议时间<a href=\"javascript:orderby('/jsoa/BoardRoomAction.do?action=boardRoomUseSearch&orderbytime=");
            out.print(timeOrder);
            out.write("')\">");
if(request.getParameter("orderbytime")==null){
            out.write("\r\n\t<img src=\"/jsoa/images/blanksort.gif\" border=\"0\" alt=\"按会议时间排序\">\r\n\t");
}else if("1".equals(timeOrder)){
            out.write("\r\n\t<img src=\"/jsoa/images/downsort.gif\" border=\"0\" alt=\"按会议时间排序\">\r\n\t");
}else if("0".equals(timeOrder)){
            out.write("\r\n\t<img src=\"/jsoa/images/upsort.gif\" border=\"0\" alt=\"按会议时间排序\">\r\n\t");
}
            out.write("</a></td>\r\n\t\t<td class=\"listTableHead\" width=\"15%\">会议室名称<a href=\"javascript:orderby('/jsoa/BoardRoomAction.do?action=boardRoomUseSearch&orderbystatus=");
            out.print(statusOrder);
            out.write("')\">");
if(request.getParameter("orderbystatus")==null){
            out.write("\r\n\t<img src=\"/jsoa/images/blanksort.gif\" border=\"0\" alt=\"按会议室名称排序\">\r\n\t");
}else if("1".equals(statusOrder)){
            out.write("\r\n\t<img src=\"/jsoa/images/downsort.gif\" border=\"0\" alt=\"按会议室名称排序\">\r\n\t");
}else if("0".equals(statusOrder)){
            out.write("\r\n\t<img src=\"/jsoa/images/upsort.gif\" border=\"0\" alt=\"按会议室名称排序\">\r\n\t");
}
            out.write("</a></td>\r\n\t\t<td  class=\"listTableHead\" width=\"8%\">类型</td>\r\n\t\t<td  class=\"listTableHead\" width=\"8%\">申请人</td>\r\n\t\t<td  class=\"listTableHead\" width=\"20%\">申请组织</td>\r\n\t\t<td  class=\"listTableHeadLast\" width=\"8%\">处理</td>\r\n\t</tr>\r\n\t");
	...
	SimpleDateFormat timeFormat = new SimpleDateFormat("HH:mm");
		...
		if(request.getParameter("pager.offset")!=null){
            ...
            try {
              ...
              // /routine/boardroom/boardRoomUseList_last.jsp(175,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setId("List");
              // /routine/boardroom/boardRoomUseList_last.jsp(175,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setName("boardroomUseList");
		...
		Object[] obj = (Object[]) List;
		Long boardroomId = Long.parseLong(obj[1].toString());
		
		if(obj[8] !=null && !"".equals(obj[8].toString())){
			beginHours = String.valueOf(Integer.parseInt(obj[8].toString())/3600);
			beginMinutes = String.valueOf((Integer.parseInt(obj[8].toString())-(Integer.parseInt(obj[8].toString())/3600 * 3600))/60);
		...
		if(obj[9] !=null && !"".equals(obj[9].toString())){
			endHours = String.valueOf(Integer.parseInt(obj[9].toString())/3600);
			endMinutes = String.valueOf((Integer.parseInt(obj[9].toString())-(Integer.parseInt(obj[9].toString())/3600 * 3600))/60);
...
if(obj[11] !=null && !"".equals(obj[11].toString())){
                  ...
                  out.print(listClass);
                  out.write("\">\r\n\t\t");
if(Long.valueOf(obj[20]+"")/(1000*3600*24)==Long.valueOf(obj[19]+"")/(1000*3600*24)){ 
                  out.write("\r\n\t\t");
                  out.print(dateFormat.format(new Date(Long.valueOf(obj[19]+"")))  );
                  out.write(" -\r\n\t\t");
                  out.print(timeFormat.format(new Date(Long.valueOf(obj[20]+"")))  );
                  out.write("\r\n\t\t");
}else{ 
                  out.write("\r\n\t\t");
                  out.print(dateFormat.format(new Date(Long.valueOf(obj[19]+"")))  );
                  out.write(" -\r\n\t\t");
                  out.print(dateFormat.format(new Date(Long.valueOf(obj[20]+"")))  );
} 
                  out.write("\r\n\t\t</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(((BoardRoomApplyTypePO)obj[12]).getType());
                  out.write("</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
if(obj[4] !=null && !"".equals(obj[5].toString())){
                  out.print(obj[5]);
}else{
                  out.write("&nbsp;");
}
...
if(maintenanceBoardRoomIds.indexOf(obj[1].toString())>=0){
                  out.write("\r\n\t\t");
if("0".equals(obj[15].toString())){ 
                  ...
                  out.write("')\">\r\n\t\t");
if("0".equals(obj[15].toString())){
                  out.write("\r\n\t\t&nbsp;<img  style=\"cursor:pointer\" border=\"0\" src=\"images/cxtj.gif\" alt=\"结束\" \r\n\t\t\t\tonclick=\"finish('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
		...
		if(("$"+obj[13]+"$"+obj[17]+obj[18]).contains("$"+session.getAttribute("userId")+"$")&&"0".equals(obj[15].toString())){
                  out.write("\r\n\t\t&nbsp;<img  style=\"cursor:pointer\" border=\"0\" src=\"images/cxtj.gif\" alt=\"结束\" \r\n\t\t\t\tonclick=\"finish('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
		 ...
		 if(("$"+obj[13]+"$"+obj[17]+obj[18]).contains("$"+session.getAttribute("userId")+"$")&&!"0".equals(obj[15].toString())){
                  out.write("\r\n\t\t &nbsp;<img  style=\"cursor:pointer\" border=\"0\" src=\"images/sj.gif\" alt=\"添加纪要\" onclick=\"summary('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
            ...
            out.print(pageSize);
            out.write("\">\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"pagebar\">\r\n\t<tr>\r\n\t<td style=\"width:300px\"><font color=\"#24514C\">*注：最近会议显示30天内的会议</font>&nbsp;</td>\r\n\t\t<td>");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n</tr>\r\n</table>\r\n<iframe name=\"myIframe\" id=\"myIframe\" style=\"display:none\"></iframe>\r\n</body>\r\n<script language=\"javascript\">\r\nfunction search(){\r\n    //\tdocument.BoardRoomActionForm.submit();\r\n    var hhref = \"&searchBoardRomeName=\"+document.all.searchBoardRomeName.value+\"&searchBoardRomeEmcee=\"+document.all.searchBoardRomeEmcee.value+\"&searchBoardRomeMotif=\"+document.all.searchBoardRomeMotif.value+\"&searchApplyName=\"+document.all.searchApplyName.value+\"&boardroomApplyType=\"+document.all.boardroomApplyType.value+\"&searchStartDate=\"+document.all.searchStartDate.value+\"&searchEndDate=\"+document.all.searchEndDate.value;\r\n\tif(document.all.searchDatecheckbox.checked){\r\n    hhref += \"&searchDatecheckbox=1\";\r\n\t}\r\n\twindow.location.href=\"/jsoa/BoardRoomAction.do?action=boardRoomUseSearch&saveType=boardRoomUseSearch\"+hhref;\r\n}\r\n\r\nfunction cleared(){\r\n    window.location.href=\"/jsoa/BoardRoomAction.do?action=useBoardroomView\";\r\n}\r\n\r\nfunction view(id,name,meetingId,statusa){\r\n\tMM_openBrWindow('BoardRoomAction.do?action=selectBoardroomApplyView&boardroomApplyId='+id+'&boardroomName='+name+'&type=view&isView=true&meetingId='+meetingId+'&executeStatus=true&statusa='+statusa,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=580')\r\n");
            out.write("}\r\n\r\nfunction modify(id,name){\r\n\tMM_openBrWindow('BoardRoomAction.do?action=selectBoardroomApplyModify&boardroomApplyId='+id+'&boardroomName='+name+'&type=view','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=580')\r\n}\r\nfunction summary(id,name,meetingId,statusa){\r\n\twindow.open('BoardRoomAction.do?action=openSummary&type=update&boardroomApplyId='+id+'&boardroomName='+name+'&viewType=view&isView=true&meetingId='+meetingId+'&executeStatus=true&statusa='+statusa);\r\n}\r\n\r\nfunction cancel(id){\r\n\t ");
 int  deloff = j==1? pageSize2-15:pageSize2;
         if(deloff<0) deloff =0 ;
     
            out.write("\r\n\tif(confirm(\"确实要删除这次申请吗？\")){ \r\n\t\twindow.open(\"/jsoa/BoardRoomAction.do?action=cancelBoardroomApply&flag=deleteMeeting&boardroomApplyId=\"+id+\"&pager.offset=\"+");
            out.print(deloff);
            out.write(",\"myIframe\");\r\n\t\t//window.location.href=\"/jsoa/BoardRoomAction.do?action=cancelBoardroomApply&flag=&boardroomApplyId=\"+id+\"&pager.offset=\"+");
            out.print(deloff);
            out.write(";\r\n    }\r\n}\r\n\r\nfunction orderby(url){\r\n\tdocument.BoardRoomActionForm.action = url;\r\n\tdocument.BoardRoomActionForm.submit();\r\n}\r\n\r\nfunction finish(id, id2, name, meetingDate, startTime, endTime,boardroomId,emproomtype,beginDate,endDate){\r\n\tif(confirm(\"确实要结束这次会议吗？\")){\r\n\t\t//parent.document.all.MainDesktop.src = '/jsoa/routine/boardroom/boardRoomApply_finish.jsp?boardroomApplyId='+id+'&meetingId='+id2+'&name='+name+'&meetingDate='+meetingDate+'&startTime='+startTime+'&endTime='+endTime+'&boardroomId='+boardroomId ;\r\n\t\tMM_openBrWindow('/jsoa/routine/boardroom/boardRoomApply_finish.jsp?boardroomApplyId='+id+'&meetingId='+id2+'&name='+name+\r\n\t\t\t\t'&meetingDate='+meetingDate+'&startTime='+startTime+'&endTime='+endTime+'&boardroomId='+boardroomId\r\n\t\t\t\t+'&emproomtype='+emproomtype+'&beginDateL='+beginDate+'&endDateL='+endDate,'','TOP=0,LEFT=0,scrollbars=yes,resizable=no,width=450,height=250')\r\n\t}\r\n}\r\nfunction hidserch()\r\n{    \r\n     var stable=document.getElementById(\"searchBar\");\r\n     var sbutton=document.getElementById(\"hiddenSearch\");\r\n");
            out.write("     if(stable.style.display==\"none\")\r\n     {\r\n      stable.style.display=\"\";\r\n      sbutton.value=\"关闭查询\";\r\n      \r\n     }else{\r\n     stable.style.display=\"none\";\r\n     sbutton.value=\"查询\";\r\n     \r\n     }\r\n}\r\nfunction changePanle(flag){\r\n\tif(\"0\"==flag){//最近会议\r\n\t\tlocation.href=\"/jsoa/BoardRoomAction.do?action=useBoardroomView\"\r\n\t}else{//全部\r\n\t\tlocation.href=\"/jsoa/BoardRoomAction.do?action=useBoardroomView&flag=all\"\r\n\t}\r\n}\r\n</script>\r\n");
