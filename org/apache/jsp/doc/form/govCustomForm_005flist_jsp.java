...
public final class govCustomForm_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String govFormType=request.getParameter("govFormType")==null?"":request.getParameter("govFormType").toString();
String govFormName=request.getParameter("govFormName")==null?"":request.getParameter("govFormName").toString();
govFormType=java.net.URLDecoder.decode(govFormType,"UTF-8");
govFormName=java.net.URLDecoder.decode(govFormName,"UTF-8");
...
if(!"1".equals(govFormType)){ 
      ...
      if(showTag){
            ...
            if (_jspx_meth_bean_005fmessage_005f0(_jspx_th_html_005fhtml_005f0, _jspx_page_context))
              return;
            out.write("</button>\r\n\t    <button class=\"btnButton4font\" onClick=\"chSearch(this)\" value=\"查询\">查询</button>\r\n\t</td>\r\n  </tr>\r\n</table>\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n     <input type=\"hidden\" name=\"action\" value=\"\">\r\n     \t<tr align=\"center\">\r\n\t\t\t<td class=\"listTableHead\">表单名称</td>\r\n\t\t <!--  <td width=\"30%\" class=\"listTableHead\">关联数据表</td> -->\r\n\t\t  <td width=\"10%\" class=\"listTableHead\">显示模版</td>\r\n\t\t  <td width=\"10%\" class=\"listTableHead\">打印模版</td>\r\n\t\t  <td width=\"8%\" nowrap class=\"listTableHead\">操作</td>\r\n\t </tr>\r\n\r\n\t ");
	 ...
	 String listClass="listTableLine1";
            ...
            try {
              ...
              // /doc/form/govCustomForm_list.jsp(195,5) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("mylist");
              // /doc/form/govCustomForm_list.jsp(195,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("mylist");
              // /doc/form/govCustomForm_list.jsp(195,5) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
//=obj[0]
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(obj[1]==null?"&nbsp":obj[1].toString());
                  out.write("</td>\r\n\t\t<!-- <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  ...
                  out.write("</td> -->\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"><a href=\"javascript:void(0);\" onclick=\"javascript:moder('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
                  ...
                  if (_jspx_meth_html_005fimg_005f0(_jspx_th_logic_005fiterate_005f0, _jspx_page_context))
                    return;
                  out.write("</a>&nbsp;<a href=\"javascript:void(0);\" onclick=\"javascript:if(confirm('确定删除吗?')) {del('");
                  out.print(obj[0]);
                  out.write('\'');
                  out.write(',');
                  out.write('\'');
...
String pagerURL = "/jsoa/GovCustomAction.do";
            out.write("\r\n\t\t \t");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.print(offset1);
      out.write("\") ;\r\n            var idsArr = ids.split(\",\")  ;\r\n            var moveoffset = idsArr.length-1 ;\r\n            moveoffset = countRecordCount == moveoffset ? offset1 -15 :offset1 ; //得到符合条件的offset,来处理临界的情况\r\n            moveoffset = moveoffset < 0 ? 0 :moveoffset ;\r\n            var hhref  = \"/jsoa/GovCustomAction.do?action=del\" ;\r\n\t\r\n\t\t\tids=ids.substring(0,ids.length-1);\r\n            hhref +=\"&ids=\"+ids ;\r\n            hhref +=\"&pager.offset=\"+moveoffset ;\r\n            window.location.href = hhref ;\r\n         }\r\n    }\r\n }\r\n\r\n //单个删除\r\nfunction del(id,formId,govFormType) { \r\n        var hhref  = \"/jsoa/GovCustomAction.do?action=del\" ;\r\n            hhref +=\"&ids=\"+id+\"&formId=\"+formId+\"&govFormType=\"+govFormType  ;\r\n        window.location.href = hhref ;\r\n }\r\n\r\n //全选|全除\r\nfunction selectAll(obj) {\r\n    if(obj.checked) {\r\n    \tfor(var i = 0 ; i < GovCustomActionForm.length ; i++ ) {\r\n        \tvar chkObj = GovCustomActionForm[i] ;\r\n        \t if(chkObj.type == \"checkbox\"){\r\n\t\t\tif(chkObj!=obj&&!chkObj.disabled) {\r\n                              chkObj.checked = true ;\r\n");
      out.write("\t\t\t}\r\n        \t }\r\n   \t }\r\n    }else {\r\n            for(var i = 0 ; i < GovCustomActionForm.length ; i++ ) {\r\n                var chkObj = GovCustomActionForm[i] ;\r\n                 if(chkObj.type == \"checkbox\"){\r\n                        if(chkObj!=obj) {\r\n                              chkObj.checked = false ;\r\n                        }\r\n                 }\r\n   \t }\r\n    }\r\n}\r\nfunction getCheckBoxID() {\r\n    var retString=\"\" ;\r\n    for(var i = 0 ; i < GovCustomActionForm.length ; i++ ) {\r\n        var obj = GovCustomActionForm[i] ;\r\n         if(obj.type == \"checkbox\"&&obj!=GovCustomActionForm.chkSelect){\r\n\t\tif(obj.checked) {\r\n                \tretString += obj.value  ;\r\n                        retString += \",\" ;\r\n\t\t}\r\n         }\r\n    }\r\n    return retString ;\r\n}\r\n\r\nfunction  loadInfo(id){\r\n    var hhref = \"/jsoa/GovCustomAction.do?action=load&record=\"+id+\"&saveType=loadType\" ;\r\n    window.open(hhref,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600') ;\r\n\r\n\r\n}\r\nfunction fff(){\r\n\talert(\"333\");\r\n}\r\n\r\n");
      out.write("function  query(){\r\n\twindow.location.href=encodeURI(encodeURI(\"/jsoa/GovCustomAction.do?action=list&govFormType=");
      out.print(govFormType);
      out.write("&govFormName=\"+document.all.govFormName.value));  \r\n}\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\n/* function chSearch(obj){\r\n\tif(obj.value == \"查询\"){\r\n\t\tobj.value = \"关闭查询\";\r\n\t\tdocument.all.searchTable.style.display=\"\";\r\n\t}else{\r\n\t\tobj.value = \"查询\";\r\n\t\tdocument.all.searchTable.style.display=\"none\";\r\n\t}\r\n} */\r\n\tfunction chSearch(obj){\r\n\tif(obj.value == \"查询\"){\r\n\t\tobj.value = \"关闭查询\";\r\n\t\tobj.innerHTML=\"关闭查询\";\r\n\t\tdocument.all.searchTable.style.display=\"\";\r\n\t}else{\r\n\t\tobj.value = \"查询\";\r\n\t\tobj.innerHTML=\"查询\";\r\n\t\tdocument.all.searchTable.style.display=\"none\";\r\n\t}\r\n}\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/form/govCustomForm_list.jsp(177,55) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("common");
      // /doc/form/govCustomForm_list.jsp(177,55) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fimg_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/form/govCustomForm_list.jsp(215,104) name = border type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f0.setBorder("0");
      // /doc/form/govCustomForm_list.jsp(215,104) name = src type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f0.setSrc("/jsoa/images/modi.gif");
      // /doc/form/govCustomForm_list.jsp(215,104) name = alt type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fimg_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/form/govCustomForm_list.jsp(215,296) name = border type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f1.setBorder("0");
      // /doc/form/govCustomForm_list.jsp(215,296) name = src type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fimg_005f1.setSrc("/jsoa/images/del.gif");
      // /doc/form/govCustomForm_list.jsp(215,296) name = alt type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/form/govCustomForm_list.jsp(255,15) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("information");
      // /doc/form/govCustomForm_list.jsp(255,15) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setKey("info.nonrecord");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /doc/form/govCustomForm_list.jsp(257,21) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setBundle("information");
      // /doc/form/govCustomForm_list.jsp(257,21) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setKey("info.suredelete");
