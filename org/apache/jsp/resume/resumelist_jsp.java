 ...
 * Generated at: 2023-01-06 09:49:07 UTC
...
String ptel = request.getParameter("tel")==null?"":request.getParameter("tel");
String papplyPosition = request.getParameter("applyPosition")==null?"":request.getParameter("applyPosition");
String ptopEducation = request.getParameter("topEducation")==null?"":request.getParameter("topEducation");
String pprofessionType = request.getParameter("professionType")==null?"":request.getParameter("professionType");
String pprofessionName = request.getParameter("professionName")==null?"":request.getParameter("professionName");


queryStr = "&id="+pid+"&name="+pname+"&tel="+ptel+"&applyPosition="+papplyPosition+"&topEducation="+ptopEducation+"&professionType="+pprofessionType+"&professionName="+pprofessionName;


            out.write("\r\n<body  class=\"MainFrameBox\" onKeyDown=\"if(event.keyCode==13) document.form2.submit();\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n\r\n<table width=\"100%\" border=\"0\" id=\"searchBar\"  style=\"display:none;\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"SearchBar\">\r\n       <form name=\"form2\" method=\"post\" action=\"/jsoa/ResumeAction.do?action=list\">\r\n             <tr>\r\n                 <td align=\"right\">简历编号：</td>\r\n                 <td><input type=\"text\" name=\"id\" id=\"id\" value=\"");
            out.print(pid);
            out.write("\"></input></td>\r\n                 <td align=\"right\">姓名：</td>\r\n                 <td><input type=\"text\" name=\"name\" id=\"name\" value=\"");
            out.print(pname);
            out.write("\"></input></td>\r\n                 <td align=\"right\">联系电话：</td>\r\n                 <td><input type=\"text\" name=\"tel\" id=\"tel\" value=\"");
            out.print(ptel);
            out.write("\"></input></td>\r\n             </tr>\r\n             <tr>\r\n                 <td align=\"right\">申请职位：</td>\r\n                 <td><input type=\"text\" name=\"applyPosition\" id=\"applyPosition\" value=\"");
            out.print(papplyPosition);
            out.write("\"></input></td>\r\n                 <td align=\"right\">最高学历：</td>\r\n                 <td><input type=\"text\" name=\"topEducation\" id=\"topEducation\" value=\"");
            out.print(ptopEducation);
            out.write("\"></input></td>\r\n                 <td align=\"right\">专业类别：</td>\r\n                 <td><input type=\"text\" name=\"professionType\" id=\"professionType\" value=\"");
            out.print(pprofessionType);
            out.write("\"></input></td>\r\n             </tr>\r\n             <tr>\r\n                 <td align=\"right\">专业名称：</td>\r\n                 <td><input type=\"text\" name=\"professionName\" id=\"professionName\" value=\"");
            out.print(pprofessionName);
            out.write("\"></input></td>\r\n                 <td align=\"right\">状态：</td>\r\n                 <td>\r\n                     <select name=\"zt\">\r\n                         <option value=\"\">请选择</option>\r\n                         <option value=\"等待笔试\">等待笔试</option>\r\n                         <option value=\"笔试1通过\">笔试1通过</option>\r\n                         <option value=\"笔试1未通过\">笔试1未通过</option>\r\n                         <option value=\"笔试2通过\">笔试2通过</option>\r\n                         <option value=\"笔试2未通过\">笔试2未通过</option>\r\n                         <option value=\"一面通过\">一面通过</option>\r\n                         <option value=\"一面未通过\">一面未通过</option>\r\n                         <option value=\"二面通过\">二面通过</option>\r\n                         <option value=\"二面未通过\">二面未通过</option>\r\n                         <option value=\"终面通过\">终面通过</option>\r\n                         <option value=\"终面未通过\">终面未通过</option>\r\n                         <option value=\"录用\">录用</option>\r\n                     </select>\r\n                 </td>\r\n                 <td></td>\r\n                 <td align=\"right\"> \r\n");
            out.write("                    <input type=\"button\" class=\"btnButton2Font\"  style=\"cursor:pointer\" onclick=\"javacript:form2.submit();\" value=\"查询\"/>\r\n                    <input type=\"button\" class=\"btnButton2Font\"  style=\"cursor:pointer\" onclick=\"reset();\" value=\"重置\"/>\r\n                 </td>\r\n             </tr>  \r\n       </form>\r\n    </table>\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n  <tr>\r\n    <td>&nbsp;</td>\r\n    <td width=\"240\" align=\"right\" nowrap>\r\n\t<button id=\"hiddenSearch\"  class=\"btnButton4Font\" onClick=\"hidserch()\">查询</button>\r\n\t</td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n<form  name=\"form1\" method=\"post\">\r\n                      <tr align=\"center\">\r\n                       <!--  <td class=\"listTableHead\">简历编号</td> -->\r\n\t\t\t\t\t\t<td class=\"listTableHead\">名称</td>\r\n\t\t\t\t\t\t<td class=\"listTableHead\">性别 </td>\r\n\t\t\t\t\t\t<td class=\"listTableHead\">年龄 </td>\r\n\t\t\t\t\t\t<td class=\"listTableHead\">电话</td>\r\n\t\t\t\t\t\t<td class=\"listTableHead\">应聘职位</td>\r\n");
            out.write("\t\t\t\t\t\t<td class=\"listTableHead\">最高学历</td>\r\n\t\t\t\t\t\t<td class=\"listTableHead\">最高学位</td>\r\n\t\t\t\t\t\t<td class=\"listTableHead\">专业类别</td>\r\n\t\t\t\t\t\t<td class=\"listTableHead\">专业名称</td>\r\n\t\t\t\t\t\t<td class=\"listTableHead\">状态</td>\r\n                      </tr>\r\n\r\n                      ");
            ...
            try {
              ...
              // /resume/resumelist.jsp(141,22) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("list");
              // /resume/resumelist.jsp(141,22) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  out.write("\r\n                      ");
										...
										String tel = obj[4].toString();
										String applyPosition = obj[5].toString();
										String topEducation = obj[6].toString();
										String topDegree = obj[7].toString();
										String professionType = obj[8].toString();
										String professionName = obj[9].toString();
										String zt = obj[10].toString();
                                    
                  out.write("\r\n                      <tr>\r\n\t\t\t\t\t\t ");
                  out.write("\r\n\t\t\t\t\t\t  <td class=\"");
                  out.print(listClass);
                  out.write("\"><a href=\"javascript:show('");
                  out.print(id);
                  out.write("');\">");
                  out.print(name );
                  out.write("</a></td>\r\n                          <td class=\"");
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(applyPosition );
                  out.write("</td>\r\n                          <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(topEducation );
                  out.write("</td>\r\n                          <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(professionType );
                  out.write("</td>\r\n                          <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(professionName );
                  out.write("</td>\r\n                          <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
...
String pagerURL = "/jsoa/ResumeAction.do";
            out.write("\r\n\t  ");
