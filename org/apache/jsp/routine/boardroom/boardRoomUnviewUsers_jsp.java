...
public final class boardRoomUnviewUsers_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(SystemCommon.getMeetingChatUse()==1){ 
      ...
      out.write("\r\n\t\t\t\t <span style=\"width:50px;color:red;\">");
      ...
      out.print(urlPath );
      out.write("\";\r\n\t}\r\n}\r\n\r\nfunction searchSubmit(){\r\n\tvar val=document.all.empName.value;\r\n\tif(val.indexOf(\"'\")>=0){\r\n\t\talert(\"用户不能包含 ' 特殊字符！\");\r\n\t\tdocument.all.empName.focus();\r\n\t}else{\r\n\t\tform1.action = \"/jsoa/BoardRoomAction.do?action=unviewUsers");
      out.print(urlPath );
      out.write("\";\r\n\t\tform1.submit();\r\n\t}\r\n}\r\nfunction resetValue(){\r\n\twindow.location.href=\"/jsoa/BoardRoomAction.do?action=unviewUsers");
      out.print(urlPath );
