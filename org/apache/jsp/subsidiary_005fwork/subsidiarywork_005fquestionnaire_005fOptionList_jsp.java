...
public final class subsidiarywork_005fquestionnaire_005fOptionList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
boolean online = com.js.system.util.SysSetupReader.getInstance().hasRtxOnline(session.getAttribute("domainId").toString());
	...
	if(request.getAttribute("maxPageItems") !=null){
      ...
      out.write("\r\n<table width=\"100%\">\r\n    <tr>\r\n        <td>\r\n            <form name=\"form1\" method=\"POST\" action=\"/jsoa/QuestionnaireAction.do?action=viewbrowserOption&themeId=");
      out.print(request.getParameter("themeId"));
      ...
      out.write("\">\r\n\t\t\t<button class=\"btnButton2font\" onclick=\"form1.submit();\">查询</button>\r\n\t\t    <button class=\"btnButton2font\" onclick=\"window.location.href='/jsoa/QuestionnaireAction.do?action=viewbrowserOption&themeId=");
      out.print(request.getParameter("themeId"));
