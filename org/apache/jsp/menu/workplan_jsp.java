 ...
 * Generated at: 2023-01-06 10:02:47 UTC
...
import com.js.oa.workplan.service.*;
import com.js.oa.workplan.bean.WorkplanSetBean;

public final class workplan_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_packages.add("com.js.oa.workplan.service");
    _jspx_imports_classes = new java.util.HashSet<>();
    _jspx_imports_classes.add("java.util.List");
    _jspx_imports_classes.add("com.js.oa.workplan.bean.WorkplanSetBean");
  }
...
boolean dataRight = managerBD.hasRight(userId, "04*60*02"); //判断有没有工作动态数据维护的权限

boolean currentUserIsLeader=false; 
currentUserIsLeader=workplanSetService.userIsLeader(userId);//判断当前用户是不是领导
boolean currentUserIsProxy=false;
currentUserIsProxy=workplanSetService.userIsProxy(userId);//判断当前用户是不是代理

//得到领导分组数据
List groupList=new WorkplanSetBean().searchGroupList();
...
if(com.js.util.util.BrowserJudge.isMSIE(request)){ 
  ...
  if(dataRight || currentUserIsLeader || currentUserIsProxy){
	  //用户是管理员或者是领导或者是领导的代理人，则有填表的权限
      ...
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/WorkplanAction.do?action=list')\"><img id=\"menuImg_");
      out.print(menuIndex );
      out.write("\"  src=\"/jsoa/imges/shanj.gif\" />&nbsp;计划填报</div></td>\r\n  </tr> \r\n  ");
  ...
  if(groupList!=null){
      ...
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/WorkplanAction.do?action=view&groupId=");
      out.print(obj[0]);
  ...
  //if(dataRight || currentUserIsLeader){
  if(currentUserIsLeader){
	  //用户是管理员或者是领导，则有设置代理人的权限
      ...
      out.write("\" class=\"menuNormal\" onclick=\"clickMenu('");
      out.print(menuIndex );
      out.write("');jumpMain('/jsoa/WorkplanSetAction.do?action=proxy')\"><img id=\"menuImg_");
      out.print(menuIndex );
      out.write("\" src=\"/jsoa/imges/shanj.gif\" />&nbsp;代理设置</div></td>\r\n  </tr>  \r\n  ");
} 
      out.write("\r\n</table>\r\n</td>\r\n  </tr>\r\n     \t  \r\n</table>\r\n\r\n\r\n</BODY>\r\n</HTML>\r\n<script src=\"/jsoa/js/imenu.js\"></script>");
