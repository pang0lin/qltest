...
public final class personalStockList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String search = "";
      ...
      out.write(".css\" rel=\"stylesheet\" type=\"text/css\" />\r\n<script\tsrc=\"js/js.js\" language=\"javascript\"></script>\r\n<script>\r\n\r\n//-->\r\n</script>\r\n</head>\r\n<body   class=\"MainFrameBox\" onkeypress=\"if(event.keyCode==13) search();\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<!-- SEARCH\tPART -->\r\n<table width=\"100%\"\tborder=\"0\" id=\"searchtable\"  style=\"display:none;\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n<form name=\"form2\" method=\"post\" action=\"/jsoa/OutStockAction.do?flag=personnalUseStock&mode=outStock\">\r\n   <tr>\r\n\t  <td>\r\n\t\t   出库单号：\r\n\t\t   <input type=\"text\" onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'出库单号')\" onblur=\"value=checkQuery1(this,'出库单号')\" class=\"inputText\" style=\"width:105px\" size=\"18\" id=\"searchId\" name=\"searchId\">\r\n\t  </td>\r\n\t  <td>\r\n\t\t   制单人：&nbsp;&nbsp;\r\n\t\t   <input type=\"text\" onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'经手人')\" onblur=\"value=checkQuery1(this,'经手人')\" style=\"width:105px\" class=\"inputText\" size=\"18\" id=\"searchSsMan\" name=\"searchSsMan\">\r\n");
      out.write("\t  </td>\r\n\t  <td> 状态：\r\n\t\t\t<select name=\"searchCheckFlag\" id=\"searchCheckFlag\">\r\n\t\t\t\t<option value=\"\">--选择--</option>\r\n\t\t\t\t<option value=\"N\">待审核</option>\r\n\t\t\t\t<option value=\"Y\">已审核</option>\r\n                <option value=\"B\">退回</option>\r\n\t\t\t    <option value=\"1\">已领用</option>\r\n\t\t\t</select>\r\n\t  </td>\r\n\t  \r\n\t</tr>\r\n\t<tr>\r\n\t\t<td>\r\n\t\t         物品名称：\r\n\t\t     <input onKeyPress=\"return look() ;\" onKeyUp=\"value=checkQuery(this,'品名')\" onBlur=\"value=checkQuery1(this,'品名')\" type=\"text\" class=\"inputText\" style=\"width:105px\" class=\"css0\" size=\"18\" name=\"goodsName\" id=\"goodsName\">\t  \r\n\t\t</td>\r\n\t\r\n\t\t ");
...
if(searchEndDate.equals("")){
      ...
      out.write("\r\n                      \r\n                    <input type=\"checkbox\" id=\"chickdate\" />\r\n                 \r\n\t\t   </td>\r\n\t\t<td>\r\n\t\t</td>\r\n\t</tr>\r\n     <tr>\r\n\t\t<td>\r\n\t\t\t\t所属仓库：\r\n\t\t\t\t<select id=\"searchStock\" name=\"searchStock\" style=\"width:110px\" >\r\n\t\t\t\t\t<option value=\"\">--选择仓库--</option>\r\n\t\t\t\t\t");
Object[] stockObj = null;
      ...
      try {
        ...
        // /routine/resource_manager/personalStockList.jsp(118,5) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("stockList");
        // /routine/resource_manager/personalStockList.jsp(118,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
stockObj = (Object[]) stockList;
      ...
      out.write("\r\n\t\t\t\t</select>\r\n\t\t\t</td>\r\n\t\t<td  align=\"right\" ></td>\r\n\t</tr>  \r\n\t<tr>\r\n\t\t<td colspan=\"2\">\r\n\t\t\t \r\n\t\t</td>\r\n\t\t<td  align=\"right\" >\r\n\t\t  <input type=\"button\"  class=\"btnButton2font\" onClick=\"search();\" value=\"查询\">\r\n\t\t  <input type=\"button\"  class=\"btnButton2Font\" onclick=\"unsearcher();\" value=\"重置\">\r\n\t\t</td>\r\n\t</tr>\r\n\t\r\n  </form>\r\n</table>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<table width=\"100%\"\theight=\"25\"\tborder=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n\t<tr height=\"20\">\r\n\t  <td align=\"right\">\r\n\t    <input type=\"button\" id=\"hiddenSearch\"  class=\"btnButton4Font\" onClick=\"hidserch()\" value=\"查询\" />\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\t      <tr align=\"center\">\r\n\t\t    <td width=\"5%\" height=\"28\" class=\"listTableHead\" nowrap><input type=\"checkbox\" value=\"1\" name=\"selectAllBox\" onclick=\"selectAll(this);\"></td>\r\n\t\t\t<td class=\"listTableHead\" width=\"10%\">物品名称</td>\r\n\t\t\t<td class=\"listTableHead\" width=\"10%\">物品数量</td>\r\n\t\t\t<td class=\"listTableHead\" width=\"10%\" >物品单价</td>\r\n");
      out.write("\t\t\t<td class=\"listTableHead\" width=\"10%\">制单日期 </td>\r\n\t\t\t<td class=\"listTableHead\" width=\"10%\">申请人 </td>\r\n\t\t\t<td class=\"listTableHead\" width=\"10%\">所属仓库 </td>\r\n\t\t\t<td class=\"listTableHead\" width=\"10%\">所属状态 </td>\r\n\t\t\t\r\n\t\t  </tr>\r\n\t\t  ");
      ...
      try {
        ...
        // /routine/resource_manager/personalStockList.jsp(168,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fpresent_005f0.setName("personnalList");
        ...
        if (_jspx_eval_logic_005fpresent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /routine/resource_manager/personalStockList.jsp(169,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setId("personnalList");
              // /routine/resource_manager/personalStockList.jsp(169,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setName("personnalList");
              int _jspx_eval_logic_005fiterate_005f1 = _jspx_th_logic_005fiterate_005f1.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object personnalList = null;
                ...
                personnalList = (java.lang.Object) _jspx_page_context.findAttribute("personnalList");
                do {
                  out.write("\r\n\t\t  ");

			personnalObj = (Object[]) personnalList;
		  	index ++;
			...
			if(index%2 != 0){listClass="listTableLine2";}
                  ...
                  out.print(personnalObj[0] );
                  out.write("\"  disabled=\"disabled\">&nbsp;</td>\r\n\t\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(personnalObj[1] );
                  out.write("</td>\r\n\t\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(personnalObj[2] );
                  out.write("</td>\r\n\t\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(personnalObj[3] );
                  out.write("</td>\r\n\t\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(personnalObj[4].toString().substring(0, 10) );
                  out.write("</td>\r\n\t\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(personnalObj[5] );
                  out.write("</td>\r\n\t\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print( new com.js.oa.routine.resource.bean.StockEJBBean().getStockNameById(personnalObj[8]+"") );
                  out.write("</td>\r\n\t\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
if("Y".equals(personnalObj[9]+"")){out.print("已审核");}else if("N".equals(personnalObj[9]+"")){out.print("未审核");} 
			      else if("B".equals(personnalObj[9]+"")){out.print("退回");}else if("I".equals(personnalObj[9]+"")){out.print("已领用");} 
                  out.write("\r\n\t\t\t  </td>\r\n\t\t\t  \r\n\t\t  </tr>\r\n\t\t  ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n<!-- PAGER -->\r\n\r\n\r\n</td></tr></table>\r\n\r\n</body>\r\n</html>\r\n<script language=\"javascript\">\r\nfunction search(){\r\n    form2.action = \"/jsoa/OutStockAction.do?flag=personnalUseStock&mode=outStock\";\r\n    \r\n    var searchId=document.getElementById(\"searchId\").value;\r\n    var searchSsMan=document.getElementById(\"searchSsMan\").value;\r\n    var searchCheckFlag=document.getElementById(\"searchCheckFlag\").value;\r\n    var goodsName=document.getElementById(\"goodsName\").value;\r\n    \r\n    var searchStartDate=document.getElementById(\"searchStartDate\").value;\r\n    var searchEndDate=document.getElementById(\"searchEndDate\").value;\r\n    var chickdate=document.getElementById(\"chickdate\").checked;\r\n    var searchStock=document.getElementById(\"searchStock\").value;\r\n    \r\n    \r\n    form2.action += \"&searchStock=\"+searchStock+\"&chickdate=\"+chickdate+\"&goodsName=\"+goodsName+\"&searchId=\"+searchId+\"&searchSsMan=\"+searchSsMan+\"&searchCheckFlag=\"+searchCheckFlag+\"&searchStartDate=\"+searchStartDate+\"&searchEndDate=\"+searchEndDate;\r\n");
      out.write("   \r\n    form2.submit();\r\n}\r\nfunction unsearcher(){\r\n\twindow.location.href='/jsoa/OutStockAction.do?flag=personnalUseStock'\r\n}\r\nfunction hidserch()\r\n{\r\n     var stable=document.getElementById(\"searchtable\");\r\n     var sbutton=document.getElementById(\"hiddenSearch\");\r\n     if(stable.style.display==\"none\")\r\n     {\r\n      \r\n      stable.style.display=\"\";\r\n      sbutton.value=\"关闭查询\";\r\n      \r\n     }else{\r\n     \r\n     stable.style.display=\"none\";\r\n     sbutton.value=\"查询\";\r\n     \r\n     }\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
