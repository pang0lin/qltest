 ...
 * Generated at: 2023-01-06 09:48:15 UTC
...
public final class boardRoomAppTypeList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(managerBD.hasRight(userId,"04*07*02")){ 
	       ...
	       if(managerBD.hasRight(userId,"04*10*01")){
            ...
            out.write("\r\n    </td>\r\n    <td width=\"140\" align=\"right\" nowrap><input type=\"button\" class=\"btnButton2font\" style=\"cursor:pointer\" onclick=\"JSMainWinOpenNew('BoardRoomAction.do?action=addBoardroomAppTypeView','','TOP=0,LEFT=0,scrollbars=no,resizable=no,width=600,height=280')\" value=\"新增\"/>\r\n     <input type=\"button\" class=\"btnButton2font\" style=\"cursor:pointer\" onclick=\"delBatch()\" value=\"删除\"/></td>\r\n  </tr>\r\n</table>\r\n\r\n\t<form  name=\"form1\" method=\"post\">\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n\t<tr>\r\n\t\t<td width=\"40\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n\t\t<td width=\"75%\" class=\"listTableHead\">会议类型</td>\r\n\t\t<td width=\"15%\" class=\"listTableHead\">会议形式</td>\r\n\t\t<td width=\"8%\" nowrap class=\"listTableHeadLast\">处理</td>\r\n\t</tr>\r\n\r\n\t");
		...
		if(request.getParameter("pager.offset")!=null){
            ...
            try {
              ...
              // /routine/boardroom/boardRoomAppTypeList.jsp(110,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("List");
              // /routine/boardroom/boardRoomAppTypeList.jsp(110,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("boardRoomAppTypeList");
		...
		if(index%2 != 0){listClass="listTableLine2";}
                  ...
                  out.print(obj[1]);
                  out.write("&nbsp;");
                  out.print("1".equals(obj[3]+"")?"（默认）":"" );
                  out.write("</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print("0".equals(obj[2]+"")?"即时会议":"定期会议" );
                  out.write("&nbsp;</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  ...
                  out.write("')\" >\r\n\t\t");
if("0".equals(obj[3]+"")){ 
                  out.write("<img style=\"cursor:pointer\" border=\"0\" src=\"images/w.gif\" alt=\"默认类型\" onclick=\"defaultType('");
                  out.print(obj[0]);
                  out.write("')\" >");
} 
                  out.write("\r\n\t\t&nbsp;</td>\r\n\t</tr>\r\n\t");
            ...
            out.write("\r\n</table>\r\n\t<input type=\"hidden\" name=\"checkboxNumber\" id=\"checkboxNumber\" />\r\n\t<input type=\"hidden\" name=\"jNumber\" id=\"jNumber\" value=\"");
            out.print(j);
            out.write("\" />\r\n\t<input type=\"hidden\" name=\"pageSize2\" id=\"pageSize2\" value=\"");
            out.print(pageSize2);
            out.write("\" />\r\n\t<input type=\"hidden\" name=\"pageSize3\" id=\"pageSize3\" value=\"");
            out.print(pageSize);
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\nfunction getCheckBoxID() {\r\n    var strCheckBox = \"\" ;\r\n    var k=0;\r\n    for(var i = 0 ; i < document.all.form1.length ; i++ ) {\r\n        var obj = document.all.form1[i] ;\r\n        if(obj.type == \"checkbox\"  && obj.name==\"batchDel\"){\r\n\t\t\tif(obj.checked) {\r\n\t\t\t\tk++;\r\n\t\t\t\tstrCheckBox += obj.value  ;\r\n\t\t\t\tstrCheckBox += \",\" ;\r\n\t\t\t}\r\n        }\r\n    }\r\n    document.all.checkboxNumber.value = k;\r\n    return strCheckBox ;\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\nfunction modify(id){\r\n\tJSMainWinOpenNew('BoardRoomAction.do?action=selectBoardroomAppTypeView&bdroomAppTypeId='+id+'&type=modi','','TOP=0,LEFT=0,scrollbars=no,resizable=no,width=600,height=280')\r\n");
      out.write("}\r\n\r\nfunction view(id){\r\n\tJSMainWinOpenNew('BoardRoomAction.do?action=selectBoardroomView&bdroomAppTypeId='+id+'&type=view','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=500')\r\n}\r\n\r\nfunction del(id){\r\n   \tvar checkboxNumber = \"1\";\r\n    var j = document.all.jNumber.value;\r\n    var pageSize2 = document.all.pageSize2.value;\r\n    var pageSize3 = document.all.pageSize3.value;\r\n    if(checkboxNumber==j && pageSize2>=pageSize3){\r\n        pageSize2 = pageSize2-pageSize3;\r\n    }\r\n    if(confirm(\"同时将删除与此类型相关的使用记录,确实要删除这条记录吗？\")){\r\n    \twindow.open(\"/jsoa/BoardRoomAction.do?action=deleteBoardroomAppType&bdroomAppTypeId=\"+id+\"&pager.offset=\"+pageSize2,\r\n    \t\t\t\"myIframe\");\r\n    \t//window.location.href=\"/jsoa/BoardRoomAction.do?action=deleteBoardroomAppType&bdroomAppTypeId=\"+id+\"&pager.offset=\"+pageSize2;\r\n    }\r\n}\r\n\r\nfunction delBatch() {\r\n    \tvar strId=getCheckBoxID();\r\n        var checkboxNumber = document.all.checkboxNumber.value;\r\n        var j = document.all.jNumber.value\r\n        var pageSize2 = document.all.pageSize2.value;\r\n");
      out.write("        var pageSize3 = document.all.pageSize3.value;\r\n    if(checkboxNumber==j && pageSize2>=pageSize3){\r\n        pageSize2 = pageSize2-pageSize3;\r\n        }\r\n        if(strId!=\"\"){\r\n\tif(confirm(\"同时将删除与此类型相关的使用记录,确实要删除这些记录吗？\")){\r\n         window.location.href=\"/jsoa/BoardRoomAction.do?action=deleteBatchBoardroomAppType&ids=\" + getCheckBoxID()+\"&pager.offset=\"+pageSize2 ;\r\n    }\r\n    }else{\r\n             alert(\"请选择要删除的记录!\");\r\n             return;\r\n         }\r\n}\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=cURL;\r\n}\r\nfunction defaultType(id){\r\n\twindow.open(\"/jsoa/BoardRoomAction.do?action=typeDefalut&bdroomAppTypeId=\"+id+\"&r=\"+Math.random(),\"myIframe\");\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
