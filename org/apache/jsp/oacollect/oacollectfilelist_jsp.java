...
public final class oacollectfilelist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String fileSizeBegin=null==request.getParameter("fileSizeBegin")?"":request.getParameter("fileSizeBegin");
String fileSizeEnd=null==request.getParameter("fileSizeEnd")?"":request.getParameter("fileSizeEnd");
...
String suffix="";//文档后缀
String allPic="bmp,jpg,tiff,gif,pcx,tga,exif,fpx,svg,psd,cdr,pcd,dxf,ufo,eps,ai,raw";
Exchange exchange=new Exchange();

String fromFlagStr = "";
if(fromFlag!=null&&!"".equals(fromFlag)){
	fromFlagStr = "&fromFlag="+fromFlag;
}

            out.write("\r\n<body class=\"MainFrameBox\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\" id=\"searchbar\" style=\"display:none\">\r\n   <form name=\"frm\" action=\"/jsoa/OACollectFileAction.do?action=fileList");
            out.print(fromFlagStr );
            out.write("&collectId=");
            ...
            out.write("\">\r\n\t\t\t</td>\r\n\t\t  <td align=\"left\">填报部门：<input type=\"text\" class=\"inputtext\" name=\"collectOrgName\" value=\"");
            out.print(collectOrgName);
            out.write("\"/></td>\r\n\t\t  <td>&nbsp;</td>\r\n\t\t  </tr>\r\n\t\t  <tr>\r\n\t\t  <td align=\"center\">文件名称：</td>\r\n\t\t  <td>\r\n\t\t\t<input type=\"text\" class=\"inputtext\" name=\"fileName\" value=\"");
            out.print(fileName);
            out.write("\"/>\r\n\t\t\t</td>\r\n\t\t  <td align=\"left\">文件大小：\r\n\t\t  <input type=\"text\" class=\"inputtext\" name=\"fileSizeBegin\" value=\"");
            out.print(fileSizeBegin);
            out.write("\"/>KB\r\n\t\t    到\r\n\t\t  <input type=\"text\" class=\"inputtext\" name=\"fileSizeEnd\" value=\"");
            out.print(fileSizeEnd);
            out.write("\"/>KB\r\n\t\t  </td>\r\n\t\t  <td>\r\n\t\t\t&nbsp;\r\n\t\t  </td>\r\n\t\t  </tr>\r\n\t\t  <tr>\r\n\t\t  <td align=\"center\">填报开始时间：</td>\r\n\t\t  <td ><script language=javascript>\r\n\t\t\t\t\tvar dtpDate = createDatePickerByDateStr(\"oprStartTime\",\"");
...
if("1".equals(searchTime)){out.print("checked");}
            out.write(">\r\n\t\t  </td>\r\n\t\t  <td  align=\"right\">\r\n\t\t  <input type=\"button\" class=\"btnButton2Font\" onClick=\"searchSubmit();\" value=\"查询\"/>\r\n\t\t  <input type=\"button\" class=\"btnButton2Font\" onClick=\"searchReset();\" value=\"重置\"/>\r\n\t\t  </td>\r\n\t </tr>\r\n   </form>\r\n</table>\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"inlineBottomLine\">  \r\n  <tr>\r\n    \t <td>\r\n\t      <div id=\"Panel0\" name=\"Panel0\" class=\"tabPanelSelected\"  onClick=\"changeURL('/jsoa/OACollectFileAction.do?action=fileList");
            out.print(fromFlagStr );
            out.write("&collectId=");
            out.print(request.getAttribute("collectId"));
            out.write("');\">\r\n\t\t\t<div class=\"tabPanelLeft\"></div>\r\n\t\t\t<div class=\"tabPanelCenter\">列表显示</div>\r\n\t\t\t<div class=\"tabPanelRight\"></div>      \r\n\t\t  </div>\r\n\t\t  <div class=\"btnBQspace AlignLeft\"></div>\r\n\t\t  <div id=\"Panel1\" name=\"Panel1\" class=\"tabPanel\"  onClick=\"changeURL('/jsoa/OACollectFileAction.do?action=fileList");
            out.print(fromFlagStr );
            out.write("&collectId=");
            out.print(request.getAttribute("collectId"));
            out.write("&displayFlag=suoluetu');\">\r\n\t\t\t<div class=\"tabPanelLeft\"></div>\r\n\t\t\t<div class=\"tabPanelCenter\">缩略图显示</div>\r\n\t\t\t<div class=\"tabPanelRight\"></div>      \r\n\t\t  </div>\r\n\t\t</td>\r\n\t  <td align=\"right\" nowrap>\r\n\t  \t");
if(null!=request.getAttribute("canUpload")&&"1".equals(request.getAttribute("canUpload").toString())){
            out.write("\r\n\t  \t<input type=\"button\" class=\"btnButton2Font\" id=\"btnButton2fontRemind\" onClick=\"doUpLoad();\" value=\"上传\"/>\r\n\t  \t");
}
            out.write("\r\n\t  \t<input type=\"button\" class=\"btnButton4font\" onClick=\"downloadPilian()\" value=\"批量下载\" />\r\n\t  \t");
if(null!=request.getAttribute("canDelete")&&"1".equals(request.getAttribute("canDelete").toString())){ 
            out.write("\r\n\t  \t<input type=\"button\" class=\"btnButton2Font\" id=\"btnButton2fontRemind\" onClick=\"allDelete();\" value=\"删除\"/>\r\n\t  \t");
} 
            ...
            try {
              ...
              // /oacollect/oacollectfilelist.jsp(148,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/OACollectFileAction");
              // /oacollect/oacollectfilelist.jsp(148,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setMethod("get");
              int _jspx_eval_html_005fform_005f0 = _jspx_th_html_005fform_005f0.doStartTag();
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n  <tr>\r\n \r\n\t\t<td width=\"40px\"  nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"sAll\" onclick=\"selectAllItem(this);\"></td>\r\n\t\t<td width=\"10%\" class=\"listTableHead\" id=\"tdWidth\">采集标题</td>\t\t\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\">填报人\r\n\t\t");
		...
		if(orderBy == null || !orderBy.equals("collectEmpName")){
                  out.write("\r\n\t\t<img src=\"images/blanksort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('collectEmpName','desc');\" title=\"按填报人排序\">\r\n\t\t");
}else if(orderBy.equals("collectEmpName") && sortType.equals("desc")){
                  out.write("\r\n\t\t<img src=\"images/downsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('collectEmpName','asc');\" title=\"按填报人排序\">\r\n\t\t");
}else if(orderBy.equals("collectEmpName") && sortType.equals("asc")){
                  out.write("\r\n\t\t<img src=\"images/upsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('collectEmpName','desc');\" title=\"按填报人排序\">\r\n\t\t");
}
                  out.write("\r\n\t\t</td>\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\">填报部门\r\n\t\t");

		  if(orderBy == null || !orderBy.equals("collectOrgName")){
                  out.write("\r\n\t\t<img src=\"images/blanksort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('collectOrgName','desc');\" title=\"按填报部门排序\">\r\n\t\t");
}else if(orderBy.equals("collectOrgName") && sortType.equals("desc")){
                  out.write("\r\n\t\t<img src=\"images/downsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('collectOrgName','asc');\" title=\"按填报部门排序\">\r\n\t\t");
}else if(orderBy.equals("collectOrgName") && sortType.equals("asc")){
                  out.write("\r\n\t\t<img src=\"images/upsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('collectOrgName','desc');\" title=\"按填报部门排序\">\r\n\t\t");
}
                  out.write("\r\n\t\t</td>\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\">文件名称\r\n\t\t");

		  if(orderBy == null || !orderBy.equals("fileName")){
                  out.write("\r\n\t\t<img src=\"images/blanksort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('fileName','desc');\" title=\"按填报部门排序\">\r\n\t\t");
}else if(orderBy.equals("fileName") && sortType.equals("desc")){
                  out.write("\r\n\t\t<img src=\"images/downsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('fileName','asc');\" title=\"按填报部门排序\">\r\n\t\t");
}else if(orderBy.equals("fileName") && sortType.equals("asc")){
                  out.write("\r\n\t\t<img src=\"images/upsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('fileName','desc');\" title=\"按填报部门排序\">\r\n\t\t");
}
                  out.write("\r\n\t\t</td>\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\">大小\r\n\t\t");

		  if(orderBy == null || !orderBy.equals("fileSize")){
                  out.write("\r\n\t\t<img src=\"images/blanksort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('fileSize','desc');\" title=\"按填报部门排序\">\r\n\t\t");
}else if(orderBy.equals("fileSize") && sortType.equals("desc")){
                  out.write("\r\n\t\t<img src=\"images/downsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('fileSize','asc');\" title=\"按填报部门排序\">\r\n\t\t");
}else if(orderBy.equals("fileSize") && sortType.equals("asc")){
                  out.write("\r\n\t\t<img src=\"images/upsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('fileSize','desc');\" title=\"按填报部门排序\">\r\n\t\t");
}
                  out.write("\r\n\t\t</td>\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\">填报状态\r\n\t\t");

		  if(orderBy == null || !orderBy.equals("collectEmpStatus")){
                  out.write("\r\n\t\t<img src=\"images/blanksort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('collectEmpStatus','desc');\" title=\"按填报部门排序\">\r\n\t\t");
}else if(orderBy.equals("collectEmpStatus") && sortType.equals("desc")){
                  out.write("\r\n\t\t<img src=\"images/downsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('collectEmpStatus','asc');\" title=\"按填报部门排序\">\r\n\t\t");
}else if(orderBy.equals("collectEmpStatus") && sortType.equals("asc")){
                  out.write("\r\n\t\t<img src=\"images/upsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('collectEmpStatus','desc');\" title=\"按填报部门排序\">\r\n\t\t");
}
                  out.write("\r\n\t\t</td>\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\">填报时间\r\n\t\t");

		  if(orderBy == null || !orderBy.equals("createDate")){
                  out.write("\r\n\t\t<img src=\"images/blanksort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('createDate','desc');\" title=\"按填报部门排序\">\r\n\t\t");
}else if(orderBy.equals("createDate") && sortType.equals("desc")){
                  out.write("\r\n\t\t<img src=\"images/downsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('createDate','asc');\" title=\"按填报部门排序\">\r\n\t\t");
}else if(orderBy.equals("createDate") && sortType.equals("asc")){
                  out.write("\r\n\t\t<img src=\"images/upsort.gif\" style=\"cursor:pointer\" onClick=\"orderBy('createDate','desc');\" title=\"按填报部门排序\">\r\n\t\t");
}
                  out.write("\r\n\t\t</td>\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\">操作</td>\r\n  </tr>\r\n  ");

  // po.id,po.collectId,po.collectTitle,po.fileName,po.filePath,po.collectEmpId,po.collectEmpName,po.collectOrgName,po.collectEmpStatus,po.createDate,po.fileNameSys 
  ...
  for(int i=0;i<myList.size();i++){
 	...
 	if(index%2 != 0){
 	     ...
 	     listClass="listTableLine1";
                  ...
                  out.print(obj[0]);
                  out.write("\" onclick=\"clickObj(this);\"></td>\r\n        <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(obj[2]);
		...
		suffix=obj[3].toString().substring(obj[3].toString().lastIndexOf(".")+1);
		suffix = picSingleton.isExist(suffix)?suffix:"unknown";
		if(!"unknown".equals(suffix)&&allPic.indexOf(suffix+",")>0){//如果是图片
		
                  out.write("\r\n\t\t<a title=\"");
                  out.print(obj[3]);
                  out.write("\" href=\"javascript:showPic('");
                  out.print(obj[10]);
                  out.write("');\" >");
                  out.print(obj[3]);
                  out.write("</a>\r\n\t\t");
                  ...
                  out.print(listClass);
                  out.write("\">\r\n\t\t");
                  out.print(null==obj[11]?"0":obj[11].toString());
                  out.write("KB\r\n\t\t</td>\r\n        <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(null==obj[8]?"":("0".equals(obj[8].toString())?"完成":("1".equals(obj[8].toString())?"未完成":obj[8].toString())));
                  out.write("</td>\r\n         <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  out.print(null==obj[9]?"":(obj[9].toString().length()>=16?obj[9].toString().substring(0,16):obj[9].toString()));
                  out.write("</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\">\r\n\t\t");
if(null!=request.getAttribute("canDelete")&&"1".equals(request.getAttribute("canDelete").toString())){ 
                  out.write("\r\n\t\t<img title=\"删除\" style=\"cursor:pointer\" border=\"0\" src=\"images/del.gif\" onclick=\"DeleteIt('");
                  out.print(obj[0]);
                  out.write("');\" >\r\n\t\t");
}
                  out.write("\r\n\t\t<a class=\"a1\" href=\"/jsoa/download.jsp?");
                  out.print(com.js.util.util.BASE64.BASE64EncoderNoBR("FileName="+obj[10]+"&name="+obj[3].toString()+"&moduleCode=oa_collect_filecollect&path=collectfile"));
                  out.write("\">\r\n\t\t<img title=\"下载\" style=\"cursor:pointer\" border=\"0\" src=\"images/G1.gif\">\r\n\t\t</a>&nbsp;&nbsp;\r\n\t\t</td>\r\n  </tr>\r\n  ");
...
String pagerURL = "/jsoa/OACollectFileAction.do";
            out.write("\r\n\t\t\t\t\t\t\t\t\t");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\";\r\nif(\"deletetasksuccess\"==flag){\r\nalert(\"删除成功！\");\r\n}\r\nif(\"deletetaskerror\"==flag){\r\nalert(\"删除失败！\");\r\n}\r\nfunction MM_openBrWindow(theURL,winName,features) { //v2.0\r\n  JSMainWinOpen(theURL,winName,features);\r\n}\r\nfunction orderBy(orderBy,sortType){\r\n\tdocument.frm.action=\"/jsoa/OACollectFileAction.do?action=fileList&collectId=");
            out.print(request.getAttribute("collectId"));
            out.write("&orderBy=\"+orderBy+\"&sortType=\"+sortType+\"&displayFlag=");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.displayFlag}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
