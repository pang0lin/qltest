...
public final class bjyh_005fopinionSearch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Object[] obj; 
      ...
      try {
        ...
        // /bjyh/bjyh_opinionSearch.jsp(61,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("opinionList");
        // /bjyh/bjyh_opinionSearch.jsp(61,7) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("opinionList");
        // /bjyh/bjyh_opinionSearch.jsp(61,7) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setScope("request");
        int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          java.lang.Object opinionList = null;
          ...
          opinionList = (java.lang.Object) _jspx_page_context.findAttribute("opinionList");
          do {
            out.write("\r\n\t\t\t\t\t\t ");

						 	obj=(Object[])opinionList;
							index ++;
							String listClass="listTableLine1";
							if(index%2 != 0){
								listClass="listTableLine2";
							}
							if(obj[0].toString()!=null && !"".equals(obj[0].toString()) && !"null".equalsIgnoreCase(obj[0].toString())){
								temp=bob.getComment(obj[0].toString(),obj[1].toString(),obj[5].toString());
								status=bob.getStatus(obj[0].toString(),obj[1].toString(),obj[5].toString());
							}
							String t=obj[3]==null?"":obj[3].toString();
							if(t.endsWith(".0")){
								t=t.substring(0,t.length()-2);	
							}
							recordId=obj[1].toString();
            ...
            out.write("&curStatus=");
            out.print(status[1]);
            out.write("&fromDossierData=y','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=770,height=500')\" href=\"javascript:void(0);\">");
            out.print(obj[2]==null? "":obj[2]);
            out.write("</a>\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">&nbsp;");
            ...
            out.print(listClass);
            out.write("\">&nbsp;");
            out.print(temp[0]==null? "":temp[0]);
            out.write("</td>\r\n\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">&nbsp;");
            out.print(temp[1]==null? "":temp[1]);
            out.write("</td>\r\n\t\t\t\t\t\t\t</tr >\r\n\t\t\t\t\t\t");
...
String pagerURL="/jsoa/OpinionShow.do";
      out.write("\r\n\t\t\t\t\t\t\t ");
