 ...
 * Generated at: 2023-01-06 10:01:09 UTC
...
public final class personalwork_005fgroupsetup_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(searchUser==null || "null".equals(searchUser)){
   searchUser="";
}
...
if("0".equals(SystemCommon.getShowPassword())){
	  ...
	  String url="/GroupAction?action=del&groupType="+groupType+"&pager.offset="+index;
            ...
            try {
              ...
              // /personal_work/setup/personalwork_groupsetup.jsp(172,3) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
	 ...
	 String listClass="listTableLine1";
                  ...
                  try {
                    ...
                    // /personal_work/setup/personalwork_groupsetup.jsp(189,5) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("groupList");
                    // /personal_work/setup/personalwork_groupsetup.jsp(189,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("groupList");
                    // /personal_work/setup/personalwork_groupsetup.jsp(189,5) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
//=index
                        ...
                        out.write('\'');
                        out.print(indexTmp);
                        out.write("')\">&nbsp;<img src=\"images/del.gif\" alt=\"删除\" border=\"0\" style=\"cursor:pointer\" onclick=\"javascript:del(");
                        out.print(obj[0]);
                        out.write(");\" >&nbsp;</td>\r\n\t\t</tr>\r\n\t  ");
...
String pagerURL = "/jsoa/GroupAction.do";
            out.write("\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\n\r\nfunction changePanle(obj,cURL){\r\n\tlocation.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+cURL;\r\n}\r\n\r\nfunction openSearch(){\r\n  document.getElementById(\"searchbar\").style.display=\"\";\r\n  document.getElementById(\"openSearch\").style.display=\"none\";\r\n  document.getElementById(\"closeSearch\").style.display=\"\";\r\n}\r\n\r\nfunction closeSearch(){\r\n  document.getElementById(\"searchbar\").style.display=\"none\";\r\n  document.getElementById(\"openSearch\").style.display=\"\";\r\n  document.getElementById(\"closeSearch\").style.display=\"none\";\r\n\r\n}\r\n\r\nfunction del(id){\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=\"/jsoa/GroupAction.do?action=del&type=1&id=\"+id+\"&pager.offset=");
      out.print(indexTmp);
      out.write("&groupType=");
      out.print(groupType);
      out.write("&searchName=\"+document.GroupActionForm.searchName.value+\"&searchUser=\"+document.GroupActionForm.searchUser.value;\r\n    }\r\n}\r\n\r\nfunction batchDel(){\r\n    if(checkboxIsChecked(document.all.batchDel)){\r\n    \tif(confirm(\"确实要删除吗？\")){\r\n        \tGroupActionForm.submit();\r\n        }\r\n    }else{\r\n    \talert(\"请选择要删除的记录！\");\r\n    }\r\n}\r\n\r\nfunction delAll(){\r\n\tif(confirm(\"确实要全部删除吗？\")){\r\n        \twindow.location.href=\"/jsoa/GroupAction.do?action=delAll&groupType=");
      out.print(groupType);
      out.write("\";\r\n        }\r\n}\r\n\r\nfunction modify(id,index){\r\n\tJSMainWinOpen('GroupAction.do?action=modify&id='+id+'&pager.offset='+index+'&groupType=");
      out.print(groupType);
      out.write("&searchName='+document.GroupActionForm.searchName.value+'&searchUser='+document.GroupActionForm.searchUser.value,'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=668,height=450')\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\nfunction search(){\r\n    var searchName=document.frm.searchName.value;\r\n    var searchUser=document.frm.searchUser.value;\r\n    if(searchName.indexOf(\"'\")>=0){\r\n        alert(\"组名称不合法,输入值不能包含:'!\");\r\n        document.frm.searchName.focus();\r\n     }else{\r\n     \t  if(searchUser.indexOf(\"'\")>=0){\r\n\t\t        alert(\"组用户不合法,输入值不能包含:'!\");\r\n\t\t        document.frm.searchUser.focus();\r\n\t\t    }else{\r\n\t\t    \tdocument.frm.submit();\r\n\t\t    }\r\n     }\r\n}\r\n\r\nfunction resetForm(){\r\n");
      out.write("\tdocument.frm.searchName.value=\"\";\r\n\tdocument.frm.searchUser.value=\"\";\r\n\tdocument.frm.submit();\r\n}\r\n//-->\r\n</script>\r\n<script src=\"/jsoa/js/util.js\"></script>");
