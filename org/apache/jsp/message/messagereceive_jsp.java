 ...
 * Generated at: 2023-01-06 09:53:31 UTC
...
public final class messagereceive_jsp extends org.apache.jasper.runtime.HttpJspBase
...
MessageBD mbd = new MessageBD();

      out.write("\r\n<body  class=\"MainFrameBox\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n  <tr>\r\n    <td align=\"right\" nowrap><button class=\"btnButton2Font\" onclick=\"delReceive()\">删除</button>\r\n\t<button class=\"btnButton4Font\" onclick=\"delRealReceive()\">彻底删除</button>\r\n\t<button class=\"btnButton2Font\" onclick=\"delAllReceive()\">清空</button></td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n<form name=\"form1\" action=\"\" method=\"post\">\r\n<TBODY>\r\n\t<tr>\r\n\t\t<td width=\"2%\" nowrap class=\"listTableHead\"><input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n\t\t<td width=\"12%\" class=\"listTableHead\">发信人</td>\r\n\t\t<td width=\"74\" class=\"listTableHead\">内容</td>\r\n\t\t<td width=\"12%\" class=\"listTableHeadLast\">接收时间</td>\r\n\t</tr>\r\n");
	...
	String ss="";
      ...
      try {
        ...
        // /message/messagereceive.jsp(72,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fnotEmpty_005f0.setName("receiveList");
        ...
        if (_jspx_eval_logic_005fnotEmpty_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /message/messagereceive.jsp(73,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("recList");
              // /message/messagereceive.jsp(73,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("receiveList");
              // /message/messagereceive.jsp(73,1) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setScope("request");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object recList = null;
                ...
                recList = (java.lang.Object) _jspx_page_context.findAttribute("recList");
                do {
                  out.write('\r');
                  out.write('\n');
                  out.write('	');

		Object[] obj = (Object[]) recList;
		index ++;
		j ++;
		String listClass="listTableLine1";
		if(index%2 != 0){listClass="listTableLine2";}
		if(!"1".equals(String.valueOf(obj[6]))){
			ss="red";
		}else{
			ss="";
		}
                  ...
                  out.print(ss);
                  out.write("\">\r\n\t\t\t");
if(obj[1].toString().equals("系统管理员") ){
                  out.write("\r\n\t\t\t\t\t\t\t\t\t  系统\r\n\t\t\t\t\t\t\t\t\t  ");
}else{
                  out.write("\r\n\t\t\t\t\t\t\t\t\t  ");
                  out.print(obj[1]);
...
//=listClass
                  ...
                  out.write('>');
//if(!"1".equals(String.valueOf(obj[6]))){
                  out.write("<a href=\"javascript:veiwMsg('");
//=obj[0]
                  out.write("');\"><font color=\"");
//=ss
                  out.write('"');
...
//}
                  ...
                  out.write("</font></a></td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write(" listTableLineLastTD\"><font color=\"");
                  out.print(ss);
                  out.write('"');
                  out.write('>');
                  out.print(obj[3]==null?"":obj[3].toString().substring(0,19));
                  out.write("</font>&nbsp;</td>\r\n\t</tr>\r\n\t");
