...
public final class workflow_005fDossierDatasearch_005fforRWS_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getAttribute("optMsg")!=null) {
            ...
            try {
              ...
              // /jsflow/workflow_DossierDatasearch_forRWS.jsp(184,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/WorkFlowDossierForRWSAction?type=queryData");
              // /jsflow/workflow_DossierDatasearch_forRWS.jsp(184,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if("-2".equals(searchStatus)){out.print("selected");} 
			...
			//办理监控
                  ...
                  out.write("\r\n\t\t</td>\r\n\t\t<td align='right' width=\"10%\"><input type=\"button\" class=\"btnButton4font\" onClick=\"searchAction();\" value=\"");
...
//System.out.println("\n------\n"+(session.getAttribute("js")==null?"":session.getAttribute("js").toString())+"\n--------\n");
            ...
            try {
              ...
              // /jsflow/workflow_DossierDatasearch_forRWS.jsp(267,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("tableHead");
              // /jsflow/workflow_DossierDatasearch_forRWS.jsp(267,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(!"1000003".equals(obj1[6]) && (orderBy == null || !orderBy.equals(obj1[2]))){
            ...
            out.write("\r\n\t<td class=\"listTableHead\">提交时间</td>\r\n\t<td class=\"listTableHead\">");
		...
		String processStatus="0";
            ...
            try {
              ...
              // /jsflow/workflow_DossierDatasearch_forRWS.jsp(294,1) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setId("tableData");
              // /jsflow/workflow_DossierDatasearch_forRWS.jsp(294,1) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
			...
			if(index%2 != 0){
				listClass="listTableLine2";
                  ...
                  out.print(obj[obj.length-7]);
                  out.write(" onclick=\"selectBox(this)\">");
//=i
                  out.write("</td>\r\n\t\t<!--td class=\"");
                  out.print(listClass);
                  out.write("\" rowSpan=1>");
                  out.print(obj[obj.length-4]);
                  out.write("</td-->\r\n\t\t");
for(int k=0;k<tableHeadArr.length;k++){			
		...
		curStatus=obj[obj.length-11].toString();
		submitTime=obj[obj.length-12].toString();
		if(submitTime.indexOf(":")>0){
			submitTime=submitTime.substring(0,submitTime.lastIndexOf(":"));
                  ...
                  out.write("\r\n\t\t</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\"><a href=\"javascript:void(0);\" onclick=\"JSMainWinOpen('/jsoa/jsflow/workflow_listInfo_forRWS.jsp?record=");
                  out.print(obj[obj.length-7]);
			...
			//out.print(obj[obj.length-4]+":<label style=color:red>"+obj[obj.length-5]+"</label>");
			out.print(customBD.getCurStep(obj[obj.length-3].toString()));
	...
	if(!"".equals(sum)){
            ...
            out.print(tableHeadArr.length+4);
            out.write("\">合计：");
            out.print(sum);
            out.write("</td>\r\n\t</tr>\r\n\t");
}
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\";\r\n\threfV+=\"&queryType=");
      out.print(request.getAttribute("queryType"));
      out.write("\";\r\n\threfV+=\"&flag=\"+flag;\r\n\threfV+=\"&endRecordId=\"+recordId;\r\n\tlocation.href=hrefV;\r\n\t\r\n}\r\n function guidang(record,workStatus,curStatus)\r\n{\r\n\tJSMainWinOpen(\"/jsoa/jsflow/workflow_listInfo_forRWS.jsp?record=\"+record+\"&workStatus=\"+workStatus+\"&curStatus=\"+curStatus+\"&fromDossierData=y&gd=1\",\"mygdIframe\",\"\");\r\n\t//var setFileMethod=document.getElementById(\"mygdIframe\").contentWindow;;\r\n\t//setFileMethod.guidang();\r\n\t//alert(\"归档成功！\");\r\n}\r\nfunction yuguidang(tableStr,recordid){\r\n    var hrefV=\"/jsoa/WorkFlowDossierForRWSAction.do?type=yuguidang&recordId=\"+recordid+\"&tableStr=\"\r\n    +tableStr+\"&queryType=");
      out.print(request.getAttribute("queryType"));
      out.write("\"\r\n    +\"&processId=");
      out.print(request.getAttribute("processId"));
      out.write("\"\r\n    +\"&tableId=");
      out.print(request.getAttribute("tableId"));
      out.write("\";\r\n    location.href=hrefV;\r\n}\r\nfunction chexiaoguidang(tableStr,recordid){\r\n  var hrefV=\"/jsoa/WorkFlowDossierForRWSAction.do?type=chexiaoguidang&recordId=\"+recordid+\"&tableStr=\"\r\n    +tableStr+\"&queryType=");
      out.print(request.getAttribute("queryType"));
      out.write("\"\r\n    +\"&processId=");
      out.print(request.getAttribute("processId"));
      out.write("\"\r\n    +\"&tableId=");
...
if("1".equals(com.js.util.config.SystemCommon.getDataExportWithSub())){
      ...
      out.write("\r\nfunction toexcelWithSub1(){\r\n    var ids = document.getElementById(\"selectedId\").value;\r\n    JSMainWinOpen(\"/jsoa/WorkFlowDossierForRWSAction.do?type=toexcelWithSub&processId=");
      out.print(request.getAttribute("processId"));
      out.write("&title=");
      out.print(mailTitle);
      out.write("&tableId=");
      ...
      out.write("\r\nfunction toexcel1(){\r\n    var ids = document.getElementById(\"selectedId\").value;\r\n    JSMainWinOpen(\"/jsoa/WorkFlowDossierForRWSAction.do?type=toexcel&processId=");
      out.print(request.getAttribute("processId"));
      out.write("&tableId=");
      out.print(request.getAttribute("tableId"));
      out.write("&processType=");
...
if(request.getParameter("search")!=null){
      out.write("\r\n\tMyFlowActionForm.action = \"/jsoa/WorkFlowDossierForRWSAction.do?type=queryData&export=toexcelWithSub&ids=\"+document.getElementById(\"selectedId\").value; \r\n\tMyFlowActionForm.target = \"_blank\";\r\n\tMyFlowActionForm.submit();\r\n\t");
}else{
      ...
      out.write("\r\n}\r\nfunction toexcel(){\r\n\t");
if(request.getParameter("search")!=null){
      out.write("\r\n\tMyFlowActionForm.action = \"/jsoa/WorkFlowDossierForRWSAction.do?type=queryData&export=toexcel&ids=\"+document.getElementById(\"selectedId\").value; \r\n\tMyFlowActionForm.target = \"_blank\";\r\n\tMyFlowActionForm.submit();\r\n\t");
}else{
      out.write("\r\n    var ids = document.getElementById(\"selectedId\").value;\r\n    JSMainWinOpen(\"/jsoa/jsflow/toexcel.jsp?type=toexcel&processId=");
      out.print(request.getAttribute("processId"));
      out.write("&tableId=");
      out.print(request.getAttribute("tableId"));
      out.write("&processType=");
...
//=request.getParameter("moduleId")
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_DossierDatasearch_forRWS.jsp(189,16) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f0.setBundle("workflow");
      // /jsflow/workflow_DossierDatasearch_forRWS.jsp(189,16) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_DossierDatasearch_forRWS.jsp(190,165) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f1.setBundle("filetransact");
      // /jsflow/workflow_DossierDatasearch_forRWS.jsp(190,165) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_DossierDatasearch_forRWS.jsp(221,109) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f2.setBundle("common");
      // /jsflow/workflow_DossierDatasearch_forRWS.jsp(221,109) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_DossierDatasearch_forRWS.jsp(222,109) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f3.setBundle("common");
      // /jsflow/workflow_DossierDatasearch_forRWS.jsp(222,109) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_DossierDatasearch_forRWS.jsp(255,302) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setBundle("common");
      // /jsflow/workflow_DossierDatasearch_forRWS.jsp(255,302) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f4.setKey("comm.delselect");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_DossierDatasearch_forRWS.jsp(266,49) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f5.setBundle("filetransact");
      // /jsflow/workflow_DossierDatasearch_forRWS.jsp(266,49) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jsflow/workflow_DossierDatasearch_forRWS.jsp(282,27) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f6.setBundle("filetransact");
      // /jsflow/workflow_DossierDatasearch_forRWS.jsp(282,27) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_bean_005fmessage_005f6.setKey("file.dostatus");
