 ...
 * Generated at: 2023-01-06 09:43:44 UTC
...
public final class kq_005fovertime_005fupdate_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if ("1".equals(request.getParameter("resubmit"))) {
  ...
  calendar.setTime(kqOvertimePO.getStartTime());
      ...
      out.write("\r\n                              <td height=\"32\" nowrap><label style=\"width:7px;\"  class=\"mustFillcolor\"> </label>开始时间：</td>\r\n                              <td ><script language=javascript>\r\n\t\t\t\t\t\t\t\t\tvar dtpDate = createDatePicker(\"start_date\",\"");
  ...
  calendar.setTime(kqOvertimePO.getEndTime());
      ...
      out.write("                                  <option value=\"7:30\">7:30</option>\r\n                                  <option value=\"8:00\" >8:00</option>\r\n                                  <option value=\"8:30\">8:30</option>\r\n                                  <option value=\"9:00\">9:00</option>\r\n                                  <option value=\"9:30\">9:30</option>\r\n                                  <option value=\"10:00\">10:00</option>\r\n                                  <option value=\"10:30\">10:30</option>\r\n                                  <option value=\"11:00\">11:00</option>\r\n                                  <option value=\"11:30\">11:30</option>\r\n                                  <option value=\"12:00\">12:00</option>\r\n                                  <option value=\"12:30\">12:30</option>\r\n                                  <option value=\"13:00\">13:00</option>\r\n                                  <option value=\"13:30\">13:30</option>\r\n                                  <option value=\"14:00\">14:00</option>\r\n                                  <option value=\"14:30\">14:30</option>\r\n");
      out.write("                                  <option value=\"15:00\">15:00</option>\r\n                                  <option value=\"15:30\">15:30</option>\r\n                                  <option value=\"16:00\">16:00</option>\r\n                                  <option value=\"16:30\">16:30</option>\r\n                                  <option value=\"17:00\">17:00</option>\r\n                                  <option value=\"17:30\">17:30</option>\r\n                                  <option value=\"18:00\">18:00</option>\r\n                                  <option value=\"18:30\">18:30</option>\r\n                                  <option value=\"19:00\">19:00</option>\r\n                                  <option value=\"19:30\">19:30</option>\r\n                                  <option value=\"20:00\">20:00</option>\r\n                                  <option value=\"20:30\">20:30</option>\r\n                                  <option value=\"21:00\">21:00</option>\r\n                                  <option value=\"21:30\">21:30</option>\r\n                                  <option value=\"22:00\">22:00</option>\r\n");
      out.write("                                  <option value=\"22:30\">22:30</option>\r\n                                  <option value=\"23:00\">23:00</option>\r\n                                  <option value=\"23:30\">23:30</option>\r\n\t\t\t\t\t\t\t\t  <option value=\"24:00\">24:00</option>\r\n                                </select>\t\t\t\t\t\t\t\t</td>\r\n                            </tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t   <td width=\"80\" height=\"60\"><label class=\"mustFillcolor\" style=\"width:7px;\" > *</label>参与人：</td>\r\n\t   <td colspan=\"3\"><input type=\"hidden\" name=\"userOrgGroup\" value=\"");
      out.print(userandorg);
...
if(!"1".equals(request.getParameter("printFlag")+"")){
	if("1".equals(new SystemCommon().getKeyboardTip())){
      ...
      out.write("</td>\r\n   </tr>\r\n     ");
                            ...
                            String mainLinkFile = "/jsoa/KqOvertimeAction.do?action=update";//文件办理时打开的页面链接
                            String passLinkFile ="/jsoa/KqOvertimeAction.do?action=update";
							String subProcHref = "/jsoa/JsFlowAddAction.do?action=add&moduleId=7";//新建子流程链接
