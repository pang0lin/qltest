 ...
 * Generated at: 2023-01-06 09:47:13 UTC
...
String addGoods = request.getParameter("addGoods")==null?request.getAttribute("addGoods")+"":request.getParameter("addGoods");
if(addGoods==null || "".equals(addGoods) || "null".equals(addGoods)){
  addGoods="0";
}
...
//System.out.println("queryString:"+request.getAttribute("queryString"));
//System.out.println("addGoods:"+addGoods);
      ...
      try {
        ...
        // /routine/resource_manager/goodsList.jsp(111,36) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_logic_005fpresent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /routine/resource_manager/goodsList.jsp(112,38) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("searchGoodsTypeList");
              // /routine/resource_manager/goodsList.jsp(112,38) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  out.write("\r\n                                          ");
                                          ...
                                          String goodsTypeName=goodsTypeObj[3].toString()+"."+goodsTypeObj[1].toString();
                  out.write("\r\n\t\t\t\t\t  <option value=\"");
...
if(request.getParameter("addGoods") != null && "1".equals(request.getParameter("addGoods"))) {
 ...
 if(!((String)request.getAttribute("queryString")).contains("addGoods=") && !"1".equals(addGoods) ) { 
      out.write("\r\n     <td>\r\n     ");
...
if(addRight.booleanValue() && "0".equals(addGoods)){
...
if(!addGoods.equals("1")){
      ...
      try {
        ...
        // /routine/resource_manager/goodsList.jsp(258,22) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f1.setId("goodsList");
        // /routine/resource_manager/goodsList.jsp(258,22) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
//if(!addGoods.equals("1")){
            out.write("\r\n\t\t\t\t\t\t  ");
						  ...
						  //String curKc="2";
						  String goodsObj6 = goodsObj[6]==null?"0":goodsObj[6].toString();
						  if("".equals(goodsObj6)){
						     goodsObj6="0";
						  }
						  if(goodsObj[7]==null||"".equals(goodsObj[7]+"")){
						     goodsObj[7]="0";
						  }
						   if(goodsObj[6]==null||"".equals(goodsObj[6]+"")){
						     goodsObj[6]="0";
						  }
						  if(!addGoods.equals("1")){
...
if(!deleteSuccess.booleanValue()){
 ...
 if(request.getParameter("chuku") != null && request.getParameter("chuku").equals("1")){ 
	...
	if(BrowserJudge.isMSIE(request)){
      ...
      out.write("\r\n\t\t\t\t\t\t\t\t\tstrValue = \"<input type=hidden name=kc value=\" + goodsTable.rows[j + 1].cells[8].innerHTML + \">\";\r\n\t\t\t\t\t\t\t\t\t//strValue += \"<input type=text name=useNamestr readonly=true value=\" + ssUseMan + \">\";\r\n\t\t\t\t\t\t\t\t\t");
