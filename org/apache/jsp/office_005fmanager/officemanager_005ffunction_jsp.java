...
public final class officemanager_005ffunction_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getAttribute("fromSystem")!=null && !"".equals(request.getAttribute("fromSystem").toString()) && !"null".equals(request.getAttribute("fromSystem").toString())){
 ...
 String searchDutyLevel = request.getParameter("searchDutyLevel")==null?"":request.getParameter("searchDutyLevel");
            ...
            out.write("\r\n</head>\r\n<body   class=\"MainFrameBox\" onKeyDown=\"if(event.keyCode==13) setEnter();\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<form name=\"form1\" action=\"/jsoa/DutyAction.do?action=search\"  method=\"post\" >\r\n<input type=\"hidden\" name=\"fromSystem\" value=\"");
            out.print(fromSystem );
            out.write("\">\r\n<table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\" id=\"searchbar\" style=\"display:none\">\r\n\t<tr>\r\n\t<td width=\"20\" rowspan=\"5\"></td>\r\n    <td width=\"293\"> 职务名称：\r\n\t<input type=\"text\" onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'职务名称')\" onblur=\"value=checkQuery1(this,'职务名称')\" Class=\"inputtext\" name=\"searchDutyName\" maxlength=\"20\"  style=\"width:120px;\"  value=\"");
            out.print(searchDutyName);
            out.write("\"/></td>\r\n    <td width=\"318\" > 职务级别：\r\n     <input type=\"text\" onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'职务级别')\" onblur=\"value=checkQuery1(this,'职务级别')\" class=\"inputtext\" name=\"searchDutyLevel\" maxlength=\"3\" size=\"10\"  style=\"width:120px;\" value=\"");
            out.print(searchDutyLevel);
            out.write("\"/></td>\r\n    <td width=\"298\" align=\"right\" ><input type=\"button\" class=\"btnButton2font\" onClick=\"search();\" value=\"查询\"/>\r\n\t<input type=\"button\" class=\"btnButton2font\" onClick=\"searchClear();\" value=\"重置\"/>\r\n   </td>\r\n  <td width=\"16\" rowspan=\"5\" align=\"center\" valign=\"middle\"></td>\r\n  </tr>\r\n</table>\r\n</form>\r\n</td>\r\n</tr>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<tr>\r\n<td>\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"inlineBottomLine\">\r\n  <tr>\r\n    ");
if(!"1".equals(fromSystem)){ 
            out.write("\r\n    <td>\r\n    ");
//if (newRight3||newRight4){ 
            out.write("\r\n\t  <div id=\"PanleDIV\"  class=\"tabPanelSelected\" onClick=\"changePanle(this,'/jsoa/DutyAction.do?action=view');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">职务</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n    ");
//}if(managerBD.hasRight(userId, "04*01*02")){
            out.write("  \r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/StationAction.do');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">岗位</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n    ");
//} 
            out.write("  \r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/EmpChangeAction.do?action=empChangTypeView');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">人事调整类型</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/ExaminationTypeAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">试题类型</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n");
            out.write('\r');
            out.write('\n');
            out.write('\r');
            out.write('\n');
            ...
            out.write('\r');
            out.write('\n');
            out.write("\r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/WorkAddressAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">办公地点</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/PersonalKindAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">人员性质</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n      <div class=\"btnBQspace AlignLeft\"></div>\r\n\t    <div id=\"PanleDIV\" class=\"tabPanel\" onClick=\"changePanle(this,'/jsoa/EmpRemindAction.do?action=list');\">\r\n        <div class=\"tabPanelLeft\"></div>\r\n        <div class=\"tabPanelCenter\">人事提醒</div>\r\n        <div class=\"tabPanelRight\"></div>      \r\n      </div>\r\n\t</td>\r\n\t");
} 
            out.write("\r\n     \r\n\t  <td align=\"right\">\r\n\t  <input type=\"button\" class=\"btnButton2Font\" onclick=\"MM_openBrWindow('/jsoa/DutyAction.do?action=add&fromSystem=");
            out.print(fromSystem );
            out.write("','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=300')\" value=\"新增\"/>\r\n\t  <input type=\"button\" class=\"btnButton2Font\" onclick=\"batchDel();\" value=\"删除\"/>\r\n\t  <input type=\"button\" class=\"btnButton2Font\" id=\"btnButton2FontShow\" onClick=\"showSearch();\" value=\"查询\"/>\r\n\t  <input type=\"button\" class=\"btnButton2font\" onClick=\"javascript:uploadtemplate(10,2);\" value=\"导入\"/>\r\n      <input type=\"button\" class=\"btnButton2font\" onClick=\"javascript:downloadtemplate(10);\" value=\"下载模版\"/>\r\n      <input type=\"button\" class=\"btnButton2Font\" id=\"btnButton2FontClose\" onClick=\"closeSearch();\" style=\"display:none\" value=\"关闭查询\"/>\r\n\t  <a id=\"downloadtemplate\" ></a>\r\n\t  </td> \r\n    </tr>\r\n</table>\r\n</td>\r\n</tr>\r\n\r\n\r\n<!-- LIST TITLE PART -->\r\n\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n    ");
            //  html:form
            ...
            try {
              ...
              // /office_manager/officemanager_function.jsp(158,4) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		Object[] obj;
                  ...
                  try {
                    ...
                    // /office_manager/officemanager_function.jsp(173,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("DutyList");
                    // /office_manager/officemanager_function.jsp(173,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("dutyList");
                    // /office_manager/officemanager_function.jsp(173,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setScope("request");
                    int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
                    if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      java.lang.Object DutyList = null;
                      ...
                      DutyList = (java.lang.Object) _jspx_page_context.findAttribute("DutyList");
                      do {
                        out.write("\r\n\t\t\t");
...
if(index%2 == 0){
                        ...
                        out.write("</td>\r\n\t\t\t\t<td class=\"");
                        out.print(listClass);
                        out.write(" listTableLineLastTD\"  nowrap align=\"center\"><div align=\"left\">\r\n\t\t\t\t");
if(SystemCommon.getMultiDepart()==0){ 
                        out.write("\r\n\t\t\t\t<img src=\"images/modi.gif\" title=\"修改\" style=\"cursor:pointer\" onclick=\"modify('");
                        out.print(obj[0]);
                        out.write("')\" >&nbsp;\r\n\t\t\t\t<img src=\"/jsoa/images/del.gif\" style=\"cursor:pointer\" title=\"删除\" onclick=\"del('");
                        out.print(obj[0]);
                        out.write("');\" >&nbsp;\r\n\t\t\t\t");
}else{ 
				if(session.getAttribute("sysManager").toString().indexOf("1")>=0&&request.getParameter("fromSystem")!=null&&
						request.getParameter("fromSystem").equals("1")){
                        out.write("\r\n\t\t\t\t<img src=\"images/modi.gif\" title=\"修改\" style=\"cursor:pointer\" onclick=\"modify('");
                        out.print(obj[0]);
                        out.write("')\" >&nbsp;\r\n\t\t\t\t<img src=\"/jsoa/images/del.gif\" style=\"cursor:pointer\" title=\"删除\" onclick=\"del('");
                        out.print(obj[0]);
            ...
            out.write("\r\n</table>\r\n\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"pagebar\">\r\n  <tr>\r\n     <td style=\"padding-top:5px;\">&nbsp;<label class=\"TextDescriptionColor\">职务级别0为最大级别、1其次，数字越大职级越小</label>\r\n\t  </td>\r\n    <td style=\"padding-top:5px;\">\r\n\t\t");
String pagerURL = "/jsoa/DutyAction.do";
            out.write("\r\n        ");
