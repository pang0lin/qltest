...
public final class datasync_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.js.oa.datasync.bean.DataSyncEJBBean");
  }
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write(".css\" rel=\"stylesheet\" type=\"text/css\" />\r\n</head>\r\n\r\n<body  class=\"MainFrameBox\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<table width=\"100%\" height=\"25\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"inlineBottomLine\">  \r\n  <tr>\r\n    <td align=\"right\">\r\n\t<button class=\"btnButton2Font\" onClick=\"JSMainWinOpen('DataSyncAction.do?action=toAddSync','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=668,height=450');\">新增</button>\r\n\t<button class=\"btnButton2Font\" onClick=\"delBatch();\">删除</button>\r\n\t</td>\r\n</tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable\">\r\n   <form action=\"\" name=\"form1\" method=\"post\">\r\n     <tr align=\"center\">\r\n\t\t<td  width=\"3%\" class=\"listTableHead\"><input type=\"checkbox\" name=\"selectAll\" onclick=\"javascript:selectAllItem();\"></td>\r\n\t\t<td width=\"20%\" class=\"listTableHead\">同步名称</td>\r\n\t\t<td width=\"20%\" class=\"listTableHead\">关联流程</td>\r\n\t\t<td width=\"40%\" class=\"listTableHead\">备注</td>\r\n\t\t<td width=\"8%\" class=\"listTableHeadLast\">处理</td>\r\n");
            out.write("\t  </tr>\r\n\t ");
            ...
            try {
              ...
              // /datasync/datasync_list.jsp(59,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("dataSyncList");
              // /datasync/datasync_list.jsp(59,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("dataSyncList");
              // /datasync/datasync_list.jsp(59,2) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setScope("request");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object dataSyncList = null;
                ...
                dataSyncList = (java.lang.Object) _jspx_page_context.findAttribute("dataSyncList");
                do {
                  out.write("\r\n\t \r\n\t ");

	    Object[] obj = (Object[]) dataSyncList;
		index ++;
		if(index%2 != 0){
		  ...
		  DataSyncEJBBean db = new DataSyncEJBBean();
		  String name;
		  com.js.oa.jsflow.po.WFWorkFlowProcessPO po=db.getWFWorkFlowProcessPOById(Long.valueOf(obj[3].toString()));
		  if(po!=null){
			  name=po.getWorkFlowProcessName();
		  }else{
			  name="&nbsp;";
		  }
                  ...
                  out.write("</td>\r\n\t\t  <td class=\"");
                  out.print(listClass);
                  out.write("\">\r\n\t\t  \t<img  style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" alt=\"修改\" onclick=\"JSMainWinOpen('/jsoa/DataSyncAction.do?action=toUpdateSync&id='+");
                  out.print(obj[0]);
                  out.write(",'','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=668,height=450')\">&nbsp;\r\n\t\t  \t<img  style=\"cursor:pointer\" border=\"0\" src=\"images/del.gif\" alt=\"删除\" onclick=\"javascript:del('");
                  out.print(obj[0]);
                  out.write("')\">&nbsp;\r\n\t\t  \t<img  style=\"cursor:pointer\" border=\"0\" src=\"/jsoa/imges/di1.gif\" alt=\"添加\" onclick=\"javascript:add('");
                  out.print(obj[0]);
                  out.write("')\">&nbsp;</td>\r\n\t\t</tr>\r\n\t  ");
...
String pagerURL = "/jsoa/DataSyncAction.do";
            out.write("\r\n\t\t ");
...
if(!currentPageNumber.equals(pageCount)){
      ...
      out.write("\r\n<script language=\"javascript\">\r\n<!--\r\nfunction delBatch() {\r\n\tvar strId=getCheckBoxID();\r\n    if(strId!=\"\"){\r\n        if(confirm(\"确实要删除吗？\")){\r\n            window.location.href=\"/jsoa/DataSyncAction.do?action=deleteSync&ids=\"+strId;\r\n        }\r\n    }else{\r\n        alert(\"请选择要删除的记录！\");\r\n        return;\r\n    }\r\n}\r\n\r\nfunction getCheckBoxID() {\r\n    var copyitem=\"\";\r\n\t  var a = document.getElementsByName(\"batchDel\");\r\n\t\tif(a.length>1){\r\n\t\t\t for(var i=0;i<document.all.batchDel.length;i++){\r\n\t\t\t\t if(document.all.batchDel[i].checked){\r\n\t\t\t\t\t var tmp=document.all.batchDel[i].value.split(\",\");\r\n\t\t\t\t\t copyitem+=tmp[0]+\",\";\r\n\t\t\t\t }\r\n\t\t\t}\r\n\t\t }\r\n\t\t if(a.length==1){\r\n\t\t\t if(document.all.batchDel.checked){\r\n\t\t\t\t var tmp=document.all.batchDel.value.split(\",\");\r\n\t\t\t\t copyitem=tmp[0];\r\n\t\t\t }\r\n\t\t }\r\n\t  if(copyitem==\"\"){\r\n\t    alert(\"至少选择一条!\");\r\n\t\treturn false;\r\n\t  }\r\n    return copyitem;\r\n}\r\n\r\nfunction del(id){\r\n    if(confirm(\"确实要删除吗？\")){\r\n        window.location.href=\"/jsoa/DataSyncAction.do?action=deleteSync&ids=\"+id+\",\";\r\n");
      out.write("    }\r\n}\r\n\r\nfunction add(id){\r\n        window.location.href=\"/jsoa/DataSyncAction.do?action=detailList&syncId=\"+id;\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\n//-->\r\n</script>\r\n\r\n<script src=\"/jsoa/js/util.js\"></script>");
