 ...
 * Generated at: 2023-01-06 09:47:17 UTC
...
public final class outStockList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
StockBD sbd = new StockBD();
String[] objs = sbd.getSingleStock(request.getParameter("stockId"));
boolean isModify = false;
if(objs != null){
	String stockPut = objs[1].toString();
	if(stockPut.indexOf("$"+userId+"$")!=-1){
		isModify = true;
	}
}
...
if(!deleteSuccess.booleanValue()){
      ...
      out.write("\r\n\t  <td>\r\n\t\t   出库单号：\r\n\t\t   <input type=\"text\" onkeypress=\"return look() ;\" onkeyup=\"value=checkQuery(this,'出库单号')\" onblur=\"value=checkQuery1(this,'出库单号')\" class=\"inputText\" style=\"width:105px\" size=\"18\" name=\"searchId\" value=\"");
      out.print(searchId);
...
Object[] searchDeptObj = null;
      ...
      try {
        ...
        // /routine/resource_manager/outStockList.jsp(137,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fpresent_005f0.setName("searchDeptList");
        ...
        if (_jspx_eval_logic_005fpresent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /routine/resource_manager/outStockList.jsp(138,5) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("searchDeptList");
              // /routine/resource_manager/outStockList.jsp(138,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if ("1".equals(flag)) {
      ...
      out.write("\r\n\t\t</td>\r\n\t\t<td >\r\n\t  \t\t使用人：&nbsp;&nbsp;&nbsp;<input type=\"text\" id=\"useMan\" name=\"useMan\" class=\"inputText\" style=\"width:105px\" class=\"inputText\" size=\"18\"  value=\"");
      out.print(useMan);
...
if("1".equals(stockShow)){
	...
	if(isStockPut.equals("1")){
      ...
      out.write("\r\n\t <input type=\"button\" id=\"hiddenSearch\"  class=\"btnButton4Font\" onClick=\"hidserch()\" value=\"查询\" />\r\n\t  </td>\r\n\t</tr>\r\n</table>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n\r\n\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\t<tr align=\"center\">\r\n\t\t<td width=\"40\" height=\"28\" class=\"listTableHead\" nowrap><input type=\"checkbox\" value=\"1\" name=\"selectAllBox\" onclick=\"selectAll(this);\"></td>\r\n\t\t<td class=\"listTableHead\" width=\"10%\"> 出库单号 </td>\r\n\t\t<td class=\"listTableHead\" width=\"15%\"> 申请出库日期 </td>\r\n\t\t<td class=\"listTableHead\" > 领用部门 </td>\r\n\t    <td class=\"listTableHead\" width=\"10%\"> 使用人 </td> \r\n\t\t<td class=\"listTableHead\" width=\"10%\"> 制单人 </td>\r\n\t\t<td class=\"listTableHead\" width=\"10%\"> 状态 </td>\r\n\t\t<td class=\"listTableHeadLast\" width=\"8%\"> 处理 </td>\r\n   </tr>\r\n\t\t  ");
		  ...
		  int now_year = new Date().getYear() + 1900;
		  int now_month = new Date().getMonth() + 1;
      ...
      try {
        ...
        // /routine/resource_manager/outStockList.jsp(255,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fpresent_005f1.setName("intoStockList");
        ...
        if (_jspx_eval_logic_005fpresent_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /routine/resource_manager/outStockList.jsp(256,4) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f1.setId("intoStockList");
              // /routine/resource_manager/outStockList.jsp(256,4) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
			...
			boolean zf = false;
			Date zkrq = (Date) intoStockObj[1];
			int zkrq_y = zkrq.getYear() + 1900;
			int zkrq_m = zkrq.getMonth() + 1;
			if(zkrq_y <now_year || (zkrq_y == now_year && zkrq_m < now_month)){
				zf = true;
			}
...
if(intoStockObj[3].toString().equals("Y")&& intoStockObj[5].toString().equals("0")){
                  ...
                  out.write('"');
                  out.write('>');
                  out.print(intoStockObj[6]==null?"&nbsp;":StaticParam.getOrgByNum(intoStockObj[6]+""));
                  out.write("</td>\r\n\t\t\t  <td class=\"");
                  out.print(listClass);
                  out.write('"');
                  out.write('>');
                  ...
                  out.write('"');
                  out.write('>');
if(!intoStockObj[5].toString().equals("1")&&intoStockObj[3].toString().equals("Y")&&isModify){
                  out.write("<img src=\"images/modi.gif\" title=\"修改\" style=\"cursor:pointer\" onClick=\"modify2('");
                  out.print(intoStockObj[0]);
                  out.write("', '");
                  out.print(intoStockObj[3]);
                  out.write("')\" >");
if(zf){
                  out.write("&nbsp;<img src=\"images/toolbar/delete.gif\" title=\"作废\" width=\"16\" height=\"16\" style=\"cursor:pointer\" onClick=\"zf('");
                  out.print(intoStockObj[0]);
                  out.write("')\" >");
}}
if(intoStockObj[3].toString().equals("Y")){
                  out.write("&nbsp;<img src=\"images/print.gif\" title=\"打印\" style=\"cursor:pointer\" onClick=\"myPrint('");
                  out.print(intoStockObj[0]);
                  out.write("', '");
                  out.print(intoStockObj[3]);
                  out.write("')\" > ");
...
if(!currentPageNumber.equals(pageCount)){
	...
	if(request.getAttribute("deleteSuccess") != null && ((Boolean)request.getAttribute("deleteSuccess")).booleanValue()){

      out.write("\r\n\talert(\"作废成功！\");\r\n");
}
      out.write("\r\nfunction search(){\r\n//    var tmp = form2.searchId.value;\r\n//    if(tmp.length>=1 && isNaN(tmp)){\r\n//        alert(\"领用单号必须为数字!\");\r\n//        return false;\r\n//    }\r\n    form2.action = \"/jsoa/OutStockAction.do?flag=search&mode=outStock\";\r\n    form2.action += \"&stockName=");
      out.print(request.getParameter("stockName"));
      out.write("&stockId=");
      out.print(request.getParameter("stockId"));
      out.write("&processId=");
      ...
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("&mode=outStock&canview=0','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=640,height=500')\r\n}\r\n\r\nfunction modify2(id, checkFlag){ MM_openBrWindow('/jsoa/OutStockAction.do?temp=no&flag=listLoad&stockId=");
      out.print(request.getParameter("stockId"));
      out.write("&checkFlag=' + checkFlag + '&record=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("&mode=outStock&canview=0&isModify=");
      out.print(isModify?"true":"false");
      ...
      out.write("&checkFlag=' + checkFlag + '&record=' + id + '");
      out.print(request.getParameter("pager.offset")==null?"":"&pager.offset=" + request.getParameter("pager.offset"));
      out.write("&mode=outStock&canview=1','','')\r\n}\r\n\r\n");
