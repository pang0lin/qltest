 ...
 * Generated at: 2023-01-06 09:43:23 UTC
...
public final class kq_005foutsidecheckinfo_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String userId = null!=request.getAttribute("userId") ? request.getAttribute("userId").toString() : "";
String userName = null!=request.getAttribute("userName") ? request.getAttribute("userName").toString() : "";
String orgId = null!=request.getAttribute("orgId") ? request.getAttribute("orgId").toString() : "";
String orgName = null!=request.getAttribute("orgName") ? request.getAttribute("orgName").toString() : "";
String start = null!=request.getAttribute("start") ? request.getAttribute("start").toString() : "";
String end = null!=request.getAttribute("end") ? request.getAttribute("end").toString() : "";
String position = null!=request.getAttribute("position") ? request.getAttribute("position").toString() : "";
String byTime = null!=request.getAttribute("byTime") ? request.getAttribute("byTime").toString() : "";
...
if(!"".equals(end)){
	...
	nowDay = Integer.parseInt(end.split("-")[2]);
      ...
      out.write("\t\t\topenEndow('userId','userName',checkinForm.userId.value,checkinForm.userName.value,'user','yes','user','");
      out.print(range);
      out.write("');\r\n\t\t}\r\n\t\tfunction selectOrg(){\r\n\t\t\topenEndow('orgId','orgName',checkinForm.orgId.value,checkinForm.orgName.value,'org','yes','org','");
      out.print(range);
      out.write("');\r\n\t\t}\r\n\t\t\r\n\t\tfunction openInfo(id,username,imageurl,position,time,customName,reason) {\r\n\t\t    JSMainWinOpen2NoResizeable('/jsoa/kqCheckinInfoAction.do?action=outsidereadload&customName='+customName+'&reason='+reason+'&id='+id+'&username='+username+'&imageurl='+imageurl+'&time='+time+'&position='+position,'','',560,520);\r\n\t\t}\r\n\t\t\r\n\t\tfunction toexcelWithSub(){\r\n\t\t  var userId=document.getElementById(\"userId\").value;\r\n\t\t  var orgId=document.getElementById(\"orgId\").value;\r\n\t\t  var position=document.getElementById(\"position\").value;\r\n\t\t  \r\n\t\t  var startTime=document.getElementById(\"startTime\").value;\r\n\t\t  var endTime=document.getElementById(\"endTime\").value;\r\n\t\t  var byTime=\"\";\r\n\t\t  if(document.getElementById(\"byTime\").checked){\r\n\t\t     byTime=\"1\";\r\n\t\t  }else{\r\n\t\t    byTime=\"\";\r\n\t\t  }\r\n\t\t  \r\n\t\t   var sms = document.getElementsByName(\"InnerPersonId\");\r\n\t\t   var ids = \"\";\r\n\t\t   for(var i=0;i<sms.length;i++){\r\n\t\t\t\tif(sms[i].checked){\r\n\t\t\t\t    if(i==sms.length-1){\r\n\t\t\t\t       ids += sms[i].value;\r\n\t\t\t\t    }else{\r\n\t\t\t\t       ids += sms[i].value+\",\";\r\n");
      out.write("\t\t\t\t    }\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t  \r\n          JSMainWinOpen(\"/jsoa/kqCheckinInfoAction.do?action=exportoutsidelist&ids=\"+ids+\"&orgId=\"+orgId+\"&userId=\"+userId+\"&position=\"+position+\"&startTime=\"+startTime+\"&endTime=\"+endTime+\"&byTime=\"+byTime+\"  \");\r\n        }\r\n        \r\n        function selectAll(obj){\r\n\t\t\tvar sms = document.getElementsByName(\"InnerPersonId\");\r\n\t\t\tif(obj.checked){\r\n\t\t\t\tfor(var i=0;i<sms.length;i++){\r\n\t\t\t\t\tsms[i].checked=true;\r\n\t\t\t\t}\r\n\t\t\t}else{\r\n\t\t\t\tfor(var i=0;i<sms.length;i++){\r\n\t\t\t\t\tsms[i].checked=false;\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t}\r\n\t\t</script>\r\n\t</head>\r\n\r\n\t<body class=\"MainFrameBox\">\r\n\t    <DIV id=\"mytips\" style=\"BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; DISPLAY: none; FONT-SIZE: 9pt; FILTER: progid: DXImageTransform.Microsoft.Shadow(color=#999999,direction=135,strength=3); BORDER-LEFT: gray 1px solid; WIDTH: 150px; COLOR: red; BORDER-BOTTOM: gray 1px solid; POSITION: absolute; HEIGHT: 120px; BACKGROUND-COLOR: #ffffff\">\r\n\t\t<p>&nbsp;</p>\r\n\t\t<p>&nbsp;</p>\r\n\t    </DIV>\r\n\t\t<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n");
      out.write("\t\t\t<tr>\r\n\t\t\t\t<td>\r\n\t\t\t\t\t<form id=\"checkinForm\" name=\"checkinForm\"  action=\"/jsoa/kqCheckinInfoAction.do?action=outsidelist\" method=\"post\">\r\n\t\t\t\t\t\t<table width=\"100%\" border=\"0\" id=\"searchtable\" style=\"display:none;\" align=\"center\" cellpadding=\"1\" cellspacing=\"1\" class=\"searchbar\">\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td width=\"20px\" ></td>\r\n\t\t\t\t\t\t\t\t<td align=\"right\">部门：</td>\r\n\t\t\t\t\t\t\t\t<td align=\"left\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"orgName\" id=\"orgName\" value=\"");
      out.print(orgName );
      ...
      try {
        ...
        // /kq/kq_outsidecheckinfo_list.jsp(265,6) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("List");
        // /kq/kq_outsidecheckinfo_list.jsp(265,6) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("tableList");
        // /kq/kq_outsidecheckinfo_list.jsp(265,6) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            out.write("\r\n\t\t\t\t\t\t\t");
							...
							//打卡时间格式显示为yyyy-MM-dd HH:mm:ss
							String time = null!=obj[1] ? obj[1].toString() : "";
            ...
            out.write("\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t    <td class=\"");
            out.print(listClass);
            out.write("\"><input type=\"checkbox\" name=\"InnerPersonId\" value=\"");
            out.print(obj[4] );
            out.write("\" ></td>\r\n\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">&nbsp;");
            out.print(null!=obj[7] ? obj[7] : "" );
            out.write("</td>\r\n\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">&nbsp;<a  href=\"javascript:openInfo('");
            out.print(obj[4]);
            out.write('\'');
            out.write(',');
            out.write('\'');
            ...
            out.print(listClass);
            out.write("\">&nbsp;");
            out.print(null!=obj[5] ? obj[5] : "" );
            out.write("</td>\r\n\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">&nbsp;");
            out.print(null!=obj[6] ? obj[6] : "" );
            out.write("</td>\r\n\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t<td class=\"");
            out.print(listClass);
            out.write("\">&nbsp;");
            out.print(null!=obj[2] ? obj[2] : "" );
            out.write("</td>\r\n\t\t\t\t\t\t\t  <td class=\"");
            out.print(listClass);
            out.write("\">\r\n\t\t\t\t\t\t     ");
