...
public class LogPO implements Serializable {
  ...
  public LogPO(Long logId, String empId, String empName, String empOrgName, String moduleSerial, Date oprStartTime, Date oprEndTime, String oprSubModule, String oprType, String oprContent, String logIP, String domainId) {
    this.logId = logId;
    this.empId = empId;
  ...
  public LogPO(Long logId, String doaminId) {
    this.logId = logId;
  ...
  public boolean equals(Object other) {
    if (!(other instanceof LogPO))
      return false; 
    LogPO castOther = (LogPO)other;
