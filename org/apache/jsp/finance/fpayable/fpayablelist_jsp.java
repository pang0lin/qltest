 ...
 * Generated at: 2023-01-06 10:06:30 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.finance.fpayable;
...
public final class fpayablelist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if("1".equals(searchTime)){out.print("checked");}
	    ...
	    String canEidt=request.getAttribute("canEdit")==null?(new com.js.system.manager.service.ManagerService().hasRight(session.getAttribute("userId").toString(), "07*55*10")?"1":""):request.getAttribute("canEdit").toString();
	    if("1".equals(canEidt)){
	    ...
	    if("1".equals(canEidt)){
            ...
            out.write("\r\n\t\t<input type=\"button\" class=\"btnButton2font\" onClick=\"javascript:uploadtemplate(7,2);\" value=\"导入\"/>\r\n      \t<input type=\"button\" class=\"btnButton2font\" onClick=\"javascript:downloadtemplate(7);\" value=\"下载模版\"/>\r\n\t\t\t");
            ...
            try {
              ...
              // /finance/fpayable/fpayablelist.jsp(121,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/oaSysRemindAction");
              // /finance/fpayable/fpayablelist.jsp(121,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if(null!=showList&&showList.size()>0){ 
			for(int i=0;i<showList.size();i++){
				Object obj[]=(Object[])showList.get(i);
                  ...
                  out.write("\r\n\t\t\t<td  class=\"listTableHead\" width=\"60px\" nowrap id=\"tdWidth\">");
                  out.print(obj[2] );
                  out.write("</td>\t\r\n\t\t");
	}
			} 
                  out.write("\r\n\t\t<td  class=\"listTableHead\" id=\"tdWidth\" >内容</td>\r\n\t\t<td  width=\"110px\"  class=\"listTableHead\" id=\"tdWidth\" >录入时间</td>\r\n\t\t<td  width=\"90px\"  class=\"listTableHead\" id=\"tdWidth\">操作</td>\r\n  </tr>\r\n  ");
  ...
  for(int i=0;null!=datas&&i<datas.length;i++){
 	...
 	if(index%2 != 0){
 	     ...
 	     listClass="listTableLine1";
                  ...
                  out.print(datas[i][0]);
                  out.write("\"></td>\r\n        ");
for(int j=1;j<(datas[i].length-3);j++){ 
                  out.write("\r\n        <td  class=\"");
                  out.print(listClass);
                  out.write("\" title=");
                  ...
                  out.print((null==datas[i][datas[i].length-3]||"".equals(datas[i][datas[i].length-3]))?"&nbsp;":datas[i][datas[i].length-3].toString());
                  out.write("\r\n\t\t </div>\r\n\t\t</td>\r\n\t\t<td class=\"");
                  out.print(listClass);
                  out.write("\">\r\n\t\t");
...
String pagerURL = "/jsoa/fPayableAction.do";
            out.write("\r\n\t\t\t\t\t\t\t\t\t");
