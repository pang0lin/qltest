...
public final class pro_005fmore_005ftask_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if("1".equals(userRoll)){
      out.write("\r\n\t\t<button  onclick=\"add();\"  class=\"btnButton4font\" >新建任务</button>\r\n\t\t");
} 
      out.write('\r');
      out.write('\n');
      out.write('	');
if(projectId_!=null){
      ...
      out.write("\r\n\t</td>\r\n  </tr>\r\n</table>\r\n\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n<tr align=\"center\">\r\n\t\t<td width=\"50%\" class=\"listTableHead\">任务名称</td>\r\n\t\t<td width=\"15%\" class=\"listTableHead\">开始日期</td>\r\n\t\t<td width=\"15%\" class=\"listTableHead\">任务进度</td>\r\n\t\t<td width=\"15%\" class=\"listTableHead\">负责人</td>\r\n\t  </tr>\r\n\t  \t  ");
String listClass="listTableLine1";
      ...
      try {
        ...
        // /relproject/pro_more_task.jsp(101,0) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setId("list");
        // /relproject/pro_more_task.jsp(101,0) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_logic_005fiterate_005f0.setName("list");
        // /relproject/pro_more_task.jsp(101,0) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
		...
		countRecordCount ++ ;
            ...
            out.write("\r\n\t\t<tr>\r\n\t\t\r\n\t\t   <td class=\"");
            out.print(listClass);
            out.write("\" style=\"padding:0px;padding-left:3px;\" ><a href=\"javascript:void(0);\" onclick=\"openTask('");
            out.print(obj[0]);
            out.write('\'');
            out.write(',');
            out.write('\'');
