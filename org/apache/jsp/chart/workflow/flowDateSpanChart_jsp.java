...
public final class flowDateSpanChart_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String filenamezhe= (String)request.getAttribute("filenamezhe");
      ...
      try {
        ...
        if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write(".css\" rel=\"stylesheet\" type=\"text/css\" />\r\n<script\tsrc=\"js/js.js\" language=\"javascript\"></script>\r\n<!--  STYLE\tCHANGE START -->\r\n<style><!--\r\n.head\r\n\t{font-size:20.0pt;\r\n\tfont-weight:700;\r\n\ttext-align:center;}\r\n-->\r\n</style>\r\n<script language=\"JavaScript\" type=\"text/JavaScript\">\r\n<!--\r\nfunction MM_openBrWindow(theURL,winName,features) { //v2.0\r\n  JSMainWinOpen(theURL,winName,features);\r\n}\r\ndocument.onkeydown=look;\r\nfunction look(){\r\n\tif(event.keyCode==13){\r\n\t\tsearch();\r\n\t}\r\n}\r\nfunction showData(){\r\n\twindow.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/chartWorkFlow.do?action=flowDateSpanDataList&flowStatus=");
            out.print(request.getAttribute("flowStatus"));
            out.write("\"\r\n\t+\"&searchOrg=");
            out.print(request.getAttribute("searchOrg"));
            out.write("&pager.offset=");
            out.print(request.getAttribute("offset"));
            out.write("&searchOrgName=");
            out.print(request.getAttribute("searchOrgName"));
            out.write("\"\r\n\t+\"&oprStartTime=");
            out.print(request.getAttribute("oprStartTime"));
            out.write("&oprEndTime=");
            out.print(request.getAttribute("oprEndTime"));
            out.write("&searchTime=");
            out.print(request.getAttribute("searchTime"));
            out.write("\";\r\n}\r\n//-->\r\n</script>\r\n<script language=\"JavaScript\" src=\"js/date0.js\"></script>\r\n</head>\r\n\r\n<body  class=\"MainFrameBox\">\r\n\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n<table width=\"100%\"\theight=\"25\"\tborder=\"0\" cellpadding=\"0\" cellspacing=\"0\" >\r\n\t<tr height=\"22\">\r\n        <td align=\"center\" class=\"head\" colspan=\"2\">\r\n\t\t\t事项状态分析-图示\r\n\t\t</td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td align=\"right\">\r\n\t\t<button  class=\"btnButton2Font\" onclick=\"showData();\">返回</button>\r\n\t\t</td>\r\n\t</tr>\r\n</table>\r\n</td>\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<br />\r\n</tr>\r\n<tr>\r\n<td>\r\n<!-- SEARCH\tPART -->\r\n\r\n<!-- SEARCH\tPART -->\r\n\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<!-- MIDDLE\tBUTTONS\t-->\r\n<br />\r\n<!-- LIST TITLE PART -->\r\n<!--table width=\"100%\"  border=\"1\" align=\"center\" cellpadding=\"1\" cellspacing=\"0\" bordercolorlight=\"#000000\" bordercolordark=\"#FFFFFF\"-->\r\n<table width=\"100%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n\t<tr align=\"center\">\r\n\t\t<td width=\"100%\"><img src=\"");
            out.print( request.getContextPath() + "/DisplayChart?filename=" +filenamezhe);
            out.write("\" width=700 height=450 border=0 usemap=\"#");
            out.print(filenamezhe);
