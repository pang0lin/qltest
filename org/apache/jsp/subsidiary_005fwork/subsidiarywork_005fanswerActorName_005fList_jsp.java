 ...
 * Generated at: 2023-01-06 09:50:29 UTC
...
public final class subsidiarywork_005fanswerActorName_005fList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        if(request.getAttribute("searchActorId") !=null){
        searchActorId = request.getAttribute("searchActorId").toString();
        }
        String searchActorName = "";
        if(request.getAttribute("searchActorName") !=null){
        searchActorName = request.getAttribute("searchActorName").toString();
        }
	...
	String sszzDesc = "none" ;
    if(request.getParameter("sszzDesc")!=null) {
      sszzDesc = request.getParameter("sszzDesc") ;
    }
    String tpsjDesc = "none" ;
    if(request.getParameter("tpsjDesc")!=null) {
       tpsjDesc = request.getParameter("tpsjDesc") ;
    }
...
if(request.getParameter("sortFirst")!=null) {
    sortFirst = request.getParameter("sortFirst") ;
            ...
            out.write("\r\n<body   class=\"MainFrameBox\" onload=\"resizeWin(800,600);initSort();\" onKeyDown=\"if(event.keyCode==13) search();\">\r\n<table width=\"100%\" border=0 cellpadding=\"0\" cellspacing=\"0\">\r\n<tr>\r\n<td>\r\n ");
            //  html:form
            ...
            try {
              ...
              // /subsidiary_work/subsidiarywork_answerActorName_List.jsp(102,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fform_005f0.setAction("/QuestionnaireAction.do?action=answerActorNameSearch");
              // /subsidiary_work/subsidiarywork_answerActorName_List.jsp(102,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  out.write("\" >\r\n\t<tr>\r\n\t  <td width=\"20\" rowspan=\"2\" ></td>\r\n\t  <td colspan=\"2\"> 投票人姓名：<input type=\"text\" title=\"请点击选择\" class=\"inputtext\" onClick=\"openEndow('searchActorId','searchActorName',QuestionnaireActionForm.searchActorId.value,QuestionnaireActionForm.searchActorName.value,'user','yes','user','");
                  out.print(session.getAttribute("grantRange"));
                  out.write("')\" readonly=\"readonly\" maxlength=\"25\" name=\"searchActorName\" size=\"30\" value=\"");
                  out.print(searchActorName);
                  out.write("\"/> <input type=\"hidden\" name=\"searchActorId\" value=\"");
                  out.print(searchActorId);
                  ...
                  out.write(',');
                  out.print(s_day);
                  out.write(");\r\n\t\t   </script>&nbsp;&nbsp;\r\n\t\t   结束日期： <script language=javascript>\r\n\tvar dtpDate = createDatePicker(\"searchEndDate\",");
                  out.print(e_year);
                  out.write(',');
                  out.print(e_month);
                  out.write(',');
                  out.print(e_day);
                  out.write(");\r\n\t\t   </script>\r\n            <input type=\"checkbox\" value=\"1\" name=\"timecheck\" ");
if ("1".equals(request.getParameter("timecheck"))) {
                  out.write("checked");
}
                  out.write(" style=\"cursor:pointer\">\r\n\t  </td>\r\n\t   <td align=\"right\">\r\n\t\t  <input type=\"button\" class=\"btnButton2Font\"  style=\"cursor:pointer\" onclick=\"search();\" value=\"查询\"/>\r\n\t\t  <input type=\"button\" class=\"btnButton2Font\" style=\"cursor:pointer\" onclick=\"cleared('");
                  out.print(questionnaireId);
                  out.write("');\" value=\"重置\"/>\r\n\t  </td>\r\n\t</tr>\r\n\t<input type=\"hidden\" name=\"questionnaireId\" value=\"");
                  out.print(questionnaireId);
                  out.write("\">\r\n\t<input type=\"hidden\" name=\"grade\" value=\"");
                  out.print(grade);
                  out.write("\">\r\n\t\r\n</table>\r\n<!-- SEARCH\tPART -->\r\n\r\n\r\n\r\n\r\n\r\n\r\n<!-- LIST TITLE PART -->\r\n<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"listTable outTopline\">\r\n\t   <input type=\"hidden\"   name=\"sszzDesc\" value=\"");
                  out.print(sszzDesc);
                  out.write("\"/>\r\n       <input type=\"hidden\"   name=\"tpsjDesc\" value=\"");
                  out.print(tpsjDesc);
                  out.write("\"/>\r\n\t    <input type=\"hidden\"   name=\"sortFirst\" value=\"");
                  out.print(sortFirst);
                  out.write("\"/>\r\n\t  <tr align=\"center\">\r\n\t\t<td  class=\"listTableHead\"> 投票人姓名 </td>\r\n\t\t<td  class=\"listTableHead\" onclick=\"sort('sszz');\"> 所属组织<img  name=\"imgsszz\"  title=\"按所属组织排序\" style=\"cursor:pointer\" src=\"/jsoa/images/blanksort.gif\"/> </td>\r\n\t\t<td  class=\"listTableHead\" onclick=\"sort('tpsj');\"> 投票时间<img  name=\"imgtpsj\"  title=\"按投票时间排序\" style=\"cursor:pointer\" src=\"/jsoa/images/blanksort.gif\"/></td>\r\n\t\t<td width=\"8%\" class=\"listTableHeadLast\" nowrap=\"nowrap\"> 处理 </td>\r\n\t  </tr>\r\n\r\n\t  ");
				...
				pageSize2=Integer.parseInt(request.getParameter("pager.offset"));
                  ...
                  try {
                    ...
                    // /subsidiary_work/subsidiarywork_answerActorName_List.jsp(158,3) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setId("List");
                    // /subsidiary_work/subsidiarywork_answerActorName_List.jsp(158,3) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    _jspx_th_logic_005fiterate_005f0.setName("actorNameList");
...
if(index%2 != 0){listClass="listTableLine2";}
		String redStyle="mustFillcolor";
		if(obj[4]!=null&&obj[4].toString().indexOf(request.getSession(true).getAttribute("userId").toString())>=0){
			redStyle="";
		}
	  
                        out.write("\r\n\t  <tr>\r\n\t\t  <td class=\"");
                        out.print(listClass);
                        out.write("\"><a style=\"cursor:pointer\" href=\"javascript:void(0);\" onclick=\"answerPreview('");
                        out.print(obj[0]);
                        out.write('\'');
                        out.write(',');
                        out.write('\'');
...
if(obj[3] !=null && !"".equals(obj[3].toString())){
                        out.print(obj[3].toString().substring(0,16));
}else{
                        out.write("&nbsp;");
}
                        out.write("</label></td>\r\n\t\t  <td class=\"");
...
if (grade !=null && "1".equals(grade)){
                        out.write("\r\n\t\t  <a style=\"cursor:pointer\" href=\"javascript:graded('");
                        out.print(obj[0]);
                        out.write('\'');
                        out.write(',');
                        out.write('\'');
                        out.print(questionnaireId);
                        out.write("')\"><img title=\"评分\" src=\"/jsoa/images/pf.gif\" border=\"0\" /></a>");
}
                        ...
                        out.print(obj[0]);
                        out.write("')\" >&nbsp;<img  style=\"cursor:pointer\" border=\"0\" src=\"images/modi.gif\" alt=\"设计\" onclick=\"design('");
                        out.print(obj[0]);
                        out.write("')\">&nbsp;<img  style=\"cursor:pointer\" border=\"0\" src=\"images/konwledge_view.gif\" alt=\"预览\" onclick=\"preview('");
                        out.print(obj[0]);
                        out.write("')\">&nbsp;<img  style=\"cursor:pointer\" border=\"0\" src=\"images/konwledge_view.gif\" alt=\"答卷\" onclick=\"answer('");
                        out.print(obj[0]);
                        out.write("')\"-->\r\n\t\t  </div></td>\r\n\t  </tr>\r\n\t  ");
...
if(!currentPageNumber.equals(pageCount)){
            ...
            out.write("\r\n</td></tr></table>\r\n</body>\r\n<script language=\"javascript\">\r\n<!--\r\n\r\nfunction orderBy(ord){\r\n\twindow.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/QuestionnaireAction.do?action=actorNameListView&questionnaireId=");
            out.print(request.getParameter("questionnaireId"));
            out.write("&grade=");
            out.print(request.getParameter("grade"));
            out.write("&ord=\"+ord;\r\n}\r\nfunction orderBy1(ord){\r\n\twindow.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/QuestionnaireAction.do?action=actorNameListView&questionnaireId=");
            out.print(request.getParameter("questionnaireId"));
            out.write("&grade=");
            out.print(request.getParameter("grade"));
            out.write("&ord1=\"+ord;\r\n}\r\nfunction getCheckBoxID() {\r\n    var strCheckBox = \"\" ;\r\n    var k=0;\r\n    for(var i = 0 ; i < document.all.QuestionnaireActionForm.length ; i++ ) {\r\n        var obj = document.all.QuestionnaireActionForm[i] ;\r\n         if(obj.type == \"checkbox\"  && obj.name==\"batchDel\"){\r\n\t\tif(obj.checked) {\r\n             \tk++;\r\n                \tstrCheckBox += obj.value  ;\r\n                    \tstrCheckBox += \",\" ;\r\n\t\t}\r\n         }\r\n    }\r\n    document.all.checkboxNumber.value = k;\r\n    return strCheckBox ;\r\n}\r\n\r\nfunction selectAllItem(){\r\n    var result=document.all.selectAll.checked;\r\n    if(document.all.batchDel){\r\n        if(isNaN(document.all.batchDel.length)){\r\n            document.all.batchDel.checked=result;\r\n        }else{\r\n            for(var i=0;i<document.all.batchDel.length;i++){\r\n                document.all.batchDel[i].checked=result;\r\n            }\r\n        }\r\n    }\r\n}\r\nfunction graded(answerSheetId,questionnaireId){\r\n\tMM_openBrWindow('QuestionnaireAction.do?action=answerGraded&answerSheetId='+answerSheetId+'&questionnaireId='+questionnaireId+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600')\r\n");
            out.write("}\r\n\r\n\r\nfunction answerPreview(answerSheetId,questionnaireId){\t\r\n\tMM_openBrWindow('QuestionnaireAction.do?action=answerPreview&answerSheetId='+answerSheetId+'&questionnaireId='+questionnaireId+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600')\r\n}\r\n\r\n\r\nfunction modify(id){\r\n\tMM_openBrWindow('QuestionnaireAction.do?action=selectQuestionnaireView&questionnaireId='+id+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=450')\r\n}\r\nfunction view(id){\r\n\tMM_openBrWindow('QuestionnaireAction.do?action=selectQuestionnaireSee&questionnaireId='+id+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=450')\r\n}\r\n\r\nfunction design(id){\r\n\tMM_openBrWindow('QuestionnaireAction.do?action=questhemeListView&questionnaireId='+id+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600')\r\n}\r\nfunction preview(id){\r\n\tMM_openBrWindow('QuestionnaireAction.do?action=questionnairePreview&questionnaireId='+id+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600')\r\n}\r\n");
            out.write("function answer(id){\r\n\tMM_openBrWindow('QuestionnaireAction.do?action=questionnaireAnswer&questionnaireId='+id+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=800,height=600')\r\n}\r\n\r\nfunction del(id){\r\n    \tvar checkboxNumber = document.all.checkboxNumber.value;\r\n        var j = document.all.jNumber.value\r\n        var pageSize2 = document.all.pageSize2.value;\r\n        var pageSize3 = document.all.pageSize3.value;\r\n    if(checkboxNumber==j && pageSize2>=pageSize3){\r\n        pageSize2 = pageSize2-pageSize3;\r\n        }\r\n    if(confirm(\"确实要删除这则问卷吗？\")){\r\n    window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/QuestionnaireAction.do?action=deleteQuestionnaire&questionnaireId=\"+id+\"&pager.offset=\"+pageSize2;\r\n    }\r\n}\r\n\r\nfunction delBatch() {\r\n    \tvar strId=getCheckBoxID();\r\n        var checkboxNumber = document.all.checkboxNumber.value;\r\n        var j = document.all.jNumber.value\r\n        var pageSize2 = document.all.pageSize2.value;\r\n        var pageSize3 = document.all.pageSize3.value;\r\n");
            out.write("    if(checkboxNumber==j && pageSize2>=pageSize3){\r\n        pageSize2 = pageSize2-pageSize3;\r\n        }\r\n        if(strId!=\"\"){\r\n\tif(confirm(\"确实要删除这些问卷吗？\")){\r\n         window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/QuestionnaireAction.do?action=deleteBatchQuestionnaire&ids=\" + getCheckBoxID()+\"&pager.offset=\"+pageSize2 ;\r\n    }\r\n    }else{\r\n             alert(\"请选择要删除的问卷!\");\r\n             return;\r\n         }\r\n}\r\nfunction openFSDW(id,filemc){\r\n\tMM_openBrWindow('SkwjAction.do?action=selectFsDw&fileId='+id+'&fileMc='+filemc+'','','TOP=0,LEFT=0,scrollbars=yes,resizable=yes,width=600,height=600')\r\n}\r\nfunction search(){\r\n\tdocument.QuestionnaireActionForm.action=\"/jsoa/QuestionnaireAction.do?action=answerActorNameSearch&name=");
            out.print(name);
            out.write("\";\r\n    if(document.QuestionnaireActionForm.searchActorId.value==\"\"){\r\n        document.QuestionnaireActionForm.searchActorName.value=\"\";\r\n    }\r\n    document.QuestionnaireActionForm.submit();\r\n}\r\nfunction cleared(questionnaireId){\r\n window.location.href=((window.location.href).substring(0,(window.location.href).indexOf(\"/jsoa\")))+\"/jsoa/QuestionnaireAction.do?action=actorNameListView&questionnaireId=\"+questionnaireId+\"&grade=");
            out.print(grade);
            out.write("&name=");
            out.print(request.getParameter("name"));
            ...
            out.write("\" ;\r\n    var tpsjDesc=\"");
            out.print(tpsjDesc);
            out.write("\" ;\r\n    if(\"2\" == sszzDesc ) {\r\n        QuestionnaireActionForm.imgsszz.src = \"/jsoa/images/downsort.gif\" ;\r\n        QuestionnaireActionForm.imgsszz.title = \"升序\" ;\r\n    }else if(\"1\" == sszzDesc ) {\r\n        QuestionnaireActionForm.imgsszz.src = \"/jsoa/images/upsort.gif\" ;\r\n        QuestionnaireActionForm.imgsszz.title = \"降序\" ;\r\n    }\r\n    if(\"2\" == tpsjDesc ) {\r\n        QuestionnaireActionForm.imgtpsj.src = \"/jsoa/images/downsort.gif\" ;\r\n        QuestionnaireActionForm.imgtpsj.title = \"升序\" ;\r\n    }else if(\"1\" == tpsjDesc ) {\r\n        QuestionnaireActionForm.imgtpsj.src = \"/jsoa/images/upsort.gif\" ;\r\n        QuestionnaireActionForm.imgtpsj.title = \"降序\" ;\r\n    } \r\n}\r\n\r\n\r\n\r\n//排序\r\nfunction sort(sorttype) {\r\n    if(\"sszz\"==sorttype) {\r\n    \tif(QuestionnaireActionForm.sszzDesc.value == \"2\") {\r\n\t\t\tQuestionnaireActionForm.sszzDesc.value = \"1\" ;\r\n           QuestionnaireActionForm.imgsszz.title = \"降序\" ;\r\n\t\t   QuestionnaireActionForm.imgsszz.src = \"/jsoa/images/downsort.gif\" ;\r\n    \t} else {\r\n           QuestionnaireActionForm.sszzDesc.value = \"2\" ;\r\n");
            out.write("           QuestionnaireActionForm.imgsszz.title = \"升序\" ;\r\n\t\t   QuestionnaireActionForm.imgsszz.src = \"/jsoa/images/upsort.gif\" ;\r\n   \t\t}\r\n    }\r\n    if(\"tpsj\"==sorttype) {\r\n    \tif(QuestionnaireActionForm.tpsjDesc.value == \"2\") {\r\n\t\t   QuestionnaireActionForm.tpsjDesc.value = \"1\" ;\r\n           QuestionnaireActionForm.imgtpsj.title = \"降序\" ;\r\n\t\t   QuestionnaireActionForm.imgtpsj.src = \"/jsoa/images/downsort.gif\" ;\r\n    \t} else {\r\n           QuestionnaireActionForm.tpsjDesc.value = \"2\" ;\r\n           QuestionnaireActionForm.imgtpsj.title = \"升序\" ;\r\n\t\t   QuestionnaireActionForm.imgtpsj.src = \"/jsoa/images/upsort.gif\" ;\r\n   \t\t}\r\n    }\r\n    QuestionnaireActionForm.sortFirst.value = sorttype  ;\r\n    search() ;\r\n}\r\n//-->\r\n</script>\r\n\r\n");
